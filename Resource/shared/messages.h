...
#define MSG_LOCATION_SETQUESTPOINTER 30182 // lss
#define MSG_LOCATION_HIDEQUESTPOINTER 30183 // lss
...
#define MSG_CHARACTER_ISRUN 30374   // "lee" character run
// evganat - мушкеты
#define MSG_CHARACTER_SETMUS 30375				// экипировать модель мушкета на персонажа, "ls", s - модель мушкета
