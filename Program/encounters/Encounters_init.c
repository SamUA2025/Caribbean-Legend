...
void InitEncounters()
{
	...
	Enc_AddClasses(rEnc, 4, 3, 4, 3, 3);
	Enc_AddClasses(rEnc, 1000,3, 4, 3, 3);
	...
	///////////////////////////////////////////////////////////////////////////////////////
	/// 1-3 торговых корабля 2-3 класса (коронный торговец) + 1-3 корабля охранения 3 класса
	/////////////////////////////////////////////////////////////////////////////////////// 
	...
	Enc_AddClasses(rEnc, 4, 2, 3, 3, 3);
	Enc_AddClasses(rEnc, 1000,2, 3, 3, 3);
	
	///////////////////////////////////////////////////////////////////////////////////////
	/// 1 торговый корабля 2 класса  + 1 корабль охранения 3 класса (экспедиция)
	/////////////////////////////////////////////////////////////////////////////////////// 	
	...
	Enc_AddClasses(rEnc, 4, 2, 2, 3, 3);
	Enc_AddClasses(rEnc, 1000,2, 2, 3, 3);
