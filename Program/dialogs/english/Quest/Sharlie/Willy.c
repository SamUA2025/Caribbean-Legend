...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "catoche_1":
			dialog.text = "A Scotsman, Monsieur. Captain of the English Navy William Paterson, and this is my first mate and right hand, Archibald Calhoun. Thing is, there is a Spanish fort in the jungles. My mission is to kick the cursed bastards out of the fort, which they have built dangerously close to English territory.\nRecently we tried to storm it, but the bastards have managed to hold out despite their losses. I left for reinforcements and...";
		...
		case "catoche_2":
			...
			link.l1 = "I dare remind you Captain Paterson, that this isn't Belize. What English possession? All this fuss got started due to Don Diego de Montoya and his risky decision to attack me and my ships.";
		...
		case "isladevieques":
			...
			link.l1 = TimeGreeting()+", Mr. Paterson. I have to say, you and your friend Archibald played your roles and fooled me pretty well, Fuck you all! I didn't even see it coming...";
		...
		case "isladevieques_4":
			dialog.text = "Haw-haw! Well, we'll be honest right down til the end... Do you really believe, sir, that I'm such an idiot, like you and Don Diego, that I would carry around such a precious object with me? The compass is on Jamaica and not even in Port Royal, but in a place where no one would even think about looking and under a safe lock. But you won't need that information.";
			if (CheckAttribute(pchar, "questTemp.Guardoftruth.OfficerKill"))
			{
				link.l1 = "As I understand, you've already buried me, Mr. Paterson? I dare proclaim that the cat has one life left!.. Where are my officers?";
				link.l1.go = "isladevieques_5_1";
			}
			else
			{
				link.l1 = "As I understand, you've already buried me, Mr. Paterson? I dare proclaim that the cat has one life left!..";
