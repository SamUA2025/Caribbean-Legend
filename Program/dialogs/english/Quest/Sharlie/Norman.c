...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "norman_fes":
			...
			switch (drand(5))
			{
				case 0:
					...
					link.l2 = "Ha, call yourself an admiral while you're at it, I'll definitely buy that!";
		...
		case "tieyasal":
			...
			{
				link.l4 = "Miguel Dichoso has killed a man. That's why I'm looking for him.";
		...
		case "tieyasal_18":
			dialog.text = "And you? Why are you searching for him? Oh, I get it, I get it: to kill him! Kill him, kill the bastard! Avenge Blaze Sharp! Blaze was a terrific guy. I remember him, even as a child he was just like Nicholas.";
