...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "ring_35":
			...
			dialog.text = "Well, and let's keep what each of us have found at the decks for ourselves. Are you alright with that? Have you found anything useful in chests and in cabinets?";
