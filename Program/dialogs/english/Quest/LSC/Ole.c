...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "store_1":
			...
			{
				link.l1 = "Hm, I don't have beads, but I can give you this pearl. It is white and it's just like the bead. Are you alright with that?";
				link.l1.go = "store_2";
			}
		...
		case "store_13":
			dialog.text = "Oh, "+pchar.name+" is very brave! Then you should go to uncle Henrik, he will teach you how to walk at the bottom and you will kill every crab there. You will also find there one more big bead for Ole. right?";
