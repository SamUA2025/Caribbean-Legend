...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		case "First time":
			if (npchar.quest.meeting == "0")
			{
				...
				link.l1 = TimeGreeting()+". My name is "+GetFullName(pchar)+". I am a newcomer here and I'm just looking around getting to know people...";
				link.l1.go = "meeting";
			...
			else
			{
				...
				{
					link.l4 = "I have enough of metal, the one you asked for. Take it.";
		...
		case "mechanic_2":
			dialog.text = "It's true. I've been at the bottom myself several times. Though, I don't dive any more, the shoal is crawling with giant crabs nowadays and, surely, as you can see, I am not capable of fighting them, I am a scientist, I can't fight those things.\nBesides, there also were two other men, two Narwhals, who used to dive, but they eventually stopped doing so - looting holds of the outer ring ships turned out to be safer than diving to place infested by giant crabs\nNow they use my equipment rarely, not a single dive for the last few months because of the suit's fracture...";
			link.l1 = "Do you really have a suit with which you can dive to the bottom? Did I mishear you?";
			link.l1.go = "mechanic_3";
		break;
		
		case "mechanic_3":
			dialog.text = "Your ears are in the right place, young man. I have invented and crafted the suit myself. It is made of thick soaked completely watertight canvas, metal parts and a steel helmet forged by me and Jurgen in his smithy\nI also enforced the suit with metal chest plate, kneepieces, chest pieces and boots for better protection against crabs and extra weight\nSpecial tanks, filled with pressurized air, provide life-support function and ability to spend some time under the water. The suit is unique, and I am quite proud of it.";
			link.l1 = "That is splendid. But did you mention that the suit is damaged?";
			link.l1.go = "mechanic_4";
		break;
		
		case "mechanic_4":
			dialog.text = "Unfortunately, it is so. Several parts of the suit were connected by metal plates in order to achieve flexibility and extra protection, but the sea water affected them badly. The plates got rusty for years of operation and have lost their water protection abilities\nIt's good that I've noticed the damage and prevented people from dying. Even the dry suit contained some salt and water, they had finished their ill job completely.";
			link.l1 = "Well.. But you can repair the suit! You can replace the old rusty parts with the new ones... Right?";
			link.l1.go = "mechanic_5";
		break;
		
		case "mechanic_5":
			dialog.text = "For what purpose? To replace them again a year later? Do you know how difficult this work is? To compose the suit with flexible joints and to make it waterproof? It is at least one week of work with no rest.";
		...
		case "mechanic_7":
			...
			link.l1 = "And what is this... metal of which are you talking about?";
			link.l1.go = "mechanic_8";
		break;
		
		case "mechanic_8":
			dialog.text = "Oh, this is a unique metal, really underestimated by many. It has high durability, plasticity and it is absolutely immune to exposure - neither water, nor salt can damage it\nPerhaps you might have already seen the metal before. It is white, looks like silver, that's why Spanish called it the 'silver'. Ha! It is hundred times better than silver! Even better than gold! One day they will understand that, but the right time hasn't come yet.";
			link.l1 = "Listen, why can't you use other types of metal instead? Why don't you use gold to make those plates? I have never heard that gold can go rusty or go to ruin.";
			link.l1.go = "mechanic_9";
		break;
		
		case "mechanic_9":
			dialog.text = "You have a flexible and living mind, young man. That's good to know. Unfortunately, you proposition won't work. The thought of gold was the first thing which crossed my mind. But the gold is too soft to link different parts of the suit\nAlas, platinum is the only material that will do. I'll be crafting parts only from it, even if it'll take years to collect enough. But I've seen pieces of the metal before on the Island - it is often mixed with silver due to the looks of it.";
			link.l1 = "Hm. And if I will help you to find enough of this... 'silver', will you lend me the suit so that I can dive underwater?";
		...
		case "mechanic_10":
			...
			link.l1 = "Then show me this piece of metal to help me understand what I need to find.";
			link.l1.go = "mechanic_11";
		break;
		
		case "mechanic_11":
			dialog.text = "So you are going to search for it? Excellent. Here, take this piece as an example. Look for it among the silver ore and nuggets. It won't be easy to find it but you will handle it. There are small darkenings on silver but our metal is clear and much harder than silver. The easiest way to test it would be by scraching the silver coin on it, if the coin gets damaged then you have found it.";
		...
		case "mechanic_12":
			...
			dialog.text = "Alas, I don't. If I knew where to find it, I'd do it myself. But I can give you an advice though. Search in the Rivados ships. I don't visit them so it's very likely that they might have it.";
		...
		case "mechanic_16":
			dialog.text = "Well, now I can start the repairs. I won't waste the time and I will start tomorrow. You are really eager to dive, aren't you?";
			link.l1 = "Indeed. I really want to explore the underwater.";
			link.l1.go = "mechanic_17";
		break;
		
		case "mechanic_17":
			dialog.text = "That is very good, because I will have an ask for you when we will organize your dive. But we will talk about it later. Come and see me in five days, I hope that I will finish the repairs.";
		...
		case "mechanic_20":
			...
			{
				dialog.text = "Yes. Me and Jurgen did hell of a job and the amount of pieces you've brought was enough to do it. The suit is repaired and prepared. I only need to run several tests, but I am sure that it is fine. Come tomorrow at 10 a.m. - I will fill the tanks with air and you will be able to do what you want.";
		...
		case "immersion_1":
			...
			link.l1 = "I will deal with crabs. I got the rest. Don't dive deeper, don't go far away from the hoist and don't forget about the time. When can I dive?";
		...
		case "immersion_4":
			dialog.text = "That's just it. Take the suit from the room at the platform. Take it off after a dive and bring to me. I will fill it with air again. But don't try to dive more than once per day, even the 20 minutes of diving and breathing the compressed air is bad for your health.";
	...
	//--------------------------------------вернулся на Остров---------------------------------------------
		...
		case "return_1":
			dialog.text = "I see, I see. I will have to trust you, though your words are the anti-scientific nonsense. Teleports, statues... ha! And who could even think about it, how do such things even work?";
			link.l1 = "Just trust me and don't try to find any logic here. I am not lying.";
			link.l1.go = "return_2";
		break;
		
		case "return_2":
			dialog.text = "Fine. But I hope that you didn't lose the suit during that teleportation of yours?";
			if(CheckCharacterItem(pchar, "underwater"))
			{
