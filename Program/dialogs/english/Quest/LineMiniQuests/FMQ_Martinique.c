...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "officer_1":
			dialog.text = "Cut the crap! There are several barrels of resin inside this shipyard. Captain, you have delivered them to your partner in crime. Both of you are under arrest and I am confiscating the cargo in the name of the law!";
			link.l1 = "...";
		...
		case "greguar_2":
			dialog.text = "You look troubled, captain. What happened here? Is something wrong?";
