void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "FalseTrace":
			...
			dialog.text = "Good afternoon, captain... ehm... kha-hahrm! Fucking mines... Let me introduce myself. Adam Rayner. I am a simple man and do not like long forewords, so I'll spit it out right away. Do you want to make good money? I offer a small business to you, which we both will not be able to handle on our own.";
			link.l1 = "Heh! Good money? Interesting. I am listening to you, Adam.";
			link.l1.go = "FalseTrace_1";
			link.l2 = "You know, I am sorry, but you don't seem trustworthy. So I won't have any business with you.";
			link.l2.go = "FalseTrace_exit";
		break;
		
		case "FalseTrace_exit":
			dialog.text = "Trustworthy? Ha-ha! One shouldn't judge a man by his face. Well, nevermind. You've just missed a good opportunity to make good money easily and quickly. I will find someone more cooperative...";
		...
		case "FalseTrace_1":
			...
			dialog.text = "Kha! Pleasure doing business with such a quick-thinker like yourself, Captain. So, the job is simple: there is a galleon filled with a decent amount of silver and she will soon set sail from one of the local ports. A single vessel, no escort. Silly, right? K-kha\n Easy as pie. I tell you where and when, you take the prize and I get my cut.";
		...
		case "FalseTrace_3":
			dialog.text = "I am not a greedy man, captain. My share is as much as can be loaded in the hold of my old long boat and that is about 200 packs of silver. According to my information, there will be no less than 2000 packs of silver on the galleon, so I will get the tenth part. That's fair, don't you think so?";
			link.l1 = "Tenth of the loot just for information? I buy such information from the drunkards for a glass of rum at a local tavern. No, we are not going the same way, friend!";
		...
		case "FalseTrace_8":
			...
			link.l1 = "Of course, you will! I have already calmed down! You are not hanging on a yardarm at the moment only because I still cannot understand your motives. You pursued this galleon with me, knowing beforehand that there was no silver. So please explain yourself.";
		...
		case "FalseTrace_11":
			...
			link.l1 = "Alright listen, I don't really care for your family life, so sort it out with your wife. But you told me about compensating my costs, didn't you? Did I hear you right?";
		...
		case "FalseTrace_14":
			dialog.text = "I give you my word. I don't have other any guarantees. But it is true, I swear khe... kha...  damn mines!";
		...
		case "FalseTrace_18":
			...
			link.l1 = "None of your business. You used me, you have crossed me up, and now you're trying to deceive me again with absurd tales of treasures! Bosun, take him away!";
		...
		case "FalseTrace_19":
			...
			link.l1 = "Really? Do you really think that you stand a chance?! You'll regret this, fucker!";
		...
		case "FalseTrace_abordage_3":
			...
			link.l1 = "Giving up? No! I don't need any witnesses. Take your sword and fight, or I will gut you like a sheep.";
		...
		case "FalseTrace_wife_12":
			dialog.text = "No... (crying) I do not want to go back to this rascal! I made a huge effort to run away from him and cover my tracks, but he has found me anyway... Scoundrel! Bandit! Fucking thief!";
			link.l1 = "Calm down, Katerine... Watch your language. He is your husband, after all. And he said he loved you.";
		...
		case "FalseTrace_wife_21":
			...
			link.l2 = "To tell you the truth, I do not trust Adam... I hate to be manipulated. Alright, I will talk to your captain and I'll see what he can tell me. You can go now... Bosun! Take her away!";
			link.l2.go = "FalseTrace_wife_24";
		break;
		
		case "FalseTrace_wife_23":
			dialog.text = "You are a cruel and heartless man! I swear I...";
			link.l1 = "Boatswain! Guard her and keep an eye on her entire time until we arrive to "+XI_ConvertString("Colony"+pchar.questTemp.FalseTrace.QuestCity+"Gen")+"!";
			link.l1.go = "FalseTrace_wife_18";
		...
		case "FalseTrace_wife_26":
			dialog.text = "Of course, captain. My husband - thank God, now ex-husband - was a bandit, as you already know. Fearing possible searches, he did not keep pillaged loot at home. He organized a cache - but he once blabbed out about it. Still, he hid it in a very clever way - there is no access to that place from the shore.";
		...
		case "FalseTrace_wife_28":
			dialog.text = "Probably so. You will be able to find the loot there. You'll see. That's all. Bye, Captain.";
		...
		case "FalseTrace_wife_32":
			...
			link.l1 = "Didn't I tell you, dear, that you'd lose your head if you deceive me? A crafty devil! You will be way less dangerous dead. This pretty head is getting bullet right now...";
		...
		case "FalseTrace_wife_35":
			dialog.text = "May you drown! May your ship crash against the rocks! May you...";
			link.l1 = "Bye, Katerine.";
		...
		case "FalseTrace_Bandits_3":
			dialog.text = "Don't slander the poor widow, scum! Why would she come to us then? She offered us to take all gold to ourselves in exchange for your life. She doesn't want coins, she wants your death! A holy death for the death of husband!\nBut I swear, she won't die in poverty, this is as true as my name's "+GetFullName(npchar)+", and that this is the time for you to die, coward!";
		...
		case "FalseTrace_Remove2":
			dialog.text = "I have warned you, captain, we only had two weeks! By now Squint-eyed Solly must have already taken away all the booty. It's not my fault that you are such a muddler. Farewell!";
			link.l1 = "Yeah, my fault. Farewell, I hope that we won't meet again, you're just a bad luck for me.";
			link.l1.go = "FalseTrace_Remove_exit";
		break;
		
		case "FalseTrace_Solly":
			dialog.text = "Heh! Finally! We are tired of waiting, and these damn mosquitoes... Wait... And where is Solly? I don't get it...";
