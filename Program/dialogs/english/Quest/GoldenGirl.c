...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
       ...
       case "First time":
		...
		case "fraofficer":
			dialog.text = "Captain Charles de Maure! At last! His Excellence Jacques Dille do Parkuet is demanding to see you! This is urgent!";
		...
		case "Julianna":
			dialog.text = "My eyes must be deceiving me if it is Charles de Maure himself! I don't do such receptions very often and I am delighted that you managed to find some time to spare for my humble cloister. Lucky me! This deserves a toast!";
			link.l1 = "My regards, madam. Forgive me for a possible disappointment of my manner - it's been a very long time since I attended such... events last time. A ship's etiquette narrows to subordination, clean scarfs and a regular cup of refreshing coffee every morning.";
			link.l1.go = "Julianna_1";
		break;
		
		case "Julianna_1":
			dialog.text = "So charming, Captain, you still have your Paris gloss with you. I can see its shy glance under this seasoned and salted mask. Don't you worry, I am so glad to finally meet you that I can forgive you for many things. For now. We will see how it goes with us in the future. Wine? Red or white?";
		...
		case "Julianna_2":
			...
			link.l2 = "In that case, I'll have white but you choose. This should work in both ways, don't you agree?";
		...
		case "Julianna_3":
			...
			link.l1 = "Pinot Noir, huh? Works for me. Unreliable and mysterious, a bleak taste at first but let it breathe for a while and you'd be surprised. A light dance of shades and tastes, a choice of an experienced connoisseur. First impressions lie, right? I drink to your eyes, madam!";
		...
		case "Julianna_6":
			dialog.text = "This 'unpleasant' monsieur is Angerran de Chievous, an unrecognized bastard of Count de Levi Vantadur. You are entertaining their topic of argument. De Chievous has been trying to earn my good favor for years, and he followed me here, thinking that he can replace his father for me. Even though he is not a lawful son, he is rich and powerful. Stubbornness is another of his traits, for some people it replaces wisdom. Just before your arrival he and Jacques started arguing about the obvious subject. His Excellence always protects me in a very touching way, you should see! Come on, let's observe and see how it ends this time.";
			link.l1 = "I smell trouble in the air... Why is there always a catch, even in such a wonderful night...";
		...
		case "Julianna_11":
			...
			link.l1 = "I am afraid I don't follow you... What can I possibly do here? He refused to duel me already...";
			link.l1.go = "Julianna_12";
		break;
		
		case "Julianna_12":
			dialog.text = "Captain, please don't disappoint me. Just a moment ago you were a virtuoso of conversations and now your world is split between things you can poke with a sword and things you can't. Think out of the box! Let's spoil Angerran's play. He wants to challenge poor Jacques on his own, but that's just dull! Let's run a tournament! Several gentlemen here can support serious stakes and your luck is already known as legendary! Perhaps cards will favor it tonight?";
		...
		case "Julianna_13":
			dialog.text = "Splendid, now go to the table and have something to eat, it will be a long night. Once you are ready, see me in the hall, we will need more room for this. In the meantime, I will throw a show, persuading others to give me spectacles and games of high stakes. I might even shout at them to make these cocks notice a lady drowning in boredom. Please do not interfere, no one must know we are in the same team tonight. See you later, my Captain!";
			link.l1 = "Whatever you say, madame, whatever you say...";
		...
		case "Julianna_19":
			if (CheckAttribute(pchar, "questTemp.GoldenGirl.Game.Win")) 
			{
				dialog.text = "I congratulate you on your well deserved victory, Captain! It's still unclear who will face you in our finale... Let's step aside a bit. Lower your voice and observe that table. Look, there he goes! I am starting to see what Angerran is up to! He already stripped sweet Jacques of cash but he is not letting him leave the table. When I passed by, the poor sod gambled on some documents over a whole ship with cargo. Sadly, luck is not on his side tonight. Or someone told her to not be.";
		...
		case "Julianna_23":
			dialog.text = "Charles, hold me or I will fall... Or I won't - these idiots will not even notice me feinting. Did you see this? Jacques, damn your stupidity! Like a child, Jesus! An imbecile child!";
		...
		case "Julianna_24":
			dialog.text = "On me, Charles. Our sweet, stupid Jacques gambled on me. Angerran found his only soft spot and hit it in the right moment.";
			link.l1 = "Blast it! But I am the next in the tourney, I could gamble back his bloody ship! Why?";
		...
		case "Julianna_25":
			...
			link.l1 = "Don't bury our governor just yet, madam. Maybe he will win his ship back? Lady Luck is a fickle... woman.";
			link.l1.go = "Julianna_26";
		break;
		
		case "Julianna_26":
			dialog.text = "You still don't get it, do you? Luck has no place at that table! Angerran de Chievous calls all shots. He discovered a way to both have me and keep his father away from this. I have no idea how long has he been planning it, but he has almost won by now. He is owning the game and we have only one chance to break it. Here, take this! I am going to feint, will give a minute or two. Use it wisely.";
		...
		case "Julianna_28":
			dialog.text = "No, no I am fine... It's a bit stuffy here... I am so sorry, gentlemen. I will leave you for some fresh air for a moment. You can go on without me.";
			link.l1 = "...";
		...
		case "Julianna_32":
			dialog.text = "Angerran, you are impossible! Learn how to lose! This is just a game and you can't predict everything. Finish your wine and get dressed - the rules remain - a defeated leaves our comfy party.";
		...
		case "Julianna_36":
			dialog.text = "Charles, I am afraid I will have to ask you to take your leave as well. Go upstairs and take a room for yourself. I will arrange everything. I am grateful for everything you've done for me beyond any measure but I need some time for myself and you must be dreadfully tired.";
			link.l1 = "It's not too bad, madam, but I won't say no to a bed. This casual party hit me harder than a massive enemy naval squadron. I understand that all this wasn't easy for you either, marquise. Get some rest and don't you worry, you owe me nothing. All I need right now is a sleep.";
		...
		case "Julianna_39":
			...
			link.l1 = "Your hospitality is legendary, madam, but I am afraid I have no time to enjoy it. His Excellency, de Chievous' seconds, ships I won - all of it, is waiting for me.";
			link.l1.go = "Julianna_40";
		break;
		
		case "Julianna_40":
			dialog.text = "You won not only the ships. This is another thing I wanted to ask you about, Charles...";
			link.l1 = "I am neither Jacques nor Angerran, marquise. I don't gamble over women to gain their favor. You owe me nothing.";
		...
		case "Julianna_41":
			...
			dialog.text = "You are either fabulously honorable or in love, Charles. And not with me. But again, I am eternally grateful to you with all my heart. If I can be of any help to you - just tell me.";
			link.l1 = "Julianne, time is running and I am facing the most uneasy task ahead. De Chievous is a scum and even an honest duel can quickly end up like the one we observed last night. Let's talk later when all of this is done for good. I thank you for a chance to sleep in silence and I am looking forward to see you again.";
		...
		case "Julianna_47":
			...
			link.l1 = "I told the governor that you might be in danger. De Chievous got wounded and run away, unleashed his thugs on us. It was a massacre. Although, stories like this are not for your beautiful ears. It's over. You are free from him and from our 'sweet' Jacques.";
			link.l1.go = "Julianna_48";
		break;
		
		case "Julianna_48":
			dialog.text = "This is so bad, Charles. Enemies like Angerran de Chievous should be killed for good when you have a chance. I knew the man for many years - he is not a forgiving type. Sooner or later, he will find his way to revenge. But I don't like how you are slouching, was your wound taken care of?";
		...
		case "Julianna_50":
			dialog.text = "Charles, you are an example of chivalry! I swear to God, if you keep being like that, I will loose my head! Alright, my knight, I'll send Denise to you, she will take care of your wounds as any proper physician would.";
		...
		case "Julianna_67":
			...
			link.l1 = "Yes, it is from him. She is alive! He captured her while stealing my ship. Now he suggests we meet and talk this through in a civilized environment. Just as you have said, Guadeloupe, Basse-Terre.";
		...
		case "Julianna_68":
			...
			link.l1 = "Julianne, I would had never made it in the New World if I always chose direct approach. Shady business is not my strongest field, but I know how to play along.";
		...
		case "Julianna_72":
			...
			link.l1 = "Everything we knew about de Chievous's capabilities turned out to be a gravely understatement. The bastard is holding my... officer captive, and I have only two weeks to collect the ransom. I fear that it can't happen without your help.";
		...
		case "Julianna_73":
			if (CheckAttribute(pchar, "questTemp.GoldenGirl.JulianaSex"))
			{
				dialog.text = "Charles, your love is quite a windflower, yet I owe you a great deal and will help you as best as I can. How can I be of service to you?";
			}
			else
			{
				dialog.text = "Charles, I already told that I will never forget what you did for me. I will do what I can to repay you. I am ready, yet I don't quite understand how can I be any use for you in this?";
			}
		...
		case "Julianna_75":
			dialog.text = "And what, you are asking me? To not to scream during my abduction? Captain, don't you think this is a bit too much to ask? I owe you a great deal, but saving someone else's love by giving my own life away in the hands of an inglorious bastard... You are the chivalry here while I am an extremely realistic and materialistic woman.";
		...
		case "Julianna_76":
			dialog.text = "You are full of surprises, Charles. Heard that? That was all the grace I had for you, it just shattered. Love or not, I will not allow you to kidnap me. Guards! Help!!! Anyone!!!!";
		...
		case "Julianna_78":
			...
			link.l1 = "I've already made apologies to you. I asked you not to complicate things any further - you didn't listen. Believe me, I don't like what I am doing, but I have no choice. I will do whatever it takes for that woman's sake.";
		...
		case "Julianna_81":
			...
			link.l1 = "Why the bastard uses me to get to you? Why did he orchestrate that card game instead of just taking what he wanted? What is he afraid of?";
		...
		case "Julianna_82":
			...
			link.l1 = "Damn it! I wish it didn't come to this... Get ready, marquise, we must go. And yes, I ask you to keep quiet.";
			link.l1.go = "Julianna_76";
			link.l2 = "But the bastard must have other weaknesses beside his father, right? He is not perfect, quite the contrary he is the opposite of perfect!";
		...
		case "Julianna_83":
			...
			link.l1 = "It's Barbazon, madam. Nice couple, both of them! But Jacques the Kind has no love for me and I can't launch an assault on Le Francois without a solid certainty.";
		...
		case "Julianna_90":
			dialog.text = "I always knew that, Bartolomeo de la Cueva. This is why you got to my party in the first place. It was like adding jalapenos to one's dinner. I know that you and your boys have been poking around this island for a couple of weeks already. I know this must be somehow connected to the pirate baron of Le Francois and Angerran de Chievous. Tell my friend all about it and we will keep your legendary name as a secret in return. Otherwise I will call the guards who are already standing behind the doors. I called for them upon you arrival.";
			link.l1 = "...";
		...
		case "Julianna_106":
			...
			link.l1 = "Not yet, but I will. De Chievous is neck deep in something serious and this is my chance. His homeland won't dare to touch him but British authorities just might. I'd rather not abduct you, Julianne.";
		...
		case "Julianna_112":
			dialog.text = "Baronet, it appears that your men just dropped something behind the door! Would you kindly tell them to behave better?";
			link.l1 = "";
		...
		case "Julianna_117":
			dialog.text = "I apologize for interrupting your exciting discussion but unless some of you is wounded let's move to a cabinet. A sight like this is not very comforting for a lady... Only the ceiling is bloodless!";
			link.l1 = "Then go upstairs, marquise. You really should lie down for a bit and away from all this blood. Baronet Cortney and I will talk this through. Shall we continue?";
		...
		case "Julianna_120":
			dialog.text = "Angerran is an embodiment of lingering when it comes to finances! He signs more paper than any banker I know. I guess he's been like that since his childhood when he didn't know who his father was and lived in poverty in the streets.";
		...
		case "Julianna_122":
			...
			link.l1 = "Don't you worry, Julianne, it will take just a few days. I promise that they will treat you like a priceless vase from China. Correct me if I am wrong, but de Chievous will never show himself to the exchange?";
		...
		case "Julianna_126":
			...
			if(sti(pchar.reputation.nobility) > 65)
			{
				...
				link.l1 = "Thank you, marquise. I will make everything right this time. I learnt a lot from this story, and I pray that I won't pay a too terrible price for what I have done.";
		...
		case "Julianna_127":
			...
			link.l1 = "Think of me what you want, Julianna, I've earned it. But I will get her back no matter the cost\nJulianna, listen, I know what I am asking you of. To leave everything behind and to let others to drag you into a questionable gamble. But at this moment you are my only hope! I need your assistance in this and I will remain in your debt until I die!";
			link.l1.go = "Julianna_129";
		break;
		
		case "Julianna_128":
			pchar.questTemp.GoldenGirl.Julianna_Helper = "true";
			dialog.text = "Very well, Captain. In the end, Angerran must be put down for good. I will help you out but tell me how are going to rescue me from his ship?";
			link.l1 = "...";
			link.l1.go = "Julianna_129";
		break;
		...
		case "Julianna_132":
			...
			{
				dialog.text = "I will tell them that I was abducted by strangers, right from my house, to be put aboard Angerran's ship. It will appear like he paid mercenaries to kidnap me.";
		...
		case "Julianna_148":
			dialog.text = "Yet apparently not marvelous enough... but I am happy that it ended well for you. You owe me nothing, after what you did I can't thank you enough! Come see me whenever you are ashore. You will always be welcome at my place, as a friend!";
		...
		case "governor_4":
			...
			link.l1 = "You sure, your Excellency? He is as drunk as my quartermaster after a week on the shore, but he surely knows how to handle his sword. I can tell such things at once.";
		...
		case "governor_8":
			dialog.text = "It wasn't. I am just... a bit overexcited and I apologize. It was an accident and I demand a chance for a rematch! This ship, I... must get it back! Or screw the game, just tell me for how much are you willing to sell her to me? Name the price and I'll see it paid tomorrow before noon!";
		...
		case "governor_12":
			...
			link.l1 = "I had a similar debt before but I had absolutely nothing and yet I did alright. So will you. See you around, Jacques. No promises and I won't even ask what kind of cargo is worth one million, that you would keep it in the flute.";
		...
		case "governor_15":
			dialog.text = "You are too all in your head, my friend. Some parts of our world still don't revolve around you. Believe me, I am deeply disappointed of how everything went last night. Very deeply. But first, let's discuss the fate of your... winnings.";
		...
		case "governor_18":
			...
			link.l1 = "Listen... I am getting tired from arguing. So pay up, get your documents and be done with it.";
		...
		case "governor_20":
			...
			link.l1 = "How nice of you. And what if our good friend will decide to play dirty? I prefer to trust my back to people I call friends, and those who know what to do in such situations, rather than to people who were born in right families.";
			link.l1.go = "governor_21";
		break;
		
		case "governor_21":
			dialog.text = "Charles, stop behaving yourself like this duel is between you and I. This is a serious business. De Chievous is not a man who you kill and just get away with it. Any outcome will be followed by investigations, even by a court perhaps. We will need trustworthy witnesses. See, I am taking care of you! The most important thing though is that you can not kill him\nI understand, Angerran is determined and most likely he is decent fighter but, Charles, you can not kill him! Wound him, humiliate him even, but stop right there. If you kill him - there will consequences and neither of us will not be able to dodge or survive them. Even though count de Levi Vantadur never officially recognized his bastard, he has no other sons. His rage will have no end.";
		...
		case "governor_23":
			dialog.text = "You sure know how to surprise, Charles. Whatever, I have a tedious meeting with the Company's agent to attend to. You should go too, get yourself ready and I remember what I warned you about.";
		...
		case "governor_25":
			...
			link.l1 = "Unfortunately yes. He is wounded, not seriously. He had to flee, but he had also thrown his thugs at us. In short, some of this blood is not mine.";
		...
		case "governor_26":
			...
			else
			{
				if (sti(pchar.questTemp.GoldenGirl.Officer) == 1)
				{
					link.l1 = "Not all of them, Excellency. One gentleman didn't make it - de Chievous took the effort to bring musketeers along. I couldn't do anything.";
					link.l1.go = "governor_27_2";
				}
				else 
				{
					link.l1 = "It was hell let loose there, Excellency. Both brave gentlemen fell in combat. If it wasn't for them, things would get ugly for me. De Chievous orchestrated a proper fucking ambush.";
		...
		case "governor_27_1":
			...
			link.l1 = "I don't think we can do even a slightest damage to his name. I'd rather find him and finish the job myself despite all your warnings. Such a coward does not deserve to live.";
		...
		case "governor_27_2":
			...
			link.l1 = "I don't think we can do even a slightest damage to his name. I'd rather find him to finish the job myself despite all your warnings. Such a coward does not deserve to live.";
			link.l1.go = "governor_28";
		...
		case "governor_29":
			...
			link.l1 = "I don't quite follow you, Jacques. What It? Do you mean the marquise? Shit! Madam Botot! De Chievous is on the run, he is no longer a threat to me, but he is desperate and he can do anything! I should go! Send the guards to the marquise house! Now!";
		...
		case "Angerran_1":
			...
			link.l1 = "If this was a suggestion to walk past the gates together then I am in. I don't like you either and I am glad that the feeling is mutual. Let's cut the talking, you are not good in it anyway. I leave to you the choice of terms and arms.";
		...
		case "Angerran_3":
			dialog.text = "Ha, such a brave boy! Now calm your temper and keep your distance. We are not in a tavern and I am not a drinking mate of yours. You are way below my class, we shouldn't even be talking, but the dame requested it. Now, Jacques and I have an unfinished business...";
			link.l1 = "";
		...
		case "Angerran_7":
			dialog.text = "You are quite right, it's muggy here. It's been a most entertaining game so far, but let's make a small break before the finale. Bye, bye Jacques - remember the terms of our tourney?\nAnd here we have Charles de Maure, correct? A captain with a poor taste for wine, I remember you. Don't you worry, after I am done here, you will drink only water. So take your time, enjoy the moment, drink something. When you are ready, come join me in this small room. We will end the night in a more comfortable environment...";
		...
		case "Angerran_10":
			...
			link.l1 = "Come on, this is dull - I can get five of them with gold in a few weeks of raiding. Give me something bigger.";
		...
		case "Angerran_11":
			...
			{
				dialog.text = "Yes, I've seen your ship, I must admit it truly is a sight to behold. Let's raise it then - two ships against one. My frigate and flute with silver against your ship?";
			...
			else
			{
				...
				{
					dialog.text = "I heard what you anchored here, Captain. Be thankful that I agreed to accept your old tub as a stake. Come then, unless you refuse?";
		...
		case "Angerran_13":
			if (CheckAttribute(pchar, "questTemp.GoldenGirl.Game.Win"))
			{
				...
				else
				{
					...
					{
						dialog.text = "So the Fortune had her say. This turned out most curiously. Congratulations. Captain de Maure. You earned a decent drink, try Sangiovese. I assume, Jacques will pay you well for this tub, it appears he has feelings for it, feelings much bigger than to other certain things. It will be sufficient to buy a decent wine.";
						link.l1 = "Surrendering already? We are disappointing other guests, monsieur. If I recall correctly, you still have one more ship. I call your frigate versus my flute with silver since you considered my own ship too modest.";
			...
			{
				dialog.text = "Bad luck, Captain. Nevertheless, I appreciate your bravery, plus I am in the good mood today. I'll take your gold but you can keep your ship. Get out of my sight and please avoid gambling in the future. Someday, it will kill you.";
		...
		case "Angerran_15_1":
			...
			link.l1 = "Are you less resourceful than our sweet Jacques Dille do Parkuet? I am gifting you the most beautiful chance to prove that not all of love is for sale. Fortune doesn't sell her favor too. The silver ship and your frigate versus the thing you value more than gold.";
			link.l1.go = "Angerran_15_2";
		break;
		
		case "Angerran_15_2":
			dialog.text = "Captain, this is not even funny. Let's get this over with - dawn is coming soon. We will discuss my frigate's buyout tomorrow.";
		...
		case "Angerran_15_3":
			...
			link.l1 = "This is going to be the legend they will be savoring for a year behind closed door! Hey you, more wine and candles! Game must go on!";
		...
		case "Angerran_16_1":
			...
			link.l1 = "I am perfectly fine, thank you. You didn't listen. Two to one stakes are not quite spectaculous, that's right, so let's even the odds! Not all valuables can be measured in gold, don't you agree? Or perhaps you just prefer not to fight the wind, if anything goes not according to your plan so you change your course? Pity then, it seems I was wrong about you. Madam Botot, I believe your salon just got another rich story about differences between saying and doing...";
			link.l1.go = "Angerran_16_2";
		break;
		
		case "Angerran_16_2":
			dialog.text = "Don't try to get under my skin, monsieur de Maure, you are well too naive for that.";
			link.l1 = "Indeed. The lack of will is not a sin... unless you are a military man of course. Or a nobleman, family honor, as you might know, is such a burden sometimes. Not likely are you familiar with such dilemmas at all though.";
		...
		case "Angerran_16_4":
			dialog.text = "So be it. This night should end properly. Two great ships against the old tub filled with silver and the best woman of New France! Breathe deeper, monsieur de Maure, this stake will become a legend among high society's gossips.";
		...
		case "Angerran_19":
			if (CheckAttribute(pchar, "questTemp.GoldenGirl.Game.Win"))
			{
				...
				link.l1 = "Yeah right, Europe hadn't known such defeat since the Battle of Rocroi, monsieur de Chievous. An artist who lives somewhere inside me is trembling of desire to picture such a historical moment. It is a shame I don't draw anymore like I did in my youth. But perhaps madam Julianne must have a talented artist around am I right?";
		...
		case "Angerran_22":
			dialog.text = "Fortune doesn't, but you, monsieur de Maure you do! It appears to me that behind your impudence there was a plan behind it not just passion. You are a liar and a cheat - I am ready to confirm this before all the guests.";
			link.l1 = "...";
		...
		case "Angerran_25":
			...
			link.l1 = "Both. To be honest, I am glad you've changed your mind. Remember, I suggested we take a walk past the gates? What did you say about my unworthy class? Perhaps the game of cards gifted you with some courage after all?";
		...
		case "Angerran_27":
			dialog.text = "Too great of honor but I concur with marquise. I will end you like a nobleman, de Maure, even though you don't deserve this. I challenge you to a duel tomorrow midday, through His Excellency the governor. Come see him by yourself or send your seconds to discuss terms. See you. Madam, my respects.";
			link.l1 = "...";
		...
		case "Angerran_31":
			...
			link.l1 = "Your wound doesn't look good, but you should show yourself to a doctor nevertheless. Clearly, you can't go on like this, you will die if you do. It looks like we are done here. I won, and I didn't cheat. I will return your ship to you and you will leave St. Pierre. We will never see each other again.";
			link.l1.go = "Angerran_32";
		break;
		
		case "Angerran_32":
			dialog.text = "What an enormous chivalry! Look, monsieur de Maure, you may be a natural swordsman but you most definitely cheated at cards. I messed with the deck trice. Trice dammit! No miracle in the world could possibly save you, but you won anyway! I wish I knew how did you do it... Whatever, soon you will tell the Devil all about it. Hit them lads!";
			link.l1 = "You bastard! I showed you mercy and this is how you repay me?! Monsieurs, to arms!";
		...
		case "Angerran_34":
			dialog.text = "I admit, Monseniour de Maure, I am a bit surprised seeing you here. That means I wasn't wrong about you and the wild lass means something to you?";
		...
		case "Angerran_37":
			dialog.text = "But good old Francois loves these carpets, Charles. Everybody loves something. Since you are here you must love your little girlfriend in arms. I am ready to return her to you in return for my property. You messed up game and even though I don't usually forgive such transgressions, I can make an exception for you. You will give me the prize I so desire and I will give you the same. Then we will beautifully part our ways. So much for love.";
		...
		case "Angerran_39":
			...
			link.l1 = "Lay a hand on her, you scum, and I will strangle you with my bare hands, I swear to God! Do not fucking test me!";
			link.l1.go = "Angerran_40";
		break;
		
		case "Angerran_40":
			dialog.text = "Calm down. Everything what is about to happen is completely on you. I don't like violence, I use it only when I have to. Don't make me. Just hand me over my prize on Cape Scott Head at Dominica in less than two weeks and you will get what is yours. I don't care how will you do it. If you want to steal - steal, you are a pirate after all, only well dressed.";
			link.l1 = "You are bloody delusional, there is a big difference between a Pirate and a damn slave trader...";
			link.l1.go = "Angerran_41";
		break;
		
		case "Angerran_41":
			dialog.text = "Breathe deeper, we are about to fashionably parade in front of old Francois. We are friends now, remember? Smile Charles, come on! Let's part our ways. Cape Scott Head, Dominica, two weeks. Don't be late.";
		...
		case "Cortny_4":
			dialog.text = "I don't give a slightest damn about shady little dealings of yours, sir. I did some digging about you and, to be honest, I made you my first suspect when I heard that you visited Martinique right after the Regina had disappeared. However, you are not an idiot and your men didn't toy around with pearls here. Therefore, you are out of my suspicion, for now.";
		...
		case "Cortny_5":
			...
			link.l1 = "I guess, yet I always thought it's just another seafarer's bullshit story. Same as stories about The Flying Dutchman. Julianne, what's wrong?";
			link.l1.go = "Cortny_6";
		break;
		...
		case "Cortny_10":
			dialog.text = "That is a game breaker, sir. And it is bad. Madam, did you find the necklace? Let me inspect it\nYes indeed, this is one of the Spanish black pearls. Take a look, this seafarer's bullshit is pretty much real. All that is left is to find out how that de Chievous got one of these. By the way, isn't he a bastard of Duke de Levy Vantadur?";
			link.l1 = "That's him alright. As far as we know he had dealings with the local pirate baron at Le Francois. Perhaps he bought this pearl from him?";
			link.l1.go = "Cortny_11";
		break;
		
		case "Cortny_11":
			dialog.text = "Maybe so. But I don't like the Spanish trail in this at all. Anyhow, thank you for your cooperation. I am afraid I must visit you again tomorrow at the same time of the day. I would ask for captain de Maure's presence as well. Perhaps I will have more questions for you. I should go to Le Francois now.";
			link.l1 = "Monseniour Cortney, wait. Perhaps I could join you? Jacques Barbazon has earned his nickname not for being a loving and gentle person, plus this matter has some interest for me too.";
		...
		case "Cortny_21":
			...
			link.l1 = "Breathe. Barbazon will weasel his arse out of any accusations. He will tell you it was just an ordinary raid of petty burglars on a wealthy household. Besides, he is a damn pirate, why would he care about authorities! Nevertheless, now I am sure that you managed to learn something truly viable. I ask you to share this knowledge with me.";
			link.l1.go = "Cortny_22";
		break;
		
		case "Cortny_22":
			dialog.text = "I can't really say no, can I? Otherwise the next attempt might be a success? Fine, I will pretend I didn't notice a sign of threat in your tone. Let's say I am returning you a favor. Jacques The Kind didn't sell pearls to your noble bastard. He was buying. That's it.";
		...
		case "Cortny_24":
			dialog.text = "One would hardly call the Regina a regular prize of a pirate, Captain. We assume she had at least half a dozen of black pearls. Even a single black pearl is priceless. I absolutely have to meet that sir de Chievous at all cost.";
		...
		case "Cortny_33":
			...
			link.l1 = "Thanks, Baronet. See you on my ship, we will set sail soon.";
		...
		case "Cortny_40":
			dialog.text = "You and I, we overlooked the main thing. How did he learn about the pearls? Who invited that Spanish captain to this very house? Who could move the bastard to pursue such prize?";
		...
		case "Cortny_43":
			...
			link.l1 = "You are right, I am. Farewell and Godspeed in your searches, Baronet!";
		...
		case "Cortny_48":
			...
			link.l1 = "I have nothing to do with this spy story! Neither do the Spanish. Your network is safe, don't you worry. However, you had a leak and someone used it. And then, I got myself into an argument with this someone. I found evidences of his involvement in the Mercury business and I wanted to use them to beat him.";
			link.l1.go = "Cortny_48_1";
		break;
		
		case "Cortny_48_1":
			dialog.text = "";
			link.l1 = "God be witness, I thought of this case as an ordinary action of piracy, I couldn't even think that Crown's intelligence has something to do with it! All I have is this pearl, yet I know very well when and where you can find more.";
			link.l1.go = "Cortny_49";
		break;
		
		case "Cortny_49":
			dialog.text = "Ever heard of John Thurloe? He is the head of Crown intelligence. One day I will be in London, reporting to him, personally, about the fate of the Mercury. Therefore, give me a name of that miserable adversary of yours.";
			link.l1 = "Angerran de Chievous, Count de Levy Vantadur bastard. I suppose that he considered the Mercury to be only a transporter of capers' plunder. He might had known about pearls, yet had no idea about British intelligence's connection.";
		...
		case "Cortny_51":
			dialog.text = "More than one, you can count on that. We would never put the Regina at risk for a batch of common pearls. I hope you realize that I absolutely must talk with Monseniour de Chievous. I don't give a damn about pearls, but I must find out more about the leak. My superiors will bury me if I won't deliver a full picture to them.";
		...
		case "Cortny_52":
			dialog.text = "These are very serious accusations of very serious people, Captain. Do you realize what kind of... shitstorm might backfire afterwards? A brigand attack of a vessel flying a flag of an ally? This can seriously complicate relations between two great nations. I find it hard to imagine how deep did he manage to get under your skin to make you eager to risk that much.";
			link.l1 = "He took something from me, milord. Something I value the most. More than my life. I must fix that. If it leads to war, then I will be serving my country under its flag. Nevertheless, de Chievous will get what he deserves and he is the only one that's to be blamed!";
			link.l1.go = "Cortny_53";
		break;
		
		case "Cortny_53":
			dialog.text = "Did anyone ever tell you that you are a man of great danger, Captain? Ready to start a war on a half of the globe in order to achieve your goal? Very well, let's do it your way. I will go to Basse-Terre with you. I cannot let go of such trace. I will send a scribe to write down your evidence while I am preparing my vessel.";
			link.l1 = "Thank you, sir. But we don't have time to spare here, I warn you!";
			link.l1.go = "Cortny_54";
		break;
		
		case "Cortny_54":
			dialog.text = "Captain de Maure, we will make it in time, I have no doubt in you. However, if this adventure won't work out... you understand me? I can't promise you even a proper grave.	";
		...
		case "Cortny_56":
			dialog.text = "The die is cast, Captain. I demanded a meeting with Angerran de Chievous. His frigate will be searched immediately upon her arrival. Francois de Lyon has his doubts, but seals on my papers hold him back for now. I ask you to stay in town until the situation is settled.";
		...
		case "Cortny_58":
			dialog.text = "Dead serious. You still remain one of my major suspects and letting you go in these circumstances would be most very stupid of me. I will apologize to you in any way I will find fit, when and if your words prove true.";
			link.l1 = "";
		...
		case "moreno_5":
			...
			link.l1 = "The Portuguese's quartermaster? The Bloody Don, right? This night is just getting better and better. Let's do it!";
			link.l1.go = "moreno_6";
		break;
		...
		case "moreno_9":
			...
			link.l1 = "Monseniour Moreno, are you having some troubles with the local officials? It is nice to see you too by the way ha-ha!";
		...
		case "moreno_12":
			dialog.text = "Madam, you are charming! This new friend of yours once already tried to turn me in. Actually, it didn't turn very well, and in fact he saved my sorry ass so many times that I have lost the count. Anyway now I owe him one, so there is no need for threats, don't you worry.";
		...
		case "moreno_18":
			...
			link.l1 = "Think de Chievous bought stolen pearls from Jacques the Kind and his boys? I am afraid this... is not enough.";
		...
		case "moreno_21":
			dialog.text = "And that is where he got wrong! The brits had already started an official investigation of the Mercury's disappearance, although they call her a missing courier ship with some important documentation onboard. Any leads will be generously rewarded, any responsible will be severely punished. The best part is that they have sent a special noble official to Antigua who is now tirelessly digging through the case. I don't recall his name, fancy as his smug face, but I am glad that he is not hunting me!";
		...
		case "moreno_31":
			...
			link.l1 = "I will handle it. We don't have much time, so let's split. You and the marquise will go to Dominica while I will rush to St. Jones. I will find Colonel D'Oyley or that British investigator and will tell him who is responsible for the Mercury's disappearance.";
		...
		case "secundant": // fix 22-03-20
			...
			link.l1 = "Good evening, gentlemen. I hope everything will go smoothly and no one is going to die tonight. But be ready for anything anyway. This 'gentleman' can be a disappointment.";
		...
		case "sailor_4":
			dialog.text = "Will you give the orders to the boys to get ready, Cap? We can set sail in two hours time, everybody's being on edge whole morning, your second in command especially, we barely managed to stop him from sailing after them.";
		...
		case "Cap_Nayad":
			dialog.text = "Monseniour, we almost lost hope of having you here. I can see marquise Botot in your longboat. I am not even going to ask how it happened. Your companion is waiting for you. She is safe and sound, take her and get the hell out of here.";
			link.l1 = "If you layed a finger on her, I will tear your old tub to pieces!";
		...
		case "baster_officer":
			dialog.text = "I don't like this either, Monseniour. Alas, this insolent brit has such an authority that even Monseniour de Lyon can't do much about it. I apologize, Captain, hand over your sword please.";
		...
		case "statist_2_1":
			dialog.text = "Oh, captain de Maure! Would you like some more wine... hick? Take a look at what we has just been served - Syrah of 1643 year made, just from the northern hills of the Rhone Valley. This is, damn it, a real pearl! And the year was excellent in every way, I tell you ... one defeat of the Spaniards at Cape Gat is worth it! By the way ... why does everyone fuss like that, do you know? Does anyone feel bad? Well - whatever, cheers...";
		...
		case "statist_3_1":
			...
			link.l1 = "I don't remember that I promised anything. I'm sorry, but I have to go.";
			link.l1.go = "statist_3a";
		break;
		...
		case "statist_4":
			...
			link.l1 = "An interesting comparison, monsieur. Well, I'm leaving you to enjoy the night....";
		...
		case "statist_5":
			dialog.text = "Well, at least one nice meeting! We have already met, captain de Maure, but you hardly remember. "+GetFullName(npchar)+" - I was the captain of the sixth infantry company of the garrison, fought with you on our streets with the Spaniards. True, I got a bullet to my knee and most of the battle I was admiring how this same brothel was burning, while I was lying in a ditch. Now here - again a civil, and again I admire it, but now from the inside.";
			link.l1 = "Glad to meet you, monsieur. That day was really hot, but admittedly, since that day, this place became significantly more beautiful!";
			link.l1.go = "statist_5a";
		break;
		
		case "statist_5_1":
			dialog.text = "And how do you like the atmosphere here, captain? It seems that these secular wallies decided to make a goddamn mess! Interestingly, can the governor's chair be played like a bet in cards? Remember my word - it will end with steel. It's a pity, with my knee, such entertainments are no longer for me. However, somewhere I saw Jacqueline - her gentleman is seriously passionate about what is happening... I guess I'll go and try my luck, while everything is still calm here.";
