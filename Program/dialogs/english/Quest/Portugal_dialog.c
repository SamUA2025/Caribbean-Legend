void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Avendel_tavern":
			...
			link.l1 = "I will ask you about different matter, it is about your debt which you owe to the mistress of the local... umm, establishment. She has asked me to remind you about your debt, I suggest you doing something about it, otherwise she will have to address the guards to do the same tomorrow.";
			link.l1.go = "Avendel_tavern_1";
			DelLandQuestMark(npchar);
		break;
		
		case "Avendel_tavern_1":
			dialog.text = "Local est... oh, fuck! Johanna, she can't do that to me! Are you sure? Has she really said that she would send me to the casemates for a few god damned coins?";
		...
		case "Avendel_tavern_2":
			dialog.text = "Wait! Please, wait! You look like an experienced captain. Surely, you've got some coins, I am broke, only good old bartender fills my cup on credit for our old friendship's sake. Listen to my pro... proposal! You pay my debt and I will cut you a slice\nThere is a business... a very profitable business, screw me and my ass! I swear to my bloody anchor, just trust me, captain - whatever your name is!\nJust redeem one small debt, ten thousand pesos and you'll have a chance to make enough coins to buy all brothels of the New-bloody-World! What do you say? You give me, I give you, like honest folk do...";
			...
			link.l2 = "A slice? And why should I trust the word of drunken idiot? Because of imaginary promises?";
		...
		case "Avendel_tavern_4":
			dialog.text = "Listen to me, captain! Hic, shoot me dead if I am lying! But I am telling the truth! Think about that, if you catch me on lying, then you will cut off my guts with that beauty you are carrying on your belt! Damn, her hilt costs five times more than my miserable debt! So what say you? You have got nothing to lose!";
			link.l1 = "I have had enough of your speeches. Farewell.";
			link.l1.go = "Avendel_tavern_3";
			link.l2 = "Fine, Hugo... I will risk believing in that nonsense you speak. But remember that you will have to persuade me and make sure that my money wasn't wasted for nothing when I am back, otherwise it's your ass on the line.";
		...
		case "Avendel_repeat":
			dialog.text = "Captain, come back as fast as you can - this business might run away.";
		...
		case "Avendel_tavern_7":
			...
			link.l1 = "I've dealt with it, now it is your turn, Hugo. Tell me your story and try to make it just slightly believable!";
			link.l1.go = "Avendel_tavern_8";
			DelLandQuestMark(npchar);
		break;
		
		case "Avendel_tavern_8":
			dialog.text = "Don't worry, captain! Did you know that I am a bounty hunter? Or... I used to be. I wasn't lucky enough I guess. Perhaps, the Devil himself with all of his deeds wasn't such a loser as I was. I have lost everything on my last job... The crew ran away and I had to sell my ship because of the debts...";
		...
		case "Avendel_tavern_10":
			dialog.text = "He is taking a God damn main part in it! I have been tracking him down for the last year and a half. The Dutch Company had put a great price for his head. But I have failed, and I lost everything. And the Company has tripled the price recently for him alive and alive only damn him!";
		...
		case "Avendel_tavern_12":
			dialog.text = "Wait, captain! Please! Listen to me, I have seen few guys near the doctor's home and I have recognized them. They are from the 'Albatross', a frigate of the damn Portuguese! And one of them was talking about their captain's health! See now, " + pchar.name + ", Bartolomeo is here, in this city! Right under our noses, he is either wounded or ill, that is why they need a blasted physician!\nI doubt that the Portuguese has brought his whole crew here, but I can't start this mess alone! Surely, you damn know how to handle your cursed sword! Take a few tough guys with you and we will find the rat! Then we capture him and deliver him to the authorities!\nAnd two thousand good gold doubloons are in our pockets!";
			link.l1 = "No, Hugo, I've had enough of your talk. I won't take part in this mess, even if you are right. Farewell.";
			link.l1.go = "Avendel_tavern_3";
			link.l2 = "Hmm, interesting. Do you know where is he hiding? If it works out we can discuss shares, but if what you are telling me is the truth then we must hurry now!";
			link.l2.go = "Avendel_tavern_13";
		break;
		
		case "Avendel_tavern_13":
			dialog.text = "No I do not know where he is, captain. I was too scared to track down these lads. If the One-eyed would have seen me...fuh! But together, plus your lads, we will be able to comb this enitre town, call your men and let's get started! Damn, the Dutch doubloons are waiting for us! Such a God damn chance happens only once in a lifetime, bite me a herring!";
			link.l1 = "A commendable enthusiasm... I hope that you are able to get away from the table, a 'great' bounty hunter. I am going to search immediately and you can follow me if you want, just don't bother me too much.";
		...
		case "Avendel_tavern_repeat":
			...
			link.l1 = "Where?!... I am going, with or without you.";
			link.l1.go = "exit";
		...
		case "Bart_lay":
			...
			link.l1 = "Hmm, he is lucky to be alive...";
			link.l1.go = "exit";
		...
		case "Portugal_doctor_1":
			dialog.text = "He is my patient and he is even unable to stand! Can't you see that? Please, put your blade down! I beg of you!";
		...
		case "Avendel_house":
			dialog.text = "We did it, captain! We have found him and we will soon be rich, just as I told you! What is our plan?";
		...
		case "Avendel_house_1":
			dialog.text = "No-no, No captain! Don't go to this damned Thomas! Trust me, this scoundrel will take away our prisoner and if we are lucky he will treat us with a cup of coffee! His Excellency is a fishy type, so if you want to get a full reward you have to sail to Curacao! Otherwise the Portuguese will be taken from us to the fort and they will drive us away like beggars!";
			link.l1 = "Well, if you are really sure of that...";
			link.l1.go = "Avendel_house_2";
		break;
		
		case "Avendel_house_2":
			dialog.text = "I am, captain, damn sure I am! But remember that Bartolomeo's men must be somewhere in the town and we don't want to attract garrison's attention either, that is for damn sure! We have to decide how to get the Portuguese to your ship and how to do it in an unnoticeable way.";
		...
		case "Avendel_house_3":
			dialog.text = "Yes, I have got one. We need to find a more noble suit for him first, then we drag him through the rear entrance as a drunken officer! No one will suspect that it's a damn pirate, trust me!";
			link.l1 = "Hmm, I am not sure about this, but we don't have a better plan yet anyway. I will try to get some pretty cloth for our passenger. You stay here and watch over Bart and doc.";
		...
		case "Portugal_doctor_4":
			dialog.text = "I don't see the soldiers, "+GetAddress_Form(NPChar)+". Where are they? You said that he would be arrested as soon as you told them about the situation. So why are the soldiers not here?";
		...
		case "Portugal_doctor_5":
			dialog.text = "Captain, listen, I can't handle his wound, all I can do is just lowering the fever a bit. He is mostly unconscious and delirious, there is no doubt that he will die even without any interference and the sea rolling will kill him in a few days. I will give you some mixtures that will help...";
		...
		case "Portugal_doctor_6":
			dialog.text = "...Yes, I suppose that you are right. But know that this pirate is very resilient, I have seen people with only small scratches made by Indian weapons and all of them died in less than three days. And according to his 'friends', he has been in this state for a week already! Nevertheless, I affirm that he will survive for a short period of time on a ship in the open sea. Three days, no longer!\nThat's all the time we have.";
			link.l1 = "Even the bird won't reach Curacao in three days. But I think I know what I can do! There is this... friend of mine, he lives in St. John's, Antigua. He knows how to heal people from fatal wounds. He is the only person who can help us now. Our goal is simple - to get there before the Portuguese dies. Pack up your things, doc, we set sail immediately and your patient will be transferred next!";
		...
		case "Avendel_goodbye":
			dialog.text = "What a pity, captain. We have lost, and we won't see that damn gold. Farewell.";
		...
		case "Portugal_doctor_9":
			dialog.text = "...";
			link.l1 = "Doc, prepare your patient for landing. The longboat is ready. Hurry up!";
		...
		case "Avendel_Room":
			...
			link.l1 = "Hugo, spare me from you jokes. I have left few men on the streets to watch over the house, but one more guard won't be unnecessary to our guest. Keep an eye on him and try to stop the swearing, or Gino will make you drink some mixture of his, I am sure that he can cure that.";
		...
		case "Avendel_Room_1":
			...
			link.l1 = "See, you can be nice when you want. Be on the alert, I have to go.";
			link.l1.go = "exit";
			chrDisableReloadToLocation = false;
		break;
		
		case "Avendel_Room_2":
			dialog.text = "Leaving already, captain? Nice! It is time! I saw few fuc... suspicious lads, on a street. They don't look like the Portuguese men, though they were searching for something, we have to be careful, captain!";
		...
		case "Portugal_hunter":
			dialog.text = "Captain, we have been waiting for this meeting for far too long! And who is that with you? Bartolomeo the Portuguese himself, ha, it seems that the Bold Pierre was right - it is him! Stay away, captain, we are going to take him with us and no one will get hurt.";
			link.l1 = "I'm sorry sir, but who the fuck are you? Get out of my way or none of you will see tomorrow!";
			link.l1.go = "Portugal_hunter_1";
		break;
		
		case "Portugal_hunter_1":
			dialog.text = "Oh, such a menacing fellow, just look at him lads! Ha-ha-ha! Listen here, pup, don't stay between Leo Cord and his money! We have been tracking down the Portuguese for almost half of year and now we have finally got him. So put down that toothpick of yours and get lost while you are still breathing! We are not that greedy, dead man will do just fine, ha-ha!";
		...
		case "Avendel_street":
			...
			if (LAi_GetCharacterHP(sld) > 0)
			{
				...
				link.l1 = "Good point, Hugo, and I am very glad that no bullet was shot at the hole where you were hiding.";
		...
		case "Avendel_street_1":
			dialog.text = "I... I was securing our rear, captain! You were doing just fine without me, but what if someone would have attacked us from other side of the street? You wouldn't have the time to run to the ship.";
		...
		case "Portugal_doctor_12":
			...
			link.l1 = "That is why we are here, mynheer van Stal, our trip is almost over. I will rent a room in the tavern and our prisoner will stay there for few days.";
		...
		case "Portugal_doctor_14":
			dialog.text = "Mynheer captain, I will be looking after the Portuguese, he needs the full rest.";
			link.l1 = "I got it, doc, it is alright. Damn it, for how long should I take care of this pirate? That is bad for him, that is not what he needs! It seems that I was hired as a babysitter and... agh, pardon me, doctor, it is just too much... I will see you later.";
		...
		case "Portugal_patrol":
			dialog.text = "Monsieur, are you captain "+GetFullName(pchar)+", whose ship has just arrived in our harbour today?";
		...
		case "Avendel_seapatrol_1":
			dialog.text = "To go to the ship? Why? Will you lend me few of your men to help me out? What if something happens while you are away?";
			link.l1 = "I am sorry, but no. I doubt that anything can threaten you here. The garrison is alerted and there are more soldiers on the streets than usually, so if something goes wrong call them. They have seen a big ship not far from this island, a pirate one, perhaps. And his Excellency the governor has asked me to fortify the island by patrolling with my ship.";
			link.l1.go = "Avendel_seapatrol_2";
		break;
		
		case "Avendel_seapatrol_2":
			dialog.text = "A ship? Pirate one? It could be the Albatross! Or some colleague of our old friend Leo Cord!";
			link.l1 = "Or perhaps it is just an ordinary pirate ship. Nevertheless, Hugo, if this vessel is here for our heads then I'd better face her with the local patrol by my side and for the governor's gold. It is much better than watching over our rear for the rest of the trip. If this alarm is false however, then it will simply spare me from sitting my ass in the tavern for few days.";
		...
		case "Avendel_seapatrol_3":
			...
			link.l1 = "Enough talking, Hugo Avendell! I am the captain here and the final decision is mine! So do as I command you. Go to the tavern and keep an eye on the doctor and the Portuguese until I'm be back.";
		...
		case "Avendel_seapatrol_5":
			dialog.text = "You are back, captain, at last! I am afraid that I have got bad news for you - the Portuguese is gone and so is the doc!";
		...
		case "Avendel_seapatrol_7":
			dialog.text = "I told you that I saw nothing. I ran away through the kitchen as soon as I saw Franz Garcke and his men... It was too close! It happened yesterday evening and I didn't know how to let you know...";
		...
		case "Avendel_seapatrol_9":
			...
			link.l1 = "Relax, Hugo. I am sure that Bartholomeo is still on the island, he might have gotten better, but he is still too weak. And I think I know where to find him! We will get them, I won't step away from my reward. If you are no coward then follow me, it is not over yet.";
		...
		case "FranzGarke":
			dialog.text = "... you, miserable crab's shit, you will tell us everything, you can trust me on that, you fucking rat! Then you will be hanged on a yardarm instead of a topsail... And who the hell are you? Damn those apes can't be trusted! Always have to do everything myself...";
		...
		case "Portugal_LFTalk_1":
			...
			link.l2 = "Don't even think that I will give you a weapon so that you can hit me once I turn my back to you! Just stay close to me.";
		...
		case "Portugal_LFTalk_2":
			...
			link.l1 = "Well, thing is, I don't want you dead, yet. Let's go, time is running out!";
		...
		case "Vaskezs_pirate":
			...
			link.l1 = "Here we go again... Come then you mongrels!";
		...
		case "Avendel_LeFransua_1":
			...
			link.l1 = "Well, that's it Hugo Avendell, your cowardice has surpassed all my expectations, have you got any idea how tough that fight was for us? We barely made it!";
		...
		case "Avendel_LeFransua_2":
			...
			link.l1 = "That's just glorious! Are you bargaining now? No, my friend, your part in this business is over! You have lost your money in the tavern of Saint-Pierre. You have left it there and ran away, so it is over for you now.";
		...
		case "Avendel_LeFransua_3":
			...
			link.l1 = "Do not test my patience! Get lost! I don't need cowards in my crew, especially now when the clock is ticking!";
		...
		case "Portugal_treasure":
			...
			{
				dialog.text = "And here you are, my brave friend, we can have a decent talk at last! Congratulations, captain - killing the One-eyed Dog and destroying the 'Albatross' wasn't an easy job! Actually, you have done so much for saving my life... Perhaps, I should even thank you?";
			...
			{
				dialog.text = "And here you are my brave friend, we can have a talk at last! Congratulations, captain - killing the One-eyed Dog is worth of an honourable song! Actually, you have done so much for saving my life... Perhaps, I should even thank you?";
				link.l1 = "You will thank me when you are dancing on the gallows or whatever they have prepared for you in Willemstad.";
		...
		case "Portugal_treasure_4":
			dialog.text = "Really? I would like that, captain! Won't you order to bring here some rum? You know, just to celebrate your knightly qualities, our relationship and the deferment of my sentence?";
		...
		case "Portugal_treasure_6":
			dialog.text = "I see... so it is the gallows then. That was expected. Then listen what I will tell you, captain. You were so eager to keep me alive in order to execute me properly later and I appreciate that. I suppose that it will be stupid of me to ask you to change your mind just like that, right? And what will you say if I offer you something in exchange? A deal so to speak, huh?";
		...
		case "Portugal_treasure_10":
			dialog.text = "These dogs were not people, trust me, they are all now in their deserved place - the hell, ha-ha! As a payment for my freedom and my life, I can tell the exact location of the Dutch treasures.";
			link.l1 = "No, Bart, your betrayal has totally convinced me of your meanness. Willemstad and a lawful retribution are waiting for you. No deal.";
			link.l1.go = "Portugal_treasure_2_1";
			link.l2 = "And am I supposed to believe that those gems do exist? Whatever, I won't lose a thing anyway... The deal was the start of this story and the deal will be it's end. I accept your terms, Portuguese.";
		...
		case "Portugal_treasure_12":
			...
			link.l1 = "Thanks for your warning, Portuguese. Now would you kindly leave my ship already... don't test my patience.";
		...
		case "Avendel_Marigo":
			...
			link.l1 = "You know, I am actually happy to see you again. But perhaps I was too rough with you on Martinique.";
			link.l1.go = "Avendel_Marigo_1";
		break;
		
		case "Avendel_Marigo_1":
			dialog.text = "Whatever, captain! What happened, happened... But truth to be told, I had really given you a reason to send me away... But hey, you won't believe who is a guest in Phillipsburg today!";
			link.l1 = "Don't tell me that it is...";
			link.l1.go = "Avendel_Marigo_2";
		break;
		
		case "Avendel_Marigo_2":
			dialog.text = "No-no, captain, it is not the Portuguese. And it is not some wounded bastard again. It is much better! It is Hernando Vasquez... The Bloody Don himself! He is being a guest of the local governor for a few last days.";
		...
		case "Avendel_Marigo_3":
			...
			link.l3 = "I have got a better proposal for you. How about you join my crew? I take it that you have a talent for making and finding profitable deals, so if you are fed up of pretending to be a brave fighter - you are more than welcome to take a position of my purser.";
		...
		case "Avendel_Marigo_4_1":
			...
			{
			link.l1 = "Ah hell with you, take them!";
		...
		case "Avendel_Marigo_4_2":
			...
			dialog.text = "Now that's the prize for me! ... Listen, Vasquez was sailing with me on the same ship, yet while I was cleaning the decks as a payment for the trip, he was resting in a cabin so thank God we rarely saw each other and he didn't recognize me. But I have started to follow this devil immediately... An interesting story has happened with him.";
			link.l1 = "Go on! What is he doing in the governor's palace?";
			link.l1.go = "Avendel_Marigo_5";
		break;
		
		case "Avendel_Marigo_5":
			dialog.text = "I don't know much, but the garrison has been alerted for a few days after his arrival and the huge warship had suddenly up-anchored and gone in a great hurry, it sailed North-West I believe. The whole town was lost in guesses and gossips...";
			link.l1 = "So that was the ship I met! Intriguing... Don't digress from the topic, Hugo, continue your story, please.";
			link.l1.go = "Avendel_Marigo_6";
		break;
		
		case "Avendel_Marigo_6":
			dialog.text = "Well, as I said, the ship was gone and Vasquez had become some sort of a guest of our governor Martin Thomas. I see him sometimes in the town, he is always in a company of few soldiers. I don't know if it is his escort or convoy, ha-ha. But only people in residence could to tell you more regarding the Don.";
		...
		case "Avendel_Marigo_4_3":
			...
			if (sti(pchar.money) >= 10000)
			{
			link.l1 = "Forget about that, I have not been myself and I am sorry, greed consumed me I guess. Here, take 10000 pesos and tell me what you know about Vasquez, I am in a hurry.";
			link.l1.go = "Avendel_Marigo_4_2";
			}
		...
		case "Avendel_Marigo_7":
			...
			dialog.text = "What can I say... I will agree, but only after I get my share, captain. Ten percent, remember? You have received two thousand for that scoundrel, so if you are asking me to join your crew you'd better start by wiping away your debts. Ten percent and no arguing!";
		...
		case "Servant":
			...
			link.l1 = "No-no, I am just waiting, when will mynheer Thomas be free? I am waiting for an audience... yes. Tell me, does his Excellency really consider a famous pirate Hernando Vasquez his friend?";
		...
		case "Servant_1":
			...
			link.l1 = "A nightmare it is! What could that beast tell to mynheer Thomas in order to avoid the gallows? I can't even imagine!";
		...
		case "Servant_3":
			dialog.text = "Not quite so. Yet. A few days ago he was taken to a military brig which sailed to Willemstad. See, mynheer Thomas had lost an interest in the scoundrel, it seems that he tried to fool him\nAlso, they say that his ex captain was caught - Bartolomeo the Portuguese! Just think about it! Looks like the Company wants to hang them together. Birds say that the trial will be in a month, but why wait that long?";
			link.l1 = "The Portuguese?! Hm... thanks for keeping me company friend... it seems that mynheer Thomas is free now, I shall take my leave.";
		...
		case "Portugal_free":
			...
			{
				dialog.text = "Now this is whom I didn't expected to see, captain! But it doesn't look like a friendly visit, all of this blood, noise, and a gunfight, or is it some kind of a celebration with fireworks eh?";
				link.l1 = "Stop cracking your wicked jokes, Portuguese. I just don't like how you have used your freedom which you bought from me. I have put too much effort on saving you pathetic arse to let you be so stupidly caught right after our parting!";
		...
		case "Portugal_free_1a":
			...
			dialog.text = "So the nobleness is sometimes not affected by coins, huh? Hah... WATCH OUT, RIGHT BEHIND YOU!";
			link.l1 = "Agh, not this shit again!";
			link.l1.go = "exit";
		...
		case "Portugal_free_3":
			dialog.text = "I saw that he had a lock pick, it seems that someone had given it to him... he always had connections in the lower strata. Well, captain, I believe that we should leave this place, don't you agree?";
			link.l1 = "You don't say so! Fine, let's hurry up before the whole garrison has arrived here. I will break your lock in a second...";
		...
		case "Portugal_free_5":
			dialog.text = "You know, captain, this fresh air... you start to value it only after spending a few weeks in a dungeon right after your ships' boat was found by the local patrol. I suppose, that I still owe you for my rescue.";
			link.l1 = "No need, Portuguese. I am not an honourable knight, I just... I do what I think is right and needs to be done.";
			link.l1.go = "Portugal_free_6";
		break;
		
		case "Portugal_free_6":
			dialog.text = "Ha, and that is a perfect quality! But I insist, here, take it... this is the only thing I was able to hide in the prison... Yeah, you got it right. This is my talisman. It always gave me luck in the sea. You are a fine sailor and you or your navigator will be able to use it, I am sure of it.";
		...
		case "Portugal_free_7":
			dialog.text = "Hey! I am still alive, aren't I? And just so you know, I am not in prison any longer. Take it, captain, it is time for the talisman to serve you. And I thank you again!";
