void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Waitress":
			...
			link.l1 = "Damn, that escalated quickly...";
			link.l1.go = "Waitress_1";
		break;
		case "Waitress_1":
			dialog.text = "Let's not waste our time!";
			link.l1 = "Heh, I couldn't agree more!";
			link.l1.go = "exit";
		...
		case "SeekCap_inDeck":
			...
			link.l1 = "It's nothing, just wanted to hear some news. Got anything for sale?";
...
//--------------------------------------------поисковые квесты дворян---------------------------------------------
		...
		case "SCQ_NM_peace": //вариант С
			...
			link.l1 = "Well... I can try. Tell me the details.";
		...
		case "NM_peaceCap_1":
			...
			link.l1 = "I have. A man named "+GetFullName(sld)+" is looking for you. He wants you to pay him a visit as soon as possible. He lives in "+XI_ConvertString("Colony"+npchar.quest.cribCity+"Voc")+".";
		...
		case "NM_prisonerBoard_1":
			...
			link.l1 = "Stronger men have tried...";
		...
		case "SCQ_NM_result":
			...
			switch (npchar.quest.SeekCap)
			{
				...
				case "NM_peaceover"://сдача квеста, вариант C
					...
					link.l1 = "Did your friend visit you?";
...
//<-- поисковые квесты дворян
		...
		case "PiratesCap_Board_1":
			dialog.text = "Ha! No way, only over my dead body!";
		...
		case "AffairOfHonor_Jackanapes_2":
			dialog.text = "Get out of my way, coward!";
			link.l1 = "...";
			link.l1.go = "exit";
			LAi_CharacterDisableDialog(NPChar);
		break;
		...
		case "AffairOfHonor_BeforeFight_1":
			...
			switch(AffairOfHonor_GetCurQuest())
			{
				...
				case "CowardFencer":
					dialog.text = "Here we are. Prepare your sword, sir!";
					link.l1 = "Gladly, may the better man win!";
					link.l1.go = "AffairOfHonor_BeforeFight_2"
				break;
