...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "cureer":
			dialog.text = "Monsieur de Maure, such a luck! I've been looking for you for months!";
			link.l1 = "My dear, I don't buy fake maps, dubious information and homemade rum - thank you! Or are you a bounty hunter? And how much is it for my head now?";
			link.l1.go = "cureer_1";
		break;
		
		case "cureer_1":
			dialog.text = "Oh, monsieur, I... I don't trade junk and don't kill people - don't touch the sword, you will not need it I mean no harm! Everything is much more prosaic - I'm a captain of a courier ship. I distribute mail. And for you, I've got an important correspondence!";
			link.l1 = "A letter? Who is sender, may I ask?";
			link.l1.go = "cureer_2";
		break;
		
		case "cureer_2":
			dialog.text = "One abbot handed it to me, and asked to deliver to captain de Maure personally, from hand to hand. I already lost all hope for finding you and wanted to leave it at the the harbor office in Saint Pierre, but such a luck - here you are!";
			link.l1 = "Yes, here I am, I'm waiting - give me the letter.";
			link.l1.go = "cureer_3";
		break;
		
		case "cureer_3":
			dialog.text = "There is one problem... The abbot said that the delivery would be paid by the recipient. So you own nine thousand and two hundred pesos.";
		...
		case "spa_officer":
			dialog.text = "Holy Father, you are earlier than usual today. Please, your escort is waiting. And you, senor de Maure - father Vincento found out that you were in the city and urges you to join him for a dinner.";
			link.l1 = "I'm afraid the Inquisitor will have a dinner alone. I hope this won't make his appetite worse. And Abbot Benoit will also deprive him of his company. You know who I am, so I recommend you. let us pass without any conflict and say my best wishes to Father Palotti.";
		...
		case "spa_officer_1":
			...
			{
				dialog.text = "Yes, I heard about you... a lot of interesting things. However, rejecting such invitations is dangerous to health, senor. As well as kidnapping guests of father Vincento. Hold them!";
		...
		case "Svenson_3":
			dialog.text = "I sent Gladys back to Blueveld on a merchant ship - she doesn't approve of all these dashing parties. Joanna couldn't arrive - oh, I had no time to tell you on Martinique! Just imagine - in my old age, I will become a legal father, how about that? Look, if you hurry, our offsprings will be almost the same age, hahaha!";
			link.l1 = "Jan, my congratulations, those are the good news!!! We should drink to it!";
			link.l1.go = "Svenson_4";
		break;
		
		case "Svenson_4":
			dialog.text = "Definitely! But first, to you and your better half! Hey, you there, shut up!!! The old Forest Devil must hold a speech!\nKhe-khe... So, our dear Monsieur and Madame de Maure... Fuck it! I can't speak like this! Charles, Helen - you two, to me, are like my own children, and I know that in this room there is no one who wouldn't be happy for your union! So let us drink, my Brethren, for the happiness of our faithful friends, for the fair wind in their sails and for the love of Lady Fortune, as strong as their feelings for each other!!! Cheers!";
			link.l1 = "Cheers! Thanks Jan... oh, this rum is much stronger than usuall... What did Nathan mix in it?";
			link.l1.go = "Svenson_5";
		break;
		
		case "Svenson_5":
			dialog.text = "I have no idea, but it srikes rightly so. Old Hawk is generally an expert on drinks. Come on, go to the others, I need to make drinks for a good hundred of souls greedy to get their fill.";
			link.l1 = "The Forest Devil pouring drinks - such a view! Thank you for taking the organization of the party on yourself. I will definitely be back, as soon as I get around everyone - maybe, someone needs help.";
		...
		case "Svenson_7":
			...
			link.l1 = "It has changed much earlier, Jan. But everything went surprisingly well. Where is Joahnna and...";
			link.l1.go = "Svenson_8";
		break;
		
		case "Svenson_8":
			dialog.text = "Helen? Girl set sail as soon as she found out what we were up to, and sailed towards the horizon. She conveyed all sorts of warm congratulations to you, but still... you broke her heart, oh you really did that. However, everything will be fine, it's just youth.";
			link.l1 = "Well, the heart wants what it wants, you understand it.";
			link.l1.go = "Svenson_9";
		break;
		
		case "Svenson_9":
			dialog.text = "I do. Well, Joahnna couldn't arrive, just imagine - in my old age, I will become a legal father, how about that? Look, if you hurry, our offsprings will be almost the same age, hahaha!";
			link.l1 = "Jan, my congratulations, those are the good news!!! We should drink to it!";
			link.l1.go = "Svenson_10";
		break;
		
		case "Svenson_10":
			dialog.text = "Definitely! But first, to you and your better half! Hey, you there, shut up!!! The old Forest Devil must hold a speech!\nCharles and Mary, the entire Brethren is raising goblets in your honor now! The happiness of true friends pleases the soul of any sea wolf, almost as much as the splendor of Spanish gold, ha-ha! Sail well, and may the fair winds follow you on your family journey!!! Cheers!";
			link.l1 = "Cheers! Thanks Jan... oh, this rum is much stronger than usuall... What did Nathan mix in it?";
			link.l1.go = "Svenson_11";
		break;
		
		case "Svenson_11":
			dialog.text = "I have no idea, but it srikes rightly so. Old Hawk is generally an expert on drinks. Come on, go to the others, I need to make drinks fow a good hundred of souls greedy to get their fill.";
			link.l1 = "This tavern definitely needs to be renamed - 'The Forest Devil himself was standing here behind the counter'! Thank you, Jan, I will definitely be back, as soon as I get around everyone - maybe, someone needs help.";
			link.l1.go = "Svenson_6";
		break;
		...
		case "Svenson_13":
			dialog.text = "Yes, they are! So, it's time to open what you brought here. And another thing - those guys that helped me at first got way too drunk in the back room. You seem to be still on your feet, bridegroom - can you bring a box of another sherry?";
		...
		case "Svenson_14":
			dialog.text = "The wine was piled in the cellars under shipyard, remember them? Hawk said to keep it in the far corridor, ''to save until the holiday'' - he says. Also he says that there is the perfect temperature and humidity, says it would make a perfect place for a wine cellar. Well, he is a big snob.";
		...
		case "Svenson_15":
			...
			link.l1 = "Alright, go save the meat, I'll bring our wine.";
		...
		case "Svenson_17":
			...
			link.l1 = "No, Jan, we fought together againts some armed cutters in the dungeons. We dealt with them, but they were only scouts - the main squad is right behind us!";
			link.l1.go = "Svenson_18";
		break;
		
		case "Svenson_18":
			dialog.text = "Squad? What are you talking about?! Marcus, come here! Charles, come on, tell us everything.";
			link.l1 = "Like I said: there are some bastards in the dungeons under the shipyard. Well-armed. Nathan and I fought them and miraculously put everyone down. But there are more of them on the way - I heard, one of them was sent for help. And yes, one of them remembered some Jacques.";
		...
		case "Svenson_20":
			dialog.text = "I recognize their faces... this one, and that bastard lying beside the door. They are thugs of Jacques the Kindman. Don't remember their names, but I know it for sure.";
			link.l1 = "So this is Barbazon's fault? Is he out of mind or what?!";
		...
		case "Svenson_21":
			...
			link.l1 = "In this case, I hope that he will appear himself - I've been dreaming so long to make a couple of holes in his body. Bastard, ruined my wedding, just think about it! Let's move, to the streets! We will make a proper welcome for our guests!";
			link.l1.go = "exit";
		...
		case "Svenson_23":
			if (CheckAttribute(pchar, "questTemp.LongHappy.SvensonsShipSink")) dialog.text = "Well, can't say it's over at all - our life goes on! Although I feel myself completely wrecked. I am too old to jump into the sea from a shit covered with fire and swim a whole hour to the shore, looking out for sharks. I hope we still have some rum...";
			else dialog.text = "Well, can't say it's over at all - our life goes on! Damn it, I feel myself ten years younger! It was long time ago since I last time fought like that! I hope your stocks of rum and wine weren't stolen during the mess - we need to drink for it well!";
		...
		case "Svenson_24":
			...
			{
				dialog.text = "It's about your Indian fellow? Yes, I heard, how did it happen?";
				link.l1 = "He jumped to cover my wife and Dannielle from a bullet shot by one bastard. We should go, I'll tell you along the way.";
			}
			else
			{
				dialog.text = "It's about Nathan? Yes, I heard, just didn't get how it happened?";
				link.l1 = "He jumped to cover our wives from a bullet shot by one bastard. We should go, I'll tell you along the way.";
			}
		...
		case "Svenson_26":
			...
			{
				dialog.text = "Stay strong, Charles. I'm really sorry for your boys. Today, many good guys have gone, and for each of them, in hell, Barbazon will get more oil in his boiler.";
				link.l1 = "It makes no sence... damn it! It's hard, Jan... I've already lost friends, but I can't get used to it. I don't if I can go on anymore.";
			...
			else
			{
				...
				else
				{
					...
					dialog.text = "Well, it seems to be over. Today, many good guys have gone, and for each of them, in hell, Barbazon will get more oil in his boiler, but "+sTemp+" will be fine and this is the main thing.";
					link.l1 = "You're right, Jan, and it's a great weight off my mind. How are the other barons? Are they alright?";
		...
		case "Svenson_27":
			dialog.text = "The last filth of Jacques Barbazon. You're right, if we had killed him before everything could have been otherwise.";
		...
		case "Svenson_28":
			dialog.text = "No one can get used to it. Let's dink for our guys? I found a bottle in the table, it miraculously survived this mess.";
		...
		case "Svenson_31":
			...
			dialog.text = "Well, he paid you the debt, what can I say. Saved "+sld.name+" and Dannielle from that bastard. It seems to me - this is a worthy end for such a brave warrior.";
			link.l1 = "It is, Jan. Lets drink to the memory of the fallen... May they find peace. How are the other barons? Are they alright?";
			link.l1.go = "Svenson_32";
		break;
		
		case "Svenson_32":
			dialog.text = "This night has cost us dearly. I don't even know when the Brethren will recover from this massacre. Kindman perfectly chose the time and place to hit. He almost succeeded - just a bit and all would be over. But we lost much less than we could.";
			link.l1 = "";
		...
		case "Svenson_33":
			dialog.text = "The Shark is in the infirmary, his ship got a volley from twenty-four pounds. He flew overboard, broke a couple of ribs, swallowed sea water, but he lives, in few days he will be as good as new.";
			link.l1 = "";
		...
		case "Svenson_34":
			if (CheckAttribute(pchar, "questTemp.LongHappy.Vensan_alive")) dialog.text = "Bernard got just a couple of scratches - he was defending the shore and wiping out the catacombs. Now, he's in the harbor, organizing hospitals for the wounded and funerals for those who were unlucky.";
			else dialog.text = "Bernard was unlucky he was clearing out the houses after the attack from the catacombs and ran into a bunch of these bastards in the storehouses. He caught a bullet, straight in the head. It is a pity, he was a good captain... Tyrex will be furious when he finds out.";
			link.l1 = "";
		...
		case "Svenson_36":
			dialog.text = "About Hawk you know. Dannie won't allow him to leave the island for at least a month, that's for sure. He had one business on our minds... oh, well.";
			link.l1 = "";
		...
		case "Svenson_37":
			if (CheckAttribute(pchar, "questTemp.LongHappy.Terrax.Free"))
			{
				...
				link.l1 = "Iron is softer. I guess, our baron is made from metal that is still unknown to science, haha!";
			}
			else
			{
				pchar.questTemp.LongHappy.Terrax.Lost = "true";
				dialog.text = "Only with Marcus is incomprehensible, his ship was boarded, but the survivors claim that he managed to jump overboard. I already sent the longboats to search the bay. I hope it comes out that our baron is tough enough to not give up so easily.";
				link.l1 = "That's bad, but it's too early to cry over him, Marcus wouldn't give up on us that easily. Let's wait for the result of searches.";
			}
		...
		case "Svenson_38":
			...
			{
				dialog.text = "Marcus swam to shore after his ship was sunk. Well, you know, Tyrex is not one of those who will drown from such a trifle. Now he's somewhere in the town. Probably shaking out the souls of the sentries that overlooked all this filth. Iron man, not otherwise.";
				link.l1 = "Iron would sink. I guess, our baron is made from material that is still unknown to science, haha!";
			}
			else
			{
				dialog.text = "Marcus is fine as always. As soon as he went ashore, he immediately began to shake out the souls of the sentries that overlooked all this filth. He still manages to command the restoration of order in the town. Iron man, not otherwise.";
		...
		case "Svenson_39":
			dialog.text = "That's all. Well, it could have been worse. Even your wedding, Charles, came out... fighting. The important thing is that you are both alive. A small advice, in general... love... and don't you dare give up on fighting for it!";
		...
		case "Svenson_41":
			dialog.text = "Oh yup it sure was, wait a minute. There is something - you seemed to have an Indian guy with you right, always by your side or looking around if someone as if someone is aiming you. Funny dressed, and very noticable in big crowds.";
		...
		case "Svenson_42":
			...
			dialog.text = "Seems like. Our bartender was making noise that his niece had been abducted, only supposedly before the attack. He says they saw her with some kind of an Indian, he carried her on his shoulder along the shore east of the town. I didn't notice among Kindman's scum any Indians, but I remembered about yours when I heard it, so I didn't say anything. You should go, look for him or something, until he gets into some trouble. Cause bartender threatens to kill him if he finds him first. He is a good fellow, but for his niece he will unscrew any head.";
			link.l1 = "Yup I know the kind don't you worry, and thanks Jan, I'll go and search for him right away.";
			link.l1.go = "Svenson_43";
		break;
		
		case "Svenson_43":
			dialog.text = "Well, in general, something like this... Sorry, I am suck with speeches. And now it's even worse - this night has squeezed everyone dry. We all should rest at least a day - then we will decide how to proceed.";
			link.l1 = "You're right, Jan. I should go, I need to freshen up my mind.";
		...
		case "Svenson_45":
			...
			link.l1 = "Yes, we were given a cozy house on the outskirts of the town. I even thought that I dreamed of all the madness that happened yesterday. And here you are Jan, you look horrible. What else happened?";
		...
		case "Svenson_47":
			dialog.text = "Having rest. Don't disturb them, Dannie warned everyone that she has taken guns to bed today... Dodson is in the sea, set out to find more ships to secure the island so this wouldn't happen again, others are burying the departed on north of the island.";
			link.l1 = "";
			link.l1.go = "Svenson_48";
		break;
		
		case "Svenson_48":
			if (CheckAttribute(pchar, "questTemp.LongHappy.Terrax.Prisoner") && !CheckAttribute(pchar, "questTemp.LongHappy.Terrax.Free")) dialog.text = "Marcus hasn't been found yet, but we can handle it, don't worry. You have done so much for all of us, so don't bother yourself. Tyrax will return sooner or later - we will find him.";
		...
		case "Svenson_49":
			dialog.text = "Well, Brethren withstood this blow. Soon, we will rise even stronger than we ever were. Kindman and Jackman have been shaking our unity for too long, now they're gone and my heart feels - we will make the Caribbean flinch more than once. The Golden Age is coming for those to whom laws and kings are not nice, remember my words.";
			link.l1 = "That would be nice. I'm not sure that I will be able to withstand the Old World anymore. I never thought when I came here that I would fall in love with the freedom of the sea, these crazy colors of sunsets and sunrises, that I would find the best woman in the world and... friends to whom I would trust with my life.";
		...
		case "Svenson_51":
			...
			dialog.text = "But first, there's something important left. Charles, while you were sleeping, we got together and we decided\nSince Barbazon is dead, the Brethren needs a new baron. Since there was a clear majority of us here, and the decision was made unanimously, here it is. Congratulations - you are the new Baron of Le Francois. But wait ... I understand - you are a secular person, and you have no time to conduct business in this nice place, so we put a trusted person there, and you do what you want. Just remember - your voice is in the Brethren now.";
			link.l1 = "Jan, I... I am speechless... It's a great honor, I don't even know...";
			link.l1.go = "Svenson_52";
		break;
		
		case "Svenson_52":
			dialog.text = "C'mon! You have proven yourself perfectly back then with Tyrex, and then with all this story with the Sharp's legacy. You are the blessing of God himself. For you nothing will change - do as planned, and in your absence, your man will take charge of all affairs\nThere is one promising guy Jan David, he's one of the Buccaneers. Frenchman an honest fella, with a brilliant mind and he knows how to use it, like you. But it will take some time for me to find him - it seems he was captured by the Spaniards, but this can be solved, don't worry. I will make sure that he will send your part to you as soon as he gets comfortable with business.";
			link.l1 = "I really didn't expect that everything would be like that. Well, since you already decided so then be it. The Pirate Baron Charles de Maure!";
			link.l1.go = "Svenson_53";
		break;
		
		case "Svenson_53":
			dialog.text = "Long live the baron! If anyone deserves the name, it should be you. Wear it with pride, and don't forget - you are one of us now, no matter how beautiful the uniform  you wear, here, right under it beats the heart of a real pirate.";
		...
		case "Svenson_54":
			dialog.text = "What are you going to do now? Go back to Europe, back to your father, to introduce him with your wife?";
			if (CheckAttribute(pchar, "questTemp.LongHappy.Tichingitu_died") || CheckAttribute(pchar, "questTemp.LongHappy.Jino_died"))
			{
				link.l1 = "Yes, but first I must say farewell to someome... You know what I mean.";
		...
		case "Svenson_57":
			...
			link.l1 = "Thanks Jan. See you soon my old friend! Give my best to the Hawks and Shark!... Well, Antigua it is.";
			link.l1.go = "Svenson_58";
		break;
		...
		// Глэдис
		case "Gladis":
			dialog.text = "Young man, you have grown even more in my eyes today. You have done so much for Helen, that no words of gratitude will be enough. I only do hope that you will take care of her further. If her father was alive and saw this, how happy he would've been... oh I am sorry.";
		...
		case "forge_2":
			...
			link.l1 = "Me and my wife thank you. See you, Baron.";
			link.l1.go = "Guests_block";
		break;
		...
		// Форже гость
		case "forge_5":
			dialog.text = "Charles, please, accept my sincere congratulations! Your chosen one is just a miracle! I think, today, colonial fashion has got a strong ... jab to a new direction. Your originality had always fascinated me! May you and your beautiful half live happily ever after!";
		...
		case "puancie_1":
			dialog.text = "Not a word more, my friend, not a word! I will immediately write to my authorized representative in Lyon - by your arrival these vineyards will be given to your chosen one.";
		...
		// Фадей патер
		case "fadey":
			dialog.text = "Charles, such a celebration, and how many important people! Let me wholeheartedly wish you happiness and good health, and children for joy! As we say - 'gor'ko'!";
			link.l1 = "Thank you, Fadey, you honored me by agreeing to come.";
			link.l1.go = "fadey_1";
		break;
		
		case "fadey_1":
			dialog.text = "But, I don't quite understand why there are so many people like we are not concluding a marriage, but a big trade deal, and still not enough beers and vodka for my taste here... haha! Well, I'm joking, Charles, why have you completely become pale? Give me a hug, you married captain!";
		...
		case "fadey_2":
			...
			link.l1 = "This is a real gift! Thank you, Fadey. These are indeed wonderful weapons, and they will take their rightful place in the estate de Monper, I promise!";
			link.l1.go = "Guests_block";
		break;
		
		// Фадей гость
		case "fadey_3":
			dialog.text = "Charles, such a celebration, and how many important people! Let me wholeheartedly wish you happiness and good health, and children for joy! As we say - 'gor'ko'! Give me a hug, you married captain!";
			link.l1 = "Wow... Fadey, you're strong like a bear!";
			link.l1.go = "Guests_block";
		break;
		...
		case "Tichingitu_1":
			...
			if (CheckAttribute(pchar, "questTemp.LongHappy.MarrySP")) link.l1 = "I do hope it will not come to dances around bonfires long before the end, and I would rather keep without boarding. Fine, be patient - just a bit left, and we immediately move to the tavern.";
			else link.l1 = "I'm afraid it will come to dances around bonfires long before the end, and I would rather keep without boarding. Fine, be patient - just a bit left, and we immediately sail to Sharptown.";
			link.l1.go = "Guests_block";
		break;
		...
		case "Tichingitu_5":
			dialog.text = "Captain, came out to look at the stars? The night promises to be very beautiful. Tichingitu loves the night over the sea. It is very peaceful.";
			link.l1 = "Glad to see that you are still standing my friend! Me and Nathaniel need your help - guys at the tavern are out of drinks, we need to bring a few boxes of drinks from stock under the shipyard.";
		...
		case "Tichingitu_8":
			dialog.text = "Captain, there are people, and they are armed, Tichingitu hears the rattling of their weapons and they are becoming louder by a second. I don't like it. Let's hide.";
			link.l1 = "Come on, mate - this is Sharptown, here even to the restroom people go armed with pistols. Hey Nathan... well, shit! That's one bottle gone. If it goes like this, you'll break up all the bottles! Stand on your feet damn you! Ha-Ha!";
		...
		case "Tichingitu_10":
			...
			link.l1 = "I wanted to ask you the same! Where have you been all this time?!";
			link.l1.go = "Tichingitu_11";
		break;
		
		case "Tichingitu_11":
			dialog.text = "Tichingitu woke up an hour ago because of the cries of this girl. She ran along the beach almost naked and screamed something about the abductors and savages... But there is nobody here except us. Do you have water? Not fiery one again, Tichingitu hates it now?";
		...
		case "Tichingitu_13":
			...
			link.l1 = "Yes, my friend, the women, having fun all night long, are a miserable sight in the morning. Don't worry, hero-lover, we'll come up with something. Come on, we have to go back to Sharptown, you missed your holiday boarding...";
			link.l1.go = "Tichingitu_14";
		break;
		
		case "Tichingitu_14":
			dialog.text = "A boarding? Captain has mentioned a battle before. Thoughts still don't obey Tichingitu. What happened in the town?";
			link.l1 = "A real battle on land and at sea. The guns were shooting all night, I guess, they was probably heard even in San Jose. However, you were busy with another 'battle', all is well I can understand it... Come on, I'll tell you everything along the way.";
		...
		case "Tichingitu_19":
			dialog.text = "Tichingitu doesn't like fire water, but if the captain insists, today it is possible to do. To your happiness, and your squaw! May you walk the same path, and let the sun and moon always shine on it.";
		...
		case "FortFrance_Mayor_1":
			dialog.text = "Wait, Charles. You misunderstood me, I am sincerely happy with all my heart! And yes... here, take it. Our common... Friend, really requested that you get it exactly today.";
		...
		// Бас Тер
		case "BasTer_Mayor":
			dialog.text = "A delightful liturgy, isn't it, Charles? I am sincerely happy for you! From me personally and all the citizens of Basse-Terre - I say our congratulations to you and your... charming wife. You are a wonderful couple! May you live happily ever after!";
		...
		// Тортуга
		case "Tortuga_Mayor":
			dialog.text = "So cute - you and your bride, monsieur de Maure, looked so unusual! However, you are an unusual man. I wish you a long and happy family life. May you live happily ever after!";
		...
		case "Terrax":
			if (CheckAttribute(pchar, "questTemp.Mtraxx")) 
			{
				...
				{
					dialog.text = "And what is this married dandy doing on my pirate beach, huh?! Tell me, monsieur, what did you do with my old friend - the harsh Pirate Charlie Prince?";
					link.l1 = "Charlie Prince is dead, you remember it, Marcus... Ha-ha-ha come here you sea devil! I'm glad to see you! How are you you guys doing here, has everyone gathered?";
				...
				else // 28-03-20
				{
					...
					link.l1 = "Ahoy, Marcus, I'm glad to see you too! How are you guys doing here, has everyone gathered?";
					link.l1.go = "Terrax_1";
				}
			}
			else
		...
		case "Terrax_4":
			...
			{
				dialog.text = "Dannie and Nathan are long-standing case - I have already come to terms with this, but you surprised me, there is nothing to say! However, the pupil of the Forest Devil is beautiful - there is nothing to say, anytime ready to use a word and a gun, and she can handle any storm. It is unlikely that you could find yourself a more worthy woman. You are a lucky one, captain - take care of her!";
			}
			else
			{
				dialog.text = "Dannie and Nathan are long-standing case - I have already come to terms with this, but you surprised me, there is nothing to say! Although, as I heard, your Mary knows a lot about swords and she clearly knows how to use them - my respects! A true war girlfriend. I'll tell you a secret, for the sake of such a girl, I myself could reconsider my convictions as bachelor. You are a lucky one, captain - take care of her!";
			}
		...
		case "Terrax_5":
			dialog.text = "Well then, a toast!... For love!... But, not for the one that drives us across the threshold and to the horizon!... But for the one that is waiting on us in this threshold! For the love, the one that makes us go back to it, even from the end of the world and from the golden mountains! Live with it and be happy!";
		...
		case "Terrax_8":
			dialog.text = "There's no time! They are behind the doors! Everyone, to arms!";
			link.l1 = "Here we go!";
			link.l1.go = "exit";
		...
		case "Terrax_9":
			dialog.text = "I don't remember the last time I had so much fun on a party! It's not over yet! Do you hear that? Someone's shooting outside! Let us litter the streets with their blood!";
			link.l1 = "Wait! Who the hell are they!? And what the fuck do they even want?!";
		...
		case "Nathaniel":
			...
			link.l1 = "And I've been thinking why it burns in my throat as if I drank molten lead. Well, Nathan, cheers...";
			link.l1.go = "Nathaniel_1";
		break;
		
		case "Nathaniel_1":
			dialog.text = "Wait, first a toast! Hey gentlemen, raise your mugs! Today, our friend and associate Charles de Maure is entering the path of family life. Accept from us the deepest condolen.. oh, Dannie please, put down the gun! Congratulations, of course! Now, you are the sails of the same ship, so lead her through any storms to the most fertile shores!";
		...
		case "Nathaniel_3_1":
			dialog.text = "You look so much like me and Dannie twenty years ago!";
		...
		case "Nathaniel_4":
			...
			dialog.text = "What!? Did Jan send you into the cellars to bring wine? Let's have a walk, I will help you a bit, and fresh air will be useful.";
			link.l1 = "But where are Dannie and "+sld.name+"? Jan told me that they had gone to have a talk.";
			link.l1.go = "Nathaniel_5";
		break;
		
		case "Nathaniel_5":
			dialog.text = "Yes, Dannie knows that presence of even the best girl-in-arms still will not give gentlemen of fortunate time to relax to the fullest. So they listened to all the compliments they received and went to the residence to let the guys have fun.";
		...
		case "Nathaniel_7":
			...
			dialog.text = "So, here is the chest. We take as much as we can carry and we go back, until this old grouch will lock us here.";
		...
		case "Nathaniel_12":
			...
			dialog.text = "We put these bastards down, but guns rumble from the sea, do you hear? We've got only two crews ready for battle, on Marcus' frigate and Jan's corvette. Me, Dannie and others have landed our guys - wedding after all - so Centurion is out. What about your ship? We have to decide what to do and quickly!";
			link.l1 = "I've landed a half of the crew, I hope the rest is sober. But first, I have to find my wife and make sure she is alright.";
			link.l1.go = "Nathaniel_13";
		break;
		
		case "Nathaniel_13":
			dialog.text = "Yes, Dannie is also nowhere to be seen. Then we act like this - Tyrex and Svenson have already rushed to the harbor, they will reach their ships on boats. We are going to the residence for the wives, the rest - let them organize defense on the shore. Can you send few of your officers to gather people on your ship? Help there obviously won't hurt.";
		...
		case "Nathaniel_17":
			...
			dialog.text = "Damn it! Your fellow, he rushed right into the gun so that bastard wouldn't shoot girls!";
			link.l1 = "And he got a bullet... Wait, Nathan... he's breathing! He is still alive! Damn it, I need Gino! "+sld.name+", honey, how are you?";
		...
		case "Nathaniel_18":
			...
			link.l1 = "I will find Gino and send him here, he will help ... he must! "+sld.name+", dear, stay here, take care of him, both of you.";
		...
		case "Nathaniel_21":
			dialog.text = "Crap! Forgive me Charles. We were stuck upstairs, there was a dozen of these bastards... It's a pity I didn't get here in time, but I see, you dealt with the situation in the best possible way.";
			link.l1 = "I can't say that it was easy, but, fuck, I received a great pleasure when I killed this 'kind man'! It's time to go ashore, Nathan, Our people are waiting for us there!";
		...
		case "Nathaniel_24":
			dialog.text = "He's in rough shape, but he will be alright. Tyrex is stronger than a nail for a coffin, so don't worry, he has already been transferred to your ship and asked for a saber.";
		...
		// Даниэль Хоук
		case "Danielle":
			dialog.text = "Hello, Charles. Let me look at you - became prettier, can't complain! Almost like Nathan, about ten years ago! Come in, don't stand on the doorstep, everyone has just been waiting for you!";
		...
		case "Danielle_3":
			...
			link.l1 = "Ah Dannie, how can I even refuse you ha-ha! You can't even imagine how me and my wife are glad to see you all!";
		...
		case "Danielle_7_1":
			...
			dialog.text = "We're fine, Charles! I will untie her. I hear cannons in the harbor, you and Nathan need to go there, otherwise Barbazon will drown our ships like ducklings in a barrel. You shouldn't lose any minute!";
		...
		case "Danielle_10":
			...
			link.l1 = "Yes, I know. Fucking bastard, he will pay for this!";
			link.l1.go = "exit";
			AddDialogExitQuestFunction("LongHappy_OutOfBedroom");
		break;
		
		case "Danielle_11":
			dialog.text = "Here you are at last! Is everyone alright?";
			if (CheckAttribute(pchar, "questTemp.LongHappy.Tichingitu_Victim"))
			{
		...
		case "Danielle_12":
			...
			else
			{
				...
				link.l1 = "Dannie, he covered my wife and you from a bullet and I'll forever owe him for this. You can't even imagine how glad I am to hear that he is recovering. Let him rest, I'll check on you later.";
				link.l1.go = "Danielle_14";
			}
		break;
		
		case "Danielle_13":
			dialog.text = "Of course! But, I must leave you, I have to go to my husband... Don't you mind if we lend your friend? When Nathan gets better, I myself will bring him to Antigua. Centurion somehow miraculously survived, she only needs to recruit a new team.";
		...
		case "Danielle_19":
			...
			link.l1 = "... Long ago he said that he would die for me... I guess he never knew that he would sacrifice his life for us all... and now he is a hero and I will remember him as nothing less... Where's "+sld.name+"? Is she alright?";
		...
		case "Danielle_20":
			...
			link.l1 = "Curse on you Jacques Barbazon... We should've killed him before!";
		...
		case "Dodson_1":
			dialog.text = "And that is true! We'll finish here and I will immediately take care of them, damn it! Come on, Charles, let's drink for your luck and family life. So, as they say, happily ever after!";
		...
		case "Vensan":
			pchar.questTemp.LongHappy.Count = sti(pchar.questTemp.LongHappy.Count)+1;
			dialog.text = "Charles, can you even imagine how many girls' hearts you broke with this wedding of yours? Yes, half the girls of the archipelago must have mourned after your wedding, haha!";
			link.l1 = "What can I do - I only needed one and I got her. But it's too early for the girls to be upset, because they still have you, Bernard.";
			link.l1.go = "Vensan_1";
		break;
		...
		case "Vensan_4":
			dialog.text = "Not a big loss, I say! Better to have one gold coin than a bag of nickels. Let's have a drink! Cheers to you and your wife! Keep your gold safe and be happy!";
			link.l1 = "Thanks Bernard. Oh, this is a really strong rum. Whew!";
			link.l1.go = "Vensan_5";
		break;
		...
		case "Jino":
			...
			link.l1 = "Thanks, Gino. I'm glad you decided to come! I hope the local... color, does not bother you?";
			link.l1.go = "Jino_1";
		break;
		...
		case "Jino_2":
			dialog.text = "Thank you, captain, I've got enough diluted wine. Alcohol, I must warn you, is not very good for the liver and possibly the heart. As for the conversations, I tried to discuss the healing properties of Chirik-Sanango with that gentleman over there, it is also called Manaka. Maine natives use it for...";
			link.l1 = "Let me guess - that gentleman couldn't support the discussion? Gino, for my sake and only today - try the rum that Jan over there is pouring at the counter. If you can guess all of its ingredients, Nathaniel Hawk, over there, will be extremely impressed. I am sure he will be glad to be in your company as well as Svenson, the man at the counter, both of them respect educated people.";
			link.l1.go = "Jino_3";
		break;
		...
		case "Jino_4":
			dialog.text = "Captain, it's you, thank God! Those masked people, I saw them and hid here, and they tried to break through the door...";
			link.l1 = "It's alright, Gino, nobody's gonna hurt you anymore. It's a great luck that I found you, I need your help. My friend is injured - he has been shot, and he has lost a lot of blood. We must hurry!";
			link.l1.go = "Jino_5";
		break;
		
		case "Jino_5":
			dialog.text = "Shot... blood... fine, captain. While coming here, I grabbed my camping chest with all the tools in case of an injury. Lead me to him, I will see what can be done. And these... masked men, maybe they have lurked somewhere else?";
			link.l1 = "I'm sure, they were the last. Gino, there's battle in the harbor and I need to go there right now. You have to get to the residence on your own it's not far. The big house is around the corner - you won't miss it. Don't be afraid - the streets are full of our people, and hurry up, I'm begging you!";
			link.l1.go = "Jino_6";
		break;
		...
		case "Jino_8":
			dialog.text = "Everything is fine, captain, thanks for care. I must say - I haven't been out of Antigua for a long time, and among elite I... don't feel myself very comfortable. But the reason to come did not leave me a choice. By the way - the service was excellent, I am very happy for both of you! The bride in this outfit is charming - is this a new fashion? It turns out that I fell behind on living a life, but I like it, really.";
			link.l1 = "Fashion... In some way yes, or at least, will become soon. Fine, have fun, Gino, and if the noble interlocutors will become bore for you, then come to the port. The whole crew is in the tavern. Guys will be happy to see you.";
			link.l1.go = "Guests_block";
		break;
		
		case "Jino_9":
			dialog.text = "Captain, Once more, I congratulate you and your beautiful wife! Long and happy years to you together!";
			link.l1 = "Thanks, Gino. I'm glad you came! I hope the local... color, does not bother you?";
			link.l1.go = "Jino_10";
		break;
		
		case "Jino_10":
			dialog.text = "This society it's not easy for me to feel comfortable. But, you always knew how to choose people, so I will try to stay calm, since I trust you..";
			link.l1 = "Maybe you need to drink something stronger? Relax and find someone to talk to?";
			link.l1.go = "Jino_11";
		break;
		
		case "Jino_11":
			dialog.text = "Thank you, captain, I've got enough diluted wine. Alcohol, I must warn you, is not very good for the liver and possibly the heart. As for the conversations, I tried to discuss the healing properties of Chirik-Sanango with that gentleman, it is also called Manaka. Maine natives use it for...";
			link.l1 = "Let me guess - that gentleman couldn't support the discuss? Gino, for my sake and only today - try the rum that Jan over there is pouring at the counter. If you can guess all of its ingredients, Nathaniel Hawk, over there, will be extremely impressed. I am sure he will be glad to be in your company as well as Svenson, the man at the counter, both of them respect educated people.";
			link.l1.go = "Jino_3";
		break;
		...
		case "Longway":
			...
			link.l1 = "Longway, never thought you were a master of a word!";
		...
		case "Knippel_1":
			if (CheckAttribute(pchar, "questTemp.LongHappy.MarrySP"))
			{
				dialog.text = "It's wonderful, chain shot to my butt! Captain, I mean, this celebarion is in your honor, well, I... I, congratulate, I mean... also... Happiness and... this, I am not good in speeches. But you must know that we all love you both and we will follow you even to hell captain!";
				link.l1 = "Thank you, old friend.";
			}
			else
			{
				dialog.text = "Wait, I mean... What do I even mean, chain shot to my butt?! Captain, I meant that this day is in your honor, well, I... I congratulate you... and also... I wish you happiness and... and sorry cap, I might be a bit too drunk to hold a speech chain shot to my neck, I haven't been sober in a while ha-ha-ha!";
				link.l1 = "Hah! It's alright... thank you, old friend.";
			}
		...
		case "Knippel_2":
			...
			dialog.text = "Ah! And yes, captain, accept this, please. For you and your lady. I've kept these stones for a rainy day... I understand that you have no shortage of gold, but they will not be superfluous, right?";
		...
		case "Knippel_3":
			dialog.text = "Well, let's cheer to this, chain shot to my... hm. Just be happy, both you and your beauty, captain!";
		...
		case "Tonzag":
			...
			link.l1 = "This is it, mate! And truly, I'm glad that this part of my life was left behind. Cheers!";
			link.l1.go = "Tonzag_1";
		break;
		...
		case "Tonzag_1":
			...
			link.l1 = "You? Married? Interesting stuff you are telling me! But what happened?";
			link.l1.go = "Tonzag_2";
		break;
		
		case "Tonzag_2":
			dialog.text = "What, do you think I was always an old cyclop smelling with gunpowder and blood, captain? But no. Madame Tonzag she... she loved me, I guess. But then, an unpleasant story happened. In which the Tonzag couple died and only Bald Gaston with set of scars managed to survive.";
		...
		case "Tonzag_3":
			...
			link.l1 = "Let us, mate. You know - since the day I met you, I always looked at you as I would look at my own father, so maybe one day you will get a chance to be a great grandfather. Anyway, Cheers! I must see to the rest, we will talk later.";
			link.l1.go = "Tonzag_4";
		break;
		...
		// Алексус
		case "Alexus":
			dialog.text = "Young people, why are you breaking in, may I ask? The shipyard is closed, isn't it noticeable? Come back tomorrow.";
		...
		case "Alexus_2_1":
			dialog.text = "C'mon, don't stand, go! Well, captain, are you happy with everything?";
			link.l1 = "...";
		...
		case "Shivo_3":
			dialog.text = "Don't be so funny, Charles. You and madame Botot have caused me a lot of troubles, and I intend to repay you in full. Although she caused a lot more problems for me than you did... however if you and the imposing monsieur pirate will sit quietly, then I give you a word of honor - your wives will stay alive. I think in the Spanish colonies on Maine such slaves are valued. Even unofficially. But this is still life, isn't it?";
			link.l1 = "Angerran, you are a coward, a bastard and... Shit, there are no suitable words for you yet in any language!";
			link.l1.go = "Shivo_4";
		break;
		
		case "Shivo_4":
			dialog.text = "You know it, you have no choice. I can only promise that it will be fast. So, if you love these women - behave yourself, save their lives and ease your fate. And yes - lock the door if it's not that hard for you. Thank you.";
			link.l1 = "";
			link.l1.go = "Shivo_5";
		break;
		...
		case "Dussak_5":
			dialog.text = "Listen, madame, I've never killed women, don't make me start, alright? You are unnerving the captain and your husband... Damn!";
			link.l1 = "";
			link.l1.go = "exit";
			AddDialogExitQuestFunction("LongHappy_BedroomShot");
		break;
		...
		// официантка
		case "waitress":
			dialog.text = "Captain, help, this savage, he abducted me! I... I need to go home - uncle has probably already turned the whole town upside down!";
		...
		case "waitress_2":
			dialog.text = "Wife? In the eyes of his Gods?! No, captain, I beg you, save me from this! It was just... an adventure, he was so gallant and nice, not like these bumpkins... But marry? I am too young to move to a hut to a savage!";
			link.l1 = "He is my officer and my best friend, so don't worry, I pay him well, and you will have the best hut you ever wanted. Tichingitu is a good hunter, he will procure food for you, and you will give birth and babysit children.";
		...
		case "waitress_4":
			...
			link.l1 = "Fine, you should go, beauty squaw. I will try to keep my friend away.";
		...
		case "waitress_5":
			...
			link.l1 = "Alright, hush, beautiful lady, hush. Maybe twenty thousand 'reasons' to forgive him will be more eloquent than my words? Or should I give them to your uncle, like a ransom for a wife? After all, everyone is on the island, right? Tomorrow we can organize another wedding...";
			link.l1.go = "waitress_6";
		break;
		
		case "waitress_6":
			if (sti(Pchar.money) >= 20000) AddMoneyToCharacter(pchar, -20000); 
			dialog.text = "No no, captain, wait! You convinced me. I'll come up with something so my uncle isn't angry. Farewell! And goodbye to you, my stallion from the distant plains! See me next time you visit...";
		...
		case "tavernkeeper_1":
			dialog.text = "Don't worry about this, if the barrels show the bottom, I will send an assistant to the port warehouse. Have fun, monsieur, and don't worry about anything.";
			link.l1 = "Fine, "+npchar.name+". Then I will go to my guests.";
		...
		case "JanDavid":
			...
			if (CheckAttribute(pchar, "questTemp.LongHappy.Baron"))
			{
				...
				{
					dialog.text = "Ah, I've been waiting for your visit, boss. Jan Svenson warned that you would definitely come to check how things are going in Le Francois. I took everything into my own hands and swear by thunder, this village will live better than with the damned Kindman, may the devils have fun with him in the darkest cellars of hell!";
					link.l1 = "You are Jean David, right? Svenson said something about my share...";
		...
		case "JanDavid_2":
			...
			dialog.text = "At your service, boss! As for the share - on the fifth of every month, you will be deducted a part of the gold coins from the deeds of our guys, and it'll wait for you as much as you need. Starting from next month you can come for it.";
			link.l1 = "Nice!";
		...
		case "JanDavid_3":
			...
			link.l1 = "You were told correctly. Fine, Jean, I rely on you, I hope you won't let me down.";
			link.l1.go = "JanDavid_4";
		break;
		
		case "JanDavid_4":
			dialog.text = "All will be well, boss. Everything is under control here, ha-ha, and may I not drink rum until the end of days if I mess something up!";
