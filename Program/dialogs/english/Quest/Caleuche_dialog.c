void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Tuttuat_1":
			...
			dialog.text = "You know what give to Tuttuathapak, white man. Tuttuathapak accept your gift. He will speak. What advice you seek of me?";
		...
		case "Tuttuat_3":
			PlaySound("interface\important_item.wav");
			dialog.text = "(looking at the amulet)... Your friend tell the truth, white man. This amulet belong to my people, great Indians, Chavin their name was. Cursed blasphemous palefaced cur defile the shrine and take it here. Tuttuathapak punished that hound.";
		...
		case "Tuttuat_7":
			dialog.text = "Three amulets like this was taken from our shrine. They have different powers, but if they are bring together, they be very very powerful. Find all three amulets and bring them to me, and I reward you. I give you power you can hold forever.";
		...
		case "Tuttuat_13":
			...
			link.l1 = "Calm down?! Are you insane how can I even survive against such thing!";
		...
		case "Tuttuat_17":
			dialog.text = "When my father be a young warrior, white men come to my land on ship the Flying Heart. They went to mountains. Legend say, a shrine of our ancestors is hidden there. Shrine of jaguar warriors. White men find shrine and gold and defiled ancient sacred thing. They take away great treasure of Chavins - the jade skull of  Yum Cimil, god of death and patron of jaguar men\nWhite men come to their ship. They decide to return to take more gold, but as their man step on dry land, he die in horrible pain. Yum Cimil cursed the captain and his crew. They become immortal, but they cannot step on land anymore. They sail many-many winters, half a century by your calendar. That's how the Caleuche emerged.\nTheir bodies wither, they flesh rotten, but they still live. If you hack an arm or leg off, it comes back. It you slice them into, they again become one. If their ship go down, they fix it underwater, and it sail again.";
			link.l1 = "Just great...";
		...
		case "Tuttuat_21_1":
			...
			link.l1 = "So, do I understand correctly that I have to find this skull again? And then what should I do with it?";
			link.l1.go = "Tuttuat_22";
		break;
		
		case "Tuttuat_21_2":
			dialog.text = "Skull must be here, in Caribbean. Caleuche be here not by chance. For the last six moons it often seen at the island. Before it be not there for many winters. Captain of Caleuche can feel the artifact of jaguar men. That's how he find you and your ship.";
			link.l1 = "So, do I understand correctly that I have to find this skull again? And then what should I do with it?";
			link.l1.go = "Tuttuat_22";
		break;
		
		case "Tuttuat_22":
			dialog.text = "First, you must find two amulet of which we spoke. Without them you cannot do anything. Amulet give you power to stand against jaguar men and any enemy you walk into.";
			link.l1 = "Stand against jaguar men? What are you talking about?";
			link.l1.go = "Tuttuat_23";
		break;
		
		case "Tuttuat_23":
			dialog.text = "Temple where you must bring jade skull, is on a desert island in the Caribbean. It guarded by jaguar men. They are all dead but alive now. Without amulet you not pass them. Jaguar men in life were a fierce warrior, and after death become almost invincible. They are given strength by Yum Cimil himself.";
			link.l1 = "Undead? Again? Lucky me...";
			link.l1.go = "Tuttuat_24";
		break;
		
		case "Tuttuat_24":
			dialog.text = "Why so surprised, white captain? Yum Cimil is a god of death, jade skull give power over dead and live. Caribbean. It guarded by jaguar men. Without amulet you not pass them. With amulet you can enter temple and survive, you leave skull there, then find the Caleuche, defeat her captain and take amulet he took from you.";
			link.l1 = "And why does the captain of the Caleuche need these amulets?";
			link.l1.go = "Tuttuat_25";
		break;
		
		case "Tuttuat_25":
			dialog.text = "Methinks he want go to temple of jaguar men and he thinks amulet help him. But I can be wrong. Still, the Caleuche is always lured by artefacts of my land. She sailed near island where temple of jaguar men is, and she sailed at shores of my motherland.";
		...
		case "Tuttuat_28":
			...
			link.l1 = "This cursed ship is insanely fast! It's about twice as fast as any ship I have ever seen. But I noticed that it struggles while sailing into the wind.";
			link.l1.go = "Tuttuat_29";
		break;
		
		case "Tuttuat_29":
			dialog.text = "The Caleuche is cursed - that's why she's so fast. Hard to escape. You must have ship which can outrun the Caleuche. Or you end up dead. When you find amulet, bring it to me. Not keep amulet on ship.";
		...
		case "Tuttuat_45":
			...
			link.l1 = "Sure... But what's more interesting - I crossed the entire Caribbean sea from Cuba to Dominica, and the Caleuche never tried to attack me, when I had this skull, I didn't even see it. And when I was carrying amulets to you, it constantly ran me down as soon as I sailed out it found me in few hours.";
			link.l1.go = "Tuttuat_46a";
		break;
		
		case "Tuttuat_46a":
			dialog.text = "Methinks, the Caleuche is afraid of skull or it cannot sense it. I have no other explanation. Perhaps Yum Cimil make jade skull very dangerous to the Caleuche - in addition to curse. Perhaps that's why captain wanted so much taking three amulets of my people. To gain wisdom how to control spell of Yum Cimil.";
		...
		case "Tuttuat_50":
			...
			link.l1 = "Alright, got it. But what should I do in the temple? Where should I put the skull? How can I beat the jaguar warriors guarding it? If they are the Chavinavi like those summoned by that warlock Merriman, it'd be foolish to go there alone - each of them is as strong as ten soldiers.";
			link.l1.go = "Tuttuat_51";
		break;
		
		case "Tuttuat_51":
			dialog.text = "They are not. Chavinavi summoned by white warlock with skull are weak. Much weaker than those summoned by Yum Cimil himself. You never harm them, and they kill you with one touch of their weapon.";
			link.l1 = "Hold on - and how did that 'pale-faced man' managed to enter the temple and steal the artifact?";
		...
		case "Tuttuat_53":
			dialog.text = "I help you, white man. I give you two Chavins amulets you bring me. Me talk to ancestor spirits and empower amulet. When you have one with you, you can fight jaguar warriors like common soldiers, you will be like one of them, though very strong. Amulet protect you and give you weapon power to harm Chavinavi of temple.";
			link.l1 = "Are you sure that the amulets will help?";
			link.l1.go = "Tuttuat_54";
		break;
		
		case "Tuttuat_54":
			dialog.text = "Me know. Me talk to ancestors. Me great shaman. You trust me. You take two amulets. One protects. Other empowers weapon. One amulet you must use. Which one - you choose. If you no wear amulet, you perish to jaguar warriors\nAnd you remember that on midnight Yum Cimil bring back to life all warriors you kill. You must figure the time to not fight they twice, or do, spirits tell me that you could.";
			link.l1 = "I see.";
			link.l1.go = "Tuttuat_55";
		break;
		
		case "Tuttuat_55":
			dialog.text = "You take amulets. Here they are. You remember, they power has limits. It wane in one moon. You remember me say, that you not hold they power? Only great shaman of our tribe can hold it.";
		...
		case "Tuttuat_57":
			dialog.text = "Condor is a great bird which live in the mountains of my home. In memory of home, ancestors build statue of Condor near shrine.";
		...
		case "Tuttuat_59":
			dialog.text = "I don't know for sure. You see by yourself. It be a trap, or a... confusion. To enter shrine is hard. Entrance be sealed, and you must find way open it. My ancestors be not only great warriors and shamans, but great builders, too, to open it you need think.";
			link.l1 = "Heh! Sounds frightening, but let 'em all come! I will not waste time. I am setting sail at once!";
			link.l1.go = "Tuttuat_60";
		break;
		
		case "Tuttuat_60":
			dialog.text = "Go, white warrior. Me shall summon spirits help you against jaguar warriors and the Caleuche. Remember, if you use amulets I can help, if not you perish";
		...
		case "Tuttuat_62":
			...
			{
				dialog.text = "Me talk with spirits. You were on the island in temple of Yum Cimil. You find the  Caleuche and amulet?";
		...
		case "Tuttuat_64":
			...
			PlaySound("interface\important_item.wav");
			dialog.text = "You fast and strong warrior, palefaced one. Tuttuathapak not like white men, but me respect brave and skillful warrior. You did very well. You rid seas of the Caleuche. You bring me three amulets. Me reward you.";
			link.l1 = "You promised something about 'power that I will be able to hold forever'?";
		...
		case "Tuttuat_66":
			dialog.text = "Me hear of herbalist Amelia. She not knows little but not much. She not know the secret of Manga Rosa. Only great shaman from my homeland, from where Manga Rosa be taken here, can use its full power.";
			link.l1 = "What power?";
		...
		case "Tuttuat_67":
			dialog.text = "Me can make potions of Manga Rosa. Very strong potions. None but me in the Caribbean can make those. My potions make man forever stronger, faster, smarter, keen-eyed, handsomer and luckier. I brew for you three such potions.";
			link.l1 = "Very interesting!";
			link.l1.go = "Tuttuat_68";
		break;
		
		case "Tuttuat_68":
			dialog.text = "You great warrior, so you first need potion to make you sturdier and one to make you quicker. And you choose third potion after I make first two. But you must bring me Manga Rosa to make them - I have none.";
			link.l1 = "Where should I look for Manga Rosa?";
			link.l1.go = "Tuttuat_69";
		break;
		
		case "Tuttuat_69":
			dialog.text = "Manga Rosa is a rare herb in the Caribbean. It grows where people walk not a lot. Stupid people pick it, dry it and smoke it. Very stupid people. NO SMOKE IT! It be a waste of power... Seek jungle and coves, secret places where silly people not thread. Look carefully. For each potion I need five stems of Manga Rosa.";
		...
		case "Tuttuat_77_2":
			dialog.text = "Come tomorrow, as usual. I brew you potion to make your eyes keen so you see every target, and you better hit with fiery weapons that roar.";
			link.l1 = "Fine.";
			link.l1.go = "Tuttuat_74";
		...
		case "Tuttuat_79":
			...
			link.l1 = "I see. Alright, thanks once again for your excellent potions. You truly are a great shaman. It is time for me to go now. Farewell, Tuttuathapak, I hope I will see you again.";
		...
		case "Tuttuat_80":
			...
			link.l1 = "Well then... hah... may the spirits light your path as well, great shaman. Farewell...";
		...
		case "Tuttuat_82":
			...
			link.l1 = "I'm sorry I was really unlucky... Oh, well. Farewell, shaman.";
		...
		case "CaleucheCap":
			...
			dialog.text = "It's all in vain, sailor. You will not best me. And all my men lying on the deck will put together their bones and rise again before dawn. We cannot be killed, for death abandoned us forever.";
		...
		case "CaleucheCap_3":
			...
			dialog.text = "I can't believe it! It's been so long ago when I have last seen my own blood and felt any pain...HOW?!";
		...
		case "CaleucheCap_5":
			...
			dialog.text = "Hawk! Twenty five years have passed, and I still remember it like it was only yesterday. The radiance of that orb which blinded us and split my ship in half. That was the first and the last defeat of the Flying Heart and Balthazar de Cordes... So let's cross the last time, captain! Death in battle is light and welcome!";
			link.l1 = "...";
		...
		case "on_coast":
			...
			link.l1 = "Goddammit, what happened? My head is splitting apart from pain...";
			link.l1.go = "on_coast_1";
		break;
		
		case "on_coast_1":
			dialog.text = "When we entered the captain's cabin, you were lying on the floor, still not a single movement. The guys picked you up and dragged you to our ship - and just in time, since the dead men lying on the deck began to rise again\nMost Holy Virgin and all the Saints! We quickly cut the lines and tried to sail away, but a salvo from their ship quickly turned our old tub into splinters and we lost control over her. Then they hoisted sails and were gone in blink of an eye\nOur ship run agound, and everyone who managed to survive, has reached the shore in a boat. Lots of good men died today... if only we stayed aboard... But we were sure that the storm will finish the ship for good.";
		...
		case "on_coast_4":
			dialog.text = "That's for sure... Was it the Flying Dutchman, cap? Why did they attack us? And why didn't they shoot at us before the boarding, but almost sunk our ship with just one volley later?";
		...
		case "on_coast_5":
			...
			link.l1 = "Me too... I guess. But first I'll go back to that village. I need to tell Tuttuathapak everything about it. That accursed ship attacked us because of the amulet! I am sure that red-skinned devil had some ideas, why in the hell those living dead might have needed it.";
		...
		case "on_coast_7":
			dialog.text = "What are you talking about, cap! We'd go to the world's end for you and fight thousands of undead! It's a damn shame we lost so much but this story will live in legends.";
			link.l1 = "...";
		...
		case "fergus_5":
			...
			link.l1 = "Believe me or not, but I am telling the truth. I wouldn't believe it myself, it I didn't see it with my own eyes, I can swear on the Book or you can ask those that were with me. I barely survived after that encounter with the Caleuche.";
			link.l1.go = "fergus_6";
		break;
		
		case "fergus_6":
			dialog.text = "The Caleuche?";
			link.l1 = "Well, the Flying Dutchman most call it but it's true name is Flying Heart. Whatever. Just sell me that amulet. It's of no use to you anyway, I know.";
			link.l1.go = "fergus_7";
		break;
		...
		case "Beliz_townbandos_1":
			dialog.text = "Have not you heard? Get the fuck out, or I'll kick you out the door!";
			link.l1 = "Hmm... Well, perhaps you're the person I am looking for after all. You seem way to nervous, mate...";
		...
		case "Beliz_townbandos_2":
			...
			link.l1 = "Throw me behind bars? How very interesting. You know, now I am almost positive that I have found whom I was looking for. Alright, I agree. Let's call the guards, and then we'll walk to the commandant's office together, like a happy family. I've just been there, so I remember the way... Guards! GUARDS!";
		...
		case "Beliz_forestbandos_3":
			...
			link.l1 = "I told you already, they seized your guy, so I took his job. He promised money and a warm welcome from you...";
		...
		case "Beliz_forestbandos_5":
			dialog.text = "Sure you will! If you're brave in battle and if you stay alive. But don't expect a cakewalk, the merchant is not alone, he has an escort, and very large escort. Well, time to go - our prey is close. Boys! Prepare your weapons, we're heading out!";
			link.l1 = "...";
		...
		case "Beliz_forestbandos_7":
			dialog.text = "I see you're no coward. Well done! You have earned your share. How would you like it? Cash? Merchandise? They carried a lot of alcohol, sure it's worth a lot.";
			link.l1 = "Cash.";
		...
		case "Beliz_forestbandos_8_1":
			...
			link.l1 = "Thanks! Now that's how I like it!";
		...
		case "Beliz_forestbandos_10":
			...
			link.l1 = "Stop scaring me already. I got it. I will be quiet as a fish. Wait for me in three days, I'll be there. I love easy money!";
		...
		case "Beliz_cavebandos":
			...
			link.l1 = "Whom did you just call a worm, you scum?!";
		...
		case "reginald_1":
			dialog.text = "'Mynheer Jackson', ha-ha! Well, to be honest, soon I am going call myself that too. I am working for this damned Company without a break... but they pay well, very well!.. So, what brings you here mate?";
		...
		case "reginald_2":
			dialog.text = "Oh, you mean that fancy trinket, of which I had inquired that retired bosun? Yeah, friend, you are right, it actually never came in handy it just looks pretty.";
			link.l1 = "How much do you want for it?";
			link.l1.go = "reginald_3";
		break;
		
		case "reginald_3":
			dialog.text = "You see, there's a small problem... Let me explain. I don't have it with me at the moment. Since I never found a use for it, I left it in my chest on the shore, among my other belongings.";
			link.l1 = "Oh, that explains that you are still... well, never mind. Let's just head to that chest of yours, and I'll buy the amulet from you. As simple as that. Where do you have it?";
		...
		case "reginald_5":
			dialog.text = "Hmm... Well, there is one option. I give you the key to my chest, and you sail to Barbados on your own. But you will have to compensate me all stuff which is in it and you can have them. I am sorry for the distrust - but you must understand. I've never seen you before.";
			link.l1 = "How much?";
		...
		case "reginald_7":
			dialog.text = "Then come see me again once you've raised the money. If you found me once, you'll find me again. I am going to sail between St. Martin and Jamaica for quite some time now.";
		...
		case "reginald_9":
			dialog.text = "You again, friend? You have 500 coins?";
			if (PCharDublonsTotal() >= 500)
			{
		...
		case "reginald_10":
			...
			dialog.text = "Great! And here is your key. And I have but one request: after you take everything that's in it, please leave the key in the lock. I would hate to commission a new lock and a key for it.";
			link.l1 = "Alright.";
		...
		case "reginald_11":
			...
			link.l1 = "And same to you... Bon voyage, mynheer Jackson!";
		...
		case "monk_caleuche_1":
			dialog.text = "I made inquiries about you, once your ship has moored in. And I think I can ask you for assistance.";
		...
		case "monk_caleuche_3":
			...
			dialog.text = "There is a house at the back of the bank. A lady that lived there was renting a room in it to one very suspicious type, not the local, and not the Dutchman. And so our father superior, Father "+sld.name+", had recognized him\nIt was Joachim Merriman, a Portuguese, accused by the Inquisition of witchery and dealings with unholy powers. He hid himself from the Inquisition in the New World. You know, Spaniards often accuse those out of favour of heresy and witchery in order to burn them at the stake, but... In this case they were right. Merriman is a warlock\nSo, he'd been living in Willemstad for some time, and then he disappeared as suddenly as he had emerged. And after some time a woman, the one that rented the room to him, was never seen going out of that house. Never! And she was never seen anywhere ever since\nAnd at nights citizens can occasionally see red-blue lights flashing in the windows of the second floor and hear strange sounds, almost like some unholy screams. Father "+sld.name+" appealed to the commandant. He sent a patrol of four soldiers, they searched the house, but have found nothing: neither the landlady herself, nor anyone else, nor anything suspicious at all\nBut these strange things continue happening. The landlady has never shown up, and this hellish light can still be seen there at nights. Besides, two beggars have recently gone missing as well. I heard them, talking at the parvis - they knew that there were no owners in the house, and so they decided to lodge there. No one has seen them thereafter.";
			link.l1 = "I take it, you want me to go into that house and check what really happend?";
		...
		case "monk_caleuche_5":
			sld = characterFromId("Villemstad_Priest");
			dialog.text = "Yes, mynheer. It's quiet there during daytime, that's why soldiers didn't find anything, I think that commandant is scared for his men, I would be too. But please, I beg of you. Father "+sld.name+" will thank you and reward you for your service. Once you've been to that den during the night, please tell him what you find there. I assure you, our misgivings are well-grounded.";
			link.l1 = "Alright. I'll think about it.";
			link.l1.go = "monk_caleuche_6";
		break;
		
		case "monk_caleuche_6":
			dialog.text = "Thank you, captain. I hope you don't turn down my humble request. Please, do it in the name of our Lord, our faith and all that is holy. Go with my blessings.";
			link.l1 = "...";
		...
		// охотник у пещеры
		case "cavehunter":
			dialog.text = "Hold on, mate. You'd better not go there, if you cherish your life.";
			link.l1 = "And what's the deal?";
			link.l1.go = "cavehunter_1";
		break;
		
		case "cavehunter_1":
			dialog.text = "Trust me, you don't want to know. But Death itself is around the corner, and I can swear on the Book that you won't came back alive, there are things beyond your imagination.";
		...
		case "cavehunter_5":
			...
			link.l1 = "Absolutely. "+sld.name+", father superior of the church in Havana, sent me here. I must determine what's happening here, and take adequate measures.";
			link.l1.go = "cavehunter_6";
		break;
		
		case "cavehunter_6":
			dialog.text = "What's happening here? I'm afraid you'd be shaking with fear, once you see what is happening here with your own eyes.";
		...
		case "cavehunter_7":
			...
			link.l1 = "And I do believe you. I have already encountered that unholy thing in Willemstad and destroyed it. And I will now go in there and destroy all filth that lurks in this cave.";
		...
		case "cavehunter_8":
			...
			switch (icpy)
			{
				...
				case 1:
					dialog.text = "Just the two of you? I am afraid you won't get far. You have no idea just how many of those things are there. It's a suicide.";
					link.l1 = "You just don't know us well, friend. Step aside, and we will cleanse this unholy den.";
					link.l1.go = "cavehunter_exit";
				break;
				
				case 2:
					dialog.text = "Just the three of you? You must be seasoned fighters if you dare to do it. But I am still afraid that you will not manage. You have no idea just how many of those things are there inside of that grotto.";
					link.l1 = "You just don't know us well, friend. Step aside, and we will cleanse this unholy den.";
					link.l1.go = "cavehunter_exit";
				break;
				
				case 3:
					dialog.text = "You guys are no cowards, I see. But you really have no idea, how many of those things are there. In such an affair every man counts. Screw this, I'll come with you and I will shoot that filth with my musket!";
		...
		case "cavehunter_11":
			dialog.text = "Now that was quite a massacre! Who could have thought that so many dead were hiding in this place! Well, at least we can rest now... Please tell that father superior of yours about this, the one that had sent you here. I do hope that the Inquisition is going to get down to this after your report. Dealing with the undead is on their own ground, after all, I am just a simple hunter.";
			link.l1 = "I'll definitely tell him. Thanks you for the help, mate. You're a rare kind not many would dare to fight death itself! Good luck!";
			link.l1.go = "cavehunter_exit";
		break;
		...
		case "Chavinavi":
			...
			dialog.text = "Hold still, human! You're in the very heart of the temple, and you have gone too far to turn back now.";
			link.l1 = "Who are you?!";
			link.l1.go = "Chavinavi_1";
		break;
		
		case "Chavinavi_1":
			dialog.text = "I am the chieftain of the Chavinavi, the keeper and the guardian of this sacred place. You're not the first to enter this temple, but only two men and one woman entered it and left alive before you. That is the only reason I condescend to speaking with you now. Why have you come here, pale-face?";
		...
		case "Chavinavi_3":
			...
			link.l1 = "No. I came here on advice of a great shaman by the name of Tuttuathapak. As he said, the skull is the key to the curse, and this is the only temple in the Caribbean. An you know what - I think that he indeed can converse with the spirits of the past. Perhaps even with you, chieftain of the jaguar warriors.";
		...
		case "question2":
			dialog.text = "What Indian tribe build this temple?";
			link.l1 = "Inca.";
		...
		case "question4_r":
			dialog.text = "Years of prosperity have passed and faded, like the flame of the lamp, and life abandoned the island. Only the temple was left to stand here as a reminder of the great power of ancient Indians. The last shaman left on a pedestal a holy solar orb, which gave power to the courageous and punished the wicked. It was taken by the man who'd been here before you.";
			link.l1 = "";
		...
		case "question5_r":
			if (CheckAttribute(pchar, "questTemp.Caleuche.QuestionFail"))
			{
				...
				link.l1 = "Well, if you insist - let's see, how great of a warrior you are...";
		...
		case "Chavinavi_6":
			...
			PlaySound("interface\important_item.wav");
			dialog.text = "This is not a simple pelt. Once you wear it, you will gain the strength of the jaguar warrior. The power of your weapon which breathes fire and fires lead, will increase tenfold, and you will be able to litter the battlefield with the corpses of your enemies\nBut no mortal can hold the power, which was put into this pelt by Yum Cimil. Once you release it, it shall accompany you only until next midnight, and then it will fade. Take care of it, pale-face, and don't waste its power on a petty skirmish.";
