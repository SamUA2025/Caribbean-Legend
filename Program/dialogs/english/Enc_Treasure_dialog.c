...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "First time":
			...
			dialog.Text = "Pssst... Listen here... I've got something interesting for you...";
		...
		case "map_treasure_2":
            dialog.Text = "It's a great map. You will never buy anything like that in any store. It shows where a treasure is hidden. I can't get there myself, but the map is genuine, I swear.";
