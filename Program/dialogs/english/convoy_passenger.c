...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "prepare_convoy_quest":
			...
			{
				dialog.text = RandPhraseSimple("Ahhh, hell! I know who you are! Only a complete idiot would get on board your ship as a passenger! Farewell!", "Oh, I know who you are! I will never set foot on board your ship. I am not a fool...");
		...
		case "convoy_DeskTalk":
			dialog.text = NPCStringReactionRepeat(LinkRandPhrase(RandSwear() + "Captain, time has run out. When, damn it, will I finally get to " + XI_ConvertString("Colony" + npchar.GenQuest.GetPassenger_Destination + "Acc") + "?", 
						  ...
						  RandSwear() + "Listen, captain, I need to get to " + XI_ConvertString("Colony" + npchar.GenQuest.GetPassenger_Destination + "Gen") + ", and I want to get a clear and simple answer when this will happen!"), 
				RandPhraseSimple("Captain, once again I have to open a question regarding your obligations. When will we get to " + XI_ConvertString("Colony" + npchar.GenQuest.GetPassenger_Destination + "Gen") + "?", "Captain, the second time I have to raise the question about my journey. When, finally, will we see the coast of " + XI_ConvertString("Colony" + npchar.GenQuest.GetPassenger_Destination + "Gen") + "?"), 
			...
			link.l2 = HeroStringReactionRepeat(RandPhraseSimple("Oh... a passenger... I have forgotten about you... I think you will find it more comfortable in the hold, where you will no longer pester me.", "Well-well, I can't believe my own eyes! Stranger is on my ship! Fine, then shut up and go into my hold, now!"),
				"For the second time? Oh, indeed... But you know, perhaps, I'll send you to the hold for an 'excursion'.",
				"For the third time? That's too bad, he-he... Well, mate, welcome to my hold. You should't have been walking around on the deck of my ship and bothering me.",
		...
		case "convoy_Prison_2":
			...
			Link.l1 = "Everybody says that - but in the end they all pay me!";
