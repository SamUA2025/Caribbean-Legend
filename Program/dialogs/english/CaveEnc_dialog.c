...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "CaveBanditosSit":
			...
			{
				dialog.text = LinkRandPhrase("Whoa, good heavens! No need to go hunting the prey - it's already here... Hey, guys - let's shake this fop, will we?","No one invited you here, mate... But it's so good that you are here, anyway. Let's see now, just how heavy your purse is!","No one dragged you here by force, he-he... But if you're already here, guess we'll tickle you a bit to see what drops out of your pockets...");
				link.l1 = LinkRandPhrase("Now I will make your tongue shorter a bit...","I hope your skills with a sword match your wits, flapjaw!","Well, seems that it's time to make a couple more holes in your perishable body...");
				link.l1.go = "fight";
			}
		...
		case "CaveBanditosTreasure":
			dialog.text = NPCStringReactionRepeat("Get lost, mate. There's nothing to do for you here!", "Hey, I am asking in a friendly way: get lost. You never know what can happen...", "Last warning: if you don't get lost right now, you'll regret you came here.", "That's it, mate, you asked for troubles.", "block", 1, npchar, Dialog.CurrentNode);
		...
		case "CaveCaribSit":
			...
			else
			{
				...
				link.l1 = LinkRandPhrase("Now I will tear out your tongue...","Now the world will have several cannibals less...","Well, seems that it's time to make a couple more holes in your perishable body, you red-faced ape.");
				link.l1.go = "fight";
			}
		...
		case "CaveCaribStay":
			...
			link.l1 = LinkRandPhrase("I will cut off your freaking head...","Now the world will have several cannibals less...","Well, prepare to meet your ancestors, red-skin. To the Hell with you!");
			link.l1.go = "fight";
		break;
