...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		...
		case "FMQM":
			...
			dialog.text = "Yes-yes, captain "+GetFullName(pchar)+". I saw your vessel entering our port and immediately sent my worker to you. Straight to the business then: you are a newcomer, but they say that you have already become a seasoned sailor and the fortune is on your side. This is why I have a business proposal for you.";
		...
		case "FMQM_1":
			dialog.text = "Have you ever heard of special resin the Spaniards produce on the island of Trinidad? It is a rare resource of strategic value used to fortify the hull of the ships. Every barrel costs a hefty sum because the Spanish direct all the resin for the needs of their Navy. Every colonial authority keeps a trade of this good under control, to put it simple, it's a pure contraband\nI need this resin for a special order. Of course, our store doesn't have it, same can be said about our local military warehouses or they simply didn't want to sell it. It's irrelevant really. What is relevant is that I need the resin and I know where to get some. All I need is a captain who is comfortable about boardings.";
			link.l1 = "I think, I am starting to see your point...";
			link.l1.go = "FMQM_2";
		break;
		
		case "FMQM_2":
			dialog.text = "Splendid. Now listen, a small trade convoy was located near Trinidad or to be more precise, in the harbor of San Jose. One ship is carrying a decent batch of the resin, the same resin that I am in dire need of. I will tell you more if you like the idea of plundering the enemies of our nation. What's your call?";
			link.l1 = "I like your proposal. I am ready to give it a try.";
			link.l1.go = "FMQM_3";
		...
		case "FMQM_exit":
			dialog.text = "Fine, it's your right to do what you want. Sorry for taking your time, captain.";
			link.l1 = "Goodbye.";
		...
		case "FMQM_3":
			...
			dialog.text = "Then listen: the convoy consists three ships, the resin will be among other goods on a "+sTemp+" called the 'Bensecho'. This is your main target. As I've said before, the Spanish are sailing from San Jose - Trinidad, to San Juan - Puerto Rico. They will set sail tomorrow, so you are free to choose where to attack them.";
			link.l1 = "Got it. What about a reward?";
			link.l1.go = "FMQM_4";
		break;
		
		case "FMQM_4":
			dialog.text = "All I am interested in is the resin. I will pay fifteen golden doubloons for every barrel of that stuff. According to my information, the 'Bensecho' carries around a hundred of barrels.";
		...
		case "FMQM_6":
			...
			link.l1 = "You think ahead of me, master. Very well. No wasting time them. I am on the way to set sail.";
			link.l1.go = "FMQM_7";
		break;
		...
		case "FMQM_9":
			dialog.text = "Excellent! Let's put your ship in docks as we agreed before. We will unload her there tonight. Go back to your ship and let me prepare the money for you.";
