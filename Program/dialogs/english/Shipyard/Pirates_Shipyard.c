...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
	...
	{		
		...
		case "First time":  // перехват основного диалога, только один раз
			...
			{
				Dialog.Text = "Phew... What kind of a terrible climate... My name is " + GetFullName(npchar) + ", and may the God damn me, if I'm not the best shipwright in these God-forgotten islands. But this humidity is just knocking me down...";
				Link.l1 = pcharrepphrase("A thousand sharks, I was just missing an old man's muttering. My name is " + GetFullName(pchar) + ", I believe you've heard about me.",
					"It's not humidity, it's the old age, sir. My name is " + GetFullName(pchar) + ", I believe you've heard about me.");
				Link.l1.go = "node_1";
		...
		case "node_1":
			...
			link.l1 = pcharrepphrase("That's right. But sooner or later an end comes to everything and looks like your time is near...",
				"Something tells me that during your young years, you didn't necessarily have much respect for elders either. Am I correct?");
			link.l1.go = "node_2";
		break;

		case "node_2":
			dialog.text = "Don't argue with your elders, puppy.";
		...
		case "shipyard_dlg":			
			...
			{
				dialog.Text = "I can propose to you a capital repair of your hull's frame. People don't have a clue on how to build decent ships here, they all fall apart from one shot...";						
			...
			{
					link.l50 = "I'm here about the reconstruction of the ship.";
		...
		case "ship_repair_start":
            ...
            else
            {
			    ...
			    else
			    {
                    ...
                    {
						dialog.Text = "Sheesh... Your ship is completely wrecked. I won't do a capital repair, don't even ask me... If you had come a little bit earlier...";
                    ...
                    {
						dialog.Text = "What's all this hocus pocus... Your ship looks as good as new... The frame is practically shining bright. There's nothing to repair here.";
						Link.l1 = "Fine... Well, I'll come later...";
    			        Link.l1.go = "ship_tunning_not_now";
    			        break;
					}
    ...
    " the shipmaster requires: ironwood - " + NPChar.Repair.Matherial1 + ", resin - "+ NPChar.Repair.Matherial2 + ", ship silk - " + NPChar.Repair.Matherial3 + " ropes - " + NPChar.Repair.Matherial4 + 
		...
		case "ship_repair_HP_again":
			...
			else
			{
			    ...
			    dialog.Text = "It seems to me, sir, that's you have changed your ship since the time of our last agreement. We'll have to recount everything all over again...";
		...
		case "ship_repair_HP_complite":
			...
			Link.l1 = "Thank you! I'd rather not experiment but I will trust you.";
			Link.l1.go = "Exit";
		...
		case "quests":
			...
			link.l1 = HeroStringReactionRepeat(RandPhraseSimple("I've changed my mind...", "I've got nothing to talk about at the moment."), "Umph, where has my memory gone...",
                      "Hm, well...", "Fine, let us...", npchar, Dialog.CurrentNode);
			link.l1.go = "exit";
			if (!CheckAttribute(npchar, "Step_Door"))
			{
				link.l2 = "Listen, I'd like to pass through and that door is locked...";
...
//*************************** Открывание двери ***************************
	...
	// ------------------------------------------- хронометр Ђлекса ----------------------------------------------// Addon-2016 Jason замена дублонов на песо везде
		...
		case "clock_begin_2":
			dialog.text = "I told him... The thing is our new leader has not that time nor the opportunity to find and bring these materials. You have to know what kind of a rarity it is. And there's no way I'll be able to build a frigate with the said characteristics without them.";
		...
		case "clock_begin_4":
			dialog.text = "I'm missing 100 unites of ironwood, 150 containers of resin, 110 rolls of ship silk, and 90 coils of hemp ropes. What do you think? Could you find me all of that in the course of four months? I don't think I have more time.";
			link.l1 = "I can at least try. And as for the payment?";
			link.l1.go = "clock_begin_5";
		break;
		
		case "clock_begin_5":
			dialog.text = "Here are my rates: ironwood at 4000 pesos per a piece, resins at 1400 pesos per a container, silk at 2500 pesos per roll, and ropes at 1500 pesos per coil. And if you bring all of that to me, you'll receive a very nice gift from me.";
			link.l1 = "What is it, I wonder?";
			link.l1.go = "clock_begin_6";
		break;
		
		case "clock_begin_6":
			dialog.text = "Bring me the materials first. But I assure you: it'll come well in handy for you, and the thing is unique. there isn't another on the Caribbean, or in the whole world as of yet. I hope that little spark of curiosity ignited your interest into gathering the materials for me.";
		...
		case "sandal": // бакаут
			...
			{
				iSum = 4000*iSan;
				dialog.text = "Fine, alright. I'm also going to need "+FindRussianQtyString(amount)+" of ironwood. You've brought me "+FindRussianQtyString(iSan)+". . So, what's left for you to bring me is "+FindRussianQtyString(iTemp)+". All right, at the rate of 4000 pesos per a piece, your reward totals at "+FindRussianMoneyString(iSum)+". Please, take it.";
			...
			{
				iSum = 4000*amount;
				dialog.text = "Fine, alright. I'm also going to need "+FindRussianQtyString(amount)+"  of ironwood. You've brought me "+FindRussianQtyString(iSan)+". So, we've taken care of the ironwood now! All right, at the rate of 4000 pesos per a piece, your reward totals at "+FindRussianMoneyString(iSum)+". Please, take it.";
				link.l1 = "Thank you!";
				link.l1.go = "clock_1";
		...
		case "oil": // смолы
			...
			{
				iSum = 1400*amount;
				dialog.text = "Fine, alright. I'm also going to need "+FindRussianQtyString(amount)+" resins. You've brought me "+FindRussianQtyString(iOil)+". So, we've taken care of the resins now! All right, at the rate of 1400 pesos per a container, your reward totals at "+FindRussianMoneyString(iSum)+". Please, take it.";
				link.l1 = "Thank you!";
				link.l1.go = "clock_1";
		...
		case "shipsilk": // шёлк
			...
			{
				iSum = 2600*iSil;
				dialog.text = "Fine, alright. I'm also going to need "+FindRussianQtyString(amount)+" silk. You've brought me "+FindRussianQtyString(iSil)+". So, what's left for you to bring me is "+FindRussianQtyString(iTemp)+". All right, at the rate of 2600 pesos per a piece, your reward totals at "+FindRussianMoneyString(iSum)+". Please, take it.";
				link.l1 = "Thank you! You'll have the rest soon.";
				link.l1.go = "clock_1";
			...
			{
				iSum = 2600*amount;
				dialog.text = "Fine, alright. I'm also going to need "+FindRussianQtyString(amount)+" silk. You've brought me "+FindRussianQtyString(iSil)+". So, we've taken care of the silk now! So, at the rate of 2600 pesos per a piece, your reward totals at "+FindRussianMoneyString(iSum)+". Please, take it.";
				link.l1 = "Thank you!";
				link.l1.go = "clock_1";
		...
		case "ropes": // канаты
			...
			{
				iSum = 1500*iRop;
				dialog.text = "Fine, alright. I'm also going to need "+FindRussianQtyString(amount)+" ropes. You've brought me "+FindRussianQtyString(iRop)+". So, what's left for you to bring me is "+FindRussianQtyString(iTemp)+". So, at the rate of 1500 pesos per a piece, your reward totals at "+FindRussianMoneyString(iSum)+". Please, take it.";
				link.l1 = "Thank you! You'll have the rest soon.";
				link.l1.go = "clock_1";
			...
			{
				iSum = 1500*amount;
				dialog.text = "Fine, alright. I'm also going to need "+FindRussianQtyString(amount)+" ropes. You've brought me "+FindRussianQtyString(iRop)+". So, we've taken care of the ropes already. All right, at the rate of 1500 pesos per a piece, your reward totals at "+FindRussianMoneyString(iSum)+". Please, take it.";
				link.l1 = "Thank you!";
				link.l1.go = "clock_1";
		...
		case "clock_5":
			dialog.text = "Ah, sorry for my fantasies. Being old is not easy, young man. Pardon me. But it's irrelevant. What's relevant is that a box with a gift for you is in the chest which is lying in the dungeon currently occupied by some scums. They are not our men, nor from Isla Tesoro\nTreasure hunters, someone must had told them that this place is full of treasures. They won't dare to show themselves right here, however I am too scared to visit them, see? Their faces are...";
			link.l1 = "I see. Open your door. I'll beat out your uninvited guests.";
			link.l1.go = "clock_6";
		break;
		
		case "clock_6":
			dialog.text = "Just like that? You'll beat them out? Alone? Aren't you scared? We have an enitre settlement that will fight for you if you only ask...";
		...
		case "clock_complete":
			...
			link.l1 = "That's right. They ended up being some polite nice guys. I explained to them that their presence is scaring the old famous shipwright and out of respect to you old age, they left the premises. You can go down there without a fret.";
		...
		case "clock_complete_3":
			...
			link.l1 = "Everyone has their secrets, don't they master? Fine... keep your secrets and I won't bud into your business. Thanks for the gift!";
	...
	// <-- хронометр Алекса
		...
		case "tieyasal_1":
			dialog.text = "Oh, sorry, young man. Don't pay much attention to my talking... Our curious Michel had satisfied his curiosity and disappeared. Only three days ago we had a chat.";
		...
		case "FDM":
			if(CheckAttribute(npchar, "quest.FDM_secondtime"))
				dialog.text = "Again with your 'ghost ship'... Know this - I'm only working with it in hopes that it will turn into something decent. Otherwise, I wouldn't even touch it. I think everyone at sea shares a similar opinion. What do you want to do with it this time?";
			else	
				dialog.text = "Ah, the 'ghost ship'! Mothers use your galleon to scare naughty kids. And you decided to keep that damned vessel instead of sinking it! Sailors tremble when they see your ship on the horizon... So, what do you want to do with it?";
			if (!CheckAttribute(npchar, "quest.FDM_cabin"))
			{
				link.l1 = "I like the idea of little cowards who are scared shitless. But the interior makes me sad. Have you seen the cabin? It feels like a coffin. All that mold and dust. I want to fix it. Can you do that, master?";
		...
		case "FDM_sails_do":
			...
			dialog.text = "Good. I have the coins, time to do my job. Walk around until it's done and don't you worry.";
			link.l1 = "Good...";
		...
		//--> Xenon
		case "FDM_hull":
			dialog.text = "Well, glad to finally hear that. And true enough - you seem to be a fine fellow, yet you're sailing on heaven knows what. But let me warn you upfront, this job is not just for a few hours, and it wall cost you a pretty penny. ";
			link.l1 = "Ok, can you be a bit more specific?";
			link.l1.go = "FDM_hull_01";
		break;

		case "FDM_hull_01":
			dialog.text = "Ok, let's calculate... For a complete overhaul of the ship's hull, I'll need 150 units of ironwood, 130 coils of ropes, 170 rolls of ship silk, and 200 barrels of resin. I'll take 250 thousand pesos for all this. And don't look at me like that - most of that money will go to work anyway! After all, we are not rebuilding a tartan.";
			link.l1 = "I think not. I am not up for hauling such a huge amount or materials along with paying a quarter million for the job. Guess, I'll keep sailing on it the way it is.";
		...
		case "FDM_hull_02":
			dialog.text = "Fine, less conversation, more action. I'll be waiting for the money from you so that I can start buying everything I need. Once I have the money, you can start bringing me the materials. And I'll get to working on your vessel.";
			if(sti(pchar.money) >= 250000)
			{
    			link.l1 = "Well, money is not a problem. I got it on me. Here you go, master.";
    			link.l1.go = "FDM_hull_waitmaterials";
            }
            else
            {
    			link.l1 = "At the moment, I don't have that kind of money. Wait a little, I'll bring it for you.";
		...
		case "FDM_hull_checkmaterials":
			...
			link.l5 = "Nothing yet. Just wanted to make sure that the deal is still on.";
			link.l5.go = "exit";
		break;
		...
		case "FDM_hull_checkmaterials_1":
			...
			{
				dialog.text = "Wonderful! All the materials are accounted for. Now, let me take that monster off your hands. At last, it will attain a proper look.";
				link.l1 = "Ok, enough grumbling, master. I'm eagerly awaiting the result.";
		...
		case "FDM_hull_givemoney":
            ...
            {
    			link.l1 = "Not yet, hang on, master.";
    			link.l1.go = "exit";
            }
		break;
