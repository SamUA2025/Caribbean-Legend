...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		...
		// Addon 2016-1 Jason пиратскаЯ линейка
		case "mtraxx":
            dialog.text = "You are talking in riddles, sir... Speak frankly what brought you here? Nothing to worry, I am not some kind of a pen pusher and here ain't a custom house.";
