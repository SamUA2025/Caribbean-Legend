...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		...
		case "Portobello_ratS_2":
			dialog.text = "No, mate, I haven't got a clue. I repair and sell ships, I don't track where they go. It's none of my business.";
			link.l1 = "Well then, gracias... Let's find out where you have gone...";
			link.l1.go = "exit";
