...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		case "quests":
			...
			{
				link.l1 = "I am interested in a ship named 'Cantavro'. I am looking for its captain - Esberdo Cabanas, for a private matter. Could you help me?";
				link.l1.go = "mtraxx";
			}
		break;
		
		case "Havana_ratP_1":
			dialog.text = NPCStringReactionRepeat("Yes, he was here. But he has gone already. Ask our tavern keeper about him, he has rented a room upstairs.", "You have already asked about this and I've answered.", "I tell you that you have already asked about this Gontier..", "I ask you to don't bother me!", "block", 0, npchar, Dialog.CurrentNode);
