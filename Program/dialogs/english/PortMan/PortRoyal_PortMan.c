...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		case "quests":
            ...
            {
                link.l1 = "Good day. Has Captain Francois Gontier registered here? He was sailing from Porto Bello on a corvette named '" + pchar.questTemp.Slavetrader.ShipName + "'.";
		...
		case "Jamaica_ratPP_1":
			dialog.text = NPCStringReactionRepeat("No he hasn't. And the corvette '" + pchar.questTemp.Slavetrader.ShipName + "' hasn't been seen at Port-Royal.", "You have already asked about this and I've answered.", "I tell you that you have already asked about this Gontier fellow.", "Please, don't distract me from my work!", "block", 0, npchar, Dialog.CurrentNode);
