...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		case "quests":
			...
			{
				link.l1 = "I'm looking for a galleon named 'Admirable' under the French flag. Its captain name was Gaius Marchais. Can you tell me where has he sailed to next? Perhaps, he has registered himself here?";
                link.l1.go = "guardoftruth";
			}
		break;
		
		case "guardoftruth":
			dialog.text = "Hmmm, 'Admirable'? Galleon? I remember it. Let's see here...we chartered it to deliver paprika to Bridgetown on Barbados. Something happen?";
		...
		case "guardoftruth_1":
			...
			link.l1 = "Off I go again, I guess.";
