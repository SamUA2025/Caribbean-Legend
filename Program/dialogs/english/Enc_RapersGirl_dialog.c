void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Begin_21":
			dialog.text = RandPhraseSimple("Rapists are chasing me!"+ GetSexPhrase(" Would you stand up for a lady's honor?","") +"","Captain, "+ GetSexPhrase("be a man","you're a woman, too") +" would you not save a girl from disgrace!");
			link.l1 = "Stop panicking"+ GetSexPhrase(", beauty","") +". What happened here?";
			link.l1.go = "exit_1";
		break;
		...
		case "ThanksForHelp":
			...
			if(pchar.GenQuest.EncGirl == "Begin_33")
			{
				...
				link.l1 = "Now that's the news! And what were you thinking crying out that you were chased by bandits?!";
				link.l1.go = "Node_31";
			}
		break;
		...
		case "Node_12":
			...
			link.l2 = "I am sorry, darling, but I simply have no time, I'm too busy.";
		...
		case "Node_22":
			...
			link.l2 = "No, that's it, "+ GetSexPhrase("beauty","dear") +"! I've had enough surprises for today. Look for somebody else to help you.";
			link.l2.go = "Node_3End";
		break;
		...
		case "Node_32":
			...
			link.l1 = "A crisis? Ha... For a real pirate, a crisis is when there is a trade caravan at the horizon, but no wind to fill the sails...";
		...
		case "Node_12End":
			Diag.TempNode = "Node_12End";
			dialog.text = RandPhraseSimple("You know, "+ GetSexPhrase("captain","young lady") +"? I was so scared even my legs are still a little wobbly.","Oh, you know, I was so frightened. It's great that God had sent you my way.");
			...
			switch(sti(pchar.GenQuest.EncGirl.variant))
			{
				case 0:
					if(rand(1) == 0)
					{
						...
						link.l1 = "Oh my god! What "+ GetSexPhrase("are these women thinking of","were you thinking of") +"?! Apparently, you have collected a lot of them, there was quite a number of suitors chasing you, I've had a hard time beating them all off. Ha-ha-ha-ha... Goodbye.";
						link.l1.go = "Node_1End";
					}
					else
					{
						...
						link.l1 = "What a carelessness?! Thank God I showed up in time. Well, best of luck to you.";
						link.l1.go = "Node_1End";
					}
				break;
				case 1:
					dialog.text = "My mistress spilled the pearls of her necklace somewhere here, when she was on a promenade. As she came home, she shouted at me and ordered to go out and collect them. She said, 'Don't even show your face here until you collect them all!', And I don't even know the exact place. Besides, how am I supposed to find them anyway in this thick grass? The pearls are so small... So, I am just wandering here without a clue on what should I even do...";
				...
				break;
				case 2:
					dialog.text = "My late father left me a map, and his companions wanted to take it from me. While he was alive, they were all trembling in fear before him, but just as I had buried him, troubled times began. First they attempted to buy this map from me, but I refused, and so they started to intimidate me.";
		...
		case "Node_131":
			...
			dialog.text = "That necklace was composed of selected pearls, those cannot be bought for cheap. There were " + sti(pchar.GenQuest.EncGirl.BigCoins) + " large pearls and " + sti(pchar.GenQuest.EncGirl.SmallCoins) + " smaller ones. If those pearls were found, we could commission another necklace like that one.";
			...
			link.l2 = "It's pointless. It'd be easier to find a needle in the haystack than the pearls in this thick grass. Not to mention that you don't even know the place where the pearls were lost...";
			link.l2.go = "Node_133";
		break;
		...
		case "Node_132_3":
			...
			link.l1 = "Well, don't sell it for too cheap. And, anyway, gold is not worth your life. Not to mention that this is the easiest way for you, you just collect your money and rid yourself of all troubles...";
		...
		case "Node_132_5":
			...
			{
				dialog.text = "Heh, being a woman is not easy... Alright, I agree. Finally this nightmare will be over... Perhaps, it's best that this map belongs to you,"+ GetSexPhrase(" a noble gentleman","") +", than to those rascals.";
		...
		case "Node_132_8":
			dialog.text = "And where will I find them? The young ones are not reliable, and they don't care much for treasures as much as, other things. And I fear the older ones, they all remind me of my dad's pals. So cunning and treacherous, you would never know what to expect of them.";
		...
		case "Node_132_12":
			dialog.text = "Here! I found it! Just like my father said! A huge pile of treasure! The half is yours, as agreed.";
		...
		case "Node_132_20":
			dialog.text = "Hold on... This trinket was among my father's treasures. I have no use for it, but you might like it. Please, accept it as my personal gratitude for what you've done for me. That's from my share, ha-ha-ha!";
			link.l1 = "Wow, now that's a really nice gift. Thank you"+ GetSexPhrase(", beauty","") +". Find a nice groom for yourself will you...";
		...
		case "Node_134_1":
			...
			link.l1 = "Wow! Well, thank you as well"+ GetSexPhrase(", beauty","") +", I did not expect... Goodbye, and be happy.";
		...
		case "Node_200":
			if(rand(1) == 0)
			{
				...
				link.l2 = "Wow! Why do you have such aversion for men?";
				link.l2.go = "Node_201";
			}
			else
			{
		...
		case "Node_202":
			dialog.text = "He used to be a captain of a pirate ship. Recently he died... They all were so courteous during the burial, but as time passed, they have forgotten him, and soon after their honor and honesty as well. It's good that I had noticed them. As soon as they learn where the treasure are, I am done for.";
		...
		case "Node_210":
			...
			link.l1 = "You're good to go, "+ GetSexPhrase("beauty","dear") +". And you'd rather hurry to the town, before they chase you again.";
			link.l1.go = "Node_1End";
		break;
		...
		case "Node_228":
			...
			{
				dialog.text = "Oh, my noble savior, finally I can thank you enough in that way only a woman can thank\nWhen I saw you in the jungle, everything changed inside me. I forgot about the rapists and sharp palm leaves that whipped down my cheeks. Forgot where to run, why run ... I only saw you. And just wanted you ... And after what you've done for me...";
				link.l1 = "Wow! What a temper! Your pursuers surely knew whom to chase...";
		...
		case "Node_233":
			...
			dialog.text = "My family lives in the settlement of " + XI_ConvertString("Colony" + pchar.GenQuest.EncGirl.Parents_City) + ". I got here by chance, on the ship, on which my groom was taking me to his parents, but it got captured by pirates. The ship was taken away, and the passengers were landed at the bay not far from here. My groom was killed during boarding of the ship, and I was seriously ill during the transition through the jungle\nMa'am of the local brothel has treated me, and when I got on my feet, she demanded to work money spent on treatment. I was a whore but I didn't please the Madame, and so Ma'am sold me to some bandits to earn at least some money. The other part of story you know.";
			link.l1 = "So just quit and return home! Why are you allowing them to treat you like a slave?!";
			link.l1.go = "Node_234";
		break;
		
		case "Node_234":
			dialog.text = "I can't! All of my belongings: decent clothing, money, documents... They are all in the brothel in my travelling bag. I've hidden it in the dating room. And while I am dressed like that, all sailors in the port will be running after me. And who will take me on board without documents or money? And now I can't even show my face in the town, or I'll be thrown behind bars...";
		...
		case "Node_235":
			...
			link.l1 = "What payment are you talking about? Let's go before they are found...";
			link.l1.go = "Node_240";				
		break;
		...
		case "Node_242":
			dialog.text = "Did they really found my bag?";
			if(sti(pchar.money) >= 5000)
			{
		...
		case "Node_250":
			dialog.text = "Don't ruin my life, captain! My father wants me to marry the usurer's son, that filthy milksop... just because his daddy has a shitload of money in his coffers! Well, I'd rather stay in the jungle to be devoured by wild beasts than take a life sentence with him!";
		...
		case "Node_261":
			dialog.text = "Can you take me to the tavern? I need to wait for my auntie and take some rest, this 'adventure' had drained all of my energy...";
		...
		case "ThanksForHelp_1":
			...
			else 
			{
				if(drand(1) == 0)
				{
					dialog.text = "I will tell everybody that you have saved me! Let everybody know, "+ GetSexPhrase("what a brave and courageous man you are","what a brave and courageous lady you are") +"!";
