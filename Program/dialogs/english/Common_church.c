...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "First time":
            ...
            if (npchar.quest.BadMeeting != lastspeak_date)
			{
				...
				if(CheckAttribute(PChar, "GenQuest.ChurchQuest_1.QuestTown") && PChar.GenQuest.ChurchQuest_1.QuestTown == NPChar.city && CheckAttribute(PChar, "GenQuest.ChurchQuest_1.Complete"))
				{
					...
					link.l1 = "Yes, " + RandPhraseSimple("padre", "holy Father") + ", though not always the following wind blew in my sails, though I spent some more time, forces and money - your mission is done.";
				...
				{
					dialog.text = "Greetings, Ellen, my child.";
					link.l1 = "And to you, Father.";
				}
				link.l1.go = "node_3";
			...
			{
				Dialog.Text = "Go away from the temple of the Lord, blasphemer! We have nothing to talk about!";
		...
		case "node_3":
			if(startHeroType == 4 && NPChar.location == "SantaCatalina_church")
			{
				dialog.text = "I'm glad that despite your... pursuits with Jan, you don't forget our Lord and His house. How can I help you?";
			}
			else
			{
			...
			{
				link.l4 = "I want to order a prayer service for the peace of the soul of one lady.";
				link.l4.go = "saga";				
			}
...
// Jason-------------------------------------------------Сага----------------------------------------------
		...
		case "saga_3" :
			dialog.text = "Well, how! Each month, Alvarez, the guard of our lighthouse for two decades, orders a prayer service for the peace of the soul of this lady. Anyone but him still hasn't cared about Lady Gonzales. And you come here. So I thought. However, it is not my business. Certainly, I will be glad to humbly carry out your wishes to help the stray soul find calmness and the road to paradise.";
			Link.l1 = "Thank you, holy Father.";
			Link.l1.go = "saga_4";
		break;
		...
		case "saga_5" :
			dialog.text = "Is there anyone else's soul you'd like to order a requiem for?";
			Link.l1 = "Mmm... No, I don't think so. Do I need to order for someone else?";
			Link.l1.go = "saga_6";
		break;
		
		case "saga_6" :
			dialog.text = "Well, perhaps for the hundreds of innocent people who fell by your hand or the blades of your godless companions when you plundered this unfortunate city?.. However, a humble priest is unlikely to hope to reach the conscience of a man who killed simple peaceful citizens without remorse...";
			Link.l1 = "Father, you don't understand... That's all in the past. Here and now, I don't intend to harm anyone.";
			Link.l1.go = "saga_7";
		break;
		
		case "saga_7" :
			pchar.questTemp.saga7 = true;
			dialog.text = "Can I trust your word...? But, in any case, this is holy ground that should not be covered in blood. So, I won't call the guards. Go in peace. Perhaps before you face God's judgment, you'll have time to redeem at least part of your sins.";
			Link.l1 = "Perhaps. God's will be done.";
			Link.l1.go = "saga_4";
		break;
		// <-- Чика Гонсалес
		...
		case "treatment_3":
			dialog.text = "This poor sinner confessed quite a few times with me. Hatred completely destroyed her from the inside. I knew what she was up to. I attempted to stop her, tried to make her follow the straight and narrow, but all my efforts were in vain. I warned her about the terrible danger and dire consequences of the unholy deeds...";
			link.l1 = "Yes, holy Father. What I have seen, was terrible indeed. But... how can I be cured?";
			link.l1.go = "treatment_4";
		break;
		
		case "treatment_4":
			dialog.text = "By the power of prayer, my son. By the power of the holy cleansing prayer at our temple. You will have to pray for very long, and not only for yourself. You'll have to pray for her as well.";
			link.l1 = "For Jessica?";
		...
		case "treatment_6":
			dialog.text = "Everything is in the hands of the Lord. I will teach you how to pray and leave the Holy Scripture for you. The power of holy prayer shall destroy foul spells which befell you, and also cleanse the soul of poor Jessica.";
		...
		case "treatment_9":
			dialog.text = "Well, my son. Give them to me and come back tomorrow after ten o'clock in the evening. I will teach you the necessary prayers and leave you in the church for the night.";
		...
		case "seektreatment_1":
			...
			{
				dialog.text = "I have heard of those... They were brought into our world by unholy witches of these red-skinned pagans. I would advise you to see the father superior of the church of Bridgetown - he had spent several years studying the pernicious influence of Indian curses on the bodies and souls of Christians.";
		...
		case "seektreatment_2":
			dialog.text = "Don't despair, my son. The Lord will hear you and He will send you help. But I would recommend you to ask around in other holy abodes - perhaps there are priests who know how to remove pagan curses.";
		...
		case "findtreatment_1":
			dialog.text = "It was not hard to see it, looking at your step as you approached me, my son. May the Lord be merciful to our sinful souls... Tell me, my son, and be honest - who has placed these enchantments upon you?";
		...
		case "GenQuest_Church_2_Start_3":
			dialog.text = "Under the cloud of night, some scoundrels snatched everything collected by the parish! These blasphemers have taken even the sacrificial chalice!";
		...
		case "GenQuest_Church_2_Start_4":
			...
			link.l1 = "I have no doubt this it is a most effective measure. But I meant something more practical. To organize pursuit, for example.";
			link.l1.go = "GenQuest_Church_2_Start_5";
		break;
			
		case "GenQuest_Church_2_Start_5":
			dialog.text = "Ah, what can a simple priest, bound by the vow of non-resistance to evil, do? These scoundrels are certainly already far from here, drinking away in taverns amassed by robbery or giving in to debauchery and dissipation in the company of fallen women! I do hope they will meet their end there!";
			link.l1 = RandPhraseSimple("I am sure, that such an end is much more attractive, than to be hanged. However, I will not distract you anymore. All the best.", "Well, one time, sooner or later, we will all go to the forefathers, but I wouldn't say no to a faster end for them. However, I have to go. Good luck.");
			link.l1.go = "exit";
			link.l2 = LinkRandPhrase("Holy Father", "Padre", "Father") + ", but I am unburdened by any vows and with readiness I will help the Lord to bring about the time of retribution.";
		...
		case "GenQuest_Church_2_Thief_4_1_3":
			...
			{
				dialog.text = ""+ GetSexPhrase("My son","My daughter") +"... With the tears of repentance and gratitude, I shall accept this chalice from you as a sign of the Lord's mercy and forgiveness. The purity and nobility of your soul have truly shaken me. I bless you with all my heart!";
				link.l1 = "Thank you for the blessing, " + LinkRandPhrase("padre.", "Father.") + ".";
				link.l1.go = "GenQuest_Church_2_Thief_4_1_4";
				link.l1 = "Benediction is certainly necessary, but it wouldn't hurt to support it with something more material, considering the considerable expenses I incurred...";
		...
		case "GenQuest_Church_2_Thief_4_1_6":
			...
			dialog.text = "Oh, child, I am truly sorry... I hope this small contribution of " + FindRussianMoneyString(iMoneyToCharacter) + " will be enough to cover your expenses?";
		...
		case "GenQuest_Church_2_Thief_4_2_3":
			...
			{
				dialog.text = "What is there to explain?! Now, look - you're a "+ GetSexPhrase("clever man","clever girl") +", and surely you must understand that whatever these crooks might have told you - that I had supposedly hired them - is a blatant lie! The Lord shall punish these blasphemers not only for sacrilege, but also for false evidence!";
		...
		case "GenQuest_Church_2_Thief_4_2_4_1":
			dialog.text = "Mmmm... "+ GetSexPhrase("My son... Mister... Sir...","My daughter... Miss... Lady...") +" " + PChar.name + "... I am ready to bend before you... and consider our disagreements, so to say... and compensate your expenses with this modest sum of " + FindRussianMoneyString(iMoneyToCharacter) + "... of course, if you are not going to involve others in this affair...";
		...
		case "GenQuest_Church_2_Finally_Complete_1":
			...
			{
				link.l1 = "Dire news, " + LinkRandPhrase("Father", "Padre", "Father") + ": the robbers were too treacherous and resourceful, and so I failed to get the church gold back...";
			...
			{
				link.l1 = "Dire news, " + LinkRandPhrase("Father", "Padre", "Father") + ": I managed to catch up with the robbers, but my only trophy was this chalice.";
			...
			if(CheckAttribute(PChar, "GenQuest.ChurchQuest_2.Complete.With_All"))
			{
				...
				{
					link.l1 = "I am certain, that you'll like the news - I approximately punished robbers and took away parish money from them, and also this chalice.";
					link.l1.go = "GenQuest_Church_2_Finally_Complete_1_2_1";
				}
				// Деньги можно заныкать.
				link.l2 = LinkRandPhrase("Father", "Padre", "Father") + ", I've brought bad news... I had to spend plenty of time, forces and resources to hunt down the scoundrels, but when I found them, i discovered that they had the time to drink away and spend everything, except this chalice...";
			...
			if(CheckAttribute(PChar, "GenQuest.ChurchQuest_2.Complete.Short_With_Mon"))
			{
				...
				// Деньги можно заныкать.
				link.l2 = LinkRandPhrase("Father", "Padre", "Father") + "... I have to disappoint you. I have been pursuing robbers all over the archipelago, overcame a great number of dangers and barriers, almost ruined oneself, and eventually overtook them, but alas... they already had time to squander church money.";
				link.l2.go = "GenQuest_Church_2_Finally_Complete_1_3_1";
			}
		break;
		...
		case "GenQuest_Church_2_Finally_Complete_1_3_1": // ГГ решил заныкать деньги...
			if(rand(1) == 0)	// Священник верит ГГ но не даёт денег...
			{
				...
				{
					dialog.text = "Oh, "+ GetSexPhrase("my son","my daughter") +". Your words plunged me into deep sorrow - but not despair, because desperation is a mortal sin! The Lord faced us with another trial in order to strengthen our faith.";
						link.l1 = "Amen, Father...";
						link.l1.go = "exit";
						sQuestTitle = NPChar.City + "ChurchGenQuest2";
			...
			else
			{
				...
				iMoneyToCharacter = sti(PChar.GenQuest.ChurchQuest_2.MoneyToCharacter);
				dialog.text = "Oh, "+ GetSexPhrase("my son","my daughter") +". Your words plunged me into deep sorrow - but not despair, because desperation is a mortal sin! The Lord faced us with another trial in order to strengthen our faith. But your efforts and expenses should be compensated, despite being fruitless. Please, accept this modest sum - " + FindRussianMoneyString(iMoneyToCharacter) + " - and continue your righteous path!";
		...
		case "GenQuest_Church_2_Finally_Complete_1_4_1_2":
			dialog.text = "Get out and thank the Almighty, who had given me a meek heart. It's the only reason that you're still not marked as a thief and rogue!";
		...
		case "GenQuest_Church_2_Finally_Complete_1_2_2":
			dialog.text = ""+ GetSexPhrase("My son","My daughter") +", I want to reward you properly, you"+ GetSexPhrase(", like a true knight of Mother Church,","") +" did everything in power overca...";
		...
		case "donation":
			dialog.Text = "Of course, "+ GetSexPhrase("my son","my daughter") +". How much would you like to donate to the Holy Church?";
		...
		case "GenQuest_Church_1_Start_2":
			...
			dialog.text = "Oh! Good... But, again, this is a very delicate business... Some time ago father superior " + PChar.GenQuest.ChurchQuest_1.ToName + " from " + XI_ConvertString("Colony" + PChar.GenQuest.ChurchQuest_1.ToColony + "Gen") + " on " + XI_ConvertString(PChar.GenQuest.ChurchQuest_1.ToIsland + "Voc") + "borrowed a few theological works and ancient manuscripts from a church library for me for a while. Because the request was supported by the insistence of the archbishop not to prevent the distribution of the lovely light of knowledge, I couldn't refuse, even though I presumed that difficulties of sea voyages wouldn't allow him to return the manuscripts in time... Could you assist me in solving this problem?";
		...
		case "GenQuest_Church_1_Dialog_1":
			if(CheckAttribute(PChar, "GenQuest.ChurchQuest_1.2A_Scene"))	// Сцена 2а
			{
				...
				link.l1 = "But, " + LinkRandPhrase("Father", "Padre", "Father") + ", the parishioners of Father " + PChar.GenQuest.ChurchQuest_1.PriestName + " are also in need of salvation, and without these works, he will lack the support of the pillars of theology, and his sermons will lack inspiration.";
		...
		case "GenQuest_Church_1_Dialog_1_1": // Сцена 2а
			dialog.text = "I understand, my child, but don't we pray to our Lord every day: 'and forgive us our trespasses, as we forgive those who trespass against us'? And the church of " + XI_ConvertString("Colony" + PChar.GenQuest.ChurchQuest_1.QuestTown + "Gen") + " more rich than my modest parish.";
		...
		case "GenQuest_Church_1_Dialog_1_1_1":
			dialog.text = "T-T-To the a-archbishop?! Because of such a little matter!.. Why? Really? I was going to send these works to my beloved brother in Christ anyway - it's just there wasn't a good opportunity to deliver them to him. But in you, "+ GetSexPhrase("my son","my daughter") +", I see a truly deserving servant of our Lord. Here - take these books and manuscripts and please deliver them to Father " + PChar.GenQuest.ChurchQuest_1.PriestName + " safe and sound. And also add to that my most sincere gratitude.";
		...
		case "GenQuest_Church_1_Dialog_1_2":	// Сцена 2б-а и 2б-б
			...
			{
				dialog.text = "But, "+ GetSexPhrase("my son","my daughter") +"... You see, the thing is that last week I met a captain of vessel '" + sld.Ship.Name + "', where I was called to administer communion of a dying sailor. To my great joy, captain " + GetFullName(sld) + " told me that he was going to " + XI_ConvertString("Colony" + GetColonyExpect2Colonies(NPChar.city, PChar.GenQuest.ChurchQuest_1.QuestTown)) + ". And although he didn't warrant any terms, he still agreed to help and assured me that the port of " + XI_ConvertString("Colony" + PChar.GenQuest.ChurchQuest_1.QuestTown + "Gen") + " he will certainly visit. So I took advantage of this opportunity, sent away books with that kind man and handed their further fate to Lord.";
		...
		case "healthAdd_info":
			dialog.text = "That's very simple, "+ GetSexPhrase("my son","my daughter") +". You take damage each time you're wounded. That doesn't pass without a trace. Your health worsens with every wound, and, as a result, you become weaker. Your crew, seeing a weak captain, loses respect for you. However, you become more careful, and the ability to defend yourself increases temporarily. Rest and minimizing wounds will help you stay full of strength.";
		...
		case "healthAdd_4":
			dialog.text = "One hundred thousand pesos pesos will be a sufficient payment for the miracle of healing.";
			link.l1 = pcharrepphrase("What?!! Are you totally crazy? I'd pay such a sum once I robbed a couple of churches!", "That's too much for me. They say the truth - health cannot be bought for money.");
			link.l1.go = "exit";
		...
		case "HostessChurch_ok_1":
			dialog.text = "I accept it, "+ GetSexPhrase("my son","my daughter") +". Tell this donator of yours about it.";
			link.l1 = "Alright, padre. Thank you.";
			link.l1.go = "exit";
			AddMoneyToCharacter(pchar, -sti(pchar.questTemp.different.HostessChurch.money));
			AddCharacterExpToSkill(pchar, "Fortune", 20);
		...
		case "Churchbooks":
			dialog.text = "You've been sent to take prayer books from us - for the church of "+XI_ConvertString("Colony"+pchar.GenQuest.Churchbooks.StartCity+"Gen")+"? Well. I have a package with thirty prayer books. Take it, my son.";
