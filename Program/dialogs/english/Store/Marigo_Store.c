...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
	...
	switch (Dialog.CurrentNode)
	{
		case "quests":
			...
			{
   				link.l1 = "Listen, I need some fancy clothes. Expensive, I want to look like a proper nobleman. Do you have anything of the sort?";
				link.l1.go = "Portugal_cloves";
			}
			//<-- Португалец
			if (CheckAttribute(pchar, "questTemp.Guardoftruth") && pchar.questTemp.Guardoftruth == "maarten")
			{
				link.l1 = "A galleon named 'Admirable' has brought you a cargo of hides recently. Do you recall that?";
		...
		case "Portugal_cloves":
			dialog.text = "Noble clothes? Sure, I've got a set lying here: pants, a jerkin, a silk shirt, and boots. It costs 20,000 pesos. The clothes are very high quality, they're comfortable, and have a remarkable look, so I won't take any less for it.";
