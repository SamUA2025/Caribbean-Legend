void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		case "First time":
			...
			{
				dialog.text = TimeGreeting() + "! I've never seen you before, senor. Dare I assume, you're a captain... Did I guess right? My name is "+GetFullName(npchar)+", and my store is at your service. Gold, silver, and much more to pique the interest of a curious man.";
			...
			{
				dialog.text = TimeGreeting() + ", senor! I'm glad to see you again in my store. Would you like to acquire some gold nuggets? Or possibly you'd be interested in minerals today?";
		...
		case "meeting":
			dialog.text = "As am I, senor. Will you have a look at my merchandise? I'm sure I have something that'll be of interest to you.";
