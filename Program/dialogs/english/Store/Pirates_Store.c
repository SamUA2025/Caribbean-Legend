...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
	...
	switch (Dialog.CurrentNode)
	{
		...
		case "mtraxx_5":
			...
			if (iTotalTemp < 1)
			{
				dialog.text = "Are you kidding me young man? Your cargo holds do not have a single plank of ebony in them! This is an insolent trickery! Get out of here! I will inform Marcus of this! Get out!!!";
				link.l1 = "Hm...";
				link.l1.go = "mtraxx_6";
				break;
			}
			...
			{
				dialog.text = "Are you kidding me boy? Your cargo hold has only a few splinters of ebony! This is an insolent trickery! Get out of here! I will inform Marcus of this! Get out!!!";
				link.l1 = "Hm...";
				link.l1.go = "mtraxx_6";
				break;
			}
			...
			link.l1 = "150 pieces of eight? I guess that ebony costs much more.";
