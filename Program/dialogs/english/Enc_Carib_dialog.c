void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "war_indian_1":
			...
			link.l1 = RandPhraseSimple("You still can't shut your smelly mouth, painted scarecrow? I will drive you back to the jungle where you came from!","You dare to threaten me, scum?! Well, now you will climb back up the tree you just came down from!");
		...
		case "war_indian_trade_agree":
			...
			{
				dialog.text = "Fine. Here you goods. You have more fiery weapon to trade?";
				if (CheckCaribGuns())
				{
		...
		case "peace_indian_2":
			...
			link.l1 = RandPhraseSimple("You still can't shut your smelly mouth, painted scarecrow? I will drive you back to the jungle where you came from!","You dare to threaten me, scum?! Now you will climb back up the tree you just came down from!");
			link.l1.go = "exit_fight";
		break;
	}
}
