	...
	switch(Dialog.CurrentNode)
	{
		...
		case "First Time":
			...
			dialog.text = LinkRandPhrase(LinkRandPhrase("Stand where you are and drop your weapon! Your money or your life!",
				...
				"Stand where you are, "+ GetSexPhrase("traveler","lass") +"! This is a toll road. If you wanna pass you pay the toll."),
				LinkRandPhrase("Hey, "+ GetSexPhrase("mate","lass") +"! Not so fast! I want to see how heavy your purse is.",
				"Would you come closer, friend. I want to hear the jingle of gold in your purse.",
				"Hold on, "+ GetSexPhrase("mate","lass") +". Me and guys bet on how much gold will fit into your purse. Now we must check it before things get violent."),
			...
			Link.l2 = LinkRandPhrase(LinkRandPhrase("Brigands?! Excellent, I was longing for a fight!", 
				...
				"I will not waste words with you, but you'll find my pistol to be very eloquent!",
		...
		case "Node_2":
			dialog.text = LinkRandPhrase(LinkRandPhrase("Don't play a fool! Cash on the nail and maybe then I will let you go!",
				...
				RandPhraseSimple("It's very simple. You give us all your gold and then you are free to leave, or you stay here, and we take off all your gold, anyway. But I think that the later is not what you would like, he-he.",
				"Don't pretend you don't understand! Give me your purse if you don't want me to take it from your dead body!"),
				"I'll explain, if you're so slow-witted. You give me all your money, if you cherish your life.");
			...
			Link.l2 = LinkRandPhrase(LinkRandPhrase("You want my money? Come and get it, and I will see how much you're worth!",
				...
				"What a self-confidence! Well, let's see how you stand against a real "+ GetSexPhrase("sea wolf","Louve des mers") +"!"),
			...
			else
			{
				...
				else
				{
					...
					Link.l2 = RandPhraseSimple(LinkRandPhrase("He-h, I'm not gonna obey orders from such a wimp like you.", 
						"I'll make a couple of new holes in your skull 'cause of such impudence! Just to ventilate your brain a bit.",
						"Such impudence won't go unpunished!"),
		...
		case "CheckSkills":
			...
			if (z_ok || CheckCharacterPerk(pchar, "SeaDogProfessional"))
			{
				...
				dialog.text = LinkRandPhrase(RandPhraseSimple("Hey, don't get so excited, "+ GetSexPhrase("mate","lass") +"! I was just joking! You can continue your way!",
					...
					"Relax, "+ GetSexPhrase("mate","lass") +". You see, we were mistaken, "+ GetSexPhrase(" we thought you were a merchant"," we thought you were a merchant") +". You can go.");
				Link.l1 = LinkRandPhrase(LinkRandPhrase("Alright, until we meet again!",
					"You ought to quit robbing people, while you still can.",
					...
					RandPhraseSimple("This criminal trade will surely kill you in the end. Farewell.",
					"That's a wise decision. Well, good luck!"));
				Link.l1.go = "Exit_NoFight";
				Link.l99 = LinkRandPhrase("No, mate. Now I'll teach you some good manners!",
			...
			{
				dialog.text = LinkRandPhrase("And you could have gone in peace! Now you can only blame yourself!",
								"You shouldn't have started it, you rascal! Now you're gonna die like a dog!",
								"Ah well! I'll tear you to pieces! Cut out the liver and feed it to the dogs!");
		...
		case "CheckMoney":
			if(makeint(makeint(Pchar.money)/20)*10 >= makeint(Pchar.rank)*100)
			{
				...
				dialog.text = LinkRandPhrase(RandPhraseSimple("Alright! Give it to me and get lost!",
					...
					"Now that's a different story! Like one my friend was saying 'it's always good to listen to someone who is smart, but talking with the fool is much better'! He-he!",
					"In exchange for your gold I will give you an advice, you should not walk in the jungle, if you're "+ GetSexPhrase("such a wimp. Drink your rum at the tavern, so that you and your purse remain safe!","a lass. Being robbed is not the worst that could have happened to you.") +".");
				Link.l1 = "Damn you!";
		...
		case "OnceAgain":
			...
			dialog.text = LinkRandPhrase("You again? Run home to your mommy, before I am angry with you!",
				...
				"Look, "+ GetSexPhrase("mate","lass") +", I'm fed up with you! Get out of my sight while you're still alive!");
			Link.l1 = "Yeah, I am already leaving.";
			Link.l1.go = "Exit";
			Link.l2 = "I thought that it wouldn't be fair. Therefore I decided to set things straight...";
		...
		case "GetLost":
			...
			dialog.text = LinkRandPhrase("What else do you need? We have already agreed that you're leaving!",
				"Leave me be, "+ GetSexPhrase("fellow","lass") +". I mind my own business, and you have your own, and we shouldn't try to get along!",
				"Leave now, "+ GetSexPhrase("mate","lass") +"! Goddammit, are you really willing to give away all your money?");
			Link.l1 = "Yeah, I am already leaving.";
			Link.l1.go = "Exit";
			Link.l2 = "I've remembered that you didn't say goodbye! So let us say a proper goodbye...";
			Link.l2.go = "Exit_Fight";
		break;
		...
		case "GetTheHellOut":
			...
			Link.l1 = LinkRandPhrase(LinkRandPhrase("If you had stayed at home, you would have lived on!",
				...
				"You should have known that there are always consequences!"),
				"Sooner or later, this was bound to happen.",
				"Too late to repent, now fight scum!");
			Link.l1.go = "exit_Fight";			
		break; 				
	}
}
