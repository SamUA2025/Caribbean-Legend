	...
	switch(Dialog.CurrentNode)
	{
		...
		case "First time":
			if (LAi_group_GetPlayerAlarm() > 0)
			{
				...
				if(pchar.questTemp.Slavetrader == "After_enterSoldiers" && pchar.questTemp.Slavetrader.UsurerId == npchar.id)
				{
					...
					link.l1 = "Alright, I will sail out!";
					link.l1.go = "exit";
					break;
				}
				//<-- работорговец
       			...
       			dialog.text = NPCharRepPhrase(pchar, 
					LinkRandPhrase("The town is on alarm and they are searching for you everywhere! If I were you I would not stay here for long.", "All guards are looking for you. I am not an idiot and won't risk talking to you!", "Run, "+ GetSexPhrase("pal","girl") +", before soldiers make a sieve from you..."), 
					LinkRandPhrase("What do you want, vile creature?! Town guards are aware of your position and you won't run away, "+ GetSexPhrase("filthy pirate","you pirate whore") +"!", "Dirty murderer, get away from my place! Guards!", "I don't fear you, vile creature! Soon you'll be hanged in our fort, you won't get away..."));
				link.l1 = NPCharRepPhrase(pchar,
					RandPhraseSimple("Heh, it's not a problem for me...", "They'll never get me."), 
					RandPhraseSimple("Shut your mouth, " + GetWorkTypeOfMan(npchar, "") + ", or I will cut your bloody tongue!", "Heh, " + GetWorkTypeOfMan(npchar, "") + ", want to catch a pirate too? Listen, lad, sit here quietly and you will live..."));
				link.l1.go = "fight";
				break;
			}
		//Jason ---------------------------------------Бремя гасконца------------------------------------
			if (CheckAttribute(pchar, "questTemp.Sharlie.Lock") && pchar.location == "Fortfrance_bank")
			{
				...
				{
					link.l4 = "Take a look at these earrings, monsieur. I've found them in the pocket of a bandit in the jungle. This is clearly the work of a fine jeweler which, I'm sure, is not from this wilderness. What do you say?";
		...
		//<-- Бремя гасконца
			...
			if (pchar.questTemp.Slavetrader == "canTakeQuest" && pchar.questTemp.Slavetrader.UsurerId == npchar.id)
			{
				...
				Link.l1 = "I suppose that your clients won't be glad to hear such words from the man who holds their savings.";
			...
			{
				dialog.Text = "...";
				Link.l1 = "Listen, old hamster, you've really to do your best now to explain me everything! There were no slaves in that ship's cargo but a company of soldiers! It was a really tough mission to deal with them! I am very angry, so you'd better explain yourself!";
			...
			{
				dialog.Text = "Hm.. You are still alive? Strange. But it won't last long. Soldiers! Help! I've got a bandit here!";
			...
			{
				dialog.Text = "...";
				link.l1 = "Hey there, you bastard. Did you have a bright idea? Hired thugs to kill me? Wanted to shut me down? Speak, now!";
				link.l1.go = "FMQG_x";
				break;
			}
			...
			if(NPChar.quest.meeting == "0")
			{
				...
				link.l1 = RandPhraseSimple(LinkRandPhrase("My pleasure! I have just been walking around the town and decided to visit you.","My pleasure, I am "+GetFullName(pchar)+", nice to meet you.",""+GetFullName(pchar)+" , captain of the ship named "+pchar.ship.name+" , glad to meet you. This is a bank, right?"), RandPhraseSimple("Nice to meet you. I am "+GetFullName(pchar)+". A captain of the ship named "+pchar.ship.name+". I've just wanted to get to know you.","Aha, so you have a bank here, right? Glad to meet you, I am "+GetFullName(pchar)+", a captain of my own vessel."));
				link.l1.go = "next";
			...
			{
				dialog.Text = pcharrepphrase(LinkRandPhrase(LinkRandPhrase("It's you! What do you want, "+GetAddress_Form(NPChar)+"?","What's your business here, captain? I'm sorry but your reputation doesn't make you a very desired client.","Aha, another client! At first I thought that you were a robber... ha-ha I'm just joking."),LinkRandPhrase("Oh! What do you want? It's a bank not a tavern.","Good day to you, captain. I must inform you that I'm quite selective in choosing my clients.","What do you want, "+GetFullName(pchar)+"? I hope that you remember that your renown won't let you to raise a large loan?"),LinkRandPhrase("I hope that you want to invest money, "+GetAddress_Form(NPChar)+"? It won't be easy to raise a loan for you.","Captain "+GetFullName(pchar)+" what do you want from the modest banker? I'm sorry but I won't be able to arrange a loan for you. You can only lend money to me on interest.","Come in, "+GetAddress_Form(NPChar)+". I am sorry to inform you that you are not the most welcome client but I don't usually reject people immediately.")),LinkRandPhrase(LinkRandPhrase("Hello, sir "+GetFullName(pchar)+"! I am always ready to help you in business problems.","Hello, sir "+GetAddress_Form(NPChar)+". I am always ready to raise a loan or accept any investment.","Dear "+GetFullName(pchar)+"! Glad to see you! What do you wish?"),LinkRandPhrase("Captain "+GetFullName(pchar)+"! I am always at your service. Want to raise a loan or invest money on interest?","Greetings to you captain! You are always a desired client here. You have got an excellent business renown!","Good day, "+GetFullName(pchar)+". I am glad that you've visited me again. Hope that you came for a profitable business agreement?"),LinkRandPhrase("Good day to you, captain! What do you want? Want to raise a loan or make an investment?","Captain "+GetFullName(pchar)+"! Do you want to lend money with a profitable terms? I am always glad to see such a respectable client.","Glad to see you again, captain! I am always ready to help you, whether it's to raise a loan or to make an investment.")));
				link.l1 = pcharrepphrase(RandPhraseSimple(LinkRandPhrase("No kidding, banker, I've got a business here.","Too much talking, pal. Let's get straight to business.","Have you heard that money has no smell? So close your nose and let's get down to the business."), LinkRandPhrase("And this is how you meet your clients? Lucky for you that I am in a good mood today.","Ha! Aren't you glad too see me, huh? And am I not a golden doubloon to make a positive impression on you. Anyway, let's do business, usurer.","Eh, I'd like to teach you some respect but I have no time for this. Let's talk about money instead.")),
				RandPhraseSimple(LinkRandPhrase("Glad to see my old friend!","It is always a pleasure to come here, pal. Let's go straight to business.","I am very glad too. Let's talk business, friend."),LinkRandPhrase("Really glad to meet you. What's new in the financial seas?","Glad that you still remember me. I'm in a hurry so let's get straight to business.","Hello, old friend! Glad to see you again!")));
				link.l1.go = "next";
			}
			break;
			...
			dialog.text = NPCStringReactionRepeat("How can I help you?", 
                ...
                "Eh, " + GetAddress_Form(npchar) + ", you can't even imagine how annoying clients could be..." , "block", 1, npchar, Dialog.CurrentNode);
			link.l1 = HeroStringReactionRepeat("No thanks, I'm just walking around and talking.", 
				"Me again. Just wanted to talk with you.",
                "Yup, it's me again. Nothing serious, just wanted to talk with you.", 
			...
			link.l3 = "I am interested in jewels and unusual idols or gems.";
...
//Jason, генер почтового курьера 2 уровня
			...
			{
				link.l11 = "We had a meeting three months ago and talked about one man's relic. His name was "+pchar.GenQuest.Noblelombard.Name+". Remember that? He had to open a deposit for my name. The sum is  "+FindRussianMoneyString(sti(pchar.GenQuest.Noblelombard.Regard))+"...";
			...
			{
				link.l8 = "" + npchar.name + ", I was able to intercept that so called 'galleon'.";
			...
			{
				link.l8 = "" + npchar.name + ", I am sorry but I have failed to catch Francois Gontier, although I was following him to Tortuga. He managed to escape on his corvette from me.";
		...
		case "Helen_next":
			dialog.text = NPCStringReactionRepeat("I wouldn't say you're in need of money or looking to grow your wealth. What brings you to my office?", 
				"What do you want this time?", 
				"Hm... what are your concerns?",
                "Eh, " + GetAddress_Form(npchar) + ", you can't even imagine how annoying clients could be..." , "block", 1, npchar, Dialog.CurrentNode);
			link.l1 = HeroStringReactionRepeat("No thanks, I'm just walking around and talking.", 
...
//Jason, генер почтового курьера 2 уровня
		...
		case "ShipLetters_Usurer1":
			...
			dialog.text = "It will take o lot of my time to read these papers and my time costs a lot.";
		...
		case "ShipLetters_Usurer2":
			...
			if(sti(pchar.questTemp.different.GiveShipLetters.variant) == 0)
			{
				...
				link.l1 = "I am sorry but we had a deal! You promised me to tell me about this captain!";
		...
		case "ShipLetters_Usurer2_2":
			dialog.text = "It's your call. Our commandant has been showing quite an 'interest' to for this one person, for a long time. Got any ideas already? And here we have bills of lading with no marks on them...";
		...
		case "ShipLetters_Usurer2_3":
			...
			dialog.text = s1 + "And as I mentioned before, paper's owner is a man of principals and doesn't really like local crimes.";
			link.l1 = "I see. My gratitude!";
			link.l1.go = "exit";		
		break;
		...
		case "EncGirl_5":
			dialog.text = "I am really grateful for helping my kid and not leaving him in that troublefull situation. Please, allow me to thank you as best as I can. Accept this modest sum and a small gift from me.";
		...
		case "EncGirl_6_1":
			dialog.text = "Feelings? What kind of feelings? You are an adult man and you are talking about these feelings too? Such a shame on you to be a pander for youth. Took away the girl from her parents and destroyed my son's life. You won't get any thanks from me. Farewell.";
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		case "LoanUsurer":
			if (npchar.id == "Panama_Usurer")
			{
				...
				else
				{
					...
					if (CheckAttribute(pchar,"questTemp.Mtraxx.Cartahena.Gold"))
					{
						...
						{
							dialog.text = "Mm-hmm, "+GetAddress_Form(NPChar)+". I have to inform you that your deposit is no longer valid.";
			...
			else
			{
				...
				{
					Link.l7 = LinkRandPhrase("I would like to deposit my money for interest.","Would you accept to keep few sacks of my silver?", "May I leave you some silver for an unlucky day?"); // patch
					Link.l7.go = "deposit";				
				}			
			...
			if(CheckAttribute(Pchar, "Quest.Deposits." + (sDepositType1)) && makeint(Pchar.Quest.Deposits.(sDepositType1)) == true)
			{
				...
				Link.l9 = LinkRandPhrase("I'm here to get my investment back, in pesos.", "It's time to get back my silver which you owe me.", "I need back my investment in pesos with all of interest.");
			...
			if(CheckAttribute(Pchar, "Quest.Deposits." + (sDepositType2)) && makeint(Pchar.Quest.Deposits.(sDepositType2)) == true)
			{
				...
				Link.l10 = LinkRandPhrase("I want to take back my investment in doubloons.", "It's time to get back my gold that you owe me.", "I need back my investment in doubloons with all of interest.");
...
*/			
			...
			if (sTemp == "credit")
			{
				link.l11 = "I remember my debt, yet I am not ready to pay up...";
		...
		case "Medium":
			...
			Link.l2 = "It won't work for me. Let's change it.";
			Link.l2.go = "Loan";
			Link.l3 = "I suppose that it's better to stay away from debts for me. Farewell.";
			Link.l3.go = "ExitDelLoan1";
		...
		case "Period":
			...
			dialog.text =  "Taking into account my information about you, " + Pchar.name + ", I'll wait for return of this loan for " + FindRussianMonthString(sti(Pchar.Quest.Loans.(NPC_Area).Period)) + ". After that I will take certain measures. Hope that you understand that."; 
		...
		case "loan_return":
			...
			dialog.text = LinkRandPhrase("Wonderful! Come to me when you need coins. I will be at your service anytime.", "My gratitude. It is always a pleasure to deal with a man who is able to return his debts in time. Things happen sometimes, and I can understand it you know... but I prefer problems to be solved.",  "Oh, I was right trusting you, " + GetAddress_Form(NPChar) + "! I hope that it's not the last time you use my services. Maybe we can even make better deals for you, since now I know that you are an honest man.");
			Link.l1 = LinkRandPhrase("I want to borrow some money.", "I really need to get some pesos.", "How about a small lend?");
			Link.l1.go = "loan";			
			if(makeint(PChar.money) >= 100)
			{
				Link.l2 = LinkRandPhrase("I'd like to invest my money.","Will you keep some pirate booty?", "May I leave you some silver for an unlucky day?");
				Link.l2.go = "deposit";				
			}		
			if(CheckUseDublons(NPChar))	
			{
		...
		case "deposit":
			dialog.text = LinkRandPhrase("I see a wise man! What sum would you like to invest?", "Fine. Trust me, this sum will wait you here in safety and with all of its interest.", "I see that you know what's really important in this life. How much would you like to invest?");
			link.l1.edit = 3;
			link.l1 = "";	
			Link.l1.go = "result";
		break;
		...
		case "result":
			...
			dialog.text = "Alright. I can offer you... let's say..." + Pchar.QuestTemp.Deposits.(sDepositType1).Interest + " %. Per month, of course.";
		...
		case "Deposit_placed":
			...
			{
			    dialog.text = "Pardon me, captain, but this sum is too huge for my colonial bank. I won't be able to pay you your interest. And the lack of a reliable guard... I hope that you understand. Anyways, the maximum sum I can accept from you is " +
		...
		case "Deposit_return":
			...
			Link.l3 = "You are right. I'll let it to stay with you for a while. Have a good day.";			
			Link.l3.go = "Exit";		
		break;		
		...
		case "Deposit_return_1":
			...
			dialog.text = "Oh... It is so hard to lose it. I have really got used to this money. Come again anyway.";			
		...
		case "deposit_dub":
			dialog.text = LinkRandPhrase("I see a wise man! What sum would you like to invest?", "Fine. Trust me, this sum will wait you here in safety and with all of your interest.", "I see that you know what's really important in this life. How much would like to invest?");
			link.l1.edit = 3;
			link.l1 = "";	
		...
		case "result_dub":		
			...
			Link.l2 = "I'd better change the sum.";
			Link.l2.go = "Deposit_dub";
			Link.l3 = "I suppose that it's better to keep my gold. Farewell.";
			Link.l3.go = "Exit";
		break;
		...
		case "DeadMotherfucker":
			...
			Dialog.snd = "voice\USDI\USDI035";
			dialog.text = "You are still alive? Want to return my money perhaps? Screw you! I've lost so much money that you would never repay me! And I won't find rest until I see your lifeless body!";
            Link.l1 = "I just want to settle out things in a peaceful way.";
			Link.l1.go = "LoanRestore_1";
			Link.l2 = LinkRandPhrase("Very well, let's see then! Know that you are not protected from death either!", "A threat?! Let's see then what you're going to do...", "Money isn't the most important thing in our life. Don't grieve too much over it and kill people, come on I dare you.");
		...
		case "LoanRestore_2":
			dialog.text = "Now we are talking! I can do business with you after all.";
		...
		case "GiveTaskSlave":
			...
			dialog.Text = "Ah, come on! We are serious people, you and I, we are better than those idiots who are ready to die for a single doubloon, yet never ever try to make two doubloons of it\nI am looking for a man to offer a serious business to. A man brave and active, honest and punctual, but not burdened with... eh... too much of scrupulousness concerning moral dilemmas. And I hope that you are the man I am looking for.";
			Link.l1 = "It will depend on what kind of a 'deal' you are going to offer me.";
		...
		case "GiveTaskSlave_1":
			...
			dialog.Text = "Very well, listen then. Slavery is the most profitable business in the Caribbean now days. I am not a planter, but I have trustworthy clients\nSo, I need the following amount of slaves - " + pchar.questTemp.Slavetrader.iSlaveQuantity + " heads. I am ready to pay you 250 pesos for each. Trust me, that's a fine price. In total you will earn " + FindRussianMoneyString(sti(pchar.questTemp.Slavetrader.iSlaveMoney)) + " pesos.";
		...
		case "exit_slaves":
			dialog.Text = "Meh, it seems that nobody is eager to move his butt and take the gold under his feet. I am disappointed, very. Farewell and don't even think to spread gossips about our talk. My arm has a long reach...";
		...
		case "GiveTaskSlave_2":
			dialog.Text = "I won't limit your time but try to accomplish your mission as soon as possible. The demand for the 'black ivory' is huge. If you do your job well then I'll be giving you such kind of jobs every now and then in future.";
			Link.l1 = "Sounds nice. Well, wait for the good news.";
			Link.l1.go = "exit";						
		...
		case "Takeslaves":
			...
			dialog.Text = "Splendid. My men will take them... Don't worry about customs or the commandant of the fort. I am running a huge operation here so don't expect any troubles and no one will accuse you in smuggling.";
		...
		case "Takeslaves_2":
			dialog.Text = "Next? Come here again in three weeks. I am preparing a deal right now and it should be ready around that time.";
		...
		case "Takeslaves_3":
			...
			{
				dialog.Text = "I've got a job but your ship is too weak. I don't want you to fail the mission and neither do I want to send you to your own death. There is still time so get yourself a bigger ship like barkentine, brigantine, brig or flute at least. Don't waste the time!";
				Link.l1 = "I see, I'll handle it. See you.";
            	Link.l1.go = "Takeslaves_3_smallship";
			}
			else
			{
				dialog.Text = "At last! I was waiting for you. Now let's get straight to the point. As you know, there always are competitors in any business... and I have my own. These grasping and unscrupulous bastards are always eager to take away a client from me! Actually, I want to eliminate one of them and make a good coin at the same time.";
		...
		case "exit_slaves_1":
			dialog.Text = "Well.. It looks like I was mistaken about you... Farewell and forget about our talk. And don't spread gossips about what you've heard here. I own this town. And if you are planning to board the '" + pchar.questTemp.Slavetrader.ShipName + " for yourself... I will make sure that you end up on gallows. Consider it.";
		...
		case "Takeslaves_6":
			dialog.Text = "Considering that I've given you a location of the cargo and you don't need to sail in a search for 'a prize' the payment is a bit lower - 200 pesos for a head. And still that is a great sum - three hundred thousand pesos in case of success and the ship.";
		...
		case "Takeslaves_7":
			dialog.text = "You've got two weeks. Don't be late or he will transfer his cargo and it will all be over.";
		...
		case "Takeslaves_4_win":
			dialog.text = "Well, " + GetFullName(pchar) + ", what's your catch for today? They told me that " + GetName( NAMETYPE_ORIG, pchar.questTemp.Slavetrader.UnknownPirateName, NAME_NOM) + " feeds the fish! Ha-ha-ha!";
			link.l1 = "Yes, I was just in time! " + GetName( NAMETYPE_ORIG, pchar.questTemp.Slavetrader.UnknownPirateName, NAME_NOM) + " was transferring slaves to the smuggler's ship. Had to board them both and send them to Davy Jones himself, so you have less competitors now.";
			link.l1.go = "Takeslaves_5_win";
		break;
		
		case "Takeslaves_5_lose":
			dialog.text = "Yes, I guess I was wrong about you. You were late? Or were just too scared to fight? Whatever. It holds no meaning now. Get lost. I am done with you. Forget everything that you saw or heard here.";
		...
		case "Takeslaves_5_win":
			...
			if (amount < 0)
			{
				dialog.text = "I was right about you - "+ GetSexPhrase(" you are a dashing thug"," you are fierce Maiden") +"! I need men like you. You have succeeded on your mission in the most excellent way - you have brought more than a thousand and a half slaves! Unfortunately, I can pay you only for one thousand and six hundred slaves. I don't have enough coin to pay you for the rest, so you have to sell them by yourself. Your reward is 320 000 pesos.";
			...
			{
				dialog.text = "I was right about you - "+ GetSexPhrase(" you are a dashing thug"," you are fierce Maiden") +"! I need men like you. You have succeeded on your mission in the most excellent way - you have brought me "+ sTemp +" slaves. Your reward is " + FindRussianMoneyString(iSlaveMoney) + ".";
				link.l1 = "Gratitude. Nice doing business with you, " + npchar.name + "!";
				link.l1.go = "Takeslaves_6_win";
			...
			{
				dialog.text = "I see... I can understand that but I was expecting far more. You've brought only "+ sTemp +" slaves. At least you've destroyed my competitors and that worths something. Your reward is  " + FindRussianMoneyString(iSlaveMoney) + ".";
		...
		case "node_hanter_1":
			...
			link.l1 = "Fuck you and your slave trading! I should cut you where you stand, but I am a better man than you will ever be.";
			link.l1.go = "exit";
		...
		case "Takeslaves_6_win":
			dialog.text = "It looks like we are doing well together, " + pchar.name + ". I am very glad. See me in a month and, perhaps, I'll find a job just for you. I have a few ideas already.";
		...
		case "Takeslaves_7_win":
			...
			{
				link.l2 = "You mean this old buckle, some 'scoripion' amulet?";
				link.l2.go = "Yestatue";
			}
		break;
		...
		case "Yestatue":
			dialog.text = "Exactly! This is a Medici fibula... have you ever heard about them? That means that it really was in the bastard's cabin... May I take a look?";
		...
		case "Nobuystatue":
			dialog.text = "You see, I desperately need this fibula! I completely agree with you, it can't be valued with money, any dumb salesman will not even pay you five thousand for it. But it seems that you really know what it can do, since you refuse to sell it for such a sum.\n May I offer you an exchange, if you don't want money. I have something you might find interesting. Here, take a look. An amazing light armor! See for yourself! I offer it to you in exchange for the fibula\nIt is not unique by the way. You sailors, you can always find more for yourself and I can't. Do you agree now?";
			link.l1 = "Heh... I suppose. Give me the armor and take this fibula.";
		...
		case "EscapeSlave_2":
			dialog.text = "This one is all about our business. There was the greatest runaway of slaves in the New World's history! More than a thousand souls have escaped and in the meantime they have destroyed and burned few of Holland's outposts.";
			link.l1 = "Intriguing. Go on.";
			link.l1.go = "EscapeSlave_3";
		break;
			
		case "EscapeSlave_3":
			dialog.text = "But they didn't just run away, somehow they had managed to leave the island! No trails left. Mathias Beck is outraged. But that is not the point... Point is, that I ask you to sail to Curacao, learn what happened there, find the refugees and capture them\nAnd, of course, to save them from the hands of Dutch justice, which would be merciless to them. I will pay 300 pesos per a head - I have heard that they are very good slaves.";
			link.l1 = "Got it. I'm heading to Curacao. Await me with the good news.";
			link.l1.go = "EscapeSlave_yes";
			link.l2 = "You know, I won't take the mission. I won't deprive the people of their freedom. They have put their lives at risk to get it. They have earned it.";
		...
		case "Escape_slaves_win":
			...
			if (amount < 0)
			{
				dialog.text = "Ha! You've not only succeeded in your hard mission but you've brought more slaves that I've requested - "+ sTemp +" slaves. But "+ sNum +" slaves didn't escape from Curacao. I pay you 100 pesos for a head. I suppose that will work for you. Your reward is 330 000 pesos and " + FindRussianMoneyString(iSlaveMoneyH) + " for an excess, ha-ha.";
		...
		case "Slaveshore_1":
			...
			pchar.questTemp.Slavetrader.ShipName = GenerateRandomNameToShip(sti(NPChar.nation));
			pchar.questTemp.Slavetrader.Nation = NPChar.nation;
			dialog.text = "It is quite simple this time. Today, a pinnace '" + pchar.questTemp.Slavetrader.ShipName + "' under the flag of " + NationNameGenitive(sti(npchar.nation)) + " has dropped an anchor at " + XI_ConvertString(pchar.questTemp.Slavetrader.Island.Shore + "Gen") + " bay. It was loaded with a large batch of 'ebony' with a help of the local smugglers. Two thousand heads, not less\nNo soldiers in a crew and a captain is a trader. Overall, no threat at all. Board the ship and bring me the cargo. 200 pesos per a head as usual.";
			link.l1 = "Hm... It is not the same as the last job. You suggest me attacking a ship of your own nation!";
			link.l1.go = "Slaveshore_2";
		break;
			
		case "Slaveshore_2":
			dialog.text = "I don get it, " + pchar.name + ". Does the ship's flag matter? Do you really care about that?";
			link.l1 = "Do I? No, I don't give a fuck, gold doesn't have a nationality. It was just a bit unexpected...";
		...
		case "Slaveshore_3_no":
			dialog.text = "Are you serious? You gotta be kidding me, can't put your trust in anyone these days... In that case, go away. And forget about everything you saw or heard here!";
			link.l1 = "See ya," + npchar.name + ".";
			link.l1.go = "node_hanter_1";
		break;
			
		case "Slaveshore_3_yes":
			dialog.text = "Why are you surprised? Because I don't care about coins' nationality? I assure you, that indeed, I don't. To be honest, patriotism is bad for a professional banker, unless he is eager to go broke one day\nBut enough of philosophy. Let's cut to the chase - the ship will stay here until the midnight, so you don't have much time left. Are you ready to proceed?";
		...
		case "Slaveshore_5":
			dialog.text = "" + pchar.name + ", please calm down. It is not my fault! Damn, I have received the report too late... There was a treachery! One of my trusted men had sold me out!";
			link.l1 = "Fine, I see that you are speaking the truth. You are lucky that captain of the pinnace told me that our 'business' was uncovered. I'd have already killed you if he hasn't blabbed out. But you, fucking sack of money, were telling me all the time that you 'own this town'!";
		...
		case "Slaveshore_7": //выбор острова, куда бригантина пойдёт
			...
			pchar.questTemp.Slavetrader.Nation = NPChar.nation;
			dialog.text = "Listen carefully. We have still got a chance. The package was sent on brigantine '" + pchar.questTemp.Slavetraderbrig.ShipName + ". That is the only thing I am certain about. Papers are being delivered to governor-general to his residence on " + XI_ConvertString(pchar.questTemp.Slavetraderbrig.Island) + ". You've got to intercept it, board it and find those discrediting evidences.";
			link.l1 = "Don't have much choice here. Pray for me, for yourself and hope that I will be able to catch it. We'll talk again about all of this when I'm back. Don't think that I'll just let it go.";
		...
		case "Brig_lose":
			dialog.text = "Damn... I was counting on you, " + pchar.name + ". Fine then. But we won't be doing any business anymore. If I am not able to bribe an investigator I'll have to run away. And I don't recommend you to stay here - soldiers may come here at any time. Farewell.";
			link.l1 = "Farewell, " + npchar.name + ".";
			link.l1.go = "exit";
			pchar.questTemp.Slavetrader = "End_quest";
		break;
		...
		case "Brig_win_1":
			...
			link.l1 = "Sounds great, but don't you think that you have to compensate me for my troubles because of your thoughtless actions?";
		...
		case "Brig_win_4":
			dialog.text = "Me and my companion were caught by a storm close to southern shores of Main a year ago. Our ships had been thrown at the rocks of Boca de la Serpienta coast, although they sank soon, we managed to drag our cargo ashore. Chests filled with precious stones and jewelry. The bay seemed to be quite cozy, so we hid treasures without a trouble\nBut we were attacked by the Indians the next morning as soon as the storm had ended. That's how the majority of survivors died, including my companion. Me and a few sailors managed to escape on a longboat\nWe had safely reached Cumana, yet I didn't risk to return for the treasures. I am sure that local savages are still protecting their shore as well as my chests. But you can deal with that bunch of redskins\nThe jewelry you'll find there is sufficient enough to cover all your expenses, including an expedition to southern Main.";
			link.l1 = "Hm... fine. Then I am heading to Cumana";
			link.l1.go = "Brig_win_5";
		break;
			
		case "Brig_win_5":
			dialog.text = "You can be confident, " + pchar.name + ", that all I've said was a truth. I expect to see you in a month. I have already got in mind one more deal and how I should help my staggered business. Farewell.";
			link.l1 = "See you, " + npchar.name + ".";
			link.l1.go = "exit";
		...
		case "SlaveGalleon_4":
			...
			dialog.text = "Soon from Caracas, a heavy galleon will ship out. It's named " + pchar.questTemp.Slavetrader.ShipName + ". It contains a huge amount of slaves - about 3000 men - Indians of Orinoco, captured according to the repartimentos policy. The galleon is sailing to Santiago, sugar plantations of Cuba need a lot of workers. You must capture the galleon with her cargo. I would take at least two ships with me if I were you they say that the galleon is the best of its kind. Pay rates stay usual - 200 pesos per head. ";
		...
		case "Lostgalleon":
			dialog.text = "Well, " + pchar.name + ", it was my very last hope... That's why I've offered this job to you. Nobody else but only you is able to do that... and I see that you are not capable either. Let's say goodbyes then. After the last fail and all of those gossips, all of my clients are gone. And I am almost bankrupt, perhaps, I have to leave this town. I don't blame you - this job was too tough. Eh... Farewell," + pchar.name + ".";
		...
		case "Wingalleon":
			...
			if(amount < 1) 
			{
				...
				link.l1 = "Dear sir, it wasn't a galleon... or a very a big galleon... Damn! It was a Line Ship! And you haven't even warned me! But I have managed to board her. I have "+ sTemp +" slaves and I'm ready to transfer them to you. According to our deal you owe me - " + FindRussianMoneyString(iSlaveMoney) + ". It would be great to get some compensation for your misinformation.";
		...
		case "Wingalleon_no":
			...
			link.l1 = "Don't dare to scare me, an empty money chest. I will sink all of your fleets and feed crabs with it.";
			link.l1.go = "exit";
			AddQuestRecord("Slavetrader", "9");
			CloseQuestHeader("Slavetrader");
			ChangeCharacterHunterScore(pchar, NationShortName(sti(pchar.questTemp.Slavetrader.Nation)) + "hunter", 70);
		...
		case "FindRat_1":
			AddMoneyToCharacter(pchar, makeint(pchar.questTemp.Slavetrader.iSlaveMoney));
			dialog.text = "You can always trust in my word, " + pchar.name + ". I have never given you any reason to doubt me. Partners must be honest with each other, that's the key of business\nLet's talk about Indian artifacts now. Show me what you have, don't make such collector like myself wait.";
		...
		case "BG_money":
			...
			link.l1 = "Good. And is that all in what you are interested in...";
			link.l1.go = "BG_PF";
		...
		case "PF_check":
			...
			{
				dialog.text = "This! And I didn't even notice it at first. I am interested in this bone with a ring made of copper. Such an interesting thing I'd tell you... I can pay you 20 000 pesos or give you an amulet of 'Cimaruta' in exchange.";
				link.l1 = "I'd take money.";
				link.l1.go = "PF_money";
		...
		case "FindRat_3":
			dialog.text = "Well... by boarding the galleon, oh I am sorry, the Line Ship you have saved me. I really appreciate our partnership, " + pchar.name + ". You are my best agent.";
		...
		case "FindRat_8":
			dialog.text = "I wish you luck then. Know that this Gontier is a very experienced sailor and he has a crew of reckless cut-throats. He has got nothing to lose so he'll be fighting in a very desperate way.";
			link.l1 = "I am not scared of people like him but I'll consider what you've said. Farewell, and be sure that I will get him even in hell.";
			link.l1.go = "exit";
			pchar.questTemp.Slavetrader.ShipName = GenerateRandomNameToShip(SPAIN);
		...
		case "Wincorvette_2":
			...
			link.l1 = "Thanks, " + npchar.name + ". I say it again that it's a real pleasure to deal with you.";
		...
		case "Lostcorvette":
			dialog.text = "Pity, what a shame... Well, don't feel upset, you are not the first man that scum fooled. I will nail him one day anyway\nAs for you, come and see me in a month. This will be big, so gather a well equipped and armed squadron. Please, be serious about it and do you your best to prepare. If my plan works, we will be rich.";
			link.l1 = "Good, " + npchar.name + ". I'll come back when I'm ready.";
			link.l1.go = "exit";
		...
		case "Havana_fort":
			dialog.text = "You are just in time, " + pchar.name + "! I was close to start worrying, I was going to send a man to find you\nLet's get started! Your mission is really big and risky now, but the reward is adequate. You will receive more than a million pesos after the job is done.";
			link.l1 = "Now we are talking! I am listening, " + npchar.name + ".";
		...
		case "Havana_fort_2":
			...
			link.l2 = "You know what, " + npchar.name + ", this is going too far. I had enough of these surprises of yours. Next time your greed will want me to declare a war on Spain and I would have to fight them all by myself. If you really need those slaves then storm Havana by yourself.";
			link.l2.go = "Havana_fort_not";
		break;
		
		case "Havana_fort_not":
			dialog.text = "Didn't expect that from you... Damn, what do I suppose to tell my customer? Fine. It's your call and I have to find a new partner. Farewell, " + pchar.name + ". And I will not use your services in the future. Remember that you have dropped the deal which could make your progenies rich until the seventh generation.";
			link.l1 = "You can't get all money in the world, and you bite off more than you can chew. Farewell, " + npchar.name + ".";
			link.l1.go = "exit";
			AddQuestRecord("Slavetrader", "8");
			AddQuestUserData("Slavetrader", "sSex", GetSexPhrase("",""));
			CloseQuestHeader("Slavetrader");
		...
		case "Havana_fort_3":
			...
			link.l1 = "I see. It won't be the first time I fight Line Ships, ha-ha. How much time do I have?";
		...
		case "Havana_fort_5":
			dialog.text = "One moment!" + pchar.name + ", you and I never had any misunderstandings and disagreements. Nevertheless, I want you to know what is going on here. I count on you, and the client counts on me\nWe have invested a lot of effort and money in this operation. Every single slave, all five thousand must be delivered to me\nOtherwise, we will take very radical measures against you. No offence, this is only a warning. ";
		...
		case "Win_Havana_Fort":
			...
			if (amount < 4500 && amount >= 1)
			{
				...
				link.l1 = "Hmm.. Part of them haven't survived the road from Havana... food and medicines were running low.";
		...
		case "Havana_Fort_no":
			dialog.text = "Fine. I don't need your explanations. We had a deal and I will give you one week to get not less than a five thousand slaves. You will have a lot of problems otherwise.";
		...
		case "Havana_Fort_yes_1":
			sTemp = GetSquadronGoods(Pchar, GOOD_SLAVES);
			iSlaveMoney = makeint(sTemp)*200;
			dialog.text = "Sure. I am going to sell the slaves to my client, he'll pay and you'll get your coins. Just like the last time. Let's see, you've brought here " + sTemp + " slaves. The sum is " + FindRussianMoneyString(iSlaveMoney) + ". Come here for the payment in a week.";
		...
		case "Havana_Fort_yes_3":
			dialog.text = "See now..." + pchar.name + ", you are the best agent of mine and I am counting to do business with you again in the future. ";
		...
		case "Havana_Fort_yes_4":
			dialog.text = "I understand you very well but I have to sell the slaves at first and only then I'll receive money.";
			link.l1 = "Fine. I think we understood each other.";
			link.l1.go = "Havana_Fort_yes_5";
		break;
		
		case "Havana_Fort_yes_5":
			dialog.text = "Splendid. See you in a week. And now I have to prepare and leave to trade with my client.";
		...
		case "Usurer_Escape":
			...
			link.l1 = "Fuck the credits! Where is " + pchar.questTemp.Slavetrader.Name + "?";
		...
		case "Usurer_Escape_3":
			dialog.text = "I've heard that he has ran away from our colony... I take it that he owes you too. A lot?";
		...
		case "Usurer_Escape_4":
			...
			link.l1 = "Fuck! And I've trusted that bastard! He had a smell of traitor on the very first day! And I was foolish enough to believe that we are true partners! But I will make him regret one day... Fine," + npchar.name + ", I apologize for my behavior... If you are a good man I will deal with you in future be sure of it, but for now, farewell.";
	...
	//--> семейная реликвия
		case "Noblelombard":
			...
			{
				link.l2 = "My client will have the money in a three months. Let's make a deal, I'll pay you the interest for the last three months and for the next three months."+FindRussianMoneyString(sti(pchar.GenQuest.Noblelombard.Percent)*2)+". And the debt itself will be paid to you later.";
				link.l2.go = "Noblelombard_2";
			}
			if(sti(pchar.money) >= sti(pchar.GenQuest.Noblelombard.Percent))
			{
				link.l3 = "My client will have money in a three months. How about I pay you the interest for last three months and you'll wait until my client has enough money?";
		...
		case "Noblelombard_1":
			dialog.text = "Excellent! It all turned well, I got my money and "+pchar.GenQuest.Noblelombard.Name+" will get his relic back.";
		...
		case "Noblelombard_2":
			...
			{
				dialog.text = "Hm.. Fine. This works for me. But if "+pchar.GenQuest.Noblelombard.Name+" doesn't find money in three months then I won't make a delay again. Make sure he knows that.";
				link.l1 = "I will! I am glad that we had made a deal. Farewell now.";
				link.l1.go = "exit";
			...
			{
				dialog.text = "No. It won't work. I need the entire sum and before the sunset. Make sure your 'client' knows that. I have nothing more to tell you.";
		...
		case "Noblelombard_3":
			...
			{
				dialog.text = "Hm.. Fine. I accept it just because of my respect to your client. But if "+pchar.GenQuest.Noblelombard.Name+" doesn't find money in three months then I won't make a delay again. Make sure he knows that.";
			...
			{
				dialog.text = "No. It won't work. I need the whole sum and before the sunset. Make sure your 'client' knows that. I have nothing more to tell you.";
				link.l1 = "Hm... fine. Too bad that you don't want to compromise.";
				link.l1.go = "Noblelombard_4";
		...
		case "Noblelombard_5":
			...
			{
				dialog.text = "You don't say so! "+pchar.GenQuest.Noblelombard.Name+" hasn't opened a deposit for your name. He is not even in our colony - sailed away to the Europe. I tell you that I've never seen such a dishonest man. He wanted to cheat on me but failed - I have some of my own tricks...";
...
//<-- семейная реликвия
		...
		case "FMQG_x1":
			dialog.text = "";
			link.l1 = "So I suggest you praying for my good health in church on every morning sermon instead of sending assassins for my life. One last warning! Make a move against me and you are fucked. Got it? Good. Take a deep breath and keep counting your doubloons.";
			link.l1.go = "FMQG_x2";
		break;
