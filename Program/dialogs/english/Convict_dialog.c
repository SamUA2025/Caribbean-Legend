...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "CitizenNotBlade":
			dialog.text = "Captain, what are you doing? Hide away your weapon, before you'll get a lot of trouble!";
			link.l1 = LinkRandPhrase("Fine.", "Fine.", "Don't worry, I am hiding it away...");
			link.l1.go = "exit";
		break;  
	}
}
