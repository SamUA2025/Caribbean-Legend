...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		case "quests":
			...
			{
				link.l1 = "Listen, has a man called Joachim Merriman been here? A middle-aged senor, Portuguese, with moustache, imperial beard and piercing eyes? Maybe he wanted to take a loan?";
				link.l1.go = "caleuche";
			}
		break;
		...
		// калеуче
		case "caleuche":
			dialog.text = "I'm afraid I can't help you, young man. I have no clue whom you are talking about.";
