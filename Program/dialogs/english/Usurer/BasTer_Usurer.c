...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		...
		case "FMQG_1":
			...
			link.l1 = "Very well. Monsieur Pinette hired my ship to deliver him and two of his friends from Guadeloupe to the Spanish Maine. More specifically, Mosquitoes Bay of Portobello. I did the job, they left my ship and they walked right into the jungle.";
			link.l1.go = "FMQG_2";
		break;
		...
		case "FMQG_15":
			...
			link.l1 = "It's worth much more than gold sometimes, monsieur. Lesson learnt. Farewell!";
			link.l1.go = "FMQG_16";
		break;
		...
		case "FMQG_25":
			dialog.text = "But...";
			link.l1 = "I don't give a shit about how you will do it. If the hunt after my head doesn't end tomorrow, the governor will learn about everything.";
			link.l1.go = "FMQG_21";
		break;
	}
