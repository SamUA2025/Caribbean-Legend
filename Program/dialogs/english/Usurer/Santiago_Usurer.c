...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		...
		case "SantiagoTripBank_1":
			dialog.text = "Hm-m... interesting. So he 'sends his regrets'. Well-well. Though, senior Rodenburg's regrets are quite persuasive, it's hard to deny. Senior, it will take some time to write a proper answer, could you come again and see me tomorrow around noon so you could take a reply? Rest in a tavern, walk around the city. Santiago has a lot to offer.";
			link.l1 = "Fine, I will be back around noon tomorrow. I will see you then, senor.";
		...
		case "SantiagoTripBank_3":
			dialog.text = "Yes, of course... but I believe we can get along without written conventionalities. Just tell him these words 'this man must die'. That would be fair and we won't have any problems considering a 'value' of received apologies. And the incident will be considered fully settled.";
			link.l1 = "Fine, I will remember that, senor. Anything else?";
			link.l1.go = "SantiagoTripBank_4";
			DelLandQuestMark(npchar);
		break;
		
		case "SantiagoTripBank_4":
			dialog.text = "Yes, of course. What I've said is the will of the Giraldi family. And you can, of course, give my best wishes to Senor Lucas. I wish you a fair wind, captain " + GetFullName(pchar) + ".";
