...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		...
		case "UsurerDone":
			...
			link.l1 = "All right. I'll load the hold and count how much space is left. Then I'll figure out the amount that I'm missing and then I'll come back to you, if the need arises.";
			link.l1.go = "exit";	
