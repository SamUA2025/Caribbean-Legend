    ...
    switch (Dialog.CurrentNode)
	{
		case "quests":
			dialog.text = NPCStringReactionRepeat("All the rumors of "+ GetCityName(npchar.city) +" at your service. What would you like to find out?",
                          ...
                          "You're repeating like a parrot...", "block", 1, npchar, Dialog.CurrentNode);
            ...
            {
                link.l1 = "Has Francois Gontier happened to stopped by your town by any chance? He has a corvette '" + pchar.questTemp.Slavetrader.ShipName+ "', just in case... ";
                link.l1.go = "Havana_ratT_1";
            }
			if (CheckAttribute(npchar, "quest.batabano"))
            {
                link.l1 = "Tell me, mate, where could I find Don Diego de Montoya? Am I late? Has he already departed to Main?";
                link.l1.go = "guardoftruth";
            }
			// калеуче
			if (CheckAttribute(pchar, "questTemp.Caleuche") && pchar.questTemp.Caleuche == "graveyard" && !CheckAttribute(npchar, "quest.caleuche"))
			{
				link.l1 = "Listen, has a man by the name Joachim Merriman stopped by here? A middle-aged doctor, Portuguese, with a moustache, imperial beard and piercing eyes? Perhaps, he wanted to rent a room?";
				link.l1.go = "caleuche";
			}
		break;

		case "Havana_ratT_1":
			dialog.text = "Aha, that gloomy fellow? Yes, he's stopped by at my place. I'll tell you something: he had an appointment with Oregon-and-Haskon. He applied to receive a patent. But it didn't pan out for him and he got out of there.";
		...
		case "Havana_ratT_2":
			dialog.text = "What do you need from him? He's afraid of outsiders, he always hides from everybody, as soon as he sees an armed stranger he grabs a sword. He only walks around surrounded by four guards. Do you happen to be the man he's on guard from?";
			Link.l1 = "Lord, people are saying that again and again! What, do I look like a killer? He's my old mate, I'm in a hurry to pass on some news to him, he'll be quite overjoyed to know that there's no need for him to hide any longer, nobody's looking for him.";
			Link.l1.go = "Havana_ratT_3";
		break;
		
		case "Havana_ratT_3":
			dialog.text = "No need for him to hide? Ha-ha-ha! Just one day before his departure from Havana a whole pack of hoodlums tried to kill him in the jungle... Of course, he had his own people and they turned them into mincemeat in a second. And here you are saying...";
			Link.l1 = "Oh, come on. It was probably just some local bandits trying to get his wallet. You know yourself how many scoundrels are walking around the jungle. So where did he go?";
		...
		case "guardoftruth_1":
			dialog.text = "A-ha, so you work for His Reverence, Father Vincento? This changes things. Don Diego de Montoya left two days ago with his squadron, but soon returned on his courier lugger. One of his ship foundered on the reefs south of Cuba, so he has been buying repair material just today\nCheck the bay at the South, you will find there a ship and the man himself. I doubt that they've already managed to fix holes.";
			link.l1 = "Thanks, mate! You've been a lot of help!";
