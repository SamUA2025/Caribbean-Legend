...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		case "quests":
            ...
            {
                link.l1 = "I hear you've got a privateer by the name of Francois Gontier in your town. Would you happen to know where to find him?";
            ...
            {
                link.l1 = "Look, I am in a search of a man named Bertrand Pinette, have you heard about him? He arrived to Panama not long ago. An imposing gentleman in a periwig. He might have been here...";
                link.l1.go = "FMQG";
            }
		break;
		...
		//-->работорговец
		case "Panama_rat_1":
			dialog.text = NPCStringReactionRepeat("Yes, we've had a fellow like that in town. He was lurking around dark places... Then some of his mates came and paid him a visit, looked like a band of cutthroats. He left the town with them.", "You've already asked about that and I've answered you.", "I told you, you'd already asked about that Gontier.", "Listen, walk away and stop bothering me! Have you completely lost your noggin?", "block", 0, npchar, Dialog.CurrentNode);
		...
		case "Panama_rat_2":
			dialog.text = "Well, there is only one way out of here on foot - Portobello. And he hoofed it. So look for him there.";
		...
		case "FMQG":
			...
			dialog.text = "Bertrand Pinette? French? Never heard about him. No mate, we haven't seen French folk around in a while.";
			link.l1 = "What a pity... You sure? He is a friend of an important hidalgo named Don Carlos de Milyar. They were supposed to arrive here together.";
			link.l1.go = "FMQG_1";
		break;
		
		case "FMQG_1":
			dialog.text = "Senor de Milyar? That gentleman visited Panama a year ago. Actually, Don Carlos de Milyar lives in Portobello. He is a big friend of the local governor.";
