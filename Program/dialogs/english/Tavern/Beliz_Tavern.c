    ...
    switch (Dialog.CurrentNode)
	{
		case "quests":
			dialog.text = NPCStringReactionRepeat("All the rumors of "+ GetCityName(npchar.city) +" at your service. What would you like to find out?",
                          "We were just talking about that. You must have forgotten...", "This is the third time today you're asking me...",
			...
			link.l1 = HeroStringReactionRepeat("You know, " + NPChar.name + ", maybe next time.", "Right, I've forgotten for some reason...",
                      "Yes, it really is the third time...", "Aye...", npchar, Dialog.CurrentNode);
			link.l1.go = "exit";
			// Страж Истины
			if (CheckAttribute(pchar, "questTemp.Guardoftruth") && pchar.questTemp.Guardoftruth == "merdok" && !CheckAttribute(npchar, "quest.jino"))
			{
				link.l1 = "Listen, has there been an alchemist that arrived here in this town, a physician? He's Italian, about thirty years old, his name is Gino Gvineili?";
		...
		// Калеуче
		case "caleuche":
			dialog.text = "Fergus? He often visits my place. But he is been in the selva since yesterday. Don't worry, he'll be back in a week, drinking rum and bragging about his sea adventures. Though, I admit, he is a damn good hunter. Don't know anyone who can catch snakes as good as he can.";
		...
		case "caleuche_2":
			...
			link.l1 = "Merci! You have helped me a lot, mate. See you around!";
