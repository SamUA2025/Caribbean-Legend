...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		case "quests":
			...
			{
				link.l1 = "I'm looking for Raymond Baker, a former executioner. Do you know if he's alive and where I can find him?";
				link.l1.go = "baker";
			}
			...
			{
				link.l1 = "I'm looking for Mr. Jones. Can you help my in my search, mate?";
				link.l1.go = "terrapin";
			}
			// Страж Истины
		...
		//Сага, Тени прошлого
		case "baker":
			dialog.text = "Our dear fatso has become more popular than Colonel Fox! He's alive, the poor guy. But he's not in town right now. After Raymond found out that serious people like you are taking an interest in him, he hurried up and sold his hovel for peanuts and was gone with the wind.";
			link.l1 = "Gone with the wind where?";
			link.l1.go = "baker_1";
		break;
		
		case "baker_1":
			dialog.text = "Oh, who knows. He went to serve a ship's doctor on the first vessel that came by. Only that vessel just came back today and nobody has seen Baker come ashore yet.";
			link.l1 = "How can I find the captain?";
			link.l1.go = "baker_2";
		break;
		
		case "baker_2":
			dialog.text = "Why do you think you need to look for him? I'm sure he's already drunk off usual in his cabin. His leaky bucket is called 'Callow Meggy'. Such is the captain, such is the name...";
			link.l1 = "Thanks for the help, mate!";
			link.l1.go = "baker_3";
		break;
		...
		//суп из черепахи
		case "terrapin":
			dialog.text = "Mr. Jones? You're pulling my leg, mate. You know how many fucking Joneses are on this island? You're gonna need to be more specific than that.";
			link.l1 = "He's got an adult sister Molly. They say she's amazingly beautiful.";
			link.l1.go = "terrapin_1";
		break;
		
		case "terrapin_1":
			dialog.text = "No. Nothing like that comes to mind. Sorry, mate...";
		...
		case "guardoftruth_2":
			dialog.text = "Maybe, he is. But I there's one thing I know for sure, somebody lives on his second floor. The window is constantly draped off. Even when John's downstairs, a clinking sound like glass vials and bottle as well as the smell of boiling herbs, and at night the light doesn't go out. That's why I'm suspicious that the inhabitant of that room is the one who's preparing John's medicine's for sale.";
			link.l1 = "Hm. Interesting observation. Thanks, mate!";
			link.l1.go = "exit";
