...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		case "quests":
			...
			{
				link.l1 = "I'm looking for a man nicknamed Valet. Do you know him?";
				link.l1.go = "valet_1";
		...
		case "valet_1":
			dialog.text = NPCStringReactionRepeat("No, I don't know, matey. So there's nothing I can help you with.", "I've already told you that I don't know!", "Are you drunk or are you just messing around?", "Leave me alone!", "block", 1, npchar, Dialog.CurrentNode);
		...
		case "valet_2":
			dialog.text = NPCStringReactionRepeat("Ah, Mr. David Fackman! He rents a house not far from the shipyard. Look for him there.", "I've just answered you. How did you listen to me?", "Are you drunk or are you just messing around?", "Leave me alone!", "block", 1, npchar, Dialog.CurrentNode);
