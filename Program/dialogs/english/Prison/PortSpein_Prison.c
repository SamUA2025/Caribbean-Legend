...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
 	switch(Dialog.CurrentNode)
	{
		...
		//--> Цена чахотки
		case "Consumption":
			dialog.text = "You are correct, so avoid visiting the dungeons without a serious reason. Why are you interested in this?";
		...
		case "Consumption_2":
			dialog.text = "Way too serious. We don't even have a physician here, he died of the damn consumption too. Now only a medic of local garrisson examines prisoners once in a week. But who cares about these tramps and criminals?\nMost folks think that they totally deserved such fate and it's hard to argue about this.";
		...
		case "Consumption_3":
			dialog.text = "As you have just mentioned, you are not a medic, therefore talking about disease's characteristics could be just... a made up lie. I just repeated what our physician had been saying before disease took him too. So I don't understand your curiosity and cynic behavior. People die here!";
