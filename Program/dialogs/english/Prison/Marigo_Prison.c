...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
 	switch(Dialog.CurrentNode)
	{
		...
		case "FMQN":
			...
			dialog.text = "Useful? Ha! On the second thought, wait. I have something useful to tell you. One of our patrols has gone missing in the jungles. They were supposed to be back in their barracks by now but it seems that they prefer a company of parrots instead. Or something really has happened. If you find them during your searches, please, tell them to make up a decent justification of their delay or otherwise they won't like the consequences... The patrol's commander is called Jannes Hoffman.";
			link.l1 = "Is tha all, officer?";
			link.l1.go = "FMQN_1";
		break;
		
		case "FMQN_1":
			dialog.text = "Yes, dammit. I'm sorry but I have nothing else to tell you. Good luck, captain.";
			link.l1 = "Thank you...";
			link.l1.go = "FMQN_2";
		break;
		...
		case "FMQN_3":
			...
			link.l1 = "I met a patrol near a cave in the jungle. They stopped me and asked where I was heading to and why, then let me go. Damn me, if those weren't the Brits disguised in Dutch uniforms! I also saw something curious in the jungle which looked exactly like a bunch of naked men hidden in bushes. I assume, the British raiding party had unarmed your patrol and taken their uniforms.";
			link.l1.go = "FMQN_4";
		break;
		
		case "FMQN_4":
			dialog.text = "...";
			link.l1 = "As you understand, I didn't take my chances to fight against a squad of trained red coats and so I rushed to you with a report instead.";
			link.l1.go = "FMQN_5";
		break;
		...
		case "FMQN_6":
			dialog.text = "I am sending a squad to the cave immediately! Captain, if the men you met are really the British spies, you will get a well-deserved reward. You are free to join the squad if you want to assist the authorities in detention of those bastards and receive an extra reward, these are governor's orders after all. So, are you coming with?";
		...
		case "FMQN_10":
			...
			link.l1 = "A small advice, you should send the best soldiers you have for this mission. Those spies are dangerous.";
			link.l1.go = "FMQN_11";
		break;
		
		case "FMQN_11":
			dialog.text = "Don't worry. I am sending our most experienced soldiers under command of an officer Hans Shulte - the master swordsman of Philipsburg.";
			link.l1 = "Great! Let's not waste time then.";
			link.l1.go = "exit";
			WaitDate("",0,0,0,1,5);
