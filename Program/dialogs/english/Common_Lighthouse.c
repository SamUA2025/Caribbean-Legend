...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		case "First time":
			...
			{
       			dialog.text = PCharRepPhrase(LinkRandPhrase("Alarm is raised in the town. Apparently, it's time for me to take up arms as well...", "Aren't the town guards running after you, by chance?", "You won't find a shelter here, but you may find several inches of cold steel under your rib!"), 
			...
			if(npchar.quest.meeting != "0" && CheckAttribute(npchar, "quest.trial_usurer"))
			{
				...
				link.l1 = "I believe you know a gentleman named Gerard LeCroix? He should have left a reward for me...";
				link.l1.go = "Trial";
...
//------------------------------------------------заказ артефактов------------------------------------------------
		case "Trade_artefact":
			...
			{
				dialog.text = "Well, not all of them, but some trinkets are brought more frequently than others, so I guess I'd be able to help you. But I warn you: all amulets ordered in this way will cost you 100 doubloons. You should understand...";
				link.l1 = "Price is not a problem. What amulets can you deliver?";
				link.l1.go = "Trade_artefact_1";
				link.l2 = "Pff! One could buy a ship with that kind money. It's too expensive. I guess I'll do fine by myself...";
		...
		case "exit_artefact":
			...
			{
				link.l1 = "All this, of course, is good, but here's what I wanted to ask - I suppose you know a gentleman named Gerard Lecroix? He should have left a reward for me...";
				link.l1.go = "Trial";
				DelLandQuestMark(npchar);
				break;
			}
		...
		case "indian_11":
			dialog.text = "Ngombo mask? Put down the vigilance of your enemies, ha-ha! Good...";
			link.l1 = "When should I come back to pick up my order?";
			link.l1.go = "Trade_artefact_2";
		...
		case "amulet_9":
			dialog.text = "Encolpion? Your sails shall fear no wind, while you possess this amulet. Good...";
			link.l1 = "When should I come back to pick up my order?";
			link.l1.go = "Trade_artefact_2";
		...
		case "caleuche_1":
			...
			{
				dialog.text = "Well-well. You're the third person who's shown me such a thing, mate. This amulet was brought here from the wild selva of Southern Main. There are Indians not far from Panama who wear trinkets like this one. The red-skin say that this is a legacy of their 'great ancestors.'\nI have no idea who their ancestors were or what kind of legacy they left, but I can give you advice on where to inquire. Interested?";
				link.l1 = "Certainly!";
		...
		case "caleuche_2":
			...
			link.l1 = "I assume he got to the Caribbean in that manner?";
		...
		case "caleuche_5":
			...
			link.l1 = "Thank you! I'll do as you say... Say, mate, how do you know all of this?";
		...
		case "caleuche_12":
			...
			link.l1 = "That's something! Fine, I'll try to find this lover of feathered women until he will be found by someone else... Thanks, mate, you helped me a lot!";
		...
		// belamour legendary edition карибские нравы
		case "Trial":
			dialog.text = "Ah, so you are that captain! Yes, I've been waiting for you. Gerard was also waiting, but he needed to urgently go on some kind of expedition, so he asked me to transfer the payment to you. He said you must come. There are four hundred doubloons here, if you please.");
