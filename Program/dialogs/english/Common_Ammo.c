	...
	switch(Dialog.CurrentNode)
	{
		...
		case "First time":
			...
			if (pchar.location == "Cumana_Ammo")
			{
				...
				{
					link.l2 = "You look worried, officer. How can I help you?";
					link.l2.go = "zpq_prs1";
				}
		...
		case "TakeGun":
			...
			{
				dialog.Text = RandPhraseSimple("Excellent. I will send a squad from the garrison to unload them.","Excellent. My soldiers will help you unload the cannons.");
