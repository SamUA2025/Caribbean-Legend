	...
	switch(Dialog.CurrentNode)
	{
		...
		case "PearlMan":
			...
			dialog.text = NPCStringReactionRepeat("Hello! My name is  " + GetFullName(npchar) + ". What can I do for you?", 
				"Hello once again!", 
				"Guests are very rare in this back of beyond...",
		...
		case "PearlMan_2":
			...
			{
				dialog.text = "Yeah, we have harsh orders here, and one can easily lose his had for any wrongdoings. I am not dealing in this, but I can advise you to talk with the local Indians about this. They have somewhere to run away to if anything goes wrong, so they should be bolder than us...";
		...
		case "CitizenNotBlade":
			dialog.text = "Captain, what are you doing? Hide away your weapon, before you make a lot of trouble!";
			link.l1 = LinkRandPhrase("Fine.", "Fine.", "Don't worry, I am already putting it away...");
			link.l1.go = "exit";
		break;  
