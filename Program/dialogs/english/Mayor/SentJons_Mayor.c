...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		...
		case "G_Girl":
			...
			link.l1 = "The brigantine, your Excellency. Transporting mail. Documents of great importance and such. I heard about the investigation and, obviously, as a loyal friend of the British Crown, I'd like to help.";
			link.l1.go = "G_Girl_1";
		break;
