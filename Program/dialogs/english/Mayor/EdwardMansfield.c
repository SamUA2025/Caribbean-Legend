	...
	switch(Dialog.CurrentNode)
	{
		case "First time":
            ...
            if (CheckAttribute(npchar, "Sp5LaVegaAttackDone"))
            {
				...
				{
					dialog.Text = TimeGreeting() + "! I am "+ GetFullName(NPChar) + ", the new governor of this pit. It won't be easy to call the local thugs to order, but there is no threat from them to the Spanish colonies anymore.";
            ...
            {
				dialog.text = NPCStringReactionRepeat("Do you have anything to tell me? No? Then "+ GetSexPhrase("get away from here!","I ask you to not disturb me.") +"",
	                         "I think that I've made myself clear...", "Although I've made myself clear, you keep annoying me!",
	                         "Well, you are beyond measure "+ GetSexPhrase("too rude, mon cheri","such a discourtesy, girl","such a discourtesy, girl") +"...", "repeat", 30, npchar, Dialog.CurrentNode);
				...
				link.l1.go = "exit";
					...
					if (npchar.city == sti(pchar.HeroParam.Location))
					{
						...
						else
						{
							...
							{
								link.l2 = "Here, look at this letter I've found on the smuggler's corpse";
		...
		case "pirateStartQuest":
			dialog.text = "Hm.. Work, you said? Actually, it's good that you have asked me. I need a man from outside. I want to find out something in the nearest town but my men are known there. Can't promise you a lot but you will get something.";
		...
		case "pirateStartQuest_1":
			dialog.text = "Then listen, I had a deal for delivering 200 slaves a month ago with the captain of the schooner 'Saintblue'. I wanted to sell them to the local plantation owner. The time has passed and the client has started to worry, but yesterday I was told that the schooner was seen not far from the island. But! The captain didn't show up. Today, my client has demanded me to return his advance and said that he was offered to buy slaves from another seller. More expensive, but the whole bunch of slaves at once.";
		...
		case "pirateStartQuest_2":
			dialog.text = "Of course not. Do I look like an idiot? I won't return him the advance anyway. But I need proof that those slaves which were offered to him are mine. Find those who offered him a new deal and you will get your 10.000 pesos. Deal?";
			link.l1 = "I'm in. Do you have any suspicions who it could be?";
		...
		case "pirateStartQuest_3":
			dialog.text = "If I had any ideas then I would never use your services. Those men would be dead already. But I am eager to know how they found out about the 'Saintblue's' cargo and my client. It looks like it was quite easy for them. See now?";
		...
		case "pirateStartQuest_final":
			dialog.text = "I know, I know. My men were watching the battle and have already reported to me about your flawless victory. Fine, you've done your job well. Here is 15.000 pesos, as I promised. And thank you, you helped me with a great deal.";
		...
		break;
 		...
 		case "No_Mansfield_first_time":
			dialog.text = "Greetings, my name is Alistair Good. I was elected as head of buccaneers after Mansfield's death.";
