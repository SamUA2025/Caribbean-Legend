...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		case "quests":
			...
			{
				link.l1 = "Your Excellency, I would like to report an illegal trading activity on this island.";
                link.l1.go = "Mtraxx";
			}
			...
			{
				link.l1 = "I arrived on behalf of Governor-General Phillipe de Poincy. My job is to bring to you the slaves captured from the Dutch, is that right?";
			...
			{
				link.l1 = "I arrived on the instructions of Governor-General Phillipe de Poincy to participate in a joint expedition to Curacao against the Dutch.";
		...
		case "Mtraxx":
			...
			link.l1 = "I have it on good authority that a Dutch brigantine the 'Utrecht' under English colors has been unloading high quantities of silk sailcloth in Portland Bay for a long time. They've been operating for over a year, during night time, between the 10th and 15th of each month.";
			link.l1.go = "Mtraxx_1";
		break;
		...
		case "patria_Sl_2":
			...
			dialog.text = "Excellent! With Chevalier de Poincy one can really do business. Tell the Governor-General that my squadron for the Curacao attack will be ready in a month. I'm sure, he will send you for this campaign to me, so I'll see you soon, Monsieur de Maure.";
