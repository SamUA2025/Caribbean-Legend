...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		...
		case "MayorDone":
			dialog.text = "My assistance? Our trader is a very honest man, so I doubt that he will attempt to fool you. Talk to the shipmaster about the flute, he will help you with this matter. And if you get trouble anyway, then you should come see me. I am interested in advancing the trade connections with our colony and I will show you all my support.\nAlso, I'm organizing a banquet tonight, all Bridgetown's brightest will attend. You should come too, captain.";
