...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "First time":
			...
			{
				dialog.text = RandPhraseSimple("A spy? Guards!", "Alarm! There's an intruder!");
				link.l1 = "Shut up. I'm leaving.";
				link.l1.go = "fight";
				break;
			}*/
			...
			if (sti(NPChar.nation) == PIRATE)
			{
				...
				{
				    dialog.text = RandPhraseSimple("They say that you are the one who rules this town, "+ GetSexPhrase("sir","miss") +".", "What a pleasant meeting, the city head has appealed to me with a question.");
					link.l1 = RandPhraseSimple("I've changed my mind.", "I'm simply exploring this town. Goodbye.");
					link.l1.go = "exit";
					...
					if (CheckAttribute(pchar, "GenQuest.Loan.FindCitizen") && !CheckAttribute(pchar, "GenQuest.Loan.FindCitizenDone") && !CheckAttribute(pchar, "GenQuest.Loan.FindCitizenFalied"))
		            {
		                ...
		                {
							link.l3 = RandPhraseSimple("I want to discuss business.", "Regarding finances...");
				...
				{ // пираты, не наши
					...
					link.l1 = RandPhraseSimple("Hey, stop barking, won't you?", "Simmer down, or you might regret it!");
					link.l1.go = "exit";
					link.l2 = RandPhraseSimple("I have a question for you.", "A moment of your attention, please. I have a question.");
					link.l2.go = "quests";//(перессылка в файл города)
					if (CheckAttribute(pchar, "GenQuest.Loan.FindCitizen") && !CheckAttribute(pchar, "GenQuest.Loan.FindCitizenDone") && !CheckAttribute(pchar, "GenQuest.Loan.FindCitizenFalied"))
		            {
		                if (Characters[sti(pchar.GenQuest.Loan.FindCitizenIdx)].id == Npchar.id)
            ...
            if(NPChar.quest.meeting == "0")
			{
				...
				dialog.Text =NPCharRepPhrase(npchar,
        		                ...
        		                LinkRandPhrase("Greetings, " + GetAddress_Form(NPChar) + ". My name is " + GetFullName(npchar) + ". What's yours?",
                                 "Hello, " + GetAddress_Form(NPChar) + "! I am " + GetFullName(npchar) + ". May I have your name?",
			...
			else
			{
				if(rand(5) == 1 && NPChar.sex == "woman" && !CheckAttribute(NPChar, "CitizenFindItem.NoQuest") && !CheckAttribute(PChar, "GenQuest.CitizenFindItem.StartQuest") && CheckAttribute(NPChar, "City"))
				{
					...
					link.l1 = LinkRandPhrase("Sorry, no. I have little time to spare.", "Sorry, I can't. Too busy.", "No, I can't. I have urgent matters that require my attention.");
					link.l1.go = "CitizenFindItem_NoQuest";
					link.l2 = LinkRandPhrase("Sure I can. What's the problem?", "Yes, I'll help you. Tell me more about that business of yours.", "Tell me more about that business of yours...");
				...
				if(CheckAttribute(PChar, "GenQuest.CitizenFindItem.CitizenID") && PChar.GenQuest.CitizenFindItem.CitizenID == NPChar.ID && CheckCharacterItem(PChar, "DOjeronRing"))
				{
					...
					link.l1 = NPChar.name + ", I found your wedding ring.";
					link.l1.go = "CitizenFindItem_Complete_1";
					break;
				}
			
				link.l1 = PCharRepPhrase("I want to learn more about this town.", "Tell me about this town.");
	            ...
	            {
					link.l4 = NPCharSexPhrase(npchar, LinkRandPhrase("Hold on! Tell me who you are - right now! I am seeking an enemy spy on request of the governor of " + XI_ConvertString("Colony"+characters[GetCharacterIndex(pchar.GenQuest.SeekSpy.MayorId)].city+"Gen") + "!", 
						"Halt! I operate in the interest of the town " + XI_ConvertString("Colony"+characters[GetCharacterIndex(pchar.GenQuest.SeekSpy.MayorId)].city+"Gen") + " by order of the governor. I'm searching the city for a hostile agent.", 
						"Stop, friend! Local governor " + characters[GetCharacterIndex(pchar.GenQuest.SeekSpy.MayorId)].lastname + " wants to find a spy in the town."), 
						LinkRandPhrase("Hold on, lady! Tell me who you are - right now! I am seeking out an enemy spy upon request of the governor of " + XI_ConvertString("Colony"+characters[GetCharacterIndex(pchar.GenQuest.SeekSpy.MayorId)].city+"Gen") + "!", 
						"Woman, I must detain you! I operate in the interest of the town " + XI_ConvertString("Colony"+characters[GetCharacterIndex(pchar.GenQuest.SeekSpy.MayorId)].city+"Gen") + " by order of the governor. I'm searching the city for a hostile agent", 
						"Stand still, beauty! A local governor " + characters[GetCharacterIndex(pchar.GenQuest.SeekSpy.MayorId)].lastname + " wants to find a spy in the town..."));
					link.l4.go = "SitySpy";
				}
				...
				{
					link.l16 = "Maybe you can give me some advice. I want to purchase "+pchar.GenQuest.Device.Shipyarder.Type+", and I've been told that it was being sold in your town. Well, someone was selling it on the streets. Do you know anything about that?";
	            ...
	            {
					link.l5 = LinkRandPhrase("Are you aware", "Did you know", "Did you hear") + " that a local church has been raided recently?");
                ...
                dialog.Text = NPCharRepPhrase(npchar,
                        ...
                        + Pchar.name, "Oh, it's good old "+ GetSexPhrase("Captain","lady") +" "
                         +GetFullName(Pchar))
                                        +LinkRandPhrase(". I thought you were dead!", ". And, surely, "+ GetSexPhrase("drunk as usual.","already under the weather.") +"", ". And, as I see, at liberty still!")
                                        ...
                                        +LinkRandPhrase(". What could "+ GetSexPhrase("such a gallant gentleman","such a dashing lady") +", like? Could you possibly need anything from me?", ". What have you come for?", ". What do you want to know this time?")
	   			...
	   			link.l6 = PCharRepPhrase(RandPhraseSimple("No, you're hearing things. I'll be going now.", "No, nothing - I was just heading"+ GetSexPhrase("","") +" to the tavern."),
		...
		case "ShipLetters_8":
			dialog.text = LinkRandPhrase("I don't care for unfamiliar papers. Besides, I don't know how to read. Go see the usurer, that devil surely knows how to read and write.",
		...
		case "Meeting":
		    dialog.Text  = NPCharRepPhrase(npchar, LinkRandPhrase("But aren't you lying, Captain " + GetFullName(Pchar)+"?",
                                                                    "And so what, " + PChar.name+"?",
                                                                    "I will remember you, " + GetFullName(Pchar)+".")
                                                                     + "And now, what is it that you need?",
                                                    LinkRandPhrase("A pleasure to meet you, Captain " + PChar.name,
                                                                    "Glad"+NPCharSexPhrase(NPChar, " ", " ")+" to meet you, " + GetAddress_Form(NPChar) + " " + PChar.lastname,
                                                                     "Nice to meet you, Captain " + PChar.name) + ". But, I take it, you came here for more than just learning my name?");
	        ...
	        {
				link.l4 = NPCharSexPhrase(npchar, LinkRandPhrase("Hold on! Tell me who you are - right now! I am seeking an enemy spy on request of the governor of " + XI_ConvertString("Colony"+characters[GetCharacterIndex(pchar.GenQuest.SeekSpy.MayorId)].city+"Gen") + "!", 
					"Halt! I operate in the interest of" + XI_ConvertString("Colony"+characters[GetCharacterIndex(pchar.GenQuest.SeekSpy.MayorId)].city+"Gen") + " by order of the governor. I'm searching the city for a hostile agent.", 
					"Stop, friend! Local governor " + characters[GetCharacterIndex(pchar.GenQuest.SeekSpy.MayorId)].lastname + " wants to find a spy in the town."), 
					...
					"Woman, I must detain you! I operate in the interest of the city " + XI_ConvertString("Colony"+characters[GetCharacterIndex(pchar.GenQuest.SeekSpy.MayorId)].city+"Gen") + " by order of the governor. I'm searching the city for a hostile agent.", 
			...
			if(CheckAttribute(PChar, "GenQuest.ChurchQuest_2.AskPeople") && !CheckAttribute(NPChar, "GenQuest.ChurchQuest_2.AskedPeople") && NPChar.location == PChar.GenQuest.ChurchQuest_2.QuestTown + "_town")
	        {
				link.l5 = LinkRandPhrase("Are you aware", "Did you hear", "Did you hear") + " that a local church was raided recently?");
				link.l5.go = "Citiz_GenQuest_Church_2_1";
			}
			// <-- Квестовый генератор священника. Квест №2.
			
			Link.l6 = PCharRepPhrase(RandPhraseSimple("No, you're hearing things. I'll be going now.", "No, nothing - I was just heading to the tavern."),
                                        RandPhraseSimple("No, nothing. Best of luck to you!", "Just looking around. Goodbye."));
			Link.l6.go = "exit";
		break;
		...
		case "new question":
            dialog.text = NPCharRepPhrase(npchar,
		                PCharRepPhrase(LinkRandPhrase("Oh yeah, I am almost as glad"+NPCharSexPhrase(NPChar, " ", " ")+" to see you as a cup of booze. Ask whatever you like.", "You like talking, Captain? Well, me too... Especially over a cup of rum.", "Yes, " + PChar.name + "?"),
                                        LinkRandPhrase("What do you need?", "I see, Captain "+PChar.name+". You are"+ GetSexPhrase("","") +" quite a talker. ", "You've tired me out"+ GetSexPhrase("","") +" with your questions, Captain. Better help me with the rum.")),
		                PCharRepPhrase(LinkRandPhrase("What do you want to know "+ GetAddress_Form(NPChar) + "?", "I'm listening to you, Captain.", "I have to go, so please be quick about it, Captain."),
                                        LinkRandPhrase("Always glad"+NPCharSexPhrase(NPChar, " ", " ")+"  to have good company, " + GetAddress_Form(NPChar) + " " + PChar.lastname + ". Speak your mind.",
                                                        "Yes, " + GetAddress_Form(NPChar) + "?",
                                                        "You like chatting, Captain? Well, me too..."))
                            );

            // homo 25/06/06
			link.l1 = LinkRandPhrase ("What gossip is popular in the local tavern?",
                                    "What's going on in these lands?",
                                    "What's new ashore here?");
			link.l1.go = "rumours_citizen";
			link.l2 = LinkRandPhrase("Can you direct me there?", "I can't find a way to a certain place...", "Could you show the way...?");
            ...
            link.l4 = RandPhraseSimple("I've got important business!", "I have business with you.");
			link.l4.go = "quests";  //(перессылка в файл города)
			link.l5 = PCharRepPhrase(RandPhraseSimple("No, you're hearing things. I'll be going now.", "No, nothing - I was just heading to the tavern."),
                                        RandPhraseSimple("No, nothing. Best of luck to you!", "Just looking around. Goodbye."));
			link.l5.go = "exit";
		break;
		
		case "RumourAboutOwners":
			Dialog.Text = "Whom would you like to know about?";
	  ...
	  // to_do
		...
		case "Device_Citizen":
           dialog.text = "Hmm, "+pchar.GenQuest.Device.Shipyarder.Type+"? Never heard of it before... Just what is it, actually? I've never heard about such a thing in all my time"+ NPCharSexPhrase(npchar, "","") +".";
			link.l1 = "Well, it's a shipwright's tool, "+pchar.GenQuest.Device.Shipyarder.Describe+". Had anyone been selling such a thing in town? Perhaps. You noticed someone to have such a thing on himself?";
		...
		case "Device_Citizen_1":
			...
			{
				dialog.text = "Hmm... Yeah, I guess I've seen a person with a similar looking thing. He was walking around there with it several hours ago. An interesting device, certainly.";
		...
		case "SitySpy":
			dialog.text = NPCStringReactionRepeat(NPCharSexPhrase(npchar, "And what does it have to do with me? I'm a local!", "Well, why do you trouble me with this? I live in this city, and know nothing of such things!"), 
				NPCharSexPhrase(npchar, "What do you want from me again? Haven't I already told you that I'm not the spy?!", "Didn't I already tell you that I'm a local?!"), 
				NPCharSexPhrase(npchar, "My dear, it's you again! Leave me be - I am a local!", "Why are you bothering me with your stupid questions again?"), 
				NPCharSexPhrase(npchar, "Again! Now this is an outrage!", "Listen, just leave me be, alright? Please!"), "block", 0, npchar, Dialog.CurrentNode);
			link.l1 = HeroStringReactionRepeat("Who can confirm your statement?", "Oh, I am sorry - I'd already asked you...",
                      "I am sorry, there are so many people...", "All right, all right...", npchar, Dialog.CurrentNode);
		...
		case "SitySpy_1":
			...
			{
				dialog.text = "Anyone can! Listen, why do you keep pestering me?! If you have a problem, go to see the governor and sort it all out!",
		...
		case "SeekSpy_Checking":
			dialog.text = "Yes, " + NPCharSexPhrase(&characters[sti(pchar.GenQuest.SeekSpy.BaseIdx)], " is indeed a local.", "she is indeed a local.");
			link.l1 = RandPhraseSimple("I see"+ GetSexPhrase("","") +". Thank you for the help.", "All clear. Thank you for the help.");
		...
		case "CitizenFindItem_1":
			...
			link.l2 = LinkRandPhrase("No, I can't. I am sorry. I have too much to do.", "I am sorry, I can't. I just remembered"+ GetSexPhrase("","") +", that I still have incomplete business...", "I have very little time, so I can't help you with anything...");
		...
		case "Citiz_GenQuest_Church_2_1":
			if(rand(3) != 1)
			{
				dialog.text = LinkRandPhrase("No, I don't know anything about it.", "I don't know anything in this regard.", "I don't know anything.");
					link.l1 = LinkRandPhrase("Alright, thanks.", "I see, thanks.", "Fine, please excuse me.");
				link.l1.go = "exit";
			}
			else
			{
				dialog.text = LinkRandPhrase("I don't know anything about it, but you can ask the patrons at the tavern - they are sure to tell you a thing or two.", "I can't tell you anything. Ask around at the tavern.", "I don't know anything in particular, but I've heard that there was gossip at the tavern.");
		...
		case "CitizenNotBlade":
			...
			{
				dialog.text = NPCharSexPhrase(NPChar, "Listen - as a citizen of this town, I must ask you to refrain from walking around with an unsheathed blade.", "Listen - as a citizen of this town, I must ask you to refrain from walking around with an unsheathed blade.");
				link.l1 = LinkRandPhrase("Fine.", "Fine.", "As you say...");
			}
			else
			{
				dialog.text = NPCharSexPhrase(NPChar, "Hold your horses "+ GetSexPhrase("mate","lass") +" when running around with a weapon in hand. That makes me nervous...", "I don't like it when "+ GetSexPhrase("men","anyone") +" walk around with weapons ready. It scares me...");
				link.l1 = RandPhraseSimple("Got it.", "I'll put it away.");
			}
			link.l1.go = "exit";
			NextDiag.TempNode = "First Time";
		break;
