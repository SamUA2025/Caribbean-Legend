			...
			if (npchar.quest.trade_date != lastspeak_date || bBettaTestMode)
			{
				...
				else
				{
					...
					else
					{
                        ...
                        {
                            dialog.text = "Politische Realitäten im Archipel erlauben es mir nicht zu handeln. "+XI_ConvertString(NationShortName(sti(NPChar.nation))+"Jäger")+" ist feindselig gegenüber jedem und hat nur mich im Laden gelassen.";
