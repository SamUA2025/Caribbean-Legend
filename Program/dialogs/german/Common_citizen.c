	...
	switch(Dialog.CurrentNode)
	{
		...
		case "First time":
            ...
            if(NPChar.quest.meeting == "0")
			{
				...
				{
					dialog.Text = LinkRandPhrase(LinkRandPhrase("Die ganze Stadt ist angespannt - Don Fernando de Alamida, der königliche Inspektor, ist angekommen. Sie wissen, ich habe hier viel gesehen, aber das... Es ist nicht die Trauer, die die Menschen verändert, sondern wie sie damit umgehen. Sie sagen, er sei nach dem Tod seines Vaters ein anderer Mensch geworden. Jetzt finden Sie keinen unbestechlicheren und... gnadenloseren Diener der Krone im gesamten Archipel.","Schau dir nur die 'Heilige Barmherzigkeit' an! Sie sagen, der König selbst habe sie nach speziellen Entwürfen bauen lassen. Und bemerke - nicht ein einziger Kratzer. Als ob die Jungfrau Maria selbst sie schützt. Obwohl ich Gerüchte gehört habe... vielleicht ist es überhaupt nicht die Jungfrau.","Weißt du, wie oft sie versucht haben, Don Fernando zu töten? Zwölf Angriffe in offenen Gewässern - und das nur im letzten Jahr! Nun, mit so einer treuen und ausgebildeten Besatzung und unter dem Schutz des Herrn - er wird auch den dreizehnten überleben!"),LinkRandPhrase("Hast du gehört? Don Fernando de Alamida ist in unserer Stadt angekommen, und man sagt, er ist gerade irgendwo auf den Straßen. Würde ihn gerne mit meinen eigenen Augen sehen...","Ein komplizierter Mann, dieser Don Fernando. Einige sagen, er sei ein Retter, der das Mutterland von Dreck reinigt. Andere flüstern, dass etwas in ihm zerbrochen ist nach dem Tod seines Vaters und bald werden wir alle weinen. Aber ich sage dir das: Fürchte ihn nicht. Fürchte diejenigen, die ihn zu dem gemacht haben, was er ist.","So ein hübscher Mann, dieser Don Fernando! Aber wissen Sie, was seltsam ist? Es ist, als würde er niemanden bemerken. Alles Pflicht und Dienst. Ich habe gehört, es gab ein Mädchen... aber nach einem Treffen mit einem Priester hat er weltliche Freuden komplett abgelehnt. Als hätte er ein Gelübde abgelegt."),RandPhraseSimple(RandPhraseSimple("Verdammter Inspektor! Solange er hier ist, ist die Stadt wie tot. Kein Handel, kein Spaß. Selbst das Atmen scheint leiser sein zu müssen. Und wissen Sie, was am beängstigendsten ist? Es ist in jedem Hafen dasselbe. Wie ein Uhrwerk. Seine Königliche Majestät hätte diese Folter für uns alle nicht absichtlich erfinden können!","Don Fernando besuchte das Waisenhaus wieder. Spendet großzügig, betet stundenlang. Ein solch würdiger Mann sollte den verfluchten Unterschlagern als Beispiel dienen!"),RandPhraseSimple("Ha! 'Heiliger' Fernando hat wieder alle Bordelle geschlossen. Nun, macht nichts, er wird bald absegeln und sie werden gleich wieder öffnen.","Der Insp... Inspektor ist angekommen, das ist es! Don Fernando de Almeyda, oder wie heißt er, Alamida! So wichtig, dass der Gouverneur selbst um ihn herum schleicht. Sie sagen, er sieht dir in die Augen und sieht sofort all deine Sünden. Schrecklich!")));
					link.l1 = "...";
					link.l1.go = "exit";
				}
				//<== прибыла инспекция на Святом Милосердии
