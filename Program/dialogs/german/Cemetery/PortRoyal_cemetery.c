...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		case "quests":
			...
			link.l1 = HeroStringReactionRepeat(RandPhraseSimple("Ich habe meine Meinung geändert, entschuldigung.","Es ist nichts, entschuldigen Sie mich."),"Verzeih mir, es ist nichts.","Du hast recht, es ist bereits das dritte Mal. Entschuldige mich...","Entschuldigungen.",npchar,Dialog.CurrentNode);
			link.l1.go = "exit";
		break;
	}
