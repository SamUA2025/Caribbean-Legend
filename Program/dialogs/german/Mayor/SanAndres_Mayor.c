...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
	...
	{
		case "quests":
			dialog.text = NPCStringReactionRepeat(RandPhraseSimple("Was willst du? Frag los.","Ich höre zu, was ist die Frage?"),"Das ist das zweite Mal, dass du versuchst zu fragen...","Das ist das dritte Mal, dass du versuchst zu fragen...","Wann wird das endlich enden?! Ich bin ein beschäftigter Mann, der sich um Kolonialangelegenheiten kümmert und Sie belästigen mich immer noch!","block",1,npchar,Dialog.CurrentNode);
