...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "First time":
			...
			{
       			dialog.text = NPCharRepPhrase(pchar,LinkRandPhrase(""+GetSexPhrase("Hijo mío","Mi hija")+", desafortunadamente, no puedo darte refugio. ¡Corre!","La guardia de la ciudad está peinando la ciudad buscándote, "+GetSexPhrase("hijo mío","mi hija")+". Las puertas de mi iglesia están siempre abiertas para los que sufren, pero no puedo ofrecerte refugio...","Hola, amigo."+GetSexPhrase("Hijo mío","Mi hija")+"¡, tienes que correr! ¡No te demores, te lo ruego!"),LinkRandPhrase("¿Qué haces en la iglesia, alma caída? ¡Exijo que te vayas de inmediato, antes de que los soldados te encuentren aquí y perpetren una masacre!","¡Abandona el templo de inmediato, blasfemo! ¡Nunca protegeré a un villano como tú!","¡Abandona el templo de nuestro Señor de inmediato! ¡No necesitamos asesinos aquí!"));
            ...
            if (npchar.quest.BadMeeting != lastspeak_date)
			{
				...
				{
					Dialog.Text = ""+GetSexPhrase("Mi hijo","Mi hija")+", ¡me alegra verte de nuevo!";
				...
				{
					Dialog.Text = ""+GetSexPhrase("Hijo mío","Mi hija")+"¡ Me alegra verte de nuevo con buena salud y buen ánimo. El Señor debe habernos ayudado en nuestro asunto, ¿verdad?";
				...
				Dialog.Text = "Bienvenido a nuestro sagrado refugio, "+GetSexPhrase("hijo mío","mi hija")+".";
				link.l1 = "Hola, santo Padre.";
				if(startHeroType == 4 && NPChar.location == "SantaCatalina_church")
				{
					dialog.text = "Saludos, Ellen, mi hija.";
...
// Jason-------------------------------------------------Сага----------------------------------------------
		...
		case "GenQuest_Church_2_Start_2":
			dialog.text = "Oh, "+GetSexPhrase("hijo mío","mi hija")+", ¡terrible sacrilegio, el más atroz de los crímenes acaba de suceder! ¡Robar de la iglesia!!! ¡Es como meter la mano en el bolsillo del Señor mismo!";
		...
		case "GenQuest_Church_2_Thief_4_1_3":
			...
			{
				dialog.text = ""+GetSexPhrase("Hijo mío","Mi hija")+"... Con lágrimas de arrepentimiento y gratitud, aceptaré este cáliz de ti como un signo de la misericordia y el perdón del Señor. La pureza y nobleza de tu alma realmente me han conmovido. ¡Te bendigo con todo mi corazón!";
		...
		case "GenQuest_Church_2_Thief_4_2_1":
			dialog.text = "No entiendo del todo tus insinuaciones, "+GetSexPhrase("mi hijo","mi hija")+", ¿de qué estás hablando?!";
		...
		case "GenQuest_Church_2_Thief_4_2_4_1":
			dialog.text = "Mmmm... "+GetSexPhrase("Hijo mío... Señor... Caballero...","Mi hija... Señorita... Dama...")+" "+PChar.name+"... Estoy listo para inclinarme ante usted... y considerar nuestras discrepancias, por así decirlo... y compensar sus gastos con esta modesta suma de "+FindRussianMoneyString(iMoneyToCharacter)+" ... por supuesto, si no vas a involucrar a otros en este asunto... ";
		...
		case "GenQuest_Church_2_Finally_Complete_1":
			...
			{
				dialog.text = "Oh, "+GetSexPhrase("hijo mío","mi hija")+", ¿qué podría haberme pasado? Es tu camino el que está lleno de peligros y ansiedad, y mi celda pacífica, dominio de la reflexión y la oración, es una isla tranquila en un océano tempestuoso de pasiones humanas...";
		...
		case "GenQuest_Church_2_Finally_Complete_1_3_1": // ГГ решил заныкать деньги...
			if(rand(1) == 0)	// Священник верит ГГ но не даёт денег...
			{
				...
				{
					dialog.text = "Oh, "+GetSexPhrase("hijo mío","mi hija")+". Tus palabras me sumieron en una profunda tristeza, pero no en la desesperación, ¡porque la desesperación es un pecado mortal! El Señor nos enfrentó a otra prueba para fortalecer nuestra fe.";
						link.l1 = "Amén, Padre...";
						link.l1.go = "exit";
						sQuestTitle = NPChar.City + "ChurchGenQuest2";
				...
				{
					dialog.text = ""+GetSexPhrase("Hijo mío","Mi hija")+", no mientas a tu pastor espiritual.";
		...
		case "GenQuest_Church_2_Finally_Complete_1_3_1_3":
			if(rand(6) == 3)
			{
				dialog.text = "Está bien, te creo, "+GetSexPhrase("mi hijo","mi hija")+"El Señor nos ha visitado con otra prueba para fortalecer nuestra fe.";
				link.l1 = "Amén...";
		...
		case "GenQuest_Church_2_Finally_Complete_1_4_1":
			if(rand(1) == 0) // Поверил.
			{
				dialog.text = "Oh, "+GetSexPhrase("mi hijo","mi hija")+". Tus palabras me sumieron en una profunda tristeza, ¡pero no en la desesperación, porque la desesperación es un pecado mortal! El Señor nos ha enfrentado a otra prueba para fortalecer nuestra fe.";
				link.l1 = "Amén, Padre...";
				link.l1.go = "GenQuest_Church_2_Finally_Complete_1_1_2"; // Переход сюда, т.к. одно и тоже.
			}
			else
			{
				dialog.text = "Sí, es ese mismo cáliz que fue robado junto con el dinero... Pero... Si lo has conseguido, ¿cómo es que no has traído de vuelta el dinero? Era una suma considerable, y seguramente esos granujas no podrían haberla gastado toda tan rápido... "+GetSexPhrase("Mi hijo","Mi hija")+", recuerda que no hay pecado mayor que mentir a tu pastor espiritual y dar falso testimonio en el templo ante Dios!";
		...
		case "GenQuest_Church_2_Finally_Complete_1_2_2":
			dialog.text = ""+GetSexPhrase("Hijo mío","Mi hija")+", quiero recompensarte debidamente, tú"+GetSexPhrase(", como un verdadero caballero de la Santa Madre Iglesia,","")+" hizo todo lo posible para sobreca...";
		...
		case "donation":
			dialog.Text = "Por supuesto, "+GetSexPhrase("mi hijo","mi hija")+". ¿Cuánto le gustaría donar a la Santa Iglesia?";
		...
		case "donation paid_100":
			...
			dialog.Text = "En nombre de la Santa Iglesia te agradezco, "+GetSexPhrase("mi hijo","mi hija")+", por tu regalo.";
		...
		case "ispoved":
			dialog.text = "Por supuesto, "+GetSexPhrase("mi hijo","mi hija")+" , te escucho.";
        ...
        case "work":
        	...
        	{
        		dialog.text = "Lo siento, "+GetSexPhrase("hijo mío","mi hija")+", pero todos los confesionarios están ocupados en este momento. Podré escuchar tu confesión en al menos media hora.";
				link.l1 = "Disculpe, "+RandPhraseSimple("padre","Padre")+", esto es un asunto diferente. Padre "+PChar.GenQuest.ChurchQuest_1.PriestName+", de "+XI_ConvertString("Colonia"+PChar.GenQuest.ChurchQuest_1.QuestTown+"Gen")+",   una vez te dio tesoros invaluables de la biblioteca teológica. Me pidió que los devolviera.";
				link.l1.go = "GenQuest_Church_1_Dialog_1";
				DeleteAttribute(PChar, "GenQuest.ChurchQuest_1.AskOwner");
				break;
        	}
			dialog.text = "¿Qué clase de negocio te ha traído aquí, "+GetSexPhrase("mi hijo","mi hija")+"¿?";
			...
			{
	            link.l11 = "Padre, vine de la colonia de "+XI_ConvertString("Colonia"+pchar.GenQuest.Churchbooks.StartCity)+"  La iglesia local necesita más libros de oraciones, y un monje local sugirió que hablara con usted al respecto.";
		...
		case "prihod":
		    ...
		    {
		        dialog.text = "Eso es estupendo. Y aún así, en estos tiempos sombríos, "+GetSexPhrase("hijo mío","mi hija")+", no todos los visitantes del templo pueden ser útiles para nuestra Madre Iglesia.";
            ...
            dialog.text = "Todo está tranquilo en la parroquia hasta ahora, "+GetSexPhrase("hijo mío","mi hija")+"Gracias por la oferta.";
		...
		case "GenQuest_Church_1_Dialog_1":
			...
			{
				dialog.text = "¡Oh! Sí... De hecho, ahora recuerdo... Pero, "+GetSexPhrase("mi hijo","mi hija")+", ¡estos tesoros son más de naturaleza espiritual que material! ¡Ya han ayudado enormemente a mis feligreses y podrían seguir haciéndolo en el futuro!";
			...
			{
				dialog.text = "¡Oh, sí!.. ¡En efecto...!"+GetSexPhrase("Hijo mío","Mi hija")+", ¡estos tesoros son más de naturaleza espiritual que material! Ya han ayudado enormemente a mis feligreses, así que, para mi ignominia, he 'olvidado' devolverlos a su legítimo propietario...";
		...
		case "GenQuest_Church_1_Dialog_1_1_1":
			dialog.text = "¿A-A-Al arzobispo?! ¡Por un asunto tan trivial!.. ¿Por qué? ¿De verdad? De todos modos, iba a enviar estas obras a mi amado hermano en Cristo; simplemente no había una buena oportunidad para entregárselas. Pero en ti, "+GetSexPhrase("mi hijo","mi hija")+", veo a un verdadero siervo digno de nuestro Señor. Aquí - toma estos libros y manuscritos y por favor entrégalos al Padre "+PChar.GenQuest.ChurchQuest_1.PriestName+" sano y salvo. Y además, añade a eso mi más sincero agradecimiento.";
		...
		case "GenQuest_Church_1_Dialog_1_2":	// Сцена 2б-а и 2б-б
			...
			{
				dialog.text = "Oh, "+GetSexPhrase("mi hijo","mi hija")+"¡Llegas con varias horas de retraso! Ya he enviado los libros del Padre "+PChar.GenQuest.ChurchQuest_1.PriestName+" con capitán "+PChar.GenQuest.ChurchQuest_1.CapFullName+". Esta mañana, ese hombre temeroso de Dios ha venido a confesarse y mencionó que hoy su navío iba a zarpar hacia "+XI_ConvertString("Colonia"+PChar.GenQuest.ChurchQuest_1.CapColony)+". Y aunque el señor capitán no garantizó ningún término, aún así accedió a ayudar y me aseguró que el puerto de "+XI_ConvertString("Colony"+PChar.GenQuest.ChurchQuest_1.QuestTown+"Gen")+" ciertamente visitará.";
		...
		case "GenQuest_Church_1_Dialog_1_2_1":	// 2б-а
			dialog.text = "Confío en la gente, "+GetSexPhrase("mi hijo","mi hija")+", cada uno de nosotros es creado a imagen y semejanza de nuestro Señor, ¡y Su fuego sagrado arde en cada alma!";
		...
		case "GenQuest_Church_1_Dialog_1_2_2_1":
			dialog.text = "Deberías confiar en la gente, "+GetSexPhrase("hijo mío","mi hija")+". En cuanto a su barco, no tengo nada que decir.";
		...
		case "GenQuest_Church_1_Dialog_1_2_2_2":
			dialog.text = "Verás, "+GetSexPhrase("mi hijo","mi hija")+", capitán "+PChar.GenQuest.ChurchQuest_1.CapFullName+" es muy temeroso de Dios...";
		...
		case "GenQuest_Church_1_Dialog_1_2_2_4":
			dialog.text = "Eres muy perspicaz, "+GetSexPhrase("hijo mío","mi hija")+". No sé el nuevo nombre de este barco, pero ciertamente es algo exaltado.";
		...
		case "GenQuest_Church_1_Complete_1":
			dialog.text = "¡Oh, hijo mío! He estado rezando fervientemente, ¡y todo parece haberse resuelto de la mejor manera posible! Por tu ayuda y fe, "+GetSexPhrase("mi hijo","mi hija")+", el paraíso y el canto angelical ciertamente estarán esperando...";
		...
		case "GenQuest_Church_1_Complete_2":
			dialog.text = "Sí, sí, "+GetSexPhrase("mi hijo","mi hija")+", por supuesto. Te recompensaré merecidamente. Toma esto y recuerda que nuestro Señor castiga a aquellas almas necias, que ansían demasiado las bendiciones terrenales y adoran al diablo amarillo.";
		...
		case "healthAdd_info":
			dialog.text = "Eso es muy sencillo, "+GetSexPhrase("hijo mío","mi hija")+"  Sufres daño cada vez que eres herido. Eso no pasa sin dejar rastro. Tu salud empeora con cada herida, y, como resultado, te vuelves más débil. Tu tripulación, al ver a un capitán débil, pierde el respeto por ti. Sin embargo, te vuelves más cauteloso, y la capacidad de defenderte aumenta temporalmente. Descansar y minimizar las heridas te ayudará a mantenerte con fuerza.";
			link.l1 = "Gracias por la iluminación.";
			link.l1.go = "exit";
		break;

		case "healthAdd_2":
			dialog.text = "Oraciones y abstinencia de la violencia, "+GetSexPhrase("mi hijo","mi hija")+". Entonces el Señor te devolverá lo que has perdido.";
		...
		case "healthAdd_3":
			...
			{
                dialog.text = ""+GetSexPhrase("Hijo mío","Mi hija")+", ya estoy rezando por tu bienestar. Estas oraciones ocuparán todo mi tiempo hasta el final del mes.";
		...
		case "HostessChurch_call":
			...
			else
			{
				...
				{
					dialog.text = "No puedo aceptar dinero conseguido en pecado. Devuélvelo a esa mujer caída, "+GetSexPhrase("hijo mío","mi hija")+" Nadie puede encontrar el camino hacia Dios a través del dinero.";
		...
		case "HostessChurch_ok":
			dialog.text = "Lo acepto, "+GetSexPhrase("hijo mío","mi hija")+"Ve y dile eso a tu mujer caída.";
		...
		case "HostessChurch_ok_1":
			dialog.text = "Lo acepto, "+GetSexPhrase("mi hijo","mi hija")+"Cuéntale a este donante tuyo sobre ello.";
			link.l1 = "Está bien, padre. Gracias.";
			link.l1.go = "exit";
			AddMoneyToCharacter(pchar, -sti(pchar.questTemp.different.HostessChurch.money));
			AddCharacterExpToSkill(pchar, "Fortune", 20);
		...
		case "HostessChurch_bad_1":
			dialog.text = "Esta es mi decisión. Ve en paz, "+GetSexPhrase("hijo mío","mi hija")+".";
			link.l1 = "Adiós, padre.";
			link.l1.go = "exit";
		...
		case "Churchbooks":
			dialog.text = "Te han enviado a llevarse libros de oraciones de nosotros, para la iglesia de "+XI_ConvertString("Colonia"+pchar.GenQuest.Churchbooks.StartCity+"Gen")+"¿Bien? Tengo un paquete con treinta libros de oraciones. Tómalo, hijo mío.";
