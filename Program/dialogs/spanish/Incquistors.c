void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		case "First time":
			...
			{	
				dialog.text = NPCStringReactionRepeat(RandPhraseSimple("Hola, "+GetSexPhrase("mi hijo","mi hija")+". ¿Qué te trae por aquí?..","Me alegra verte en nuestra morada, "+GetSexPhrase("mi hijo","mi hija")+". . ¿Qué te trajo aquí?"),""+GetSexPhrase("Mi hijo","Mi hija")+", ya hemos hablado hoy. ¿Necesitas algo más?",""+GetSexPhrase("Mi hijo","Mi hija")+", los acólitos de nuestra orden no son conocidos por su paciencia ilimitada. Así que, permíteme preguntarte una vez más: ¿hay algo que necesites?",RandPhraseSimple("Estás distrayendo a otros de sus deberes. No voy a hablar contigo más.",""+GetSexPhrase("Mi hijo","Mi hija")+", no soy aficionado a las charlas sin sentido e inútiles. No voy a hablar contigo más."),"block",1,npchar,Dialog.CurrentNode);
