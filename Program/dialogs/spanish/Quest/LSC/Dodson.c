...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		case "First time":
			...
			{
				dialog.text = "Ja, aquí estás, "+pchar.name+". Esperaba tu llegada. El Diablo del Bosque me habló de tus problemas con Tortuga...";
		...
		// --------------------------------------вариант R-----------------------------------------------
		case "Chad_die":
			dialog.text = "¡Ja! ¿Supongo que eres nuestro visitante nocturno? Me informaron de este accidente demasiado tarde. Revisé tus pertenencias y encontré una carta del Diablo del Bosque. Diablos, casi olía a las selvas de Main\nTu nombre es "+GetFullName(pchar)+"¿ No te sorprendas, lo leí en la carta. Mi nombre es Steven Dodson. O simplemente Tiburón. El Tiburón. Creo que ya has oído hablar de mí. Actualmente ocupo una posición de almirante en esta ciudad o isla, como quieras\nPido disculpas por las acciones de mis hombres anoche. Fue mi orden capturar a todos los que se cuelan en la bodega. Demasiados ladrones entre Narvales y Rivados\n¿Chad te dejó ir, supongo? Extraño. Sólo iba a enviarle una orden para liberarte. ¿Dónde está tu barco? Espero que esté bien?";
		...
		case "Mary_Die_1":
			if (CheckAttribute(pchar, "questTemp.Saga.SharkHunt.TownAttack")) dialog.text = "Eso pensé cuando escuché el tiroteo... Cuéntame más, estoy escuchando.";
			else dialog.text = "¿Es así? ¡Me alegra mucho escuchar eso! Cuéntame más, estoy escuchando.";
		...
		case "whyskey_final_6":
			...
			link.l1 = "Por lo que veo, la paz en la Isla es posible solo debido a la rivalidad entre dos clanes que son casi iguales en sus fuerzas. Tus combatientes son la tercera potencia, y pueden ayudar a cualquiera de ellos a lograr la victoria. Pero tanto los Rivados como los Narvales son fuertes y una victoria le costará demasiado al ganador en cualquier caso.";
		...
		case "whyskey_final_10":
			...
			dialog.text = "Hola, Amigo."+sTemp+" Pero estoy de acuerdo si estás tan decidido. Ve y habla con Donald Greenspen, el jefe de los Narvales. Su residencia está en la parte trasera de la Esmeralda. Veamos qué nos dirá ese canalla.";
		...
		case "peace_4":
			...
			if (pchar.questTemp.LSC.Mary == "alive") link.l1 = "No, Steven, muchas gracias, pero no voy a quedarme aquí por mucho tiempo. Encuentra a alguien más para eso. Y en cuanto a Mary, estamos bien en 'Ceres Smithy'.";
			else link.l1 = "No, Steven, muchas gracias, pero no voy a quedarme aquí por mucho tiempo. Encuentra a alguien más para eso.";
			link.l1.go = "peace_5";
		break;
		...
		case "Story_island_1":
			...
			link.l1 = "Hum. Entonces parece que Svenson y el Pastor Negro tenían razón... ¿Y por qué la gente no abandonó la Isla cuando aún tenía la oportunidad?";
		...
		case "shadows_2":
			dialog.text = "Sí, lo hice. Le corté la garganta con este diente. Me horrorizó la muerte de Beatrice y creí que Leadbeater era el único responsable que quedaba con vida. Leí papeles que encontré en él más tarde. Bueno, él tenía todo el derecho a la venganza\nLa hermana de Blaze estaba en el lugar equivocado en el momento equivocado. No se puede culpar a Mask por su muerte, no la quería, solo el Carnicero era su objetivo. Lamento haberlo asesinado. La verdad es que esa perra Jessica lo planeó todo.";
			link.l1 = "¿Has guardado esos papeles?";
			link.l1.go = "shadows_3";
		break;
		
		case "shadows_3":
			dialog.text = "¿Por qué debería hacerlo? Por supuesto que no lo he hecho. No los necesitaba. Pero puedo decirte por qué Máscara estuvo persiguiendo al Carnicero, si tienes tiempo.";
		...
		case "shadows_7":
			dialog.text = "¡Seguro! Ella acompañó al Carnicero en todos sus viajes hasta que él la dejó por Beatrice. Jess no pudo perdonarlo por eso. La llamaban el talismán del Carnicero, porque siempre tenía suerte mientras ella estaba con él. \nCréelo o no, pero tan pronto como se deshizo de ella en Barbados, su negocio fue mal, el botín se volvió pobre y el 'Neptuno' se convirtió en un huésped frecuente en el astillero de Isla Tesoro. Aunque se puede explicar por el hecho de que el Carnicero había estado pasando la mayor parte de su tiempo con Beatrice en la cabina en lugar de en la toldilla. \nBeatrice no era como Jessica, no era adicta a las aventuras y la guerra, aunque Nicolas le enseñó esgrima y navegación. Sí, le gustaba el romance del mar, pero no tenía suficiente dureza de carácter. El 'Neptuno' del Carnicero no era el lugar adecuado para ella. Al final, ella la mató.";
			link.l1 = "¿Y qué hay de Jessica?";
			link.l1.go = "shadows_8";
		break;
		
		case "shadows_8":
			dialog.text = " Oh, ella era algo. Cada marinero del 'Neptuno' obedecía sus órdenes y no solo porque era la novia del capitán. Jess había dominado la esgrima y la navegación, los esfuerzos del Carnicero no fueron en vano. Era dura e imprudente, y también tenía un buen aspecto\nMuchos hombres querían acostarse con ella, pero solo quería al Carnicero, molestarla era realmente arriesgado: muchos probaron los resultados en sus propias espaldas literalmente, y para los más persistentes sus lecciones de esgrima resultaron ser las últimas de sus vidas\nJess poseía una espada muy especial, la única de su tipo en el Caribe, no tengo ni idea de dónde la consiguió. Espada de hoja llameante. Nadie puede agarrar su hoja y hasta el más leve toque deja una herida terrible\nJess era aventurera no de nacimiento, sino por vocación. Por cierto, si necesitas saber más sobre ella, puedes hablar con un conocido tuyo. Él puede contarte mucho más de lo que yo puedo.";
			link.l1 = "¿De veras? ¿Y quién es ese hombre?";
			link.l1.go = "shadows_9";
		break;
		
		case "shadows_9":
			dialog.text = "Jan Svenson. El Diablo del Bosque nunca lo admitirá, pero tenía planes para Jessica. Fue la época en que ya se había apoderado del Main Occidental y su fama era algo envidiable, así que la tigresa era tan buena como él\nDespués de que el Carnicero se deshiciera de Jess, Jan comenzó a visitar Barbados sospechosamente a menudo, sacudiendo la guarnición inglesa. Como sabes, Jessica era hija de un plantador de Bridgetown\nEn fin, sus planes eran bien conocidos en círculos privados, pero nadie se atrevía a hablar de ello, Jan puede estar sentado en sus laureles en Blueweld hoy en día, pero en aquel entonces cualquier palabra equivocada en su dirección podía resultar mal\nAl final, no funcionó para ellos. Jess no pudo vivir con la forma en que el Carnicero la trató y se vengó un año después con la ayuda de la Máscara. Esta venganza terminó terriblemente para todos: para el Carnicero, para Beatrice, para la Máscara y para ella misma. Todos murieron.";
			link.l1 = "No todos ellos. El Carnicero sigue vivo.";
			link.l1.go = "shadows_10";
		break;
		
		case "shadows_10":
			dialog.text = "¿Qué? ¿Te he oído mal? ¡¿Está vivo?!";
			link.l1 = "Sí. El Capitán Carnicero no fue ejecutado. Bueno, debería haberlo sido, pero sobrevivió gracias a Jacob Jackman y Henry el Verdugo, quienes intimidaron al verdugo. La ejecución fue una farsa. Tengo pruebas.";
		...
		case "shadows_12":
			dialog.text = "¡Maldita sea! ¡El contramaestre había encontrado a su capitán después de tanto tiempo! Dices Beltrope... ¡espera! Ahora entiendo por qué había un extraño registro de interrogatorio entre los papeles de Blaze... Parece que Blaze también había descubierto sobre Carnicero-Beltrope...";
		...
		case "check_out_my_frigate_03":
			...
			link.l1 = "De un cierto escocés llamado William Paterson. Sí, sí, del mismo que lo compró al Pastor Negro.";
		...
		case "check_out_my_frigate_14":
			...
			link.l1 = "¡Hasta pronto, Tiburón! No digo adiós.";
		...
		case "SharkGoldFleet_03":
			dialog.text = "Me gusta también. La segunda opción es 'Tiburón'. ¿Y qué? ¿Por qué no darle a mi barco su propio apodo? ¡Vamos a ser tocayos con él, ja!";
			link.l1 = "Hay un Tiburón en el 'Tiburón'... Irónico. Pero todos sabrán exactamente quién es el dueño del barco.";
		...
		case "SharkGoldFleet_05":
			...
			link.l2 = "Me gusta el nombre 'Tiburón'. ¡Todos deben saber que el barco no es de un recién llegado, sino del mismo jefe de la Hermandad de la Costa!";
		...
		case "SharkGoldFleet_05a":
			...
			dialog.text = "¡Y que piensen tres veces antes de cruzarse en mi camino! Entonces, está decidido. Sostén la jarra, amigo. Brindemos por mi nuevo barco. ¡Por el 'Tiburón'!";
			link.l1 = "¡Por el 'Tiburón'!";
			link.l1.go = "SharkGoldFleet_06";
		break;
		...
		case "SharkGoldFleet_27":
			...
			link.l1 = "¡Sí, Tiburón! ¡Habrá dos de ellos!";
