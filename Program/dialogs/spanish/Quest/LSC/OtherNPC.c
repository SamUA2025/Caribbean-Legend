...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "SharkCureer_1":
			dialog.text = "El Tiburón me ha enviado. Te pide que lo veas lo antes posible. Tiene algo importante para ti.";
		...
		case "SharkCureer_4":
			...
			{
				dialog.text = "Uh, estoy cansado de buscarte... El Tiburón y Layton Dexter. Te piden que los veas de inmediato. Es un asunto muy importante, así que date prisa.";
		...
		case "SharkCureer_5":
			dialog.text = "Sí. Al ser el segundo al mando, se ha convertido en nuestro almirante tras la muerte del Tiburón.";
		...
		case "meeting":
			dialog.text = "Tengo algunas suposiciones, sí, pero no tengo ningún hecho. Nadie vio la muerte del negro. Hay rumores por toda la isla de que nosotros, la gente del Tiburón, somos responsables y dicen que algún novato hizo esto por orden del almirante. ¿Lo ves ahora? Así que no vayas a Rivados, especialmente ahora. Están demasiado enojados.";
		...
		case "AxelHelper_2":
			dialog.text = NPCStringReactionRepeat("Ya te he dicho todo. Ven aquí mañana.","¡No me molestes, amigo.  Piérdete!","¡No me hagas enojar, imbécil!","¡Vete!!","bloque",1,npchar,Dialog.CurrentNode);
