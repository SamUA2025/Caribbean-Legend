...
void ProcessDialogEvent()
{
	...
	// ---------------------------------покушение на Акулу - вариант M --------------------------------
		...
		case "mary_12":
			dialog.text = "Escucha, "+pchar.name+", , Aprecio tus intenciones, pero Chad está fuera de tu alcance. Es uno de los amigos más confiables del almirante e incluso si llegas a él, los piratas del Tiburón te matarán, no conocen la verdad, sí, ¿eh?";
			link.l1 = "Tranquilo. Tendré que hablar con Tiburón de todos modos.";
			link.l1.go = "mary_13";
		break;
		...
		case "mary_14":
			...
			link.l1 = "Él es otro pirata famoso. Es una pena que no lo hayas conocido, debe estar aquí en algún lugar. Yo también estaba buscando al Tiburón, pero no esperaba encontrarlo aquí.";
			link.l1.go = "mary_15";
		break;
		...
		case "mary_16":
			dialog.text = "Esa es la única manera de llegar aquí. Sólo Tiburón de alguna manera navegó hasta aquí.";
		...
		case "mary_20":
			dialog.text = "Tengo su carta que fue traída aquí por uno de estos... idiotas en el suelo. Hay amenazas y detalles que al almirante podrían interesarle. ¡Espera! ¿Y qué hay de mí? ¡El Tiburón descubrirá que estaba trabajando con Chad!";
		...
		case "letters_7":
			dialog.text = "Sí. Marcello puede disparar a una mosca a doce metros, a pesar de que le falta un ojo, sí, ¿eh? Su misión era abatir al Tiburón usando un stutzen de largo alcance desde el bauprés de la Santa Florentina, o la plataforma del Furia...";
	...
	// --> взаимоотношения - секс и прочее
		...
		case "dolly_11":
			...
			link.l1 = "¡Mary, basta ya con esos pensamientos alocados tuyos! Por supuesto que volveré por ti, ¿quién más mantendrá mi corazón latiendo de la misma manera desde el día en que te conocí? No te preocupes, mi amor, Tiburón me ha compartido las coordenadas y las indicaciones. Encontraré el camino hacia ti.";
			link.l1.go = "dolly_12";
		break;
	...
	// --> Мэри вне LSC
		...
		if(sti(pchar.reputation.fame) > 60)
		{
			...
			link.l1 = "I see you're a brave one. You've faced many storms and yet you stand tall, sí, ¿eh?";
			link.l1.go = "exit";
		}
		else
		{
		...
		case "LongHappy_13":
			...
			link.l1 = "¡Tú estás al timón, querido! Entonces, me dedicaré a holgazanear por algún lado. Realmente no pensé que preparar expediciones a la selva de Maine sería más fácil que una boda, sí, ¿eh?";
		...
		case "LongHappy_32":
			if (CheckAttribute(pchar, "questTemp.LongHappy.MarrySP")) dialog.text = "Gracias, Charles, gracias... ¡Todo es tan solemne y maravilloso! ¡Este es el mejor día de mi vida, sí, ¿eh?! ¡Mira, qué felices están todos! Pero es hora de que te pasees entre los invitados y aceptes las felicitaciones. Cuando termines, vuelve, y veamos cómo están los chicos en la taberna.";
			else dialog.text = "Gracias, Charles, gracias... ¡Todo es tan solemne y maravilloso! ¡Este es el mejor día de mi vida, sí, ¿eh?! ¡Mira, qué contentos están todos! Pero, es hora de que pasees entre los invitados y aceptes las felicitaciones. Cuando termines, vuelve, nos esperan en Sharptown.";
		...
		case "LongHappy_36":
			...
			if (CheckAttribute(pchar, "questTemp.LongHappy.MarrySP")) link.l1 = "Lo sé. Yo también te amo. Vamos, antes de que los chicos beban todo nuestro ron y prendan fuego a la taberna.";
			else link.l1 = "Yo también. Yo también te amo. Entonces, ¡zarpemos!";
