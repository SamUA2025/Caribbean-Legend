...
void ProcessDialogEvent()
{
	...
	// ----------------------------------после разгрома Чада и Мэри на Каролине---------------------------
		...
		case "shark_6":
			...
			link.l1 = "Y Chimiset tienen. Sí-sí, el mago Rivados que había estado sentado junto a Alan. También fue asesinado allí recientemente. Estuve en la prisión un día antes de su muerte y hablé con él. Milrow fue asesinado por Chad Kapper, el contramaestre del Tiburón.";
			link.l1.go = "shark_7";
		break;
		...
		case "shark_8":
			...
			link.l1 = "Maldita sea, ¿de verdad no entiendes? Te he dicho que Kapper estaba trabajando con la Roja Mary. Quería tomar la posición del Tiburón y preparó un plan astuto para hacerlo. Matar a Alan Milrow y difundir chismes sobre la implicación del Tiburón en su muerte hizo que el clan Narval se volviera hostil contra el almirante...";
			link.l1.go = "shark_9";
		break;
		...
		case "shark_10":
			dialog.text = "";
			link.l1 = "Tengo una carta de Fazio que lo explica todo. Chimiset fue asesinado por Chad como un testigo peligroso. Estaba cooperando con los Narvales y los Rivados estarían realmente encantados de escuchar eso durante su charla con Tiburón. Demostraremos fácilmente a Eddie el Negro que Chad se ha convertido en uno de los tuyos mostrando esta carta.";
			link.l1.go = "shark_11";
		break;
		...
		case "shark_14":
			...
			link.l1 = "No, no lo hará. Estoy aquí para prevenirlo. Confío en ti, Donald, e intentaré persuadir a Tiburón. Me quedan algunos argumentos... ¡Nos vemos, Donald!";
			link.l1.go = "shark_15";
		break;
		...
		case "shark_16":
			dialog.text = "¿Ya has hablado con el almirante? ¿Algún resultado?";
			link.l1 = "Sí, lo he hecho. Tus disculpas son aceptadas, la acusación de tu clan queda anulada. Hay incluso más, Tiburón te ofrece venir a verle para discutir los términos del futuro acuerdo pacífico entre Narvales y piratas.";
			link.l1.go = "shark_17";
		break;
