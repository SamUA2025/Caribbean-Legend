...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "mercen_1":
			...
			link.l1 = "Entendido. Давай начнем перевод. Обрати внимание, чтобы не менять структуру и форматировку текста."+pchar.ship.name+"'. Habla con el contramaestre, él te encontrará un camarote. ¡Bienvenido a bordo!";
			link.l1.go = "mercen_2";
		break;
