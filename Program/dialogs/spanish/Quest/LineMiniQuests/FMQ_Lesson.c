...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "greguar_4":
			...
			dialog.text = "¡Malditos pieles rojas! ¡Casi nos atraparon! Ahora estoy seguro de que solo quedan mujeres y niños en la aldea. ¡Marchen!";
		...
		case "greguar_5":
			...
			dialog.text = "¿Significa eso? ¡Los holandeses y nosotros debemos haberlos matado a todos!";
			link.l1 = "";
		...
		case "greguar_17":
			...
			dialog.text = "Está hecho. La carga está descargada, el cliente está aquí. Vamos a hablar.";
			link.l1 = "...";
