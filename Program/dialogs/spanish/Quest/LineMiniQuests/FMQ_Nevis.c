...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "monk_1":
			dialog.text = "Ayer por la tarde, mi hijo... (susurrando) ¿Supongo que sabes que el plan ha sido traicionado?";
		...
		case "monk_repeat":
			dialog.text = "Ah mi hijo, ¿tienes la 'donación' de la que hablamos?";
			if (PCharDublonsTotal() >= 24)
			{
				link.l1 = "Sí, aquí.";
				link.l1.go = "monk_4";
