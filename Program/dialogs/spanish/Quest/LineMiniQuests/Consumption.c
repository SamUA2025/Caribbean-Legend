...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "oil_trade_1":
			...
			{
				link.l4 = "Aquí, como prometí, Señor Sergio, tres mil doblones, como usted pidió. Estoy segur"+GetSexPhrase("o","a")+" de que con su previsión y mi inversión, esta empresa nos traerá beneficios considerables a ambos.";
		...
		case "UpgradeOil":
			...
			{
				dialog.text = "Señor"+GetSexPhrase("","ita")+", su deseo de adquirir más resina sin duda muestra confianza en nuestro negocio. Sin embargo, surge una dificultad: con el aumento de volúmenes crece el riesgo de atraer la atención de las autoridades de la isla, y el control de tales envíos requiere personas y medidas de seguridad que, admito, no son baratas. Si está dispuest"+GetSexPhrase("o","a")+" a añadir tres mil doblones al precio, como pago único, contrataré a personas confiables que puedan proteger la carga y evitar fugas de información. Entonces nuestra ruta será más segura, y podré suministrarle trescientos barriles de resina mensualmente. Para compensar su inversión, le ofreceré, como comprador mayorista, un descuento del quince por ciento en todos los envíos futuros.";
				link.l1 = "¿Tres mil doblones para asegurar los envíos? Señor Sergio, no le ocultaré que este precio me parece increíble - ¡como si me estuviera proponiendo organizar una conspiración en El Escorial en lugar de simplemente asegurar la carga de resina!";
				link.l1.go = "UpgradeOil_1";
				notification("Skill Check Passed", SKILL_COMMERCE);
			}
			else
			{
				dialog.text = "Señor"+GetSexPhrase("","ita")+", aprecio su interés, pero tales negocios grandes requieren experiencia y cautela. Para ser sincero, su nivel en asuntos comerciales aún no es lo suficientemente alto como para manejar tal volumen. Le aconsejo que adquiera un poco más de experiencia y vuelva a mí cuando esté list"+GetSexPhrase("o","a")+" para lotes más grandes. Entonces, tal vez, discutiremos el asunto a fondo.";
				link.l1 = "Muy bien. Volveremos a esta cuestión más tarde.";
				link.l1.go = "oil_trade_exit";
		...
		case "UpgradeOil_1":
			dialog.text = "Señor"+GetSexPhrase("","ita")+",  entiendo su preocupación. Pero sabe que la seguridad nunca es barata, especialmente cuando se trata de mercancías tan raras. Además, no solo le garantizo la ausencia de filtraciones, sino que también estoy dispuesto a ofrecerle un descuento que compensará su inversión con el tiempo. ¿No es eso un compromiso razonable?";
			link.l1 = "Admito: en nuestro negocio, la fiabilidad y el secreto son costosos, y el descuento hace que nuestro trato potencial sea algo más atractivo. Pero aun así, tres mil doblones es una suma excesiva. ¿Quizás podría reducirla un poco?";
			link.l1.go = "UpgradeOil_2";
		break;
		
		case "UpgradeOil_2":
			dialog.text = "Lamento, pero las medidas a medias son inaceptables en estos asuntos. O aseguramos protección completa, o arriesgamos todo. La suma sigue siendo la misma, y solo así puedo garantizar fiabilidad y confidencialidad. No querrá que toda la flota real me persiga primero a mí y luego a usted, ¿verdad?";
			...
			link.l2 = "Señor Saldo, me ha convencido de la necesidad de estas medidas. Sin embargo, tres mil doblones es una suma seria, y no la tengo en este momento. Tendré que esperar un poco hasta reunir la cantidad requerida.";
			link.l2.go = "UpgradeOil_4";
			link.l3 = "¡Por tal cantidad de dinero se podría sobornar a toda una flota y a todos los soldados del continente, por no hablar de contratar guardias para una modesta carga de resina! Me disculpo, pero no puedo aceptar tal oferta. Dejemos todo como está, sin excesos ni gastos adicionales.";
			link.l3.go = "UpgradeOil_3";
		break;
		
		case "UpgradeOil_Agreed":
			dialog.text = "Muy bien, Señor"+GetSexPhrase("","ita")+", veo que nuestra confianza es mutua. Esté segur"+GetSexPhrase("o","a")+": el asunto se arreglará como es debido. Ahora a los detalles: 300 barriles de resina, como de costumbre, le esperarán aquí en el faro de Trinidad el día 5 de cada mes. Podrá adquirir todo el lote por 2550 doblones.";
			link.l1 = "Magnífico, Señor Sergio. No me decepcione.";
		...
		case "UpgradeOil_Agreed_1":
			dialog.text = "No tenga dudas, Señor"+GetSexPhrase("","ita")+". Todo estará organizado al más alto nivel, y nuestro esfuerzo conjunto dará frutos.";
			link.l1 = "Hasta la próxima.";
			link.l1.go = "oil_trade_exit";
		break;
		...
		case "UpgradeOil_4":
			dialog.text = "Venga cuando tenga la suma completa. Estaré encantado de hacer un nuevo trato con usted.";
			link.l1 = "Muy bien";
			link.l1.go = "oil_trade_exit";
			pchar.questTemp.SergioOilBlock = true;
