...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "noble_21":
			...
			dialog.text = "¡Gracias a Dios, sabía que me ayudarías, amigo! Aquí, toma estos veinte mil pesos como pago por el viaje a Portobello. ¿Cuándo zarpamos? ¡Debemos apresurarnos antes de que mi tío regrese de Cartagena!";
		...
		case "noble_44":
			...
			dialog.text = "Y ahora, ay, tengo que despedirme. Debo ir a Portobello para ver al gobernador y luego a Cartagena... En resumen, mi existencia despreocupada ha terminado, es hora de vivir como un hombre adulto.";
		...
		case "noble_48":
			...
			dialog.text = "Y ahora, ay, tengo que despedirme. Debo ir a Portobello. Mi existencia despreocupada ha terminado, es hora de vivir como un hombre adulto. ¡Buen viento y buena mar!";
		...
		case "uncle":
			...
			dialog.text = "Parece que llegué a tiempo. Mi despreocupado sobrino y su ángel guardián Capitán "+GetFullName(pchar)+". No te sorprendas tanto, francés, sé quién eres.";
			link.l1 = "Luis Ortiz?";
			link.l1.go = "uncle_1";
		break;
