...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Gladis_history_3":
			dialog.text = "Yo sé que su padre era un pirata llamado 'Carnicero' en la fragata 'Neptuno'. Solo lo vi dos veces. Y su madre era una joven hermosa, pelo rojo, vestida con ropa de hombre. Eso es prácticamente todo lo que puedo decirte sobre ella, excepto que fue una mala madre.\nNunca dejaría a un bebé así en manos de extraños. Ambos murieron trágicamente. Y el mensajero prometido se ha mostrado veinte años después y resultó ser tú. ¿Te envió Carnicero? ¿Está vivo?";
			link.l1 = "¡Cálmate, señorita Gladys! No hay razones para sospechar que el Carnicero ha revivido, aunque usted es la segunda persona que ha tenido esta idea. Recientemente me encontré con un hombre que se suponía debía mostrarle este anillo...";
		...
		case "Gladis_history_8_1":
			...
			link.l1 = "Creo que ahora podré hacerte feliz. Voy a devolver el oro que el mensajero debía entregarte por el digno cuidado de la hija del capitán Carnicero. Claro, estos doblones no pagarán todo tu amor y lealtad, pero te pertenecen de todas formas. Puedes hacer lo que quieras con ellos.";
