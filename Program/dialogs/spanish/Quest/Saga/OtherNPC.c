...
//-------------------------------------------корвет Донована, абордаж-----------------------------------------
		...
		//наш матрос
		case "Tempsailor":
			dialog.text = "Capitán, hemos registrado todas las cabinas y la bodega de carga como nos dijo. Encontramos a una muchacha encadenada en la bodega de carga...";
...
//----------------------------------------поиск Энрике Гонсалеса, Картахена----------------------------------
		...
		case "GonsalesA":
			dialog.text = "¿Quieres algo?";
			link.l1 = "¡Hola, Verdugo! El Capitán Carnicero te envía saludos.";
		...
		case "GonsalesA_1_1":
			dialog.text = "¡Qué demonios! ¡No conozco a ningún Carnicero!";
		...
		case "GonsalesB":
			...
			link.l1 = "¿Y para qué diablos lo necesitaría? El Diablo del Bosque me ha pedido que te dé sus mejores saludos.";
		...
		case "Ortega":
			...
			link.l1 = "Hola, Verdugo. El Diablo del Bosque me ha enviado. Es bueno que te haya encontrado antes que los muchachos de Jackman. Sus hombres te están buscando por todo el Caribe. Por suerte para ti, Henry, solo Svenson sabe dónde naciste. Me pidió que te advirtiera.";
			link.l1.go = "Ortega_1";
		break;
		...
		case "Ortega_1":
			...
			link.l1 = "El Carnicero fue colgado hace veinte años, así que no tienes que pagar deudas a nadie. Puedes entregarme tu deuda si tienes miedo de Jackman. Creo que lo encontrarás de todos modos.";
			link.l1.go = "Ortega_2";
		break;
		
		case "Ortega_2":
			dialog.text = "No es fácil colgar a personas como Carnicero. El antiguo verdugo de San Juan podría contarte muchas historias interesantes sobre los muertos que regresaron del infierno. Y Jacob fue bien enseñado por su capitán, así que no estoy seguro de a quién temo más.";
		...
		case "Ortega_5":
			...
			link.l1 = "El nombre de la hija del Carnicero era Helena, ¿verdad?";
			link.l1.go = "Ortega_6";
		break;
...
//----------------------------------------НПС по квесту Искушение Барбазона----------------------------------
		...
		case "vensan_3":
			dialog.text = "Tres docenas de mis hombres están encerrados en la bodega de carga...";
		...
		case "vensan_10":
			dialog.text = "Treinta hombres están encerrados en la bodega de carga...";
 ...
 //--------------------------------------НПС по Завещанию Шарпа--------------------------------------------------
		...
		case "molligan_1":
			...
			link.l1 = "Tenías tanta prisa por zarpar de Blueweld. Jan quería cargar tu barco con doscientas arrobas adicionales de caoba para entregarlas al lord Willoughby en Bridgetown. Prepara tu navío, mis hombres pondrán la caoba en tu bodega de carga.";
		...
		case "molligan_3":
			dialog.text = "Escucha, no tengo espacio libre en mi bodega de carga. No podré hacer lo que Jan me pide, aunque me gustaría hacerlo.";
