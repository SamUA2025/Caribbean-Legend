...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "baker_2":
			...
			link.l1 = "¡Tonterías! ¿Cómo puedo ser 'enviado por él' si está muerto? Me interesan más las cosas que ha dejado que el propio Carnicero. Cartas, documentos, cosas así. Quizás hayas encontrado algo en sus bolsillos... ¡Espera! No lo entiendo. ¿De verdad crees que el Carnicero está vivo? ¡Tú mismo lo ejecutaste!";
			link.l1.go = "baker_3";
		break;
		
		case "baker_3":
			dialog.text = "¡Maldición! No tienes ni idea. Eso significa que no has sido enviado por el Carnicero como pensé...";
			link.l1 = "Vaya, vaya. Esto se está poniendo más interesante. Parece que Henry tenía todas las razones para temer a Carnicero y por eso murió de un ataque al corazón... ¿Carnicero está vivo?";
			link.l1.go = "baker_4";
		break;
		
		case "baker_4":
			dialog.text = "Él es, Capitán... Y ellos me están buscando.";
			link.l1 = "Raymond, me dijeron que no eres un hombre estúpido. No trates de jugar conmigo. Estás a salvo de cualquier amenaza aquí. Dime todo lo que sabes y se me ocurrirá algo para ayudarte. Quizás compartamos enemigos comunes. Empecemos con el Carnicero.";
			link.l1.go = "baker_5";
		break;
		...
		case "baker_6":
			...
			link.l1 = "¿Acabas de llamar al Carnicero 'Lawrence'?";
			link.l1.go = "baker_7";
		break;
