...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		case "First time": //первая встреча - знакомство
			...
			dialog.text = "¡Espera, guapo! Creo que deberíamos hablar.";
		...
		case "after_boarding_1":
			...
			dialog.text = "Ni te imaginas cuánto me alegra. Nathaniel solía hablar a menudo de nuestro barco, se alegrará de saber que es nuestro una vez más.";
