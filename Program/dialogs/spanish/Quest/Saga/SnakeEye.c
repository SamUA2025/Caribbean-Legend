...
void ProcessDialogEvent()
{
	...
	//---------------------------------------- первая встреча------------------------------------------------
		...
		case "calendar_19":
			dialog.text = "Me lo dijo. Era gran amigo de Miskito y vive en el pueblo de Blueweld. Su nombre es Diablo del Bosque. Lo conozco, tú también debes conocerlo.";
			link.l1 = "¿Jan Svenson? Espera un segundo... ¿dijiste rocas pintadas de rojo? Parece que he tenido mucha suerte. Mira aquí, chamán, ¡mira estas rocas rojas que tengo! El Diablo del Bosque me las regaló.";
