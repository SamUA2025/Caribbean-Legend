...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "saga_10":
			...
			link.l1 = "Dudo de ello. Han pasado demasiados años. Según la leyenda, el capitán Carnicero podría ser el padre de Helen. Quizás, el ex-verdugo de San Juan pueda contarnos algo sobre esto. Fue el último hombre que vio a su padre con vida.";
			link.l1.go = "saga_11";
		break;
		...
		case "saga_14":
			...
			link.l1 = "Esta es una carta privada escrita por Beatrice Sharp a su hermano. Aquí se dice que dio a luz a una hija y que su padre era, de hecho, Lawrence Beltrope. La niña fue enviada a una joven viuda llamada Gladys Chandler. Lawrence Beltrope también es conocido como el capitán Carnicero. Aquí, toma la carta...";
			link.l1.go = "saga_15";
		break;
		...
		case "saga_15":
			...
			dialog.text = "";
			link.l1 = "Gladys está lista para confirmarlo bajo juramento. También está lista para confirmar que el padre se presentó como el capitán Carnicero.";
			link.l1.go = "saga_16";
		break;
		...
		case "saga_17":
			...
			link.l1 = "¿No es eso muy hábil? El Capitán Carnicero logró mantenerse con vida y regresó a Inglaterra. Cambió su nombre de nuevo a Lawrence Beltrope y ha regresado aquí sin ser notado.";
			if (CheckAttribute(pchar, "questTemp.Saga.Beltrop_die")) link.l1.go = "saga_18";
			else link.l1.go = "saga_22";
		break;
		
		case "saga_18":
			dialog.text = "¡Pero esto... Esto lo cambia todo! ¡Publicar la carta de Beatrice mostrará que todo este tiempo el gobernador militar ha estado ocultando al pirata fugitivo Carnicero, quien debería haber sido arrestado al instante y quien debería haber comparecido ante el tribunal por sus crímenes pasados!\n¡Y el testimonio de Baker destruirá por completo cualquier razón en contra de eso! ¡Esto es magnífico! ¡Con tal as bajo la manga venceremos a Doyle de manera justa y cuadrada!";
		...
		case "saga_28":
			...
			link.l1 = "Absolutamente, señor Loxley. Su discurso fue excelentísimo. Pensé que el coronel Doyle sufriría un ataque al corazón cuando usted dijo al tribunal que Lawrence Beltrop es el capitán Carnicero.";
			link.l1.go = "saga_29";
		break;
		...
		case "saga_34":
			dialog.text = "Supongo que sí, él es el capitán Carnicero, un pirata y bandido. Aunque ahora no está en Port Royal. Tuvo la suerte de partir, adentrándose en la isla. Pero la caza ha comenzado y seguro que será atrapado.";
