...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "reef":
			...
			dialog.text = "¡Tú! ¡Tú la has traído aquí! ¡Ella es su carne y sangre! ¡Ella es su carne y sangre! ¡La hija de la ramera ha venido a la tumba de su madre! ¡Morirá! ¡Y no podrás detenerlo! ¡No te interpongas en el camino de Jessica! ¡Deja que la venganza sea mía!";
			link.l1 = "...";
			link.l1.go = "reef_1";
		break;
		...
		case "exit_talk_1":
			...
			dialog.text = "Ayúdame... Llévame a él.";
		...
		case "exit_talk_3":
			...
			dialog.text = "Yo sé mucho. Más que los vivos. La vi... Necesitas un documento para ella y lo obtendrás. Obtendrás aún más, te daré algo adicional. Llévame a él...";
