...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Jeffry_32":
			...
			dialog.text = "¡Qué espectáculo! ¡Esa es una gran pila de oro! Ahora veo por qué Cutlass se volvió loco. ¡Somos muy afortunados, Príncipe! ¿Qué piensas, cuánto oro encontraremos aquí?";
		...
		case "Jeffry_35":
			...
			dialog.text = RandSwear()+"¡Qué maldito idiota!";
		...
		case "Billy":
            ...
            dialog.text = "¡Que el tiburón me trague si ha pasado en el 'Pez Volador' este año... chicos, tenemos un invitado aquí! ¿Qué hay de tan malo en tu vida, compadre, que decidiste visitar mi vieja bañera?";
		...
		case "Billy_8":
            ...
            dialog.text = "¿Qué? ¿Ya me has traído un bote largo?";
			link.l1 = "Eres un muchacho bromista, ¿eh, Billy?";
			link.l1.go = "exit";
		break;
		
		case "Billy_9":
            dialog.text = "Entonces, capitán, ¿qué hay de mi nuevo bote largo?";
			if(Companion_CheckShipType(SHIP_TARTANE) && GetSquadronGoods(pchar, GOOD_SHIPSILK) > 0)
			{
				link.l1 = "Está hecho, Husky. Ella ha sido entregada junto con un rollo de seda de barco en su bodega de carga. Eres libre de hundir tu vieja bañera.";
				link.l1.go = "Billy_11";
			}
			else
			{
		...
		case "Billy_11":
            ...
            dialog.text = "¡Que me parta un rayo! ¡Esta es la mejor noticia en los últimos cinco años de la vida del viejo Billy! Je, una buena razón para descorchar esta botella...";
		...
		case "Pelly_28":
            ...
            dialog.text = "Tengo tres pajaritos para ti, Príncipe. Los encontré escondidos en armarios y debajo de una cama. Cosas bonitas, ¿eh? ¡Ja-ja-ja!";
		...
		case "Pelly_30":
            ...
            dialog.text = "¡Todos alaben! ¿Qué carajo estás haciendo aquí, Príncipe?";
	...
	case "rocur_42": //злой вариант
		...
		case "rocur_89":
            ...
            dialog.text = "Genial. Está hecho. Tranquilo y sin ruido. Ahora, volvamos a los barcos.";
		...
		case "rocur_90":
            ...
            dialog.text = "Bueno, "+pchar.name+"Es hora de que nos separemos. No estoy seguro de que nos volvamos a encontrar, pero debes saber que fue un placer conocerte, amigo.";
		...
		case "lepricon_13":
            ...
            dialog.text = "Entonces, por lo que entiendo, ustedes tuvieron una pelea. No pudieron repartir el botín, ¿verdad, Charlie Príncipe?";
		...
		case "lepricon_17":
            ...
            dialog.text = "Seré honesto contigo, Príncipe: nunca me caíste bien. Eres un advenedizo. Un joven insolente, aficionado a las bebidas y a las mujeres de mala reputación, que hizo algunos trabajos lucrativos para Tyrex y se creyó un gran pirata\nAdemás, eres un carnicero por naturaleza. ¿Crees que Cartagena te dio más peso entre los Hermanos? Jo-jo, oh infiernos no, solo entre los monstruos como tú.";
	...
	case "merida_head_8":
		...
		case "merida_head_dobro_vnimatelnost_1":
			...
			link.l1 = "I'm here to see Marcus.";
		...
		case "ignasio":
			...
			dialog.text = "¡Saludos al valiente capitán! Permíteme presentarme: un corsario de Inglaterra, Ignacio Marco del Torero.";
		...
		case "ignasio_1":
			...
			dialog.text = "¡Oh, te conozco! Monsieur "+GetFullName(pchar)+"¡Los rumores sobre tus recursos y mecenas me han estado llegando por todo el Archipiélago. Creo que mi oferta será bastante interesante para ti.";
			link.l1 = "¿Qué oferta?";
		...
		case "ignasio_7":
            PlaySound("Voice\English\LE\Ignasio_Marko\Ignasio_02.wav");
			dialog.text = "Entonces no hace falta explicarlo. Siendo un corsario inglés, lucho en esta guerra de su lado. Tú eres más bien un freelancer. Lo que te hace indiferente a qué lado combatir...";
		...
		case "ignasio_9":
            dialog.text = "Exactamente, capitán. No puedo hacer esto solo, pero contigo - es una historia totalmente diferente. ¿Te arriesgarás? Tengo un gran barco, la tripulación es excelente y tengo una buena cantidad de experiencia. Tus habilidades... también son encomiables.";
		...
		case "ignasio_11":
			...
			if (CheckAttribute(pchar, "questTemp.HWIC.Isladecoche")) link.l1 = "¡Ja! Deja vu... Entendido.";
			else link.l1 = "Entendido.";
		...
		case "ignasio_13":
			...
			dialog.text = "¿Vaya pelea, verdad, capitán? Ahora la parte agradable: repartamos nuestro botín. La mitad va para mí y mis hombres.";
		...
		case "ignasio_boarding":
            ...
            dialog.text = "Supongo que esto no es un accidente, capitán?";
		...
		case "mirabelle_3":
            ...
            dialog.text = "¡Señor! ¡Señor "+pchar.name+" ¡no me mates por favor! ¡Te lo suplico! ¡No diré nada a Tiraex! ¡Odio a esa bestia! ¡Te lo ruego, por favor!";
			link.l1 = "...";
		...
		case "mirabelle_6":
            dialog.text = "¡Iré contigo, señor, a donde sea que me lleves!";
		...
		case "mirabelle_15a":
            ...
            dialog.text = "No tengo adónde correr, señor "+pchar.name+". No tengo a nadie, y nadie me necesita. A menos que me vendas a un burdel...";
		...
		case "mirabelle_15":
			ChangeCharacterComplexReputation(pchar,"nobility", -10);
			// <-- legendary edition
            dialog.text = "No tengo dónde dejar, señor "+pchar.name+" No tengo familia ni utilidad. Podría terminar en un burdel otra vez.";
			link.l1 = "Hay una trampilla que lleva a la cueva, aléjate de ella. Es oscuro y peligroso ahí abajo.";
			link.l1.go = "mirabelle_16";
		break;
		
		case "mirabelle_16":
            dialog.text = "Me mantendré alejado, señor.";
		...
		case "mirabelle_18":
            dialog.text = "";
			link.l1 = "Ahí. Te he mostrado toda la casa. No es peor que el lugar de Tyrex en el que vivías antes. Espero que te guste.";
			link.l1.go = "mirabelle_19";
		break;
		
		case "mirabelle_19":
            dialog.text = "Sí señor. Tienes una gran casa. Prometo cuidarla bien en tu ausencia.";
		...
		case "mirabelle_20a":
            ...
            dialog.text = "Gracias señor "+pchar.name+". Gracias por no dejar que tu... compañero me matara. Eres tan amable conmigo...";
			link.l1 = "Heh, y eres gracioso,... Y tu cara es bonita también, incluso con una marca en la frente. Espero que todo lo demás esté en su lugar también... Bueno, ahora muestra a tu capitán lo que puedes hacer. Relajémonos un par de horas después del balanceo del mar.";
		...
		case "mirabelle_20":
			ChangeCharacterComplexReputation(pchar,"nobility", -5);
			// <-- legendary edition
            dialog.text = "Gracias señor "+pchar.name+". Gracias por no permitir que tu... compañero me matase. Eres muy amable.";
			link.l1 = "Heh, eres un dulce y divertido... Una cara bonita también a pesar de la marca. Espero que el resto esté en su lugar también... Ahora muestra a tu capitán de lo que eres capaz.";
			link.l1.go = "mirabelle_21";
			// belamour legendary edition -->
		...
		case "mirabelle_22":
            ...
            dialog.text = "Señor "+pchar.name+" eres tan dulce... Eres todo un caballero. Debes haber llegado de Europa hace poco.";
		...
		case "mirabelle_23":
            dialog.text = "No lo soy. Eres un caballero. Pero estás pretendiendo ser grosero por alguna razón. Mhmm... Me gustó mucho. Estaré esperando verte de nuevo...";
		...
		case "mirabelle_26":
            dialog.text = TimeGreeting()+", señor "+pchar.name+"¡Me alegra mucho verte! ¿Cómo estás?";
		...
		case "mirabelle_sleep":
            dialog.text = "¡Esto no es cierto, no es cierto! Señor "+pchar.name+" ¡es bueno y amable! ¡Sólo está fingiendo ser un malvado pirata! Tú eres, señor "+pchar.name+"¿?";
			link.l1 = "";
			link.l1.go = "exit";
		...
		case "camilla":
            ...
            dialog.text = "¡Oh, así que este es El Príncipe Charlie, el famoso pirata, el terror del Mar del Sur español!";
		...
		case "camilla_4":
			...
			link.l1 = "Parece que quieres que resuelva este misterio. ¿No? ¡Soy un maestro en resolver misterios de damas, lo juro! ¿Deberíamos ir a una taberna y beber algo de vino? ¡Te conseguiré el mejor regalo!";
		...
		case "camilla_7":
            ...
            dialog.text = "Vamos... ¡Llénalo, no hagas esperar a la dama!";
		...
		case "camilla_27":
			PlaySound("Voice\English\hambit\Girls_3.wav");
            dialog.text = "¿Y bien? ¿Trajiste el dinero, cariño?";
		...
		case "Nemezida_Knippel_4":
            ...
            dialog.text = "¡Ay, señor!";
			link.l1 = "¡Entonces, vámonos!";
			link.l1.go = "exit";
			AddDialogExitQuest("Mtraxx_RetributionZasada4");
		break;
