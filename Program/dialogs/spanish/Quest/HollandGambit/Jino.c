...
void ProcessDialogEvent()
{
	...
	// ----------------------------------------- Португалец ----------------------------------------------------
		...
		case "guardoftruth_14":
			...
			if (CheckAttribute(pchar, "questTemp.Dolly")) link.l1 = "¿Kukulcán?! Ya he tenido la imprudencia de encontrarme con su 'espíritu' que habita en las estatuas. Ahora veo... ¡continúa!";
			else link.l1 = "Mm. Interesante. Ya he oído ese nombre del padre Vincento... ¡continúa!";
