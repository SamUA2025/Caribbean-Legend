	...
	switch(Dialog.CurrentNode)
	{
		...
		case "trade_silk":
			if (CheckAttribute(pchar, "questTemp.UpgradeSilk"))
			{
				...
				{
					link.l1 = "¡Claro! Aquí, toma 2550 doblones.";
			...
			{
				link.l4 = "Mijnheer "+npchar.name+", me gustaría discutir la posibilidad de aumentar los suministros de seda.";
			...
			{
				link.l4 = "He traído sus doblones, Mijnheer "+npchar.name+". Sírvase aceptarlos.";
		...
		case "UpgradeSilk": //
			...
			{
				dialog.text = "Aprecio su enfoque comercial y estoy dispuesto a considerar su solicitud. Quizás podríamos aumentar el volumen, digamos, cinco veces. Sin embargo, organizar tales suministros requerirá recursos significativos. Necesitaremos ampliar el espacio de almacenamiento, reforzar la seguridad y garantizar rutas de entrega confiables. Como esto también le beneficia, sugiero que compartamos estos gastos entre nosotros.";
				link.l1 = "Todo esto suena razonable. ¿Qué cantidad considera necesaria para cubrir estos gastos?";
				link.l1.go = "UpgradeSilk_1";
				notification("Skill Check Passed", SKILL_COMMERCE);
			}
			else
			{
				dialog.text = "Entiendo su interés en aumentar los suministros, sin embargo, en esta etapa me resulta difícil aceptar tales cambios. No dudo de su aspiración por el desarrollo, pero este tipo de transacción requiere mucha más experiencia en asuntos comerciales y confianza en sus propias acciones. Le sugiero que aumente sus conocimientos en el arte de la negociación, y luego regrese a mí con una propuesta más específica. Cuando esté listo(a), estaré encantado de fortalecer nuestra cooperación.";
				link.l1 = "Hmm... Está bien. Volveré a esta conversación más tarde.";
				link.l1.go = "exit";
		...
		case "UpgradeSilk_1":
			dialog.text = "Considerando todos los matices, su parte de los gastos será de tres mil doblones de oro. Estos fondos nos permitirán organizar las medidas necesarias sin demora.";
			link.l1 = "Mijnheer "+npchar.name+", ¿tres mil doblones? ¿Es esto una broma? He venido a usted con una propuesta honesta, ¿y quiere que pague una cantidad tan exorbitante por organizar suministros?";
			link.l1.go = "UpgradeSilk_2";
		break;
		
		case "UpgradeSilk_2":
			dialog.text = "Le pido que me entienda correctamente. No estoy tratando de engañarle. Este dinero es la cantidad que nos permitirá asegurar el orden adecuado en la organización de los suministros. No se trata solo de ampliar almacenes y seguridad, sino también de garantizar la entrega de mercancías sin retrasos ni pérdidas, a pesar de toda la imprevisibilidad de este negocio. Estos son gastos estándar para tales volúmenes. Al final, sus inversiones se justificarán, y recibirá las mercancías en condiciones adecuadas y a tiempo.";
			link.l1 = "Sus explicaciones son algo tranquilizadoras, mijnheer. Pero aún así, esta cantidad sigue siendo demasiado alta. Estoy dispuest"+GetSexPhrase("o","a")+" a aceptar sus términos si baja el precio a al menos dos mil quinientos doblones. Estoy segur"+GetSexPhrase("o","a")+" de que esto será suficiente para organizar los suministros y observar todas las medidas de seguridad.";
			link.l1.go = "UpgradeSilk_3";
		break;
		
		case "UpgradeSilk_3":
			dialog.text = "Entiendo, la cantidad es grande, pero como ya dije, es necesaria para la correcta ejecución del trabajo. No puedo reducirla, ya que esto pondría en peligro todos nuestros esfuerzos. Sin embargo, para que no se sienta engañad"+GetSexPhrase("o","a")+", estoy dispuesto a ofrecerle un descuento del quince por ciento en todos los suministros futuros. Esto, espero, le permitirá compensar los gastos.";
			if (PCharDublonsTotal() >= 3000)
			{
				link.l1 = "Hmm, un descuento del quince por ciento es, por supuesto, un paso adelante. De acuerdo. Estoy dispuest"+GetSexPhrase("o","a")+" a aceptar su oferta, aunque el precio me parece extremadamente alto. Espero que nuestra cooperación cumpla con mis expectativas. Aquí está su dinero.";
				link.l1.go = "UpgradeSilk_Agreed";
			}
			link.l2 = "Mijnheer "+npchar.name+", su oferta no me deja elección. Que sean tres mil doblones, aunque es una suma considerable. Sin embargo, no puedo pagar todo de una vez ahora. Volveré tan pronto como consiga el dinero.";
			link.l2.go = "UpgradeSilk_5";
			link.l3 = " ¿Un descuento del quince por ciento? Mijnheer "+npchar.name+", esto no es lo que esperaba. Esta cantidad no son solo gastos, ¡es un robo abierto y descarado! Pero no tengo la intención de romper relaciones comerciales con usted. Volveremos a los términos anteriores - 30 rollos de seda a 20 doblones cada uno.";
			link.l3.go = "UpgradeSilk_4";
		break;
		
		case "UpgradeSilk_Agreed":
			dialog.text = "Me alegra que haya aceptado, "+pchar.name+". Ahora en cuanto a los detalles: 150 rollos de seda a 17 doblones cada uno. Total - 2550 doblones por todo el lote. Puede recoger la mercancía como de costumbre - los días 1 y 15 de cada mes. Creo que este trato traerá buenos beneficios para ambas partes.";
		...
		case "UpgradeSilk_4":
			dialog.text = "Esto es solo un enfoque comercial, no un robo, como podría haberle parecido. Pero, como desee. Venga como de costumbre, los días 1 y 15, por un lote de seda, estaré encantado de hacer un nuevo trato.";
			link.l1 = "Ciertamente, mijnheer. Adiós.";
			link.l1.go = "exit";
			pchar.questTemp.GVIKSilkBlock = true;
			NextDiag.TempNode = "HWIC_Boss";
		break;
		...
		case "UpgradeSilk_5":
			dialog.text = "Me alegra que haya tomado la decisión correcta. Tan pronto como traiga el dinero, discutiremos todos los detalles del trato y procederemos a su implementación.";
			link.l1 = "Adiós, Mijnheer "+npchar.name+". Nos vemos tan pronto como reúna la cantidad requerida.";
			link.l1.go = "exit";
			pchar.questTemp.GVIKSilkBlock = true;
