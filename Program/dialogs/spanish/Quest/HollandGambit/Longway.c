...
//-----------------------------------------------за Голландию-----------------------------------------------
		...
		case "MC_GoAway":
			...
			{
				dialog.text = "Eres un idiota, mongol, ¡chuanzhang! Perdimos demasiado tiempo resolviendo tus propios asuntos en lugar de reunirnos con Jacob van Berg. Ya se ha ido de "+XI_ConvertString("Colony"+pchar.questTemp.HWIC.Holl.JacobCity+"Datos")+"\nNo lograste cumplir la tarea. Longway no desea ni servirte ni verte más. Longway está seguro de que el señor Rodenburg aprobará su decisión.";
				link.l1 = "¡Al diablo contigo y tu amo!";
				link.l1.go = "exit";
