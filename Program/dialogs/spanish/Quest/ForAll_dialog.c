...
//<-- поисковые квесты дворян
		...
		//========= квесты баб ===========
		case "SCQ_woman":
			dialog.text = LinkRandPhrase("Saludos, capitán. ¿Puedes ayudarme?","¡Capitán! ¿Puede ayudar a una mujer? Sería tan amable...","Capitán, ayuda "+GetSexPhrase("una chica","yo")+".");
		...
		break;
		case "SCQ_Pirates_1":
			dialog.text = "Tal vez sí, pero mi esposo es un alma inocente. Solo era un pasajero allí. Tuvo que decirles que es rico para salvar su vida. Los piratas le perdonaron, ni siquiera lo metieron en la bodega de carga.";
		...
		case "FriendCap_2":
			...
			link.l1 = "En "+XI_ConvertString("Colony"+npchar.quest.cribCity+"Fecha");
