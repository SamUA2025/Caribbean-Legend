...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "marshe_tavern":
			...
			dialog.text = NPCStringReactionRepeat("¡Oh! ¿No serás tú del barco mercante? ¿No? Oh, mis disculpas. Por supuesto que no... Mi error.","No estoy de humor, monsieur, así que búscate a otro con quien hablar.","¿Ah, tú otra vez?!","Ajá...","bloque",1,npchar,Dialog.CurrentNode);
		...
		case "galeonguard":
			...
			dialog.text = "¡Alto! ¿Quién va ahí? ¡Alarma! ¡Repele abordajes!";
			link.l1 = "...";
