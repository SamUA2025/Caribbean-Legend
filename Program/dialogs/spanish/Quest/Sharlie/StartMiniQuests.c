void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Jilberte":
			...
			dialog.text = "¡Oh Señor, realmente todo ha quedado atrás? No puedo ni creerlo... Has salvado tanto a mí como a Celine. Si no fuera por ti, el mismo destino que le ocurrió al desdichado Cesar habría llamado a ella mañana y lo mismo estaría preparado para mí en unos días.";
