...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "gambit_fale_4":
			...
			link.l1 = "I'm ready to help. Please provide the text you would like me to translate.";
			link.l1.go = "exit";
		...
		case "saga_11":
			dialog.text = "Siempre hay una solución, hermanito. Simplemente no siempre es visible en la superficie. No todos los piratas simpatizan con los hugonotes de Tortuga. Conozco al menos a dos piratas autoritarios que consideran a Levasseur un traidor y escoria. Estoy hablando de Steven Dodson, también conocido como el Tiburón, y del legendario barón de la Bahía de los Mosquitos, Jan Svenson.\nNo sé dónde encontrar al Tiburón, he oído rumores de que algo ha pasado y tuvo que abandonar su base en Isla Tesoro. Pero siempre puedes encontrar a Svenson en Blueweld. Es una figura significativa allí.";
		...
		case "saga_17f":
            dialog.text = "Me alegra que te hayas detenido, hermano. Una vez te dije que es un juego totalmente diferente ser pirata y hacer negocios con ellos. Y has perdido el rumbo. Espero que no cometas el mismo error con el Tiburón y Svenson. Haz el trabajo pero mantén tu distancia de ellos. Después de todo, eres un noble francés, así que estate por encima de ellos. Ahora ve a Jan Svenson, él está en Blueweld. Trata de hacerlo tu aliado o nuestro trato con Levasseur se convertirá en un derramamiento de sangre.";
		...
		case "saga_17gx":
            dialog.text = "Tendrás que esforzarte mucho, hermano. ¿Recuerdas lo que te dije una vez? Que es un juego totalmente diferente ser pirata y hacer negocios con ellos. Tú... Olvídalo, espero que no cometas el mismo error con el Tiburón y Svenson. Haz el trabajo pero mantén tu distancia de ellos. Después de todo, eres un noble francés, así que mantente por encima de ellos. Ahora ve a Jan Svenson, está en Blueweld. Intenta hacerlo tu aliado o nuestro trato con Levasseur se convertirá en un derramamiento de sangre.";
			link.l1 = "Está bien. Estoy en camino.";
			link.l1.go = "saga_17";
			pchar.questTemp.Mtraxx = "full_complete_end";
		break;
		...
		case "kukulkan_win_1":
			...
			link.l1 = "I'm ready to translate your dialogues. Please provide the text you want translated.";
