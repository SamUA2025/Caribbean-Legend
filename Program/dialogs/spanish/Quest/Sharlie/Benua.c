...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "escape_7":
			dialog.text = "Mi hijo, un sacerdote no ve con sus ojos, sino con su corazón. No puedo explicártelo con palabras, pero... tu hermano se ha propuesto hacer algo impuro, sucio. Nunca pensé que mi boca pudiera pronunciar esto. Sin embargo...";
