...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Svenson_5":
			...
			link.l1 = "¡El Diablo del Bosque sirviendo bebidas - qué vista! Gracias por encargarte de la organización de la fiesta. Definitivamente regresaré, tan pronto como me haya reunido con todos - tal vez alguien necesite ayuda.";
		...
		case "Svenson_11":
			...
			link.l1 = "Esta taberna definitivamente necesita ser renombrada - '¡El mismo Diablo del Bosque estaba aquí detrás del mostrador'! Gracias, Jan, definitivamente regresaré, tan pronto como pase por todos - tal vez, alguien necesite ayuda.";
			link.l1.go = "Svenson_6";
		break;
		...
		case "Svenson_23":
			if (CheckAttribute(pchar, "questTemp.LongHappy.SvensonsShipSink")) dialog.text = "Bueno, no puedo decir que todo haya terminado - ¡nuestra vida sigue! Aunque me siento completamente destrozado. Soy demasiado viejo para saltar al mar desde un barco cubierto de fuego y nadar una hora entera hasta la orilla, cuidándome de los tiburones. Espero que todavía tengamos algo de ron...";
			else dialog.text = "Bueno, no puedo decir que todo haya terminado - ¡nuestra vida continúa! ¡Maldita sea, me siento diez años más joven! ¡Hace mucho tiempo que no peleaba así! Espero que tus reservas de ron y vino no hayan sido robadas durante el caos - ¡necesitamos beber por ello bien!";
		...
		case "Svenson_33":
			dialog.text = "El Tiburón está en la enfermería, su barco recibió una andanada de veinticuatro libras. Voló por la borda, se rompió un par de costillas, tragó agua de mar, pero vive, en unos días estará como nuevo.";
			link.l1 = "";
		...
		case "Svenson_34":
			if (CheckAttribute(pchar, "questTemp.LongHappy.Vensan_alive")) dialog.text = "Bernard solo recibió un par de rasguños - estaba defendiendo la costa y limpiando las catacumbas. Ahora, está en el puerto, organizando hospitales para los heridos y funerales para aquellos que no tuvieron suerte.";
			else dialog.text = "Bernard no tuvo suerte, estaba despejando las casas después del ataque desde las catacumbas y se topó con un montón de estos bastardos en los almacenes. Le alcanzó una bala, directo en la cabeza. Es una lástima, era un buen capitán... Tyrex estará furioso cuando se entere.";
			link.l1 = "";
			link.l1.go = "Svenson_36"; // на завершение
		break;
		
		case "Svenson_35":
			if (CheckAttribute(pchar, "questTemp.LongHappy.Vensan_alive")) dialog.text = "Bernard solo tiene un par de rasguños - estaba defendiendo la costa y limpiando las catacumbas. Ahora, está en el puerto, organizando hospitales para los heridos y funerales para los que no tuvieron suerte.";
			else dialog.text = "Bernard tuvo mala suerte, estaba despejando las casas después del ataque desde las catacumbas y se topó con un montón de estos bastardos en los almacenes. Recibió una bala, directo en la cabeza. Es una lástima, era un buen capitán... Tyrex se enfurecerá cuando lo descubra.";
			link.l1 = "";
			link.l1.go = "Svenson_36"; // на завершение
		break;
		...
		case "Svenson_48":
			if (CheckAttribute(pchar, "questTemp.LongHappy.Terrax.Prisoner") && !CheckAttribute(pchar, "questTemp.LongHappy.Terrax.Free")) dialog.text = "Marcus aún no ha sido encontrado, pero podemos manejarlo, no te preocupes. Has hecho tanto por todos nosotros, así que no te preocupes. Tyrax volverá tarde o temprano - lo encontraremos.";
			else dialog.text = "Marcus terminó aquí y se marchó rápidamente en el lanchón de alguien hacia La Española. Es necesario resolver algunos asuntos que surgieron tras la muerte de Barbazon. Envió saludos y los mejores deseos para ti y tu esposa.";
			link.l1 = "";
		...
		case "Svenson_55":
			...
			link.l1 = "Eso espero. Gracias Jan, gracias a todos vosotros y hasta luego, ¡mi viejo amigo! ¡Saluda a los Halcones y al Tiburón!";
		...
		case "Svenson_57":
			...
			link.l1 = "Gracias Jan. ¡Hasta pronto, mi viejo amigo! ¡Dale mis saludos a los Halcones y al Tiburón!... Bueno, Antigua será.";
			link.l1.go = "Svenson_58";
		break;
		...
		case "Tichingitu":
			...
			if (CheckAttribute(pchar, "questTemp.LongHappy.MarrySP")) link.l1 = "Bueno, de alguna manera lo hice, y es solo una formalidad. ¡Gracias, mi amigo!";
			else link.l1 = "Bueno, de alguna manera lo hice, y es solo una formalidad. ¡Gracias, mi amigo! Tú y yo hablaremos más en Sharptown - habrá mucha menos oficialidad y más diversión sincera, ¡lo prometo!";
		...
		case "Tichingitu_1":
			...
			if (CheckAttribute(pchar, "questTemp.LongHappy.MarrySP")) link.l1 = "Espero que no termine en danzas alrededor de hogueras mucho antes del final, y preferiría evitar abordajes. Bien, ten paciencia - falta poco, y nos dirigimos inmediatamente a la taberna.";
			else link.l1 = "Tengo miedo de que terminemos bailando alrededor de hogueras mucho antes del final, y preferiría evitar los abordajes. Bien, ten paciencia - queda poco, y zarpamos inmediatamente hacia Sharptown.";
			link.l1.go = "Guests_block";
		break;
		...
		case "Tichingitu_12":
			dialog.text = "Tichingitu recordó. Ella estaba ayudando al Diablo del Bosque en la taberna con la boda. Bebimos agua de fuego contigo, y Tichingitu quería más. Y luego, esta squaw... ella era tan linda y... Capitán, ¡creo que recordé! Tichingitu quería casarse con ella... Quería construir una canoa y llevársela... ¡Espíritus de misericordia! Muy mala gente vino con agua de fuego. ¡Quizás, los demonios o espíritus malignos! Tichingitu nunca más...";
		...
		case "PortRoyal_Mayor":
			...
			dialog.text = "¡Por el bien de tu boda, valió la pena cruzar el Caribe! ¡Felicitaciones, capitán, en nombre de los habitantes de todas las colonias inglesas! Tú y tu novia, lo siento, ya esposa, ¡sois una pareja maravillosa!";
		...
		case "Terrax_4":
			...
			{
				dialog.text = "Dannie y Nathan son un caso de larga data - ya me he acostumbrado a esto, ¡pero me sorprendiste, no hay nada que decir! Sin embargo, la pupila del Diablo del Bosque es hermosa - no hay nada que decir, siempre lista para usar tanto la palabra como la pistola, y puede manejar cualquier tormenta. Es poco probable que pudieras encontrar una mujer más digna. ¡Eres un afortunado, capitán - cuida de ella!";
			}
			else
			{
		...
		case "Shivo_3":
			dialog.text = "No seas tan gracioso, Charles. Tú y madame Botot me habéis causado muchos problemas, y tengo la intención de pagaros con creces. Aunque ella me causó muchos más problemas que tú... sin embargo, si tú y el imponente monsieur pirata os quedáis quietos, entonces os doy mi palabra de honor: vuestras esposas seguirán con vida. Creo que en las colonias españolas de Maine tales esclavos son valorados. Incluso extraoficialmente. Pero esto sigue siendo vida, ¿no es así?";
		...
		case "JanDavid_3":
			dialog.text = "Y yo me encargaré del resto. El Diablo del Bosque dijo que no tendrías tiempo para ocuparte de cosas tan pequeñas como Le Francois...";
