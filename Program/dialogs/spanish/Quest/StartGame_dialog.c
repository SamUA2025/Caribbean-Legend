...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Node_3_Jess":
			dialog.text = "No, gracias a Dios. Oh, lo siento... Fue ahorcado por orden de la Máscara. Y dicen que la Máscara fue cortada por el Tiburón. Creo que todos se lo merecían, eran unos bastardos ambos. Estos canallas eran un gran problema para nosotros.";
