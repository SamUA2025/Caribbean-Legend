...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
	...
	{
		case "quests":
			dialog.text = NPCStringReactionRepeat(RandPhraseSimple("¿Qué preguntas tienes?","¿Cómo puedo ayudarte?"),"Intentaste hacerme una pregunta hace un rato...","Jamás he conocido a personas con tanta curiosidad en mi astillero ni en ninguna otra parte de este pueblo.","¿Por qué tantas preguntas? Mi trabajo es construir barcos. Ocupémonos de eso.","bloque",1,npchar,Dialog.CurrentNode);
