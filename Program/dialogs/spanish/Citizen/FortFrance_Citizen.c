...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
	switch (Dialog.CurrentNode)
	{
		case "quests":
			...
			{
				link.l1 = "Escucha, "+GetAddress_FormToNPC(NPChar)+", quiero preguntarte algo... Estoy buscando un navegante para servir en mi barco, ¿conoces a alguien?";
		...
		case "Sharlie":
			...
			{
				dialog.text = LinkRandPhrase("No, no he oído hablar de él.","No puedo ayudarte, tengo trabajo que hacer.","¿Quién? No me suena, no. Me iré por mi camino.");
		...
		case "Sharlie_1":
			dialog.text = LinkRandPhrase("No, no conozco ningún navegante.","Tengo trabajo que atender y no, pregunta a alguien más...","Lamentablemente no puedo ayudarte, no conozco a nadie.");
