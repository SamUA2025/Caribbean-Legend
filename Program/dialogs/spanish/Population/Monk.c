...
//----------------------------------------------освятить корабль------------------------------------------------
		...
		case "shipshine_1":
			dialog.text = "Te costará "+FindRussianMoneyString(sti(pchar.GenQuest.Shipshine.Money))+", mi hijo.";
