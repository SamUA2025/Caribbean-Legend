	...
	switch(Dialog.CurrentNode)
	{
		...
		//квестовая часть
			...
			case "march_1":
				...
				dialog.text = "Mi barco es "+GetStrSmallRegister(XI_ConvertString(GetBaseShipParamFromType(sti(pchar.GenQuest.MarchCap.shiptype),"Nombre")))+" '"+pchar.GenQuest.MarchCap.shipname+"Está en el puerto ahora mismo. ¡No llegues tarde, capitán, me iré en seis horas!";
