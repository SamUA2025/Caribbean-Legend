...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		case "quests":
			...
			link.l1 = HeroStringReactionRepeat(RandPhraseSimple("He cambiado de opinión, mis disculpas.","No es nada, discúlpame."),"Perdóname, no es nada.",
                      "Tienes razón, ya es la tercera vez. Perdóname...", "Mis disculpas.", npchar, Dialog.CurrentNode);
			link.l1.go = "exit";
		break;
	}
