...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
	...
	{
		case "quests":
			dialog.text = NPCStringReactionRepeat(RandPhraseSimple("¿Qué tipo de preguntas, "+GetSexPhrase("mi hijo","mi hija")+"¿?","Pregunta, estoy escuchando..."),"Te escucho, habla ahora, "+GetSexPhrase("hijo mío","mi hija")+"...","Por tercera vez, "+GetSexPhrase("hijo mío","mi hija")+", pide lo que necesites.","Un clérigo tiene mucho trabajo y me estás distrayendo, "+GetSexPhrase("hijo mío","mi hija")+"...","bloqueo",1,npchar,Dialog.CurrentNode);
