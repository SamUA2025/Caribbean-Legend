...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
	...
	{
		case "quests":
            dialog.text = NPCStringReactionRepeat(RandPhraseSimple("¿Qué tipo de preguntas, "+GetSexPhrase("hijo mío","mi hija")+"¿?","Pregunta lo que quieras, estoy escuchando..."),"Estoy escuchando, habla ahora, "+GetSexPhrase("hijo mío","mi hija")+"... ","Por tercera vez, "+GetSexPhrase("mi hijo","mi hija")+", pide lo que necesites.","Un clérigo tiene mucho trabajo y me estás distrayendo, "+GetSexPhrase("mi hijo","mi hija")+"...","bloqueo",1,npchar,Dialog.CurrentNode);
