...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
	...
	{
		case "quests":
			dialog.text = NPCStringReactionRepeat("Todos los rumores de "+GetCityName(npchar.city)+" a su servicio. ¿Qué le gustaría saber?","Justamente estábamos hablando de eso. Debes haberlo olvidado...","Esta es la tercera vez hoy que hablas de alguna pregunta...","Repites lo mismo como un loro...","bloqueo",1,npchar,Dialog.CurrentNode);
		...
		case "Panama_rat_2":
			dialog.text = "Bueno, solo hay una forma de salir de aquí a pie - Portobello. Y se fue a pie. Así que búscalo allí.";
		...
		case "FMQG_1":
			dialog.text = "¿Señor de Milyar? Ese caballero visitó Panamá hace un año. En realidad, Don Carlos de Milyar vive en Portobello. Es un gran amigo del gobernador local.";
