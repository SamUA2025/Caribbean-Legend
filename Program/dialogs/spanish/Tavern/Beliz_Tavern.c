...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
	...
	{
		case "quests":
			dialog.text = NPCStringReactionRepeat("Todos los rumores de "+GetCityName(npchar.city)+" a su servicio. ¿Qué le gustaría averiguar?","Justo estábamos hablando de eso. Debes haberlo olvidado...","Esta es la tercera vez hoy que me lo preguntas...","Repites todo igual que un loro...","bloqueo",1,npchar,Dialog.CurrentNode);
