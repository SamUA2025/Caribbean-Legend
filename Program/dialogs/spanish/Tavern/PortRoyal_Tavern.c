...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
	...
	case "Jamaica_ratP_1":
		dialog.text = NPCStringReactionRepeat("No tengo la menor idea. Ni siquiera he oído ese nombre antes.", "Ya has preguntado sobre eso y te he respondido.", "Te dije, ya has preguntado por ese Gontier.", "¡Escucha, aléjate y deja de molestarme! ¿Has perdido completamente la chaveta?", "block", 0, npchar, Dialog.CurrentNode);
