...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "free_buyout":
			dialog.text = "Y tengo una propuesta para ti. En "+XI_ConvertString("Colonia"+NPChar.Hold_GenQuest.City+"Voc")+" vive mi amigo, "+NPChar.Hold_GenQuest.Name+" es su nombre. Una vez tuvimos un negocio juntos."+"Encuéntralo allí. Estoy seguro de que te pagará una gran suma. Me debe y me ocuparé de él yo mismo.";
		...
		case "FalseTrace_Prisoner_4":
			dialog.text = "";
			link.l1 = "Iba a pedirte rescate a las autoridades y a entregar a Adam con Katerine a "+XI_ConvertString("Colonia"+pchar.questTemp.FalseTrace.QuestCity+"Acc")+", luego obtén de Adam la información sobre el oro de Solly el Bizco y navega hacia él. Pero Katerine me ha convencido de hablar contigo primero, ella dijo que podrías ofrecerme algo mejor y más seguro que lo que Adam ofreció, a cambio de vuestras vidas y libertad.";
