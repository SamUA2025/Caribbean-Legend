	...
	switch(Dialog.CurrentNode)
	{
		...
		case "HouseMan":
			...
			if (LAi_grp_playeralarm > 0)
			{
				...
				link.l1 = PCharRepPhrase(RandPhraseSimple("Veo que estás cansado de vivir...","Así parece, no hay vida pacífica para los ciudadanos de "+XI_ConvertString("Colonia"+npchar.city+"Gen")+"¡"),RandPhraseSimple("¡Vete al infierno!","Je, esos serán los últimos segundos de tu vida..."));
		...
		case "SkladMan":
			...
			if (LAi_grp_playeralarm > 0)
			{
				...
				link.l1 = NPCharRepPhrase(pchar,RandPhraseSimple("Veo que estás cansado de vivir...","Así parece, no hay vida pacífica para los ciudadanos de "+XI_ConvertString("Colonia"+npchar.city+"Gen")+"¡!"),RandPhraseSimple("¡Vete al infierno!","Je, esos serán los últimos segundos de tu vida..."));
