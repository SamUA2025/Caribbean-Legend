...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
	...
	case "quests":
		...
		link.l1 = HeroStringReactionRepeat("Sabes, " + NPChar.name + ", quizás la próxima vez.", "Es cierto, lo he olvidado por alguna razón...", "Sí, realmente es la tercera vez...", "Hum, no...", npchar, Dialog.CurrentNode);
		link.l1.go = "exit";
		break;
	}
