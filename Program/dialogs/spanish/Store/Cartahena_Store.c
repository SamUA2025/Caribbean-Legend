...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
	...
	case "quests":
		...
		link.l1 = HeroStringReactionRepeat("Sabes, " + NPChar.name + ", tal vez la próxima vez.", "Claro, lo he olvidado por alguna razón...", "Sí, de verdad es la tercera vez...", "Hm, no lo haré...", npchar, Dialog.CurrentNode);
		link.l1.go = "exit";
		break;
	}
