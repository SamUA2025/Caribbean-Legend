...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
	...
	{
		case "quests":
			dialog.text = NPCStringReactionRepeat(RandPhraseSimple("¿Qué preguntas tienes?","¿Cómo puedo ayudarle?"),"Intentaste hacerme una pregunta no hace mucho...","Nadie ha hecho preguntas así en una tienda de Tortuga desde hace mucho tiempo...","Preguntas, preguntas, y más preguntas...","bloque",1,npchar,Dialog.CurrentNode);
