void ProcessDialogEvent() 
{
    ...
    switch(Dialog.CurrentNode)
	{
		...
		case "GiveMeSomeMoneyToo":	
			...
			Link.l1 = "Думаю, что " + makeint(sti(Pchar.money)/10) + " песо будет достаточно.";
			...
			Link.l2 = "Как насчёт " + makeint(sti(Pchar.money)/5) + " песо?";
			...
			Link.l3 = "Вам, офицер, я готов"+GetSexPhrase("","а")+" отдать " + makeint(sti(Pchar.money)/2) + " песо!";
