   ...
   /*NPChar.FileDialog2 = "DIALOGS\" + LanguageGetLanguage() + "\Prison\" + NPChar.City + "_Prison.c";
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "First time":
			...
			{
				dialog.text = "Приветствую вас в форте, капитан. Вам что-то нужно?";
				link.l1 = "Нет, ничего, просто зашёл по случаю.";
			}
			// вице-адмирал
			...
			{
				dialog.text = "Приветствую вас, вице-адмирал! У вас есть какие-нибудь указания?";
				link.l1 = "Нет, офицер, указаний нет. Я просто зашёл осмотреть форт.";
			}
			// генерал-губернатор
			if(CheckAttribute(pchar, "questTemp.Patria.GenGovernor") && npchar.nation == FRANCE)
			{
				dialog.text = "Генерал-губернатор, Ваша Светлость! У меня в форте полный порядок. Будут какие-либо распоряжения?";
				link.l1 = "Рад, что у вас всё в порядке, офицер. Распоряжений нет, я просто зашёл проведать форт.";
			}
			// <-- legendary edition
		...
		case "trial_exit":
			dialog.text = "Это ваше право, хотя я рассчитывал на ваше согласие. Придётся искать другого курьера, а времени практически не осталось... Я вас более не задерживаю, капитан.";
		...
		case "zpq_prs1":
			if(!isBadReputation(pchar, 70))
			{
				...
				link.l1 = "Достаточно интригующе звучит. И хоть я не догадываюсь, о каком грузе идёт речь, всё же готов"+ GetSexPhrase("","а") +" рискнуть, если оплата будет достойной. В любом случае, я даю слово.";
				link.l1.go = "zpq_prs2";
		...
		case "zpq_prs3":
			dialog.text = "Нам нужно 15 000 картузов орудийного пороха. За всю партию я заплачу 100 000 песо... Это очень хорошая цена, сами понимаете. Наше положение вынуждает идти на подобные издержки, хотя мне стоило немалых усилий убедить в этом губернаторского казначея... Сезон штормов не даёт возможности воспользоваться штатными каналами снабжения, да и афишировать такой казус нам не с руки...";
		...
		case "zpq_ex2":
			dialog.text = "Да-да, конечно. Вам сейчас же выплатят 50 000 песо, согласно нашему уговору.";
			link.l1 = "Вы, верно, шутите, сеньор?! Договор был на 100 000, и я не намерен"+ GetSexPhrase("","а") +" уступать ни единого песо!";
			link.l1.go = "zpq_ex3";
		...
		case "zpq_ex4":
				dialog.text = "Какая дерзость! Я ещё из ума не выжил и совершенно точно помню, что наш уговор был на 100 000 пе\nАх чёрт! Тебе не удастся меня надуть!";
		...
		case "zpq_ex6":
			dialog.text = "Гм-гм... веский аргумент. 125 000 песо, говорите? Вот, держите ваши деньги... А теперь прошу меня простить, дела ждут...";
