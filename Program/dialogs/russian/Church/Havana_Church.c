...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		...
		case "caleuche_1":
			dialog.text = "Уверяю тебя, "+GetSexPhrase("сын мой","дочь моя")+", это не шутки! Человек, который поведал мне о ходячих мертвецах, заслуживает самого полного доверия!";
		...
		case "caleuche_4":
			dialog.text = "Что ты там нашёл, "+GetSexPhrase("сын мой","дочь моя")+"? Быть может, наши страхи были напрасны?";
		...
		case "caleuche_5":
			dialog.text = "Слава Всевышнему! Ты воистину карающий меч Господень, "+GetSexPhrase("сын мой","дочь моя")+"! Позволь выразить тебе глубокую признательность от всего прихода Гаваны, и прими мою награду: вот эти освящённые обереги. Они наверняка пригодятся тебе в твоих нелёгких странствиях.";
		...
		case "caleuche_6":
			...
			dialog.text = "Также я позабочусь, чтобы о твоём подвиге узнали и простые горожане, и власть предержащие. И буду неустанно молиться за тебя.";
		...
		case "caleuche_9":
			dialog.text = "Какой кошмар! Я немедленно сообщу в инквизицию, самому отцу Винсенто! Он должен знать, что у нас происходит! Скажи, "+GetSexPhrase("сын мой","дочь моя")+", ты подозреваешь, что пропавшие в джунглях люди...";
		...
		case "caleuche_11":
			dialog.text = "Да смилуется над нами Всевышний! Ищи, "+GetSexPhrase("сын мой","дочь моя")+", благословляю тебя и разрешаю любые действия во имя нашей Церкви! И я немедленно отправляю гонца в Сантьяго с депешей к отцу Винсенто.";
