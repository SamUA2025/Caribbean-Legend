...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		...
		case "guardoftruth":
			dialog.text = "О да, "+GetSexPhrase("сын мой","дочь моя")+"! Это лучшая вещь в нашем приходе. Я за всю свою жизнь не видел подобного великолепия. А что-то не так, "+GetSexPhrase("сын мой","дочь моя")+"? Почему тебя интересует этот крест?";
			link.l1 = "Святой отец, я знаю, что вам будет неприятно это услышать, но этот крест был похищен из другого прихода, причём его похищение было сопряжено с убийством священнослужителя. Человек, даровавший его вам - преступник.";
			link.l1.go = "guardoftruth_1";
		break;
		
		case "guardoftruth_1":
			dialog.text = "Все мы грешны, "+GetSexPhrase("сын мой","дочь моя")+", и все равны перед Богом... но убийство священнослужителя - серьёзное обвинение. Ты можешь чем-нибудь доказать свои слова? И из какого прихода был украден этот крест?";
			link.l1 = "Моё слово разве не может являться доказательством? А этот крест был похищен из прихода Сантьяго и должен быть возвращён назад.";
		...
		case "guardoftruth_3":
			dialog.text = "Сын мой, ты понимаешь, что говоришь? Этот крест был получен нашим приходом в дар от верующего христианина! Нет, "+GetSexPhrase("сын мой","дочь моя")+", я не могу исполнить твою просьбу.";
		...
		case "guardoftruth_4":
			dialog.text = "Сын мой, ты не предоставил никаких доказательств. Крест останется в нашем приходе. Таково моё решение. Более того, твоя заинтересованность по этому вопросу в интересах испанцев настораживает меня...";
