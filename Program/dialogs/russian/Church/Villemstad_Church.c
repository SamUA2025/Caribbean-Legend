...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		...
		// калеуче
		case "caleuche":
			dialog.text = "И? Ты был там, "+GetSexPhrase("сын мой","дочь моя")+"? Говори же, не томи!";
		...
		case "caleuche_1":
			...
			link.l1 = "Это ещё не всё. Когда я вышиб из этого скелета дух, или что там ещё внутри него было, он издал предсмертный женский крик. Потом я пошарил по его костям и нашёл женские украшения. Я полагаю, что это и есть пропавшая хозяйка дома.";
		...
		case "caleuche_8":
			...
			dialog.text = "Я не знаю, что и думать, "+GetSexPhrase("сын мой","дочь моя")+". Но если этот чёрный колдун стал настолько силён, что способен осуществить такие страшные вещи, то все жители архипелага находятся в большой опасности. Одному Господу известно, что задумал этот приспешник дьявола\nЯ всё же надеюсь, что отец "+sld.name+" ошибся, но прошу тебя: отправься в Гавану и переговори с ним. Я приготовил торговую лицензию сроком на месяц - возьми, она поможет тебе беспрепятственно войти в порт Гаваны.";
		...
		case "caleuche_8_1":
			sld = characterFromId("Havana_Priest");
			dialog.text = "Я не знаю, что и думать, "+GetSexPhrase("сын мой","дочь моя")+". Но если этот чёрный колдун стал настолько силён, что способен осуществить такие страшные вещи, то все жители архипелага находятся в большой опасности. Одному Господу известно, что задумал этот приспешник дьявола\nЯ всё же надеюсь, что отец "+sld.name+" ошибся, но прошу тебя: отправься в Гавану и переговори с ним.";
			link.l1 = "Хорошо, святой отец. Я отправлюсь в Гавану.";
			link.l1.go = "caleuche_9";
		break;
		
		case "caleuche_9":
			dialog.text = "Я рад, что ты оказался истинным сыном церкви, "+GetSexPhrase("сын мой","дочь моя")+". Я буду неустанно молиться за твоё здоровье и благополучие. Ступай с моим благословением. Да укрепит Господь твою руку в борьбе против нечисти.";
