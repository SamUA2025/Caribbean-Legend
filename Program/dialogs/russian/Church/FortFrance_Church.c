...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		...
		// Jason Долго и счастливо
		case "LH_church":
			dialog.text = "Аббат уехал по делам церкви к представителям Испанской Католической миссии в Новом Свете. Подробностей я не знаю, но отца Бенуа нет достаточно долго, чтобы заподозрить, что переговоры затянулись, или - случилось что-то в пути. Мы все немного взволнованы, но нам остаётся лишь молиться и ждать вестей.";
			link.l1 = "Я и не думал, что всё будет легко. Святой отец, скажите, куда именно в испанских колониях отправился аббат. Мне необходимо его найти как можно быстрее.";
			link.l1.go = "LH_church_1";
		break;
		
		case "LH_church_1":
			dialog.text = "Извини, "+GetSexPhrase("сын мой","дочь моя")+", но я не знаю. Насколько мне известно - аббат отправился на переговоры с епископом Новой Испании и прелатом инквизиции отцом Винсенто Палотти, но где будет происходить встреча простым слугам Господа никто не уточнял.";
