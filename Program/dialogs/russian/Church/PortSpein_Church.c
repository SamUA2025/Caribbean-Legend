...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		case "quests":
			...
			{
				link.l1 = "Скажите, святой отец, а имя 'Хуан' вам что-нибудь говорит?";
		...
		//Цена чахотки
		case "Consumption":
			dialog.text = "Нет, "+GetSexPhrase("сын мой","дочь моя")+". В нашем городе много прихожан с таким именем.";
			link.l1 = "Ясно. Простите за беспокойство, падре...";
			link.l1.go = "exit";
