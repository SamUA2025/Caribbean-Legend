...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "terrapin_3":
			...
			dialog.text = "Также к нему я прилагаю небольшой комплект боеприпасов и инструкции по изготовлению зарядов к нему. Негоже, чтобы вы не смогли реализовать его мощь на полную катушку!";
