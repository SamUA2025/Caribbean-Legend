	...
	switch(Dialog.CurrentNode)
	{
		case "First time":
			...
			if (CheckAttribute(pchar, "questTemp.Sharlie.Lock"))
			{
				...
				{
					link.l13 = "Здравствуйте ещё раз. Прочтите вот это письмо, и, быть может, вы пересмотрите вопрос о продаже вина?"; 
				...
				dialog.text = "Вы хотели приобрести что-то в моём магазине, месье?";
				Link.l1 = "Конечно! А для чего же ещё магазины существуют? Показывайте ваши товары.";
				Link.l1.go = "trade_1";
				...
				if(NPChar.City == "FortFrance")
				{
					...
					{
						Link.l2 = "Послушайте, месье, я ищу работу. Ну, не то, чтобы поденным рабочим или грузчиком мешки из порта таскать, а выполнить какое-нибудь поручение, скажем. Вы не нуждаетесь в сторонней помощи?";
					...
					{
						Link.l2 = "Я выполнил ваше поручение. Мне удалось отыскать Гийома Лавуа.";
					...
					{
						Link.l2 = "Вот ваш новый помощник, месье. Знакомьтесь.";
					...
					{
						Link.l2 = "Это опять я, месье. Я пришёл за своей наградой.";
					...
					{
						link.l4 = "Посмотрите на эти серьги, месье. Я нашёл их на теле убитого бандита в джунглях. Это явно работа хорошего ювелира, которого в этой глуши и быть не могло. Можете что-нибудь сказать об этих серьгах?";
			...
			if(CheckAttribute(npchar, "quest.trial_usurer"))
			{
				...
				Link.l1 = "Да, представьте себе - потерял. Где этот чёртов Жерар Лекруа? Я выполнил все поручения Флориана Шоке, и, поглоти меня акула, мне пришлось здорово постараться! А теперь, когда я являюсь за своей наградой, выясняется, что этого пижона и след простыл!";
				Link.l1.go = "trial";
				// belamour legendary edition -->
				Link.l2 = "Как вам сказать... Потерял. Вы моего заказчика не видели? Его зовут Жерар Лекруа.";
				Link.l2.go = "trialA";
				//<-- legendary edition
			...
			// <-- legendary edition
            dialog.Text = GetNatPhrase(npchar, LinkRandPhrase("Рад приветствовать вас, "+GetAddress_Form(NPChar)+"! Впервые в наших краях?","Добро пожаловать, капитан! Мой магазин к вашим услугам, "+GetAddress_Form(NPChar)+".","Прошу вас, "+GetAddress_Form(NPChar)+", проходите! Я рад предложить вам всё лучшее, что только можно купить на архипелаге."), LinkRandPhrase("О, "+GetAddress_Form(NPChar)+" капитан! Лучшие товары французских колоний - здесь и сейчас - и только для вас!","Какое приятное знакомство, "+GetAddress_Form(NPChar)+"! Лучший магазин лучших французских товаров к вашим услугам!","Мы не встречались раньше, "+GetAddress_Form(NPChar)+" капитан? Мой магазин не уступит лучшим салонам метрополии!"), LinkRandPhrase("О, "+GetAddress_Form(NPChar)+" капитан! Я рад видеть вас в моём магазине!","Рад приветствовать столь "+GetSexPhrase("блестящего кабальеро","блестящую сеньориту")+" в лучшем магазине испанских колоний!","О, "+GetSexPhrase("благородный идальго","благородная сеньорита")+"! Судьба не зря привела вас в мой скромный магазин - здесь вы найдёте все, что только пожелаете!"),LinkRandPhrase("Добрый день, "+GetAddress_Form(NPChar)+" капитан. Это ваш первый визит к нам?","Здравствуйте, "+GetAddress_Form(NPChar)+". Впервые у нас? Поверьте, качество голландских товаров приятно вас поразит!","Прошу вас, "+GetAddress_Form(NPChar)+" капитан! Самые качественные товары по самым низким ценам - иное было бы не по-голландски!"));
			Link.l1 = LinkRandPhrase("Я вам тоже рад"+GetSexPhrase("","а")+". Моё имя "+GetFullName(pchar)+" и я здесь совсем недавно. Ну, показывайте, чем богат архипелаг?","Приятная встреча, я "+GetFullName(pchar)+". капитан корабля '"+pchar.ship.name+"'.  Итак, что там у вас есть интересного?",""+GetFullName(pchar)+", капитан корабля '"+pchar.ship.name+"', рад"+GetSexPhrase("","а")+" знакомству. Что вы мне предложите?");
			link.l1.go = "node_1";
			
			if(startHeroType == 4 && NPChar.location == "SantaCatalina_store")
			{
				dialog.text = "Капитан Элен! Всегда рад.";
				link.l1 = "Как и я вам, благодарю.";
		...
		case "node_1":
			...
			if(CheckAttribute(pchar,"questTemp.SharkGoldFleet") && npchar.location == "caracas_store")
			{
				if(pchar.questTemp.SharkGoldFleet == "start" || pchar.questTemp.SharkGoldFleet == "afterGvik")
				{
					...
					link.l14 = "Послушайте, я сейчас собираюсь отправляться в Порто-Белло и хотел бы купить у вас партию кофе и какао. Скажем, по триста единиц и того, и другого."; 
			...
			{
				dialog.Text = pcharrepphrase(LinkRandPhrase(LinkRandPhrase("Кого это к нам занесло? Впрочем, деньги-то не пахнут, так что проходите, капитан, поторгуем...","Не могу сказать, что рад видеть вас, "+GetFullName(pchar)+"... Но поторговать пока готов.","Хе-хе... в гости не приглашаю, капитан, но мой магазин пока ещё к вашим услугам."),LinkRandPhrase("О, кого я вижу! Сам "+GetFullName(pchar)+"! Торговать к нам, или так, брать без денег? Шучу, шучу...","Не то, чтобы я был рад вашему визиту, "+GetAddress_Form(NPChar)+". Но если вы при деньгах - заходите, чего уж там...","Хотите поторговать, капитан "+GetFullName(pchar)+"? Давайте, только побыстрее, а то прочие клиенты при вас не торопятся в магазин, а дело от этого страдает."),LinkRandPhrase("Будем торговать, минхер? Минуточку, я кассу приберу, а то ходят тут... всякие... Это я, конечно, не вам, капитан!","Завидев вас в море, "+GetAddress_Form(NPChar)+", я бы, пожалуй, приказал добавить парусов, хе-хе... Но здесь, у себя, предлагаю поторговать.","Кэп, сразу предупреждаю: если, как в прошлый раз, ткани заляпаны кровью, а кофе провонял порохом - ничего брать не буду. А так - смотрите, выбирайте.")),LinkRandPhrase(LinkRandPhrase("И снова я рад приветствовать вас, "+GetAddress_Form(NPChar)+"! Купить или продать  - я всегда рад помочь вам.","Прошу вас, "+GetAddress_Form(NPChar)+", прошу! Я рад приветствовать своего лучшего клиента. Желаете что-нибудь купить или продать?","О, "+GetAddress_Form(NPChar)+" "+GetFullName(pchar)+"! Как я рад снова видеть вас! Хотите купить или продать что-нибудь?"),LinkRandPhrase("Вам понравились наши товары, "+GetAddress_Form(NPChar)+" "+GetFullName(pchar)+"? Я всегда к вашим услугам - смотрите, выбирайте.","Здравствуйте, "+GetAddress_Form(NPChar)+" "+GetFullName(pchar)+". Я рад, что вы снова заглянули ко мне. Угодно глянуть наш ассортимент товаров?","Рад вам, капитан! Я знал, что наши добротные товары вам приглянутся. Посмотрите, что есть новенького?"),LinkRandPhrase("О, "+GetAddress_Form(NPChar)+" "+GetFullName(pchar)+"! Прошу вас, любые товары для вас! В честь вашего визита - с огромными скидками!","Капитан "+GetFullName(pchar)+", вы снова осчастливили меня своим визитом! Выбирайте - что вам угодно!","Что вам угодно, капитан? Рад, что помните дорогу ко мне. Любые товары для вас в наличии - полюбуйтесь, все высшего разряда!")));
				link.l14 = "Я по поводу кофе и какао."; 
			...
			/*link.l3 = HeroStringReactionRepeat(NPCharRepPhrase(npchar,
											   ...
											   NPCharRepPhrase(npchar,
											        pcharrepphrase("Я думаю, ты знаешь, о чём я хочу спросить.",
			...
			if (CheckAttribute(PChar, "questTemp.WPU.Postcureer.LevelUp"))
			{
				...
				{
					link.l12 = "Я доставил"+GetSexPhrase("","а")+" вам сводку цен из города "+XI_ConvertString("Colony"+pchar.questTemp.WPU.Postcureer.StartCity+"Gen")+".";
			...
			link.l5 = HeroStringReactionRepeat(NPCharRepPhrase(npchar,
											   ...
											   NPCharRepPhrase(npchar,
													...
													pcharrepphrase("Считай свои дублоны и гинеи, пройдоха! Я ещё зайду.",
		...
		case "Helen_node_1":
			dialog.text = "Чем могу служить? Снабдить  Радугу , продать добычу? Сомневаюсь, что вам интересны текущие выгодные фрахты, ха-ха.";
			link.l1 = HeroStringReactionRepeat(NPCharRepPhrase(npchar,
			                                        pcharrepphrase("Давай, показывай, что у тебя есть, старый пират!",
													               "Я всего лишь хочу посмотреть на ваши товары, любезный."),
													pcharrepphrase("Клянусь виселицей, " +GetFullName(npchar)+", я не позволю тебе водить меня за нос! Живо показывай свои товары!",
...
//navy <--
		...
		case "TransferGoods":
			...
			if(sti(Pchar.Ship.Type) != SHIP_NOTUSED && ok)
			{
				dialog.text = LinkRandPhrase("...Уже сделал. Нужно только определьться, на борт какого корабля доставлять товары.",
					"Ваш казначей уже это сделал. Давайте определимся с кораблём, на который будут доставлены товары.",
          ...
          SetPriceListByStoreMan(rColony); // mitrokosta обновляем список цен
				...
				else
				{
					dialog.text = LinkRandPhrase("Капитан, весь товар, который запросил ваш казначей, уже есть на борту указанного вами судна!", 
						...
						"Кэп, данный корабль в обслуживании не нуждается, так как весь товар на нём уже присутствует.");
					link.l1 = "Да, точно.";
					link.l1.go = "exit";
			...
			{
				dialog.text = LinkRandPhrase("Сдаётся мне, столько товара на этот тип корабля не влезет.", 
		...
		case "business":
			...
			{
				dialog.text = "Капитан, я хочу попросить вас оказать мне одну услугу. За её выполнение я хорошо заплачу.";
...
//navy <--
            ...
            if (sti(Pchar.Ship.Type) != SHIP_NOTUSED && ok)
			{
				...
				{
					link.l8 = "Послушай, я пытаюсь найти своего компаньона, "+pchar.GenQuest.FindFugitive.Name+" его зовут. В таверне Порт-Ройала мне сказали, что он собирался именно в ваше поселение. Не встречал этого человека?";
					...
					else
					{
                        ...
                        if (storeMan > 0)
                        {
    						...
    						if (iQuantityGoods < 100)// это в шт. товара
    						{
    							...
    							link.l1 = NPCharRepPhrase(npchar, "У меня достойный корабль, но я понял"+GetSexPhrase("","а")+" вашу мысль. До свиданья.","Я вас понимаю, бизнес прежде всего. Прощайте.");
    							link.l1.go = "exit";
    						}
    						else
    						{
		...
		case "generate_quest_failed_2":
            ...
            iQuantityGoods =  makeint(pchar.CargoQuest.iQuantityGoods);
            iMoney =  3*makeint(iQuantityGoods * sti(Goods[iTradeGoods].Cost) / sti(Goods[iTradeGoods].Units));
			dialog.text = "Замечательно. Теперь я могу сообщить своим коллегам, что с вами всё же можно иметь дело.";
...
// Jason --> -------------------------генератор Сомнительное предложение----------------------------------------
		...
		case "Contraoffer":
			...
			link.l1 = "Хм... Звучит заманчиво. Я соглас"+GetSexPhrase("ен","на")+"!";
		...
		case "Device_Trader_1":
			...
			{
				dialog.text = "Хм... Да, приносил мне такую вещь один странный тип. Только он её никак не назвал, а просто пытался мне продать. Да только зачем она мне, если я даже не знаю, для чего она нужна? Как я её потом продать сумею? В общем, отказал я ему, и он ушёл.";
		...
		//Jason --> генератор Место под солнцем
		case "Sunplace_begin":
			dialog.text = "Конкуренция... В нашем деле без неё никак не обойтись. Алчные негодяи так и норовят ворваться в твой уютный бизнес, и, действуя всяческими гнусными методами, переманить клиентуру к себе\nНо это лирика. А по сути: я хотел бы попросить вас помочь мне избавиться от одного из таких моих конкурентов. Нет, убивать его вовсе не обязательно. Достаточно просто захватить или потопить его корабль с грузом.";
			link.l1 = "Хм, ну, если вы хорошо заплатите, это можно устроить.";
			link.l1.go = "Sunplace_1";
			link.l2 = "Нет уж, я не намерен"+GetSexPhrase("","а")+" ввязываться в ваши торгашеские разборки. Топите своего недруга без моего участия.";
		...
		case "Sunplace_1":
			...
			dialog.text = "Очень хорошо. Итак, вашего клиента зовут "+pchar.GenQuest.Sunplace.Trader.Enemyname+". Недавно он снарядил "+GetStrSmallRegister(XI_ConvertString(GetBaseShipParamFromType(sti(pchar.GenQuest.Sunplace.Trader.ShipType), "Name") + "Acc"))+" '"+pchar.GenQuest.Sunplace.Trader.ShipName+"' с грузом " + GetGoodsNameAlt(sti(pchar.GenQuest.Sunplace.Trader.Goods))+ " в плавание. Он вложил в этот товар значительную сумму денег, так что потеря груза весьма серьёзно ударит по его кошельку.";
		...
		case "Sunplace_complete_murder":
			...
			link.l1 = "Послушайте, перестаньте, наконец, причитать. Вы просили избавить вас от конкурента - я сделал"+GetSexPhrase("","а")+" это. Я сделал"+GetSexPhrase("","а")+" даже лучше, чем вы просили изначально - потеряв груз, можно вновь разбогатеть и вредить, а будучи мертвецом уже ничего нельзя сделать.";
		...
		case "FindFugitiveSt":
			...
			{
				dialog.text = NPCStringReactionRepeat("Не знаю, что там говорят в таверне Порт-Ройала, а в своём магазине я такого человека не встречал. И вообще нигде не видел. Поспрашивайте в посёлке, может, кто что скажет...", "Ты уже спрашивал меня об этом человеке, и я тебе сказал: не знаю!", "Ты что, издеваешься, или на самом деле тупой? Третий раз спрашиваешь одно и то же!", "Ох, и как только такой дурень капитаном стал...", "block", 1, npchar, Dialog.CurrentNode);
		...
		// belamour legendary edition -->
		case "trial":
			dialog.text = "Господи, да что же вы так расшумелись, молодой человек! Будьте сдержаннее, в конце концов, и выбирайте выражения, когда говорите об уважаемых людях! Жерар Лекруа отбыл с Гваделупы в экспедицию на материк, но оставил ваше вознаграждение у доверенного человека. Успокоились?";
			link.l1 = "Гхм... прошу меня извинить, месье. Я погорячился...";
			link.l1.go = "trial_1";
		break;
		
		case "trial_1":
			dialog.text = "Прекрасно. Постарайтесь впредь сначала спрашивать, а уже потом кричать во весь голос. Ваше вознаграждение господин Лекруа оставил местному смотрителю маяка - они давние друзья. Вам нужно только наведаться к нему и забрать причитающуюся оплату. Надеюсь, теперь вы удовлетворены?";
			link.l1 = "Вполне. Ещё раз прошу извинить меня. А теперь позвольте откланяться.";
			link.l1.go = "trial_2";
		break;
		...
		case "trialA":
			dialog.text = "Да, он был здесь, ждал вас. Но, наверное, задача, которую он поручил вам, оказалась сложнее, чем изначально предполагалось, поэтому он не дождался и отправился в экспедицию на материк. Ваше вознаграждение он оставил у доверенного человека.";
			link.l1 = "Да, у меня действительно возникли непредвиденные обстоятельства, но поручение я успешно выполнил. Рад слышать, что моя оплата ждёт меня. У кого я могу её получить?";
			link.l1.go = "trialA_1";
		break;
		
		case "trialA_1":
			dialog.text = "Ваше вознаграждение господин Лекруа оставил местному смотрителю маяка - они давние друзья. Вам нужно только наведаться к нему и забрать причитающуюся оплату. Месье Лекруа - честный человек, поэтому, думаю, вы будете удовлетворены своим вознаграждением.";
			link.l1 = "Понял, благодарю вас! Тогда отправляюсь к смотрителю маяка. А теперь позвольте откланяться.";
			link.l1.go = "trialA_2";
		break;
		...
		case "trial_2":
			...
			link.l1 = "Ещё раз прошу прощения... Спасибо за помощь, месье. Отправляюсь к господину Моруа немедленно!";
		...
		// belamour legendary edition на пару с Акулой -->
		case "SharkGoldFleet":
			dialog.text = "А-а, предприимчивый торговец! Сразу видно деловой подход. Уважаю. Конечно, у меня есть нужный вам товар.";
			link.l1 = "Уверен, что я смогу выгодно продать его. Насколько я знаю, в Порто-Белло хороший спрос на этот товар. Во сколько мне это обойдётся?";
			link.l1.go = "SharkGoldFleet_01";
		break;
		
		case "SharkGoldFleet_01":
			pchar.questTemp.SharkGoldFleet = "buyincar";
			dialog.text = "Так-так... Значит, триста единиц кофе... И ещё столько же какао... Это будет вам стоить..."+sti(GetStoreGoodsPrice(&stores[sti(rColony.StoreNum)], GOOD_COFFEE, PRICE_TYPE_BUY, pchar, 300) + GetStoreGoodsPrice(&stores[sti(rColony.StoreNum)], GOOD_CHOCOLATE, PRICE_TYPE_BUY, pchar, 300))+" песо!";
			...
			{
				link.l1 = "Хм... Прошу прощения: кажется, у меня не хватает наличности. Подождите, пожалуйста: я сейчас сбегаю на корабль за деньгами - и сразу вернусь!";
				link.l1.go = "exit";
			}
			else
			{
				link.l1 = "Вот, пожалуйста.";
		...
		case "SharkGoldFleet_02":
			...
			{
				dialog.text = "Подождите минутку, сеньор. Кажется, у вас на судне места не хватит для такой партии. Освободите трюм и возвращайтесь.";
				link.l1 = "Ох, забыл разгрузиться! Подождите минутку - я мигом!";
				link.l1.go = "exit";
			}
			else
			{
				dialog.text = "Отлично! Я немедленно отдам распоряжение о погрузке товара на ваш корабль. С вами приятно иметь дело!";
				link.l1 = "Взаимно, сеньор! А теперь позвольте откланяться: дела не ждут.";
		...
		case "SharkGoldFleet_again":
			dialog.text = "Товар ожидает вас. Вы принесли деньги?";
			if(pchar.money < sti(GetStoreGoodsPrice(&stores[sti(rColony.StoreNum)], GOOD_COFFEE, PRICE_TYPE_BUY, pchar, 300) + GetStoreGoodsPrice(&stores[sti(rColony.StoreNum)], GOOD_CHOCOLATE, PRICE_TYPE_BUY, pchar, 300)))
			{
				link.l1 = "Пока нет. Я просто хотел убедиться, что ваше предложение в силе. А деньги скоро будут.";
				link.l1.go = "exit";
			}
			else
			{
