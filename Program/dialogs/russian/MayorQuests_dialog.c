	...
	switch(Dialog.CurrentNode)
	{
		...
		case "DestroyGang_1":
			dialog.text = LinkRandPhrase("Да, я известен в этих краях, хе-хе... Стоп, а ты не "+ GetSexPhrase("очередной ли пёс","очередная ли шавка") +" губернатора, "+ GetSexPhrase("которого","которую") +" он пытается натравить на меня?",
				"Губернатор - мой большой друг, чего скрывать? Ха, а не "+ GetSexPhrase("очередной ли ты герой, отправленный","очередная ли ты героиня, отправленная") +", им за моей головой?",
		...
		case "ContraPass_abordage":
			dialog.text = "Аргх, мерзавец! Как ты посмел напасть на моё судно?! Тебе это даром не пройдёт!";
			link.l1 = "Конечно, не пройдёт! Мне за это заплатят... У тебя на борту есть один человек, "+pchar.GenQuest.TakePassenger.Name+" его зовут. Он-то мне и нужен.";
		...
		case "ContraPass_abordage_1":
			...
			link.l1 = "Сам держись и не падай, пёс!";
		...
		case "Fugitive_city_2":
			dialog.text = "Значит, вы всё-таки нашли меня... Сударь, выслушайте меня, и, возможно, вы измените своё решение. Да, я действительно дезертировал со службы. Но у меня просто уже не было сил смотреть на безобразие, которое творится в наших регулярных частях!\nЯ хочу тихой и мирной жизни, и здесь, в этом посёлке, я нашёл её. Оставьте меня в покое, скажите, что не нашли, или что я сбежал с пиратами в море, а я взамен отдам вам вот этот мешочек с янтарем. Очень ценная вещь, скажу вам...";
		...
		case "Fugitive_city_fight":
			dialog.text = "Тогда обнажи свой клинок, наёмник! Так просто я не дамся!";
		...
		case "Fugitive_shore": // в бухте
			...
			link.l1 = "Как бы там ни было, а поговорить всё-таки придётся. Вы - "+pchar.GenQuest.FindFugitive.Name+"? Думаю, вам не стоит отрицать этого.";
		...
		case "Fugitive_tavern": // в таверне
			...
			link.l1 = "Зато я ищу вашей компании, "+pchar.GenQuest.FindFugitive.Name+". Точнее, вы мне скоро её составите, причём в трюме моего корабля. Нас ждёт путь в "+XI_ConvertString("Colony"+pchar.GenQuest.FindFugitive.Startcity)+", к тамошнему губернатору. Он просто сгорает от желания вас увидеть.";
			link.l1.go = "Fugitive_tavern_1";
		break;
		
		case "Fugitive_tavern_1":
			dialog.text = "И-ик!.."+RandSwear()+" Он всё-таки достал меня! Послушай, дружище, ты не знаешь того, что произошло... Я не мог после этого оставаться на службе, не мог! Я до сих пор каждый вечер напиваюсь в стельку, лишь бы забыть об этом\nПослушай, давай договоримся. Скажи, что не нашёл меня, или что я сбежал с пиратами в море, а я взамен отдам тебе самородки, которые я нашёл в местной пещере. У меня больше ничего нет, я все отдаю тебе, лишь бы никогда больше не увидеть "+XI_ConvertString("Colony"+pchar.GenQuest.FindFugitive.Startcity)+"...";
			link.l1 = "Не пытайтесь меня подкупить, любезный! Немедленно сдайте оружие и следуйте за мной!";
