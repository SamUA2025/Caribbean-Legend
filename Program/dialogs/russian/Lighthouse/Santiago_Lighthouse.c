...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		case "quests":
			...
			{
				link.l1 = "Инквизитор Сантьяго, отец Винсенто, упомянул тебя в своём письме. Тебе известно про это?";
			...
			{
				link.l1 = "Мне нужно увидеть отца Винсенто. Я нашёл вещи, которые ему нужны.";
		...
		case "guardoftruth":
			dialog.text = "Конечно, сеньор. Вы, видать, большая шишка, раз сам отец Винсенто ведёт с вами дела...";
		...
		case "guardoftruth_1":
			dialog.text = "";
			link.l1 = "За пленника отвечаешь перед самим инквизитором. Не советую снимать кандалы - Гай Марше парень прыткий, да и силёнка в руках имеется. Кроме того, передай отцу Винсенто это письмо и скажи, что я жду на него ответа через два дня. Думаю, этого будет достаточно...";
		...
		case "guardoftruth_2":
			...
			dialog.text = "Я вас понял, сеньор. Всё будет сделано в лучшем виде, не сомневайтесь. Я не первый раз помогаю святому отцу.";
			link.l1 = "Это ещё не всё. К тебе должен был прибыть капитан каракки 'Сан-Грегорио', Карлос Геварра. Он привёз ваниль для меня. Он передавал моё письмо?";
		...
		case "guardoftruth_5":
			dialog.text = "Да, сеньор. Вот письмо от Его Преосвященства. Отец Винсенто очень доволен вами. Также он сказал, что вы всё сами поймёте из текста письма.";
		...
		case "guardoftruth_7":
			...
			link.l1 = "Ну нет, дружище! Очень уж тяжёлым трудом они мне достались, чтобы я с ними расстался. Я передам их только отцу Винсенто лично в руки.";
		...
		case "guardoftruth_11":
			dialog.text = "Его Преосвященство примет вас, сеньор. Не затягивайте с визитом. Вот, он передал для вас эту грамоту - покажите её страже, и она не будет чинить вам препятствий. Но учтите, что на вашем корабле должен быть поднят флаг Испании, иначе солдаты по уставу будут обязаны арестовать вас.";
