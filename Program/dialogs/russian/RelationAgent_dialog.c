		...
		case "patent_2":
            ...
            switch (sti(NPChar.nation))
            {
			    case PIRATE :
                    ...
                    break;
                case HOLLAND :
                    dialog.text = "Голландия почти мирная страна, у вас станет много друзей и мало врагов. А сам патент обойдётся вам всего лишь в "+pchar.PatentPrice+" песо.";
                    link.l1 = "Неплохая перспектива. Я "+ GetSexPhrase("согласен","согласна") +" на ваши условия!";
                    break;
                case FRANCE :
                    dialog.text = "Друзья и враги Франции станут вашими. Вы сможете топить корабли врагов. А сам патент обойдётся вам всего лишь в "+pchar.PatentPrice+" песо.";
                    link.l1 = "Отличная перспектива! Мне плевать, кому служить! Послужу и французам!";
                    break;
                case SPAIN :
                    dialog.text = "У Испании много врагов и они тут же станут вашими! Испанцы - нация морских воинов. Патент обойдётся вам всего лишь в "+pchar.PatentPrice+" песо.";
                    ...
                    break;
                case ENGLAND :
                    dialog.text = "Если честно, таким образом генерал-губернатор Англии набивает свой карман. А сам патент обойдётся вам всего лишь в "+pchar.PatentPrice+" песо.";
