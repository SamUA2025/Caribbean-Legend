...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		...
		case "FMQM_5":
			...
			link.l1 = "Но вы также говорили и о том, что свободный оборот смолы запрещён...";
			link.l1.go = "FMQM_6";
		break;
		
		case "FMQM_6":
			dialog.text = "Не переживайте. Вы же не понесёте её в магазин или контрабандистам. После операции возвращаетесь в Сен-Пьер и ставите своё судно ко мне в доки на ремонт, вечером. По темноте, дабы не привлекать внимание плотников, двое моих верных людей перенесут всю смолу с вашего корабля в укромное место на верфи. Никто ничего не заподозрит.";
			link.l1 = "Вы предусмотрительны, мастер. Хорошо. Тогда я не буду терять время и отправляюсь на своё судно.";
			link.l1.go = "FMQM_7";
		break;
		...
		case "FMQM_9":
			dialog.text = "Превосходно! Давайте поставим ваше судно в доки, а в сумерки займёмся разгрузкой, как и договаривались. Вы отправляйтесь на корабль, а я пока соберу монеты и подготовлю вашу награду.";
