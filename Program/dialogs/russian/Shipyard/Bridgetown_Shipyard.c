...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		case "quests":
            ...
            {
                link.l1 = "Я тут направляюсь в Блювельд с грузом кофе и хочу докупить ещё товар, но вот незадача: на этом бриге, который я купил у вояки, просто безобразное количество тяжёлых пушек, целых 24 штуки. Я же не на войну собрался? Я хочу продать тебе их все, и купить 12 шестифунтовок. Этого вполне достаточно, чтобы припугнуть пиратов. А освободившееся место заполню товаром.";
                link.l1.go = "ShipyardDone";
			}
		break;
		
		case "ShipyardDone":
			dialog.text = "Да пожалуйста, продавай. Шестифунтовок у меня всегда хватает, а вот с тяжёлыми пушками проблема, так что заплачу тебе за них неплохую цену, если они, конечно, ещё в годном состоянии.";
