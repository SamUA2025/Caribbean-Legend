	...
	switch(Dialog.CurrentNode)
	{
		case "First time":
			...
			if (npchar.quest.meeting == "0")
			{
				...
				link.l1 = "Приветствую, "+NPCharSexPhrase(NPChar,"сын","дочь")+" джунглей. Я рад"+GetSexPhrase("","а")+" тебя видеть, но мне пора продолжить свой путь.";
				link.l1.go = "exit";
		...
		case "CitizenNotBlade":
			dialog.text = NPCharSexPhrase(NPChar, "Не искушать судьбу, бледнолицый! Убери свой сабля!", "Знаете, я, как гражданка этого города, прошу вас не ходить у нас с обнажённым клинком.");
