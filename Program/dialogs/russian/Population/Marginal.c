	...
	switch(Dialog.CurrentNode)
	{
		case "First time":
			...
			if (npchar.quest.meeting == "0")
			{
				...
				{
					dialog.text = "Эй ты, моря"+GetSexPhrase("к","чка")+"! Да-да, ты. Подойди-ка поближе, у меня к тебе дело есть...";
				...
				dialog.text = LinkRandPhrase("Эй, моря"+GetSexPhrase("к","чка")+", я вообще-то занят. Чего тебе?","Что ты хочешь, "+GetSexPhrase("солёный сюртук","деваха")+"?","Кэп, мне тут не до праздной трескотни. Что ты хотел"+GetSexPhrase("","а")+"?");
