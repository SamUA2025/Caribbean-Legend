	...
	switch(Dialog.CurrentNode)
	{
		...
		//Jason ---------------------------------------Бремя гасконца------------------------------------
			if (CheckAttribute(pchar, "questTemp.Sharlie.Lock") && pchar.location == "Fortfrance_bank")
			{
				...
				Link.l1.go = "quests";
				Link.l2 = "Как насчёт небольшого кредита?";
				...
				{
					link.l4 = "Взгляните на эти серьги, месье. Я нашёл их в кармане мёртвого бандита в джунглях. Это явно работа хорошего ювелира, которого в этой глуши и быть не могло. Можете что-нибудь сказать о них?";
		...
		//<-- Бремя гасконца
			...
			if (pchar.questTemp.Slavetrader == "Havana_seekslaves" && pchar.questTemp.Slavetrader.UsurerId == npchar.id)
			{
				...
				{
					Link.l1 = "Да, привёз"+ GetSexPhrase("","ла") +". Они у меня в трюмах.";
			...
			{
				dialog.Text = LinkRandPhrase(LinkRandPhrase("Здравствуйте, "+GetAddress_Form(NPChar)+". Чем обязан? Мы с вами не знакомы?","Прошу вас, капитан, проходите! Будем знакомы, я "+GetFullName(npchar)+", здешний ростовщик.","Рад знакомству, "+GetAddress_Form(NPChar)+"! Я здешний ростовщик, и если вы по денежному вопросу, то вы зашли правильно."), LinkRandPhrase("Мы не встречались раньше, капитан? Я "+GetFullName(npchar)+", здешний ростовщик.","Прошу вас, капитан! Будем знакомы, я "+GetFullName(npchar)+", здешний ростовщик.","Здравствуйте, "+GetAddress_Form(NPChar)+". Я "+GetFullName(npchar)+", здешний ростовщик."), LinkRandPhrase("Будем знакомы, "+GetAddress_Form(NPChar)+", я "+GetFullName(npchar)+", скромный ростовщик, единственный в этом прекрасном городе.","Прошу вас, капитан! Желаете взять в долг, или напротив - отдать в рост ваши кровные?",""+GetSexPhrase("Господин капитан","Госпожа")+"! Я рад, что вы посетили мою скромную контору!"));
				link.l1 = RandPhraseSimple(LinkRandPhrase("Я тоже рад"+GetSexPhrase("","а")+" приветствовать вас. Вот, прогуливал"+GetSexPhrase("ся","ась")+" по городу и решил"+GetSexPhrase("","а")+" заглянуть к вам.","Очень приятно, я "+GetFullName(pchar)+", будем знакомы.",""+GetFullName(pchar)+", капитан корабля "+pchar.ship.name+", рад"+GetSexPhrase("","а")+" знакомству. А у вас тут, как я понимаю, банк?"), RandPhraseSimple("Будем знакомы, я "+GetFullName(pchar)+", капитан корабля "+pchar.ship.name+".  Я вот решил"+GetSexPhrase("","а")+" заглянуть, познакомиться.","Ага, значит я заш"+GetSexPhrase("ёл","ла")+" в местный банк? Рад"+GetSexPhrase("","а")+" знакомству, я "+GetFullName(pchar)+", капитан собственного корабля."));
				link.l1.go = "next";
				NPChar.quest.meeting = "1";
				if(startHeroType == 4 && NPChar.location == "SantaCatalina_bank")
				{
					dialog.text = "Госпожа МакАртур, приветствую, заходите.";
					link.l1 = "И я вас, мистер "+npchar.lastname;
					link.l1.go = "Helen_next";
				}
			}
			else
			{
				dialog.Text = pcharrepphrase(LinkRandPhrase(LinkRandPhrase("Кого я вижу! И что это вас сюда занесло, "+GetAddress_Form(NPChar)+"?","С чем пожаловали, капитан? Увы, ваша репутация делает вас не очень желанным клиентом...","Ага, к нам пожаловал очередной клиент! А я уж сперва подумал - грабители... Хе-хе, шучу я."),LinkRandPhrase("О! А вам тут что понадобилось, милейший? Здесь у меня банк, а не кабак...","Здравствуйте, капитан. Сразу должен предупредить вас - я очень разборчив в выборе клиентов.","Что вам угодно, "+GetFullName(pchar)+"? Надеюсь, вы помните, что ваша репутация не позволяет вам рассчитывать на крупный займ?"),LinkRandPhrase("Надеюсь, вы пришли сделать вклад, "+GetAddress_Form(NPChar)+"? Ибо насчёт кредита договориться нам с вами будет непросто.","Капитан "+GetFullName(pchar)+", что вам угодно от скромного ростовщика? Увы, вряд ли я готов предоставить вам займ... разве что - принять на хранение ваши деньги.","Заходите, "+GetAddress_Form(NPChar)+". С прискорбием должен заметить, что вы сейчас не самый желанный клиент, но я не привык с порога отказывать, так что - проходите.")),LinkRandPhrase(LinkRandPhrase("Здравствуйте, "+GetSexPhrase("господин","госпожа")+" "+GetFullName(pchar)+"! Если вы по делу, то я всегда готов помочь вам.","Приветствую вас, "+GetAddress_Form(NPChar)+". Одолжить наличность, или принять на хранение любую сумму - я всегда к вашим услугам.","Дорог"+GetSexPhrase("ой","ая")+" "+GetFullName(pchar)+"! Как я рад снова видеть вас! Что вам угодно?"),LinkRandPhrase("Капитан "+GetFullName(pchar)+"! Я всегда к вашим услугам - одолжить монет, или принять на хранение некую сумму?","Приветствую вас, капитан. Вы всегда желанный клиент - у вас прекрасная деловая репутация!","Добрый день, "+GetFullName(pchar)+". Я рад, что вы снова заглянули ко мне. Надеюсь, по выгодному делу?"),LinkRandPhrase("Добрый день, капитан! Что вам угодно? Хотите взять займ, или открыть вам кредит?","Капитан "+GetFullName(pchar)+"! Не угодно ли вам сделать вклад на выгодных условиях? Я всегда рад столь уважаемому клиенту.","Рад вас видеть снова, капитан! Сделать вклад, или открыть кредит - я всегда готов помочь вам.")));
				link.l1 = pcharrepphrase(RandPhraseSimple(LinkRandPhrase("Шутки в сторону, ростовщик, я приш"+GetSexPhrase("ёл","ла")+" по делу.","Много болтаешь, дружок. Давай-ка перейдём к делам.","Деньги не пахнут, слышал такую умную фразу? Ну-ка, зажимай нос и переходи к делу."), LinkRandPhrase("Это так здесь встречают клиентов? Твоё счастье, что я сегодня в добром настроении.","Ха! Вижу, здесь мне не рады? Ну, так я и не золотой дублон, чтобы тебе нравиться. И вообще, давай-ка к делу, меняла.","Эх, и поучил"+GetSexPhrase("","а")+" бы я тебя вежливости, дружок... да некогда мне. Займёмся, пожалуй, мы с тобой денежными вопросами.")),
				RandPhraseSimple(LinkRandPhrase("Рад"+GetSexPhrase("","а")+" видеть старого знакомого!","К вам всегда приятно зайти, дружище. Ну что, перейдём к делам?","Очень рад"+GetSexPhrase("","а")+", очень рад"+GetSexPhrase("","а")+". Обсудим дела, дружище?"),LinkRandPhrase("Весьма рад"+GetSexPhrase("","а")+" новой встрече. Ну, что нового в финансовых морях-океанах?","Рад"+GetSexPhrase("","а")+", что помните меня, любезный. Я тороплюсь, так что, может быть, сразу перейдём к делам?","Привет, старина! Рад"+GetSexPhrase("","а")+" снова видеть старых знакомых!")));
				link.l1.go = "next";
			}
			break;
...
//Jason, генер почтового курьера 2 уровня
			if (CheckAttribute(PChar, "questTemp.WPU.Postcureer.LevelUp"))
			{
				...
				{
					link.l12 = "Я доставил"+GetSexPhrase("","а")+" вам деловые бумаги из города "+XI_ConvertString("Colony"+pchar.questTemp.WPU.Postcureer.StartCity+"Gen")+".";
			...
			{
				link.l11 = "Я хочу поговорить по поводу долга вашего клиента по имени "+pchar.GenQuest.Noblelombard.Name+". Он отдал в залог свою семейную реликвию. Я представляю его интересы и уполномочен"+GetSexPhrase("","а")+" вести переговоры по вопросу возврата залога.";
			...
			{
				link.l11 = "Три месяца назад мы с вами встречались по поводу реликвии одного дворянина, по имени "+pchar.GenQuest.Noblelombard.Name+". Вы, наверное, помните? Он должен был открыть депозит на моё имя, на сумму "+FindRussianMoneyString(sti(pchar.GenQuest.Noblelombard.Regard))+"...";
			...
			{
				link.l8 = "Я приш"+ GetSexPhrase("ёл","ла") +", как мы и договаривались. Что там насчёт работенки?";
				link.l8.go = "Takeslaves_3";
				break;
			}
			if(pchar.questTemp.Slavetrader == "waitship" && pchar.questTemp.Slavetrader.UsurerId == npchar.id)
			{
				link.l8 = "Как мы и договаривались, я приш"+ GetSexPhrase("ёл","ла") +". Что там насчёт работенки?";
				link.l8.go = "Takeslaves_3";
				break;
			}
		...
		case "Helen_next":
			dialog.text = NPCStringReactionRepeat("Не сказал бы, чтобы у вас была потребность в деньгах или преумножении богатств. Что же вас привело ко мне в кабинет?", 
				"Что вы хотите на этот раз?", 
				"Хм... Что вы желаете?",
                "Эх, " + GetAddress_Form(npchar) + ", вы себе представить не можете, до чего порой бывают навязчивы клиенты..." , "block", 1, npchar, Dialog.CurrentNode);
			link.l1 = HeroStringReactionRepeat("Ничем, я просто заш"+ GetSexPhrase("ёл","ла") +" посмотреть и поговорить.", 
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		case "LoanUsurer":
			if (npchar.id == "Panama_Usurer")
			{
				...
				{
					dialog.text = "М-м-м... боюсь, вынужден отказать вам, "+GetAddress_Form(NPChar)+". Простите, но врагам Испании мой банк услуг не оказывает.";
					link.l1 = "У денег нет национальности, сеньор банкир.";
					if (CheckAttribute(pchar,"questTemp.Mtraxx.Cartahena.Gold"))
					{
						...
						{
							dialog.text = "М-м-м... "+GetAddress_Form(NPChar)+". Вынужден сообщить, что ваш вклад более не действителен.";
							Link.l1 = "На каком основании?!";
			...
			{
				Link.l6 = LinkRandPhrase("Я хочу занять денег.", "Мне срочно понадобилась пара-другая песо.", "Как насчёт небольшого кредита?");
				Link.l6.go = "loan";					
				if(makeint(Pchar.money) >= 100)
				{
					Link.l7 = LinkRandPhrase("Я бы хотел"+ GetSexPhrase("","а") +" отдать деньги в рост.","Примете на хранение пару мешков монет?", "Серебришко на чёрный день оставить можно?"); // patch
					Link.l7.go = "deposit";				
				}			
...
*/			
			...
			if (sTemp == "credit")
			{
				link.l11 = LinkRandPhrase("Я помню, что брал"+ GetSexPhrase("","а") +" у вас кредит, но рассчитаться пока не готов"+ GetSexPhrase("","а") +"...", "Я знаю, что долж"+ GetSexPhrase("ен","на") +" вам, но сейчас у меня нет денег. Верну позже...", "Я помню, что долж"+ GetSexPhrase("ен","на") +" вам, но в данный момент не имею достаточных средств для погашения кредита. Я сделаю это позже.");
		...
		case "loan_return":
			...
			Link.l1 = LinkRandPhrase("Я хочу занять денег.", "Мне срочно понадобилась пара-другая песо.", "Как насчёт небольшого кредита?");
			Link.l1.go = "loan";			
			if(makeint(PChar.money) >= 100)
			{
				Link.l2 = LinkRandPhrase("Я бы хотел"+ GetSexPhrase("","а") +" отдать деньги в рост.","Примете на хранение пиратскую добычу?", "Серебришко на чёрный день оставить можно?");
				Link.l2.go = "deposit";				
			}		
			if(CheckUseDublons(NPChar))	
			{
		...
		case "result_part":
			...
			{
				dialog.text = "Сударь, у вас нет столько денег на счёте.";			
		...
		case "result_dub_part":
			...
			{
				dialog.text = "Сударь, у вас нет такого количества золота на счёте.";			
				link.l1 = "Тысяча акул! Я ошибся. Изменим сумму...";	
				Link.l1.go = "Deposit_return_dub_part";
				break;
			}			
		...
		case "GiveTaskSlave":
			...
			dialog.Text = "Ах, оставьте! Мы с вами серьёзные люди, и ни к чему оглядываться на пересуды всей этой голытьбы, которая готова удавиться за испанский дублон, но при этом и пальцем не пошевелит, чтобы сделать из него два\nЯ ищу человека, которому хочу предложить серьёзное дело. Человека отважного и деятельного, честного и пунктуального, но не обременённого... э-эм... излишней щепетильностью в вопросах морали. И очень надеюсь найти такого человека в вашем лице.";
		...
		case "Checkslaves":
			...
			dialog.Text = "Ну что, удалось вам добыть оговорённую партию 'чёрного дерева'?";
            if (amount < 0)
			{
		...
		case "Takeslaves_4":
			...
			dialog.text = "Превосходно. Так вот. Этот проходимец, по кличке " + GetName( NAMETYPE_ORIG, pchar.questTemp.Slavetrader.UnknownPirateName, NAME_NOM) + ", привёз из Африки груз рабов, и сейчас остановился у " + XI_ConvertString(pchar.questTemp.Slavetrader.Island.Shore + "Gen") + ", это остров " + XI_ConvertString(pchar.questTemp.Slavetrader.Island) + ". Он ждёт там контрабандистов. Его галеон называется '" + pchar.questTemp.Slavetrader.ShipName + "'. Эту сделку нужно сорвать, во что бы то ни стало!";
		...
		case "Takeslaves_6":
			dialog.Text = "С учётом того, что я даю полную информацию о местонахождении груза, избавляя вас от необходимости бороздить море в поисках добычи, оплата будет, как вы сами понимаете, несколько ниже. По 200 песо за каждого раба. Но это всё равно огромная сумма - порядка трёхсот тысяч, если всё пройдёт успешно.";
		...
		case "Takeslaves_5_lose":
			dialog.text = "Да, похоже, я в тебе ошибся. Ты опоздал"+ GetSexPhrase("","а") +"? А может, просто струсил"+ GetSexPhrase("","а") +", покинув поле боя? Ладно. Теперь это уже не имеет значения. Ты загубил"+ GetSexPhrase("","а") +" отличную идею, и я более не желаю иметь с тобой дел. Проваливай, и забудь обо всём, что ты здесь видел"+ GetSexPhrase("","а") +" и слышал"+ GetSexPhrase("","а") +".";
		...
		case "Takeslaves_5_win":
			...
			{
				dialog.text = "Это конечно весьма занимательно, но... Гм... Похоже, я в тебе ошибся. Что ты мне привёз"+ GetSexPhrase("","ла") +"? "+ sTemp +" рабов? А где остальной товар? И только не говори, что ты его утопил"+ GetSexPhrase("","а") +". Ты продал"+ GetSexPhrase("","а") +" его контрабандистам, или, что ещё хуже - мерзавцу Вуазье. Убирайся с глаз долой, не желаю больше иметь с тобой никаких дел.";
				link.l1 = "Счастливо оставаться.";
				link.l1.go = "node_hanter_1";
				break;
			}
			dialog.text = "Это конечно весьма занимательно, но... Где рабы? Где наш товар? И только не говори, что ты его утопил"+ GetSexPhrase("","а") +". Ты продал"+ GetSexPhrase("","а") +" его контрабандистам, или, что ещё хуже - мерзавцу Вуазье. Убирайся с глаз долой, не желаю больше иметь с тобой никаких дел.";
			link.l1 = "Счастливо оставаться.";
			link.l1.go = "node_hanter_1";
		break;
		...
		case "Takeslaves_7_win":
			...
			{
				link.l2 = "Вы имеете в виду вот эту старинную застёжку?";
				link.l2.go = "Yestatue";
			}
		break;
		...
		case "Yestatue":
			dialog.text = "Да, именно! Это фибула самих Медичи... слыхали о таких? Значит, она всё-таки была в каюте этого мерзавца... Разрешите, я взгляну поближе?";
		...
		case "Yestatue_1":
			...
			dialog.text = "Так-так... Без сомнения, это она. Послушайте, " + pchar.name + ", продайте мне её. Я готов заплатить сто тысяч золотом.";
			link.l1 = "Сто тысяч? Хм... Я соглас"+ GetSexPhrase("ен","на") +". Забирайте!";
			link.l1.go = "Buystatue";
			link.l2 = "Нет, не продам. Ценность этой застежки отнюдь не в золоте, которое можно за неё выручить. Я разбираюсь в подобных вещах.";
		...
		case "Nobuystatue":
			dialog.text = "Понимаете, мне очень нужна эта фибула! Я полностью с вами согласен - она ценна не деньгами - любой безграмотный торгаш не заплатит вам за неё и пяти тысяч. Но вы и впрямь знаете толк в тайных обрядах, если отказываетесь продать её за такую сумму\nРаз вы не хотите за неё денег, то я предлагаю обмен. У меня есть кое-что, что может вас заинтересовать. Вот, посмотрите. Великолепный лёгкий доспех! Оцените! Предлагаю в обмен на фибулу\nОна не единственная такая на свете. Вы моря"+ GetSexPhrase("к","чка") +", вы сможете отыскать себе ещё. А вот мне сложнее. Ну, так что, согласны?";
			link.l1 = "Хех... Пожалуй, я соглас"+ GetSexPhrase("ен","на") +". Давайте мне доспех, и оставьте фибулу себе.";
			link.l1.go = "Nobuystatue_yes";
			link.l2 = "Нет. Фибула имеет для меня большую ценность, нежели этот доспех. Я оставлю её себе.";
		...
		case "Nobuystatue_no":
			dialog.text = "Жаль, очень жаль... Ну что же, возьмите её назад. Я не осуждаю вас. Жду вас через месяц. До свидания.";
			link.l1 = "До встречи.";
			link.l1.go = "exit";
		...
		case "EscapeSlave_1":
			...
			link.l1 = "Гм... О чём это вы? Новостей много, и каждый день - новая.";
		...
		case "Escape_slaves_win":
			...
			if (amount >= 600 && amount < 1100)
			{
				dialog.text = "Нашли? Гм... Ну а что вы мне привезли? "+ sTemp +" рабов? А где остальной товар? И только не говорите, что вы его утопили. Вы продали его контрабандистам, или, что ещё хуже - мерзавцу Вуазье с Исла Тесоро. Убирайтесь с глаз долой, не желаю больше иметь с вами никаких дел.";
				link.l1 = "Счастливо оставаться.";
				link.l1.go = "node_hanter_1";
				break;
			}
			dialog.text = "Нашли? А где рабы? Где наш товар? И только не говорите, что вы его утопили. Вы продали его контрабандистам, или, что ещё хуже - мерзавцу Вуазье. Убирайтесь с глаз долой, не желаю больше иметь с вами никаких дел.";
			link.l1 = "Счастливо оставаться.";
			link.l1.go = "node_hanter_1";
		break;
		...
		case "Slaveshore_1":
			...
			pchar.questTemp.Slavetrader.ShipName = GenerateRandomNameToShip(sti(NPChar.nation));
			pchar.questTemp.Slavetrader.Nation = NPChar.nation;
			dialog.text = "На этот раз всё предельно просто. Сегодня в акватории " + XI_ConvertString(pchar.questTemp.Slavetrader.Island.Shore + "Gen") + " встал на якорь пинас '" + pchar.questTemp.Slavetrader.ShipName + "' под флагом " + NationNameGenitive(sti(npchar.nation)) + ". На него тайно, при помощи местных контрабандистов, уже погружена большая партия 'чёрного дерева', не менее двух тысяч голов\nКоманда пинаса - обыкновенная портовая матросня, капитан - торгаш. В общем, никудышные вояки. Задача ваша - как обычно: абордировать судно, а товар забрать и привезти мне. Оплата - согласно нашей таксе, по 200 песо за единицу товара. Всё, как обычно.";
		...
		case "Slaveshore_3_no":
			dialog.text = "Вот как? Вы что, шутите? Ну раз такое дело, тогда проваливайте. И забудьте обо всём, что здесь видели и слышали!";
		...
		case "Slaveshore_7": //выбор острова, куда бригантина пойдёт
			...
			link.l1 = "Другого мне не остаётся. Ну что же, молитесь, и за себя, и за меня, и надейтесь, что я её догоню. А когда вернусь - мы ещё продолжим наш разговор. И не думайте, что я всё это вот так оставлю!";
		...
		case "Brig_lose":
			dialog.text = "Проклятие... А я так надеялся, на вас, " + pchar.name + ". Ну что же, больше никаких дел мы с вами вести не можем. Если мне не удастся откупиться от следствия, я буду вынужден бежать. Да и вам не советую здесь находиться - солдаты могут нагрянуть в любой момент. Прощайте.";
		...
		case "Brig_win_1":
			...
			dialog.text = "Отлично... Теперь можно быть спокойным. Генерал-губернатор ни о чём не узнает, а с местными властями все вопросы я уже уладил, хотя пришлось посуетиться изрядно, скажу я вам.";
		...
		case "SlaveGalleon_1":
			dialog.text = "Вы очень близки к истине, " + pchar.name + ". Именно отобрать, а конкретно - свободу. Репартиментос - это своеобразный хитрый способ закабаления индейцев под благовидными псевдозаконными предлогами - мирным путём, так сказать. Применяется испанскими властями по отношению к коренному населению Мэйна. Вам интересно полушать подробности?";
		...
		case "FindRat_2":
			...
			{
				dialog.text = "Вот! Замечательно! Золотой ритуальный нож! Это редкая вещица. Я давно хотел иметь такую в своей коллекции. Предлагаю вам за неё 30 000, или обмен на амулет Эхекатль, у меня таких два.";
		...
		case "PF_check":
			...
			{
				dialog.text = "Вот! Я её сразу не заметил! Меня интересует вот эта кость с медным кольцом. Очень занятный предмет, скажу я вам... Я готов заплатить за неё 20 000 песо, либо обменять на амулет 'Чимарута'.";
				link.l1 = "Я возьму деньги.";
				link.l1.go = "PF_money";
		...
		case "PF_money":
			...
			Log_Info("Вы отдали заговорённую кость");
			PlaySound("interface\important_item.wav");
		...
		case "FindRat_3":
			...
			link.l1 = "Польщён"+ GetSexPhrase("","а") +", не скрою. Но вы несколько преувеличиваете мои заслуги...";
		...
		case "FindRat_6":
			...
			link.l1 = "Хм... Этого негодяя следует вздёрнуть на ноке рея! Сообщите мне более подробную информацию о нём, ну и, конечно, размер гонорара за работу.";
			link.l1.go = "FindRat_7";
		break;
			
		case "FindRat_7":
			dialog.text = "Насчёт вознаграждения не беспокойтесь. Я щедро заплачу вам за его уничтожение, и не только деньгами. Я не пожалею лучших вещей из своей коллекции. Теперь о нём. Эту крысу зовут Франсуа Гонтьер\nНедавно, чтобы замести следы - ибо он знает, что я за ним охочусь - он продал свой фрегат на одной из верфей архипелага и скрылся. Мне удалось выяснить у своих коллег, что его недавно видели в Панаме. Пожалуй, вам стоит начать поиски именно оттуда.";
		...
		case "Havana_fort_1":
			dialog.text = "В течение последнего месяца в Гавану со всего Мэйна, мелкими партиями, свозились порабощённые индейцы, кроме того, туда прибыли из Африки и разгрузились несколько галеонов с 'чёрной слоновой костью'. В данный момент в Гаване, за высокими стенами форта, находится не меньше пяти тысяч рабов.";
		...
		case "Havana_Fort_yes_1":
			sTemp = GetSquadronGoods(Pchar, GOOD_SLAVES);
			iSlaveMoney = makeint(sTemp)*200;
			dialog.text = "Да, безусловно. Я передам рабов заказчику, он рассчитается, и вы получите свои деньги. Всё, как в прошлый раз. Давайте посчитаем: вы привезли " + sTemp + " рабов. Соответственно, причитающаяся вам сумма составляет " + FindRussianMoneyString(iSlaveMoney) + ". Через неделю приходите ко мне за расчётом.";
		...
		case "Usurer_Escape_4":
			dialog.text = "Никто не знает. Ничего. Вообще. Он словно испарился. Был - и нет. В тот день из гавани вышел флейт, то ли 'Маврикий', то ли 'Мавродий' - наверно, на нём он и скрылся.";
	...
	//--> семейная реликвия
		case "Noblelombard":
			...
			{
				link.l1 = "Прекрасно! В таком случае, я немедленно оплачиваю всю положенную сумму долга с процентами - "+FindRussianMoneyString(sti(pchar.GenQuest.Noblelombard.Summ))+". Свою реликвию мой доверитель заберёт сам. Вот ваши деньги.";
				link.l1.go = "Noblelombard_1";
			}
			if(sti(pchar.money) >= sti(pchar.GenQuest.Noblelombard.Percent)*2)
			{
				link.l2 = "Деньги будут у моего доверителя через три месяца. Давайте заключим соглашение: я оплачиваю вам проценты за истекшие три месяца и авансом проценты ещё за три месяца - всего "+FindRussianMoneyString(sti(pchar.GenQuest.Noblelombard.Percent)*2)+". А по истечении этого срока будет погашен основной долг.";
				link.l2.go = "Noblelombard_2";
			}
			if(sti(pchar.money) >= sti(pchar.GenQuest.Noblelombard.Percent))
			{
				link.l3 = "Деньги будут у моего доверителя через три месяца. Может, я погашу набежавшие проценты, а вы подождёте до момента, когда мой доверитель будет располагать достаточной суммой?";
				link.l3.go = "Noblelombard_3";
			}
			link.l4 = "Ничего так себе стоимость этого раритета! Да, похоже, моему доверителю придётся расстаться со своей реликвией. Всего доброго!";
			link.l4.go = "Noblelombard_4";
			pchar.quest.noblelombard = "true";//лесник с нпчара на пчара
		break;
		
		case "Noblelombard_1":
			dialog.text = "Великолепно! Всё повернулось как нельзя лучше - теперь и я получу свои деньги, и уважаемый "+pchar.GenQuest.Noblelombard.Name+" вернёт назад свою реликвию.";
			link.l1 = "Рад"+GetSexPhrase("","а")+", что мы без труда договорились с вами, "+npchar.name+"! Ну а теперь позвольте откланяться.";
			link.l1.go = "exit";
		...
		case "Noblelombard_2":
			...
			{
				dialog.text = "Хм... Хорошо. Такой вариант меня вполне устраивает. Но если уважаемый "+pchar.GenQuest.Noblelombard.Name+" не найдёт денег через три месяца - то более отсрочек я делать не буду ни на каких условиях. Так и передайте ему.";
				link.l1 = "Обязательно передам! Рад"+GetSexPhrase("","а")+", что мы с вами договорились. Ну а теперь позвольте откланяться.";
				link.l1.go = "exit";
			...
			{
				dialog.text = "Нет. Не пойдёт. Мне нужна вся сумма, причём до заката солнца. Так и передайте вашему 'доверителю'. Больше мне добавить нечего.";
		...
		case "Noblelombard_3":
			...
			{
				dialog.text = "Хм... Ладно. Пойду на такую уступку из уважения к вашему доверителю. Но если "+pchar.GenQuest.Noblelombard.Name+" не найдёт денег через три месяца - то более отсрочек я делать не буду ни на каких условиях. Так и передайте ему.";
				link.l1 = "Обязательно передам! Рад"+GetSexPhrase("","а")+", что мы с вами договорились. Ну а теперь позвольте откланяться.";
				link.l1.go = "exit";
		...
		case "Noblelombard_5":
			...
			{	// Addon-2016 Jason уменьшаем раздачу дублонов
				dialog.text = "Да, всё верно. На ваше имя "+pchar.GenQuest.Noblelombard.Name+" оставил депозит именно на эту сумму. Извольте получить...";
		...
		case "Noblelombard_6":
			...
			link.l1 = "Выходит, что так. Ладно, "+npchar.name+", я тоже на Карибах не навечно, а Европа маленькая... Глядишь, ещё и встретимся. До свидания!";
...
//<-- семейная реликвия
		...
		case "FMQG_x":
			DelLandQuestMark(npchar);
			dialog.text = "Вы... Вы о чём это сейчас?";
			link.l1 = "Какой же ты всё-таки гад! Слушай меня внимательно: не на дурака напал. Пинетт написал письмо в двух экземплярах. Один я отдал тебе, а второй лежит у моего доверенного лица. И если со мной что-нибудь случится - мой человек тут же отнесёт его губернатору, Клоду Франсуа де Лиону...";
			link.l1.go = "FMQG_x1";
		break;
		
		case "FMQG_x1":
			dialog.text = "";
			link.l1 = "Так что тебе не убийц ко мне посылать надо, а ежедневно молиться в церкви за моё здоровье. Запомни: ещё раз рыпнешься в мою сторону - тебе конец. А теперь выдыхай и считай свои дублоны дальше.";
			link.l1.go = "FMQG_x2";
		break;
		...
		case "NeHochuRazgovarivat":
			dialog.text = "Я не хочу с вами разговаривать.";
			link.l1 = "Ладно.";
			link.l1.go = "exit";
		break;
		...
		case "LadyBeth_Usurer_2":
			dialog.text = "Говорят, условия в команде всё хуже. Месье Блэквуд даже стал допускать регулярные потери - чего раньше никогда не было. Но это не моё дело. Я просто продаю товар. Так что вас интересует?";
			link.l1 = "Давайте перейдём к делу.";
			link.l1.go = "next";
