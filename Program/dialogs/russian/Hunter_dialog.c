void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "TreasureCaptain":
			dialog.text = LinkRandPhrase("Вот кто завладел моей картой сокровищ! Придётся тебе, "+GetSexPhrase("приятель","подруга")+", вернуть всё то, что взял...","А! Конкурент"+GetSexPhrase("","ка")+"! Далеко ты не убежишь, вижу, что ноги твои подгибаются под тяжестью моих сокровищ...","Ха, мы всё-таки догнали тебя! Сокровища в этой пещере - мои, тебе ясно? А ну, выворачивай карманы!");
			Link.l1 = LinkRandPhrase("Придётся, дружок, познакомить тебя с моей саблей!","Твои сокровища? Может и так. Были твои - стали мои!","Сейчас я охлажу твой пыл, наглец!");
