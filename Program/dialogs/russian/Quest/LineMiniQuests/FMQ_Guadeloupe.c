...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "citizen_15":
			...
			link.l1 = TimeGreeting()+", месье Пинетт. Я уже с ног сбился, разыскивая вас.";
		...
		case "citizen_19":
			...
			link.l2 = "Пожалуй, вы правы. Убить вас, конечно, было бы неплохо, но действительно в этом нет смысла, и проблем не оберёшься. Но вы не думайте, что я так всё оставлю. Я сейчас же выхожу в море, отправляюсь в Бас-Тер и расскажу ростовщику, где вы прячетесь. А он уже пришлёт за вами людей в чёрных костюмах с полумасками на лицах.";
