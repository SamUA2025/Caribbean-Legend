...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "ShadowGuarder_1":
			dialog.text = "А-а, а я-то его здесь жду! Мне же сказали, что он придёт в таверну! Хорошо, я уже иду.";
		...
		case "ShadowAgent":
			dialog.text = "Доброй ночи, капитан. Пришли за дешёвыми товарами, хе-хе? Следуйте за мной!";
			link.l1 = "Хорошо.";
		...
		case "ShadowTrader":
			dialog.text = "Доброй ночи, "+GetSexPhrase("господин","госпожа")+". Приятно познакомиться с новым клиентом, хе-хе. Представимся: меня зовут " + GetFullName(npchar) + ". У меня самые дешёвые товары в этом городе, смею уверить.";
			link.l1 = "Ну вот мы и встретились... " + npchar.name + ". Пожалуй, я тебя разочарую: я разыскал"+GetSexPhrase("","а")+" тебя не для торговли, а чтобы пресечь твои грязные делишки. Уж очень много ты попортил крови одному человеку в этом городе. Так много, он жаждет закрытия твоей лавочки... любой ценой.";
			link.l1.go = "ShadowTrader_1";
			if (IsCharacterPerkOn(pchar, "Trustworthy"))
			{
				notification("Вызывающий доверие", "Trustworthy");
				link.l2 = "(Вызывающий доверие) Ага, вот ты и попался, каналья! Разве тебе не известно, что коммерческая деятельность без уплаты налогов в городскую казну является серьёзным преступлением? " + GetFullName(npchar) + ", именем закона ты арестован и будешь препровождён в тюрьму, а товар подлежит конфискации! За дверью отряд солдат, так что без глупостей, уважаемый!";
		...
		case "ShadowTrader_1":
			dialog.text = "Вот как? Не ожидал... Кого вы мне привели? Это же подстава! Я даже догадываюсь, кто "+GetSexPhrase("его","её")+" нанял! Закрыть любой ценой... а ну, ребята, в расход "+GetSexPhrase("его","её")+"!";
	...
	case "ShadowTrader_2":
		dialog.text = "Ой... офицер, послушайте! Давайте договоримся. Вы же разумный человек! Я заплачу вам 5 000 песо, и вы дадите нам уйти через второй этаж. Товары тоже заберёте... вам ведь это нужно, да? Зачем вам я? Я сегодня же покину город и никто ничего не узнает. А денежки будут у вас. По рукам, офицер?";
		link.l1 = "Ты что же, негодяй, решил, что за такую смехотворную сумму я буду марать честь мундира?";
		link.l1.go = "ShadowTrader_3";
		break;
	
	case "ShadowTrader_3":
		dialog.text = "Хорошо-хорошо, офицер, возьмите всё, что у меня есть - 10 000 песо. У меня нет больше, клянусь!";
		link.l1 = "Хм... Если я тебя задержу, то, пожалуй, все твои деньги конфискуют... а, ладно! Незаконная торговая точка закрыта, товар конфискован... Давай сюда монеты и проваливай, и чтобы духу твоего в этом городе больше не было!";
		link.l1.go = "ShadowTrader_4";
		break;
		
	case "ShadowTrader_4":
			dialog.text = "Спасибо, спасибо, "+GetSexPhrase("господин","госпожа")+" офицер! Вот ваши деньги, а меня вы больше здесь не увидите. Уходим!";
			link.l1 = "Давай шевелись, или мне всё-таки придётся арестовать тебя!";
		...
		case "ShadowTrader_6":
			...
			link.l1 = "Всё, что у тебя есть, будет конфисковано властями. Или ты и вправду решил, что я сейчас после всего произошедшего буду перетаскивать товары к себе на корабль?";
