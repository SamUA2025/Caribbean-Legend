	...
	switch(Dialog.CurrentNode)
	{
		case "First time":
			if (pchar.questTemp.Consumption == "final")
			{
				...
				{//взял деньги
					link.l1 = "Нет, красавица, это был рейд по просьбе его светлости губернатора. Мне очень жаль, но Анджело действительно умер в казематах тюрьмы - теперь в этом нет сомнений. Крепитесь.";
					link.l1.go = "Waitress";
				}
				else
				{//убил Хуана
					...
					{
						link.l1 = "Вы были правы, вашего брата похитили - комендант продавал узников как скот, работорговцу по прозвищу Чахотка. Но я нагнал"+GetSexPhrase("","а")+" его судно, и теперь он покоится на дне морском, а ваш брат Анджело сойдёт на берег в ближайшее время - у меня на борту не так много шлюпок, как пассажиров сегодня.";
						link.l1.go = "Waitress_2";
					}
					else
					{//отпустил Хуана
						link.l1 = "Вы были правы, вашего брата похитили - комендант продавал узников как скот, работорговцу по прозвищу Чахотка. Но я нагнал"+GetSexPhrase("","а")+" его судно, и, хоть не удалось уничтожить самого мерзавца, ваш брат спасён. Анджело сойдёт на берег в ближайшее время - у меня на борту не так много шлюпок, как пассажиров сегодня.";
						link.l1.go = "Waitress_2";
					}
		...
		case "without_moneysss": // лесник  если Гг нажрался..сволочь:D:D:D
		    dialog.text = "Сеньор"+GetSexPhrase("","ита")+", вы же пообещали найти моего брата, а сами в таверне напились!";
			link.l1 = "Оо..Да, точно..ик.. Успокойся, милашка, я уже п-пош"+GetSexPhrase("ёл","ла")+" искать...ик..кхе..";
			link.l1.go = "exit";
		break;
		
		case "Servant":
			dialog.text = "Добрый день, сеньор"+GetSexPhrase("","ита")+". Вы по какому делу?";
			link.l1 = "Я прин"+GetSexPhrase("ёс","есла")+" депешу сеньору полковнику, но должен отдать её ему лично в руки.";
			link.l1.go = "Servant_1";
		break;
		
		case "Servant_1":
			dialog.text = "Тогда вам следует искать его в тюрьме.";
			link.l1 = "Эта встреча слишком важна, и не для солдатских глаз и ушей. Возможно, я просто приш"+GetSexPhrase("ёл","ла")+" раньше, но я могу подождать полковника здесь. Поверьте, это очень важно!";
		...
		case "Servant_2":
			...
			{
				notification("Недостаточно развит навык (40)", SKILL_SNEAK);
		...
		case "Man_FackYou":
			dialog.text = "Ах ты, ворюга! А быть может, шпион"+GetSexPhrase("","ка")+"? Ребята, сюда, на помощь!";
		...
		case "Sergio_3":
			dialog.text = "Мне известно многое, если не всё, и я вам это расскажу, но не здесь. Встретимся вечером: после отбоя, я, как фельдшер, могу спокойно покинуть тюрьму. Встретимся за городскими воротами, и я всё объясню. Только прошу - прекратите расспросы, пока вы их не насторожили! Если вы уже этого не сделали... А теперь мне пора. Помните, после заката - за городскими воротами.";
		...
		case "Sergio_4":
			...
			AddQuestUserData("Consumption", "sSex1", GetSexPhrase("ел","ла"));
		...
		case "Sergio_5":
			...
			link.l1 = "А долж"+GetSexPhrase("ен","на")+" был"+GetSexPhrase("","а")+"? Что-то вы мне подозрительны, и уже не меньше сеньора коменданта, так что лучше переходите к делу... Что вам известно о Хуане?";
			link.l1.go = "Sergio_6";
		break;
		
		case "Sergio_6":
			dialog.text = "Моё имя - Сержио Сальдо. Я исполняю обязанности фельдшера в нашей тюрьме и...";
			link.l1 = "";
		...
		case "Bandit":
			dialog.text = "Заметил"+GetSexPhrase("","а")+", гад"+GetSexPhrase("","ина")+"! Ласко, давай, режь солдафона, а я займусь "+GetSexPhrase("этим","девкой")+"!";
			link.l1 = "...";
			link.l1.go = "Bandit_1";
		break;
		...
		case "Sergio_15":
			...
			{
				link.l1 = "Благодарю вас, Сержио, вы настоящий офицер, и поступили по чести. Я немедленно снимаюсь с якоря и найду это мерзкое судно, а вы возвращайтесь, пока вас не хватились в тюрьме.";
		...
		case "Sergio_20":
			dialog.text = "О, какая встреча! Сеньор"+GetSexPhrase("","ита")+" "+GetFullName(pchar)+"! Рад вас видеть!";
			link.l1 = "Сеньор Сержио! Вот уж не ожидал"+GetSexPhrase("","а")+"! Как ваши дела? Как поживает господин комендант?";
		...
		case "Sergio_21":
			...
			link.l1 = "На рудник? Не может быть! Вот уж не ожидал"+GetSexPhrase("","а")+" такого торжества правосудия.";
		...
		case "Sergio_22":
			...
			link.l1 = "Ну, хоть так. Хотя я ожидал"+GetSexPhrase("","а")+"... несколько большего.";
			link.l1.go = "Sergio_23";
		break;
		
		case "Sergio_23":
			dialog.text = "Я тоже, но... впрочем, не будем больше об этом негодяе, он того не заслуживает. Сеньор"+GetSexPhrase("","ита")+", я как только прослышал, что ваш корабль входит в порт, сразу поспешил на пирс. У меня к вам есть дело.";
			link.l1 = "Даже так? Внимательно слушаю.";
			link.l1.go = "Sergio_24";
		break;
		
		case "Sergio_24":
			if (startHeroType == 1) sStr = "француз";
			if (startHeroType == 2) sStr = "испанец";
			if (startHeroType == 3) sStr = "англичанин";
			if (startHeroType == 4) sStr = "англичанка";
			dialog.text = "Капитан, вы показались мне честным человеком, которому можно доверять. Также немаловажное значение имеет то, что вы - " + sStr + ", и у вас есть свой корабль. Я предлагаю заключить торговое соглашение.";
		...
		case "oil_trade":
			dialog.text = "Приветствую, сеньор"+GetSexPhrase("","ита")+" капитан! Вы пришли за своей партией смол, как я полагаю?";
		...
		case "oil_trade_1":
			...
			{
				dialog.text = "Да. 2550 дублонов при вас?";
				if (PCharDublonsTotal() >= 2550)
				{
					link.l1 = "Всё по уговору. Вот, возьмите 2550 дублонов.";
			...
			{
				link.l4 = "Сеньор Сержио, я хочу покупать больше смолы. Сможете ли вы предоставлять партии, скажем, в пять раз больше?";
			...
			{
				link.l4 = "Вот, как и обещал"+GetSexPhrase("","а")+", сеньор Сержио, три тысячи дублонов, как вы просили. Уверен"+GetSexPhrase("","а")+", что с вашей предусмотрительностью и моим вложением это предприятие принесёт нам обоим немалую выгоду.";
		...
		case "UpgradeOil":
			...
			{
				dialog.text = "Сеньор"+GetSexPhrase("","ита")+", ваше желание приобрести больше смолы, несомненно, говорит о доверии к нашему делу. Однако тут возникает одна сложность\nС увеличением объёмов растёт риск привлечь внимание властей острова, да и контроль над такими партиями требует людей и мер безопасности, что, признаться, обходится недёшево. Если же за помощь в этом деле вы готовы добавить к цене три тысячи дублонов, в качестве единоразовой выплаты, то я найму надёжных людей, способных уберечь грузы и не допустить утечек сведений. Тогда наш маршрут станет безопаснее, и я сумею поставлять вам триста бочек смолы ежемесячно. В качестве компенсации за ваши вложения, вам, как оптовому покупателю, я предоставлю скидку в пятнадцать процентов на все будущие партии.";
				link.l1 = "Три тысячи дублонов за безопасность поставок? Сеньор Сержио, не скрою, цена эта кажется мне невероятной - будто вы предлагаете мне устроить заговор в Эскориале, а не просто обеспечить защиту грузов смолы!";
				link.l1.go = "UpgradeOil_1";
				notification("Проверка пройдена", SKILL_COMMERCE);
			}
			else
			{
				dialog.text = "Сеньор"+GetSexPhrase("","ита")+", ценю вашу заинтересованность, но столь крупные сделки требуют опыта и осторожности. Признаться, пока ваш уровень в торговых делах не столь высок, чтобы управляться с таким объёмом. Советую вам набраться ещё немного опыта и вернуться ко мне, когда будете готовы к большим паритиям. Тогда, глядишь, и обсудим дело основательно.";
				link.l1 = "Хорошо. Вернемся к этому вопросу позднее.";
				link.l1.go = "oil_trade_exit";
		...
		case "UpgradeOil_1":
			dialog.text = "Сеньор"+GetSexPhrase("","ита")+", я понимаю вашу обеспокоенность. Но вы же знаете, безопасность никогда не бывает дешёвой, особенно когда речь идёт о таком редком товаре. К тому же, я не только гарантирую вам отсутствие утечек, но и готов предложить скидку, которая со временем компенсирует ваши вложения. Разве это не разумный компромисс?";
			link.l1 = "Признаю: в нашем деле надёжность и тайна стоят дорого и скидка делает нашу потенциальную сделку несколько приятней. Но все же, три тысячи дублонов, это непомерно большая сумма. Возможно вы сможете немного уменьшить её размер?";
			link.l1.go = "UpgradeOil_2";
		break;
		
		case "UpgradeOil_2":
			dialog.text = "Сожалею, но в таких делах полумеры недопустимы. Либо мы обеспечиваем полную защиту, либо рискуем всем. Сумма остаётся прежней, и лишь так я могу гарантировать надёжность и конфиденциальность. Вы же не хотите, чтобы сначала за мной, а потом и за вами гонялся весь королевский флот?";
			if (PCharDublonsTotal() >= 3000)
			{
				link.l1 = "Хорошо, сеньор Сальдо, убедили. Безопасность и надёжность стоят своих денег. Три тысячи дублонов. Получите.";
				link.l1.go = "UpgradeOil_Agreed";
			}
			link.l2 = "Сеньор Сальдо, вы убедили меня в необходимости этих мер. Однако три тысячи дублонов - сумма серьёзная, и в данный момент у меня её нет. Придётся немного подождать, пока я соберу нужное количество.";
			link.l2.go = "UpgradeOil_4";
			link.l3 = "За такие деньжищи можно и целый флот подкупить, и всех солдат на континенте, не то что наемников для скромного груза смолы! Извините, но я не могу согласиться на подобное предложение. Оставим всё, как есть, без излишеств и дополнительных затрат.";
			link.l3.go = "UpgradeOil_3";
		break;
		
		case "UpgradeOil_Agreed":
			dialog.text = "Ну что ж, сеньор"+GetSexPhrase("","ита")+", вижу, что доверие у нас взаимное. Будьте уверены: дело будет устроено как надо. Теперь к деталям: 300 бочек смолы, как обычно, 5-го числа каждого месяца будут ждать вас здесь, на маяке Тринидада. Выкупить всю партию вы сможете за 2550 дублонов.";
			link.l1 = "Великолепно, сеньор Сержио. Не подведите меня.";
		...
		case "UpgradeOil_Agreed_1":
			dialog.text = "Не сомневайтесь, сеньор"+GetSexPhrase("","ита")+". Всё будет организовано на высшем уровне, и наш общий труд принесёт плоды.";
			link.l1 = "До встречи.";
			link.l1.go = "oil_trade_exit";
		break;
		...
		case "UpgradeOil_4":
			dialog.text = "Приходите когда у вас будет вся сумма целиком. Буду рад заключить с вами новую сделку.";
			link.l1 = "Хорошо.";
			link.l1.go = "oil_trade_exit";
			pchar.questTemp.SergioOilBlock = true;
	...
	// <-- генератор смол
		...
		case "Juan_abordage_1":
			if (CheckAttribute(pchar, "questTemp.Consumption.House"))
			{
				...
				link.l1 = "Золото? Я с самого начала ввязал"+GetSexPhrase("ся","ась")+" в это дело не ради денег, Хуан. Прикончить такую мерзость как ты - сама по себе награда.";
		...
		case "Juan_abordage_3":
			dialog.text = "А у тебя есть хватка, "+GetSexPhrase("приятель","подруга")+"... держи, это всё, что у меня есть - небольшая плата за жизнь, если вдуматься, да?";
			link.l1 = "За твою жизнь я бы не дал"+GetSexPhrase("","а")+" и пистолетной пули, так что это самая выгодная моя сделка. Катись к чертям.";
		...
		case "Waitress":
			...
			link.l1 = "Я ничего не смог"+GetSexPhrase("","ла")+" сделать - увы! Мне жаль. Прощайте!";
		...
		case "Waitress_2":
			...
			link.l2 = "Я сделал"+GetSexPhrase("","а")+" то, что подсказывал мне долг - только и всего.";
		...
		case "Waitress_5":
			if (CheckAttribute(pchar, "questTemp.Consumption.KillJuan"))
			{
				dialog.text = "Вы настоящ"+GetSexPhrase("ий","ая")+" "+GetSexPhrase("рыцарь","валькирия")+"! "+GetSexPhrase("Кабальеро","Сеньорита")+"! Вот, не сочтите за оскорбление, но я хочу, чтобы вы взяли их - я собрала эти деньги на выкуп за Анджело, но теперь это уже не важно! Не вздумайте отказываться - примите их!";
			...
			{
				dialog.text = "Вы настоящ"+GetSexPhrase("ий","ая")+" "+GetSexPhrase("рыцарь","валькирия")+"! "+GetSexPhrase("Кабальеро","Сеньорита")+"! Я расскажу всем! И буду помнить вас всегда-всегда!";
