void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "FalseTrace":
			...
			link.l1 = "Хех! Неплохо заработать? Очень интересно. Я готов"+GetSexPhrase("","а")+" вас выслушать, Адам.";
		...
		case "FalseTrace_exit":
			dialog.text = "Доверия? Ха-ха! Судить о человеке по его физиономии - неблагодарное дело, капитан. Впрочем, чёрт с вами. Вы упустили прекрасную возможность легко и быстро заработать. Я без труда найду другого, более сговорчивого...";
			link.l1 = "Всё, разговор окончен, сударь. Всего доброго!";
		...
		case "FalseTrace_1":
			...
			dialog.text = "Кха! Приятно иметь дело с быстро мыслящим человеком, капитан... Суть дела такова: буквально на днях из одного порта должен выйти галеон с приличным грузом серебра. Корабль пойдёт один, без охранения - такая вот глупость, хе-хе\nЗахватить его - плёвое дело. Я сообщаю вам, откуда и куда идёт корабль, вы его захватываете, я получаю свою долю. Всё просто.";
			link.l1 = "И вы, конечно, хотите получить её наличными прямо сейчас?";
			link.l1.go = "FalseTrace_2";
		break;
		
		case "FalseTrace_2":
			dialog.text = "Я что, похож на мелкого жулика, кэп? Нет. Я поднимусь на борт вашей посудины и мы вместе пойдём искать добычу. Отсиживаться во время боя в трюме я не стану - я прошу назначить меня в абордажную команду офицером, временно, конечно\nУмений владеть саблей и пистолем мне не занимать. Так что разделю с вами все опасности пути... кхе... кха! А после того, как захватим галеон, вы выдадите мне мою долю серебром.";
		...
		case "FalseTrace_5":
			dialog.text = "Галеон называется '"+pchar.questTemp.FalseTrace.ShipName+"', выходит из Картахены и направляется в колонию "+XI_ConvertString("Colony"+pchar.questTemp.FalseTrace.TargetCity)+". Времени у нас немного, не больше двух-трёх недель. Если не отыщем за эти дни - значит, прозевали.";
		...
		case "FalseTrace_7":
			...
			link.l1 = "Думаю, для тебя это не было неожиданностью... Где серебро, чёрт возьми?! Где серебро?! Я тебя спрашиваю! Капитан галеона заявил, что это просто фуражное военное судно! Ты обманул меня!";
			link.l1.go = "FalseTrace_8";
		break;
		
		case "FalseTrace_8":
			dialog.text = "Капитан, прошу вас, успокойтесь. Я вам сейчас постараюсь всё объяснить.";
			link.l1 = "Да, да! Я уже споко"+GetSexPhrase("ен","йна")+"! Ты до сих пор не болтаешься на нок-рее лишь потому, что я не могу понять мотивов твоего странного поступка - ты сам отправился со мной на охоту за этим галеоном, зная, что у него в трюмах нет никакого серебра. Так что уж изволь объясниться.";
			link.l1.go = "FalseTrace_9";
		break;
		
		case "FalseTrace_9":
			dialog.text = "Я именно это и хочу сделать, кэп. Да, я действительно обманул вас. Но в противном случае я бы никогда не смог убедить вас сделать то, что мне нужно, а именно - захватить... кхе... кха! Захватить этот треклятый галеон\nНо обещаю, что в долгу я не останусь, и сполна расплачусь за вашу помощь. Теперь к сути вопроса - зачем мне это было нужно. Вы нашли на галеоне женщину? Я видел, как матросы вели её на ваше судно...";
		...
		case "FalseTrace_10":
			dialog.text = "Это моя жена. Катерина Рейнер. Она сбежала от меня три месяца назад с этим капитанишкой. Я приложил все усилия, чтобы разыскать их, и нашёл. Они направлялись вдвоём в "+XI_ConvertString("Colony"+pchar.questTemp.FalseTrace.TargetCity)+". Более удобного случая одновременно и вернуть Катерину, и расквитаться с подлым похитителем чужих жён трудно было и представить\nЕсли бы я сказал вам правду, вы бы плюнули мне в глаза, развернулись и ушли - какое вам дело до моих семейных проблем? А представив галеон в виде богатой добычи, у меня был шанс, что вы согласитесь.";
			link.l1 = "Хех! Значит, жена сбежала от вас? Очень интересно...";
			link.l1.go = "FalseTrace_11";
		break;
		
		case "FalseTrace_11":
			dialog.text = "Это моя законная жена, и я люблю её, и никто, кроме меня, не имеет права быть с ней! Этот прохвост навешал ей лапши на уши, напел красивых сказок про романтику и прочее, пока я был на дел... в отъезде. А вы разве не знаете этих женщин? Поверила ему, глупышка, и сбежала с ним в море.";
		...
		case "FalseTrace_12":
			...
			dialog.text = "Вы не ослышались, капитан. Услуга за услугу. Денег у меня нет, но если вы отвезёте меня с Катериной в "+XI_ConvertString("Colony"+pchar.questTemp.FalseTrace.QuestCity)+", я сообщу вам на этот раз совершенно достоверную информацию, где можно без малейшего труда разжиться золотишком.";
			link.l1 = "Очень интересно. А почему бы вам не выдать мне эту 'достоверную информацию' прямо сейчас?";
			link.l1.go = "FalseTrace_13";
		break;
		
		case "FalseTrace_13":
			dialog.text = "Потому что я ей ещё не располагаю. Позвольте объяснить подробно. Один джентльмен удачи, по имени Косой Солли - не слыхали о таком? - за день до нашего с вами отплытия отправился с отрядом из Блювельда вглубь континента, чтобы хорошенько пощипать золотые рудники\nУ берегов Мэйна его должно было встретить судно, когда он будет возвращаться с добычей, но по определённым причинам этого не произойдёт, и Косой Солли будет вынужден пешком отправиться в Блювельд или Белиз - не знаю, куда ближе, за кораблём, чтобы погрузить награбленное\nЕстественно, золото он через джунгли не потащит и спрячет в какой-нибудь бухте и поставит небольшую охрану. У него в отряде есть мой человек. Он будет ждать меня в городе "+XI_ConvertString("Colony"+pchar.questTemp.FalseTrace.QuestCity)+". Как только мы бросим якорь в порту, он и сообщит мне, в какой бухте Косой Солли спрятал награбленное добро\nВы пойдёте туда, без труда вырежете его бандитов и заберёте себе золото. Я сам собирался сделать это, но учитывая обстоятельства, полностью отдаю это дело вам, и даже не прошу себе ни песо.";
			link.l1 = "Что-то ваша история попахивает очередным 'галеоном с серебром'. Один раз вы меня уже обманули. Где гарантии, что вы и сейчас не лжёте?";
		...
		case "FalseTrace_15":
			dialog.text = "Не затягивайте, капитан. Косой Солли в конце-концов вернётся за своим добром, как вы понимаете. По моим расчётам, у вас не больше двух недель, чтобы добраться до "+XI_ConvertString("Colony"+pchar.questTemp.FalseTrace.QuestCity+"Gen")+".";
		...
		case "FalseTrace_18":
			dialog.text = "Вот как? Я подозревал, что вы так сделаете, кэп. Особенно после того, как увидел, что вы пошли в трюм, беседовать с этим гнусным похитителем чужих жён. Решили встать на его сторону, так, кэп?";
			link.l1 = "Не твоё дело. Ты использовал меня, подставил и пытаешься обмануть сказками про какие-то сокровища! Боцман, взять его!";
			link.l1.go = "FalseTrace_19";
		break;
		
		case "FalseTrace_19":
			dialog.text = "Кха! Не так быстро, капитан... Боцман и ваши люди ещё не скоро смогут сюда войти. Вы не заметили, что я запер дверь? Теперь мы здесь вдвоём - вы и я. Покажите-ка кэп, на что вы способны!";
			link.l1 = "Ах вот как? Ну, держись, пёс!";
		...
		case "FalseTrace_23":
			...
			dialog.text = "Благодарю вас, кэп, что помогли мне вернуть мою жену! Адам Рейнер у вас в долгу, и он этого не забудет, ха-ха, клянусь... кха! Треклятые рудники... Теперь о Косом Солли. Мой человек уже всё сообщил мне. Солли оставил награбленное золото в гроте залива Сан-Хуан-дель-Норте под охраной своих головорезов, а сам отправился за кораблём в Блювельд\nВам следует поторопиться - у вас в запасе не больше пяти дней, по расчётам моего товарища. Возьмите с собой людей на высадку - бандиты Солли отчаянные ребята, и так просто своего не отдадут. Но проблем всё равно не будет - я видел, как вы лихо управились с галеоном\nА теперь нам пора проститься. Спасибо ещё раз и - удачи, кэп!";
		...
		case "FalseTrace_24":
			pchar.quest.FalseTraceSollyOver.over = "yes"; //снять таймер
			dialog.text = "Кха! Капитан, какого чёрта мы высадились в этой бухте? Я же сказал вам - мой человек ждёт меня в порту "+XI_ConvertString("Colony"+pchar.questTemp.FalseTrace.QuestCity+"Gen")+"! Или вы решили топать до города пешком через джунгли?";
			link.l1 = "Не угадал, Адам. Неужели ты думал, что я поверю твоим россказням и во второй раз? Ты меня за "+GetSexPhrase("дурака","дуру")+" держишь? На этот раз я заключил"+GetSexPhrase("","а")+" сделку с твоей женой.";
			link.l1.go = "FalseTrace_25";
		break;
		
		case "FalseTrace_25":
			dialog.text = "Что-о?! Кха! Какую ещё сделку с моей женой? Ты что городишь, рыбья чешуя?";
			link.l1 = "По твоей фальшивой наводке я захватил"+GetSexPhrase("","а")+" пустой галеон и убил"+GetSexPhrase("","а")+" его капитана. Я сожалею, что сделал"+GetSexPhrase("","а")+" это, хотя уже поздно. Твоя жена, как я понял"+GetSexPhrase("","а")+", любила этого моряка. Поэтому она заказала тебя. Мне. Вот почему мы здесь втроём, в этой бухте.";
			link.l1.go = "FalseTrace_26";
		break;
		
		case "FalseTrace_26":
			dialog.text = "Ушам не верю! Катерина... вот ведь маленькая дрянь! Ну доберусь я ещё до тебя... И чем же она пообещала расплатиться с тобой, ты, "+GetSexPhrase("олух","балда")+"? У неё нет ни гроша, даже украшения свои, которые я ей дарил, она продала, чтобы сбежать с этим капитанишкой!";
			link.l1 = "Не твоё собачье дело, прохвост. Пора заканчивать наш разговор. Теперь я отправлю тебя в ад, где тебе самое место!";
			link.l1.go = "FalseTrace_27";
		break;
		
		case "FalseTrace_27":
			dialog.text = "Ну что же, посмотрим, что ты стоишь, тухлая селёдка!";
			link.l1 = "...";
		...
		DeleteAttribute(pchar, "GenQuest.SeaHunter2Pause"); // вертаем морских ОЗГов
			dialog.text = "Аргх! Какого чёрта ты напал"+GetSexPhrase("","а")+" на мой корабль, мерзав"+GetSexPhrase("ец","ка")+"? Вообще в толк не возьму...";
			link.l1 = "Не притворяйся овечкой, капитан. Мне стало известно о грузе, который ты везёшь. Он-то мне и нужен.";
			link.l1.go = "FalseTrace_abordage_1";
		break;
		
		case "FalseTrace_abordage_1":
			dialog.text = "Грузе? Ха-ха! Какой груз ты ожидал"+GetSexPhrase("","а")+" здесь увидеть? У меня пустые трюмы!";
		...
		case "FalseTrace_abordage_3":
			dialog.text = "Я не знаю, кто сказал тебе о серебре, но это всё полная чушь... Я проиграл абордаж и сдаюсь. Вот моя шпага. Теперь можешь идти смотреть трюмы - они пусты.";
			link.l1 = "Сдаёшься? Ну уж нет! Мне свидетели ни к чему! Поднимай свою железяку и защищайся, или я прирежу тебя, как овцу!";
		...
		case "FalseTrace_wife":
			dialog.text = "Вы убили его, "+GetSexPhrase("негодяй! Мерзавец! Подонок!","негодница! Мерзавка! Тварь!")+" Несчастный "+pchar.questTemp.FalseTrace.CapName+"!";
			link.l1 = "Это ещё что за чудо? Откуда ты взялась, милочка?";
		...
		case "FalseTrace_wife_2":
			...
			link.l1 = "Да мне и руки поднимать не надо будет. Просто выброшу тебя за борт, а там дело довершат акулы... Ну? Чего встала? Топай живо на мой корабль! Не бойся, в обиду тебя я не дам и сам"+GetSexPhrase("","а")+" не трону, если будешь вести себя тихо...";
		...
		case "FalseTrace_wife_5":
			...
			link.l1 = "Послушай, барышня, если бы я хотел"+GetSexPhrase("","а")+" его убить - я уже бы это сделал"+GetSexPhrase("","а")+". А так он пока посидит в трюме, потом, может, я его отпущу или сдам за выкуп... второе более вероятно. А тебя я также попрошу пройти на мой корабль, и не бойся, в обиду не дам и сам"+GetSexPhrase("","а")+" не обижу, если будешь вести себя тихо...";
			link.l1.go = "FalseTrace_wife_3";
		break;
		...
		case "FalseTrace_wife_6":
			...
			{
				dialog.text = "Что вам от меня ещё нужно? Бросить акулам, как вы обещали? Вы разбили мне жизнь, и я...";
				link.l1 = "Полно, милочка. Никто никуда тебя бросать не собирается. Я вообще хочу прояснить ситуацию, поскольку нападением на галеон я обязан"+GetSexPhrase("","а")+" именно тебе, и никому другому.";
			...
			else
			{
				...
				link.l1 = "Так, милочка, давай прекратим этот поток бессмысленных вопросов, я не для того тебя позвал"+GetSexPhrase("","а")+" сюда. Выяснился один факт, который тебе, безусловно, будет интересен.";
				link.l1.go = "FalseTrace_wife_20";
			}
		break;
		
		case "FalseTrace_wife_7":
			dialog.text = "Обязаны мне? Вы хотите сказать, что я виновна в том, что вы напали на наше судно и убили моего... мужчину? Бедный "+pchar.questTemp.FalseTrace.CapName+", что он вам сделал? Не кощунствуйте, вы за всё ответите перед...";
			link.l1 = "Так, ты опять за своё? Нам что, снова вернуться к разговору об акулах?";
			link.l1.go = "FalseTrace_wife_8";
		break;
		
		case "FalseTrace_wife_8"://ноды пересечения - старт
			dialog.text = "";
			link.l1 = "Молчишь? Замечательно. Выслушай же меня наконец! Я совершил"+GetSexPhrase("","а")+" нападение на это судно, потому что у меня были сведения, что оно везёт огромный груз серебра. И сведения эти я получил"+GetSexPhrase("","а")+" от Адама Рейнера.";
			link.l1.go = "FalseTrace_wife_9";
		break;
		
		case "FalseTrace_wife_9":
			dialog.text = "Ах! Что?! Адам? Где он? Неужели здесь?";
			link.l1 = "Вижу, это имя тебе знакомо... Катерина. Как видишь, я уже всё про тебя знаю. Как я понимаю, Адам Рейнер - действительно твой муж?";
		...
		case "FalseTrace_wife_10":
			...
			link.l1 = "В общем, получилось именно так. Адам солгал мне о грузе серебра, чтобы я захватил"+GetSexPhrase("","а")+" галеон '"+pchar.questTemp.FalseTrace.ShipName+"', с очевидной целью вернуть тебя. Четверть часа назад он дал мне полный отчёт о своих действиях...";
			link.l1.go = "FalseTrace_wife_11";
		break;
		
		case "FalseTrace_wife_11":
			dialog.text = "И... что же он хочет? Что он вам сказал?";
			link.l1 = "Он хочет, чтобы его законная жена вернулась к нему. В качестве компенсации за то, что ввёл меня в заблуждение, он обеспечит меня информацией о золоте Косого Солли. Мне только нужно доставить вас обоих в "+XI_ConvertString("Colony"+pchar.questTemp.FalseTrace.QuestCity)+".";
			link.l1.go = "FalseTrace_wife_12";
		break;
		
		case "FalseTrace_wife_12":
			dialog.text = "Нет...(плачет) Я не хочу возвращаться к этому мерзавцу! Я приложила столько сил, чтобы сбежать от него и замести следы, но он всё равно меня нашёл... Негодяй! Бандит! Вор проклятый!";
			link.l1 = "Тише, Катерина, успокойся... Он ведь всё-таки твой муж. И он сказал, что любит тебя.";
			link.l1.go = "FalseTrace_wife_13";
		break;
		
		case "FalseTrace_wife_13":
			dialog.text = "(сквозь слёзы) Мой муж? А вы знаете, кто он, мой муж? Он бывший заключённый, каторжник, а нынче - самый жестокий бандит "+XI_ConvertString("Colony"+pchar.questTemp.FalseTrace.StartCity+"Gen")+"! Он низкое и грубое животное, а я для него - не больше, чем просто... подстилка!";
		...
		case "FalseTrace_wife_14":
			dialog.text = "Поначалу он был другим. А его прошлое казалось мне тогда таким романтичным... Но потом всё изменилось. И я не хочу его теперь даже видеть, не то, что жить с ним, понимаете - не хочу! Особенно после того, как он организовал нападение на галеон!";
		...
		case "FalseTrace_wife_15"://ноды пересечения - конец
			if (CheckAttribute(pchar, "questTemp.FalseTrace.KillCaptain"))
			{
				dialog.text = "Что делать? А я вот знаю, что делать. Вы, благодаря преступным деяниям моего мужа, взяли грех на душу, убили ни в чём не повинного человека... единственного человека, который хорошо ко мне относился... Искупите свою вину, капитан. Убейте Адама. Причём прямо у меня на глазах. Я хочу видеть, как будет умирать эта скотина, я хочу плюнуть на его труп\nА когда он испустит дух, я расскажу вам, где он прячет свои богатства, полученные воровством и грабежами. Он не знает, что мне известен его тайник, ха-ха! Пьяный негодяй проболтался во сне, и даже не вспомнил...";
		...
		case "FalseTrace_wife_16":
			dialog.text = "Не вам говорить о жестокости, капитан. Отправляйтесь в "+XI_ConvertString("Colony"+pchar.questTemp.FalseTrace.QuestCity)+", как вам Адам и сказал, но высадитесь не в порту, а в ближайшей бухте. Там мы втроём выйдем на берег, и вы прикончите мерзавца\nИ я сразу же расскажу вам о тайнике. Клянусь, что не лгу, и богатства Адама действительно существуют. Во всяком случае, поверить мне у вас больше оснований, чем Адаму с его мифическими сокровищами Косого Солли. Неужели вы ему верите? Он обманет вас так же, как обманул в первый раз, как обманывал меня всю нашу совместную жизнь\nЧто скажете, капитан?";
			link.l1 = "Да уж... Недаром говорят: муж и жена - одна сатана. Смотрю я на тебя, Катерина, и вижу, что ты для Адама - самая пара... Если тебе так нужна его смерть, сама зарежь его кинжалом, когда он будет в очередной раз спать, пьяный в стельку, и бормотать о каких-то тайниках... Боцман! Увести её!";
			link.l1.go = "FalseTrace_wife_17";
			link.l2 = "Ненавижу мерзавцев, которые пытаются меня обмануть и использовать в своих целях. Так и поступим, Катерина, ибо Адаму уже нет веры. Но если ты меня обманешь - клянусь, что разыщу тебя даже в Европе, и всажу тебе пулю прямо в лоб. А теперь ступай. Боцман! Увести её!";
		...
		case "FalseTrace_wife_20":
			dialog.text = "Какой ещё факт? Что вы намерены сделать с нами? Зачем вы захватили наше судно?";
		...
		case "FalseTrace_wife_21":
			dialog.text = "Золото Косого Солли? Вы верите Адаму, этому прохвосту? Да он обманет вас, как обманул с этим серебром, как обманывал меня всю нашу совместную жизнь! Вы ничего от него не получите, у него нет ни капли совести! Поговорите с вашим пленником!\n"+pchar.questTemp.FalseTrace.CapName+" - настоящий джентльмен, он не солжёт и не изменит слову!";
			link.l1 = "Не убедила ты меня, барышня. Мне не о чем говорить с твоим капитаном. За него я получу выкуп, а от Адама - золото Солли. А если Адам меня обманет - разыщу хоть на краю света, и он пожалеет, что появился на свет... Боцман! Увести её!";
			link.l1.go = "FalseTrace_wife_23";
			link.l2 = "Сказать честно, к Адаму у меня более нет доверия... Ненавижу, когда меня используют в своих целях. Ладно. Поговорю я с твоим капитаном, послушаем, что он сможет сказать. А ты ступай пока... Боцман! Увести её!";
			link.l2.go = "FalseTrace_wife_24";
		break;
		
		case "FalseTrace_wife_23":
			dialog.text = "Вы "+GetSexPhrase("жестокий, безжалостный человек","жестокое, безжалостное чудовище")+"! Клянусь, что я...";
			link.l1 = "Боцман! Приставить к ней охрану и глаз не спускать до самого "+XI_ConvertString("Colony"+pchar.questTemp.FalseTrace.QuestCity+"Gen")+"!";
			link.l1.go = "FalseTrace_wife_18";
		...
		case "FalseTrace_wife_25":
			dialog.text = "Ну вот и всё... Несчастный "+pchar.questTemp.FalseTrace.CapName+" отомщён, и я наконец-то могу спокойно вздохнуть и назвать себя вдовой...";
			link.l1 = "Я выполнил"+GetSexPhrase("","а")+" свою часть сделки, Катерина. Теперь твоя очередь.";
		...
		case "FalseTrace_wife_28":
			dialog.text = "Наверное, так. Там вы сможете найти много чего... Сами увидите. А теперь всё. Прощайте, капитан.";
			link.l1 = "Подожди... Прости, Катерина, если сможешь, за то, что причинил"+GetSexPhrase("","а")+" тебе зло. Надеюсь, смерть виновника твоих несчастий хотя бы немного облегчит твои страдания. Я искренне сожалею...";
			link.l1.go = "FalseTrace_wife_29";
		break;
		
		case "FalseTrace_wife_29":
			dialog.text = "Мне не нужны ваши сожаления, капитан. Вы сделали, что я вас просила, я рассказала вам всё, что вы хотели. Прощайте, и оставьте меня наедине с моим горем...";
		...
		case "FalseTrace_wife_31":
			dialog.text = ""+GetSexPhrase("Гнусный негодяй","Гнусная негодница")+"! Вы ухитрились убить всех четверых! Невероятно!";
		...
		case "FalseTrace_wife_32":
			...
			link.l1 = "Я говорил"+GetSexPhrase("","а")+" тебе, милочка, что ты поплатишься своей головой, если обманешь меня? Коварная бестия! Мёртвой ты будешь безопаснее. Так что помолись напоследок...";
		...
		case "FalseTrace_wife_33":
			dialog.text = "Это вам нужно молиться, "+GetSexPhrase("изверг","стерва")+"! Убийца! Будьте вы...";
		...
		case "FalseTrace_Bandits":
			dialog.text = "А-а, вот и явил"+GetSexPhrase("ся","ась")+" убийца Адама! Катерина была права - этот гад пришёл разграбить тайник покойного!";
			link.l1 = "Что? Катерина?! Кто вы такие?";
			link.l1.go = "FalseTrace_Bandits_1";
		break;
		
		case "FalseTrace_Bandits_1":
			dialog.text = "Мы? Мы друзья Адама Рейнера, которого ты убил"+GetSexPhrase("","а")+". Он был главой нашего братства. Теперь это место занимаю я, "+GetFullName(npchar)+", и я покараю тебя за убийство моего бывшего босса и товарища, и за насилие, которое ты учинил"+GetSexPhrase("","а")+" над его женой.";
			link.l1 = "Насилие? Что ты мелешь? Какое насилие?";
			link.l1.go = "FalseTrace_Bandits_2";
		break;
		
		case "FalseTrace_Bandits_2":
			dialog.text = "После того, как ты расправил"+GetSexPhrase("ся","ась")+" с Адамом, вероломно убив ударом в спину, ты силой и угрозами выбил"+GetSexPhrase("","а")+" из его жены сведения, где Адам прячет свои сбережения, а затем бросил"+GetSexPhrase("","а")+" несчастную женщину на пустынном берегу на верную смерть\nНо она осталась жива, и пришла к нам за помощью, справедливо рассудив, что злодеяние не должно остаться безнаказанным. Мы уже который день дежурим здесь, ожидая твоего появления. И вот ты "+GetSexPhrase("пришёл, мерзавец","пришла, мерзавка")+"!";
			link.l1 = "Ха-ха! Узнаю Катерину... Слушай, ты, я действительно убил Адама, но сделал это по просьбе его собственной жены - это была месть за смерть её любовника. И за это она и рассказала мне, где находится тайник...";
			link.l1.go = "FalseTrace_Bandits_3";
		break;
		
		case "FalseTrace_Bandits_3":
			dialog.text = "Ты клевещешь на бедную вдову, "+GetSexPhrase("негодяй","негодница")+"! А зачем бы тогда она пришла к нам? Зачем она сказала нам забрать себе всё из тайника Адама, лишь бы мы убили тебя? Ей не нужно золото, ей нужна твоя смерть! Священная месть за смерть мужа!\nНо клянусь, она не умрёт в нищете, и это так же верно, что меня зовут "+GetFullName(npchar)+", и то, что пришёл твой последний час, иуда!";
		...
		case "FalseTrace_Solly_1":
			dialog.text = "Аргх! Ну, это мы ещё посмотрим, кто кого! Ребята, на помощь! К бою!";
		...
		case "FalseTrace_GoldShip":
			dialog.text = "Вы всё сделали, как мы договаривались, капитан. Спасибо, что поверили и пошли навстречу. Насчёт Адама не беспокойтесь - я передам его в надёжные руки и он получит по заслугам.";
			link.l1 = "Адам меня мало волнует. Что там насчёт вашего обещания о неком корабле?";
		...
		case "FalseTrace_GoldShip_1":
			...
			dialog.text = "Да-да, конечно. Так, прикинем начиная от сегодняшнего числа... Ага... Через двенадцать-четырнадцать дней из "+XI_ConvertString("Colony"+pchar.questTemp.FalseTrace.ShipCity+"Gen")+" выйдет тяжёлый галеон с грузом золотой неочищенной руды и отправится в Европу. Его будет охранять судно сопровождения, думаю, корвет или фрегат\nТак что подготовьтесь как следует - добыча богатая, но зубастая. Хотя уверен, вы справитесь - я помню, как лихо вы подавили моё сопротивление... За две недели вам нужно добраться до "+XI_ConvertString("Colony"+pchar.questTemp.FalseTrace.ShipCity+"Gen")+" и устроить засаду\nПомните - ваша цель - тяжёлый галеон с одним кораблём сопровождения. Вот пожалуй и всё... Остальное - в ваших руках.";
			link.l1 = "Понятно... Ну что же, "+pchar.questTemp.FalseTrace.CapName+", прощайте. Наверное, я долж"+GetSexPhrase("ен","на")+" пожелать вам удачи и счастья с Катериной? Надеюсь, у вас всё будет хорошо. Жаль, что мы познакомились с вами при таких печальных обстоятельствах.";
			link.l1.go = "FalseTrace_GoldShip_2";
		break;
		
		case "FalseTrace_GoldShip_2":
			dialog.text = "Спасибо, капитан. Как я уже говорил - вы не лишены чувства благородства. Надеюсь, вы вскоре решите для себя, что честные поступки приносят гораздо больше пользы, нежели бесчестные. Посвятите себя службе во благо вашей державы - из вас выйдет отличный "+GetSexPhrase("военный моряк","капитан")+".";
