...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "noble_3":
			PlaySound("VOICE\Russian\LE\Domingo\Domingo_01.wav");
		...
		case "noble_10":
			...
			link.l1 = "Согласен, сеньор! Идёмте!";
			link.l1.go = "noble_11";
		break;
		...
		case "noble_34":
			PlaySound("VOICE\Russian\LE\Domingo\Domingo_04.wav");
		...
		case "noble_36":
			PlaySound("VOICE\Russian\LE\Domingo\Domingo_05.wav");
