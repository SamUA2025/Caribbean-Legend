...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "seafox":
			...
			PlaySound("VOICE\Russian\LE\SeaFox\SeaFox_01.wav");
		...
		case "seafox_6":
			PlaySound("VOICE\Russian\LE\SeaFox\SeaFox_02.wav");
		...
		case "seafox_9":
			DelLandQuestMark(npchar);
			PlaySound("VOICE\Russian\LE\SeaFox\SeaFox_03.wav");
		...
		case "seafox_12":
			...
			link.l1 = "Говорят, один из ваших пленных проболтался. В обмен на свободу он сдал голландцам план побега. Теперь в Филипсбурге все предупреждены и вас ждут. Воды острова патрулирует военный корвет. Вы в мышеловке, лейтенант.";
		...
		case "seafox_16":
			dialog.text = "Пленников надо освободить. Мы уже позаботились о маскировке - мой отряд одет в голландскую форму. Если бы не предательство... мы бы запросто проникли в тюрьму, уложили охрану, и всё было бы сделано. Но в тюрьме наверняка будет засада. Поэтому придётся воспользоваться дополнительными ресурсами... Капитан, вам надо отправиться в Филипсбург, в местную церковь, и найти там служку по имени Филип Якобсен. Это надо сделать с шести до десяти утра, так как потом в церкви его не найти. Филип - наш человек\nСкажете ему пароль: 'Давно ли была исповедь пленных моряков', затем обрисуете ситуацию и от моего имени потребуете помощи. Потом принесёте его ответ мне. Как видите - ничего сложного или опасного для вас.";
		...
		case "seafox_25":
			PlaySound("VOICE\Russian\LE\SeaFox\SeaFox_04.wav");
		...
		case "seafox_35":
			PlaySound("VOICE\Russian\LE\SeaFox\SeaFox_05.wav");
		...
		case "monk":
			...
			dialog.text = "Чем я могу помочь тебе, "+GetSexPhrase("сын мой","дочь моя")+"?";
			link.l1 = "Я бы хотел узнать, давно ли была исповедь пленных моряков.";
			link.l1.go = "monk_1";
		break;
		
		case "monk_1":
			dialog.text = "Вчерашним вечером, "+GetSexPhrase("сын мой","дочь моя")+". Ч-ш-ш... Говори тише... (шёпотом) Полагаю, вы уже в курсе, что было совершено предательство, и вас ждут?";
		...
		case "monk_repeat":
			dialog.text = "Ты принёс две дюжины дублонов, "+GetSexPhrase("сын мой","дочь моя")+"?";
			if (PCharDublonsTotal() >= 24)
			{
				link.l1 = "Да. Держите.";
				link.l1.go = "monk_4";
		...
		case "monk_6":
			...
			dialog.text = "Приветствую тебя, "+GetSexPhrase("сын мой","дочь моя")+".";
