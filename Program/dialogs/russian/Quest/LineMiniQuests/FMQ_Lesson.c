...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "greguar":
			PlaySound("VOICE\Russian\LE\Greguar\Greguar_04.wav");
		...
		case "greguar_1":
			dialog.text = "Верно. Буду краток, поскольку время не терпит. Итак: голландская коронная эскадра, следовавшая из Бразилии на Кюрасао с грузом стратегических товаров для Вест-Индской торговой Компании, попала в засаду англичан между Тринидадом и материком. Один флейт Компании сумел выскользнуть из боя и причалить к берегу в бухте Бока де ла Сьерпе, и тем самым спас свой груз. Ненадолго. Их атаковало местное племя индейцев\nПо моей информации, голландцев всех вырезали, а груз был унесён в деревню. Индейцы захватили голландское оружие, но понесли серьёзные потери. Это наш шанс! Англичане с голландцами всё ещё бодаются друг с другом в том районе, и им не до потерянного флейта. Пока что... У вас есть корабль и люди. Мы можем проскочить, высадиться и добить индейцев. Груз крайне ценен и его приличное количество\nЯ высадил там небольшую экспедицию для разведки - всё те же проблемы с деньгами, и на большее я не смог выделить ресурсов. У меня есть надёжный покупатель, к вашим услугам моя шпага и отряд наёмников на берегу. Добычу делим пополам. У нас есть неделя. Вы в деле?";
			link.l1 = "Простите меня, месье, но я не готов. Я только что из тяжёлого похода и не смогу подготовиться за такой короткий срок. Даже в этом Богом забытом регионе человек не может иметь всё.";
			link.l1.go = "greguar_exit";
			link.l2 = "Похоже, это серьёзное дело, сулящее недурственные барыши! Я с вами. Не будем медлить!";
			link.l2.go = "greguar_2";
		break;
		
		case "greguar_exit":
			dialog.text = "Жаль. Ну дело ваше. Удачи вам, месье, а я всё-таки отправлюсь туда. Надо ведь попытаться, верно? Прощайте.";
		...
		case "greguar_2":
			dialog.text = "Правильное решение, мой друг! Вперёд, деньги вам не помешают, верно? Кстати, как поживает ваш брат?";
		...
		case "greguar_4":
			PlaySound("VOICE\Russian\LE\Greguar\Greguar_05.wav");
			dialog.text = "Чёрт бы их побрал этих краснокожих! Они нас чуть не смяли! Ну теперь уж точно, у них в деревне остались только женщины и дети! Вперёд!";
		...
		case "greguar_5":
			PlaySound("VOICE\Russian\LE\Greguar\Greguar_06.wav");
		...
		case "greguar_11":
			...
			link.l1 = "Но какой ценой! Вы посмотрите - полегли почти все из нашего отряда. Надо уходить, Грегуар, нет никаких гарантий, что в логове карибов нас не ждут ещё бойцы. Да и нет людей, чтобы забрать груз. ";
			link.l1.go = "greguar_12";
		break;
		
		case "greguar_12":
			dialog.text = "Карамба!! Как это ни печально, но вы правы, "+pchar.name+": даже если дикарей больше нет, мы не утащим груз до высадки голландцев или англичан. А так хорошо всё начиналось! Уходим! Будь проклят этот злосчастный берег!";
			link.l1 = "...";
			link.l1.go = "greguar_10";
		break;
		
		case "greguar_13":
			dialog.text = "Фух! Мы сделали это! Отличная работа, "+pchar.name+"! Теперь вперёд, в логово дикарей, за товарами! Больше нас уже никто не остановит!";
			link.l1 = "Поторопимся! Англичане и голландцы скоро выяснят, кто из них сильнее, и тогда нам несдобровать. Вперёд!";
		...
		case "greguar_15":
			...
			link.l1 = "Дело что надо... Груз надо продавать, и делать это безопасно, иначе за контрабанду мой долг Пуанси ещё вырастет. Хорошо, буду сегодня в полночь в указанном месте.";
		...
		case "greguar_17":
			...
			dialog.text = "Всё готово, товары сгружены, порученцы клиента прибыли. Идёмте договариваться.";
			link.l1 = "...";
		...
		case "greguar_20":
			...
			link.l1 = "Нет. Точнее, да! Какого чёрта?!";
			link.l1.go = "greguar_21";
		break;
		
		case "greguar_21":
			dialog.text = "Не передразнивайте покойника, месье. Где ваши манеры?.. Деньги получены, груз при мне и моих друзьях. Я не стал их посылать на тот пляж, это было бы расточительством. Особенно посылать туда Джонни. Это тот краснокожий парень с кулевриной в руках. Джонни не очень любил своё племя, знаете ли.";
			link.l1 = "Так... И что теперь? Убьёте и меня?";
			link.l1.go = "greguar_22";
		break;
		
		case "greguar_22":
			dialog.text = "Стоило бы. Но я сентиментален. Уходите и берите четверть денег. Груз и всё остальное останется при мне. И не пытайтесь играть в героя, это не те джунгли на материке. Шансов у вас нет.";
			...
			link.l2 = "В героя играть не буду. Я просто вас всех убью. Тебя первым, потом обезьяну с гранатомётом, а потом и этих девочек.";
			link.l2.go = "greguar_25";
		break;
		
		case "greguar_23":
			dialog.text = "На этом пляже нет ни благородных, ни бандитов, месье! Есть только пять человек, большая пушка и жертва. Такое здесь происходит постоянно, но вы сделали единственный правильный выбор. Моё почтение. А вы знаете, что на вашем месте могли бы быть два других человека? Почти таких же, как вы? Но вы здесь, а они нет, и мне кажется, что они погибнут из-за этого.";
			link.l1 = "Я не понимаю...";
			link.l1.go = "greguar_24";
		break;
		
		case "greguar_24":
			dialog.text = "Потом поймёте. Они не получили свой последний урок. А вы - да. И не благодарите. Прощайте, месье. Добро пожаловать на Карибы!";
			link.l1 = "...";
			link.l1.go = "exit";
		...
		case "greguar_25":
			dialog.text = "Вы не самый способный ученик. Ну что же... каждому - своё.";
			link.l1 = "...";
			link.l1.go = "exit";
		...
		case "prosper":
			dialog.text = ""+GetFullName(pchar)+"! И вы здесь! И почему я не удивлён! Вы чертовски вовремя, мой друг. Мы еле избежали орды карибов, они бежали в вашем направлении и, судя по вашему виду, вы с ними уже познакомились.";
			link.l1 = "Проспер! А вот я удивлён! Опять дырявите индейцев? Надеюсь, у Селины всё хорошо?";
			link.l1.go = "prosper_1";
		break;
		
		case "prosper_1":
			dialog.text = "Чёрт меня дёрнул ввязаться в эту историю - не знаю, увидит ли меня моя дочь снова. Селина? Сидит дома и всё вздыхает о вас! У хлыщей с Мартиники, похоже, теперь нет даже шансов... Вы знаете, я даже уже не жалею, что купил этот мушкет. Хорошая вещь, надёжная. И лишний повод поучаствовать в самоубийственном предприятии, хотя, с вашим появлением, оно стало чуть менее самоубийственным. Логово карибов в двух шагах, но наши проблемы только начинаются.";
			link.l1 = "";
			link.l1.go = "prosper_2";
		break;
		...
		case "prosper_3":
			dialog.text = "Почти всех. Наш разведчик словил пулю, но добрался до берлоги карибов. Сюда идёт вождь со своей охраной! И у них голландские мушкеты. Их больше нас, и они в ярости. Вождь - лучший боец племени, а его люди - те ещё дьяволы. Надо срочно решать, что делать: дать бой или бежать. Второе мне нравится больше, если быть честным.";
			link.l1 = "";
		...
		case "prosper_5":
			dialog.text = "Вы не видели их, уважаемый! У этих 'дикарей' - мушкеты, и они на удивление хорошо ими пользуются! Их явно в своё время кто-то обучил! Не вам говорить мне о трусости!";
			link.l1 = "Так, давайте все успокоимся и решим, что делать. Время ещё есть.";
		...
		case "prosper_6":
			...
			if (n > 2 && GetSummonSkillFromName(pchar, SKILL_SNEAK) > 30)
			{
				...
				link.l1 = "Мы дадим бой, парни! Там, за холмом, нас ждут деньги и товары! Мы здесь ради них, и мы не уйдём. Какая-то кучка краснокожих дикарей, пусть даже с мушкетами, нас не остановит! Давайте похороним этих ублюдков и закончим работу! У нас достаточно людей, и у нас есть шанс застать их врасплох. Устроим засаду. Четверо бойцов встретят их огнём с флангов на подходе, а мы заляжем тут. Проредим их и добьём. Разом и все вместе!";
				link.l1.go = "prosper_8";
			}
			else
			{
				notification("Недостаточно развит навык (31)", SKILL_SNEAK);
				notification("Недостаточно людей", "X");
				if (n > 0)
				{
					link.l1 = "Мы дадим бой, парни! Там, за холмом, нас ждут деньги и товары! Мы здесь ради них, и мы не уйдём. Какая-то кучка краснокожих дикарей, пусть даже с мушкетами, нас не остановит! Давайте похороним этих ублюдков и закончим работу!";
					link.l1.go = "prosper_7";
				}
				else
				{
					link.l1 = "Силы слишком неравны, а за спиной ещё голландцы и англичане. Мы должны уходить - не вижу смысла сложить здесь головы. В следующий раз дело будет наше. Не последний поход же!";
		...
		case "prosper_12":
			sTemp = "";
			if (CheckAttribute(pchar, "questTemp.FMQL.PirateDead")) sTemp = "Жаль этого парня, хоть он и пират.";
			dialog.text = "Джонни проболтался. Это тот краснокожий на песке. Он зашёл в бордель и попытался снять девку. Ему отказали, ну он и начал орать, мол, скоро будет богат, только сначала сходит в джунгли и с дружками грохнет какого-то капитана. Я всё сразу понял и бросился к вашему офицеру, который тоже успел прославиться на весь город. "+sTemp+" Я у вас в долгу, "+pchar.name+", так что не благодарите.";
			link.l1 = "И всё же благодарю тебя, Проспер! Тут было слишком жарко... Хочешь пойти ко мне в команду? Мне нужен такой офицер, как ты. Верных людей сложно найти, а верных стрелков ещё сложнее.";
			link.l1.go = "prosper_13";
		break;
		
		case "prosper_13":
			dialog.text = "Нет, друг мой. У меня есть обязательства перед дочерью. Она заставила меня поклясться, что я завяжу с этими авантюрами. Эта была последняя. Жаль, чёрт побери, но дочь свою я люблю больше всего на свете. Прощайте, "+pchar.name+". И... Селина о вас постоянно говорит. Может, зайдёте к нам как-нибудь?";
			link.l1 = "Может и зайду, как знать... Прощайте, Проспер! Мир вашему дому... (сам себе) Урок усвоен, месье Грегуар. Как ты там сказал? Каждому - своё? Надо запомнить.";
		...
		case "contra":
			DelLandQuestMark(npchar);
			dialog.text = "Вы кто такие, чёрт побери?!";
		...
		case "contra_1":
			...
			link.l1 = ""+FindRussianQtyString(sti(pchar.questTemp.FMQL.Sanl))+" бакаута, "+FindRussianQtyString(sti(pchar.questTemp.FMQL.Silk))+" шёлка, "+FindRussianQtyString(sti(pchar.questTemp.FMQL.Rope))+" канатов и "+FindRussianQtyString(sti(pchar.questTemp.FMQL.Oil))+" смол.";
			link.l1.go = "contra_2";
		break;
		...
		case "contra_2":// Addon 2016-1 Jason пиратская линейка
			...
			dialog.text = "Отлично. Бакаут - 2200 песо за штуку, смолы - 900 песо за бочонок, шёлк - 1600 песо за рулон, канаты - 1000 песо за бухту. Всего это получается... так-так... "+iTotalTemp+" песо. По рукам?";
			link.l1 = "По рукам!";
			link.l1.go = "contra_3";
		break;
		...
		case "contra_3":
			...
			dialog.text = "Превосходно! Приносите ещё. Голландцы всегда будут рады подбросить краснокожим ещё подарок... А это ещё что за гости? Какого чёрта?!";
			link.l1 = "";
			link.l1.go = "contra_4";
		break;
		...
		case "FMQL_beach_1":
			dialog.text = "Простите, кэп. После этой истории с индейцами мне надо было выпить. А там ещё была эта девка, за сто песо я снял комнату, а она, она...";
		...
		case "FMQL_beach_2":
			...
			dialog.text = "Нет! Влюбилась! Проклятье, надо было валить оттуда! Но тут врывается ваш знакомый и орёт, что эта падаль, компаньон бывший, хочет вас облапошить и грохнуть.";
			...
			{
				link.l1 = "Проспер... Прости меня. Я позабочусь о твоей дочери. Урок усвоен, месье Грегуар... Как ты там сказал? Каждому - своё? Надо запомнить.";
				link.l1.go = "FMQL_beach_3";
			}
		break;
		...
		case "FMQL_beach_3":
			...
			link.l1 = "Да. Спасибо за службу. Больше не пей, мы спасём тебя от той красотки. Уходим.";
