	...
	switch(Dialog.CurrentNode)
	{
		...
		if (CheckAttribute(pchar, "questTemp.HWIC.Holl"))
		{
			...
			if (pchar.questTemp.HWIC.Holl == "MerdokDie")
			{
				...
				link.l1 = "Да. Он и его сообщник уничтожены. Мне пришлось выдержать нелёгкий бой, но всё-таки я одолел их.";
				link.l1.go = "Merdok_4";
				DelLandQuestMark(npchar);
				break;
			}
...
//----------------------------------------------задание 1а--------------------------------------------	
		...
		case "SantiagoTrip_2":
			sld = characterFromId("Santiago_usurer");
			dialog.text = "Я не стану объяснять вам сложившуюся ситуацию, однако учтите - дело касается не только моих интересов, но и всей Компании, поэтому вы действительно можете оказать нам большую услугу\nОтправляйтесь на Кубу, в город Сантьяго и вручите этот пакет прямо в руки дону " + GetFullName(sld) + ". Он крупный чиновник в банке Джеральди, и мой... наш деловой партнёр. Кроме прочего, ему необходимо передать золото, которое я вам вручу. Полагаюсь на вашу честность, капитан.";
		...
		case "SantiagoTrip_3":
			...
			link.l1 = "Так есть ещё что-то? Почему вы предупреждаете меня, минхер Роденбург?";
...
//----------------------------------------------3 задание-------------------------------------------------
		...
		case "Fleetwood_complete_5":
			dialog.text = "Не расстраивайтесь, капитан. У меня есть и чем вас порадовать. Я назначаю вас капитаном моей шебеки 'Мейфенг' вместо Лонгвэя. Вы можете пользоваться этим кораблём по своему усмотрению, в разумных пределах, конечно. И жду вас завтра в резиденции губернатора - вы представлены к государственной награде. Не покидайте город, капитан.";
...
//-------------------------------------------5 задание-------------------------------------------------
		...
		case "Merdok_book":
			dialog.text = "Отлично! Теперь он не достанется англичанам. Вы в очередной раз подтвердили то, что вы лучший... Дайте эту книгу мне...";
			link.l1 = "";
		...
		case "Merdok_book_2":
			dialog.text = "(после осмотра) Как прикажете это понимать, капитан? В архиве отсутствует несколько страниц. Самых важных для меня. Думали, я не стану проверять, чтобы вы потом могли воспользоваться ими против меня? Или хотели выторговать за него побольше? Спешу разочаровать в обоих случаях.";
			if (IsCharacterPerkOn(pchar, "Trustworthy"))
			{
				notification("Вызывающий доверие", "Trustworthy");
				link.l1 = "(Вызывающий доверие) Прошу прощения, я виноват, но лишь в том, что не проверил архив сам, заранее.";
			...
			else
			{
				...
				link.l1 = "Минхер Роденбург, стал бы я вырывать страницы, а потом отдавать вам архив с невозмутимым видом?";
		...
		case "Merdok_book_3":
			dialog.text = "Жадность, глупость и наглость порой толкают людей на самые безумные поступки, капитан.";
			link.l1 = "Ничто из этих трёх мною не руководило, уверяю вас.";
			link.l1.go = "Merdok_book_4";
		break;
		
		case "Merdok_book_4":
			dialog.text = "Значит, ван Мерден заранее вырвал и положил эти страницы в другое место, это вы пытаетесь мне сказать?";
			link.l1 = "Верно. Я мог бы вернуться и поискать их, перевернув вверх дном всю аптеку или даже весь Сент-Джонс, если считаете нужным.";
			link.l1.go = "Merdok_book_5";
		break;
		
		case "Merdok_book_5":
			dialog.text = "Не стоит, сударь. Здесь практически всё, и, несмотря на их ценность для меня, без остального архива те страницы ничем мне не угрожают.";
			link.l1 = "";
			link.l1.go = "Merdok_book_6";
		break;
		
		case "VD_Merdok_book_3":
			dialog.text = "Значит, это недостаток внимательности или любопытства, а не ума или честности? Полагаете, он уже таким был, когда вы нашли его?";
			link.l1 = "Скорее всего, господин Роденбург. Возможно, ван Мерден вырвал эти самые страницы и перепрятал. Жаль, что теперь их не найти...";
			link.l1.go = "VD_Merdok_book_4";
		break;
		
		case "VD_Merdok_book_4":
			dialog.text = "Возможно, оно и к лучшему - так эти листки навряд ли смогут нанести мне хоть малейший вред. Особенно в несведущих руках.";
			link.l1 = "";
		...
		case "Merdok_book_6":
			dialog.text = "За найденный архив вам положена награда - вот этот отличный мушкет. Он верой и правдой служил мне - пусть теперь послужит и вам!";
			link.l1 = "Спасибо!";
			link.l1.go = "Merdok_6";
		...
		case "Merdok_8":
			...
			link.l2 = "Обязательно, минхер. Желаю вам счастья в вашей новой жизни!\n(сквозь зубы) ... надеюсь, больше не свидимся, самодовольный ты ублюдок.";
...
//----------------------------------------------за Англию------------------------------------------------------
		...
		case "Lucas_abordage_1":
			...
			// belamour legendary edition -->
			link.l2 = "Ох, ну тогда мне нужно срочно бежать отсюда! Только башку тебе прострелю сначала... Так, стой ровно и не дёргайся!";
...
//----------------------------------------------против всех--------------------------------------------------
		...
		case "LucasPrisoner_1":
			PlaySound("VOICE\Russian\hambit\Lucas Rodenburg-04.wav");
			dialog.text = "Йохан? Ха-ха! Так вот кто стоял за всем этим! Старый каналья! Но игра не окончена. За тобой по пятам идёт ван Берг - тебе не скрыться от него! Тебе недолго осталось жить, мерзавец!";
