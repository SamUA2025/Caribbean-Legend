...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		case "First time":
			...
			{
				dialog.text = "Аргх! И-ик... Ты кто такой? Где этот чёртов китаец? Я тебя спрашиваю, ты что, оглох? И-ик!";
		...
		case "HollJacob_inRoom":
			dialog.text = "Что? А ты вообще кто такой? Какого чёрта ты делаешь здесь? Я тебя спрашиваю, каналья!";
		...
		case "JacobBerg_abordage":
			if (CheckAttribute(pchar, "questTemp.HWIC.Eng"))
			{
				...
				link.l1 = "Верно, мразь. Думаю, ты это уже понял по моей команде из отборных английских морпехов. Мы с Ричардом Флитвудом придумали историю с торговцем, а ты и повёлся. Твои похождения окончены, негодяй!";
				link.l1.go = "JacobBerg_abordage_1";
			}
			else
			{
				dialog.text = "Ну вот и встретились, капитан. А ты ловкий малый... Давненько мне не попадался такой серьёзный противник.";
				link.l1 = "Я твой последний противник, Якоб. Отсюда ты живым не уйдёшь.";
		...
		case "JacobBerg_abordage_3":
			dialog.text = "Да ну? Вот ты не уйдёшь точно. Я поджёг шнур, ведущий в крюйт-камеру. Так что скоро обе лоханки - и твоя, и моя, взлетят на воздух.";
		...
		case "JacobBerg_abordage_4":
			dialog.text = "А я думаю, что прикончу тебя, успею выпрыгнуть в окно и доплыть до берега, и посмотрю, как эти два чёртовых корабля разлетятся на куски!";
