...
void ProcessDialogEvent()
{
	...
	// ----------------------------------------- Португалец ----------------------------------------------------
		...
		case "guardoftruth_9":
			dialog.text = "Слушайте дальше. Конечная цель обряда - измененить прошлое так, чтобы сделать невозможным появление белых в Новом Свете. А для этого нужно отправить в прошлое некоего человека, обладающего авторитетом, силой, способностью вершить судьбы, но самое главное - наделённого современными знаниями\nКак вы думаете, "+pchar.name+", что было бы с Колумбом, если бы его каравеллы были встречены у берегов Эспаньолы индейским флотом из фрегатов и галеонов, которые отдали бы салют прибывшим из нынешних орудий, а аркебузам белых солдат противостояли бы не луки и копья, а мортиры и мушкеты?";
