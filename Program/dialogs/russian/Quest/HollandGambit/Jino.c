...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		case "First time":
			...
			{
				dialog.text = "О! Здравствуйте, "+GetSexPhrase("сударь","сударыня")+". Как вы сюда попали?";
			...
			{
				dialog.text = "О! Здравствуйте, "+GetSexPhrase("сударь","сударыня")+". Как вы сюда попали? А где Джон?";
			...
			else
			{
				...
				{
					dialog.text = "Здравствуйте, " + pchar.name + ". По вашему выражению лица я вижу, что вы хотите сказать мне нечто важное. Неужто нашли все компоненты Стража Истины?";
				...
				{
					dialog.text = "Здравствуйте, " + pchar.name + ". Что-то случилось? Вы выглядите взволнованн"+GetSexPhrase("ым","ой")+"...";
				...
				{
					dialog.text = "Пока ничего не могу сказать, " + pchar.name + ". Я борюсь за жизнь пациента. Надежда есть. Зайдите позже, думаю, скоро я смогу сказать вам что-то определённое.";
				...
				link.l9 = "Здравствуй, Джино. Дела - нормально, со всем справляюсь пока сам"+GetSexPhrase("","а")+". Просто заш"+GetSexPhrase("ёл","ла")+" проведать тебя и поговорить.";
				link.l9.go = "exit";	
			}
		...
		case "meeting_1":
			...
			link.l1 = "Ого! Не каждый день встречаешь столь учёного человека. Аптечное дело - это, конечно, хорошо, но я "+GetSexPhrase("моряк","морячка")+"... кхм, как необычно звучит для "+GetSexPhrase("самого","самой")+"... однако я совершенно уверен"+GetSexPhrase("","а")+" в том, что мы поладим, Джино. Ты будешь спокойно, как и раньше, жить в этом доме и заниматься своей наукой...";
		...
		case "meeting_4":
			...
			link.l1 = "Прекрасно. Я рад"+GetSexPhrase("","а")+", что мы так быстро нашли общий язык. Насчёт своего пансиона не беспокойся - я или мой казначей будем периодически оставлять тебе достаточные суммы денег.";
		...
		case "meeting_7":
			...
			link.l1 = "Ясно. Буду пробовать на досуге. Спасибо, Джино! А хоть какой-нибудь простенький рецепт ты мне можешь дать? Чтобы я сразу приступил"+GetSexPhrase("","а")+" к практике?";
			link.l1.go = "meeting_8";
		break;
		
		case "meeting_8":
			dialog.text = "Простых у меня нет... но вот, возьмите вот этот рецепт микстуры. Думаю, вы вполне сможете справиться с данной задачей. Держите.";
		...
		case "meeting_9":
			...
			//Log_Info("Вы получили рецепт Микстуры");
			PlaySound("interface\notebook.wav");
		...
		case "rome":
			...
			link.l1 = "Да. Джино, не сочти меня за "+GetSexPhrase("глупца","глупышку")+", но... как тебе лучше объяснить...";
			link.l1.go = "rome_1";
		break;
		
		case "rome_1":
			dialog.text = "Говорите как есть, капитан. Не стесняйтесь.";
			link.l1 = "Хорошо. Не мог бы ты мне составить список учёных латинских изречений? Понимаешь, есть тут у меня один... человек, который любит хвалиться своей 'учёностью', и время от времени в разговорах вворачивает латинские фразочки, дабы показать, какой я "+GetSexPhrase("неуч","невежда")+" по сравнению с ним. Ну, что-то вроде 'пасем-беллум'...";
			link.l1.go = "rome_2";
		break;
	...
	// ----------------------------------------- Португалец ----------------------------------------------------
		...
		case "Portugal_7":
			...
			link.l1 = "Хорошо. Я всё понял"+GetSexPhrase("","а")+". Заберу его через три дня.";
		...
		case "Portugal_9":
			...
			dialog.text = "Ухудшения нет, но и полегчало ему не слишком. Он всё ещё не до конца в сознании - не понимает где он и зачем, впрочем, это его и не беспокоит, кажется, другое дело - приступы жара - они ещё продолжаются время от времени, я не уверен, что везти его сейчас такая хорошая идея.";
			link.l1 = "Я больше не могу ждать, и так мы пробыли тут слишком долго. Собирай микстуры, которыми его придётся пичкать по дороге, и мы уходим. Надеюсь, этот негодяй достаточно крепок, и не умрёт раньше, чем его приговорят...";
		...
		case "Portugal_10":
			...
			link.l1 = "Джино, тебе не следовало этого знать. Не бери в голову - он пират, причём один из самых неприглядных представителей этого ремесла. Я долж"+GetSexPhrase("ен","на")+" доставить его на Кюрасао на свидание с властями Компании, как можно скорее, и точка.";
		...
		case "Portugal_12":
			dialog.text = "Не за что, капитан. Помните - четыре дня, ну пять, не больше. И ещё одно... знаете, обычно я спасаю жизни людям не для того, чтобы их потом повесили. Врач в ответе за своих пациентов, какими бы они ни были. И мне крайне неприятно...";
			link.l1 = "Прости, что втянул"+GetSexPhrase("","а")+" в эту историю, но, без тебя у нас не было бы и шанса. А теперь, нам пора - иначе все ребята Португальца успеют собраться у парадных дверей встречать своего вожака.";
		...
		case "guardoftruth_0":
			...
			link.l1 = "И всё же она тебе понадобится. Ты послушай, что я тебе скажу, а потом уже делай выводы.";
			link.l1.go = "guardoftruth";
		break;
		...
		case "guardoftruth_1":
			...
			link.l1 = "Не волнуйся, Джино. Я ни за что не выдам тебя отцу Винсенто, хотя именно это он мне и поручил: найти тебя и доставить к нему. Мне нужно узнать от тебя кое-что касательно информации, полученной тобой и отцом Винсенто от некоего индейца племени ица. О Тайясале, о сокровищах, о каком-то 'зле'.";
		...
		case "guardoftruth_6":
			dialog.text = "О, "+pchar.name+", оставьте эти сказки об огнедышащих чудищах старушкам, нянчащим детей! Хотя вы почти угадали, но всё намного сложнее и... серьёзнее. Даже потоп не может ныне остановить экспансию европейцев в Новый Свет - на место одного погибшего явится десять других. Канеку нужно было уничтожить саму возможность прихода и укрепления белых на земле индейцев.";
		...
		case "guardoftruth_9":
			dialog.text = "Слушайте дальше. Конечная цель обряда - изменить прошлое так, чтобы сделать невозможным появление белых в Новом Свете. А для этого нужно отправить в прошлое некоего человека, обладающего авторитетом, силой, способностью вершить судьбы, но самое главное - наделённого современными знаниями\nКак вы думаете, "+pchar.name+", что было бы с Колумбом, если бы его каравеллы были встречены у берегов Эспаньолы индейским флотом из фрегатов и галеонов, которые отдали бы салют прибывшим из нынешних орудий, а аркебузам белых солдат противостояли бы не луки и копья, а мортиры и мушкеты?";
		...
		case "guardoftruth_29":
			...
			link.l1 = "Надо убедить отца Винсенто, что ты умер, Джино. Тогда он прекратит преследования. Скажем, тебя хватил удар при моём появлении. А в качестве доказательства ты мне дашь какую-нибудь вещь, которая знакома инквизитору.";
		...
		case "guardoftruth_31":
			dialog.text = "Будьте осторожны с отцом Винсенто. Он опасен, как тигр, и ведёт свою игру. Делиться с вами он не станет - ни сокровищами, ни славой.";
		...
		case "guardoftruth_34":
			...
			link.l1 = "Давай не будем об этом... Уж больно много было желающих завладеть этими вещами. Видать, не мне одному не даёт покоя таинственный Ксочитэм.";
		...
		case "guardoftruth_37":
			dialog.text = "Не совсем. Слова Ксатл Ча были довольно расплывчатыми. Сдаётся мне, что индеец и сам толком не знал, как заставить Стража работать. Оставьте мне компоненты, а я поломаю голову над решением этой задачи. Зайдите ко мне через два дня - возможно, я разгадаю тайну.";
		...
		case "ksochitam_25":
			...
			link.l1 = "Наша догадка подтвердилась. Я нашёл то, на что указывало 'проявление' на карте. Это индейский истукан в джунглях.";
		...
		case "ksochitam_29":
			...
			link.l1 = "Да. Наша догадка подтвердилась. Я нашёл то, на что указывало 'проявление' на карте. Это индейский истукан в джунглях.";
		...
		case "ksochitam_31":
			...
			link.l1 = "Да. Отыскал и начертил на карте направление, указанное Стрелой Пути. Теперь мы знаем местоположение Ксочитэма, пусть и не идеально точное, но знаем! Я обыщу весь район в месте, где пересеклись линии, но найду этот чёртов остров!";
		...
		case "ksochitam_37":
			dialog.text = "Не нравится мне этот остров, "+pchar.name+"! Какой-то он жуткий. И шторм этот, похоже, только вокруг этого кусочка суши и наблюдается. Определённо проклятое место!";
			link.l1 = "Мне тоже здесь не по себе, Джино. Но надо же что-то выяснить по поводу 'Санта-Квитерии' и маски Кукулькана! Раз остров существует - значит, история с Кукульканом вовсе не сказки, и нам всем угрожает гибель, если он доберётся до Тайясаля с маской...";
		...
		case "adversary_4_1":
			...
			link.l1 = "Я тоже так подумал. Сколько ни искал - в неё всего один вход, он же выход...";
			link.l1.go = "exit";
		...
		case "ksochitam_54":
			dialog.text = "С огромным удовольствием сейчас прилягу на кровать, которая стоит на твёрдой земле... Надеюсь, "+pchar.name+", вы выбросили из головы мысли о походе на Тайясаль?";
