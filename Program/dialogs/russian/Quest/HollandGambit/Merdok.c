...
//--------------------------------------------против всех--------------------------------------------------
			if (CheckAttribute(pchar, "questTemp.HWIC.Self"))
			{
				...
				if (pchar.questTemp.HWIC.Self == "HWICSelf_fail")
				{
					...
					link.l1 = "Ясно. Эх, увлёкся я другими делами и совсем про Ричарда позабыл. Ладно, бывай.";
				...
				if (pchar.questTemp.HWIC.Self == "AbigileOnShip")
				{
					...
					link.l1 = "И не вернётся. Ни он, ни его бригантина.";
					link.l1.go = "Abigile";
					break;
				}
				...
				{
					dialog.text = "Всё, написал? Дай-ка гляну... У-ух... да, ты определённо жуткий тип, дружище! 'Если посланник не выйдет из дома через полчаса, или я увижу за ним слежку - через день ты получишь в коробке палец и ухо твоей любимой. Если же посланник вернётся с пустыми руками - то я отрежу Абигайль голову и пришлю тебе.' Ха-ха-ха! У тебя определённо талант!";
				...
				if (pchar.questTemp.HWIC.Self == "FleetwoodDied")
				{
					...
					link.l1 = "Флитвуд мёртв. Всё прошло по плану - он явился на остров, а я организовал засаду в бухте. Правда, он тоже оказался не лыком шит... Ух и бойня была! Но я жив, а он навсегда останется в этой бухте.";
...
//--------------------------------------------за Голландию-----------------------------------------------------
		...
		case "Knippel_1":
			dialog.text = "Якоб отдал вам свой корабль? Презанятно... Как я понимаю, теперь вам нужен человек, который смог бы поведать мистеру Флитвуду, что 'Мираж' крейсирует у берегов Доминики, ибо сами вы, хе-хе, Ричарду об этом сказать не можете, по определённым причинам...";
...
//----------------------------------------против всех-------------------------------------------------------
		...
		case "About_Fleetwood_4":
			dialog.text = "Кумир всего женского населения Антигуа от шестнадцати до шестидесяти лет. Больше вроде мне и нечего о нём сказать... Ну, а что с ним сейчас произошло - думаю, знаешь. Лежит дома и зализывает раны.";
		...
		case "Abigile_5":
			...
			link.l2 = "Джон, ты же сам всё знаешь... Уж как карта ляжет. Её карта.";
		...
		case "Abigile_20":
			dialog.text = "Джек Гаррисон его зовут. Обычно он в таверне вечером бывает. Будь осторожен!";
		...
		case "Lucas":
			DelLandQuestMark(npchar);
			dialog.text = "Но для начала пришло время раскрыть карты. Как ты уже понял, я не простой аптекарь. Моё настоящее имя - Йохан ван Мерден, и до недавнего времени я работал агентом по особым поручениям Голландской Вест-Индской торговой Компании, и был правой рукой её вице-директора Лукаса Роденбурга.";
		...
		case "Lucas_10":
			...
			link.l1 = "Я захватил курьера от имени Флитвуда отправил Лукасу письмо, в котором заявил, что захватил архив некоего аптекаря из Сент-Джонса, и скоро доказательства всевозможных гнусностей станут известны как голландцам, так и англичанам. Я ожидал, что он начнёт охоту на меня, но вышло иначе.";
			link.l1.go = "Lucas_11";
		break;
		...
		case "alchemy_1":
			dialog.text = "Для этого вам нужно научиться смешивать зелья своими руками. Но у вас ничего не получится без алхимического набора. Вот, посмотрите в этот саквояж. В нём есть всё, что нужно начинающему алхимику - пробирки, колбы, реторты, перегонный куб, шпатели, стеклянные трубки, горелка и прочее...";
