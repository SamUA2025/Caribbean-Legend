...
//---------------------------------------за Голландию--------------------------------------------------
		...
		case "Baltazar_1":
			dialog.text = "А, чёрт, я становлюсь известнее вице-короля! Кто вы? Что вам угодно?";
		...
		case "Baltazar_2":
			dialog.text = "О, значит минхер Роденбург всё-таки прислушался к моим мольбам о помощи! А то, понимаете, нашёлся какой-то капер...";
		...
		case "Santiago_Trip_1":
			...
			SetLaunchFrameFormParam("Вас оглушили ударом сзади", "", 0, 4);
			LaunchFrameForm();
		...
		case "Santiago_Trip_2":
			dialog.text = "Прости, друг мой - пришлось тебя слегка приложить, чтоб не трепыхался. Понимаю - голова болит. Ничего - пройдёт. Если успеет...";
			link.l1 = "Кто ты, раздери тебя чёрт, и что тут творится?!";
			link.l1.go = "Santiago_Trip_3";
		break;
		
		case "Santiago_Trip_3":
			dialog.text = "Потише, потише, друг - иначе придётся тебя опять угомонить. Мы ведь не хотим, чтобы сюда ломились эти скучные солдафоны, бренча своими ржавыми железяками, так? Надо поговорить, спокойно и без шума.";
		...
		case "Santiago_Trip_4":
			dialog.text = "Шустрый какой... Нет уж, обойдёмся без стали на этот раз. Если расскажешь мне то, что я хочу знать - возможно, уйдёшь отсюда на своих двоих. А будешь мутить воду, и шуметь - получишь вот этот милый кинжал в брюхо. Я понятно объясняю? Так что давай просто, как ты сказал - побеседуем\nМолчишь? Хорошо... значит, мы договорились. Что ты вёз от Роденбурга к банкиру?";
			link.l1 = "Письмо.";
		...
		case "Santiago_Trip_6":
			dialog.text = "Честный капитан - редкость в наше паршивое время. Тем хуже для тебя. А что сказал этот чёртов банкир, когда получил пакет? Что у него за дела с голландцами?";
			link.l1 = "Торгуют контрабандным парфюмом из Франции, полагаю... или баварским коровьим навозом.";
			link.l1.go = "Santiago_Trip_7";
			link.l2 = "Речь шла о некой компенсации за что-то. Это всё, что мне известно.";
			link.l2.go = "Santiago_Trip_8";
		break;
		
		case "Santiago_Trip_7":
			dialog.text = "А ты смелый парень... ещё и с чувством юмора. Жаль будет тебя убивать. Гастону бы ты понравился. Впрочем, посиди пока тут. Мне нужно кое-что проверить, а Мигель приглядит, чтобы ты не шумел, пока меня не будет.";
			link.l1 = "Клянусь, 'друг мой', вы пожалеете!";
			link.l1.go = "Santiago_Trip_9";
		break;
		
		case "Santiago_Trip_8":
			dialog.text = "Вот вам и весь гонор... Запахло жареным, и наш бравый капитан сразу проявил благоразумие. Что ж так тянул-то? Мне придётся кое-что проверить, а потом - я вернусь, и мы договорим, если будет о чём. Посиди пока тут, сейчас придёт Мигель и приглядит, чтобы ты не шумел, пока меня не будет.";
			link.l1 = "Клянусь, 'друг мой', вы пожалеете!";
			link.l1.go = "Santiago_Trip_11";
		break;
		
		case "Santiago_Trip_9":
			dialog.text = "Ну-ну. Сиди тихо, герой, и может быть, всё будет хорошо.";
			link.l1 = "...";
			link.l1.go = "Santiago_Trip_11";
		break;
		...
		case "Santiago_Trip_14":
			...
			link.l1 = "Ловчее, чем ты думаешь... Ну, а теперь посмотрим, чего ты стоишь против вооружённого противника!";
...
//---------------------------------------------против всех----------------------------------------------
		...
		case "Fleetwood_soldier"://для любителей сунуть нос куда не надо
			...
			{
			dialog.text = "Опять вы? Да что же вы тут всё вынюхиваете? Не нравится мне всё это... Вот что: я вас арестую, и отправлю на разбирательство в комендатуру. Ребята, взять этого типа!";
			...
			link.l1 = "Извините, сэр, я кажется, зашёл не в тот дом. Прошу меня извинить.";
		...
		case "Fleetwood_soldier_2":
			dialog.text = "Вот как? И кто же вам сказал, что он здесь живёт? Подозрительно всё это... Вот что: я вас арестую, и отправлю на разбирательство в комендатуру. Ребята, взять этого типа!";
		...
		case "Sailor_deck":
			...
			dialog.text = "Капитан, мы допросили этого мерзавца, как вы и сказали. Пришлось слегка прижечь его... При нём оказалось вот это письмо. Негодяй пытался его съесть, но мы вовремя пережали ему глотку. Как вы и предполагали - его цель была вывезти из Виллемстада некую девчонку для своего шефа.";
		...
		case "Sailor_deck_2":
			...
			link.l2 = "Отдайте его морю со всем почтением. Старик, а дрался до последнего, пушки сам наводил. Жаль. В других обстоятельствах могли бы и сработаться.";
		...
		case "Sailor_deck_5":
			chrDisableReloadToLocation = true;
			dialog.text = "Мы подготовили китайца к допросу, как вы приказали, капитан. При нём ничего не было, никаких бумаг. Жаровня зажжена, наручники и клещи сейчас раскаляем.";
			link.l1 = "Хорошо, Алонсо. Но прежде чем ты возьмёшься за дело, я попробую поговорить с ним по душам. Может, он решит сотрудничать добровольно?";
		...
		case "Sailor_deck_7":
			...
			link.l1 = "Наденьте на него кандалы и глаз не спускать, ни днём, ни ночью, пока не прибудем на Гваделупу. Всем троим неотступно находиться здесь. Отвечаете головой.";
		...
		case "Drunkard_1":
			dialog.text = "О! Ну конечно, это я. Кто же ещё? А что? На-а-дува-е-ет ве-е-тер пару-у-са...";
		...
		case "Drunkard_2":
			...
			link.l1 = "Никого убивать не надо, да и сомневаюсь я, что ты на это способен. Руки не оттуда растут... Вот тут письмо. Ты его берёшь и относишь в дом слева от резиденции губернатора, для Ричарда Флитвуда.";
		...
		case "Drunkard_4":
			...
			link.l1 = "Не твоё дело. Меньше знаешь - дольше живёшь. Ну, я жду. Повтори.";
		...
		case "Drunkard_6":
			if (makeint(Pchar.money) >= 5000)
			{
				...
				link.l1 = "Не только. Тебе дадут другое письмо. С ним придёшь в таверну и сядешь на это место. Я у тебя его заберу. Не вздумай сглупить, и ничего не бойся - я за тобой наблюдаю и буду рядом. Держи деньги авансом, чтобы тебе спокойнее было.";
		...
		case "Drunkard_9":
			DelLandQuestMark(npchar);
			dialog.text = "А, вот и вы, сэр... Право, лучше бы я этого не делал. Ричард пришёл в ярость, когда прочитал ваше письмо. Я думал, он меня убьёт...";
		...
		case "Drunkard_11":
			...
			dialog.text = "Я ещё дня два с трудом разговаривать буду... Прощайте... век бы вас не видеть.";
		...
		case "Cureer_abordage":
			dialog.text = "Аргх! Какого чёрта вы атаковали мой корабль? У меня нет ни ценностей, ни денег - одни бумаги, в которых вы ничего не поймёте!";
		...
		case "MatiasBek"://на случай если геймер захочет пообщаться
			dialog.text = "Меня арестовали незаконно! Я не имею к англичанам никакого отношения! Это всё интриги Роденбурга. Ничего, прибудет Питер Стайвесант - он во всём разберётся!";
			link.l1 = "...";
			link.l1.go = "exit";
		...
		case "ArestLucas_3":
			dialog.text = "Здравствуйте, минхер Стайвесант. Я получил доказательства его связи с английской разведкой и непосредственно с капитаном Флитвудом. По его наводке проклятый англичанин напал на нашу курьерскую бригантину с целью завладеть секретной перепиской компании.";
			link.l1 = "";
		...
		case "ArestLucas_7":
			dialog.text = "Об этом засвидетельствовал капитан курьерской бригантины. Ричард Флитвуд абордировал его корабль и отнял бумаги, затем корабль был отпущен. Никто, кроме меня, вас и Матиаса Бека не знал ни маршрута, ни времени движения бригантины.";
			link.l1 = "";
		...
		case "ArestLucas_9":
			dialog.text = "И поэтому вы решили, что Флитвуда на бригантину навёл Бек? Что за вздор? Флитвуд - обычный пират, он нападает только на торговые корабли. Зачем ему бумаги, в которых, кстати, ничего, кроме бухгалтерских сведений, не содержится?";
			link.l1 = "";
		...
		case "ArestLucas_11":
			dialog.text = "Минхер, кроме простых отчётов курьер вёз и более важные документы Компании. Все они теперь в руках у англичан. Поэтому я принял решение о смещении Бека и взял его под стражу.";
			link.l1 = "";
		...
		case "ArestLucas_13":
			dialog.text = "Чёрт возьми! Но это же самое настоящее самоуправство! Вы отдаёте себе отчёт в своих действиях, Лукас? Где капитан курьерской бригантины?";
			link.l1 = "";
		...
		case "ArestLucas_15":
			dialog.text = "Отбыл в Филипсбург, минхер.";
			link.l1 = "";
		...
		case "ArestLucas_17":
			dialog.text = "Так-так... Я приказал освободить Бека. Сейчас его сюда доставят. Поговорим втроём...";
			link.l1 = "";
		...
		case "ArestLucas_19":
			dialog.text = "Ну что же, я не возражаю. Втроём, так втроём.";
			link.l1 = "";
		...
		case "ArestLucas_40":
			dialog.text = "Вы поплатитесь за свой произвол, Роденбург! Ваши обвинения смехотворны. Вы даже не позволили мне встретиться с капитаном бригантины! Все ваши так называемые обвинения вы сделали сами, лично, не приведя никаких доказательств\nВидит Бог, я невиновен! У меня нет и не было никаких контактов с англичанами!";
			link.l1 = "";
		...
		case "ArestLucas_42":
			dialog.text = "Вот как? А откуда же тогда Флитвуд узнал про нашу бригантину, и про то, что на ней перевозились не только бумаги?";
			link.l1 = "";
		...
		case "ArestLucas_43":
			dialog.text = "...";
			link.l1 = "Роденбург лжёт. Ричард Флитвуд не мог напасть на курьерскую бригантину.";
		...
		case "ArestLucas_44":
			dialog.text = "А вы кто такой, минхер, позвольте спросить? И на каком основании делаете подобные заявления?";
			link.l1 = "Моё имя - " + GetFullName(pchar) + ". Я лично уничтожил капитана Флитвуда, организовав негодяю ловушку. Сейчас его останки доедают чайки на пустынном берегу Теркса... Я сам положил конец беспределу этого мерзавца, раз официальные власти оказались неспособны защитить нас, голландских торговых капитанов, от его произвола. И случилось это ДО того, как была ограблена курьерская бригантина...";
		...
		case "ArestLucas_46":
			dialog.text = "";
			link.l1 = "Флитвуд просто не смог бы этого сделать, поскольку был уже мёртв. Узнав в таверне Виллемстада от моряков о захвате курьерского корабля, а также о том, что Матиас Бек арестован, я решил докопаться до сути дела, ибо, как мне было известно, минхер Бек - человек кристально чистой репутации...";
			link.l1.go = "ArestLucas_47";			
		break;
		
		case "ArestLucas_47":
			dialog.text = "";
			link.l1 = "Поговорив с матросами в порту, я узнал, что вы расквартировали с вашей шебеки гвардейцев Компании и набрали команду из негодяев всех мастей. Я отправился в море, проследил за вашим кораблём, и, улучив момент, захватил его. Перебив свору нанятых вами головорезов, я допросил китайца Лонгвэя - капитана шебеки. В обмен на свободу он раскрыл все ваши карты, минхер Роденбург...";
			link.l1.go = "ArestLucas_48";			
		break;
		
		case "ArestLucas_48":
			dialog.text = "";
			link.l1 = "Вы решили узурпировать власть на Кюрасао, а Лонгвэю приказали потопить галеон минхера Стайвесанта. Зная ваши методы, я уверен, что капитан бригантины отбыл не в Филипсбург, а прямиком на дно. Ведь это вы сами организовали нападение на бригантину Компании, чтобы создать прецедент, не так ли? И сделали это при помощи вашего наёмного убийцы Якоба ван Берга, о котором мне также поведал Лонгвэй?";
			link.l1.go = "ArestLucas_49";			
		break;
		
		case "ArestLucas_49":
			dialog.text = "Это... это наглая ложь! Что вы несёте, сударь?! Вы кто вообще такой?!";
			link.l1 = "Я - свободный капитан, который пожелал очистить море и землю от подонка Флитвуда, и оказавшийся втянутым в ваши политические интриги! Я предупредил минхера Стайвесанта о грозящей ему опасности. И я здесь, чтобы совместно с законной властью положить конец вашим бесчинствам на Кюрасао!";
			link.l1.go = "ArestLucas_50";			
		break;
		
		case "ArestLucas_50":
			dialog.text = "Какая дерзость! Вы ответите за ваши слова, минхер 'свободный капитан'! Вы...";
			link.l1 = "";
		...
		else
		{
			...
			dialog.text = "И я прошу вас зайти завтра в резиденцию - вы будете награждены от лица Республики Свободных Провинций за ваши деяния в её благо. Прошу вас не покидать город.";
			link.l1 = "Хорошо, минхер. Буду у вас на приёме завтра.";
		...
		case "Stivesant_15":
			dialog.text = "Также, за беспрецедентную отвагу, за раскрытие коварного заговора внутри Компании и содействие в поимке бывшего вице-директора Компании, сопряжённое с серьёзным риском, вы награждаетесь денежной премией в размере 150 000 песо. Также вы получаете право на заключение контрактов с Голландской Вест-Индской Компанией\nУверен, что новый вице-директор всегда сможет найти задание, достойное такого храброго капитана, и щедро оплатить ваши услуги.";
		...
		case "Stivesant_16":
			...
			dialog.text = "Ну, и вы всегда можете рассчитывать на моё содействие в любых вопросах, до тех пор, пока действуете на стороне и в интересах Голландии. Далее предоставляю слово губернатору Виллемстада, Матиасу Беку.";
			link.l1 = "";
		...
		case "Bek_5":
			...
			dialog.text = "И знайте: в моём лице вы обрели друга, а это многое значит. Вы всегда желанный гость в моей резиденции. Заходите в любое время, по любым вопросам - я буду рад оказать вам любую помощь, которая потребуется.";
		...
		case "Stivesant_18":
			...
			link.l1 = "У меня всё хорошо. Я просто зашёл вас навестить.";
			link.l1.go = "exit";	
		...
		case "Stivesant_19":
			...
			{
				dialog.text = "О! Кто пришёл! Это же сам " + GetFullName(pchar) + ". Мы как раз недавно высылали охотников за головами, чтобы они привели вас сюда. И знаете, это уже встало нам в кругленькую сумму.";
		...
		case "Stivesant_20":
			...
			link.l1 = "Всё хорошо, минхер. Месье де Пуанси поручил мне передать вам вот это письмо и доставить ответ на него. Также в мою задачу входило сопроводить флейт '"+sld.ship.name+"' с грузом для вашей Компании в порт Виллемстада. Судно стоит на рейде, груз в целости.";
		...
		case "Stivesant_23":
			dialog.text = "Я не буду вас задерживать, капитан, вы же человек военный, у вас наверняка много дел, да и шевалье, уверен, с нетерпением ждёт вашего возвращения. Будьте так любезны подождать прямо здесь, в приёмной, два часа, и я подготовлю вам ответ на депешу. Присядьте, отдохните, сейчас вам принесут рому или вина, как пожелаете...";
		...
		case "Stivesant_28":
			...
			{
				dialog.text = "И поэтому вы здесь, капитан. Не буду вдаваться в дипломатические дискуссы: передайте шевалье, что он больше не в деле на Синт-Маартене. Хватит с него. А касательно инспекции из метрополии - пусть придумает что-нибудь, для де Пуанси перевернуть всё с ног на голову никогда не составляло труда.";
			...
			else
			{
				...
				link.l1 = "Мне кажется, что задерживать французского офицера при исполнении им служебного долга недопустимо!";
				link.l1.go = "Stivesant_31";
			}
		break;
		
		case "Stivesant_29":
			dialog.text = "Слово в слово, капитан. Ваш командир всё поймёт, а вам вникать необязательно, это ничего не изменит. Всего доброго. Сержант, проводите месье Шарля де Мора к выходу!";
			link.l1 = "...";
		...
		case "Stivesant_31":
			...
			link.l1 = "Вы просто ещё не знаете, с кем связались, минхер...";
		...
		case "Stivesant_37":
			...
			link.l1 = "Тогда скрепляем все три экземпляра подписями. Я уполномочен генерал-губернатором Филиппом де Пуанси завизировать документ со стороны Франции, полковник д'Ойли подпишет со стороны Англии.";
		...
		case "Stivesant_42":
			dialog.text = "Итак, это вы - барон Ноэль Форже? Ба, да тут ещё и месье Шарль де Мор собственной персоной! Здравствуйте, здравствуйте, вице-адмирал! Недаром про вас идёт слава самого ловкого интригана архипелага - никогда не знаешь, на чьей вы стороне в данный момент...";
		...
		case "Stivesant_44":
			dialog.text = "Такие документы у меня есть. Это целый гроссбух с нашей с Пуанси бухгалтерией по руднику и некоторым прочим делам. Также в нём есть целый ворох бумаг, относящихся к этой бухгалтерии, с личной подписью Филиппа де Пуанси. Я вам гарантирую, что содержимое этих бумаг в руках заинтересованного человека утопит шевалье глубже дна Карибского моря.";
		...
		case "Stivesant_46":
			dialog.text = "Так точно, барон. Эта сумма хотя бы частично покроет мне убытки, нанесённые недавней войной. Я дам вам совет: обратитесь к месье Шарлю де Мору. За время службы у Пуанси и мммм... других персон, он наверняка сколотил огромное состояние, и достать миллион не будет для него особой проблемой. Я в этом практически уверен\nСрок вам даю - один месяц. По истечении этого времени, если вы не принесёте указанную сумму, я отправлю письмо шевалье, в котором опишу подробности вашего визита ко мне. Что за этим последует - полагаю, вы догадываетесь.";
		...
		case "Stivesant_49":
			...
			{
				dialog.text = "Я даже не сомневался, вице-адмирал Шарль де Мор, что вы принесёте мне эти деньги. Пожалуй, я даже маловато с вас запросил, ну да ладно... Барон - лишь пешка в вашей очередной игре, так? Чина и денег вам недостаточно, теперь вы желаете занять место де Пуанси, я прав? Согласитесь, миллион - скромная плата за должность генерал-губернатора французских колоний! Вы отобьёте их за считаные месяцы, учитывая вашу железную хватку.";
		...
		case "Stivesant_50":
			...
			dialog.text = "Конечно, вице-адмирал. И не хмурьтесь так: когда вы станете генерал-губернатором, вы увидите, что Голландская Вест-Индская торговая Компания - более выгодный деловой партнёр, чем жадные и воинственные англичане. Вы разве не знаете, что если дать англичанину палец, он заберёт всю руку? Если нет, то узнаете. Так что я с вами не прощаюсь. Держите свои бумаги. Надеюсь, ваш барон будет достаточно компетентен, чтобы уничтожить шевалье.";
		...
		case "Abihouselady_3":
			dialog.text = "Вы ещё что-то хотели узнать, минхер?";
