...
//-------------------------------------------------за Англию-----------------------------------------
		case "Seek_Island":
			...
			link.l1 = "Ричард жив и уже почти здоров. Остались некоторые проблемы со зрением, но он явно идёт на поправку. Ричард предлагает вам уехать с ним в Англию, где вы сможете обвенчаться. Его командировка закончена, и он ждёт только вашего ответа.";
...
//--------------------------------------------против всех------------------------------------------------
		...
		case "Abigile_kidnapping_5":
			...
			link.l1 = "Хорошо, леди. Я буду завтра. И не беспокойтесь за себя - я моя команда оградим вас от любых неприятностей в пути.";
		...
		case "Abigile_kidnapping_19":
			...
			link.l1 = "Я думаю, он скоро вернётся. Если вам что-то понадобится - Чарли Книппель всегда к вашим услугам.";
		...
		case "Abigile_return_2":
			...
			link.l1 = "За то, что скажу вам очередную неприятную новость: Лукас Роденбург арестован за попытку совершения переворота в Виллемстаде, будет отправлен в Нидерланды и отдан под суд. Я только что прибыл с Кюрасао. С учётом того, что он пытался убить директора Компании Питера Стайвесанта, да и уличён ещё как минимум в одном убийстве, приговор вряд ли будет мягким.";
