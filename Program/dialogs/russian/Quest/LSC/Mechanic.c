...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		case "First time":
			...
			else
			{
				...
				if (pchar.questTemp.LSC == "return" && !CheckAttribute(npchar, "quest.return_isl"))
				{
					...
					link.l1 = "И напрасно - я ещё на тот свет не собираюсь. А трюк этот очень прост - я прикоснулся к статуе Кукулькана, которую нашёл на дне, и телепортировался на Доминику, прямо в деревню карибов...";
					link.l1.go = "return";
					break;
				}
				...
				{
					link.l4 = "Хенрик, я пришёл к вам по делу. Очень важному делу. Мне тут кое-что рассказал о вас Оле Кристиансен, или как его ещё называют, Белый Мальчик.";
					link.l4.go = "mechanic_1";
				}
				if(pchar.questTemp.LSC == "platinum" && GetCharacterItem(pchar, "jewelry10") >= 11)
				{
					link.l4 = "Хенрик, я принёс достаточное количество 'серебришка'. Столько, сколько вы просили: один ваш и ещё десять. Вот, держите.";
		...
		case "mechanic":
			...
			link.l1 = "Мне рассказал про вас Оле Кристиансен, или, как его ещё называют, Белый Мальчик.";
			link.l1.go = "mechanic_1";
		break;
		
		case "mechanic_1":
			dialog.text = "А, этот забавный паренёк! Да-да, знаю его. Что же он такое вам про меня рассказал?";
			link.l1 = "Заранее хочу извиниться, если это прозвучит глупо но... всё же спрошу. Оле сказал мне, что вы сможете научить, как спуститься на дно, под воду. Только не смейтесь пожалуйста, если это просто его выдумка.";
			link.l1.go = "mechanic_2";
		break;
		
		case "mechanic_2":
			dialog.text = "Выдумка? Это отнюдь не выдумка. Я сам бывал на дне, и не раз. Правда, уже давно не спускаюсь, ибо за последние годы гигантских крабов на нашем мелководье развелось просто тьма тьмущая, а я, понимаете ли, учёный, а не боец, и сражаться с этими монстрами мне не по силам\nКроме меня, на дно также спускались ещё два человека, из нарвалов, но в итоге тоже отказались - добывать всякую всячину безопаснее из трюмов кораблей, прибиваемых течением к внешнему кольцу, нежели со дна, кишащего жуткими тварями\nТеперь моим водолазным снаряжением пользуются редко, а за последние пару месяцев на дно вообще никто не отправлялся, так как костюм вышел из строя...";
			link.l1 = "У вас есть костюм, в котором можно спускаться на дно? Я не ослышался?";
			link.l1.go = "mechanic_3";
		break;
		
		case "mechanic_3":
			dialog.text = "Со слухом у вас всё в порядке, молодой человек. Я сам изобрёл и сделал этот костюм из толстой парусины, многократно пропитанной специальными смолами, в результате чего она стала абсолютно водонепроницаема, и металлических составляющих частей, а также специального стального шлема, который мы изготовили совместно с Юргеном в его кузне\nЯ усилил костюм металлическим нагрудником и наплечником, наколенниками и налокотниками на случай столкновения с крабами, а также для придания массы для устойчивости при хождении по дну. Кроме того, в состав костюма входят тяжёлые стальные ботинки - опять же для успешного передвижения по дну\nДля поддержания жизни водолаза имеются специальные ёмкости, наполненные сжатым воздухом, позволяющие некоторое время находиться под водой. Вещь уникальная, моя гордость.";
			link.l1 = "Это замечательно. Но вы сказали, что ваш костюм недавно вышел из строя?";
			link.l1.go = "mechanic_4";
		break;
		
		case "mechanic_4":
			dialog.text = "К величайшему сожалению, это действительно так. Отдельные части костюма для придания прочности и гибкости сочленений соединялись при помощи специальных металлических пластин. Однако морская вода оказала на сталь губительное воздействие - за год погружений они подверглись разрушению ржавчиной, и костюм утратил свою герметичность\nХорошо, что я вовремя это заметил и никто не пострадал. Вода оставалась на гибких сочленениях, даже при высушенном костюме, и морская соль с влагой сделали своё чёрное дело.";
			link.l1 = "Да уж... Но вы же можете починить костюм! Поставить новые детали вместо проржавевших...";
			link.l1.go = "mechanic_5";
		break;
		
		case "mechanic_5":
			dialog.text = "Для чего? Чтобы через год они опять разрушились? Вы знаете, какая это сложная работа - собрать костюм на гибких сочленениях, да так, чтобы он получился герметичным? Да мне неделю без отдыха этим заниматься придётся.";
			link.l1 = "Так что, вы из-за этого готовы выбросить своё великолепное творение на свалку?";
		...
		case "mechanic_6":
			...
			link.l1 = "Так в чём же проблема?";
			link.l1.go = "mechanic_7";
		break;
		
		case "mechanic_7":
			dialog.text = "Проблема в том, что этот металл очень редок. У меня есть всего один кусок, чего, безусловно, недостаточно. Нужно ещё как минимум десять, а то и пятнадцать таких кусков для выполнения работы.";
			link.l1 = "А что это за металл такой?";
			link.l1.go = "mechanic_8";
		break;
		
		case "mechanic_8":
			dialog.text = "О-о, это уникальный металл, который недооценивается людьми. При высокой прочности и достаточной пластичности он абсолютно устойчив ко всем внешним воздействиям - ни вода, ни соль, ни какие-либо другие вещества не могут его разрушить\nВозможно, вы встречали этот металл. Он белый, и похож на серебро, поэтому испанцы прозвали его 'серебришком'. Кхе! Да он в сотни раз ценнее серебра по своим качествам! Да что серебра - золота! Когда-нибудь люди поймут это, но, видно, время ещё не пришло.";
		...
		case "mechanic_10":
			...
			link.l1 = "Тогда покажите мне кусок этого металла, чтобы я мог понять, о чём идёт речь.";
			link.l1.go = "mechanic_11";
		break;
		
		case "mechanic_11":
			dialog.text = "Так вы берётесь за розыски? Превосходно. Вот, возьмите этот кусок как образец для сравнения. Ищите среди серебряной руды и самородков. Отличить его на первый взгляд непросто, но вы быстро разберётесь, что к чему. На серебре практически всегда есть хотя бы небольшие потемнения. А этот металл чист.";
		...
		case "mechanic_12":
			...
			dialog.text = "Увы, нет. Если бы я знал - то ваша помощь мне бы не потребовалась. Но совет всё же дам: поищите на кораблях клана ривадос - я на них не бываю, соответственно, шанс нахождения там больше, ибо корабли нарвалов я уже облазил вдоль и поперёк.";
			link.l1 = "Я принял ваши слова к сведению, Хенрик. Надеюсь, мне повезёт.";
			link.l1.go = "mechanic_13";
		break;
		
		case "mechanic_13":
			dialog.text = "Соберите ещё десять таких кусков. Это минимум, необходимый для ремонта костюма. Желаю удачи!";
		...
		case "mechanic_20":
			...
			{
				dialog.text = "Да. Мы с Юргеном замечательно потрудились - принесённых вами слитков как раз хватило для выполнения работы. Костюм починен и собран. Мне осталось только испытать его, но я уверен, что всё будет в порядке. Приходите завтра часам к десяти утра - я заправлю резервуары костюма воздухом, и вы сможете наконец осуществить своё желание.";
			...
			{
				dialog.text = "Я вынужден вас огорчить, "+pchar.name+". Как я и предполагал, металла оказалось недостаточно. Я посчитал - для завершения ремонта мне нужно ещё таких слитков в количестве "+FindRussianQtyString(sti(pchar.questTemp.LSC.PtAddQty))+". И я снова вынужден просить вас о помощи.";
		...
		case "mechanic_21":
			dialog.text = "Я буду вас ждать. Будьте уверены, этого количества уже точно хватит. Как только вы принесёте - я буквально за сутки закончу работу.";
		...
		case "mechanic_23":
			...
			dialog.text = "Замечательно! Теперь костюм будет восстановлен. Приходите послезавтра часикам к десяти утра - к этому времени я уже соберу костюм, испытаю, заправлю резервуары воздухом, и вы наконец сможете осуществить своё желание.";
		...
		case "immersion_1":
			dialog.text = "Да хоть и прямо сейчас. Но сначала я прочитаю вам небольшую лекцию, или инструкцию. Спуск производите с платформы 'Феникс' - проход туда через кормовую галерею 'Сан-Габриэля'. На платформе установлена лебёдка, при помощи которой вы спуститесь на дно. С её же помощью вы подниметесь обратно - никаким иным способом вы всплыть не сможете - костюм очень тяжёл\nТак что запомните, где находится крюк лебедки под водой и не потеряйтесь. Далее. Воздуха в резервуарах достаточно на 20 минут нахождения под водой. Если вы израсходуете весь воздух, и при этом останетесь под водой, вы попросту задохнётесь. Так что следите за временем\nНе отходите далеко от крюка лебедки, иначе у вас просто может не хватить времени вернуться к ней назад, и Боже вас упаси отправиться с нашего мелководья в морские глубины - вас сплющит, как камбалу\nПроявляйте осторожность, под водой полно гигантских крабов. Если вы подойдёте к ним слишком близко - они атакуют вас. Не стоит рисковать понапрасну - если они нападут стаей, вам придётся ретироваться, а бегать под водой у вас точно не получится.";
			link.l1 = "С крабами я как-нибудь управлюсь. Насчёт остального понял - в глубину не лезть, держаться поближе к лебёдке и не забывать о времени. Когда можно спуститься?";
		...
		case "immersion_4":
			dialog.text = "Ну вот и все инструкции. Костюм возьмёте в помещении на платформе, после погружения снимите его и принесите мне, я заправлю его воздухом снова. Но! В день больше одного погружения я вам делать крайне не советую: даже двадцатиминутное нахождение под водой и дыхание сжатым воздухом оказывают вредное воздействие на здоровье.";
			link.l1 = "Ну, тогда больше одного раза в день под воду лезть и не буду.";
			link.l1.go = "immersion_5";
		break;
		
		case "immersion_5":
			dialog.text = "Я рад, что вы всё приняли к сведению. Теперь ступайте, и удачи вам!";
			link.l1 = "Спасибо!";
		...
		case "after_first_immersion":
			...
			{
				dialog.text = "Ну, и почему вы ещё здесь? Костюм вас уже заждался.";
				link.l1 = "Да-да, я иду.";
				link.l1.go = "exit";
			}
			else
			{
				...
				{
					link.l1 = "Всё как нельзя лучше, я доволен результатами. Я нашёл в затонувшем галеоне каменную статую, у которой, как я слышал по рассказам, ривадос ранее проводили жертвоприношения. Скажите, Хенрик, вы не знаете кого-нибудь, кто мог бы поподробнее рассказать, как этот ритуал проводился?";
					link.l1.go = "af_immersion_1";
				}
				else
				{
					link.l1 = "Нормально. У меня всё получилось! И мне было очень интересно, хотя и чуточку жутковато.";
		...
		case "af_immersion_1":
			dialog.text = "Заинтересовались нашей историей? Ну, тогда вам прямая дорога к Антонио Бетанкуру. Он у нас потомственный горожанин, родился на Острове. Он живёт на флейте 'Плуто'. Если уже он не знает - то не знает никто.";
		...
		case "af_immersion_2":
			dialog.text = "Оставьте костюм у меня. Если вы захотите ещё раз спуститься на дно - приходите завтра или в любой день позже, я заправлю резервуары воздухом.";
		...
		case "af_immersion_wait":
			dialog.text = "Ну, вы принесли моё снаряжение?";
			if (CheckCharacterItem(pchar, "underwater"))
			{
				link.l1 = "Конечно. Вот ваш костюм. Спасибо!";
				link.l1.go = "af_immersion_3";
		...
		case "immersion_next_2":
			dialog.text = "Хорошо. Если желаете ещё спуститься под воду - приходите завтра или позже. Я подготовлю костюм к работе.";
		...
		case "immersion_next_pay":
			...
			dialog.text = "Когда вернёте мне скафандр - получите ваши деньги назад. Всё по-честному.";
	...
	//--------------------------------------вернулся на Остров---------------------------------------------
		case "return":
			dialog.text = "Позвольте! К какой статуе? А-а, кажется, я понимаю. Это вы сейчас про истукана, который когда-то затонул вместе с кораблём 'Сан-Херонимо'? Так что, эти сказки ривадос - действительно правда?";
			link.l1 = "Именно! И никакие это не сказки. На архипелаге я знаю ещё два таких истукана, и они переносят любого коснувшегося их от одного к другому по кругу.";
			link.l1.go = "return_1";
		break;
		
		case "return_1":
			dialog.text = "Ясно-ясно. Придётся вам поверить, хотя вы несёте антинаучный бред. Статуи переносят в пространстве... пхе! Ну кто бы подумал?";
		...
		case "return_2":
			...
			if(CheckCharacterItem(pchar, "underwater"))
			{
				link.l1 = "Нет, конечно. Он, можно сказать, спас меня от карибов. Я принёс его вам.";
				link.l1.go = "return_4";
			}
			else
			{
		...
		case "return_3":
			dialog.text = "Ну так принесите его мне, чёрт возьми! Пока не вернёте мне скафандр - дальнейшего разговора не будет, так и знайте!";
		...
		case "return_underwater":
			if(CheckCharacterItem(pchar, "underwater"))
			{
				dialog.text = "А, вы всё-таки принесли мне мой скафандр! Спасибо-спасибо, а то я уже начал было отчаиваться.";
				link.l1 = "Зря вы переживали. Я же сказал - верну, значит - верну.";
				link.l1.go = "return_4";
			}
			else
			{
				dialog.text = "Пока не вернёте мне мой скафандр - даже не подходите ко мне.";
		...
		case "return_5":
			...
			link.l1 = "Ну какой же ещё подарок можно было ждать от Механика! Конечно - набор инструментов! Спасибо большое, Хенрик, я, право, тронут... Я не заслужил этого подарка.";
			link.l1.go = "return_6";
		break;
		...
		case "return_9":
			...
			link.l1 = "Спасибо! Ещё увидимся, Хенрик!";
