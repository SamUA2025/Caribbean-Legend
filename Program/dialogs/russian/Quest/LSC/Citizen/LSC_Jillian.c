	...
	switch(Dialog.CurrentNode)
	{
		case "First time":
			...
			if (npchar.quest.meeting == "0")
			{
				...
				link.l1 = TimeGreeting()+". Меня зовут "+GetFullName(pchar)+". Я недавно попал на Остров, знакомлюсь с его обитателями, и наконец решился подойти и поговорить со столь милой особой - с вами. Как ваше имя?";
				link.l1.go = "meeting";
		...
		case "meeting": // первая встреча
			dialog.text = "Вы заставляете меня краснеть, сударь, но всё равно приятно. Спасибо за комплимент. Меня зовут Джиллиан, Джиллиан Стайнер. Рада знакомству.";
		...
		case "meeting_1":
			...
			link.l1 = "Ну... вроде того. Я отправился сюда на баркасе, почти прошёл через рифы, но неудачно налетел на обломок корабля и моя лодка перевернулась и пошла ко дну. Ну, а я вплавь добрался сюда.";
			link.l1.go = "meeting_2";
		break;
		
		case "meeting_2":
			dialog.text = "О! Так вы прибыли сюда по своему желанию? Удивительно!";
			link.l1 = "Да, вот такой я чудак. Решил найти пресловутый Остров Справедливости, и нашёл его. Правда, не знаю теперь, как отсюда выбраться.";
			link.l1.go = "meeting_3";
		break;
		
		case "meeting_3":
			dialog.text = "Вы или очень храбры, или безрассудны. Отправиться сюда на баркасе... Теперь будете жить с нами, потому что, как говорят - за последние десять лет ещё никто не покидал пределов Острова.";
			link.l1 = "И всё-таки я не теряю надежды. Ладно, Джиллиан, не буду больше отнимать ваше время. Ещё увидимся!";
			link.l1.go = "exit";
			NextDiag.TempNode = "First time";
		break;
...
//--------------------------------------- блок вопросов и ответов ---------------------------------------------
		case "int_quests":
			...
			{
				link.l4 = "Вы говорите - не замужем... Неужели у такой симпатичной девушки нет ухажёров здесь?";
		...
		case "ansewer_4":
			dialog.text = "Хи-хи... ухажёры-то есть, да толку нет. Не люб мне из них никто, а жить с мужчиной, который не по нраву - это не для меня. А те, кто симпатичны мне, не замечают меня. Ну да, я ведь всего лишь простая бедная девушка...";
			link.l1 = "Всё ещё впереди...";
			link.l1.go = "int_quests";
