...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "meeting": // первая встреча
			dialog.text = "Прекрасно. Очень правильно делаешь, поскольку мы здесь все - одна большая семья. Ну, не считая, конечно, нарвалов и гнусных ривадос. Меня зовут Антонио, Антонио Бетанкур. Внук Франциско Бетанкура, если это тебе о чём-то говорит.";
		...
		case "meeting_2":
			...
			link.l1 = "Ясно. Рад встрече и знакомству, Антонио! Ещё увидимся.";
			link.l1.go = "exit";
			NextDiag.TempNode = "First time";
		break;
		...
		case "dolly":
			...
			link.l1 = "Скажи, ты помнишь то время, когда галеон 'Сан-Херонимо' ещё стоял на поверхности?";
			link.l1.go = "dolly_1";
		break;
		
		case "dolly_1":
			dialog.text = "Конечно, помню. Это был очень примечательный корабль. На нём находилась интересная индейская статуя, у которой эти мерзкие язычники ривадос проводили жертвоприношения.";
			link.l1 = "И как они их проводили? Вырезали ножом сердца, как майя, или рубили головы?";
			link.l1.go = "dolly_2";
		break;
		
		case "dolly_2":
			dialog.text = "Нет, что ты... Это была особенная статуя - она сама затягивала в себя жертв и они бесследно исчезали. Дьявольское порождение... Слава Господу, она утонула вместе с кораблём и уже никому не принесёт вреда. И что примечательно - жертвоприношения всегда проводились в одно и то же время, утром. Тусклая статуя внезапно начинала сверкать золотом в лучах восходящего солнца, и над ней появлялось сияние\nВот тогда-то они и приводили к ней своих жертв, в основном это были пленники из клана нарвалов. Поставят рядом с ней человека - оп! И нет его, как корова языком слизала, прости за нелепое сравнение.";
		...
		case "dolly_4":
			dialog.text = "Недолюбливаю? Да я их терпеть не могу, грязных нехристей! Если хочешь знать, то мой дед был капитаном корабля, на котором эти черномазые во главе с проклятым богоотступником Ривадосом подняли бунт. Правильно сделал мой дед, что подвесил этого мерзкого бунтовщика в трюме. А ещё, у меня от деда оставалась реликвия - великолепный ключ от казны 'Санта-Анны'\nГде сейчас эта казна - никто не ведает, может, на дне среди крабов, но ключ этот был для меня как память - и тот украли! Я уверен, что это сделали черномазые. Наверняка думают найти казну. Ну, раз за столько лет никто не нашёл, то и они не отыщут, ха-ха! Негодяи...";
...
//--------------------------------------- блок вопросов и ответов ---------------------------------------------
		...
		case "ansewer_2":
			dialog.text = "Это не так, хотя на девяносто процентов ты прав. Но я не нарвал, и не желаю им становиться. Зачем? Чтобы стоять на часах, как дураку, и рубиться с ривадос? Нет уж, увольте. Я - человек совсем другого воспитания. Я предпочитаю жить независимо и посвящать всё свободное время чтению.";
			link.l1 = "Понятно...";
			link.l1.go = "int_quests";
		...
		case "ansewer_4":
			dialog.text = "Такие мысли регулярно посещают меня. Возможно, если бы тут появился надёжный корабль, способный пройти через течение и устоять в штормах, я бы рискнул. Мне жутко хочется взглянуть на то, что так занимательно описано в моих книгах! Но пока это только мечты...";
