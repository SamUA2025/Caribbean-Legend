...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "meeting_3":
			dialog.text = "На баркасе? Что-то слабо верится... Ну тогда вам вообще повезло, что вы прошли путь до Острова на такой скорлупе и не угодили в шторм. У нас на Острове штормит редко, а вот за его пределами шквал может налететь буквально как гром среди ясного неба\nТак что считайте себя счастливчиком и приспосабливайтесь к жизни на Острове! Потому как боюсь вас расстроить, но попасть сюда легко, а выбраться - практически невозможно. И не считайте это брюзжанием - за последние десять лет ещё никто не смог живым покинуть Остров.";
			link.l1 = "И всё-таки я приберегу немного оптимизма для себя. Рад знакомству, ещё увидимся!";
			link.l1.go = "exit";
			NextDiag.TempNode = "First time";
		break;
...
//--------------------------------------- блок вопросов и ответов ---------------------------------------------
		case "int_quests":
			...
			{
				link.l2 = "Вы давно тут живёте, как я понимаю?";
		...
		case "ansewer_3":
			dialog.text = "А что тут скажешь, молодой человек... разные все. Кого у нас только нет - белые, чёрные, индейцы, бывшие рабы и господа, каторжники и солдаты. А сколько их было раньше - всех не упомнить. У каждого своя история и свои склонности. Кому-то уже на всё наплевать, а кто-то горит ярым желанием уплыть назад. Так и живём...";
			link.l1 = "Интересно...";
			link.l1.go = "int_quests";
		...
		case "ansewer_4":
			dialog.text = "Самые интересные - это механик нарвалов, самоучка-изобретатель, оружейник нарвалов - герр Шмидт, кузнец от Бога, Санчо Карпентеро - прирождённый бармен. Ну, теперь ещё добавился адмирал пиратов и его старший помощник.";
			link.l1 = "Буду знать...";
			link.l1.go = "int_quests";
