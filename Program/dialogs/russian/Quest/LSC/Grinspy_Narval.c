...
void ProcessDialogEvent()
{
	...
	// ----------------------------------после разгрома Чада и Мэри на Каролине---------------------------
		...
		case "shark_3":
			dialog.text = "Надеюсь, адмирал отдаёт себе отчёт? Или он сомневается в том, что мои люди тоже умеют стрелять?";
		...
		case "negotiations":
			dialog.text = "По какому вопросу пожаловал?";
			link.l1 = "По достаточно неприятному, Дональд. На Стивена Додсона было совершено покушение. Причём бойцы твоего клана приняли в этом самое деятельное участие.";
