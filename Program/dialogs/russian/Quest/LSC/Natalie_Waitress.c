...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "meeting": // первая встреча
			dialog.text = "Недавно? Неужели ещё один корабль разбился? Что-то я ни о чём таком не слыхала... Или вы, как и месье Тьюрам, прибились сюда на обломке мачты? Ой, простите моё любопытство - женская натура, что поделать.";
			link.l1 = "Да нет, всё в порядке, Натали. Я доплыл сюда на баркасе, но он утонул. Приятно было познакомиться. Ещё увидимся!";
			link.l1.go = "exit";
			link.l2 = "Да нет, всё в порядке, Натали. Я хочу задать тебе пару вопросов об острове.";
			link.l2.go = "int_quests"; //информационный блок
			NextDiag.TempNode = "First time";
		break;
...
//--------------------------------------- блок вопросов и ответов ---------------------------------------------
		case "int_quests":
			...
			{
				link.l1 = "Ты работаешь в этой таверне. Что расскажешь о её хозяине?";
			...
			{
				link.l3 = "И много народу живёт на Острове?";
		...
		case "ansewer_1":
			dialog.text = "Только хорошее, "+GetAddress_Form(NPChar)+". У Санчо всегда большой ассортимент выпивки - от старых вин до простого рома и эля. В трюме одного из кораблей он несколько лет назад нашёл огромный запас марочных вин. Санчо два месяца на своём горбу перетаскивал ящики с бутылками себе в кладовку\nЗато теперь мы надолго обеспечены таким спиртным, которое на Архипелаге подаётся только губернаторам. А что касается рома - так этого добра ещё больше. Но кроме выпивки, вы всегда найдёте у нашего Санчо добрый совет, свежие новости и постель для ночлега.";
			link.l1 = "Понятно...";
		...
		case "ansewer_4":
			dialog.text = "А чему удивляться? Пополнения у нас нередки. Да и я сама толком не знаю, кто здесь и сколько живёт. Иногда вот вижу человека впервые - а он, оказывается, уже год как на Острове! Вот забавно, да?";
			link.l1 = "Да уж...";
			link.l1.go = "int_quests";
