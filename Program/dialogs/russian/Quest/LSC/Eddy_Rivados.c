...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Friend_1":
			dialog.text = "И он это сделал. Теперь ты можешь свободно посещать все корабли ривадос без каких-либо ограничений. Охрана не будет препятствовать, и мы будем рады видеть тебя в гостях. Но будь осторожен с нарвалами: они уже наверняка знают, что это именно ты спас Чимисета, и им это весьма не понравится, потому как они наши враги.";
		...
		case "capper_6":
			dialog.text = "Это похоже на ловушку... А если там ждёт засада? Если адмирал решил таким способом нанести удар по ривадос? Почему он сам не ликвидирует Каппера?";
		...
		case "chimiset_3":
			dialog.text = "Я признаю свою вину. Но мы не могли последовать за ним на корабли вражеского клана... Вместо головы Чада ты получишь дружбу и уважение ривадос. Отныне ты можешь всегда рассчитывать на нашу поддержку\nНаши корабли теперь открыты тебе для свободного прохода. Мудрость Чимисета, освобождённого с твоей помощью, тоже тебе пригодится. Поговори с ним, если у тебя в чём есть нужда. Также передай адмиралу мои заверения, что я оценил его поступок.";
			link.l1 = "Хорошо.";
