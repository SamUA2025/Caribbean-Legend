...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		case "First time":
			...
			{
				dialog.text = "Ты думаешь, почему меня не удивляет твоё чудесное спасение? Неисповедимы пути Господни, и его промысел нам неведом. Жизнь и смерть - всё в руках Его.";
			...
			{
				dialog.text = "Добро пожаловать в святую обитель нашего Острова, "+GetSexPhrase("сын мой","дочь моя")+". Если ты желаешь помолиться или посетить службу - двери церкви открыты для тебя. Я, брат Юлиан, рад каждому, кто приходит сюда для того, чтобы обратить свой взор к Господу нашему.";
			...
			else
			{
				...
				link.l2.go = "potion";
				link.l3 = "У вас нет на продажу освящённых предметов, брат Юлиан?";
				link.l3.go = "amulet";
				link.l5 = "Просто зашёл прочесть молитву и узнать, как у вас дела. Ещё увидимся!";
				link.l5.go = "exit";
			}
		...
		case "meeting": // первая встреча
			dialog.text = "Надеюсь, ты станешь посещать нашу церковь хотя бы изредка. Не забывай о душе, "+GetSexPhrase("сын мой","дочь моя")+". Также я могу облегчить не только твои духовные, но и телесные страдания - на нашем острове я выполняю роль не только пастыря, но и лекаря.";
			link.l1 = "Я хочу задать вам пару вопросов об острове.";
			link.l1.go = "int_quests"; //информационный блок
			...
			link.l3 = "У вас нет на продажу освящённых предметов, брат Юлиан?";
			link.l3.go = "amulet";
			link.l4 = "Мне пора, брат Юлиан. Ещё увидимся!";
			link.l4.go = "exit";
			NextDiag.TempNode = "First time";
		break;
		
		case "potion":
			dialog.text = "Конечно, "+GetSexPhrase("сын мой","дочь моя")+". Какое зелье ты желаешь приобрести?";
			...
			link.l5 = "Извините, брат Юлиан, я передумал"+GetSexPhrase("","а")+".";
			link.l5.go = "exit";
		break;
		...
		case "amulet":
			...
			if (bOk && GetSummonSkillFromName(pchar, SKILL_FORTUNE) > (10+drand(110)))
			{
				...
				if (PCharDublonsTotal() >= 10)
				{
					...
					link.l2 = "У меня уже есть такой оберег, брат Юлиан. Я подожду, пока у вас появится что-то ещё.";
			link.l2.go = "exit";
			...
			{
				dialog.text = "Нет, "+GetSexPhrase("сын мой","дочь моя")+", к сожалению, сейчас ничего нет. Зайди в другой день, возможно, у меня что-нибудь появится.";
		...
		case "amulet_pay":
			...
			PlaySound("interface\important_item.wav");
			dialog.text = "Спасибо, "+GetSexPhrase("сын мой","дочь моя")+". Твои деньги пойдут на благое дело. Возьми свою покупку, и да хранит тебя Господь!";
...
//--------------------------------------- блок вопросов и ответов ---------------------------------------------
		...
		case "ansewer_1":
			dialog.text = "Так же, как и многие другие, "+GetSexPhrase("сын мой","дочь моя")+". Судно, на котором я плыл из Гаваны в Новую Испанию, затонуло во время шторма. Милостью Господа нашего я остался в живых, и теперь служу во благо Ему, наставляя на путь истинный жителей этого клочка суши.";
			link.l1 = "Понятно...";
		...
		case "ansewer_2":
			dialog.text = "Меньше, чем хотелось бы. Большинство из клана нарвал предпочитают насилие милосердию, а ривадос - бедные заблудшие овцы. В слепости своей они практикуют языческие обряды, подвергая опасности свои бессмертные души. Среди ривадос есть опасный колдун, слуга тёмных сил, которого давно уже было бы пора предать справедливому суду Священной Инквизиции.";
			link.l1 = "Ясно...";
			link.l1.go = "int_quests";
		...
		case "ansewer_3":
			dialog.text = "У Санчо Карпентеро, владельца таверны на 'Флероне', вы найдёте еду, питьё и тёплую постель, у Акселя Йоста на 'Эсмеральде' - широкий ассортимент разнообразных товаров. Также поспрашивай на улицах, "+GetSexPhrase("сын мой","дочь моя")+" - люди часто находят на погибших кораблях внешнего кольца ценные вещи, которые готовы продать.";
			link.l1 = "Спасибо!";
			link.l1.go = "int_quests";
		...
		case "ansewer_4":
			dialog.text = "Всё в руках Господа нашего, "+GetSexPhrase("сын мой","дочь моя")+". Мы веруем в Него и уповаем на Него. До сих пор серьёзные потрясения обходили нас стороной - штормы часто бушуют вокруг Острова, но на нём самом как правило тихо и солнечно.";
