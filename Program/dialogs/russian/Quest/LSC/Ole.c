...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "store_5":
			dialog.text = "Я помню этого дяденьку. Это добрый человек. Я спас его. Я отвёл его к статуе. А вот недавно я спас ещё одного доброго человека, из трюма с едой, от злых дядек адмирала. Они бы убили его, если бы нашли там. Я хотел и его отвести к статуе, но он отказался. Совсем отказался.";
		...
		case "store_10":
			dialog.text = "Дядя Хенрик живёт среди злых дядей нарвалов. Его все знают. Он всё умеет. Он умеет ходить по дну и научил злых дядей нарвалов спускаться на дно. Дядя Хенрик добрый, он дал Оле белую бусинку.";
		...
		case "givemepearl_no_1":
			dialog.text = "Прощайте, дядя "+pchar.name+". Оле нужны белые бусинки, иначе он никогда не вернётся к маме...";
		...
		case "mother_2":
			...
			link.l1 = "Господи, что за чудная история... Ты ведь попал на Остров ещё ребёнком. Тебя что, мать выгнала из дома за порванное жемчужное ожерелье? И ты все эти годы собирал свои бусинки? Жуть какая-то...";
			link.l1.go = "mother_3";
		break;
		
		case "mother_3":
			dialog.text = "Отвези меня к маме, добрый дядя "+pchar.name+". Я так хочу её увидеть. Она обрадуется, когда увидит бусинки.";
			link.l1 = "Я бы отвёз, но где же твой дом, ты знаешь? Где живёт твоя мама?";
			link.l1.go = "mother_4";
		break;
		
		case "mother_4":
			dialog.text = "Она живёт на острове, в городе, в домике с красной крышей.";
		...
		case "mother_8":
			...
			LAi_ActorGoToLocation(npchar, "reload", "reload1", "none", "", "", "OpenTheDoors", 5.0);
			DeleteAttribute(npchar, "pearl_date");
			// ставим Агнес Кристиансен и открываем её дом в Мариго
		...
		case "home_3":
			...
			link.l1 = "Оле... Ты так вырос, но всё равно остался ребёнком... Дай я тебя обниму, сынок! Прости, прости меня пожалуйста, за то проклятое ожерелье! Больше я тебя никуда не отпущу, никогда! Мы будем жить с тобой вместе, я буду о тебе заботиться... Я искуплю свою вину, обещаю!..";
			link.l1.go = "home_4";
		break;
