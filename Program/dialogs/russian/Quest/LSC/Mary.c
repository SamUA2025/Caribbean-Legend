...
void ProcessDialogEvent()
{
	...
	// ---------------------------------покушение на Акулу - вариант M --------------------------------
		...
		case "letters":
			...
			link.l1 = "Мы натравили на него ривадос. Лейтон Декстер снял охрану с 'Тартаруса', я передал Чёрному Эдди ключ от тюрьмы, и негры отправились освобождать своего колдуна Чимисета. Но дали маху - убили каких-то двух нарвалов - дружков Каппера, а сам Чад сбежал и скрывается где-то на Острове, говорят, у вас.";
	...
	// --> взаимоотношения - секс и прочее
		...
		case "dolly_4":
			dialog.text = "Ты это всё серьёзно, или так шутишь надо мной?";
		...
		case "dolly_11":
			dialog.text = "(сквозь слёзы) Спрашиваешь... Конечно, поеду... Ты обязательно вернёшься, да? А как ты найдёшь Остров? Сюда никто, кроме адмирала, сам не доплывал!";
		...
		case "narval_5":
			dialog.text = "";
			link.l1 = "Дорогая наша девочка... Все нарвалы знают, какие испытания выпали на твою долю в последние дни. Я считаю, что ты достойна носить у себя на перевязи этот палаш, символ клана нарвал. Владей им с гордостью. Этот клинок будет грозой твоим врагам, и надёжно обережет тебя в бою.";
			link.l1.go = "narval_6";
		break;
		...
		case "talisman_1":
			...
			link.l1 = "Это ценный и очень редкий оберег. Спасибо тебе, дорогая!";
	...
	// --------------------------------------вернулся на Остров---------------------------------------------
		...
		case "adversary_2":
			...
			link.l1 = "А-а! Это Элен МакАртур. Она, как и Даниэль, оказалась замешана в этой путаной истории, и сейчас служит у меня офицером. Временно, конечно.";
		...
		case "adversary_5":
			if (CheckAttribute(npchar, "quest.blade31")) 
			{
				...
				notification("Тяжёлое оружие +", "Mary");
			}
			...
			link.l2 = "(отказать) Мэри! Быть офицером-абордажником - это очень и очень опасно! Ты не понимаешь, о чём просишь. Я не могу рисковать тобой.";
		...
		case "adversary_fail_1":
			dialog.text = "Я всё так поняла! Я видела, какими телячьими глазами она на тебя смотрит. Она не просто твой офицер, да! Мне всё понятно (всхлипывает). Конечно, куда мне до неё, она же умеет кораблём управлять...";
		...
		case "adversary_hire":
			...
			else
			{
				...
				link.l1 = "Господи, Мэри, милая, да ты как ребёнок. Ещё минуту назад слёзы ручьём, а теперь улыбаешься! И, Мэри: ты мне не просто офицер, если что.";
		...
		case "adversary_hire_no": // Мэри не пойдёт, пока не ГГ не расстанется с Элен. Выбирай, кто тебе милее...
			dialog.text = "Потому что может ты и считаешь её только своим офицером, да вот она считает тебя не только своим капитаном. Я видела, какими телячьими глазами она на тебя смотрит... Я прекрасно знаю, что означает такой взгляд, да!";
		...
		case "adversary_hire_yes_2":
			...
			link.l1 = "(смеётся) Да, как Даниэль и Натаниэль.";
		...
		case "adversary_hire_yes_3":
			...
			link.l1 = "Милая Мэри... Ты ведь меня ещё совсем мало знаешь. Но такая постановка вопроса мне очень и очень по душе - мы ещё вернёмся к этому разговору. Ну а теперь твоё пребывание на этом корабельном кладбище окончено - добро пожаловать на моё судно и в большой мир, дорогая!";
	...
	// --> консультации по морским сражениям
		...
		case "sea_bomb_3":
			dialog.text = "Рискнём, "+pchar.name+"?";
		...
		case "fugas":
			dialog.text = "Да, конечно, дорогой. Я всегда готова помочь, да! О чём пойдёт речь?";
		...
		case "on_coast_1":
			dialog.text = "Когда мы зашли в капитанскую каюту, ты валялся на полу точно мёртвый. У меня чуть сердце не выпрыгнуло, да! Ребята подхватили тебя и потащили на наш корабль, и вовремя, потому что эти проклятые дохляки, что валялись на палубе, начали подниматься и снова хвататься за сабли\nЭто просто кошмар какой-то, да! С ними невозможно справиться! Мы быстренько обрубили лини и отвалили от этой гнилой посудины, но далеко уйти не смогли: костлявые черти всадили в нас залп бортовой батареи, и наше судно в один миг потеряло управление. Это дьяволы какие-то, да! А затем они подняли свою рванину и в мгновение ока скрылись за горизонтом\nКорабль наш зарылся в мель, а все, кто выжил, добрались на лодке до берега. Я не знала, спасётся ли корабль или нет, так что прихватила твой капитанский рундук из каюты с твоими вещами. Это было нелегко в такой суматохе, чёрт побери, да!";
		...
		case "on_coast_4":
			dialog.text = "Ещё бы... Это был 'Летучий Голландец', да? Почему они на нас напали? И почему сразу не сделали ни одного выстрела, а после абордажа чуть не утопили одним залпом?";
	...
	// --> Мэри вне LSC
		...
		case "GoldenGirl_1":
			...
			link.l1 = "Мэри, успокойся, я не затем туда иду, это же не бордель... вернее, конечно бордель, но, будь я проклят, я же дворянин и человек слова, неужели ты мне настолько не доверяешь? Губернатор попросил оказать ему небольшую услугу и всё!";
		...
		case "GoldenGirl_3":
			dialog.text = "Передышка нам точно не помешает, да. Но как ты думаешь, дама в английском мундире это высшее общество сильно шокирует? Представляешь эти шепотки по углам? Может, кто даже в обморок упадёт, вот будет веселье, да?";
			link.l1 = "Мэри, радость моя, это не тот приём, на который берут дам... своих дам. Ну, в общем, это всё немного сложно, но я постараюсь объяснить...";
			link.l1.go = "GoldenGirl_4";
		break;
		
		case "GoldenGirl_4":
			dialog.text = "Ой, не трудись, да. Скажи прямо - я не того полета птичка, чтобы красоваться перед всякими кружевными уродами. Так, девчушка для развлечений, но на людях с такой показаться стыдно, да? Не гожусь для красивых приёмов, правда ведь, благородный месье Шарль де Мор?";
			link.l1 = "Послушай, дело не в этом. Ты замечательная, и мне плевать, кто и как на меня с тобой посмотрит. Просто губернатор пытается, как всегда, решить свои дела, а я тут навроде ценного трофея. Интересный гость для впечатления салонных балбесов.";
			link.l1.go = "GoldenGirl_5";
		break;
		
		case "GoldenGirl_5":
			dialog.text = "Значит не гожусь, да? Ну всё ясно, никаких проблем, благородные с благородными, а нам простолюдинам свои нехитрые развлечения. Удачи тебе в 'приличном обществе'. Вернёшься на грешную землю, договорим, да.";
			link.l1 = "Мэри, куда ты! Проклятье...";
		...
		case "GoldenGirl_10":
			dialog.text = "Удачи тебе в 'приличном обществе'. Вернёшься на грешную землю, договорим, да.";
		...
		case "GoldenGirl_13":
			...
			link.l1 = "Мэри, я тебе всё расскажу, но позже. Сейчас мне надо привести себя в порядок и отправляться на дуэль. Если я её переживу - тогда и поговорим - сочтёшь нужным - сможешь в меня выстрелить. А пока - присмотри за нашим новым кораблём, ладно? Я выиграл его этой ночью.";
			link.l1.go = "GoldenGirl_14";
		break;
		
		case "GoldenGirl_14":
			dialog.text = "Подожди с кораблём, что там про дуэль, да? Об этом горожане несут такую чушь, что я и не поверила - то ли с сыном короля, то ли с самим Папой Римским. Рассказывай сейчас, что за чертовщина тут творится?!";
		...
		case "GoldenGirl_15":
			...
			link.l1 = "Я должен это сделать, и губернатор назначил мне секундантов из числа благородных офицеров, чтобы исключить любые сомнения после дуэли. Я не могу взять ни тебя, ни кого-то из ребят. Дело очень серьёзное, прости.";
			link.l1.go = "GoldenGirl_16";
		break;
		
		case "GoldenGirl_16":
			dialog.text = "Знаешь что, я сейчас сделаю? Я пойду на этот чёртов корабль, и как следует выпью, да! Делай что хочешь, но, если этот высокородный выродок тебя не убьёт - клянусь всеми ветрами, это сделаю я!";
			link.l1 = "Мэри, всё будет в порядке, поверь мне. Ну постой... Проклятье! Опять?!";
			link.l1.go = "GoldenGirl_21";
		break;
		
		case "GoldenGirl_17":
			dialog.text = "Ты за целые сутки даже не нашёл времени подать весточку, да? Мы, как с утра услышали о чём на рынке болтают, чуть не поседели все. Играл в карты на корабли и женщин, нарвался на какую-то дуэль, то ли с наследным принцем, то ли с Папой Римским! Что, чёрт возьми, здесь вообще творится?!";
			link.l1 = "Много всего, Мэри, долго объяснять. Я действительно выиграл целый фрегат. Тебе придётся за ним присмотреть, пока я буду решать спор с его бывшим владельцем.";
		...
		case "GoldenGirl_18":
			...
			link.l1 = "Мне пришлось. Долго объяснять, но я выиграл его корабль и его... даму. А он, обвинил меня в мошенничестве прилюдно и вызвал на дуэль. Этот человек - бастард  крайне могущественного вельможи, графа де Леви Вантадура, и мне придётся изо всех сил постараться, чтобы не убить его на дуэли.";
			link.l1.go = "GoldenGirl_19";
		break;
		
		case "GoldenGirl_19":
			dialog.text = "Даму?! Играть в карты на корабль, я ещё могу себе представить, но... женщина, да? Значит на улицах не врут. И ты так спокойно мне об этом говоришь?! Словно я тебе... матрос какой-нибудь, да?!";
			link.l1 = "Проклятье, Мэри, всё не так! Он выиграл её у губернатора, а я у него, просто чтобы освободить, вот и всё. Никакой задней мысли, клянусь!";
			link.l1.go = "GoldenGirl_20";
		break;
		
		case "GoldenGirl_20":
			dialog.text = "Ну, может, у благородных это и в порядке вещей, но я-то не из таких, да. Говори что хочешь, и делай что хочешь... можешь пойти и умереть за эту... даму, коли тебе так хочется. А я пойду на этот чёртов корабль и хорошенько выпью. А я так верила, что это всё навсегда... так надеялась!";
		...
		case "GoldenGirl_24":
			dialog.text = "Шарль, ты всё же спас меня, да! Я чуть не перестала надеяться! Я так рада тебя видеть!";
			link.l1 = "И я рад, Мэри! Я места себе не находил всё это время. Хвала Господу, с тобой всё в порядке!";
		...
		case "GoldenGirl_25":
			...
			{
				dialog.text = "А что ты вообще сделал, что меня отпустили вот так запросто? Без драки, без пальбы, да! И я видела каких то расфуфыренных англичан на палубе, когда меня выводили. Что там вообще произошло, Шарль?";
			}
		...
		case "GoldenGirl_26":
			dialog.text = "Уже смогла, Шарль. И ты прости меня, да! Если бы я так не расстроилась из-за той мадамы и, хотя бы, расставила вахту на фрегате... Они бы нас так легко не взяли, да! Глупо всё вышло!";
			link.l1 = "Всё вышло как вышло, и это уже в прошлом. Ты вернулась ко мне, и это всё, о чём я смел мечтать последние недели. Я люблю тебя, и больше никогда не оставлю. Обещаю!";
		...
		case "GoldenGirl_28_1":
			if (pchar.questTemp.GoldenGirl == "alarm_fin")
			{
				dialog.text = "Ну и история вышла, кому рассказать - не поверят, да! А я с самого начала чувствовала, что этот твой 'непринужденный вечер' плохо пахнет! Все они там высокородные на голову... того, а вместо сердца - кошелёк с дублонами! Хорошо, что ты не такой, да!";
				link.l1 = "Уверен, есть много людей, считающих, что я ещё хуже. Добротное такое чудовище, как из сказок.";
			}
			else
			{
		...
		case "GoldenGirl_29":
			if (pchar.questTemp.GoldenGirl == "alarm_fin")
			{
				dialog.text = "Это неважно - ведь ты моё чудовище, Шарль! А все остальные могут пойти и поплакать по этому поводу, или будут иметь дело со мной! Помни - я всегда на твоей стороне, да!";
			}
			else
			{
			...
			link.l1 = "Мэри, я в этом никогда не сомневался. Пойдём, команда заждалась. Надо поднимать паруса и убираться отсюда. Ты снова со мной, а горизонт сам к себе не поплывет!";
		...
		case "GoldenGirl_32":
			...
			link.l1 = "Это ты меня прости, я и подумать не мог, что всё так обернется... Слава Богу, ты жива, Мэри! Как же я рад!";
			link.l1.go = "GoldenGirl_33";
		break;
		
		case "GoldenGirl_33":
			dialog.text = "Насчёт простить - сказать по правде, я не знаю, чего хочу больше - обнять тебя, или пристрелить. Ты же расскажешь, что это, чёрт возьми, было вообще, да?";
			link.l1 = "Я люблю тебя Мэри. Именно это я и хотел сказать.";
			link.l1.go = "GoldenGirl_34";
		break;
		
		case "GoldenGirl_34":
			dialog.text = "Ну да, это многое объясняет, но... Чёрт, я тоже, Шарль! Я тоже тебя люблю, да! Наконец, мы снова вместе!";
			link.l1 = "Да. Пойдём, сегодня я тебя не оставлю, даже если небо начнёт рушиться на этот город, будь он неладен. Я тебя вообще больше не оставлю. Никогда.";
		...
		case "GoldenGirl_37":
			dialog.text = "А твоя маркиза? Ты её тоже вернул? Португалец о ней очень хорошего мнения. И заверил меня, что ты выдержал все её осады не хуже Бастилии. Я хочу ему верить, да, но ты должен мне это прямо сказать, Шарль!";
			link.l1 = "Нас с мадам Бото ничего не связывает, Мэри. Я помог ей, она помогла мне вернуть тебя, вот и всё. Кстати, а где же Бартоломео?";
			link.l1.go = "GoldenGirl_38";
		break;
		
		case "GoldenGirl_38":
			dialog.text = "Он отбыл, да. Почти сразу, как доставил меня сюда. В дом этой маркизы я не пошла бы и под пушечным дулом, и он снял мне комнату тут. Оплатил на пару недель вперёд и исчез, даже не попрощавшись. Ой, я совсем забыла, да! Он же оставил письмо для тебя!";
			link.l1 = "Письмо? Бартоломью Португалец? Это что-то новенькое. Меня терзают смутные сомнения...";
			link.l1.go = "GoldenGirl_39";
		break;
		
		case "GoldenGirl_39":
			dialog.text = "Ладно, ты читай, а я побегу - покажусь нашим, а то мы ещё сутки тут просидим. Они же тоже волновались, да? И я по ним всем страшно соскучилась! Все же живы? Надеюсь, ты не против, если мы пропустим по чарке внизу? Только смотри, не влипни в очередное безобразие, да!";
			link.l1 = "Конечно, но поосторожней там с ними - этот вечер я бы не хотел тратить на перетаскивание пьяных тел на корабль. Мэри, неужели я всё-таки тебя вернул!? Поверить не могу!";
		...
		case "LongHappy":
			...
			dialog.text = "Морской берег, ты, я, и хорошее вино - Шарль, это так романтично! Нам стоило бы почаще вот так выбираться вдвоём, да!";
		...
		case "LongHappy_1":
			dialog.text = "Ты о чём? Что-то случилось с кораблём, да? Почему у тебя такое лицо?";
		...
		case "LongHappy_2":
			...
			else
			{
				...
				link.l1 = "Ты сделала меня счастливым, Мэри. И я хочу выпить за тебя, моё жгучее солнце Кариб!";
		...
		case "LongHappy_4":
			...
			link.l1 = "Но всё это только начало - за нас! И за наше будущее вместе, то ли ещё будет!!";
		...
		case "LongHappy_7":
			...
			link.l1 = "Мэри, я люблю тебя в любом наряде и... ну, ты знаешь. Можешь выглядеть как пожелаешь, пусть попробуют что-нибудь сказать! Но, я как раз хотел посоветоваться с тобой о гостях и церемонии.";
		...
		case "LongHappy_8":
			...
			{
			dialog.text = "Знаешь - большинство тех, кто могут искренне порадоваться нашему счастью в этот город на порог не пустят, не то что в церковь, да. Потому - давай обвенчаемся здесь со всеми важными лицами, как положено, а потом махнём на Исла Тесоро и как следует отпразднуем с настоящими друзьями! Что думаешь, да?";
			link.l1 = "А это выход! Так и поступим. С Аббатом Бенуа я поговорю, но нам надо разослать приглашения, и ещё...";
			link.l1.go = "LongHappy_9";
			}
			else // Сага провалена по времени или утоплен Центурион
			{
				dialog.text = "Знаешь - у меня не так много друзей, кроме наших ребят из команды. Так что приглашай тех, кого сочтёшь нужным, а я просто буду счастливой, да!";
				link.l1 = "Как скажешь, милая. С аббатом Бенуа я поговорю, и всё организую, ты достойна самой пышной церемонии.";
				link.l1.go = "LongHappy_9a";
			}
		break;
		
		case "LongHappy_9":
			dialog.text = "Не беспокойся, как хорошая жена, я возьму часть руководства на себя, да. Я напишу нашим друзьям, и всё устрою, но сначала скажи: каким ты видишь этот праздник?";
		...
		case "LongHappy_9b":
			dialog.text = "Всё, я спокойна, да. Прости - это всё так необычно. Но Шарль, как хорошая жена, давай я возьму часть организации на себя. Ребятам тоже надо устроить праздник, да, а вряд ли вся команда поместится в церковь. Я договорюсь с таверной, но нам потребуется выпивка и деньги - ты же знаешь, как кутят моряки.";
		...
		case "LongHappy_10":
			...
			dialog.text = "Поняла, сделаем. Но - нам придётся заскочить в Шарптаун и всё подготовить. Думаю, мы уложимся в полсотни бочонков рома и пару десятков бочек вина, да. Но, на всякий случай, мне понадобится тысяч триста серебром.";
			link.l1 = "Немало, но и повод особенный - я всё добуду, не беспокойся. Сейчас заскочу к аббату и отправляемся в Шарптаун.";
			link.l1.go = "LongHappy_12";
		break;
		
		case "LongHappy_11":
			pchar.questTemp.LongHappy.BigMarry = "true";
			dialog.text = "Отлично, мы соберём всех, да! Но - нам придётся заскочить в Шарптаун и всё подготовить - потребуется целый галеон выпивки! Я думаю, сотни бочонков рома и полсотни бочек вина должно хватить. Но, на всякий случай, я бы добавила тысяч пятьсот серебром - если праздник закончится быстро, какой же это праздник, да?";
			link.l1 = "Да, наши друзья не должны умереть от жажды - я всё достану, не беспокойся! Сейчас заскочу к аббату и отправляемся в Шарптаун.";
			link.l1.go = "LongHappy_12";
		break;
		...
		case "LongHappy_13":
			dialog.text = "Всё готово, Шарль, да? Я распоряжусь чтобы сгружали выпивку, схожу договорюсь с местной таверной, проведаю барона и передам письма. Ты подождёшь здесь, да?";
			link.l1 = "Ты за штурвалом, милая! А я просто немного побездельничаю. Вот уж не думал, что к экспедиции в джунгли Мэйна подготовиться проще чем к свадьбе.";
		...
		case "LongHappy_15":
			dialog.text = "Здесь мы закончили, Шарль, да! Я всё устроила, поверь мне - это будет замечательно! Одно смущает: таверна здешняя, сгорела во время какой-то пирушки с неделю назад. Но её почти отстроили заново, больше и лучше, чем прежняя, да! Должны все поместиться.";
			link.l1 = "Главное будет не сжечь ещё и эту. Мне ведь нравился 'Старый дятел'! Как бы то ни было - нам ещё многое надо успеть. Пора отчаливать. И да, Мэри - ты лучшая, ты же знаешь?";
		...
		case "LongHappy_17":
			dialog.text = "Ну вот и всё, да? Гости прибыли, церковь готова. Я знаю, мы давно ближе чем многие супруги, и это лишь несколько важных слов в красивой зале, но будь я проклята - в том древнем городе жутких аборигенов я волновалась меньше, да!";
		...
		case "LongHappy_18":
			...
			link.l1 = "Мэри, милая, для меня дороги назад нет с тех пор, как мы встретились. Я жду этого дня всем сердцем. Не волнуйся, всё будет прекрасно.";
		...
		case "LongHappy_26":
			dialog.text = "";
			link.l1 = "Я, Шарль, Анри де Мор, шевалье де Монпе, беру тебя, Мэри Каспер, в законные жёны, и клянусь хранить верность в счастье и в несчастии, в болезни и в здравии, а также любить и уважать тебя все отпущенные мне дни.";
		...
		case "LongHappy_32":
			if (CheckAttribute(pchar, "questTemp.LongHappy.MarrySP")) dialog.text = "Спасибо, Шарль, спасибо... Это всё так торжественно и прекрасно! Это самый лучший день в моей жизни, да!! Смотри, какие все кругом счастливые! Но - тебе же пора обойти гостей, и принять поздравления! Как закончишь - возвращайся - заглянем к ребятам в таверну.";
			else dialog.text = "Спасибо, Шарль, спасибо... Это всё так торжественно и прекрасно! Это самый лучший день в моей жизни, да!! Смотри, какие все кругом счастливые! Но - тебе же пора обойти гостей, и принять поздравления! Как закончишь - возвращайся - в Шарптауне нас уже заждались.";
			link.l1 = "Так и сделаю, милая. Один поцелуй и я пошёл!";
		...
		case "LongHappy_35":
			...
			{
				dialog.text = "Да, да! Мне тоже столько всякого приятного наговорили! Не все, конечно - кое-кто явно удивлён моим нарядом, да! Но я так счастлива, что половину не успеваю даже услышать. И в целом все такие милые. Шарль, нас уже заждались ребята в таверне - мы заглянем к ним? Они будут счастливы поздравить своего капитана, да!";
			...
			{
			dialog.text = "Да, да! Мне тоже столько всякого приятного наговорили! Не все, конечно - кое-кто явно удивлён моим нарядом, да! Но я так счастлива, что половину не успеваю даже услышать. И в целом все такие милые. Шарль! Нас же заждались в Шарптауне, когда отплываем?";
		...
		case "LongHappy_36":
			...
			if (CheckAttribute(pchar, "questTemp.LongHappy.MarrySP")) link.l1 = "Знаю. Я тоже тебя люблю. Пойдём, пока парни не выдули весь ром и не подпалили таверну.";
		...
		case "LongHappy_41":
			dialog.text = "Я в порядке, да! Что с Натаном, он мёртв?";
		...
		case "LongHappy_44":
			dialog.text = "Мы победили, да! Прости, что не успела, Шарль - там ещё дюжина этих крабьих пащенков под шканцами пряталась - пришлось повозиться!";
		...
		case "LongHappy_45":
			...
			link.l1 = "Ты права, солнце моё, иди, я сразу за тобой.";
		...
		case "LongHappy_47":
			dialog.text = "Приложили его крепко, но жить будет. Нашего барона так просто не проймёшь, да! Едва очнулся, а уже рвётся в бой.";
		...
		case "LongHappy_49":
			if (CheckAttribute(pchar, "questTemp.LongHappy.Tichingitu_died") && CheckAttribute(pchar, "questTemp.LongHappy.Jino_died"))
			{
				...
				link.l1 = "Всё будет хорошо, милая, всё будет хорошо. Мне тоже грустно. Но мы победили, а Жак Барбазон заплатил за всё содеянное.";
		...
		case "LongHappy_50":
			dialog.text = "Да ты же на ногах не стоишь, да! Пойдём, Данни нашла нам домик тут на окраине - не хочу сейчас возвращаться на корабль. Посидим, помянем наших друзей. Всё это как то слишком на трезвую голову, да.";
			link.l1 = "Да, Мэри, пойдём.";
		...
		case "LongHappy_52":
			...
			{
				dialog.text = "Прости, что задержалась, муж мой, да! Повидался с Хоуком, или Данни тебя не пустила? Она и меня выставила, когда Джино сказал что опасность миновала, да! Я так рада, что всё обошлось!";
		...
		case "LongHappy_53":
			dialog.text = "Шарль, я вижу, что ты на ногах не стоишь, но Тичингиту так и не нашёлся - я весь город обошла - ни следа!";
			link.l1 = "Ян дал мне кое-какую наводку... Кажется мне, наш суровый маског пошёл вразнос. Давай-ка прогуляемся до бухты Сабу Матила - кое-кто видел его, ушедшего в том направлении.";
		...
		case "LongHappy_55":
			dialog.text = "Ну даёт наш суровый абориген, да!  Пойдём, Данни нашла нам домик тут на окраине - ты же уже спишь на ходу, Шарль, да!";
			link.l1 = "Есть такое... похищай меня, моя прекрасная скво. И пусть завтра это всё покажется дурным сном.";
		...
		case "LongHappy_57":
			dialog.text = "Не пойми меня неправильно, муж мой, в церкви всё было просто роскошно, но здесь атмосфера явно душевнее, да! Ну что ж, вот и всё, Шарль  - теперь все хлопоты позади, можно и расслабиться.";
			link.l1 = "Ну, хвала Господу, не совсем ещё 'всё', жена моя - наша с тобой жизнь продолжается! Она вообще, можно сказать, сегодня началась. Так что, пойдём, выпьем с ребятами, а потом - ну, ты помнишь: каюта, вино, и мы вдвоём...";
		...
		// Jason Исла Мона
		case "IslaMona":
			dialog.text = "А вот я возражаю если что, да! Родриго, лучше следи, чтобы они сидели по домам, вышивали и вообще!";
		...
		case "IslaMona_4":
			dialog.text = "Ха-ха, Шарль!";
			link.l1 = "Мэри, опять что-то задумала?";
			link.l1.go = "IslaMona_5";
		break;
		
		case "IslaMona_5":
			dialog.text = "(хитро улыбается) Задумала-задумала. Но сначала хотела сказать тебе кое-что. Знаешь, а ведь Алан и я хотели построить на Острове примерно то же, что ты сделал здесь.";
			link.l1 = "Милроу? Твой?..";
			link.l1.go = "IslaMona_6";
		break;
		
		case "IslaMona_6":
			dialog.text = "Да... Мечтатель и фантазер. Вы бы с ним подружились, да!";
			link.l1 = "Ну в одном-то вкусы у нас точно сходятся!";
			link.l1.go = "IslaMona_7";
		break;
		
		case "IslaMona_7":
			dialog.text = "Что? Ах-ха-ха! Прекрати!\nВ любом случае, это так здорово - мы подарили этим людям счастье!";
			link.l1 = "Мы подарили им шанс на счастье, но обрели они его сами. Так что ты задумала?";
			link.l1.go = "IslaMona_8";
		break;
		
		case "IslaMona_8":
			dialog.text = "Найди меня после и узнаешь...";
			link.l1 = "Куда я денусь.";
		...
		case "tonzag_jailed":
			dialog.text = "А мне нравится темнота и теснота. Так я чувствую себя спокойно. Можно наконец собраться с мыслями\nКак будто все заботы и тревоги... пропали, да! Мне очень не хватает этого чувства...";
			link.l1 = "Тебе надо к врачу.";
			link.l1.go = "tonzag_jailed_1";
			link.l2 = "Ага. Считай, домой на 'Церес Смити' вернулась.";
			link.l2.go = "tonzag_jailed_2";
			locCameraFromToPos(-15.50, 2.28, -1.23, true, -27.00, -10.60, -22.70);
		break;

		case "tonzag_jailed_1":
			dialog.text = "... Только жаль, что я не одна. В тишине, в темноте и в одиночестве, да. Вот так идеально.";
			link.l1 = "Так держать, Мэри Каспер.";
			link.l1.go = "exit";
		break;

		case "tonzag_jailed_2":
			dialog.text = "Однажды ко мне в постель залез краб, я его порезала и сожрала. Да.";
			link.l1 = "Так держать, Мэри Каспер.";
			link.l1.go = "exit";
		break;
		
		case "tonzag_aftershot":
			dialog.text = "Паскуда масочная! А-ать! Дорогой, помоги - надо сломать решетку!";
			link.l1 = "Тихо! Я пытаюсь понять, что нам делать!!";
			link.l1.go = "exit";
		...
		case "tonzag_after_boarding":
			dialog.text = "Дорогой, эти черти в масках уже повсюду! Они проделали огромную дырищу в корпусе и лезут в неё, как те крабы! Надо порубить их всех, да!";
			link.l1 = "Мэри, оставайся тут, найди старшего офицера и командуйте! Уводите корабль из боя, второй десант мы не выдержим!";
			link.l1.go = "tonzag_after_boarding_1";
			DelLandQuestMark(npchar);
		break;
		
		case "tonzag_after_boarding_1":
			dialog.text = "А ты куда? Не пущу тебя, да!";
			link.l1 = "Мне надо выручать Эркюля и помочь нашим! Верь мне, Мэри!";
			link.l1.go = "tonzag_after_boarding_2";
		break;

		case "tonzag_after_boarding_2":
			dialog.text = "Так точно, дорогой!";
			link.l1 = "";
			link.l1.go = "exit";
		...
		case "tonzag_after_victory":
			dialog.text = "Победа, да! Иди ко мне, милый! Я хочу тебя на часок-другой!";
			link.l1 = "Э...";
		...
		case "tonzag_after_victory_1":
			dialog.text = "Ой, Эркюль! Седая борода, как же я рада видеть тебя!";
			link.l1 = "";
			link.l1.go = "exit";
		...
		case "tonzag_after_victory_2":
			dialog.text = "";
			link.l1 = "Мэри, Мэри, погоди! Мне нужен твой доклад!";
			link.l1.go = "tonzag_after_victory_3";
		break;

		case "tonzag_after_victory_3":
			dialog.text = "А? Ну, мы победили, да! Корабль тот мерзкий сбежал. Одному уроду я полбашки снесла, да!\nП-ф-ф, чёртовы пуговицы!";
			link.l1 = "Ох, Мэри...";
			link.l1.go = "exit";
		...
		case "tonzag_dead":
			dialog.text = "Боже, не смотри на меня, милый! Меня сейчас... уф!";
			link.l1 = "Держись, девочка. Я рядом!";
			link.l1.go = "exit";
