...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		case "First time":
			...
			{
				dialog.text = ""+pchar.name+"! Как же я рад тебя видеть! Я знал, я знал, что эти слухи - лживые! Чёрт возьми, за это надо немедленно выпить!";
			...
			{
				dialog.text = ""+pchar.name+", я сожалею о твоём проигрыше. Этого толстяка редко кому удавалось обыграть. Сильно голова болит?";
			...
			{
				dialog.text = "Ну, ты дал жару этому толстяку Фацио, "+pchar.name+"! Я, право, удивлён - мало кому удавалось обыграть его. Я искренне рад твоей победе. Вот, держи свои двести дублонов.";
				link.l1 = "Спасибо за тёплые слова, дружище!";
			...
			{
				dialog.text = ""+pchar.name+"? Тут слушок прошёл, что ты спускался на дно в водолазном костюме механика нарвалов. Это правда, или, как обычно, бабские сплетни?";
			...
			{
				dialog.text = "Приветствую нового человека в моей таверне! Добро пожаловать! У меня вы всегда найдёте что выпить - благо, мои винные погреба полны - а вот насчёт закусить - это уже сложнее, ха-ха... Шучу. Меня зовут Санчо Карпентеро, и я хозяин этой таверны.";
			...
			else
			{
				...
				link.l5 = "Нет, приятель. Я просто зашёл проведать тебя.";
				link.l5.go = "exit";
			}
		...
		case "meeting":
			...
			link.l4 = "Ещё увидимся, Санчо!";
			link.l4.go = "exit";
			NextDiag.TempNode = "First time";
		break;
		
		case "mushket":
			dialog.text = "Нет, дружище, не подскажу. Знаешь ли, я специалист по пивным кружкам и винным бутылкам, но никак не по мушкетам, ха-ха! Спроси в магазине, как я слышал, у Йоста в продаже периодически появляются неплохие образцы оружия. Может, что и подберёшь себе.";
		...
		// виски для Акулы
		case "whiskey":
			dialog.text = "Каппер? Нет. Он в последнее время даже не заходил ко мне. Но пузырёк мышьяка у меня буквально четверть часа назад купил Марчелло Циклоп - его тоже замучили крысы. Как я его понимаю... Житья от них нет, проклятых.";
		...
		case "whiskey_2":
			dialog.text = "Он уходил вместе с Адольфом Барбье, что живёт на 'Санта-Флорентине'. Наверное, к нему и пошли.";
			link.l1 = "Спасибо!";
			link.l1.go = "whiskey_3";
		break;
		
		case "whiskey_3":
			dialog.text = "Если тебе нужен мышьяк - могу продать пузырёк за два десятка дублонов.";
			link.l1 = "Хорошо. Вернёмся к этому разговору позже, Санчо. Бывай!";
		...
		// пей до дна
		case "drunk_fail":
			dialog.text = "Да Бог с тобой, приятель! Ничего ты мне не должен. Ты и так облегчил свой карман на сотню дублонов. Зря ты пошёл на поводу у Фацио...";
		...
		case "crab_1":
			dialog.text = "Если тебе вдруг придётся вступить с крабом в схватку и ты убьёшь его, то можешь отрезать у него клешни и принести мне. Я очень хорошо заплачу за них. Буду платить даже не песо, а дублонами - по пять монет за штуку. Аксель Йост столько не заплатит, поверь. Нет, я не подбиваю тебя охотиться на крабов, ты не подумай, но если вдруг доведётся...";
		...
		case "crab_trade_1":
			dialog.text = "Забираю. Вот, держи свои дублоны - "+FindRussianQtyString(iTotalTemp*5)+". Спасибо, приятель, если добудешь ещё клешней - обязательно приноси!";
		...
		case "rat_1":
			PlaySound("interface\important_item.wav");
			dialog.text = "Она... Точно - она! Именно такую мне и нарисовал моряк, рассказывавший о ней! Дружище, ты ведь не просто так принёс её мне, правда? Что ты за неё хочешь? Сколько?";
			link.l1 = "Ну конечно, не просто так. Что я хочу? Не знаю. А что ты предлагаешь? Помнится, ты обещал вознаградить по-царски...";
			link.l1.go = "rat_2";
			link.l2 = "Извини, приятель, но я её не продаю. Она нужна мне самому. Просто я хотел убедиться, что это действительно тот самый оберег.";
			link.l2.go = "rat_exit";
		break;
		
		case "rat_exit":
			PlaySound("interface\important_item.wav");
			dialog.text = "Эх, какая жалость... Да, парень, скорее всего, это и есть тот самый талисман. Везунчик! Теперь тебе можно не бояться крыс. А я всё так и буду травить их мышьяком...";
		...
		case "rat_2":
			dialog.text = ""+pchar.name+", а за неё ты получишь возможность купить самый лучший и дорогой предмет, который у меня есть. Бравому вояке, вроде тебя, будет отличной заменой этому оберегу. Сейчас принесу\nВот, посмотри: уникальная, великолепная миланская кираса штучной работы! Отлично защищает в бою, практически не сковывает движений, лёгкая, удобная. Таких на Карибах днём с огнём не сыскать, да и в Европе редкость\nЯ нашёл этот доспех в капитанской каюте одного испанского военного корабля несколько лет назад и хранил специально для такого случая. Я продам тебе её за две тысячи золотых и Крысиного Бога!";
			...
			link.l1.go = "rat_yes";
			link.l2 = "Сколько? Санчо, тебя крысы успели с утра уже покусать? Какие две тысячи? Ты хоть знаешь чего мне стоило достать тебе этого идола? Сбивай цену сейчас же!";
			link.l2.go = "rat_torg";
			link.l3 = "Ско-олько?! Ну и жук ты, Санчо! 'Получишь возможность купить'! Ха! Да за такие деньги я на большой земле закажу себе такую броню, что и пули в лоб стреляющим отражать, и лечить меня будет! На кой чёрт тебе столько золота? Статую свою отлить у Юргена и в полный рост на 'Сан Августине' выставить?";
			link.l3.go = "rat_no";
		break;
		
		case "rat_yes":
			dialog.text = "Я рад, что ты согласился, дружище. Спасибо тебе и за то, что не забыл про мою проблему! Тогда жду свои дублоны. Доспех тебя будет ждать.";
			link.l1 = "Скоро принесу!";
		...
		case "rat_torg":
			if(GetSummonSkillFromName(pchar, SKILL_COMMERCE) < 60)
			{
				...
				dialog.text = ""+pchar.name+", с другого я бы стребовал пять тысяч. Сам адмирал уже интересовался, да и не только он, уж поверь. Как надумаешь, подходи. Доспех тебя будет ждать сколько нужно, продам я его только тебе.";
				link.l1 = "Я подумаю, Санчо. Крепко подумаю.";
				link.l1.go = "rat_yes_1";
			...
			else
			{
				...
				dialog.text = ""+pchar.name+", с другого я бы стребовал пять тысяч. Сам адмирал уже интересовался, да и не только он, уж поверь. Ладно, скину на пятьсот, всё же ты не забыл обо мне и моей проблеме. Я ведь вижу, что без приключений не обошлось.";
				link.l1 = "Уже лучше. Но я всё равно не понимаю почему это я должен доплачивать при обмене одного уникального предмета на другой? Может, это тебе стоит мне доплатить, а Санчо?";
		...
		case "rat_yes_1500":
			...
			{
				notification("Недостаточно развит навык (90)", SKILL_COMMERCE);
				dialog.text = "Нет, не выйдет, "+pchar.name+". Крыс я могу и мышьяком травить, а тебе этот доспех жизнь спасёт однажды. Да и выглядеть будешь в нём, что твой итальянский дож. Полторы тысячи, моя последняя цена. Как надумаешь, подходи. Доспех тебя будет ждать сколько нужно, продам я его только тебе.";
				link.l1 = "Санчо, не был бы ты единственным тавернщиком на этом безрадостном кладбище... Я подумаю над твоим предложением.";
			...
			{
				notification("Проверка пройдена", SKILL_COMMERCE);
				dialog.text = "Вроде военный капитан и пират, а торгуешься лучше Йоста! А тот, знаешь ли, однажды ухитрился скупить у меня весь мышьяк по дешёвке. И это при том, что крысы уже тогда меня мучили. Уболтал ты меня, "+pchar.name+", скидываю ещё на пятьсот! И ниже не пойду!";
				link.l1 = "Всё равно грабёж, но теперь хоть типичной девкой в джунглях себя чувствовать не буду. Жди деньги, скоро принесу.";
		...
		case "rat_no":
			dialog.text = "Успокойся, "+pchar.name+". С другого я бы стребовал все пять тысяч! Сам адмирал уже интересовался, да и не только он, уж поверь. Доспех тебя будет ждать сколько нужно. Это тоже входит в цену идола.";
			link.l1 = "Вот это честь! Сиди, бокалы свои протирай, а я пойду. Две тысячи!";
			link.l1.go = "rat_yes_1";
		break;
		...
		case "rat_3":
			dialog.text = "Я рад, что ты согласился, дружище. Спасибо тебе за то, что не забыл про мою проблему! Держи кирасу, и пусть она служит тебе надёжной защитой в бою.";
			link.l1 = "Держи и ты свой оберег - похоже, для крыс в твоей таверне наступают чёрные дни!";
			link.l1.go = "rat_4";
		break;
		...
		case "ansewer_1":
			dialog.text = "Место? Ну, его называют Островом Справедливости, Островом Погибших Кораблей, но мы его зовём просто Остров. Состоит из остовов разбитых кораблей, осевших на мелководье среди рифов. Центральная часть Острова приспособлена под жилые помещения, а внешнее кольцо - необитаемо. Связи с внешним миром уже лет десять как нет.";
			link.l1 = "Понятно...";
		...
		case "ansewer_2":
			dialog.text = "Построить лодку или плот. Но закончится это плохо для тебя: за внешним кольцом - аномальная зона штормов. Сильный шквал может налететь в любую минуту, и твоему утлому челну придёт конец. К тому же, Остров огибает сильное течение, которое прибивает сюда новые корабли, так что тебе придётся здорово потрудиться, сидя на вёслах, пока преодолеешь его\nВ одиночку это у тебя не выйдет - проверено не раз. А помощников ты навряд ли найдёшь, потому как всем известно, что покидать Остров на жалкой лодке равносильно самоубийству. А построить хороший корабль, который сумеет пройти сквозь течение и устоять перед штормом - сложно в наших условиях, несмотря на обилие корабельных остовов\nК тому же, надо ещё будет вывести построенный корабль за пределы внешнего кольца и провести через рифы, а это задача, скажу тебе прямо - невыполнимая. Так что лучше привыкай к жизни у нас\nСкажу по секрету: все, кто пожил здесь хотя бы три-четыре года, оставляют свои помыслы о возврате назад, и не потому, что отчаялись, а потому, что здесь ничуть не хуже, а для большинства - лучше, чем на Большой земле. Поспрашивай у людей - тут очень мало тех, кто хочет покинуть Остров.";
			link.l1 = "Ясно...";
			link.l1.go = "int_quests";
		...
		case "ansewer_4":
			dialog.text = "Ты знаешь, дружище, нормально. До того, как я попал на Остров, вся моя деятельность была связана с едой и выпивкой: работал поваром, ещё в Европе, интендантом в гарнизоне, корчмарём, коком на корабле. А когда попал сюда - уже полтора десятка лет прошло с этого момента - сразу занялся организацией таверны\nМне моя работа нравится, да и жизнью вполне доволен. Люди тут в большинстве своём дружелюбные, или, по крайней мере - не буйные, кланы в мою деятельность не вмешиваются. По вечерам у меня бывает многолюдно - то с одним поговоришь, то с другим... В общем, это лучшее место, которое было у меня в жизни. Я сам себе хозяин\nЕдинственное, что меня донимает - это крысы. Совсем замучали, проклятые, житья от них нет. Грызут, портят мои продукты и посуду. Никак изничтожить их не могу.";
			link.l1 = "Крысы? Да, это бич для всех...";
			link.l1.go = "ansewer_4_1";
		break;
		
		case "ansewer_4_1":
			dialog.text = "Увы, но мне 'везёт' больше других. Если на прочих кораблях крыс умеренное количество, а в магазине Акселя Йоста их вообще нет - не знаю, как он ухитрился их вывести - то у меня этих проклятых грызунов буквально полчища. Эх, рассказывали мне моряки, что на Карибах встречается редкий оберег\n'Крысиный бог' называется. Вроде как маска в виде морды летучей мыши. Говорят, что при наличии этого предмета крысы разбегаются без оглядки. Видимо, Акселю кто-то продал такой амулет - он скупает и перепродаёт весь хлам, что люди находят на внешнем кольце\nПринёс бы мне кто такой оберег - честное слово, отблагодарил бы по-царски!";
			link.l1 = "Интересно...";
			link.l1.go = "int_quests";
		...
		case "drink_sit":
			...
			{
				dialog.text = "Хех, ну ты точно чудак, право... Разве тебе не с кем скоротать время на Острове? Дружище, да меня потом Мэри просто изведёт, если узнает, что я позволил тебе тут просиживать в одиночку и напиваться. Приходите вечером вдвоём и балагурьте, хоть до самого утра.";
				link.l1 = "Ладно...";
				link.l1.go = "exit";
			}
			else
		...
		case "room":
			...
			if (CheckAttribute(pchar, "questTemp.LSC.MaryBye") || CheckAttribute(pchar, "questTemp.LSC.MaryWait")) // подружился с Мэри
			{
				if(!isDay())
				{
					dialog.text = "Такого чудака я ещё не встречал. Его ждёт на 'Церес Смити' замечательная девушка, а он в таверну ночевать припёрся. Даже не думай, что я тебе позволю у меня спать. Мэри потом меня со свету сживёт.";
					link.l1 = "Ладно...";
					link.l1.go = "exit";
				}
				else
				{
					dialog.text = "Можешь отдохнуть у меня наверху до вечера. Но ночевать здесь я тебе не позволю - Мэри меня потом со свету сживёт. Ты уж извини...";
