	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Jurgen":
			...
			if (CheckAttribute(npchar, "quest.narval_blade") && npchar.quest.narval_blade == "ferrum")
			{
				...
				{
					link.l5 = "Гляньте сюда, Юрген. Я нашёл интересный слиток железа на дне, но он весит гораздо больше, чем вы говорили - в нём не меньше пяти фунтов.";
		...
		case "blade_done":
			...
			link.l1 = "Рапиры. Люблю изящное лёгкое оружие.";
			link.l1.go = "rapier";
