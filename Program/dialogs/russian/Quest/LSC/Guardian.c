...
//------------------------------------- фразы гардов нарвалов --------------------------------------------
		...
		case "Narval_warning_no":
			dialog.text = "Тогда тебе нечего там делать, если ты, конечно, не решил таким способом свести счёты с жизнью. Или ты шутишь, а? Смеёшься надо мной? Впрочем, меня это не интересует. Можешь идти вниз, моё дело предупреждать, а не задерживать. Но если ты действительно не знаешь пароля - назад ты уже не выйдешь.";
			link.l1 = "Хорошо, дружище. Я учту.";
			link.l1.go = "exit";
			NextDiag.TempNode = "Narval_warning_repeat";
		break;
...
//------------------------------------- фразы гардов ривадос --------------------------------------------
		...
		case "Rcheck_parol":
			dialog.text = "Тогда говори пароль, и говори ясно и чётко.";
			link.l1.edit = 3;
			link.l1 = "";	
...
//------------------------------------- фразы гардов пиратов --------------------------------------------	
		...
		case "first_talk_night":
			dialog.text = NPCStringReactionRepeat("Ты что, с луны свалился, или перепил? Разворачивайся назад и топай по висячему мосту, пройди прямо через два корабля - найдёшь ещё одни висячие мостки, они приведут тебя к таверне. Там и спи себе до утра.", 
