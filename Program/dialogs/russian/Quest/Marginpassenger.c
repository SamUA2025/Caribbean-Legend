void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "MarginCap_2":
			...
			{
				dialog.text = "Пожалуй, у меня нет выбора. Судьба всего экипажа важнее судьбы одного человека. Но вам это так просто с рук не сойдёт, имейте это в виду! Я это так не оставлю!";
				link.l1 = "Не кипятитесь, удар хватит... Приведите сюда моего нового пассажира!";
				link.l1.go = "MarginCap_3";
			}
			else
			{
				dialog.text = "Убирались бы вы на своё корыто, сударь, пока я вам это позволяю. Нечего тут меня пугать. Только посмейте атаковать моё судно - получите достойный отпор. Проваливайте, пока я окончательно не вышел из себя!";
		...
		case "MarginCap_4":
			...
			AddQuestUserData("Marginpassenger", "sSex1", GetSexPhrase("","ла"));
		...
		case "MarginCap_repeat":
			dialog.text = "Мы уже всё обсудили, не так ли? Убирайтесь с моего судна!";
			link.l1 = "...";
			link.l1.go = "exit";
		...
		case "MarginCap_abordage_2":
			dialog.text = "И только ради этого ты учинил резню на моём судне? Погибло столько людей! Ах ты, гнусный негодяй!";
			link.l1 = "Меньше громких слов, сударь...";
			link.l1.go = "MarginCap_abordage_3";
		break;
		...
		case "MarginNeed_2":
			...
			{
				case "woman":
					dialog.text = "Да, я знаю эту девушку... Ещё бы! А в чём дело?";
					link.l1 = "Она попала в одну неприятную историю: корабль, на котором она путешествовала, захватили пираты. Волею счастливого случая я абордировал корабль этих пиратов и освободил бедняжку. Она назвала мне ваше имя - вот я и пришёл к вам.";
					link.l1.go = "MarginNeed_woman";
				break;
				case "man":
					dialog.text = "Да, я хорошо знаю этого человека. А в чём дело?";
					link.l1 = "Он попал в одну неприятную историю: корабль, на котором он путешествовал, захватили пираты. Волею счастливого случая я абордировал корабль этих пиратов и освободил пленника. Он назвал мне ваше имя - вот я и пришёл к вам.";
		...
		case "MarginNeed_woman":
			dialog.text = "Какой ужас! Где она сейчас? И почему вы не привели её с собой?";
			link.l1 = "Она в безопасности. Что касается вашего второго вопроса - тут немного сложнее. Я мог бы отвезти её домой сам, но учитывая то, что вы... что она вам небезразлична, то я мог бы уступить эту возможность вам. За скромное вознаграждение, конечно.";
		...
		case "MarginNeed_man":
			...
			link.l1 = "Он в безопасности. Что касается вашего второго вопроса - тут немного сложнее. Я мог бы отвезти его домой сам, но учитывая то, что вы... что у вас есть определённые интересы в отношении его семьи, я мог бы уступить эту возможность вам. За скромное вознаграждение, конечно.";
		...
		if (iTemp > 0 && iTemp <= iSum)
		{
			...
			else
			{
				...
				link.l1 = "Хм. Нужны, конечно, дублоны, но, думаю, хозяин верфи возьмёт и песо... Давайте песо.";
		...
		{
			dialog.text = "К сожалению, такой суммы у меня нет. Так что при всём своём желании я не смогу пойти на ваше предложение. Прощайте!";
			link.l1 = "Гм...";
			link.l1.go = "MarginNeed_exit";
			break;
		}
		...
		{
			dialog.text = "Сударь, вы отдаёте себе отчёт? Вы вообще представляете, какие это деньги? Убирайтесь к чёрту!";
			link.l1 = "Гм...";
			link.l1.go = "MarginNeed_exit";
			break;
		}
			dialog.text = "М-да... Сударь, вам стоит обратиться к лекарю, и немедленно. У вас определённо жар, или... впрочем, вам в любом случае требуется квалифицированная помощь. А мне тут некогда с вами. Прощайте!";
			link.l1 = "Гм...";
			link.l1.go = "MarginNeed_exit";
		break;
		...
		case "MarginNeed_peso":
			dialog.text = "Вот сумма в пересчёте на песо, которую вы хотите... Где "+pchar.GenQuest.Marginpassenger.q1Name+"?";
			link.l1 = "Должно быть, уже на пирсе. Так что идите, принимайте пассажира.";
		...
		case "MarginNeed_dublon_exit":
			dialog.text = "Тогда я при всём своём желании не смогу пойти на ваше предложение. Прощайте!";
			link.l1 = "Гм...";
			link.l1.go = "MarginNeed_exit";
		break;
		...
		case "MarginPass":
			...
			link.l1 = "Всё очень просто, "+NPCharSexPhrase(NPChar, "приятель","милочка")+". Ты отправляешься на мой корабль в качестве почётного пассажира... с охраной. Сопротивляться не стоит, потому что в противном случае я отправлю тебя в трюм.";
