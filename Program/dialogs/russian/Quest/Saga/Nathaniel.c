...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "diffindoor":
			...
			dialog.text = "А... кто ты такой, чёрт подери?.. Кхе.. аха-ха-хах! Проклятая слабость...";
			link.l1 = "Здравствуй, Натаниэль. Ведь это ты - Натаниэль Хоук?";
			link.l1.go = "diffindoor_1";
		break;
		
		case "diffindoor_1":
			dialog.text = "Да, это я, если можно так сказать. Я был когда-то Натаниэлем Хоуком, а теперь я просто мешок с навозом. Будь она неладна, эта чёртова статуя! Она выпила из меня всю жизнь.";
			link.l1 = "Знакомое чувство...";
			link.l1.go = "diffindoor_2";
		break;
		
		case "diffindoor_2":
			dialog.text = "Да как же оно может быть тебе знакомо, парень, если ты даже не понимаешь, о чём я говорю? А-а-гх... Каково это - быть абсолютно здоровым и полным сил, а спустя какую-то минуту превратиться в немощного старика, неспособного даже самостоятельно двигаться\nЯ много повидал на свете, и после того заброшенного индейского храма я думал, что меня уже ничто не удивит, но это... Я должен был догадаться! Этот коварный истукан точь-в-точь похож на тот проклятый идол, который открывал проход в храм!";
			link.l1 = "Ладно, Натан, давай поговорим. Представлюсь - "+GetFullName(pchar)+". Начнём с того, что я прекрасно тебя понимаю, потому что я пришёл сюда тем же путём, что и ты - через портал Кукулькана.";
		...
		case "diffindoor_5":
			...
			dialog.text = "Спасения? Ох... Ты разве не видишь, в каком я состоянии? Я даже саблю поднять не могу. Разве можно назвать это спасением? Слава Богу, что есть ещё на свете добрые души. Оле, благослови его Господь... Ты знаешь Оле? ";
			link.l1 = "Да. Он мне и рассказал о тебе: и как тебя нашёл, и что кормит тебя жареными крысами, и что ты глушишь ром бутылку за бутылкой...";
			link.l1.go = "diffindoor_6";
		break;
		
		case "diffindoor_6":
			dialog.text = "Если я не буду пить ром, я отправлюсь на тот свет быстрее, чем успеет сгореть свеча. Только он ещё как-то поддерживает мои силы. Ром...";
			link.l1 = "Тебе всё так же плохо? Как и после телепортации?";
			link.l1.go = "diffindoor_7";
		break;
		
		case "diffindoor_7":
			dialog.text = "Ну, не совсем, чтобы так... Но немногим лучше. Да, парень, объясни наконец, зачем старый Натан тебе сдался? Какого чёрта ты явился сюда, на это полусгнившее корыто? Чтобы поболтать со мной?";
		...
		case "diffindoor_8":
			dialog.text = "Чёрт возьми... Лесной Дьявол? А-а-гх... Ты пришёл, чтобы добить меня? Или нет? Для простого убийцы ты слишком разговорчив. Прошу - не надо никаких пыток. Если тебе приказано что-то из меня вытянуть - я сам всё расскажу, мне скрывать нечего.";
			link.l1 = "Ты это сейчас о чём? А-а, понятно. Ты, как и Даниэль, решил, что это Свенсон организовал на тебя засаду в сельве? Уверяю, Ян ни при чём. Напротив, он на твоей стороне, и сильно переживает по поводу твоего исчезновения.";
		...
		case "diffindoor_9":
			...
			link.l1 = "Честно говоря, подробностей дела я не знаю, но уверен, что за всем стоит Джекман. Слишком много совпадений: сначала Блейз, потом ты... Джекман рвётся к власти и устраняет всех, кто стоит у него на пути. Сейчас он возглавляет Марун-Таун, вместо тебя.";
			link.l1.go = "diffindoor_10";
		break;
		
		case "diffindoor_10":
			dialog.text = "Джекман? Вот ублюдок! Эх.. В последние годы Братство стало разрозненным, не то, что в былые времена. Захария совсем свихнулся на почве религии, Тираксу на всё наплевать, а Барбазона интересуют только дублоны в его сундуках. Двадцать лет назад всё было совсем иначе...";
			link.l1 = "Тебя взяли в плен? Расскажи подробнее.";
			link.l1.go = "diffindoor_11";
		break;
		
		case "diffindoor_11":
			dialog.text = "А что там рассказывать! Как я уже сказал - бандиты к нашему приходу подготовились заранее. Они действовали чётко и слаженно, и явно выполняли чей-то приказ. Меня могли сто раз прикончить, но они этого не сделали. Я им нужен был живым. Они отвели меня на заброшенный рудник и заперли в одной из хижин - как они сказали, 'до приезда босса'\nЯ думал, что 'босс' - это Свенсон, но с твоих слов выходит, что тут поработал Джекман. Что ему от меня было нужно - ума не приложу, но уверен, что долго после разговора с ним я бы не прожил.";
		...
		case "diffindoor_12":
			dialog.text = "Каким-то образом на рудник проник этот индеец, Змеиный Глаз. Как я понял, мискито сильно недолюбливают этих бандитов. В общем, благодаря этому, или ещё какой-то своей причуде, Змеиный Глаз помог мне бежать: ночью устроил подкоп под хижину, пробрался внутрь, перерезал верёвки, связывавшие меня, и мы вместе ушли в сельву\nОн решил отвести меня в свою деревню, к мискито. Но видать я сильно был нужен Джекману, так как была отряжена самая настоящая погоня. Бандиты шли за нами по пятам. Змеиный Глаз петлял, запутывал следы, но они всё равно находили нас. Видимо, они хорошие следопыты\nИ когда мы уже были на подходе к деревне мискито, бандиты настигли нас. Я два дня ничего не ел и совершенно выбился из сил, а кроме того, сильно ушиб ногу и хромал. Была полночь, и я как сейчас помню эту яркую звезду, сияющую над истуканом посреди джунглей... Змеиный Глаз сказал, что мой единственный шанс спастись - добежать до статуи и прикоснуться к ней\nЯ счёл это бредом, но тем не менее, утопающий хватается за соломинку, ведь так? Я доковылял до истукана и прислонился к нему. И тут... это было что-то невообразимое!";
			link.l1 = "Можешь не объяснять - я знаю, что там творилось.";
			link.l1.go = "diffindoor_13";
		break;
		
		case "diffindoor_13":
			dialog.text = "Очнулся я в мокром трюме разрушенного корабля. Не было ни капли сил. Я мог передвигаться только ползком. С каждой минутой становилось всё хуже. Оле появился вовремя - он влил в меня какую-то травяную дрянь, по вкусу - карибская микстура, смесь противоядия и лечебной эссенции, а затем дал рому\nСразу стало легче. А затем, воспользовавшись куском бревна, перетянул меня по воде сюда, на этот треснувший корабль. Вот я и живу теперь здесь, уже даже не знаю, сколько, так как потерял счёт времени.";
			link.l1 = "Всё будет хорошо, Натан. У нас со Свенсоном большие планы, и ты играешь в них одну из ключевых ролей. Тебе следует вернуться на своё место в Марун-Таун, а о подлеце Джекмане мы позаботимся.";
			link.l1.go = "diffindoor_14";
		break;
		
		case "diffindoor_14":
			dialog.text = "В Марун-Таун? И как ты себе это представляешь, парень? Посмотри на меня: пропитанная ромом развалина! Куда уж мне... Нет, годы моего правления Марун-Тауном ушли навсегда и безвозвратно. Я заперт на этом проклятом кладбище кораблей, и, видимо, навеки. Сколько я ещё протяну? Месяц, два, год?\nА потом так и останусь лежать на этих гнилых досках, а Оле спустит то, что останется от Натаниэля Хоука, в море. Но что меня больше всего угнетает, так это то, что я больше никогда не увижу свою Данни. Эх, всё кончено, приятель.";
		...
		case "diffindoor_15":
			...
			link.l1 = "Нет. Я уйду отсюда тем же путём, как и пришёл: через портал Кукулькана. Я знаю, где находится статуя... ну, приблизительно. Я отыщу её, а затем вернусь сюда на корабле за тобой и Акулой Додсоном. А потом отправимся к Змеиному Глазу - он быстро поставит тебя на ноги.";
		...
		case "diffindoor_17":
			dialog.text = "И не надо. Не хочу, чтобы он видел меня таким. Говоришь, шаман вылечит меня? Слабо в это верю... Кстати, ты говорил что-то про Данни... Ты видел её?";
		...
		case "diffindoor_18":
			dialog.text = "Эх, моя милая Данечка! Всё такая же, ничуть не меняется: чуть что - сразу за саблю и на палубу... Ты даже не представляешь, как бы я хотел сейчас её увидеть и обнять! Я обо многом думал, пока валялся здесь. Понимаешь, дружище, когда находишься при смерти, всё, что есть, и что было, предстаёт совсем в ином свете. Как же недостаточно времени я уделял своей жене!\nМорские походы, дела Берегового братства, управление Марун-Тауном. А она всегда поддерживала меня во всём: оставалась неделями одна, ругалась с пиратами в моё отсутствие, самостоятельно выходила в море, командуя нашим кораблём... Моя Данни - лучшая жена на свете! А я... я так редко говорил ей, что люблю её!\nЯ часто вспоминаю тот день, когда мы признались друг другу в любви и решили быть вместе! Кстати, именно тогда я впервые столкнулся с необъяснимыми явлениями и потусторонней силой, и всему виной был проклятый идол, так похожий на эти статуи. Рассказать тебе? Очень занятная история.";
		...
		case "story_1":
			dialog.text = "Каменная плита ушла на несколько дюймов вниз, а одна из стен поднялась и открыла проход дальше. Идол остался в плите, он намертво влип в неё - я так и не смог его вытащить. Мы пошли в глубь храма и после долгих плутаний попали в огромный зал. Вот это была красота!\nТакого величественного сооружения я ещё не встречал: стены усеяны затейливыми письменами, кругом огромные статуи. Мы обыскали весь зал, но сокровищ не было и следа.";
			link.l1 = "Хех, ну конечно, так часто и случается у людей нашей профессии: много усилий - ноль результата...";
			link.l1.go = "story_2";
		break;
		
		case "story_2":
			dialog.text = "Результат был. В конце-концов мы вышли в колонный зал, в конце которого стояла огромная статуя в виде птицы. Около её подножия переливался таинственный свет, вроде того, что горел над истуканом в полночь. Мы подошли ближе. Над небольшим постаментом, прямо в воздухе, висел красивый призрачный шар. Клянусь, что не вру!\nОн был реален и в то же время... совсем нереален. Пока я размышлял, что да как, Данни... ох уж эта смелая чертовка! - прикоснулась к шару. Он тут же засиял ярче, начал уменьшаться в размерах, материализовался в сферический артефакт и остался у неё в руках. И тут...";
			link.l1 = "...";
			link.l1.go = "exit";
		...
		case "story_4":
			...
			link.l1 = "Ещё бы полгода назад я назвал бы тебя вруном. Но я уже пожил достаточно на Карибах, и многое повидал, так что не доверять тебе нет оснований. Продолжай. Как вы спаслись?";
			link.l1.go = "story_5";
		break;
		...
		case "story_5":
			...
			link.l1 = "Хех! Значит, вместо сокровищ вы получили какой-то странный артефакт? Отличная, а главное - равноценная замена, хе-хе... А применение этому артефакту ты нашёл? Или он оказался бесполезен?";
			link.l1.go = "story_6";
		break;
		...
		case "story_8":
			...
			link.l1 = "Кто же не слышал о 'Летучем Голландце'! С одним таким голландцем я лично столкнулся и отправил его капитана на дно морское: он оказался самым обыкновенным пиратом, разукрасившим своё судно всякой маскарадной чепухой, вроде водорослей и драных парусов.";
			link.l1.go = "story_9";
		break;
		...
		case "story_12":
			dialog.text = "Данни подняла вверх артефакт и выпустила его. Почему она так сделала - я не знаю. Как она объяснила потом - женская интуиция... Артефакт не упал. Он снова превратился в призрачный шар и засиял, словно солнце. Наконец он вспыхнул, озарив окрестности, и исчез\nКогда мы убрали руки от глаз, то увидели, что корабль-призрак дал огромную трещину прямо посередине и стоит, беспомощно хлопая рваными парусами, а скелеты, словно ослеплённые, в беспорядке бегают по палубе. Я приказал открыть огонь\nПервый бортовой залп наших пушек заставил Голландца содрогнуться. Мы успели сделать поворот оверштаг и всадить в их трухлявый корпус ядра ещё одной бортовой батареи, пока они оправились от воздействия артефакта и атаковали нас...";
			link.l1 = "Тебе всё же пришлось сражаться с ними?";
			link.l1.go = "story_13";
		break;
		
		case "story_13":
			dialog.text = "Пришлось. И, клянусь громом, это был самый тяжёлый бой в моей жизни. Их проклятая лоханка, расколотая напополам, едва держалась на воде, но они успели разнести мне полкорпуса, пока мы не накрыли их метким залпом, взорвавшим крюйт-камеру.";
			link.l1 = "Так ты потопил его? Ты потопил 'Летучего Голландца'?";
			link.l1.go = "story_14";
		break;
		
		case "story_14":
			dialog.text = "Да, чёрт возьми! Мы потопили его!..";
			link.l1 = "...";
			link.l1.go = "exit";
		...
		case "story_17":
			dialog.text = "Э-э, дружище, ты видать, совсем ничего не знаешь... Ван дер Декена можно потопить, но убить его - нельзя. Проклятие, тяготеющее над ним, его командой и кораблём, сильнее самой смерти...";
			link.l1 = "...";
			link.l1.go = "exit";
		...
		case "story_17_1":
			dialog.text = "Может, и герой, да только Ван дер Декена нельзя убить. Проклятие, тяготеющее над ним, его командой и кораблём, сильнее самой смерти...";
			link.l1 = "...";
			link.l1.go = "exit";
			pchar.questTemp.LSC.Natanstory = "VDDrepair";
			AddDialogExitQuest("Video_story");
		...
		case "story_18":
			dialog.text = "Будучи потопленными, они чинят свой корабль, поднимают на поверхность и вновь отправляются в своё плавание, которому не будет конца.";
			if (CheckAttribute(pchar, "questTemp.KhaelRoa"))
			{
		...
		case "story_21":
			...
			link.l1 = "А я бы отправился... Ладно, спасибо за интересный рассказ! Теперь буду знать немного больше о твоей жене. Вы вдвоём и впрямь - живая легенда!";
			link.l1.go = "diffindoor_19";
		break;
		
		case "story_22":
			dialog.text = "Ты это о чём сейчас, приятель? Разве ты не понял - его нельзя убить!";
			link.l1 = "Натаниэль, я был на Хаэль Роа. И в храме чавинцев, куда вы с Даниэль и каким-то стариком проникли четверть века назад, тоже был. Артефакт, который вы прихватили с собой, назывался 'шар восходящего солнца'. Именно он и привлёк внимание 'Летучего Голландца'. Он падок на чавинские артефакты.";
			link.l1.go = "story_23";
		break;
		
		case "story_23":
			dialog.text = "Ты был на Хаэль Роа? Не может быть! Это правда?";
			link.l1 = "Клянусь. Как только ты рассказал про лабиринт и огромную статую птицы, я сразу понял, что это за место. О твоих похождениях мне поведал шаман карибов Туттуатхапак. Он-то и отправил меня на остров. Он восточнее Сент-Кристофера, маленький, в виде кольца, везде скалы, а внутри небольшая бухта. От пляжа одна-единственная заросшая тропа ведёт к храму в виде пирамиды.";
			link.l1.go = "story_24";
		break;
		
		case "story_24":
			dialog.text = "Всё верно! Это Хаэль Роа. А зачем ты туда пошёл?";
			link.l1 = "Чтобы снять заклятие с Калеуче... ну, 'Летучего Голландца'. На самом деле, он назывался 'Летящее сердце', а капитана звали Бальтазар де Кордес. Его проклял полвека назад индейский бог смерти Юм Симиль. Я отнёс в храм нефритовый череп Юм Симиля, украденный когда-то этим Бальтазаром, и положил на тот самый постамент перед статуей кондора...";
			link.l1.go = "story_25";
		break;
		
		case "story_25":
			dialog.text = "";
			link.l1 = "...вернув череп, я снял проклятие с Калеуче. А так как со мной были ещё два чавинских амулета, он их почуял, и напал прямо у берегов острова, совсем, как на тебя. Да только с проклятием слетело с него и бессмертие, как и сказал Туттуатхапак. Так что... нет больше 'Летучего Голландца'. Я лично об этом позаботился.";
			link.l1.go = "story_26";
		break;
		
		case "story_26":
			dialog.text = "Разрази меня гром! Я поражён! Ты... ты и впрямь не обманываешь старого Натана? Нет, я вижу, твои глаза не лгут! Да ты - герой!";
			link.l1 = "Ну, герой, или не герой, а приключений повидал немало, как и ты. Ладно, мы с тобой ещё потом поболтаем о прошлом, раз у нас есть общая тема.";
			link.l1.go = "diffindoor_19";
			DeleteAttribute(pchar, "questTemp.LSC.Natanstory");
		break;
		...
		case "diffindoor_19":
			...
			link.l1 = "Да, Натан. Держись, я тебя очень прошу. Береги себя. Главное - выживи до моего возвращения, а потом всё будет хорошо. Ты нужен Береговому братству, и ты очень нужен Даниэль.";
			link.l1.go = "diffindoor_20";
		break;
		
		case "diffindoor_20":
			dialog.text = "Данни сейчас у тебя в команде? Умоляю, присматривай за ней. Она с юности почти не изменилась - всё такая же сорвиголова, полезет в самое пекло без колебаний. И передай ей, когда увидишь, что я очень сильно её люблю...";
		...
		case "diffindoor_wait":
			dialog.text = "А, это ты, "+pchar.name+". Ещё не выбрался с острова?";
			link.l1 = "Не беспокойся, Натан, всё идёт по плану. Отдыхай.";
			link.l1.go = "exit";
		...
		case "danny_2":
			dialog.text = "Спасибо тебе, друг. Спасибо за всё, и в особенности - за Данечку...";
		...
		// в Марун-Тауне
		case "marun_town":
			dialog.text = "Кто к нам пришёл! Это же "+GetFullName(pchar)+" собственной персоной! Проходи, проходи, дружище! Как ты?";
		...
		case "marun_town_1":
			...
			dialog.text = "Да, шаман действительно оказался чудотворцем. Я чувствую себя лучше, чем до того злосчастного телепорта! Я словно помолодел лет на десять!.. "+pchar.name+", я в неоплатном долгу перед тобой. Я поражён: ты помогал мне, по сути незнакомому тебе человеку, совершенно бескорыстно, прошёл через адский портал, вытащил меня из лап смерти, вернул мне жену!\nНет, ещё не всё! Ты вернул нам с Данни наш корабль и... этот дом. Ты наш лучший друг. Навсегда. Если тебе что-то будет нужно - ты знаешь, к кому обратиться! В Марун-Тауне ты всегда найдёшь защиту, поддержку, и если понадобится - укрытие\nВесь посёлок встанет на твою сторону в случае опасности. А в мирное время тебя здесь ждёт дружеское тепло, самый лучший ром, мягкая постель и приятный отдых. Мы с Данни об этом позаботимся.";
		...
		case "marun_town_4":
			...
			link.l1 = "Спасибо, всё хорошо! Просто зашёл повидать вас.";
			link.l1.go = "exit";
			NextDiag.TempNode = "marun_town_4";
		break;
		...
		case "caleuche_3":
			dialog.text = "Ох... Я не могу тебе отказать, дружище, но... ты не представляешь, что мы там с Данни пережили! Хаэль Роа находится севернее Сент-Кристофера, а его карту я нашёл сразу по возвращении в Марун-Таун, она вот тут... (смотрит) Итак, координаты: 19 градусов 25 минут северной широты, 62 градуса 8 минут западной долготы.";
			link.l1 = "Я запишу в журнал... Спасибо, Натан!";
			link.l1.go = "caleuche_4";
		break;
		
		case "caleuche_4":
			dialog.text = "Не благодари... Теперь подробности. Остров Хаэль Роа представляет собой скалистое кольцо с бухтой внутри. Ищи проход среди скал - там довольно глубоко. В бухте отдашь якорь и высадишься на пляж. Ищи старую тропу в глубь острова, она там одна. Тропа приведёт тебя к индейской пирамиде - это и есть нужный тебе храм\nСам остров тихий и пустынный, а вот в храме скрывается всякая мерзость. Вход в него наверху пирамиды. Внутри будет три прохода - иди в средний. Проходишь по коридору и попадаешь на площадку с четырьмя входами-выходами. Вот там меня в первый раз и атаковала храмовая нечисть, так что будь внимателен\nДальше начинается лабиринт. Он очень запутанный, и я в жизни не вспомню правильный путь. Да, и в нём полным-полно всякой погани. Твоя задача - перебить её, подняться наверх и попасть в зал с двумя входами, шестью колоннами и площадкой из девяти каменных плит - это преддверие святилища. Каменная дверь в него закрыта, и как ты её откроешь - не представляю\nТам есть какой-то механизм, но не пить мне рому до конца дней, если я что-то в нём понял! У меня был ключ - идол, я вставил его в центральную каменную плиту, и дверь открылась. Но у тебя идола нет, так что придётся что-то мудрить и пытаться понять, как работает подъёмник двери.";
			link.l1 = "Буду разбираться. Что в святилище?";
			link.l1.go = "caleuche_5";
		break;
		
		case "caleuche_5":
			dialog.text = "Святилище - огромный зал с высоченным потолком и большими каменными лестницами. Вот только пользоваться ими нельзя - от старости они во многих местах обвалились. Но строители храма, видать, были не только мастера на все руки, но и колдуны знатные. Там есть что-то вроде порталов Кукулькана, через которые тебя перекидывает с места на место\nТы легко узнаешь их - они светятся разноцветными завихрениями. На первом этаже будет два портала, один из них - ловушка, но какой из двух - не помню, так что будь готов ко всему! Нужный портал перенесёт тебя на второй этаж. Там ищешь ещё один портал, и перемещаешься выше, а потом - в самое сердце храма\nТам, у огромной статуи в виде птицы, мы с Данни и забрали магический артефакт. Что было потом - я тебе рассказывал.";
			link.l1 = "Я всё запомнил. Спасибо, Натаниэль. Ты мне очень помог.";
		...
		case "caleuche_6":
			...
			link.l1 = "Praemonitus praemunitus, дружище. Кто предупреждён - тот вооружён, а я - предупреждён. Мне пора в путь. До встречи!";
