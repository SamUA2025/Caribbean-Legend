...
//----------------------------------------НПС по квесту Искушение Барбазона----------------------------------
 ...
 //--------------------------------------НПС по Завещанию Шарпа--------------------------------------------------
		...
		case "molligan_1":
			...
			link.l1 = "Ты поторопился уйти из Блювельда. Ян хотел погрузить тебе ещё двести центеров красного дерева, чтобы ты передал его лорду Уиллогби в Бриджтауне. Готовь судно под погрузку - мои люди перенесут тебе в трюмы древесину с моего судна.";
	...
	// ----------------------------- диалоги НПС при штурме бандитского рудника -------------------------------
		...
		case "francois_6":
			...
			if (pchar.HeroParam.HeroType == "HeroType_1") {
				...
				link.l1 = "Хотите драки? Будем вам драка! Капитан, передайте полковнику, что ему пора заказать для себя подходящий гроб.";
			}
