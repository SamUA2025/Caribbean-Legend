...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "SnakeEye_5":
			...
			link.l1 = "Змеиный Глаз сказал, что истукан оживает в полночь. Тогда он из каменного становится золотым и в нём поселяется дух Кукулькана. Вот тогда-то, наверное, к нему и стоит прикасаться. Или наоборот, не стоит.";
			link.l1.go = "SnakeEye_6";
		break;
		
		case "SnakeEye_6":
			dialog.text = "Жуть какая... Теперь что? Ждём полночи и идём в джунгли?";
		...
		case "SnakeEye_9":
			dialog.text = "Да, говорила. Не сомневаюсь ни на секунду, потому что видела её в действии собственными глазами. Пожалуй, ты прав: рисковать не стоит.";
		...
		case "teleport_4":
			dialog.text = "Ты не понял. Я просто буду неподалёку. Надо же мне убедиться, что этот истукан работает... или не работает.";
			link.l1 = "Против этого я не возражаю. Но только не вздумай последовать за мной, если статуя всё-таки 'пожрёт' меня. Ты слышишь?";
		...
		// belamour legendary edition -->
			link.l2 = "(глухо) Ван дер Декен? Ух-ха-ха-ха! Этот червь уже служит мне! Теперь твой черёд! Склонись передо мной, верная раба! Ты поведёшь мою армию мёртвых!";
		...
		case "arrive_1a":
			...
			dialog.text = "А-А-А-А-А-А-А-А-А-А-А-А-А! Прочь! Изыди!";
			link.l1 = "(глухо) Данни, стой! Остановись сейчас же!";
			link.l1.go = "arrive_1";
		break;
		// <-- legendary edition
		...
		case "nathaniel_15":
			dialog.text = "Уверена. Мы доберёмся до корабля. Можешь идти спокойно - я не позволю моему мужу умереть!";
		...
		case "treatment_3":
			...
			link.l1 = "Пока нет. Надо отправиться к Яну Свенсону и посоветоваться с ним. Будем последовательны - сейчас нужно выдвинуть "+sTemp+" на пост главы Берегового братства. А для этого нужно заручиться поддержкой всех пиратских баронов.";
		...
		case "after_boarding_6":
			...
			link.l1 = "Да Бог с тобой, Даниэль. Но я с удовольствием принимаю твоё приглашение. Посидим, выпьем, вспомним, как вы с Натаном топили Ван дер Декена...";
		...
		case "marun_town_1":
			...
			//Log_Info("Вы получили талисман 'Сын ягуара'");
		...
		case "marun_town_3":
			...
			{
				dialog.text = "Что мы можем сделать для тебя, "+pchar.name+"?";
				link.l1 = "Данни, увы, уже ухожу...";
				link.l1.go = "exit";
				if (CheckAttribute(pchar, "GenQuest.MaruntownSex2"))
				{
					dialog.text = "А вот и "+GetFullName(pchar)+". По лицу видно, что времени зря ты не терял!";
					link.l1 = "Должен признать, ты знаешь толк в развлечениях! Спасибо тебе, я отлично провёл время.";
			...
			if (bOk1 || bOk2)
			{
				link.l2 = "Девочку? Тише, Данни! Ты ведь не хочешь найти меня разрезанным на кусочки и аккуратно сложенным у твоего порога, правда? Ха-ха. Моя верная спутница, которая стоит сейчас прямо за дверью, не простит мне таких шалостей.";
				link.l2.go = "marun_town_fuckgirl_Otkaz_1";
			}
			else
			{
				link.l2 = "Девочку? Это звучит интересно, Данни. Истосковался я, по... звуку биения женского сердца... Думаю, стоит взглянуть - ты ведь не предложишь абы кого.";
		...
		case "marun_town_fuckgirl_Otkaz_1":
			dialog.text = "Вот как? Что ж ты побледнел-то? Ха-ха, я же пошутила. Береги её, слышишь?";
			link.l1 = "Конечно. Она для меня дороже всех сокровищ в этих краях!";
			link.l1.go = "marun_town_fuckgirl_Otkaz_2";
		break;
		
		case "marun_town_fuckgirl_Otkaz_2":
			dialog.text = "Так-то лучше, ха-ха. Ну давай, иди уже, а то твоя ненаглядная уже поди нервничает.";
			link.l1 = "Прощай, Данни. И спасибо за заботу, ха-ха.";
			link.l1.go = "exit";
		break;
		
		case "marun_town_fuckgirl_1":
			dialog.text = "Уверяю, эта юная прелестница определённо знает, как подарить тебе незабываемое время, "+pchar.name+". Развлекайся! Она будет ждать тебя в комнате таверны.";
			link.l1 = "Спасибо, Данни. Уже бегу. Не хочу терять ни минуты!";
			link.l1.go = "marun_town_fuckgirl_2";
		break;
		
		case "marun_town_fuckgirl_3":
			dialog.text = ""+pchar.name+", в Марун-Тауне, тебе всегда рады. Лучшие девушки - твои!";
			link.l1 = "Ох, Данни. Клянусь, здесь - мой второй дом.";
			link.l1.go = "exit";
		...
		case "MarunFuckGirl":
			dialog.text = "А вот и мой капитан. Сегодня ты только мой! Иди же ко мне, я уже заждалась...";
			link.l1 = "Ах вот как? Уже не можешь дождаться? Ну что ж, не будем терять времени!";
		...
		case "MarunFuckGirl_3":
			dialog.text = RandPhraseSimple("Мой капитан... ты действительно умеешь покорять! Такого у меня ещё не было! Может задержишься ещё на пару часов?", "Уже уходишь, мой дорогой?");
			link.l1 = RandPhraseSimple("Так и знал, что ты не захочешь отпустить меня так легко. Прощай, крошка. Меня ждут великие дела...", "Увы, дела зовут. Но возможно, мы ещё встретимся...");
	...
	// ------------------------------------------- провалы Саги ------------------------------------------------
		...
		case "before_kiss":
			dialog.text = "Ой, не придуривайся, малышка. Шарль, она целыми днями бродила вокруг идола и замучила вопросами бедного Змеиного Глаза. А потом эта коза сбежала домой и кое-что принесла ему, да?";
			link.l1 = "";
			link.l1.go = "exit";
		...
		case "after_kiss":
			dialog.text = "Ох, спасибо тебе за эту сцену, Шарль. Весь Марун-Таун животики надорвёт, ха-ха!";
			link.l1 = "Не сомневаюсь, что это твой новый приоритет - чтобы так оно и произошло.";
			link.l1.go = "after_kiss_1";
		break;
		
		case "after_kiss_1":
			dialog.text = "В са-а-амом конце списка. Не обижайся на девочку - для неё это всё в первый раз. От наших с Натаном похождений тоже ржал весь архипелаг.";
			link.l1 = "Давай сменим тему и диспозицию. К этому идолу я больше - ни ногой.";
			link.l1.go = "after_kiss_2";
		break;
		
		case "after_kiss_2":
			dialog.text = "Согласна. Пошли, герой.";
			link.l1 = "";
			link.l1.go = "Dolly_4";
