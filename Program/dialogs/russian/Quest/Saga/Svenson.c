...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "saga_40":
			dialog.text = "Отправляйся в Порт-Рояль и найди там человека по имени Альберт Локсли. Это лучший адвокат на всех Карибах. Он изрядно поднаторел во всякого рода тёмных делишках, так что возьмётся за любую работу, сулящую крупный гонорар. Аппетиты у него большие, но он того стоит.";
		...
		case "saga_78":
			...
			link.l1 = "Лоуренс Белтроп из Порт-Ройаля. Хозяин рудника и та самая таинственная тень, стоявшая за Джекманом. Это тоже мне поведал Бейкер, а узнал он это от Маски.";
			link.l1.go = "saga_79";
		break;
	...
	//----------------------------------- штурм рудника --------------------------------------------
		...
		case "mine_attack_40":
			...
			link.l1 = "Нет. В этих халупах нет даже завалящего дублона. Зато я нашёл кое-какие бумаги. В них написано, что владелец этого рудника - какой-то Лоуренс Белтроп из Порт-Ройаля.";
