...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "baker_7":
			...
			link.l1 = "Хорошо. Что насчёт личных вещей Бучера... э-э-э, Белтропа? Он случайно не родственник Томаса Белтропа?";
			link.l1.go = "baker_8";
		break;
