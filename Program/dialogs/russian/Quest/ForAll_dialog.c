...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "WaitressBerglar_2":
			...
			link.l1 = "Чёрта с два! За свои карманы я сам кого хочешь зарежу...";
			link.l1.go = "WaitressBerglar_fight";
			link.l2 = "Забирай, паршивец! Но это вам так просто с рук не сойдёт...";
		...
		case "PortmansCap":
			...
			link.l1 = "Отлично! Наконец-то я тебя наш"+ GetSexPhrase("ёл","ла") +"...";
			link.l1.go = "PortmansCap_1";
		break;
		case "PortmansCap_1":
			dialog.text = "Наш"+ GetSexPhrase("ёл","ла") +"?!";
		...
		case "SeekCap_1":
			...
			link.l1 = "Нет, это не так. Кто владеет кораблём - я и сам"+ GetSexPhrase("","а") +" не знаю, но знаю, что корабль украден со стоянки одного из портов. Я долж"+ GetSexPhrase("ен","на") +" его вернуть на место.";
...
//--------------------------------------------поисковые квесты дворян---------------------------------------------
		...
		case "SCQ_Nobleman_1":
			switch (sti(npchar.quest.SeekCap.numQuest))
			{
				case 0: //вариант А
					...
					{
						dialog.text = "Суть вот в чём. "+SelectNB_battleText()+"\nУ меня нет ни времени, ни возможности разыскать его в открытом море или на архипелаге, а в нашей колонии он, конечно, не показывается. Вы, наверное, уже догадываетесь, что я хочу вам предложить?";
						link.l1 = LinkRandPhrase("Вероятно, найти этого человека и доставить его к вам?","Наверное, разыскать негодяя и привести к вам?","Думаю, речь пойдёт о розыске и доставке к вам этого человека?");
						link.l1.go = "SCQ_NM_battle";
					}
					else //вариант В
					{
						SelectNB_prisonerText(npchar);
						dialog.text = "Суть вот в чём. "+npchar.quest.text+"\nУ меня нет ни времени, ни возможности разыскать его в открытом море или на архипелаге, а в нашей колонии он, конечно, не показывается. Вы, наверное, уже догадываетесь, что я хочу вам предложить?";
						link.l1 = LinkRandPhrase("Вероятно, найти этого человека и доставить его к вам?","Наверное, разыскать негодяя и привести к вам?","Думаю, речь пойдёт о розыске и доставке к вам этого человека?");
		...
		break;
				...
				case 1: //вариант С
					...
					dialog.text = "Дело вот в чём. Оказывается, "+npchar.quest.text+", служит сейчас в нашем военном флоте, он капитан корабля. И даже не знает, что я тоже живу на Карибах!\nЯ бы очень хотел с ним встретиться, но у меня нет ни времени, ни возможности разыскать его в открытом море или на архипелаге...";
		...
		case "SCQ_NM_battle": //вариант А
			dialog.text = "Не совсем так. Найти, но ко мне доставлять не нужно. Просто убейте его и всех дел. Утопите вместе с его дрянным кораблём, застрелите, заколите шпагой - мне абсолютно всё равно, лишь бы эта пакость перестала осквернять мир своим присутствием. Награда будет щедрой.";
		...
		case "SCQ_NM_battle_2":
			...
			link.l1 = "Где вас будет проще всего найти? Давайте заранее договоримся, чтобы я не тратил своё время ещё и на ваши розыски.";
		...
		case "SCQ_NM_prisoner": //вариант В
			...
			link.l1 = "Ну, если вы назовёте корабль, на котором он служит, имя капитана этого корабля, и, конечно, как зовут вашего недруга - то я могу попробовать разыскать его.";
		...
		case "NM_battleCap":
			dialog.text = "Ну? Что вам угодно, судар"+GetSexPhrase("ь","ыня")+"?";
			link.l1 = "Вас зовут капитан "+GetFullName(npchar)+", не так ли?";
			link.l1.go = "NM_battleCap_1";
		break;
		
		case "NM_battleCap_1":
			dialog.text = "Да. А в чём дело-то?";
		...
		case "NM_battleCap_3":
			dialog.text = "Какой ещё долг? Это вы о чём?";
			link.l1 = "Долг чести!";
		...
		case "NM_prisonerCap_2":
			...
			link.l1 = "Конечно. Я разыскиваю этого человека по поручению властей "+XI_ConvertString("Colony"+sld.city+"Gen")+". Он "+sld.quest.text1+", и я уполномочен"+GetSexPhrase("","а")+" арестовать его и доставить в город "+XI_ConvertString("Colony"+sld.city)+". Я прошу вас оказать мне в этом содействие.";
		...
		case "NM_prisonerCap_3":
			if(sti(npchar.reputation.nobility) > 41)
			{
				...
				link.l1 = "Не утруждайте себя излишними заботами, "+GetAddress_FormToNPC(NPChar)+". Я пришлю барку к вашему судну и мы сами его заберём.";
		...
		case "NM_prisonerDeck_exit":
			dialog.text = "Мы ведь уже всё решили по вопросу с моим офицером, так, капитан?";
			link.l1 = "...";
			link.l1.go = "exit";
		...
		case "NM_peaceCap":
			dialog.text = "Добрый день. Что вам угодно, судар"+GetSexPhrase("ь","ыня")+"?";
			link.l1 = "Вас зовут капитан "+GetFullName(npchar)+", не так ли?";
		...
		case "NM_peaceCap_1":
			...
			link.l1 = "Да. Вас разыскивает человек по имени "+GetFullName(sld)+". Он сказал, что "+sld.quest.text1+". Он очень хочет, чтобы вы как можно быстрее нанесли ему визит. Он живёт в "+XI_ConvertString("Colony"+npchar.quest.cribCity+"Voc")+".";
		...
		case "NM_battleDeck_1":
			dialog.text = "Вы ошиблись. Никаким деревом я не торгую. И вообще, ваш визит кажется мне довольно странным. Думаю, вам лучше покинуть моё судно!";
		...
		case "NM_battleDeck_exit":
			dialog.text = "Не нарывайтесь на неприятности, сударь! Кажется, мы с вами уже всё выяснили!";
			link.l1 = "...";
			link.l1.go = "exit";
			NextDiag.TempNode = "NM_battleDeck_exit";
		break;
		...
		case "NM_battleBoard":
			...
			link.l1 = "Я пришёл, чтобы передать тебе привет из города "+XI_ConvertString("Colony"+npchar.quest.cribCity)+", от человека по имени "+GetFullName(&characters[GetCharacterIndex("QuestCitiz_"+npchar.quest.cribCity)])+". Надеюсь, теперь-то тебе всё понятно?";
		...
		case "NM_prisonerBoard":
			...
			{
				link.l1 = "У тебя на корабле в команде служит негодяй по имени "+sld.quest.SeekCap.name+". Его очень жаждут увидеть власти города "+XI_ConvertString("Colony"+npchar.quest.cribCity)+". Он будет схвачен и помещён на моё судно.";
				link.l1.go = "NM_prisonerBoard_1";
			}
		break;
		
		case "NM_prisonerBoard_1":
			dialog.text = "И ты только ради этого устроил резню на моём судне? Мерзавец! У меня ещё остались силы... Я прикончу тебя!";
		...
		case "SCQ_NM_result":
			...
			switch (npchar.quest.SeekCap)
			{
				case "NM_battleover"://сдача квеста, вариант А
					dialog.text = "Ну, что скажете, капитан? Есть какие-нибудь результаты по моему делу?";
					link.l1 = "Есть. И, думаю, они вам понравятся. " + npchar.quest.SeekCap.capName + " мёртв, а его " + GetStrSmallRegister(XI_ConvertString(npchar.quest.SeekCap.shipTapeName)) + " на дне.";
				...
				case "NM_peaceover"://сдача квеста, вариант C
					dialog.text = "А-а, вот и вы. Рад вас видеть. Я уже знаю, что вы выполнили моё поручение!";
					link.l1 = "Ваш друг нанёс вам визит?";
		...
		case "SCQ_NM_result_A1":
			...
			link.l1 = "Благодарю. Если у вас появятся ещё недруги - обращайтесь.";
			link.l1.go = "SCQ_exit";
			sTemp = "SCQ_" + npchar.index;
		...
		case "SCQ_NM_result_B1":
			dialog.text = "Отлично! Я немедленно распоряжусь прислать своих людей к вашему судну, чтобы забрать его. Теперь-то он уже никуда не уйдёт! Вот, держите ваше золото. Вы его честно заработали.";
			link.l1 = "Благодарю. Если у вас появятся ещё недруги - обращайтесь.";
			link.l1.go = "SCQ_exit";
			sTemp = "SCQ_" + npchar.index;
			pchar.quest.(sTemp).over = "yes"; //снимаем прерывание смерть горожанина-квестодателя
...
//<-- поисковые квесты дворян
		...
		case "SCQ_man_1":
			...
			{
				case "0":
					dialog.text = "Год назад один капитан взялся доставить меня в " + XI_ConvertString("Colony" + SelectNotEnemyColony(NPChar) + "Acc") + ". Но на борту его корабля я был брошен в трюм, а потом продан в рабство. Из этой переделки я выбрался с огромным трудом, несколько раз находился на грани жизни и смерти... В общем, я хочу напомнить моему 'другу', что я ещё жив."; // belamour gen
		...
		case "SCQ_Slave_1":
			...
			dialog.text = "Капитана зовут " + npchar.quest.SeekCap.capName + ". Ходит на " + GetStrSmallRegister(XI_ConvertString(npchar.quest.SeekCap.shipTapeName + "Voc")) + " с именем '" + npchar.quest.SeekCap.shipName + "'. Я заплачу вам за эту работу " + FindRussianMoneyString(sti(npchar.quest.money)) + " и все свои личные драгоценности."; // belamour gen
		...
		break;
		case "SCQ_RapeWife_2":
			dialog.text = "Её зовут " + npchar.quest.SeekCap.name + ". Мерзавца-капитана зовут " + npchar.quest.SeekCap.capName + ", плавает он на " + GetStrSmallRegister(XI_ConvertString(npchar.quest.SeekCap.shipTapeName + "Voc")) + " с именем '" + npchar.quest.SeekCap.shipName + "'."; // belamour gen
		...
		break;
		case "SCQ_Friend_3":
			dialog.text = "Его зовут " + npchar.quest.SeekCap.capName + ". Насколько мне известно, он имеет " + GetStrSmallRegister(XI_ConvertString(npchar.quest.SeekCap.shipTapeName + "Acc")) + " с именем '" + npchar.quest.SeekCap.shipName + "'."; // belamour gem
		...
		case "SCQ_manResult":
			...
			switch (npchar.quest.SeekCap)
			{
				...
				case "manFriendover":
					...
					link.l1 = "Наш"+ GetSexPhrase("ёл","ла") +" и рассказал"+ GetSexPhrase("","а") +", что вы его ждёте здесь. Так что всё вышло удачно.";
		...
		case "SCQ_manResult_exit":
			switch (npchar.quest.SeekCap)
			{
				...
				case "manFriend":
					...
					link.l1 = "Не забыл"+ GetSexPhrase("","а") +", но пока не наш"+ GetSexPhrase("ёл","ла") +". Жди...";
					link.l1.go = "exit";
				break;
			}
		break;
		...
		case "SCQR_manSlave":
			dialog.text = "Превосходно, я в вас не ошибся! Итак, как мы и договаривались, вот ваши " + FindRussianMoneyString(sti(npchar.quest.money)) + " и драгоценности. Спасибо за труд.";
		...
		case "SCQ_Hasband_1":
			...
			SetSeekCapCitizenParam(npchar, sti(npchar.nation));
			dialog.text = "Вот! Вы понимаете, о чём я говорю. По виду вы "+ GetSexPhrase("капитан бравый","девушка бравая") +", поэтому я и хотела попросить вас о том, чтобы вы нашли моего мужа. За это я готова заплатить вам " + FindRussianMoneyString(sti(npchar.quest.money)) + " и отдам свои драгоценности.";
		...
		break;
		case "SCQ_Hasband_2":
			dialog.text = "Его зовут " + npchar.quest.SeekCap.capName + ". А работает он на " + GetStrSmallRegister(XI_ConvertString(npchar.quest.SeekCap.shipTapeName + "Voc")) + " с именем '" + npchar.quest.SeekCap.shipName + "'."; // belamour gen
		...
		case "SCQ_Revenge_4":
			...
			link.l1 = ""+ GetSexPhrase("Ну что вы! ","") +"Я просто хочу знать, насколько ваши намерения серьёзны.";
		...
		break;
		case "SCQ_Revenge_8":
			dialog.text = "Этого негодяя зовут " + npchar.quest.SeekCap.capName + ", он является капитаном " + GetStrSmallRegister(XI_ConvertString(npchar.quest.SeekCap.shipTapeName + "Gen")) + " с именем '" + npchar.quest.SeekCap.shipName + "'."; // belamour gen
		...
		case "SCQ_Pirates_7":
			...
			dialog.text = "Мужа зовут " + GetFullName(forName) + ". Капитана пиратов зовут " + npchar.quest.SeekCap.capName + ", он промышляет на " + GetStrSmallRegister(XI_ConvertString(npchar.quest.SeekCap.shipTapeName + "Voc")) + " с именем '" + npchar.quest.SeekCap.shipName + "'."; // belamour gen
		...
		case "SCQ_womanResult":
			...
			switch (npchar.quest.SeekCap)
			{
				case "womanHasbandover":
					...
					link.l1 = "Да, всё верно, " + GetAddress_FormToNPC(NPChar) + ". Ваш муж, " + npchar.quest.SeekCap.capName + ", жив и здоров. Он просто заработался...";
					link.l1.go = "SCQR_womanHasband";
				break;
				case "womanRevengeover":
					dialog.text = "Что скажете, капитан? Вы сделали то, о чём я вас просила? Капитан " + npchar.quest.SeekCap.capName + " мёртв?";
		...
		break;
		case "CCmanSlave_2":
			dialog.text = "Рассчитаться?! Это ты о чём?";
		...
		case "RapeWifeCap_Board": //абордаж
			...
			link.l1 = "Я приш"+ GetSexPhrase("ёл","ла") +" за женщиной, что ты украл у мужа. Вспомни " + XI_ConvertString("Colony"+npchar.quest.cribCity) + "! Её зовут " + sld.quest.SeekCap.name + " " + sld.quest.SeekCap.lastname + ".";
		...
		case "manRapeWife_Board":
			dialog.text = "Кто вы?";
			link.l1 = "Здравствуйте. Я приш"+ GetSexPhrase("ёл","ла") +" за вами по поручению вашего мужа. Теперь, когда вы свободны, мне нужно отвезти вас к нему.";
		...
		case "FriendCap_3":
			...
			link.l1 = "Так и есть. Но я сегодня добр"+ GetSexPhrase("ый","ая") +", так что тебе не о чем беспокоиться. Всего хорошего.";
			link.l1.go = "exit";
		...
		case "FriendCap_inDeck_2":
			...
			link.l1 = "Так и есть. Но тебе пока ничего не угрожает. Меня просили передать тебе сообщение, что я и сделал"+ GetSexPhrase("","а") +". Твой земляк, кстати, живёт и работает в " + XI_ConvertString("Colony"+npchar.quest.cribCity+"Voc") + "."; // belamour gen
		...
		case "plantation_slave":
    		...
    		{
				dialog.text = RandPhraseSimple(RandPhraseSimple("Я так устал - просто с ног валюсь.", "Нет больше сил так жить!"), RandPhraseSimple("Эта работа слишком тяжела для меня.", "Надсмотрщики уже не оставили живого места на моей шкуре!"));				
		...
		case "AffairOfHonor_1":
			...
			else
			{
				if(NPChar.sex == "man")
				{
					...
					{
						dialog.text = "Здравствуйте, капитан. Вы ведь капитан, и, судя по выправке, возможно даже военный?\nДа, да, вам-то уж наверняка известно как пользоваться шпагой, в отличие от моего непутёвого сына, который, к тому же, рискует завтра поутру умереть... И всё из-за этого похотливого мерзавца, положившего глаз на небезразличную моему бедному сыну даму!";
					...
					{
						dialog.text = "Здравствуйте, капитан. Позвольте поинтересоваться - вы, случайно, не пират? Хотя нет, конечно же, нет! Вы не пират. Пираты - они ужасно выглядят, и ещё ужаснее ведут себя, а запах...";
					...
					{
						dialog.text = "Здравствуйте, капитан. У меня к вам просьба, в выполнении которой вы не сможете мне отказать, если вы честный человек\nИтак, сразу к делу: примерно с месяц тому у нас в таверне остановился какой-то дворянин. Ну, остановился и ладно, только дворянин этот оказался на деле самый что ни на есть дебошир и негодяй! А теперь ещё и убийца!";
				...
				else
				{
					...
					if(!CheckAttribute(PChar, "QuestTemp.AffairOfHonor.Cavalier"))
					{
						...
						link.l1 = "У меня нет на это времени, красотка. Поищи кого-нибудь ещё...";
						link.l1.go = "AffairOfHonor_Exit";
			...
			dialog.text = "Явный баг. И откуда он только мог взяться? Сообщите об этом Warship'у, он всё исправит. Или нет. Это достоверно не известно.";
			link.l1 = RandSwear();
			link.l1.go = "exit";
		break;
		...
		case "AffairOfHonor_Cavalier_1":
			dialog.text = "Капитан, меня уже довольно долго преследует один из офицеров нашего гарнизона с недвусмысленными намёками и предложениями. Слышали бы вы, какие непристойные слухи он распространяет, пытаясь очернить меня в глазах горожан!\nК сожалению, у меня нет знакомых и друзей, способных защитить моё честное имя! Я в отчаянии! О, Боже, а вот и он! Помогите мне!";
		...
		case "AffairOfHonor_Cavalier_2":
			dialog.text = "А, вот и вы, сударыня! Что, "+GetSexPhrase("очередной поклонник","очередная твоя заступница")+", как я погляжу? Когда же вы угомонитесь, наконец? Наверное, никогда... Ступайте работать в бордель, там вам самое место...";
		...
		case "AffairOfHonor_Cavalier_2a":
			dialog.text = "Хм... Кто это тут у нас? А-а, "+GetSexPhrase("просоленный морем отважный капитан баркаса","просоленная морем отважная морячка")+", так? И что вы сделаете, "+GetSexPhrase("морской... лев","морская... львица")+"?";
			link.l1 = "Эта дама - моя подруга! А для вас у меня найдётся удар перчаткой по лицу!";
		...
		case "AffairOfHonor_Cavalier_5":
			dialog.text = "Ах, я всё знаю, судар"+GetSexPhrase("ь","ыня")+"! Вы даже не представляете, как я вам благодарна! Да хранит вас Господь! ";
			link.l1 = "Я рад"+GetSexPhrase("","а")+", что оказал"+GetSexPhrase("ся","ась")+" рядом и смог"+GetSexPhrase("","ла")+" вам помочь. Будьте счастливы!";
			link.l1.go = "exit";
		...
		case "AffairOfHonor_HonorSlave_1":
			sTemp = "";
			if (FindLocation(NPChar.city + "_brothel") != -1) sTemp = "или борделе ";
			dialog.text = "Ох, "+GetAddress_Form(NPChar)+"... Не смею надеяться, но возможно, на этот раз ваша шпага выручит и нашу семью?\nКак я и говорил, мой сын - он не дуэлянт, а тем временем завтра на рассвете ему предстоит драться. Ах, если бы здесь не была замешана дама и честь имени\nНо он не мог не принять этот вызов и теперь обречён, понимаете? Я в отчаянии, ведь это мой единственный сын и наследник, поэтому я прошу вас - заколите негодяя, бросившего вызов моему сыну раньше, чем наступит утро, и я не останусь в долгу, уж поверьте!\nВы найдёте мерзавца в таверне "+sTemp+"- там, где и привыкли проводить время такие подонки, как он... Умоляю вас...";
		...
		case "AffairOfHonor_HonorSlave_3":
			dialog.text = "Что вам угодно, чёрт возьми? Я отдыхаю, и не хочу чтобы мне мешали. Тут полно свободных мест и свободных ушей, так что оставьте меня в покое, сударь!";
			link.l1 = "Тем не менее, вам придётся отложить свой отдых до лучших времён.";
		...
		case "AffairOfHonor_HonorSlave_3b":
			dialog.text = "А?! Моряк, да ты, похоже, пьян в стельку! Я тебя впервые вижу! Но я не намерен терпеть подобное! Даю тебе последний шанс спасти свою жалкую жизнь! Немедленно извинись, селёдка копченая, и я так и быть, забуду твои дерзкие слова!";
		...
		case "AffairOfHonor_HonorSlave_4":
			...
			link.l1 = "Я заткну эти слова тебе в глотку, крысёныш! Жду тебя на маяке через два часа, и не забудь прихватить с собой ржавую железку, которую таскаешь у себя на поясе!";
		...
		case "AffairOfHonor_BeautifulPirate_3":
			dialog.text = "Это что, вызов?! Тебе скучно и хочется подраться? Хорошо, раз ты так этого добиваешься, я прогуляюсь к маяку и там выпущу тебе кишки, а потом вернусь сюда и разнесу эту чёртову таверну вдребезги!";
		...
		case "AffairOfHonor_BeautifulPirate_5":
			dialog.text = "Ну как? Вы уже говорили с этим пиратом? Он оставит нас в покое? Сестра сказала, что он ушёл из таверны и не вернулся...";
		...
		case "AffairOfHonor_Jackanapes_1_2":
			...
			LAi_SetImmortal(NPChar, true); // Ещё успеем.
			SetFunctionTimerConditionParam("AffairOfHonor_TimeIsLeft", 0, 0, 0, GetHour() + 3, false);
			// Jason: отсрочка на 2 часа как договаривались
			SetFunctionTimerConditionParam("AffairOfHonor_LighthouseGotoMeeting", 0, 0, 0, GetHour()+2, false);
			ReOpenQuestHeader("AffairOfHonor");
		...
		case "AffairOfHonor_WolvesAndSheeps_1":
			dialog.text = "Капитан, он не так прост, этот негодяй. Том, мой давний друг Том, безвинно погиб на дуэли от его руки, обвинённый в шулерстве за карточным столом! Всё по закону, как говорит губернатор...";
			link.l1 = "Хм... Твой друг виноват сам - вместо того, чтобы жульничать в картах, нашёл бы лучше себе работу.";
		...
		case "AffairOfHonor_WolvesAndSheeps_5":
			dialog.text = "Моё почтение, сударь! В вас сразу виден благородный господин и, возможно... игрок? Не желаете ли составить мне партию?";
		...
		case "AffairOfHonor_CowardFencer_1_1":
			dialog.text = "Я думаю, что проходимец тот - наёмник, а у наёмника что за нужда? Старые долги, возможно, или иные счёты... Но видно сразу - настроен он решительно и сам по себе торговца в покое не оставит. А вас я и хотел просить как раз помочь торговцу, освободив его от неприятного общества, а тем самым и мне выполнить поручение губернатора\nМне очень нужно это место, а сам прогнать наёмника я, боюсь, буду не в силах. Прошу вас, помогите, и я отдам вам все свои сбережения, иначе мне с позором придётся покинуть город!";
		...
		case "AffairOfHonor_CowardFencer_2":
			...
			link.l1 = "Так это вы не даёте покоя этому уважаемому торговцу и занимаетесь вымогательством?";
		...
		case "AffairOfHonor_CowardFencer_5":
			dialog.text = "Какие новости, капитан?";
			link.l1 = "Наёмник мёртв. Надеюсь место теперь ваше?";
		...
		case "AffairOfHonor_CoatHonor_2_2":
			dialog.text = "К чёрту вопросы! Выпьем!";
			link.l1 = "Хорошо, но после вы мне всё-таки расскажете что с вами случилось?";
			link.l1.go = "AffairOfHonor_CoatHonor_2_3";
		break;
		
		case "AffairOfHonor_CoatHonor_2_3":
			dialog.text = "Вам правда интересно? Тогда слушайте, пока я ещё могу говорить! Через пару дней я уже ничего не расскажу, потому что буду мёртв... Да, мёртв! А всему виной ром. Много рома и этот... этот офицер, которого сам дьявол, как видно, принёс в тот вечер на мою голову!\nКонечно, если бы я не выпил тогда столько, то не ввязался бы в ссору с первой шпагой этого гарнизона, да и, пожалуй, всего города. Но что теперь? Я обречён, я пропал, я труп! Как глупо...";
		...
		case "AffairOfHonor_CoatHonor_2_5":
			dialog.text = "Вы серьёзно? Вы сделаете это! О, клянусь честью, я в долгу не останусь!\nА найти его можно в городе. Тут живёт его любовница, о которой неоднократно слышали все офицеры гарнизона, но её адрес мне неизвестен, к сожалению...";
		...
		case "AffairOfHonor_CoatHonor_Next":
			dialog.text = "Какие вести вы мне несёте, сударь? Добрые, или... не очень?";
			link.l1 = "Пока никаких. Ждите. Всё будет хорошо.";
			link.l1.go = "exit";
		...
		case "AffairOfHonor_CoatHonor_Final":
			dialog.text = "Какие вести вы мне несёте, сударь? Добрые, или... не очень?";
			link.l1 = "Всё разрешилось. Ваш возможный противник больше никому не сможет причинить вреда... Можете спать спокойно. Но, надеюсь, вы извлечёте из случившегося уроки и более не будете задираться с незнакомыми людьми?";
			link.l1.go = "AffairOfHonor_CoatHonor_Final_1";
		break;
		
		case "AffairOfHonor_CoatHonor_Final_1":
			dialog.text = "Вы не шутите? Я... я вам крайне признателен, "+GetAddress_Form(NPChar)+"! Вот, возьмите всё, что у меня есть. Это моё жалование, отдаю всё до последнего гроша!\nУрок, говорите? Да, чёрт побери, вы правы! Более такого не повторится.";
		...
		case "AffairOfHonor_CoatHonor_End":
			dialog.text = "Ещё раз большое спасибо, "+GetAddress_Form(NPChar)+", за вашу помощь!";
		...
		case "AffairOfHonor_CoatHonor_4":
			dialog.text = "Эй, какого чёрта?! Что вы делаете в покоях моей дамы? Убирайтесь отсюда немедленно, иначе я выставлю вас силой!";
			link.l1 = "Я хожу там, где мне вздумается, и не намерен отдавать отчёт вам о своих действиях! Силой? Ну что же, попробуйте!";
			link.l1.go = "AffairOfHonor_CoatHonor_5";
		break;
		
		case "AffairOfHonor_CoatHonor_5":
			dialog.text = "Вот это наглость! Неслыханно! Сударь, вы забываетесь! Немедленно покиньте этот дом, или, клянусь, вам придётся горько пожалеть о том, что родились на этот свет!";
		...
		case "AffairOfHonor_CoatHonor_6":
			dialog.text = "Ах, так? Берегитесь! Здесь, в этом доме, ваша смерть будет выглядеть обычным убийством, тогда как сегодня у маяка, где обычно решаются споры подобного рода, всё будет честь по чести, и вы своей смертью не сможете навредить моему имени!\nЯ вызываю вас на дуэль, "+GetAddress_Form(NPChar)+" наглец! Вы ответите за свою дерзость! Итак, через два часа вас устроит?";
			link.l1 = "Вполне, "+GetAddress_FormToNPC(NPChar)+" зазнайка.";
			link.l1.go = "AffairOfHonor_CoatHonor_7";
		break;
		
		case "AffairOfHonor_CoatHonor_7":
			dialog.text = "Тогда потрудитесь явиться в указанное время. У вас есть ещё немного времени - как раз успеете заказать у нашего священника панихиду.";
		...
		case "AffairOfHonor_GodJudgement_2":
			dialog.text = "Рассказывайте, как всё прошло? Мы... простите, вы победили?";
			link.l1 = "Вам будет полезно знать, что на месте дуэли была устроена засада. Вероятно, этот ваш сосед решил перестраховаться и, на всякий случай, пригласил вместо одного представителя нескольких, да ещё и отъявленных головорезов. Но, к счастью, я достаточно неплохо владею оружием.";
		...
		case "AffairOfHonor_BeforeFight_1":
			dialog.text = "Жить без багов очень весело, потому они, сцуки, лезут непонять откуда и всё портят.";
			...
			switch(AffairOfHonor_GetCurQuest())
			{
				...
				case "BeautifulPirate":
					dialog.text = "Ну, наконец-то! Я уж думал, что зря пришёл в такую даль... Давайте закончим поскорее, ведь в таверне меня заждались красотка и ром!";
					link.l1 = "Уверен, вам больше не понадобится ни то, ни другое!";
					link.l1.go = "AffairOfHonor_BeforeFight_2"
				break;
				
				case "Jackanapes":
					dialog.text = "Вы всё-таки пришли? Тем лучше! Начнём!";
				...
				case "GodJudgement":
					dialog.text = "А это ещё кто? Что-то, приятель, ты не слишком похож на простого горожанина...";
					link.l1 = "Это с вами мне придётся драться на дуэли?!";
		...
		case "AffairOfHonor_AfterFight_1":
			...
			{
				dialog.text = "Неужели вы думали, что зарежете нашего друга и спокойно уберётесь прочь? К оружию!";
			...
			if(AffairOfHonor_GetCurQuest() == "CoatHonor")
			{
				...
				link.l1 = "А в чём, собственно, дело?";
				link.l1.go = "AffairOfHonor_AfterFight_2_1";
			}
			else
			{
				dialog.text = "Всё было по чести, а теперь позвольте нам забрать нашего товарища и уйти самим.";
...
string SelectNB_battleText()
{
	...
	switch (drand(5))
	{
		...
		case 2: sText = "Один проходимец взял у меня деньги в долг, затем отдал их в моё отсутствие слуге - а монеты оказались фальшивыми. Теперь он скрывается на своём корабле неведомо где" break;
		case 3: sText = "Один негодяй пытался опорочить моё имя, оклеветав меня перед губернатором. Однако обман был раскрыт, и мерзавец сбежал в море на своём корабле" break;
		case 4: sText = "Я, по недосмотру, нанял счетоводом проходимца. Он совершил крупную растрату, купил корабль и скрылся неведомо куда" break;
		case 5: sText = "Мой бывший охранник выкрал из будуара жены шкатулку с драгоценностями и скрылся. Теперь я понял, откуда у его дружка появились деньги на покупку корабля" break;
	}
	return sText;
}
...
void SelectNB_prisonerText(ref npchar)
{
	switch (drand(5))
	{
		...
		break;
		case 2:
			npchar.quest.text = "Один проходимец взял у меня деньги в долг, затем отдал их в моё отсутствие слуге - а монеты оказались фальшивыми. Теперь он служит на одном корабле казначеем и скрывается от меня";
			npchar.quest.text1 = "фальшивомонетчик, совершивший преступление";
		break;
		case 3:
			npchar.quest.text = "Один негодяй пытался опорочить моё имя, оклеветав меня перед губернатором. Однако обман был раскрыт, и мерзавец сбежал в море на одном корабле, устроившись на должность судового врача";
...
void SelectNB_peaceText(ref npchar)
{
	switch (drand(5))
	{
		...
		break;
		case 2:
			npchar.quest.text = "мой сводный брат, покинувший Старый Свет ещё в юности";
