void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "BM_Pyanitsa_11":
			dialog.text = "Ха-ха, конечно, ик, знаю! Всем это известно. Старина Гейб живёт буквально рядом - выйдешь из таверны и повернёшь направо. Упрёшься сразу же в его д-дом, и-ик!";
