void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		bool ok = CheckFreeSitFront(npchar);
			...
			//конвой торгового судна
				...
				else
				{
					...
					link.l1 = TimeGreeting() + ", " + GetAddress_FormToNPC(NPChar) + ". Да нет, ничего не хотел"+GetSexPhrase("","а")+" - просто поздоровал"+GetSexPhrase("ся","ась")+". Удачно вам отдохнуть!";
					link.l1.go = "exit";
				}
			}
		break;
		...
		case "Trader_distress":
			dialog.text = "Капитан, мы ведь уже всё обсудили - не так ли? Вы не имеете дел с 'барыгами' - так чего же вы от меня хотите?";
		...
		case "Escort_choice"://первые развилки - выбираем между городом, бухтой и необитайкой
			...
			switch (drand(2))
			{
				case 0://город дружественный
					...
					link.l1 = "Ну что же, почему бы и нет? Вдвоём всегда безопаснее, это понятно. Я соглас"+GetSexPhrase("ен","на")+".";
					link.l1.go = "EscortType";
					link.l2 = "Я бы и рад"+GetSexPhrase("","а")+" помочь, но мне совсем в другую сторону.";
		...
		case "EscortType":
			dialog.text = "Замечательно! Я рад, что мы договорились. Надеюсь, путешествие пройдёт без неприятных приключений.";
		...
		case "EscortType_go":
			...
			AddQuestUserData("TraderEscort", "sSex1", GetSexPhrase("ся","ась"));
		...
		case "EscortTrader_complete"://сдаём квест
			...
			{
				dialog.text = "Капитан, вы не подскажете, зачем я нанял вас? Вы только посмотрите на мой корабль! На что он похож? На решето! Он еле на плаву держится! Вы это видите? Я так и не понял, кто кого сопровождал - вы меня, или я вас. В общем, награды вы не получите, и не надейтесь. Вы её не заслужили.";
				link.l1 = "Э-гхм... Если бы не я - ты бы вообще сейчас кормил крабов, тупой торгаш. Ладно, земля круглая - попадёшься ты мне ещё в море!";
			...
			{
				dialog.text = "Капитан, тут такое дело... У меня нет денег, чтобы заплатить вам за работу. Но не кипятитесь, пожалуйста, я хочу вам предложить оплату, которая значительно превзойдёт обещанную мной.";
				link.l1 = "Гм... Я вообще-то рассчитывал"+GetSexPhrase("","а")+" получить деньги сейчас. Но, раз так - я тебя готов"+GetSexPhrase("","а")+" выслушать.";
		...
		case "EscortTrader_complete_1":
			...
			AddQuestUserData("TraderEscort", "sSex", GetSexPhrase("","а"));
		...
		case "EscortTrader_complete_5":
			...
			link.l1 = "Я сказал"+GetSexPhrase("","а")+" - человек человеку - волк, да? Вы так легко и беззастенчиво 'сдаёте' своего коллегу... Впрочем, мне до вашей совести дела нет, а за наводку спасибо. Счастливо оставаться, сударь!";
		...
		case "Race_begin"://гонки на гидропланах
			...
			link.l1 = "Да я не сказал"+GetSexPhrase("","а")+" бы, что я - торговец. Но в любом случае дела идут неплохо.";
			link.l1.go = "Race_begin_1";
		break;
		
		case "Race_begin_1":
			dialog.text = "И это главное! С учётом того, как неспокойно нынче в море.";
			link.l1 = "Да, это точно. Особенно тревожно вам, купцам - вон сколько охотников за содержимым ваших трюмов. А вы ни уйти от них не можете, ни защититься толком - лоханки ваши тихоходные и орудия самых малых калибров стоят - всё за прибылью гонитесь. Только и спасает вас, что караванами по четыре-пять судов ходите.";
			link.l1.go = "Race_begin_2";
		break;
		
		case "Race_begin_2":
			dialog.text = "Ну, не все такие, "+GetSexPhrase("дружище","подруга")+". Вот я, например, всегда в одиночку хожу - мне лишний балласт не нужен. Я отлично знаю воды Карибского моря, и, позволю себе заметить, неплохо управляюсь со своим кораблём и командой. Так что я запросто уйду в море от любого пирата.";
		...
		case "Race_begin_3":
			dialog.text = "Похоже, "+GetSexPhrase("дружище","подруга")+", ты сомневаешься в том, что мой корабль может ходить быстро? Хорошо. Предлагаю тебе пари.";
			link.l1 = "Какое пари?";
		...
		case "Race_exit":
			...
			link.l1 = "Ладно-ладно, нечего мне тут морали читать, философ нашёлся. Прощай...";
			link.l1.go = "exit_sit";
		...
		case "Racing_rate5"://50 000
			...
			{
			dialog.text = "Что за несуразные предложения, капитан? За такие деньги можно купить шхуну и ещё месяц пить не просыхая. Назовите разумную сумму.";
		...
		case "Racing_rate4"://40 000
			...
			{
			dialog.text = "Что за несуразные предложения, капитан? За такие деньги можно купить барк и ещё месяц пить не просыхая. Назовите разумную сумму.";
			link.l1 = "Для меня эта сумма и есть разумная - за меньшую я не намерен тут с тобой цацкаться. Мы ведь не в подворотне, сударь, чтобы спорить на два песо. Ладно... посидели - и хватит. Боишься спорить - как хочешь... Хвастать только горазд.";
			link.l1.go = "Race_exit";
			link.l2 = "Вот как? Ну, ладно. Давай подумаем...";
			link.l2.go = "Race_begin_5";
		...
		case "Racing_rate3"://30 000
			...
			{
			dialog.text = "Что за несуразные предложения, капитан? За такие деньги можно купить шлюп и ещё месяц пить не просыхая. Назовите разумную сумму.";
			link.l1 = "Для меня эта сумма и есть разумная - за меньшую я не намерен тут с тобой цацкаться. Мы ведь не в подворотне, сударь, чтобы спорить на два песо. Ладно... посидели - и хватит. Боишься спорить - как хочешь... Хвастать только горазд.";
			link.l1.go = "Race_exit";
			link.l2 = "Вот как? Ну, ладно. Давай подумаем...";
			link.l2.go = "Race_begin_5";
		...
		case "Racing_rate2"://20 000
			...
			{
			dialog.text = "Что за несуразные предложения, капитан? За такие деньги можно купить люггер и ещё месяц пить не просыхая. Назовите разумную сумму.";
			link.l1 = "Для меня эта сумма и есть разумная - за меньшую я не намерен тут с тобой цацкаться. Мы ведь не в подворотне, сударь, чтобы спорить на два песо. Ладно... посидели - и хватит. Боишься спорить - как хочешь... Хвастать только горазд.";
			link.l1.go = "Race_exit";
			link.l2 = "Вот как? Ну, ладно. Давай подумаем...";
			link.l2.go = "Race_begin_5";
		...
		case "Racing_rate_nomoney":
			...
			{
			dialog.text = "Ну, знаете, мы не в подворотне, чтобы спорить на два песо. Или вы просто боитесь? А, ладно, чёрт с вами. Но на будущее - не торопитесь со скоропалительными выводами - среди торговцев очень много опытных моряков... гораздо опытнее вас.";
			link.l1 = "Ладно-ладно, нечего мне тут морали читать, философ нашёлся. Прощай...";
			link.l1.go = "exit_sit";
			DeleteAttribute(pchar, "GenQuest.Racing.Go");
			NextDiag.TempNode = "First time";
		...
		case "Racing_exit":
			dialog.text = "Передумали? Хм... А может, вы просто боитесь? Впрочем, ладно, чёрт с вами. Но на будущее - не торопитесь со скоропалительными выводами - среди торговцев очень много опытных моряков... гораздо опытнее вас.";
			link.l1 = "Ладно-ладно, нечего мне тут морали читать, философ нашёлся. Прощай...";
			link.l1.go = "exit_sit";
			DeleteAttribute(pchar, "GenQuest.Racing.Go");
			NextDiag.TempNode = "First time";
		...
		case "Racing_Go":
			...
			dialog.text = "Принято! Призовём в свидетели бармена, если вы не против... ему же и оставим наши ставки. Победитель вернётся и заберёт всю сумму. Обмануть не выйдет - новости по архипелагу разносятся очень быстро, так что трактирщик будет в курсе, кто из нас выиграл.";
			link.l1 = "Соглас"+GetSexPhrase("ен","на")+". Так будет вернее.";
			link.l1.go = "Racing_Go_1";
		break;
		
		case "Racing_Go_1":
			dialog.text = "Ну, а теперь, думаю, нам следует отправиться на свои корабли - отсчёт времени уже пошёл. Не знаю, как вы, а я выхожу в море. Да, если что: мой корабль - флейт, называется - "+pchar.GenQuest.Racing.Go.ShipName+". Думаю, вы легко его узнаете в порту прибытия, хе-хе...";
		...
		case "Racing_Finished":
			...
			{
			dialog.text = "Хех! Однако, я удивлён... Мои поздравления, капитан! Вы и впрямь оказались быстрее. Как говорится, на каждую силу найдётся большая сила, так?";
			...
			{
			dialog.text = "Ну что, капитан, удивлены? Как я вам уже говорил - я прекрасно знаю море и достаточно неплохо управляюсь с кораблём. Убедились?";
		...
		case "Racing_Finished_1":
			...
			link.l1 = "Именно это я и собираюсь сделать. А теперь позвольте откланяться. Был"+GetSexPhrase("","а")+" искренне рад"+GetSexPhrase("","а")+" нашему знакомству. До свидания!";
		...
		case "Racing_Finished_2":
			dialog.text = "А на самом деле никакой мистики нет - просто умение и опыт. А теперь мне нужно собираться в обратный путь в "+XI_ConvertString("Colony"+pchar.GenQuest.Racing.Go.StartCity+"Acc")+", за своим выигрышем.";
			link.l1 = "Вы его заслужили. А теперь позвольте откланяться. Был"+GetSexPhrase("","а")+" искренне рад"+GetSexPhrase("","а")+" нашему знакомству. До свидания!";
			link.l1.go = "Racing_end";
			npchar.lifeday = 0;
			DeleteAttribute(pchar, "GenQuest.Racing.Go");
...
switch (rand(7))
	{
		case 0:
			...
			pchar.GenQuest.Escort.Trader.add = "чёрного дерева";
			break;
		case 1:
