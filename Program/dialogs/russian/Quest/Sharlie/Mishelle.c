...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		case "First time":
			...
			if (pchar.questTemp.Sharlie == "gambitstage")
			{
				...
				if(bFMQM || bFMQN || bFMQT || bFMQP || bFMQG || bFMQL)
				{
					...
					{
						dialog.text = "Здравствуй, брат! Ценю твоё искреннее рвение вытащить меня отсюда, но ты пока не готов к следующему шагу. Мой план требует опытного капитана. Продолжай исследовать Карибы, захватывай призы, учись! Как будешь готов, мы продолжим.";
						link.l1 = "Ну как скажешь, брат. Тебе же тут сидеть, не мне.";
						link.l1.go = "exit";
					} 
					else 
					{
						dialog.text = "Рад тебя видеть, брат. Не забывай о своих обязательствах перед другими. Как только освободишься, жду тебя - у меня есть идеи для нашего следующего шага!";
						link.l1 = "Понял, брат. Уделю время своим обязательствам, но вскоре вернусь!";
						link.l1.go = "exit";
					}
					break;
				}
				if (sti(pchar.rank) < 12)
				{
					Log_info("Требуется 12 уровень");
					dialog.text = "Шарль-мореплаватель! Наслышан о твоих похождениях! Ты почти готов к следующей стадии моего плана. Возвращайся как только наберешь ещё немного опыта.";
					if (sti(pchar.rank) < 7)
					{
						dialog.text = "Здравствуй, брат! Ценю твоё искреннее рвение вытащить меня отсюда, но ты пока не готов к следующему шагу. Мой план требует опытного капитана. Продолжай исследовать Карибы, захватывай призы, учись! Как будешь готов, мы продолжим.";
					} 
					else 
					{
						...
						{
							dialog.text = "Рад тебя видеть, брат! Слышал, ты делаешь успехи! Но ты пока не готов к следующему этапу моего плана. Продолжай делать то, что делал, и возвращайся ко мне когда будешь готов.";
						}
					}
					link.l1 = "Ну как скажешь, брат. Тебе же тут сидеть, не мне.";
					link.l1.go = "exit";
					if(sti(pchar.rank) > 8)
					{
						link.l2 = "Нет уж, брат. Может, ты и пустил уже корни в этой камере, но я задерживаться не намерен - отец не может долго ждать. Выкладывай свой план.";
						link.l2.go = "gambitA";
					}
					break;
				}
				...
				{
					dialog.text = "Добрый день, Шарль. Смотрю я на тебя, и сердце радуется: ты определённо меняешься в лучшую сторону.";
			...
			if (CheckAttribute(pchar, "questTemp.Saga") && pchar.questTemp.Saga == "mishelle")//Сага готова к старту
			{
				...
				link.l1 = "Да, брат, мы встречались. И у меня для тебя две новости - хорошая и плохая. Начну с хорошей. Я вернул твой долг де Пуанси. А плохая новость состоит в том, что он не выпустит тебя, пока я не выполню твоё обещание разобраться с каким-то еретиком...";
				link.l1.go = "saga_5";
				DelLandQuestMark(npchar);
				DelMapQuestMarkCity("FortFrance");
				break;
			...
			if (CheckAttribute(pchar, "questTemp.Mtraxx") && pchar.questTemp.Mtraxx == "fail" && CheckAttribute(pchar, "questTemp.Mtraxx.CharleePrince")) // пиратская линейка провалена или пройдена не полностью, но дальше 4 квеста
			{
				...
				link.l1 = "Догадываюсь, что это были за слухи. Но всё в прошлом: я не намерен больше работать с Тираксом. Грязные делишки - это не моё.";
				link.l1.go = "saga_17f";
				DelLandQuestMark(npchar);
				DelMapQuestMarkCity("FortFrance");
				break;
			...
			{
				dialog.text = "Ну, здравствуй... корсар Чарли Принц. Скажи, Шарль: как ты докатился до такого? Я не могу поверить: мой брат, который когда-то кривил лицо в гримасе отвращения, едва я заикнулся о захвате призом испанского торговца, стал одним из самых дерзких и опасных пиратов? О тебе идёт такая слава, что я, даже сидя здесь, краснею. Я проклял тот день, когда послал тебя в Ла Вегу. Какой позор! Французский дворянин примкнул к пиратам, и более того - прослыл отъявленным мерзавцем и негодяем! Что дальше, брат? Будешь делать карьеру пиратского барона?";
			...
			dialog.text = "Что-то ещё, Шарль? Я думал, мы уже всё обсудили. Не теряй времени, брат: оно очень дорого стоит!";
		...
		case "Mishelle_prisoner":
			...
			dialog.text = "Брат!.. Чертовски рад тебя видеть!.. Я, конечно, понимаю, что тебе трудно в это поверить, но мне сейчас действительно очень приятно, что ты приехал сюда...";
			link.l1 = "Ха! Ну надо же! Он рад! Значит, пока ты был 'на коне' и являлся гордостью своего 'Ордена', Шарль был позором семьи, жалким художником, живущим на содержании у куртизанок, и придворным шаркуном, так? А теперь, когда тебя упекли за решётку твои же соратники, ты 'чертовски рад' видеть своего непутёвого братишку, марателя холстов!..";
			link.l1.go = "Mishelle_prisoner_1";			
		break;
		
		case "Mishelle_prisoner_1":
			dialog.text = "Шарль, ты...";
			link.l1 = "Я ещё не закончил! Почему ты ничего не сообщал о себе во Францию?! Тебя что, лишили права переписки?! Наш отец совсем разболелся от тревоги за тебя и попросил меня выяснить хоть что-то о судьбе своего драгоценного Мишеля!..";
			link.l1.go = "Mishelle_prisoner_1a";
		break;
		
		case "Mishelle_prisoner_1a":
			dialog.text = "Шарль, а как ты думаешь, какими бы словами я сообщил отцу о том, что со мной произошло? Что бы я ему сказал? Нет, брат, как бы ни было тяжело, отцу лучше пока не знать о случившемся - так я рассудил. Тебе же писать было бы бесполезно - ты же всё время по разным адресам в Париже... Как ты меня нашёл?..";
			link.l1 = "По просьбе отца я отправился на Мальту, где получил от твоего друга шевалье де Ла Бринье краткие сведения о твоих проблемах и о том, что ты, вероятно, находишься где-то на Мартинике. Затем я на время вернулся во Францию, посетил наше поместье в Гаскони, а потом отправился сюда, в эту чёртову глушь, где от жары можно сойти с ума и где москиты буквально заедают насмерть...";
			link.l1.go = "Mishelle_prisoner_1b";
		break;
		
		case "Mishelle_prisoner_1b":
			dialog.text = "Ты пересказал отцу информацию, полученную от де Ла Бринье?";
			link.l1 = "Нет. А сам шевалье ещё раньше не отвечал на его письма, опасаясь... печальных последствий. Батюшке до сих пор ничего не известно о твоей судьбе. Я решил сначала найти тебя и на месте разобраться в сути дела. Но знай, что я приехал на Мартинику не ради тебя, а ради нашего бедного отца!";
			link.l1.go = "Mishelle_prisoner_2";
		break;
		
		case "Mishelle_prisoner_2":
			dialog.text = "Ой ли? Шарль, с каких это пор в тебе взыграла сыновняя почтительность? Давай начистоту, брат: всем в Париже известно, чей ты сын, хотя ты и носишь фамилию де Мор, и тебе крайне невыгодно, чтобы фамилия де Монпе покрылась позором и была втоптана в грязь\nВедь тогда ты не сможешь бравировать, намекая на своё происхождение, и рассказывать вымышленные истории о своих героических похождениях, так? Двери лучших домов Парижа навсегда закроются перед тобой, и тебя навряд ли подпустят даже на милю к Лувру, верно?\nИ твои куртизанки и любовницы, чьим мужьям ты наставляешь рога, пока те сражаются на полях брани за наше Отечество, навряд ли захотят изменять своим благоверным с братом государственного преступника, коим меня намереваются выставить?\nСкажи, ты ведь поехал сюда прямо из постели какой-нибудь замужней девицы, я угадал? Шарль, что это с тобой? Чего ты так изменился в лице? Правда глаза колет?";
			link.l1 = "Ты... ты!..";
		...
		case "Mishelle_prisoner_3":
			...
			link.l1 = "Давай попробуем... Ты можешь толком объяснить, в чём тебя обвиняют?";
		...
		case "Mishelle_prisoner_9":
			...
			link.l1 = "Но чёрт возьми, у нашей семьи и близко нет таких денег! Нам не хватит и двадцати лет, чтобы собрать эту сумму!";
			link.l1.go = "Mishelle_prisoner_10";
		break;
		
		case "Mishelle_prisoner_10":
			dialog.text = "Если бы я не был за решёткой, и не был связан обязательствами перед Орденом, я бы заработал их за полгода-год, максимум - полтора. Шарль, здесь Новый Свет, здесь все иначе. Активный и предприимчивый человек способен сделать тут состояние, и на это не уйдёт вся жизнь, как в Европе.";
		...
		case "Mishelle_prisoner_11":
			dialog.text = "Не говори чепухи, Шарль! Пуанси ни за что не выпустит меня отсюда. Если бы всё было так просто, я бы не просил тебя о помощи.";
			link.l1 = "То есть эти деньжищи за твою свободу придётся добывать мне?!";
			link.l1.go = "Mishelle_prisoner_12";
		break;
		
		case "Mishelle_prisoner_12":
			dialog.text = "Не только за мою свободу. Или ты уже забыл? Нам снова вернуться к разговору о дворцах, балах и любовницах? Да, Шарль, это придётся сделать тебе. Если ты, конечно, хочешь продолжить вести свою распутную жизнь в Париже, как и прежде. А ты же этого хочешь, так, брат?";
			link.l1 = "Но чёрт тебя подери, как же я их достану?! Ты знаешь в округе дерево, на котором вместо листьев растут луидоры?";
			link.l1.go = "Mishelle_prisoner_13";
		break;
		
		case "Mishelle_prisoner_13":
			dialog.text = "Весь Новый Свет представляет собой рощу из таких деревьев, да вот только всем лень поднять свои тупые головы и протянуть руки к их ветвям. Не переживай, Шарль, ты справишься. Я ведь знаю тебя с раннего детства, и если бы ты был безнадёжно туп или ленив, я бы не тратил время, посвящая тебя в подробности моего теперешнего положения\nНесмотря на все твои 'достоинства', о которых я уже упомянул, ты храбр, честолюбив, толков, обладаешь хорошо подвешенным языком и умеешь обращаться со шпагой, что крайне важно в этих краях...";
			link.l1 = "Ну, спасибо. Неужели мой дорогой братец снизошёл до похвалы в мой адрес? А я-то думал, что я всего лишь жалкий художник, придворный...";
		...
		case "Mishelle_prisoner_17":
			dialog.text = "Хорошо. Для того, чтобы у тебя вообще хоть что-то получилось, тебе обязательно нужен корабль. Карибы - это архипелаг, здесь вся жизнь неразрывно связана с морем. Для человека с собственным кораблём сразу же открываются бесчисленные возможности заработка.";
		...
		case "Mishelle_prisoner_21":
			dialog.text = "Заработать. А как же ещё? Деньги валяются тут под каждым кустом, нужно просто знать, где искать, и не бояться трудностей. Походи по заведениям, поговори с людьми. Тебе наверняка предложат какое-нибудь поручение. Но будь осторожен - прохвостов у нас гораздо больше, чем честных людей.";
			link.l1 = "Ясно...";
			link.l1.go = "Mishelle_prisoner_22";
		break;
		
		case "Mishelle_prisoner_22":
			dialog.text = "После того, как купишь корабль, найми команду. Сам ты пока не сможешь управляться с кораблём, так что тебе потребуется штурман. Обо всём этом поговори с хозяином таверны - он тебе поможет. Ну и сам не теряйся, конечно. Когда выйдешь в море, сразу бери курс на Гваделупу...";
			link.l1 = "А что это такое? Город?";
			link.l1.go = "Mishelle_prisoner_23";
		break;
		
		case "Mishelle_prisoner_23":
			dialog.text = "Это остров в двух днях пути отсюда. Да, постарайся побыстрее обзавестись картой архипелага и выучи её, как 'Отче наш', чтобы не выглядеть в глазах людей остолопом, неспособным отличить город от острова. Мотаться по архипелагу тебе придётся много, так что готовься сразу.";
			link.l1 = "Хм. Ладно. Что мне там делать, на этой, как её... Гваделупе?";
			link.l1.go = "Mishelle_prisoner_24";
		break;
		
		case "Mishelle_prisoner_24":
			dialog.text = "Найдёшь там человека по имени Фадей. У него свой дом недалеко от пирса. Представишься ему от меня и потребуешь вернуть долг - он как-то весьма неплохо проигрался мне в карты. Полученные деньги будут тебе в качестве подъёмных. Используешь их, чтобы раскрутиться.";
			link.l1 = "В смысле - раскрутиться?";
			link.l1.go = "Mishelle_prisoner_25";
		break;
		
		case "Mishelle_prisoner_25":
			dialog.text = "В смысле - при помощи этих денег заработать ещё денег и так далее. Например, торговлей. Мы ещё вернёмся к этому разговору. Пока займись кораблём, отправляйся на Гваделупу, найди этого толстяка-московита и вытряси из него долг\nТолько не прими мои слова буквально - Фадей очень уважаем на Гваделупе и друг самого губернатора. Так что ссориться с ним ни к чему. Наоборот, попробуй подружиться. Как получишь от него деньги - сразу возвращайся ко мне. Ты меня понял, брат?";
			link.l1 = "Понял. Ох, и за что же мне всё это наказание...";
			link.l1.go = "Mishelle_prisoner_26";
		break;
		
		case "Mishelle_prisoner_26":
			dialog.text = "Не печалься, Шарль. Прими это как неизбежное зло, или... добро. Ты ещё благодарен потом судьбе будешь за то, что твоя жизнь повернулась таким образом. У тебя, братец, появилась возможность наконец-то проявить себя в делах, достойных настоящего мужчины. Глядишь, человеком станешь...";
			link.l1 = "(Обучающие квесты) Ты опять за своё?";
			link.l1.go = "Mishelle_prisoner_27";
			link.l2 = "(Пропустить обучение) Вместо твоих занудных нравоучений, лучше бы подсказал, где денег на корабль можно сразу взять, а не 'пойди-туда-не-знаю-куда'. Братец, я здесь без году неделя, а ты меня, как щенка в воду - выплывет, не выплывет... Чем быстрее у меня будет корабль, тем быстрее я займусь настоящим делом, и тем короче будет твоё пребывание в этой камере. Ты же не враг себе, Мишель?";
			link.l2.go = "Mishelle_prisoner_29"; // Addon 2016-1 Jason пиратская линейка 1
		break;
		
		case "Mishelle_prisoner_27":
			dialog.text = "Нет-нет, что ты... Всё, Шарль, не теряй времени понапрасну. Что делать - ты знаешь. Жду тебя с Гваделупы уже капитаном собственного корабля и с деньгами от Фадея. Удачи, брат. Я надеюсь на тебя.";
		...
		case "Mishelle_prisoner_28":
			...
			LocatorReloadEnterDisable("Fortfrance_town", "reload10_back", true);// пу закр
		...
		case "Mishelle_prisoner_29": // Addon 2016-1 Jason пиратская линейка 1
			dialog.text = "Хех! Брат, сразу даже кошки не родятся. 'Хочу всё и сразу' - это подход глупых зелёных юнцов, не видевших жизни, и многих он свёл за решетку, или даже на тот свет. Зрелый человек понимает, что всего надо достигать постепенно. Впрочем, пёс с тобой. Есть один вариант\nВ церкви Сен-Пьера ты можешь найти аббата Бенуа. Это друг нашего отца и мой хороший знакомый. Иди к нему, представься, расскажи обо мне и об отце, упади ему в ноги и попроси дать денег в долг. Глядишь, он разжалобится, пожалеет твою зелёную неопытность и ссудит тебе некоторую сумму.";
			link.l1 = "(Пропустить обучение) Вот это совсем другое дело! Иду к аббату.";
			link.l1.go = "Mishelle_prisoner_31";
			link.l2 = "(Обучающие квесты) Начать с того, чтобы ещё больше увеличить твои долги? Ты за кого меня держишь, брат? Ясно, помощи от тебя ждать не стоит. Всё сделаю сам!";
		...
		case "trial":
			DelLandQuestMark(npchar);
			dialog.text = "Ты хотел сказать - было страшно? Не стесняйся, брат, это абсолютно нормально. Я тоже в своём первом морском бою отнюдь не чувствовал себя героем. Ерунда. Через какой-то месяц или два для тебя подобные встречи будут выглядеть заурядным событием... Был у Фадея?";
		...
		case "trial_2":
			dialog.text = "Фадей? На мели? Проблемы с деньгами? Ха-ха! Ну, рассмешил ты меня, братец! Этот чёртов московит сразу распознал в тебе новичка и... ах он шельмец! Покажи мне кинжал, которым от тебя откупился этот старьёвщик.";
			...
			{
				link.l1 = "У меня его с собой нет. На вид - кинжал как кинжал. Фадей сказал, что он заговорён индейскими шаманами и называется 'Коготь вождя'.";
				link.l1.go = "trial_4";
			}
		break;
		...
		case "trial_5":
			...
			link.l1 = "Ладно. Разбирайся с ним сам... Получается, я остался без обещанных подъёмных?";
			link.l1.go = "trial_6";
		break;
		
		case "trial_6":
			dialog.text = "Получается, да, Шарль. Но ты не печалься. Тот, у кого есть корабль и голова на плечах, на Карибах не пропадёт. А у тебя есть и то, и другое, ведь так?";
			link.l1 = "Это что за намёки такие? Ну дал я маху с этим кинжалом, так что теперь, мне...";
			link.l1.go = "trial_7";
		break;
		
		case "trial_7":
			dialog.text = "Да не кипятись же ты, брат! Что за манера - вспыхивать от малейшей искры? Будь спокойнее, дольше проживёшь. Ни на что я не намекаю, даже в мыслях не было!";
			link.l1 = "Извини, Мишель. Просто я немного... ну пойми и меня тоже!";
			link.l1.go = "trial_8";
		break;
		
		case "trial_8":
			dialog.text = "Я понимаю. И очень хочу тебе помочь! Так что слушай меня внимательно. Тебе надлежит набраться опыта и поднакопить хоть немного деньжат, прежде чем браться за серьёзные дела. Ввязываться в авантюры без должной подготовки - чистой воды самоубийство. Тебя попросту раздавят, как козявку.";
			link.l1 = "Хм. О каких авантюрах ты мне сейчас толкуешь, Мишель? Я что-то перестал тебя понимать.";
			link.l1.go = "trial_9";
		break;
		
		case "trial_9":
			dialog.text = "Братец, я напоминаю тебе, что мой, точнее, наш долг де Пуанси составляет миллион песо. Неужели ты думаешь, что их можно получить мирным путём? Нет, наторговать, конечно, реально, если дела пойдут удачно, но торговля на Карибах - тоже отнюдь не тихое занятие\nЕсли ты не будешь участвовать в авантюрах, то они сами найдут тебя, хочешь ты того, или нет, вот только будешь ли ты готов к ним в этот момент? Лучше наносить удар первым. Si vis pacem, para bellum, Шарль...";
			link.l1 = "Опять твои учёные словечки? Говори по-французски, я тебя умоляю...";
			link.l1.go = "trial_10";
		break;
		
		case "trial_10":
			dialog.text = "Это латынь, братец. Я сказал - 'хочешь мира - готовься к войне'. Воспринимай эту фразу как руководство к действию. Можешь записать в своём судовом журнале и перечитывать её каждое утро после молитвы. Тебе нужно многому научиться и многое постичь...";
			link.l1 = "Так, довольно. Я устал от твоих рассуждений. Давай по существу.";
			link.l1.go = "trial_11";
		break;
		
		case "trial_11":
			dialog.text = "Я и говорю по существу, вот только ты пока этого не понимаешь. Хорошо. Для начала тебе нужно получше ознакомиться с архипелагом и привыкнуть к своей новой жизни в качестве капитана. Чтобы обеспечить своё существование и зарплату команде, придётся потрудиться. Заработать ты можешь разными способами\nСамый простой - это заняться фрахтами и перевозкой пассажиров. Фрахт ты можешь получить у купцов в магазинах, а пассажиры сами подходят на улице. Также загляни в портовое управление. Имея люггер или любой быстрый корабль, ты можешь неплохо заработать, выполняя курьерские поручения\nКогда обзаведёшься кораблём покрупнее, сможешь получать в портовых управах очень выгодные фрахты. Разговаривай с людьми на улицах - здесь все так или иначе нуждаются в услугах друг друга. Не кичись своим происхождением, будь приветлив, и дела сами пойдут на лад. Навещай губернаторов колоний - у них частенько бывает денежная работа\nМожешь попробовать заняться торговлей, но тогда обязательно найми хорошего казначея. В море будь внимателен, избегай встреч с испанскими военными эскадрами и кораблями. Если встретишь одиночного испанского торговца или незащищённый конвой - можешь попытаться захватить его.";
		...
		case "trial_12":
			dialog.text = "Ох, Шарль... Советую тебе избавиться от чистоплюйства раз и навсегда - здесь оно не в почёте. Что же касается Ордена... не будь наивным, брат. Может, в Европе между Лувром и Эскориалом - подобие мира, но здесь идёт война. Любой испанский рейдер сочтёт за честь захватить твоё судно, а тебя вместе с командой вздёрнуть сушиться на ноке рея\nТак что захват торгового судна враждебной державы никто не поставит тебе в вину, уверяю тебя. А если ты ещё обзаведёшься каперским патентом, то вообще такие действия получат официальную поддержку...";
		...
		case "trial_13":
			dialog.text = "И тебе придётся использовать эти методы, Шарль. Тем более, что это гласно и негласно поощряется действующей властью. Но даже если ты будешь просто торговать, ты всё равно, рано или поздно, столкнёшься с необходимостью вступить в бой, с пиратами или испанскими рейдерами, поскольку ты для них - добыча\nТак что чем быстрее ты откажешься от своих прежних взглядов на жизнь, тем лучше для тебя же самого. Поверь, брат, можно сделать многое, и при этом не только 'сохранить лицо', но ещё и получить благосклонность властей и любовь простого народа.";
			link.l1 = "Я всё более и более удивляюсь, Мишель. Теперь ты призываешь меня пиратствовать. Что будет дальше?";
			link.l1.go = "trial_14";
		break;
		
		case "trial_14":
			dialog.text = "Не драматизируй, Шарль. На самом деле всё просто: или ты, или тебя. Вот и вся философия. Я предпочитаю первое, и хочу, чтобы ты последовал моему примеру. И я призываю тебя не к пиратству, а к военным действиям против враждебной державы, и то, когда в этом есть смысл.";
		...
		case "trial_15":
			dialog.text = "Ты схватываешь всё буквально на лету, братец. Но довольно слов. Пора применить полученные знания на практике. Тебе нужно ознакомиться с регионом и заработать небольшой капитал. Конечно, на это потребуется время. Но используй его с толком и навещай меня периодически, посмотрим, каким ты станешь капитаном. Но если вместо дела ты решишь пошататься по кабакам и борделям, либо будешь бесцельно ходить между островами, и ничему не научишься - лучше сюда даже и не показывайся. Мы поняли друг друга, Шарль?";
			link.l1 = "Не переживай. Я не развлекаться сюда приехал...";
			link.l1.go = "trial_15_1";
		break;
		
		case "trial_15_1":
			dialog.text = "Обязательно посети все французские колонии на Архипелаге. Должен же ты знать наши владения на Карибах. Если подвернётся интересное и выгодное дело - не тушуйся, воспользуйся случаем и попробуй поймать удачу за хвост. Но и об осторожности не забывай, внимательно смотри по сторонам и включай голову - я уже упоминал о многочисленности обитающих на Карибах прохвостов.";
			link.l1 = "Хорошо, я понял... А что потом?";
			link.l1.go = "trial_16";
		break;
		
		case "trial_16":
			dialog.text = "А потом я скажу тебе, что делать дальше. У меня уже созрел план. Тебя ждёт большое будущее, Шарль, если ты будешь в точности следовать моим советам и рекомендациям.";
			link.l1 = "Я бы предпочёл своё маленькое прошлое этому большому будущему...";
			link.l1.go = "trial_17";
		break;
		
		case "trial_17":
			dialog.text = "Поверь, брат, ты ещё будешь смеяться над своим никчемным прошлым и благодарить судьбу, избавившую тебя от него. И вообще, смотри позитивнее на своё положение, и не воспринимай его, как каторгу. Ты полюбишь эту жизнь. Вот увидишь\nДа, вот что я ещё подумал: отправляйся-ка ты снова на Гваделупу, к нашему общему знакомому, Фадею, и попроси его найти для тебя какую-нибудь работу. У этого медведя обширные связи, так что я уверен, что он сможет помочь тебе. Главное - не ударь в грязь лицом. Мне не хочется краснеть за тебя.";
			link.l1 = "Опять нравоучения... Господи, да когда же это закончится? Ладно, Мишель... я пошёл?";
			link.l1.go = "trial_18";
		break;
		
		case "trial_18":
			dialog.text = "Погоди. Пара полезных советов практического плана. Если ты сильно насолишь какой-нибудь державе и тебя объявят вне закона, то обратись в нашу церковь к аббату Бенуа. Скажешь, что от меня. Он вхож как к папистам, так и к кальвинистам, и не раз помогал мне решить проблемы такого рода. Но учти, что это сложно и недёшево, так что до открытой вражды с властями лучше не доходить\nПостой, это ещё не всё! Хоть мы с тобой и дворяне, но негоже гнушаться сделать что-то своими собственными руками, особенно здесь. Имея необходимые инструменты и компоненты, ты сможешь создавать множество полезных вещей... Вот скажи, брат, как ты заряжаешь свой пистоль?";
		...
		case "trial_21":
			...
			dialog.text = "Возьми эту инструкцию по изготовлению бумажного патрона, изучи его на досуге и не поленись применить полученные знания\nПостой, брат. Не забудь зайти к нашему дражайшему губернатору.";
			link.l1 = "А что, есть повод?";
			link.l1.go = "trial_22";
		break;
		
		// Rebbebion, намёк на "Травлю крысы"
		case "trial_22":
			dialog.text = "Всегда полезно поддерживать отношения с губернаторами, особенно если на их островах сидят в казематах твои родственники.";
			link.l1 = "Расскажи мне о нём.";
			link.l1.go = "trial_23";
		break;
		
		case "trial_23":
			dialog.text = "Не каждый смог бы удержаться на троне Мартиники. Интересы Ордена, Короны, пиратов... да и о собственных интересах благородный человек тоже забывать не должен. Не будь Парке настолько распущен и искушён в грехе, он мог бы заставить считаться с собой даже Пуанси.";
			link.l1 = "И чем я мог бы быть ему полезен?";
			link.l1.go = "trial_24";
		break;
		
		case "trial_24":
			dialog.text = "У официальных лиц всегда есть работа для вольных капитанов. Платят они скупо, но только тогда, когда дело касается не личных, а государственных интересов. В любом случае, нет на Карибах лучшего способа укрепить честь и улучшить отношения с державами, чем работа на губернаторов. Лови момент, тем более, что сейчас у Парке какие-то проблемы.";
			link.l1 = "Какие?";
			link.l1.go = "trial_25";
		break;
		
		case "trial_25":
			dialog.text = "Извини, брат. Тут замешаны интересы Ордена. Скажу только, что не одни мы с тобой в нужде быстрых способов обогащения.";
			link.l1 = "Опять темнишь... Хорошо, будет время - загляну.";
			link.l1.go = "trial_26";
		break;
		
		case "trial_26":
			dialog.text = "А теперь ступай. Удачи, брат!";
		...
		case "gambitA":
			dialog.text = "Хорошо! Я верю в тебя, брат. Смотрю, и сердце радуется: ты определённо меняешься в лучшую сторону.";
			link.l1 = "Да неужели? И как же ты это понял?";
			link.l1.go = "gambit";
		break;
		...
		case "gambit":
			...
			{
				link.l1 = "Не могу понять, братец, как расценить твои слова: как похвалу или как оскорбление. Но, скажу по правде: мне всё равно, что ты там обо мне думаешь. Я собрал миллион в оплату твоего долга, так что скоро ты будешь на свободе. Где я могу найти де Пуанси?";
				link.l1.go = "gambit_1_1";
			}
			else
			{
				link.l1 = "Не могу понять, братец, как расценить твои слова: как похвалу или как оскорбление. Но, скажу по правде: мне всё равно, что ты там обо мне думаешь. У меня ворох... нет, море дел, и мне некогда вступать тут с тобой в полемику и разводить склоки. У тебя есть что сказать по существу? Если нет - то я пошёл...";
				link.l1.go = "gambit_1";
			}
			DelLandQuestMark(npchar);
		...
		case "gambit_1_1":
			dialog.text = "Тебе удалось заработать миллион? Ты молодец, Шарль, просто молодец! Но Филиппа де Пуанси, к сожалению, сейчас нет в своей резиденции - он отбыл по делам Ордена в секретную экспедицию. Так что с визитом к нему придётся повременить.";
			link.l1 = "Чёрт бы побрал вас с вашими секретными делами! Я думал покончить со всей этой историей и уехать домой, а тут...";
			link.l1.go = "gambit_1_2";
		break;
		
		case "gambit_1_2":
			dialog.text = "А тут у тебя открылась возможность заработать ещё больше денег и не только. Брат, то, что у тебя есть требуемая старой лисой сумма - это очень хорошо, но я бы не был так уверен и спокоен... Де Пуанси - хитрец ещё тот, он проявил немалый интерес к твоей скромной персоне, и...";
		...
		case "gambit_1_3":
			...
			link.l1 = "Ладно. Снявши голову по волосам не плачут - задержусь в этой глуши ещё на чуть-чуть. Не вечно же твой де Пуанси будет в разъездах. Ознакомь меня со своим планом.";
			link.l1.go = "gambit_2";
		break;
		...
		case "gambit_2":
			dialog.text = "Слушай. Деньги, конечно, играют очень большую роль на Карибах, как, впрочем, и везде, но они не всегда способны решить всё. Кроме туго набитого кошелька, успешный человек должен иметь обширные и разносторонние связи, причём не со всяким подзаборным сбродом, а с людьми, которые что-то значат в этой жизни\nИ неважно, какой они национальности и к какому сословию принадлежат. Знакомства открывают такие двери, в которые войти только при помощи одних денег невозможно. Сочетание 'деньги плюс связи' в итоге даёт самое большее, что может только быть у человека - власть\nТебе обязательно нужно обзавестись знакомствами и обрасти связями, а сделать это, занимаясь перевозками, торговлей, мелким пиратством или даже выслуживаясь у губернаторов по мелким поручениям - невозможно.";
			link.l1 = "Что ты предлагаешь?";
			link.l1.go = "gambit_3";
		break;
		
		case "gambit_3":
			dialog.text = "На Карибах не так и много влиятельных организаций. Одна из них - Голландская Вест-Индская торговая Компания. Можешь наняться к ним на службу. Их штаб-квартира находится в Виллемстаде, на Кюрасао. Компания частенько пользуется услугами сторонних капитанов, а с особо отличившимися заключает долгосрочные контракты\nЕсли тебе улыбнётся удача, ты сможешь сделать у них неплохую карьеру. Я слышал, у них сейчас назрели серьёзные проблемы: некий английский капер ополчился против Компании и регулярно пускает на дно их корабли. Сделать они с ним ничего не могут: этот капер - военный моряк, и оказался им не по зубам\nГоворят, он как-то связан с английской военной разведкой, а это очень серьёзная контора. Так что, возможно, тебе даже выгоднее было бы встать на сторону этого английского капитана, да вот беда: я не знаю его имени, известно лишь то, что он обретается на Антигуа\nМожешь отправиться туда и поспрашивать - глядишь, кто чего и скажет. Ещё я слышал о какой-то странной организации, замешанной в этом англо-голландском конфликте, но на чьей они стороне - мне непонятно. Знаю лишь то, что следы её ведут на Барбадос, в Бриджтаун...";
			link.l1 = "Так ты предлагаешь мне наняться на службу к голландцам, или пойти искать этого сомнительного капитана, либо ещё более сомнительную 'организацию'?";
			link.l1.go = "gambit_4";
		break;
		...
		case "gambit_4":
			...
			link.l1 = "Знаешь, братец, я как-то не рассчитывал делать военную карьеру во французском флоте. Не дай Бог, закончу как ты - в камере за какое-нибудь невыполненное задание... Ну что же, мне всё понятно. Штаб-квартиру Голландской Компании я, думаю, найду легко, а вот как искать остальных - ума не приложу.";
			link.l1.go = "gambit_5";			
		break;
		...
		case "gambit_fale_2":
			dialog.text = "Это уже не твоё дело. Без тебя обойдусь. У меня есть и другие люди, более способные, которые помогут решить мою проблему. Боюсь, что доверившись тебе, я просижу здесь до конца своих дней. Всё. Проваливай к своим куртизанкам.";
		...
		case "saga":
			switch(pchar.questTemp.HWIC.Detector)
			{
				...
				case "self_win": sTemp = "Я нашёл 'тайную организацию' на Барбадосе, стал вести свою собственную игру и добился немалого: уничтожил того английского капера, Ричарда Флитвуда, отправил за решётку Лукаса Роденбурга, вице-директора Компании, стал близким другом губернатора Матиаса Бека и директора Питера Стайвесанта. Кроме того, у меня теперь на Антигуа свой личный дом, и в кармане позвякивают деньжата..."; break;
			...
			dialog.text = "И? Давай, братец, не тяни. Что у тебя получилось? До меня доходили отголоски слухов о твоей бурной деятельности, но я хотел бы услышать всё из твоих уст.";
			link.l1 = sTemp;
			link.l1.go = "saga_1";
		break;
		...
		case "saga_1":
			...
			{
				dialog.text = "Вот это да! Ты молодец, Шарль! Я ни минуты в тебе не сомневался! Далеко пойдёшь, братишка... Наворотить таких дел и наладить отношения со столь важными людьми - право, я даже и не ожидал. Поздравляю!";
			}
			else
			{
				dialog.text = "Не расстраивайся, Шарль. Не вышло - так не вышло, добьёмся нужного результата другими путями.";
			}
		...
		case "saga_3_1":
			dialog.text = "Отлично! Значит, недолго мне осталось сидеть в этом каземате... Отправляйся в Капстервиль, это на Сент-Кристофере, и попроси аудиенции с Пуанси. Он должен быть у себя в губернаторском дворце. Ну а дальше смотри по ситуации и помни: Пуанси хитёр, очень хитёр... Что-то мне подсказывает, что так просто эта история не закончится. Ступай, брат, и будь осторожен!";
			link.l1 = "Я учту твои опасения, Мишель. Не переживай, я тоже не лыком шит. Отправляюсь к старой лисе. До встречи!";
			link.l1.go = "saga_4";			
		break;
		
		case "saga_3_2":
			dialog.text = "Тогда тебе у Пуанси делать нечего. Он даже на порог тебя не пустит. Добудь эти деньги скорее - ты уже настолько опытен, мой брат, что это не должно быть для тебя серьёзной проблемой. Как только они у тебя появятся - сразу отправляйся в Капстервиль, это на Сент-Кристофере\nШевалье должен быть у себя в губернаторском дворце. Попросишь аудиенции и тебя пустят. Ну а дальше смотри по ситуации и помни: Пуанси хитёр, очень хитёр... Что-то мне подсказывает, что так просто эта история не закончится.";
		...
		case "saga_5":
			dialog.text = "Дьявольщина! Это именно то, чего я и опасался. Пуанси давно присматривался к тебе и твоим действиям, Шарль. Вот почему он проявил к тебе такой интерес! Ты неплохо зарекомендовал себя на Карибах, вот он и решил использовать тебя для выполнения задания, в котором я потерпел крах...";
			link.l1 = "Сдаётся мне, Мишель, что ты всё знал, только не хотел заранее мне это сообщать. Уж больно всё гладко получается... Сначала деньги, теперь - твоя работа... Так случайно не бывает.";
			link.l1.go = "saga_6";
		break;
		...
		case "saga_6":
			...
			link.l1 = "Точно... потому что твои таланты его более не устраивают, так? Чёрт возьми! Ладно. Я вижу, что деваться, похоже, некуда. Кто этот еретик? Как его найти?";
			link.l1.go = "saga_7";
		break;
		
		case "saga_7":
			dialog.text = "А чего его искать! Он безвылазно сидит на Тортуге под защитой им же отстроенных бастионов и мушкетов верных ему гугенотов из числа солдат гарнизона. Других там уже и не осталось. Речь идёт о Франсуа Левассере, губернаторе этого острова\nИспанцам до сих пор не удалось выковырять его оттуда, а де Пуанси поверил, что я это смогу сделать один без помощи береговой стражи, поскольку затевать гражданскую войну на радость испанцам было бы политически неверно и опасно в виду близости гарнизона Санто-Доминго\nСтарый хрыч слишком печётся о своей незапятнанной карьере и скором пансионе, чтобы так рисковать. В то же время Левассер совсем зарвался и представляет для интересов короны серьёзную опасность\nДе Пуанси, который сам и назначил Левассера на сытное местечко лет десять назад, считает этого яростного гугенота личным врагом и мечтает сделать новым губернатором Тортуги мальтийца шевалье де Фонтене, моего непосредственного командира, под началом которого я и прибыл сюда с Мальты.";
			link.l1 = "Меня сейчас хватит удар... Сначала - достать миллион, теперь - устранить губернатора Тортуги. Каким будет моё следующее задание? Организация заговора в Эскориале? Карамба! Не удивлён, что ты провалил дело. Ликвидировать губернатора - это не испанских торговцев щипать. Надеюсь, у тебя был какой-то план, когда ты поклялся таскать каштаны из огня для этой парочки?";
			link.l1.go = "saga_8";
		break;
		...
		case "saga_12":
			dialog.text = "Поможет, если ты сможешь помочь ему. Дела у него идут не лучшим образом, и верные энергичные люди ему не помешают. Для серьёзного разговора тебе нужно будет доказать ему свою полезность. Как это лучше сделать, разберёшься на месте. Мне отсюда сложно давать советы такого рода\nВижу, что ты всё-таки решился играть до конца, раз задаёшь мне эти вопросы, так, Шарль?";
		...
		case "saga_13":
			dialog.text = "Шарль...";
			link.l1 = "Не перебивай меня! Так вот, было бы глупо сейчас возвращаться к отцу с пустыми руками. Проблема так и не решена - ты за решёткой и под угрозой обвинения в измене Ордену. Пуанси без колебаний опорочит фамилию де Монпе, не выполни я его 'просьбу', это у него на лисьей морде написано. Поэтому я отправляюсь в Блювельд, искать подходы к Свенсону. А ты пока подумай, что ты ещё 'забыл' рассказать мне по существу дела. Например, я впервые от тебя слышу про какое-то индейское золото, которое ты вёз де Пуанси.";
			link.l1.go = "saga_14";
		break;
		...
		case "saga_14":
			...
			link.l1 = "Боюсь, что уже не так, брат. Ты был прав - последние месяцы, проведённые на Карибах, в корне переменили меня и мои взгляды на жизнь. И, уверен, это к лучшему. Не так уж мне теперь и нужны эти парижские салоны, да и случись что, я и без фамилии де Монпе сумею прожить. Де Мор ничем не хуже...";
			link.l1.go = "saga_15";
		break;
		
		case "saga_15":
			dialog.text = "...";
			link.l1 = "И сейчас единственное, что меня по-настоящему заботит - это то, что твой позор ударит по нашему престарелому отцу. Он-то не знает истинного положения вещей, и того, что здесь происходит. И ещё, как ты правильно отметил - надо восстановить пришедшее в упадок родовое поместье. А миллион, выплаченный за твою свободу, значительно облегчил мою казну, так что ей явно требуется пополнение.";
			link.l1.go = "saga_16";
		break;
		
		case "saga_16":
			dialog.text = "Ты отлично усвоил все уроки жизни, Шарль. Я искренне рад за тебя. И рад тому, что ты всё-таки взялся за поручение де Пуанси, а не отправился домой во Францию. Надеюсь, у тебя всё получится, и ты сумеешь выполнить то, чего так и не смог сделать я.";
			link.l1 = "Боюсь, у меня нет выбора. Как, впрочем, не было с самого первого дня моего появления на Карибах. До встречи, Мишель. Думаю, на следующее свидание я приду с приказом о твоём освобождении.";
			link.l1.go = "saga_17a";
		break;
		...
		case "saga_17c":
            dialog.text = "Иметь дело с пиратами и быть пиратом - две разные вещи, братец. Надеюсь, ты их не перепутаешь. Иди в Ла Вегу и спроси Тиракса о работе. Ну а если не найдёшь общего языка, или не пойдут дела с ним - плюнь и возвращайся ко мне.";
		...
		case "saga_17g":
			...
			if(CheckAttribute(pchar, "questTemp.Mtraxx.Retribution.Choice"))
			{
				...
				{
			link.l1 = "Прекрати... Я действительно раскаялся во всех мерзостях, что натворил за время работы с Тираксом. Я видел ад собственными глазами, брат!.. Нет, с пиратским прошлым покончено! Больше я в Ла Вегу ни ногой. Я приму все меры, чтобы восстановить своё доброе имя.";
			link.l1.go = "saga_17gx";
				}
				if(pchar.questTemp.Mtraxx.Retribution.Choice == "bad")
				{
					link.l1 = "Хочешь верь, хочешь не верь. Ты же за решёткой сидишь, не я.";
		...
		case "saga_17gxa":
            dialog.text = "Ох, брат... Не гневи Бога... Надеюсь, со Свенсоном и Акулой такого не повторится. Делай дела, но держись в стороне и помни, что за люди перед тобой. Французскому дворянину негоже становиться такими, как они. Будь выше. А теперь отправляйся к Яну Свенсону в Блювельд и постарайся найти к старому корсару подход. Без него решить проблему с Левассером малой кровью не удастся.";
			link.l1 = "Хорошо. Не буду медлить.";
			link.l1.go = "saga_17";
		...
		case "saga_17gx":
            dialog.text = "Для этого тебе придётся постараться, брат... Помнишь, я сказал: иметь дело с пиратами и быть пиратом - две разные вещи, а ты... Надеюсь, со Свенсоном и Акулой такого не повторится. Делай дела, но держись в стороне и помни, что за люди перед тобой. Французскому дворянину негоже становиться такими, как они. Будь выше. А теперь отправляйся к Яну Свенсону в Блювельд и постарайся найти к старому корсару подход. Без него решить проблему с Левассером малой кровью не удастся.";
			link.l1 = "Хорошо. Не буду медлить.";
			link.l1.go = "saga_17";
			pchar.questTemp.Mtraxx = "full_complete_end";
		break;
		...
		case "Base_afterfight":
			...
			if(IsUniformEquip()) sTemp = "Смотрю, ты стал капитаном военно-морского флота... Не ожидал, честное слово. Искренне поздравляю!";
			...
			link.l1 = "Расслабляться пока рано - город очищен, но мерзавцы засели в форте, а у берегов острова стоит серьёзная эскадра во главе с линейным кораблём. Но всё же сообщу тебе радостную весть, Мишель: ты свободен!";
			link.l1.go = "Base_afterfight_1";
		break;
		
		case "Base_afterfight_1":
			dialog.text = "Не верю своим ушам! Неужели это свершилось? Свобода?!";
			link.l1 = "Левассер мёртв, Тортугу теперь возглавит Тимолеон де Фонтене, старая лиса Пуанси снял с тебя все обвинения. Ничто более не угрожает нашему доброму имени.";
			link.l1.go = "Base_afterfight_2";
		break;
		
		case "Base_afterfight_2":
			dialog.text = "Я до самого последнего момента сомневался... и напрасно. Ты превзошёл меня, Шарль, и преуспел там, где я потерпел сокрушительное фиаско.";
		...
		case "Base_afterfight_6":
			...
			link.l1 = "Ты даже не представляешь, как я ждал этой секунды... Мишель, у нас есть ещё люди, способные сражаться?";
			link.l1.go = "Base_afterfight_7";			
		break;
		
		case "Base_afterfight_7":
			dialog.text = "Что ты задумал, Шарль?";
			link.l1 = "Угроза со стороны испанцев не ликвидирована. Я хочу выбить их из форта, а потом совместными усилиями атаковать эскадру и с суши, и с моря! При помощи пушек бастиона я сумею потягаться с линейным кораблём!";
			link.l1.go = "Base_afterfight_8";			
		break;
		
		case "Base_afterfight_8":
			dialog.text = "Люди есть. Должны быть. Значительная часть рыцарей отправилась на защиту губернаторского дворца, кто-то ещё наверняка найдётся в городе... Я соберу всех, кого смогу. Встретимся за городскими воротами!";
			link.l1 = "...";
		...
		case "Fort_attack":
			dialog.text = "Вот, брат, наша с тобой армия. Те, кого я сумел найти. Нас немного, но мы сражаемся за Отечество! Выбьем же проклятых захватчиков из форта! Внезапность поможет нам - они не ожидают нападения. Вперёд!";
			link.l1 = "Dulce et decorum est pro patria mori! Вперёд!";
		...
		case "Fort_attack_2":
			...
			link.l1 = "Жаль, что он сильно пострадал в бою с испанской эскадрой... но бой вести ещё вполне сможет.";
			link.l1.go = "Fort_attack_3";			
		break;
		
		case "Fort_attack_3":
			dialog.text = "Я сейчас приведу ополчение из города, всех, кто способен держать оружие. Зарядим пушки и нанесём врагу удар! Но только тогда, когда увидим, что твоя эскадра на подходе, иначе линейный корабль быстро разнесёт нас в щепки.";
			link.l1 = "Собирай людей, Мишель! Я немедленно выдвигаюсь назад в бухту!";
			link.l1.go = "Fort_attack_4";			
		break;
		
		case "Fort_attack_4":
			dialog.text = "Шарль, учти: самый опасный в эскадре - это линейный корабль. Постарайся уничтожить его в первую очередь. Мы тоже сосредоточим огонь оставшейся батареи форта на нём.";
			link.l1 = "Я понял, брат. Может быть, мне даже удастся взять его на абордаж.";
		...
		case "Victory_2":
			dialog.text = "А ты помнишь, что сказал я тебе при нашей первой встрече тут? 'Ты полюбишь эту жизнь', вот что! Да, и спасибо тебе огромное, брат, за твою помощь. Без тебя мне бы навряд ли удалось выбраться из застенков подземной базы.";
			link.l1 = "Не за что, Мишель. В конце-концов, ты мой брат, и я был обязан тебе помочь.";
			link.l1.go = "Victory_3";			
		break;
		
		case "Victory_3":
			dialog.text = "Смотрю на тебя, братец, и поражаюсь: столько силы во взгляде, уверенности в движениях, стати в осанке... и куда только подевался маратель полотен и придворный шаркун? Да! Ты превзошёл все мои самые смелые ожидания и, право, я не предполагал, что ты станешь... таким\nЭто меня даже немного... пугает. Ведь ты ни перед чем не остановишься для достижения поставленной цели. Ты стал хорош, слишком хорош...";
			link.l1 = "Что-то я опять перестал тебя понимать. Ты снова недоволен мной?";
			link.l1.go = "Victory_4";			
		break;
		
		case "Victory_4":
			dialog.text = "Нет, что ты... ни в коей мере! Я просто выразил своё восхищение.";
			link.l1 = "Понятно. Что ты будешь делать дальше, брат? Останешься на службе Ордена? Или вернёшься в наше родовое поместье? Да, и, чуть не забыл: ты обещал мне кое-что рассказать.";
			link.l1.go = "Victory_5";			
		break;
		
		case "Victory_5":
			dialog.text = "Что именно?";
			link.l1 = "О твоей службе у Пуанси. О каком-то индейском золоте, которое ты ему вёз. Обо всём, что предшествовало твоему заключению. Ты многого недоговаривал мне, Мишель, фактически используя меня втёмную. Так что...";
			link.l1.go = "Victory_6";			
		break;
		
		case "Victory_6":
			dialog.text = "Брат, я прекрасно помню свои слова. Я всё тебе расскажу. Но не посреди улицы же в горящем городе!\nУ нас у обоих сейчас много дел: тебе нужно заняться своей эскадрой - отремонтировать и подготовить корабли к выходу в море, мне вместе с губернатором - организовать и успокоить жителей, и привести Сен-Пьер в терпимое состояние\nА завтра утром мы с тобой спокойно всё обсудим за стаканчиком доброго французского вина. Поверь, у меня большие планы, братец. Очень большие. Но всему своё время. Приходи завтра к девяти утра в церковь к аббату Бенуа. Я остановлюсь на ночь у него, это мой старый друг.";
		...
		case "kukulkan":
			...
			dialog.text = "Вот мы снова и встретились, "+pchar.name+". Несмотря на моё предупреждение, ты всё равно стал искать меня, и твои поиски завели тебя очень далеко...";
			link.l1 = "Мишель?.. Почему-то я не удивлён. Мигель Дичозо вернулся в Тайясаль за очередной партией сокровищ? Ну-ну. Да, я искал встречи с тобой, братец. Уж очень мне хотелось посмотреть в твои бесстыжие глаза. Плюс к этому добавился счёт за твоё покушение на меня в кладбищенской крипте. Но сначала скажи - как тебя величать? Мишелем де Монпе, или Мигелем Дичозо?";
			link.l1.go = "kukulkan_1";			
		break;
		
		case "kukulkan_1":
			dialog.text = "Эти имена больше не имеют никакого значения, "+pchar.name+". Это всё - прошлое, которое очень скоро исчезнет даже из истории. Наступает момент истины, к которому я шёл долгие четверть века с самого своего появления на земле...";
		...
		case "kukulkan_2":
			...
			link.l1 = "Я потрясён... Получается, что ты и есть - Кукулькан?!";
		...
		case "kukulkan_5":
			...
			link.l1 = "Теперь всё становится ясно... А что стало с твоей матерью, Шочикецаль? Почему я никогда не видел её?";
		...
		case "kukulkan_12":
			...
			dialog.text = "На тебя, братец. Кукулькан умеет читать в человеческих сердцах. Письмо, оставленное у аббата Бенуа, должно было подстегнуть тебя к действиям. И я не ошибся в тебе. Я неотступно следил за тобой с того самого момента, как ты обратился к инквизитору Сантьяго. Ты сделал всё для меня и за меня. Ты собрал Стража Истины. Ты уничтожил конкурентов. Ты нашёл Ксочитэм\nЯ был там, следом за тобой. Правда, в мои расчёты не входило, что ты проникнешь в Тайясаль, но ты сумел сделать даже это. Ты превзошёл все мои ожидания. И с твоей помощью я сделаю то, для чего родился в теле смертного.";
			link.l1 = "В твоих рассуждениях есть один маленький просчёт, братец. У тебя нет твоей маски, без которой ты - ничто. Она у меня. А я не горю желанием отдать её тебе, и скорее разнесу её в клочья из картечницы, нежели позволю попасть в твои руки.";
			if (CheckCharacterItem(pchar, "mask_true")) link.l1.go = "kukulkan_13";	
			else link.l1.go = "kukulkan_14";			
		break;
		
		case "kukulkan_13":
			dialog.text = "То, что предначертано судьбой - не изменить. Я не позволю тебе повредить мой артефакт. Я чувствую его... Он у тебя. А ты здесь, в моём храме, в моей полной власти! Тебе не уйти отсюда, никогда. Пришло время испытать, братец, чего ты будешь стоить в битве против Кукулькана!";
			link.l1 = "Может, внутри тебя и дух божества, но тело твоё - смертно!";
			link.l1.go = "kukulkan_fight";		
		break;
		
		case "kukulkan_14":
			dialog.text = "Ха-ха-ха! Мне жаль тебя, братец... Но ты столь геройски шёл к поставленной цели, что я хочу посмотреть, чего ты будешь стоить в битве против Кукулькана!";
			link.l1 = "Может, внутри тебя и дух божества, но тело твоё - смертно!";
			link.l1.go = "kukulkan_fight";			
		break;
		...
		case "kukulkan_twice": // развилка финалов - есть настоящая маска или нет
			...
			{
				dialog.text = "";
				link.l1 = "Кажется, силы тебя оставляют, великий Кукулькан... Хоть ты и силён, но тело твоё - смертно!";
		...
		case "kukulkan_fail_1":
			...
			link.l1 = "Чёрт возьми... Ну ты и дал мне последним ударом... Но о каком артефакте ты говоришь? Маска? Она ведь у меня!";
			link.l1.go = "kukulkan_fail_2";
		break;
		
		case "kukulkan_fail_2":
			dialog.text = "Бедный, бедный капитан "+GetFullName(pchar)+"... Ты прошёл долгий путь, вынес все опасности, преодолел все угрозы, уничтожил столько сильнейших врагов - и лишь для того, чтобы в итоге потерпеть полное поражение!.. Нефритовая маска, которую ты нашёл в металлической коробке у останков 'Санта-Квитерии' на Ксочитэме - это НЕ МАСКА Кукулькана! Это всего лишь древняя нефритовая маска из сокровищницы Тайясаля\nЯ сам лично вывез её отсюда после своего неудачного похода: во-первых, на ней лежит заклятие сокровищницы, и именно благодаря ей 'Санта-Квитерию' захватил шторм при попытке покинуть Карибы и отнёс на Ксочитэм, а во-вторых, попав на Ксочитэм, она должна была ввести в заблуждение любого, кто бы явился туда за моим ИСТИННЫМ артефактом.";
			link.l1 = "Но... где же тогда была настоящая маска?! Я же обошёл весь Ксочитэм!..";
			link.l1.go = "kukulkan_fail_3";
		break;
		
		case "kukulkan_fail_3":
			dialog.text = "Не весь, "+pchar.name+". Мой артефакт находился на противоположной стороне острова от бухты с 'Санта-Квитерией', в надёжно охраняемом святилище. Путь туда ведёт через подводные пещеры, он сложен и неочевиден неискушенному оку смертного. Вот она! Полюбуйся на неё, напоследок...";
		...
		case "kukulkan_fail_5":
			dialog.text = "Случится то, что было предначертано, то, для чего я спустился на эту землю и родился в теле твоего брата более четверти века назад. Канек активирует портал времён, и я отправлюсь прямиком в десятый век, на семь столетий назад. Этого будет достаточно, чтобы цивилизация майя достигла непоколебимого военного и научного могущества над белой расой.";
			link.l1 = "Что будет со всем нашим миром? Он исчезнет?";
			link.l1.go = "kukulkan_fail_6";
		break;
		
		case "kukulkan_fail_6":
			dialog.text = "Отнюдь. Он изменится. Возможно, и тебе найдётся в НЁМ местечко, но только ты не будешь знать ничего о том, что происходило в ЭТОМ мире. Кто-то из ныне родившихся так и не появится, кто-то из не появившихся - напротив, увидит свет. Умершие воскреснут, живые умрут, так или иначе - все переродятся. Suum cuique, каждому - своё, "+pchar.name+"\nНе бойся, братец. Ты не осознаешь своей трансформации и воспримешь бытность в новой реинкарнации, как свою естественную жизнь. И лишь я один, Кукулькан, буду знать о том, что было, и что произошло... Но довольно! Канек уже всё подготовил для обряда\nТы пойдёшь со мной к ним, "+GetFullName(pchar)+", и станешь свидетелем последних минут существования ЭТОЙ бытности нашего мира, которую ты так стремился сохранить.";
			link.l1 = "...";
		...
		case "kukulkan_fail_8":
			dialog.text = "Врата времён открыты! Возрадуйтесь же, мои дети, ибо вы стоите на пороге величия! Мы создадим наш новый мир, новый свет, в котором не будет места белым захватчикам!\nПрощай, "+pchar.name+", и приготовься принять свою новую судьбу, какой бы она ни была. Suum cuique!";
			link.l1 = "...";
		...
		case "kukulkan_win":
			dialog.text = "Бой ещё не окончен, смертный. Ты уже изрядно измотан, а сюда идёт подкрепление! Ты всё равно отдашь мне мой артефакт, или я сниму его с твоего трупа - неважно...";
			link.l1 = "...";
			link.l1.go = "exit";
		...
		case "kukulkan_win_2":
			dialog.text = "Уракан! Ты что, не услышал меня? Ещё раз: я приказываю тебе и твоим воинам немедленно схватить и убить этого человека!";
			link.l1 = "...";
		...
		case "kukulkan_win_5":
			dialog.text = "Ты предаёшь свой народ, Уракан! Ты струсил перед лицом предстоящих перемен! Воины, я приказываю схватить и предать смерти не только этого человека, именующего себя моим братом, но и изменника Уракана!";
		...
		case "kukulkan_win_7":
			dialog.text = "";
			link.l1 = "Не ожидал такого поворота событий, а, брат? Боги сами должны решить, кто из них сильнее. И каждому воздастся по делам его, Мишель. Suum cuique! Каждому - своё...";
			link.l1.go = "exit";
