...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		// ица-горожане
		case "itza_ctz":
			dialog.text = LinkRandPhrase("Ещё один бледнолицый... Великий жрец быть рад вырезать твой сердце...","Бледнолицый знать, как прийти в Тайясаль, но ни один не выйти наш город!","Я удивлён, бледнолицый: ты ещё не уйти в страна духи... Гулять, пока ещё мочь, скоро ты увидеть свои предок.");
		...
		// Уракан - вождь ица
		case "urakan":
			dialog.text = "Ты есть великий воин, бледнолицый. Мы принести твоя кровь богам, ты умереть с почётом.";
			link.l1 = "Полегче, краснокожий воин. Я не намерен позволить вашему Канеку принести меня в жертву Кукулькану, или кому-то ещё. Твои воины не смогли схватить меня, и все полегли в бою.";
			link.l1.go = "urakan_1";
		break;
		...
		case "urakan_2":
			dialog.text = "Уста твои говорят правду, бледнолицый. Я есть Уракан, и я удивлён...";
			link.l1 = "Сейчас ты удивишься ещё больше, когда взглянешь на это... смотри.";
			link.l1.go = "urakan_3";
		break;
		...
		case "urakan_4":
			...
			link.l1 = "Чёрт побери! Значит, ОН уже здесь... (понижая голос) Уракан, я знаю всё. Я знаю, что это ты отправил Кстал Ча со Стражем Истины на поиски Ксочитэма и маски Кукулькана. Я знаю, что ты не хочешь перемен, которые несёт с собой пришествие Кукулькана...";
			link.l1.go = "urakan_5";
		break;
		...
		case "urakan_6":
			dialog.text = "Каждый воин ица рад явлению великий Кукулькан, белый воин. Ты должен предстать перед Кукулькан. Он ждать тебя уже много ночей. Он великий пророк, он всё знать наперёд. Идти к Крылатый Змей, другой дорога у тебя нет. Мы не позволить тебе уйти из Тайясаль.";
			link.l1 = "Неужели ты не понимаешь, что как только Кукулькан уйдёт через врата времён, вы все, и ты лично - перестанете существовать? И самое лучшее, что может быть - ты переродишься в другом облике, другом теле... может, простым воином. А может, калекой, или убогим...";
			link.l1.go = "urakan_7";
		break;
		...
		case "urakan_10":
			...
			dialog.text = "Свершилось! Как только я увидеть, как ты сражаться с Кукулькан, я сразу понять: ты - сам Кавиль, и ты прийти Тайясаль, дабы спасти народ ица от гибель от действий мой отец и Кукулькан. Мой отец, великий жрец Канек, обречь народ ица на гибель во славу давно мёртвый предки майя\nЯ, вождь Уракан, защищать народ ица много лет. Ни один бледнолицый не покинуть Тайясаль. Я и мой воины обеспечить охрану и жизнь народа ица на долгий-долгий век впредь. Я не хотеть приносить жертва весь мой люди.";
		...
		case "urakan_12":
			...
			link.l1 = "Ты отправил Ксатл Ча со Стражем Истины на поиски Ксочитэма и маски Кукулькана. Значит, ты знал, как с её помощью запечатать врата времён. Отец поведал тебе об этом?";
		...
		case "urakan_14":
			dialog.text = "Я выучить это наизусть. Письмена гласить: 'Когда солнце встать напротив дождь, а огонь между они в треугольник, ударить Тохил нога об нога и испепелить пламя маска Кукулькан на алтарь времён. И запечатать тогда Ицамна врата время до скончания век.'";
			link.l1 = "Алтарь времён - это то самое место внизу, где большой календарь? Где я встретился с Кукульканом?";
			link.l1.go = "urakan_15";
		break;
		
		case "urakan_15":
			dialog.text = "Да.";
			link.l1 = "Так-так... Ладно. Покажи мне, где находятся врата времён.";
			link.l1.go = "urakan_16";
		break;
		
		case "urakan_16":
			dialog.text = "Они находиться храм Кукулькана. Но дверь туда заперта. Её запирать и отпирать только мой отец. Когда он открывать дверь храм Кукулькан, он говорить: 'Солнце приходить и уходить, вода прибывать и убывать, огонь загораться и гаснуть, война и мир сменять друг друг, но только небо быть всегда. Выше время - только небо.'";
			link.l1 = "Занятно... Запомним и будем разбираться...";
			link.l1.go = "urakan_17";
		break;
		
		case "urakan_17":
			dialog.text = "Я быть тут, внизу, у алтарь времён. Если у тебя быть вопросы - задать их.";
		...
		case "urakan_adv":
			...
			{
				link.l1 = "Взгляни вот на эту скрижаль, которую мне удалось отыскать. Судя по месту, откуда я её взял, она имела отношение к твоему отцу, и это явно не простой предмет...";
				link.l1.go = "tablets";
			}
			if (CheckAttribute(npchar, "quest.treasureentrance"))
			{
				link.l1 = "Я нашёл на вершине Большого храма ещё один вход, но он закрыт. Как мне попасть туда? Возможно, там лежит то, что я ищу.";
				link.l1.go = "treasure";
			}
		...
		case "kanek_3":
			...
			link.l1 = "Этот человек - брат Кукулькана и великий воин. Я вижу в нём воплощение самого Кавиля! Никто, кроме него, не мог бы ТАК противостоять богу. Не вмешивайся в схватку богов, отец! И если ты приносишь жертвы Кукулькану, то мои воины отдают свою кровь Кавилю!";
			link.l1.go = "kanek_4";
		break;
		
		case "kanek_4":
			dialog.text = "Ты в своём уме, Уракан?";
			link.l1 = "Долгие годы я, названный в честь Хуракана, именем Кавиля успешно защищал наши земли от вторжения чужеземцев. Сотни их пали под нашими палицами, ни один не ушёл из Тайясаля. Но за всю свою жизнь я не видел воина более ловкого и сильного, нежели этот бледнолицый. Если он сумел победить Кукулькана, то в нём заключён дух самого Кавиля!";
			link.l1.go = "kanek_5";
		break;
