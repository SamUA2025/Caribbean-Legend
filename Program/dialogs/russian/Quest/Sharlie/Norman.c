...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "norman_us":
			...
			{
				dialog.text = LinkRandPhrase("Что тебе, "+GetSexPhrase("дружок","подруга")+"? Иди своей дорогой, занимайся делами-делишками, а от меня отстань.","Привет-привет, "+GetSexPhrase("паренёк","девчонка")+". Гуляешь? Вот и гуляй себе дальше, и отстань от дядюшки Абрахама. Он тоже гуляет, морским воздухом дышит.","Здравствуй, "+GetSexPhrase("парнишка","девица")+". Хочешь поболтать? Но вот ведь незадача: я не в настроении разговаривать. Так что поищи себе другого собеседника. Зайди в таверну, рому выпей...");
			...
			dialog.text = NPCStringReactionRepeat(LinkRandPhrase("Что тебе, "+GetSexPhrase("дружок","подруга")+"? Иди своей дорогой, занимайся делами-делишками, а от меня отстань.","Привет-привет, "+GetSexPhrase("паренёк","девчонка")+". Гуляешь? Вот и гуляй себе дальше, и отстань от дядюшки Абрахама. Он тоже гуляет, морским воздухом дышит.","Здравствуй, "+GetSexPhrase("парнишка","девица")+". Хочешь поболтать? Но вот ведь незадача: я не в настроении разговаривать. Так что поищи себе другого собеседника. Зайди в таверну, рому выпей..."), LinkRandPhrase(""+GetSexPhrase("Морячок","Морячка")+", ты туго соображаешь? Я вроде ясно объяснил.",""+GetSexPhrase("Парень","Деваха")+", иди проспись. А то, видать, слышишь плоховато.",""+GetSexPhrase("Паренёк","Девчонка")+", ты что - "+GetSexPhrase("дурачок","дурочка")+"? Я же вроде доступно всё расписал."), ""+GetSexPhrase("Приятель","Подруга")+", не доводи до греха. Я столько сухопутных крыс на своём веку перерезал, что одной больше, одной меньше - уже неважно.", "Ну всё, ты меня достал"+GetSexPhrase("","а")+". Теперь или доставай свою ржавую саблю, или беги со всех ног. Второе - вернее...", "block", 1, npchar, Dialog.CurrentNode);
			link.l1 = HeroStringReactionRepeat("Хорошо, приятель. Не буду тебе мешать.", "Да-да, я понял"+GetSexPhrase("","а")+". Просто вспомнил"+GetSexPhrase("","а")+" тут...", "Ух, да ты, видать - Гроза морей! Ладно, ухожу.", "Что?!", npchar, Dialog.CurrentNode); 
		...
		case "norman_fes":
			...
			switch (drand(5))
			{
				case 0:
					...
					link.l2 = "Ха, ты ещё адмиралом назовись, вот тогда точно поверю!";
					link.l2.go = "norman_fes0_peace";
				break;
				
				case 1:
					dialog.text = "Руки по швам! Перед тобой адмирал Барбариго! Ты что, не узнал"+GetSexPhrase("","а")+" мою знаменитую саблю?";
					link.l1 = "Виноват"+GetSexPhrase("","а")+", господин адмирал! Впредь буду внимательнее.";
				...
				case 2:
					dialog.text = "Я, видите ли, здесь в изгнании, жду новостей от генерала Монка. Прошу не разглашать моё королевское инкогнито. У разведки Кромвеля длинные уши.";
					link.l1 = "Конечно, Ваше Величество. Никто не узнает, что Карл II прячется в Вест-Индии.";
					link.l1.go = "norman_fes2_fight";
					link.l2 = "Ну а я тогда - "+GetSexPhrase("римский папа Иннокентий X","Пресвятая Дева Мария")+".";
					link.l2.go = "norman_fes2_peace";
				break;
				
				case 3:
					dialog.text = "Куда ты пропал"+GetSexPhrase("","а")+", "+GetSexPhrase("Блейз","Беатрис")+"? Я ищу тебя второй день. Ты совсем забыл"+GetSexPhrase("","а")+" своего папу Николаса!";
				...
				case 5:
					dialog.text = "Я пьесу новую закончить тороплюсь. Ты долж"+GetSexPhrase("ен","на")+" мне помочь продолжить фразу 'Быть, иль не быть?!'";
					link.l1 = "Вот, в чём единственный вопрос! Сносить ли нам и впредь обиды свысока...";
		...
		case "norman_fes0_fight":
			dialog.text = "Какой к дьяволу 'Тесоро'?! Ты бы его ещё Бермудами обозвал"+GetSexPhrase("","а")+"! Запомни, в честь меня этот остров называется Норман-Айленд. Придётся поучить тебя географии...";
		...
		case "norman_fes0_peace":
			dialog.text = "Ты прав"+GetSexPhrase("","а")+", "+GetSexPhrase("матрос","морячка")+". На самом деле я адмирал Барбариго, но это строго между нами. Готовься к походу, скоро выступаем. Это тебе пригодится.";
			link.l1 = "Премного благодар"+GetSexPhrase("ен","на")+"!";
		...
		case "norman_fes1_fight":
			...
			link.l1 = "Ты что, серьёзно?!";
			link.l1.go = "fight";
			NextDiag.TempNode = "norman_fight_again";
		break;
		
		case "norman_fes1_peace":
			dialog.text = "То-то же! На вот, выпей за моё здоровье.";
		...
		case "norman_fes2_fight":
			dialog.text = "Я же просил не разглашать моё имя! Теперь придётся убрать тебя, как опасного свидетеля...";
		...
		case "norman_fes3_fight":
			dialog.text = "Все ко мне! Я поймал "+GetSexPhrase("лазутчика","лазутчицу")+", "+GetSexPhrase("похожего на моего сына","похожую на мою дочь")+"! "+GetSexPhrase("Его","Её")+" наверняка подослал Томас, чтобы выбить мне второй глаз!";
		...
		case "norman_fes3_peace":
			dialog.text = "Ты устал"+GetSexPhrase("","а")+" и плохо выглядишь, "+GetSexPhrase("сынок","доченька")+". На-ка вот, подлечись.";
			link.l1 = "Спасибо!";
		...
		case "norman_fes4_fight":
			dialog.text = "Её не надо бояться, "+GetSexPhrase("дружок","подруга")+". Смотри, умирать совсем не страшно...";
		...
		case "norman_fes4_exit":
			...
			if (GetDataDay() == 17)
			{
				...
				//Log_Info("Вы получили жилет бретёра");
			}
			else
			{
		...
		case "norman_fes5_fight":
			dialog.text = "Хренов"+GetSexPhrase("ый","ая")+" ты поэт"+GetSexPhrase("","есса")+", "+GetSexPhrase("матрос","морячка")+", быть может, твой клинок проворней языка?";
		...
		case "norman_fes5_exit":
			...
			else
			{
				if (GetDataDay() == 28 && GetDataMonth() == 11)
				{
					...
					//Log_Info("Вы получили тотем 'Лужёная глотка'");
				}
				else
				{
		...
		case "norman_fes_again":
			dialog.text = "Всё-всё, "+GetSexPhrase("приятель","подруга")+", поговорили-договорили, и ладно. Гуляй себе дальше.";
			link.l1 = "Как скажешь...";
			link.l1.go = "exit";
		...
		case "tieyasal_10":
			dialog.text = "Я не об этом, матросик... Ой, прости - капитан. Да, по-хранцузски Дичозо шпарит знатно, не хуже тебя. И по-англицки тоже. Однако в его жилах течёт индейская кровь. Я таких много повидал в своей жизни. Это явно не видно, но он полукровка. Я тебе точно говорю.";
			link.l1 = "А по-индейски он не говорит?";
			link.l1.go = "tieyasal_11";
		break;
		
		case "tieyasal_11":
			dialog.text = "А пёс его разберет. Может, и говорит. Хотя - точно, говорит! Он постоянно вворачивал фразы на непонятном языке, и делал при этом страшно учёный вид и раздувал щёки. Вот, например, скажет что-то вроде: когито эрго сум! А потом выкатит глаза и смотрит за реакцией матросиков. Или вот так он часто восклицал: аут цезар, аут нихил! Он ещё много чего лопотал, да я не помню всего.";
			link.l1 = "Это не индейский язык. Это латынь. Латынь... Латынь?! Чёрт возьми!!";
			link.l1.go = "tieyasal_12";
		break;
		
		case "tieyasal_12":
			dialog.text = "Ты чего запрыгал, парень? Чего орёшь? Никак змея укусила? Где она?";
			link.l1 = "Да как же я сразу-то не догадался! Всё лежало на поверхности! Латынь! Мигель... Мишель Счастливчик!!";
		...
		case "tieyasal_14":
			dialog.text = "Не-е, дружочек, он не хранцуз. Я тебе говорю - полукровка. Его белый папашка обрюхатил индианочку, из араваков или мискито, из карибов или даже ица, а от неё и появился на свет Божий Мигель Дичозо. Ты этого не видишь, а я вижу. У него в глазах написано...";
			link.l1 = "Оставим вопрос о его происхождении. Где он, Абрахам?! Он был тут?!";
			link.l1.go = "tieyasal_15";
		break;
		
		case "tieyasal_15":
			dialog.text = "Тс-с... Да, он был тут. Но он ушёл. Его сейчас нет на Исла Тесоро.";
		...
		case "tieyasal_18":
			dialog.text = "А ты? Зачем ты его ищешь? О, понимаю, понимаю: чтобы убить его! Убей его, убей мерзавца! Отомсти за Блейза Шарпа! Блейз был отличным парнем. Я помню его ещё ребёнком - весь в Николаса.";
		...
		case "tieyasal_20":
			dialog.text = "Люди Дичозо. Он приказал караулить тебя здесь. О, я знаю, знаю! Будь внимателен, капитан: у рифов Исла Тесоро стоят корабли, и стоят они по твою душу. Капитан их очень хитёр. Не дай себя обмануть.";
			link.l1 = "Я постараюсь...";
			link.l1.go = "tieyasal_21";
		break;
		
		case "tieyasal_21":
			dialog.text = "И ещё: вот, возьми мою саблю. Бери-бери, она тебе понадобится. Это сторта самого капитана Барбариго, да-да. Отличный клинок. Лучший на архипелаге. Не стесняйся, бери. Блейз Шарп должен быть отомщён!";
