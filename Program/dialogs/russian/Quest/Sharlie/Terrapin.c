...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "tibo_17":
			dialog.text = "";
			link.l1 = "Мартэн должен выполнить то, что обещал мне, но пусть даже не смеет взять девушку на своё корыто. Она должна остаться в бухте и ждать меня. Передашь Роберу: если он не выполнит своих обязательств, или увезёт Кэтрин, или с головы девушки упадет хоть один волос, я потрачу остаток жизни, но найду его и доставлю полковнику Фоксу... живым. Да, кстати - и тебя, Тибо, тоже...";
			link.l1.go = "tibo_18";
		break;
