...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "sister":
			dialog.text = "Ха! Вы первый, кто обозвал мою сестрёнку красавицей. Господь дал ей стать гренадёра и иерихонскую трубу вместо глотки. Это да! В драке наша Молли может постоять за себя\nНо вот на том, что выше плеч, фантазия Отца небесного закончилась, и он не нашёл ничего лучшего, кроме как прилепить к её пышным формам рябую рожу нашего папаши. А надо сказать, что ещё при жизни от одного его вида лошади падали в обморок.";
			link.l1 = "Я смотрю, ты не слишком расстроился...";
			link.l1.go = "sister_1";
		break;
		
		case "sister_1":
			dialog.text = "Да откуда же ей взяться на Тортуге? Кэтрин, дочь нашего бравого полковника, у которой Молли служит в няньках с самого рождения, собиралась порадовать своего отца визитом к его юбилею. Но эскадра, с которой она должна была прибыть, задержалась в Англии, так что подарка не получилось\nЕсли хочешь увидеть настоящую Молли Джонс, а заодно и её хозяйку - вот уж кто истинная красотка - заходи через месяц. Не раньше.";
		...
		case "Rober":
			...
			dialog.text = "Что нужно?! Я не расположен тратить время на пустые беседы.";
			if (CheckAttribute(PChar, "questTemp.Terrapin") && pchar.questTemp.Terrapin == "rober")
			{
				link.l1 = "У меня есть к тебе дело, кэп. Я вижу, ты не весел, и возможно моё предложение тебя взбодрит.";
				link.l1.go = "rober_1";
			}
			else
			{
		...
		case "rober_1":
			...
			link.l1 = "Я в курсе ваших дел с Тибо... Не дёргайся! Меня ты можешь не бояться, я намерен предложить тебе сделку.";
			link.l1.go = "rober_2";
		break;
		
		case "rober_2":
			dialog.text = "Дьявольщина! Проклятая пьяная свинья!.. Не успел я его...";
		...
		case "rober_3":
			dialog.text = "Каррамба! Я вспомнил, кто ты! Ты - тот самый парень, который умыл полковника д'Ойли, отобрав у него целый остров! Ты был замешан в крупных махинациях Голландской Вест-Индской Компании, ты якшаешься с пиратским бароном Западного Мэйна... Тебя зовут... "+GetFullName(pchar)+", верно?";
		...
		case "rober_4":
			...
			dialog.text = "Аргх! Да как же я могу расслабиться, когда мной заинтересовался один из самых известных интриганов архипелага, да ещё и вызнал что-то про мои дела! Чёрт меня дёрнул напасть на этот бриг! Что ты от меня хочешь?";
			link.l1 = "Уймись и слушай. Похоже, нам обоим нужна голова Левассера. Этот напыщенный индюк отжил своё и стал мешать серьёзным людям. Я намерен сменить власть на острове и поставить на его место человека де Пуанси, но не хочу лишний раз проливать кровь соотечественников, тем более из-за такого мерзавца. Ты можешь мне в этом помочь. А я помогу тебе и Тибо сохранить свои привилегии.";
			link.l1.go = "rober_5";
		break;
		
		case "rober_5":
			dialog.text = "Не верю ушам своим! Ты прав - у нас общие цели. С тобой может получиться более интересный вариант, чем тот, который я сейчас обдумывал... Тибо отличный фехтовальщик, но у него не хватит духу, чтобы перегрызть горло своему дяде. А вот у такой акулы, как ты, это выгорит. Слава твоя хорошо известна\nТвои гарантии мне не нужны, но я помогу тебе в обмен на эту кралю. Она нужна мне в качестве заложницы, пока я не закончу свои дела на Карибах. Скоро за мной начнут охоту английские фрегаты. Чёрт меня дёрнул напасть на тот бриг! Слишком лёгкой добычей он выглядел после шторма...";
			link.l1 = "Что в нём было особенного? Девка, которую вы утаили от Левассера?";
			link.l1.go = "rober_6";
		break;
		
		case "rober_6":
			dialog.text = "Да. Ты должен уговорить Тибо расстаться с девчонкой. Я попросил его приглядеть за ней, пока я выясню, кто она такая, но эта мисс Джонс, или как её там, совсем закружила ему голову, и теперь Анри прячет её даже от меня. Приведи ко мне эту чертовку, а я организую для тебя встречу с Левассером за городом. Ну а там у тебя будет возможность его прикончить. Я буду ждать в бухте Глаз Рыбы.";
			link.l1 = "Договорились. Теперь рассказывай, как мне выйти на Тибо.";
			link.l1.go = "rober_7";
		break;
		
		case "rober_7":
			dialog.text = "Его дом тебе укажут в таверне: Анри - личность известная. Припугни Тибо угрозой разоблачения и заставь его привести пленницу ко мне в лапы. Ну а я через верных людей в тот же день передам Левассеру весточку, что его племянник прячет от него редкую красавицу в городском подземелье\nМой гонец найдёт тебя в таверне. Не найдя любимого племянника, губернатор явится в катакомбы с небольшой свитой, и у тебя появится отличная возможность свести с ним счёты.";
			link.l1 = "Куда доставить девчонку?";
			link.l1.go = "rober_8";
		break;
		
		case "rober_8":
			dialog.text = "Скажешь, чтобы он сам доставил её в бухту. Заодно я скажу ему пару слов...";
			link.l1 = "Хорошо. Считай, что мы договорились. Увидимся на Тортуге!";
			link.l1.go = "rober_9";
		break;
		
		case "rober_9":
			dialog.text = "Если всё пойдёт как надо, мы с тобой более никогда не встретимся. Надеюсь на это. Бывай!";
			link.l1 = "...";
			link.l1.go = "rober_10";
		break;
		...
		case "rober_abordage":
			dialog.text = "Аргх! Никак не ожидал, что ты придёшь по мою душу... Мы же с тобой не ссорились, приятель! Я сделал всё, как договорились! Какого чёрта?!";
			link.l1 = "Тебя заказали, Робер. Заказали мне. Так что я выполняю свою работу.";
			link.l1.go = "rober_abordage_1";
		break;
		
		case "rober_abordage_1":
			dialog.text = "Дьявол! Это невозможно! Он не мог так быстро всё узнать! И как он вообще узнал?!";
			link.l1 = "Ты имеешь в виду Фокса? Нет. Я не от него. Полковник ещё не знает, что ты зарезал его дочь. Твоей смерти желает бывший дружок, Анри Тибо. Он нанял меня.";
			link.l1.go = "rober_abordage_2";
		break;
		
		case "rober_abordage_2":
			dialog.text = "Проклятый светский хлыщ! Надо было прикончить его, когда он был на 'Вольтижёре'... Сколько тебе пообещал этот гад?";
		...
		case "rober_abordage_3":
			...
			link.l1 = "Из каких таких средств, Робер? Я уверен в том, что ты лжёшь. У тебя нет даже той суммы, которая обещана Анри. Но это не главное. Если бы не один факт, я бы отказался от предложения охотиться за тобой и решать грязные делишки Тибо.";
			link.l1.go = "rober_abordage_4";
		break;
		
		case "rober_abordage_4":
			dialog.text = "Какой такой факт?";
			link.l1 = "Ты убил девушку. Её вина заключалась лишь в том, что она была дочерью полковника Фокса. Я ненавижу мерзавцев, которые режут беззащитных женщин! Так что ни о каких договорах с тобой и речи быть не может. Не надейся.";
			link.l1.go = "rober_abordage_5";
		break;
		
		case "rober_abordage_5":
			PlaySound("VOICE\Russian\sharlie\Rober Marten-03.wav");
			dialog.text = "Проклятие! Но что мне оставалось ещё делать?! Я не мог отпустить её живой или возить без конца на корабле! А ты... ты - аферист, интриган, наёмник - читаешь мне морали! Посмотри на себя! На свои 'методы'! Ты ничем не лучше меня, ничем!";
		...
		case "tibo":
			...
			dialog.text = "Что вы делаете в моём доме, сударь?";
		...
		case "tibo_1":
			...
			link.l1 = "Капитан Мартэн ждёт вас прямо сейчас в бухте Глаз Рыбы. Но не одного. Он также хочет узреть вместе с вами мисс Молли Джонс. Вы понимаете, о чём я?";
			link.l1.go = "tibo_2";
		break;
		
		case "tibo_2":
			PlaySound("VOICE\Russian\sharlie\Henry Thibault-01.wav");
			dialog.text = "Увы, сударь, но - нет. Никакой Молли Джонс я знать не знаю, а Роберу не было нужды присылать вместо себя парламентёра, которого я в первый раз вижу. К вашему сведению, месье, я здесь второй человек после моего дяди губернатора, так что...";
		...
		case "tibo_3":
			dialog.text = "Что... что вы несёте?";
			link.l1 = "Вам, как никому другому должен быть известен крутой нрав вашего дяди. О том, что вы укрыли девчонку, Левассеру станет известно ещё до захода солнца. Не спрашивайте меня, откуда это узнал Робер, но заверяю: он крайне напуган и готов немедленно поднять якоря. Он даже не посмел явиться в город, и упросил меня за кругленькую сумму доставить вам это сообщение.";
			link.l1.go = "tibo_4";
		break;
		
		case "tibo_4":
			dialog.text = "Чёрт... но этого не может быть!";
		...
		case "tibo_5":
			dialog.text = "Каррамба! Как же дядя сможет прознать об этом?";
		...
		case "tibo_6":
			dialog.text = "Похоже, вы не лжёте, сударь. Передайте Мартэну...";
			link.l1 = "Вы не поняли, Анри. Мартэн не будет вас ждать. Ваша единственная надежда - увезти отсюда девку, из-за которой вы оба с Робером вляпались в дерьмо по самые уши. Бегите туда, где вы её прячете, хватайте под белые ручки и тащите на 'Вольтижёр'. Не найдя её, ваш дядя ничего не сможет вам предъявить.";
			link.l1.go = "tibo_7";
		break;
		...
		case "tibo_10":
			dialog.text = "Хм. И что?";
			link.l1 = "Капитан Мартэн ждёт вас прямо сейчас в бухте Глаз Рыбы. Но не одного. Он также хочет узреть вместе с вами мисс Кэтрин Фокс. Вы понимаете, о чём я?";
			link.l1.go = "tibo_11";
		break;
		
		case "tibo_11":
			dialog.text = "Увы, сударь, но - нет. Никакой Кэтрин Фокс я знать не знаю.";
			link.l1 = "Я ожидал подобного ответа. Конечно, навряд ли вы ранее могли быть представлены дочери полковника Фокса, командира 'морских лис'... К чёрту игры! Вы с Робером заварили такую кашу, что навряд ли расхлебаете! Девушка, захваченная с английского брига, которую вы утаили от Левассера, и известная тебе как Молли Джонс - дочь полковника Фокса, Кэтрин Фокс!";
			link.l1.go = "tibo_12";
		break;
		
		case "tibo_12":
			dialog.text = "Что?!";
			link.l1 = "Что-то вы побледнели, сударь. Так вот, слушай меня внимательно, Анри, и вникай: ты и твой дружок Робер по уши в дерьме. С недели на неделю на Карибы прибывает военная эскадра Кромвеля. Только её флагман способен разнести ваш хвалёный Ля-Рош за пару часов. Как ты думаешь, нападение на английский бриг и пленение дочери Фокса - достаточный повод для этого?";
			link.l1.go = "tibo_13";
		break;
		
		case "tibo_13":
			dialog.text = "";
			link.l1 = "Но это ещё не всё. О ваших махинациях стало известно не только мне. Твой дядя-губернатор узнает о том, что ты в нарушение его приказа утаил от него девушку, которую старый хрыч наверняка захотел бы забрать себе. Как ты думаешь, Анри, что с тобой сделает твой дядюшка? Его крутой нрав должен быть известен тебе, как никому другому...";
			link.l1.go = "tibo_14";
		break;
		
		case "tibo_14":
			dialog.text = "Это всё ложь!";
			link.l1 = "Да? Дорогой мой, спросишь у своего друга Мартэна. Именно он послал меня к тебе. О том, что вы укрыли девчонку, Левассеру станет известно ещё до захода солнца. Не спрашивай меня, откуда это узнал Робер, но заверяю: он крайне напуган и готов немедленно поднять якоря. Он даже не посмел явиться в город, и упросил меня доставить тебе это сообщение.";
			link.l1.go = "tibo_15";
		break;
		
		case "tibo_15":
			dialog.text = "";
			link.l1 = "Мартэн не будет ждать тебя дольше двух часов - ему дорога собственная голова. Только в знак вашей дружбы он до сих пор торчит в бухте Глаз Рыбы и ждёт, пока ты отведёшь ему девушку, а не прячется где-нибудь у голландцев... Однако несчастный Робер даже не подозревает, кто есть Молли Джонс на самом деле. Тоже мне, ценители женских статей! Не смогли отличить леди от простолюдинки!";
			link.l1.go = "tibo_16";
		break;
		
		case "tibo_16":
			dialog.text = "Чего ты хочешь?";
			link.l1 = "Ну наконец-то я слышу разумные слова! Значит так, Тибо: сейчас ты идёшь туда, где прячешь Кэтрин, берёшь её нежно под белые ручки и идёшь вместе с ней в бухту Глаз Рыбы, где стоит 'Вольтижёр' Мартэна. Скажешь ему, что планы меняются...";
			link.l1.go = "tibo_17";
		break;
		
		case "tibo_17":
			dialog.text = "";
			link.l1 = "Мартэн должен выполнить то, что обещал мне, но пусть даже не смеет взять девушку на своё корыто. Она должна остаться в бухте и ждать меня. Передашь Роберу: если он не выполнит своих обязательств, или увезёт Кэтрин, или с головы девушки упадёт хоть один волос, я потрачу остаток жизни, но найду его и доставлю полковнику Фоксу... живым. Да, кстати - и тебя, Тибо, тоже...";
			link.l1.go = "tibo_18";
		break;
		
		case "tibo_18":
			dialog.text = "";
			link.l1 = "Кто я такой, и какие у меня возможности - спросишь у Робера, он в курсе. Если же вы оба сделаете, как я сказал - в выигрыше останемся все мы: Робер сможет и дальше пиратствовать, ты - сохранишь все свои привилегии и получишь наследство горячо любимого дядюшки, а я... тоже в накладе не останусь. Всё понял?";
			link.l1.go = "tibo_19";
		break;
		...
		case "tibo_22":
			...
			link.l1 = "Как вы любезны сегодня, однако, месье Тибо... Давайте не будем рассиживаться, а перейдём непосредственно к сути дела.";
			link.l1.go = "tibo_23";
		break;
		
		case "tibo_23":
			dialog.text = "Дело касается моего бывшего друга и компаньона, небезызсвестного вам Робера Мартэна, бывшего капитана галеона 'Вольтижёр'...";
			link.l1 = "Значит, Робер вам больше не товарищ? Очень занятно!";
			link.l1.go = "tibo_24";
		break;
		
		case "tibo_24":
			dialog.text = "Капитан, выслушайте причины, побудившие меня искать вашей помощи, и вы всё поймёте. Как вы сами знаете, Мартэн взял на абордаж английский бриг, и пленил англичанку, некую служанку по имени Молли Джонс, из-за которой потом и заварилась вся эта каша.";
			link.l1 = "Конечно, знаю. Как я понимаю, вы выполнили мои рекомендации и отвели девушку на корабль Мартэна?";
			link.l1.go = "tibo_25";
		break;
		
		case "tibo_25":
			dialog.text = "Да, выполнил. Но не проходит и дня, чтобы я не пожалел о содеянном. Если хотите знать, Молли - очень красивая и обаятельная девушка, я таких раньше не встречал. Не побоюсь сказать - я в неё влюбился. И я тоже был ей симпатичен, она сама так говорила! Я не мог допустить, чтобы она попала в руки дяди\nКогда я отводил её на 'Вольтижёр', я был уверен, что после того, как дядюшка, не найдя никаких спрятанных девушек, успокоится, Робер привезёт её обратно на Тортугу и я поселю её в своём доме. Во всяком случае, такой договор был у нас с Мартэном. Но всё обернулось совсем не так\nКогда обнаружилось, что дядюшка убит, скрывать Молли более не стало причин, и я стал ожидать прибытия 'Вольтижера' с Молли на борту со спокойной душой.";
			link.l1 = "И 'Вольтижёр' прибыл?";
			link.l1.go = "tibo_26";
		break;
		
		case "tibo_26":
			dialog.text = "Прибыл. Вот только Молли на нём не было. Робер вёл себя так, словно за ним гнался сам Люцифер. Во время этого кратковременного плавания он каким-то образом прознал одну ужасную вещь: девушка, Молли, была совсем не Молли Джонс, а Кэтрин Фокс! Дочь самого полковника Фокса, командира английской морской пехоты, 'морских лис'! Вы понимаете, что это означает!";
			link.l1 = "Вот это да! Безусловно, в таком случае Роберу есть чего бояться. Но как такое могло получиться?";
			link.l1.go = "tibo_27";
		break;
		
		case "tibo_27":
			dialog.text = "Когда Кэтрин взяли в плен, она намеренно выдала себя за служанку Молли Джонс, погибшую при абордаже. Она боялась, что Мартэн узнает, кто она на самом деле. И обман ей удался. Но во время последнего плавания Робер каким-то образом прознал, кто она на самом деле. Сказал, нашёл какие-то её письма, или бумаги...";
			link.l1 = "И где же девушка сейчас, раз её не было на 'Вольтижёре'?";
			link.l1.go = "tibo_28";
		break;
		...
		case "tibo_29":
			dialog.text = "Он считает, что вся его команда повязана с ним кровью. Возможно, он в чём-то прав. Но я знаю полковника Фокса! Он будет копать до последнего, до конца своих дней, чтобы найти того, кто похитил его дочь!";
			link.l1 = "В этом у меня нет сомнений. Особенно после того, как французы убили его жену. Теперь ещё и дочь... А вы уверены, месье, что Кэтрин действительно мертва? Может, Робер спрятал её от вас где-нибудь...";
			link.l1.go = "tibo_30";
		break;
		
		case "tibo_30":
			dialog.text = "Уверен. Я разговаривал с матросом с 'Вольтижёра'. Ему можно верить. Он своими глазами видел, как девушке перерезали горло, а затем привязали к ногам пушечное ядро и выбросили за борт.";
			link.l1 = "Да уж... ничего не скажешь. Жаль бедняжку. Но чего же вы от меня хотите, Анри?";
			link.l1.go = "tibo_31";
		break;
		
		case "tibo_31":
			dialog.text = "С того дня я не могу спать спокойно. У меня перед глазами постоянно стоит Молли... точнее, Кэтрин. Я сам отвёл её на смерть! Не могу простить себе этого. Кроме того, я не питаю иллюзий насчёт Фокса. Он выйдет на след Мартэна, рано или поздно, заставит его говорить, а когда узнает, что его дочь убита - произойдёт что-то страшное. Не поздоровится всем, кто был так или иначе причастен к этой истории.";
			link.l1 = "И вам в том числе.";
			link.l1.go = "tibo_32";
		break;
		
		case "tibo_32":
			dialog.text = "И мне. Поэтому я хочу, чтобы вы нашли Мартэна раньше, чем это сделает Фокс. Отыщите мерзавца и убейте его. И если нетрудно - то перед смертью заставьте его страдать... за несчастную Кэтрин. Когда он умрёт, отрежьте у него безымянный палец правой руки с кольцом и принесите мне - это будет доказательство\nЯ хорошо знаю и его кривой палец, и это кольцо, так что легко узнаю, кому он принадлежал! Если вы сделаете это, я заплачу вам четверть миллиона серебром.";
		...
		case "tibo_33":
			dialog.text = "Потому что я тоже кое-что про вас узнал, "+GetFullName(pchar)+". Это было нетрудно: вы - личность известная. Непонятно правда, на кого вы работаете - то ли на де Пуанси, то ли на голландцев, то ли на англичан, то ли на пирата Яна Свенсона... Но ясно одно: вы берётесь за опасные и скользкие дела, сулящие приличный барыш, и успешно их выполняете. И не связаны с испанцами\nВедь и к событию, благодаря которому я получил наследство горячо любимого дядюшки, приложили руку тоже вы? Не отпирайтесь... Сумма в четверть миллиона - немалые деньги. Я скажу, где искать Мартэна. Вам нужно только перехватить его и взять на абордаж.";
			link.l1 = "Увеличьте гонорар ещё на сто тысяч - и я займусь вашей проблемой.";
			link.l1.go = "tibo_34";
			link.l2 = "Увы, месье Тибо, но решать свою проблему с Мартэном и полковником Фоксом вы будете без моего участия. Я со своей стороны обещаю, что не стану извещать полковника о судьбе его дочери и о тех, кто виновен в её смерти. Всего доброго, сударь.";
		...
		case "tibo_34":
			dialog.text = "Сударь, побойтесь Бога... У меня же нет в сундуках миллионов, поверьте! Я понимаю, что ваши услуги недёшевы, поэтому и предложил сразу двести пятьдесят тысяч. Ну хорошо, давайте я ещё добавлю пятьдесят тысяч золотом. Но больше я просто не могу!";
			link.l1 = "Ладно. По рукам. Давайте ваши вводные - где в последний раз видели Мартэна?";
			link.l1.go = "tibo_35";
		break;
		
		case "tibo_35":
			dialog.text = "Он подался к испанцам в Каракас и добился аудиенции у дона Диего Франциско де Кера, губернатора. Чем-то он сумел его умаслить, поскольку этот дон даровал ему покровительство испанской короны. Свой галеон Робер продал. Теперь он капитан тяжёлого галеона под названием 'Инфанта'. Видать, у Мартэна были немалые сбережения, раз хватило и на подкуп, и на приобретение и снаряжение большого военного корабля\nТак вот, через несколько дней он выйдет из Каракаса на своём новом корабле и в составе эскадры отправится в Санто-Доминго. Это всё, что смог узнать мой агент. Единственная возможность схватить Мартэна - это настигнуть испанскую эскадру на этом переходе\nЕсли конвой достигнет Санто-Доминго - Робера вы уже не достанете, а куда он отправится потом - одному Богу известно.";
			link.l1 = "Ясно. Буду перехватывать эскадру у Эспаньолы на подходе к Санто-Доминго.";
			link.l1.go = "tibo_36";
		break;
		
		case "tibo_36":
			dialog.text = "И не забудьте про палец с кольцом! Это обязательное условие нашего договора! Я хочу быть абсолютно уверен в том, что Робер мёртв!";
		...
		case "tibo_time":
			dialog.text = "Мартэн ещё оскверняет Карибы своим присутствием, капитан?";
		...
		//	Log_Info("Вы получили 500 дублонов");
			...
			dialog.text = "У меня уже всё готово. Пожалуйста, получите ваш гонорар.";
		...
		case "envoy_1":
			dialog.text = "Твой должник просил передать, что дело сделано, и рыба приплывёт в сеть не позднее, чем через час. Так что поспеши.";
		...
		case "levasser_cave":
			...
			dialog.text = "Какого чёрта ты здесь шляешься? Кто ты такой? Отвечай немедленно!";
			link.l1 = "А ты кто такой, чтобы задавать мне дурацкие вопросы?";
			link.l1.go = "levasser_cave_1";
		break;
		
		case "levasser_cave_1":
			dialog.text = "Что?! Наглец! Я кто такой? Да я губернатор этого острова Франсуа Левассер, сеньор де Рене де Буадуфле де Летр! И всё, что на нём, в моей власти! И ты в том числе, пока ты ходишь по моей земле, червяк!";
			link.l1 = "Охо-хо... Какой пафос! Но ты заблуждаешься, Левассер, сеньор де Рене и прочее и прочее. Время твоё закончилось. Приказом генерал-губернатора Франсуа Ловинье де Пуанси ты смещён с поста и заочно приговорён к смерти! А я - твой судья и палач в одном лице!";
		...
		case "levasser_room":
			dialog.text = "Какого чёрта ты здесь делаешь? Кто ты такой? Где Анри? Отвечай немедленно!";
		...
		case "levasser_room_1":
			dialog.text = "Да, я губернатор этого острова Франсуа Левассер, сеньор де Рене де Буадуфле де Летр! И всё, что на нём, в моей власти! И ты в том числе, пока ты тут, каналья! Отвечай на заданный тебе вопрос! Сержант, заприте дверь - этот тип мне кажется очень подозрительным!";
			link.l1 = "Ты необычайно проницателен, месье Левассер, сеньор де Рене и прочее и прочее. Моё появление здесь не сулит тебе ничего хорошего. Приказом генерал-губернатора Франсуа Ловинье де Пуанси ты смещён с поста и заочно приговорён к смерти! А я - твой судья и палач в одном лице!";
		...
		case "roof_girl":
			...
			link.l1 = "Замолчи, дурёха! Если не будешь орать - я тебе ничего не сделаю!";
		...
		case "roof_girl_3":
			dialog.text = "Ой, не надо! Месье Тибо побежал дальше, вон туда, в сторону моря, и спрыгнул с подъёмника, прямо в воду. Наверное, он убился - там очень высоко...";
		...
		case "kathy":
			...
			link.l1 = "Надеюсь, что спасти, так как намерен вернуть тебя, Кэтрин Фокс, отцу в Сент-Джонс. Если он после этого прибьёт тебя за непослушание, то моя вина в этом будет второстепенной. Однако я всё же полагаю, что полковник будет рад видеть свою дочь живой, угодившую благодаря своему легкомыслию в такую переделку.";
			link.l1.go = "kathy_1";
		break;
		...
		case "kathy_3":
			dialog.text = "Скажите, капитан, вы действительно отвезёте меня к отцу, в Сент-Джонс?";
		...
		case "kathy_4":
			dialog.text = "Если мы доберёмся до Антигуа, я приложу все усилия, чтобы убедить своего отца в том, что среди французов есть настоящие рыцари...";
			link.l1 = "Буду весьма признателен за это... Ладно, я надеюсь на то, что мои бравые орлы всё-таки отследили мой путь по крышам города и уже ищут нас...";
			link.l1.go = "exit";
		...
		case "kathy_5":
			...
			dialog.text = "До последней минуты мне не верилось, что вы сдержите своё обещание! Слишком много мерзости было вокруг меня последнее время. Я благодарю вас капитан за то, что вы вернули мне веру в людей и благородство. Вы непременно должны навестить моего отца!\nТакие люди, как вы, всегда пользовались у него уважением. И неважно, что вы француз. Я сделаю всё возможное, чтобы убедить отца пересмотреть своё отношение к вашим соотечественникам.";
			link.l1 = "Спасибо, Кэтрин. Возможно, я воспользуюсь твоим любезным приглашением.";
			link.l1.go = "kathy_6";
		break;
		
		case "kathy_6":
			dialog.text = "Я буду надеяться на это, капитан. Ещё раз огромное вам спасибо за то, что вы для меня сделали. Я никогда не забуду этого.";
