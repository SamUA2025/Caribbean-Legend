...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "catoche_6":
			dialog.text = "Эх, и вот кто вас просил лезть не в своё дело... Принесла вас нелёгкая на мою голову...";
			link.l1 = "Капитан, я не понимаю ваших упрёков. Я сделал вашу работу, положил своих людей в бою, сам рисковал жизнью - а вы недовольны. Вам остаётся только доложить в Порт-Ройал об успехе миссии и всех дел. Я не буду претендовать на вашу славу, заверяю.";
		...
		case "isladevieques_2":
			dialog.text = "Отнюдь. Я действительно нашёл беднягу Арчибальда на этом самом острове. Вот только мемуаров никаких он не сочинял - дневник, который вы нашли в комнате Арчи в Порт-Ройале, куда пробрались столь изысканным способом, был написан им под мою диктовку, специально для вас, месье де Мор\nЯ давно за вами наблюдаю, с самого того дня, как мы встретились на мысе Каточе. Ведь это вы забрали с трупа дона Диего карту Двух Появлений? Не отпирайтесь: я знаю, что это вы.";
		...
		case "isladevieques_4":
			dialog.text = "Хо-хо! Ну, будем честны до конца... неужели вы думаете, сударь, что я такой же идиот, как вы и дон Диего, что таскаю столь ценные предметы с собой? Компас лежит на Ямайке, и даже не в Порт-Ройале, а в месте, где никому даже в голову не придёт его искать, и под надёжным замком. Но вам эта информация не пригодится.";
