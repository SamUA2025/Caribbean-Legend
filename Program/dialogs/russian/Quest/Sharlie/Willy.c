...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "isladevieques_4":
			dialog.text = "Хо-хо! Ну, будем честны до конца... неужели вы думаете, сударь, что я такой же идиот, как вы и дон Диего, что таскаю столь ценные предметы с собой? Компас лежит на Ямайке, и даже не в Порт-Рояле, а в месте, где никому даже в голову не придёт его искать, и под надёжным замком. Но вам эта информация не пригодится.";
