...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "guardoftruth_20":
			...
			link.l1 = "И как теперь называется 'Санта-Квитерия'?";
