...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "spa_prisoner_7":
			dialog.text = "Точных сведений у нас не было, но барон де-Мендоса-и-Риба утверждал, что в подземельях форта хранится серебро, а на портовых складах - стратегическое сырье: бакаут и корабельный шёлк.";
		...
		case "spa_prisoner_26":
			...
			link.l1 = "Хорошо. Вы собщили много интересного, "+npchar.name+", и я вас забираю отсюда. Вы мне ещё пригодитесь. А пока... дайте немного подумать и проанализировать ваши слова...";
		...
		case "spa_prisoner_51":
			...
			link.l1 = "Счастливого пути, сеньор "+npchar.name+". Может, ещё как-нибудь встратимся в более мирное время.";
		...
		case "gevarra_6":
			...
			link.l1 = "Наивные - это мало, так ещё и тупые! Я преложил купить у него ваниль по двести десять песо - он и двести-то не выручит в магазине - так представляете: он послал меня к чёрту! Сказал, что продаст по двести пятьдесят!";
