...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "spa_prisoner_1":
			dialog.text = "Да какая вам к чёрту разница, кого вам расстреливать или вешать? Я имел неосторожность угодить к вам в лапы, и...";
			link.l1 = "Сеньор, повторяю ещё раз: назовите ваше имя. Я не могу разговаривать с человеком, не зная, как его зовут.";
		...
		case "spa_prisoner_3":
			dialog.text = "Нет, каналья! Я не обязан знать весь...";
			link.l1 = "Довольно. Обойдёмся без оскорблений и постараемся вести себя, как культурные люди. От того, что именно вы сможете мне сообщить, будет зависеть ваша судьба. Если вы скажете хоть что-то меня интересующее - я походатайствую о вашей выдаче в моё распоряжение, и вы сможете избежать расстрела или виселицы, которая вас ждёт.";
		...
		case "spa_prisoner_7":
			dialog.text = "Точных сведений у нас не было, но барон де-Мендоса-и-Риба утверждал, что в подземельях форта хранится серебро, а на портовых складах - стратегическое сырьё: бакаут и корабельный шёлк.";
		...
		case "spa_prisoner_9":
			...
			link.l1 = "Я вам скажу следующее: в форте Сен-Пьера никогда не было серебра, а на складах - бакаута и шёлка. А вот теперь хорошо подумайте, офицер, перед тем как отвечать, ибо если ваш ответ мне не понравится, я развернусь и уйду, предоставив вас своей судьбе... весьма печальной судьбе.";
			link.l1.go = "spa_prisoner_10";			
		break;
		
		case "spa_prisoner_10":
			dialog.text = "Я вас внимательно слушаю.";
			link.l1 = "Я не верю, что единственной целью налёта был банальный грабёж. Сен-Пьер - далеко не такая богатая колония, чтобы присылать сюда эскадру во главе с линейным кораблём. Наверняка вы, или ваш командир, или кто-то ещё, имел дополнительные приказы или указания. Какие именно? Хорошенько подумайте, прежде чем отвечать...";
		...
		case "spa_prisoner_13":
			dialog.text = "У меня есть кое-что... Но вы должны поклясться мне, что заберёте меня отсюда и в дальнейшем передадите за выкуп Испании.";
		...
		case "spa_prisoner_17":
			...
			link.l1 = "Да. Я подтверждаю, что если вы продолжите ваш рассказ, вы будете доставлены как важный свидетель на моё судно, а в дальнейшем... в общем, я найду способ отправить вас в испанское поселение. Но не раньше, чем вы поведаете всё, что меня может заинтересовать.";
			link.l1.go = "spa_prisoner_18";			
		break;
		
		case "spa_prisoner_18":
			dialog.text = "Мигель Дичозо - бывший соратник барона, однако, как говорят, он предал его. Сеньор де-Мендоса-и-Риба хочет найти его, причём живым, ибо нам был отдан приказ ни в коем случае не убивать Дичозо.";
			link.l1 = "Дичозо - испанец?";
			link.l1.go = "spa_prisoner_19";			
		break;
		
		case "spa_prisoner_19":
			dialog.text = "Да. Дон Диего де Монтойя дал приблизительное описание и потребовал всех подпадающих под него лиц доставлять именно к нему. Но у нас не было времени разыскивать Мигеля, пока мы находились в городе.";
			link.l1 = "Вы знали Дичозо лично?";
			link.l1.go = "spa_prisoner_20";			
		break;
		
		case "spa_prisoner_20":
			dialog.text = "Нет. Но в моём отряде были люди, знавшие его в лицо. Все они мертвы.";
		...
		case "spa_prisoner_23":
			...
			link.l1 = "Хм. Занятно. Опять эти индейские сокровища. Что-то всё так подозрительно на них завязано... Значит, Дичозо так и не нашли?";
		...
		case "spa_prisoner_24":
			...
			link.l1 = "Скажите, "+npchar.name+", а откуда дон Мендоса узнал про этот... как его... Тайясаль? Он же не во сне его увидел, ведь так? Были какие-то факты, или что-то ещё?";
		...
		case "spa_prisoner_25":
			...
			link.l1 = "Интересно получается. Отец Винсенто сам выдвинул теорию существования Тайясаля, сам сообщил об этом в Мадрид, и сам же начал вставлять палки в колёса барону, сообщая о его неудачах...";
		...
		case "spa_prisoner_26":
			...
			link.l1 = "Хорошо. Вы сообщили много интересного, "+npchar.name+", и я вас забираю отсюда. Вы мне ещё пригодитесь. А пока... дайте немного подумать и проанализировать ваши слова...";
		...
		case "spa_prisoner_28":
			...
			dialog.text = "Что скажете? Вы выполните своё обещание?";
		...
		case "spa_prisoner_30":
			...
			link.l1 = "Бережёного Бог бережёт. Увидимся на корабле.";
		...
		case "spa_prisoner_32":
			...
			link.l1 = "Именно для того, чтобы высадить вас. Однако смысл моего прибытия сюда несколько глубже, чем вам кажется. Но вас это уже никоим образом не касается. Я отпущу вас прямо сейчас, без всякого выкупа, но при условии того, что вы поклянётесь мне в двух вещах.";
			link.l1.go = "spa_prisoner_33";			
		break;
		
		case "spa_prisoner_33":
			dialog.text = "О чём пойдёт речь?";
		...
		case "spa_prisoner_39":
			...
			link.l1 = "Приветствую, сеньор "+npchar.name+". Я думал, что мы больше никогда не увидимся, а тут - на тебе! Нет, просто зашёл в гости к отцу Винсенто. Ну а вы как? Служите теперь в Сантьяго?";
		...
		case "spa_prisoner_41":
			...
			link.l1 = "Не буду возражать, я не против немножко промочить ромом горло. Пойдёмте в таверну.";
		...
		case "spa_prisoner_44":
			...
			link.l1 = "И давайте ещё за то, чтобы наши власти когда-нибудь договорились друг с другом, и французы с испанцами прекратили вражду на архипелаге.";
		...
		case "spa_prisoner_46":
			...
			link.l1 = "Согласен. Расскажите, не сильно вы поплатились на службе за своё пленение в Сен-Пьере?";
		...
		case "spa_prisoner_47":
			...
			link.l1 = "А где сейчас ваш командир, как его... Диего, да? Как на нём отразился неудачный поход? Разжаловали?";
		...
		case "spa_prisoner_49":
			dialog.text = "Дону Диего сейчас не до вас, капитан. У него дела поважнее, чем рисковать жизнью на дуэли. Он вместе с бароном затеял что-то на Западном Мэйне. В Гаване он собрал эскадру и намерен со дня на день отплыть на материк.";
			link.l1 = "Вы тоже в его команде?";
			link.l1.go = "spa_prisoner_50";
		break;
		
		case "spa_prisoner_50":
			dialog.text = "Нет. Завтра я отбываю в гарнизон Сан-Хуан, что на Пуэрто-Рико. На Провиденсии у дона Мендосы я более не в почёте.";
		...
		case "spa_prisoner_51":
			...
			link.l1 = "Счастливого пути, сеньор "+npchar.name+". Может, ещё как-нибудь встретимся в более мирное время.";
		...
		case "spa_prisoner_53":
			...
			dialog.text = "Как я вам и говорил, дон Диего: рыбка заглотила наживку целиком... вот и ещё раз встретились, месье. Правда, не в мирной обстановке, как вы хотели.";
		...
		case "spa_prisoner_54":
			dialog.text = "Отчего же ошибались? Я своё слово сдержал, а вот в вечной дружбе вам не клялся. Ничего не изменилось, месье - вы по-прежнему враг Испании и мой личный враг. Здесь не Сантьяго, и тут нет отца Винсенто, и его бумага вам не поможет...";
			link.l1 = "Вот как? И всё же мне кажется, что пить ром за одним столом, вести дружескую беседу и при этом преследовать цель заманить в западню - это довольно подло, вы так не считаете, сеньор "+npchar.name+"?";
		...
		case "vinsentoagent_2":
			...
			dialog.text = "Держи. Как насчёт нескольких монет за труды?";
		...
		case "vinsentoagent_2_1":
			...
			link.l1 = "Всё, давай проваливай, и не трепи языком о том, что здесь произошло.";
			link.l1.go = "vinsentoagent_3";			
		break;
		
		case "vinsentoagent_2_2":
			dialog.text = "Гаванский волк тебе дружище...";
			link.l1 = "Чего? Шёл бы ты отсюда...";
			link.l1.go = "vinsentoagent_3";			
		break;
		...
		case "boatsvandega_1":
			dialog.text = "Да кто же во французских колониях не слышал про капитана по имени "+GetFullName(pchar)+", разгромившего наголову испанскую эскадру во главе с линейным кораблём, напавшую на Сен-Пьер, и перебившего весь вражеский десант! Вы, можно сказать, национальный герой!";
		...
		case "boatsvandega_3":
			dialog.text = "А я похож на капитана? Хо-хо! Нет, я всего лишь боцман, Серж Дега. Наш капитан - Гай Марше, целыми днями сидит в таверне, а мы уже которую неделю стоим на рейде, ожидая караван каких-то 'купцов'. Кэп задолжал жалование матросам, да и нам тоже, и вся команда совсем не в духе... Будь она неладна его чёртова ваниль!";
		...
		case "boatsvandega_4":
			dialog.text = "Какое там - 'пощипать'! Кэп завязал с каперством, как только захватил у испанцев вот этот самый галеон. А случилось вот что: он услышал, что на Гваделупу скоро прибудет купеческий караван, следующий в Европу, для закупки пряностей. Вот он и забил трюмы в Бриджтауне доверху этой ванилью! Решил, что продаст по триста песо за ящик, ага, держи карман шире!\nНикакого каравана, конечно, нет, ваниль же в местном магазине продавать невыгодно. Вот мы и ждём этих 'купцов', которых, наверняка, не будет ещё года три... Целыми днями кэп сидит в таверне и расспрашивает всех приезжих, только ночевать на корабль приходит. Уже готов и по двести песо продать, лишь бы своё вернуть\nДенег нет - всё в товар вложил. Дождётся, что его и нас всех матросы скрутят и спустят ваниль за долги по бросовой цене... Клянусь громом, всё к этому и идёт.";
			link.l1 = "Да уж... и чего же ваш капитан так промахнулся?";
			link.l1.go = "boatsvandega_5";
		break;
		
		case "boatsvandega_5":
			dialog.text = "Да потому что не умеешь - не берись. Торгаш из Гая никудышный. Ладно бы ещё фрахты возил, так нет же - захотелось себя негоциантом почувствовать, якорь ему в корму...";
			link.l1 = "Всё ясно, Серж. Ладно, глядишь - ещё и появится ваш... караван.";
			link.l1.go = "boatsvandega_6";
		break;
		
		case "boatsvandega_6":
			dialog.text = "Ох, не верю я в чудеса, капитан. Уже уходите? Возможно, как-нибудь ещё встретимся, попьём рому... эх, так в горле пересохло!";
		...
		case "marshe_lay":
			...
			dialog.text = "А-аргх... М-м... Чёрт возьми, что такое?..";
		...
		case "marshe_sitground":
			...
			link.l1 = "Будешь орать - быстро угомоню кастетом по голове, усёк? Где церковная утварь, которую ты прихватил, когда абордировал этот корабль?";
			link.l1.go = "marshe_sitground_1";
		break;
		
		case "marshe_sitground_1":
			dialog.text = "Какую утварь? Я не понимаю! Это мой корабль!";
			link.l1 = "Как же, твой... Ещё не так давно он был 'Санта Маргаритой' и ходил под испанским флагом... Где церковные драгоценности, я тебя спрашиваю? Золотой остензорий, крест с лазуритом и золотое кадило? Куда ты их дел? Продал уже, небось?";
			link.l1.go = "marshe_sitground_2";
		break;
		
		case "marshe_sitground_2":
			dialog.text = "Ушам не верю... ты что же - испанец? О нет... ты не испанец! Но это ещё хуже! Ты продался гнусным кастильцам! Почём нынче они покупают души французов? Я ничего тебе не скажу, не получишь ты этих церковных вещичек!";
			link.l1 = "Не скажешь? Да и чёрт с тобой, тут не лучшее место для допроса... Сейчас мы заткнём тебе рот кляпом, чтобы не визжал, и пойдём ко мне в шлюпку... ты всё равно заговоришь, дружок. Ой как заговоришь!";
			link.l1.go = "marshe_sitground_3";
		break;
		
		case "marshe_sitground_3":
			dialog.text = "Испанский приспешник! Будь ты...";
			link.l1 = "Умолкни, пёс... Вот так. И топай за мной сам, иначе оглушу и поволоку через всю палубу за ноги.";
		...
		case "gevarra_1":
			dialog.text = "А в чём проблема, сударь? Да, я испанец, это легко догадаться по типу моего корабля и по названию, но я нахожусь здесь на законных основаниях, у меня есть лицензия Голландской Вест-Индской Компании, так что...";
		...
		case "gevarra_2":
			dialog.text = "Я привёз из Гаваны товар и продал его в местном магазине. Сейчас жду выгодного фрахта, чтобы не идти порожняком домой.";
			link.l1 = "Каррамба! Сеньор, у меня к вам деловое предложение. Вы можете очень неплохо заработать, если поможете мне. Обсудим? Кстати, как ваше имя?";
			link.l1.go = "gevarra_3";			
		break;
		
		case "gevarra_3":
			dialog.text = "Карлос. Капитан Карлос Геварра. Какое предложение?";
			link.l1 = "Мне нужно закупить большую партию ванили и отправить её на Кубу, человеку по имени "+pchar.questTemp.Guardoftruth.LMname+", это смотритель маяка Сантьяго. Однако у меня с этим возникли серьёзные трудности. Во-первых, столько ванили, сколько мне нужно, в магазине Бас-Тера нет...";
			link.l1.go = "gevarra_4";			
		break;
		
		case "gevarra_4":
			dialog.text = "";
			link.l1 = "Во-вторых, мне нужно немедленно отправляться на Сент-Кристофер, и неизвестно, сколько я там пробуду. У меня срывается заработок, понимаете? Обидно, чёрт возьми...";
		...
		case "gevarra_6":
			...
			link.l1 = "Наивные - это мало, так ещё и тупые! Я предложил купить у него ваниль по двести десять песо - он и двести-то не выручит в магазине - так представляете: он послал меня к чёрту! Сказал, что продаст по двести пятьдесят!";
			link.l1.go = "gevarra_7";			
		break;
		
		case "gevarra_7":
			dialog.text = "Ха-ха-ха! Нет границ у человеческой глупости...";
			link.l1 = "Вот-вот! Я примерно это ему и сказал. Он, конечно, разозлился... но мне очень нужна эта ваниль! Сеньор, я всё-таки не торговец, а вы, как я вижу, на этом деле собаку съели, да и каракка у вас вместительная...";
			link.l1.go = "gevarra_8";			
		break;
		
		case "gevarra_8":
			dialog.text = "";
			link.l1 = "Уговорите этого чёртового дурака продать груз вам - мне он его уже точно не продаст. Я готов заплатить по двести десять песо за ящик. Если вы собьёте цену ниже - оставьте разницу себе. А я за это зафрахтую ваше судно до Сантьяго - вы отвезёте ваниль туда и передадите смотрителю...";
		...
		case "gevarra_11":
			dialog.text = "Хорошо, мне ведь всё-таки по пути... Двадцать пять тысяч и ни монетой меньше.";
			link.l1 = "Я согласен. Капитана галеона зовут Гай Марше, он постоянно днём сидит в таверне. Надеюсь, вам удастся уговорить его.";
		...
		case "gevarra_14":
			...
			{
				dialog.text = "Прекрасно. Люблю вести дела с толковыми партнёрами. Приходите "+sTemp+" часикам к десяти утра - думаю, к этому моменту ваш клиент уже 'созреет'.";
			...
			{
				dialog.text = "Прекрасно. Люблю вести дела с толковыми партнёрами. Я отправляюсь на берег. Приходите часа через три - думаю, к этому моменту ваш клиент уже 'созреет'.";
				link.l1 = "Отлично! До встречи!";
				link.l1.go = "gevarra_15";
				pchar.quest.GuardOT_tradetimer.win_condition.l1 = "Timer";
		...
		case "gevarra_time":
			dialog.text = "Сеньор, я всё помню. Не переживайте, заключим мы вашу сделку с этим горе-торговцем.";
			link.l1 = "Хорошо...";
			link.l1.go = "exit";
		...
		case "gevarra_16":
			...
			link.l1 = "Да. Вот это письмо. Говорите, сделка будет у пляжа Капстер завтра в полдень? Хорошо, я на всякий случай буду неподалёку, у мыса Недоступный на островке...";
		...
		// матросы Марше
		case "marshe_sailor":
			dialog.text = LinkRandPhrase("И-ик! К-капит-тан након-нец выд-дал жалование! Иех!","Я е-ещё только н-начал... ик!","Морда об стол... тело под забор... йо-хо-хо, и бутылка рома-а!");
			link.l1 = LinkRandPhrase("Да уж... Ну-ну.","Ясно... Пора завязывать с этим ромом, не считаешь?","Тяжёлый случай...");
			link.l1.go = "exit";
		break;
		...
		case "dominica_hunter":
			dialog.text = "Хо-хо! Ты тоже за кладом Ролли Колпака явился? А то мы тут неделю ищем, ищем, никак не найдём. И хоть бы один из этих дураков догадался заплыть в скалы за водопад!";
			link.l1 = "Ты из людей полковника Фокса, так?";
			link.l1.go = "dominica_hunter_1";
		break;
		
		case "dominica_hunter_1":
			dialog.text = "Скажем, я имею отношение к 'морским лисам'. Но тебе это знать необязательно, а точнее - ни к чему. Тебе уже вообще никакие знания ни к чему. Ты нашёл для меня клад, за что тебе мы сейчас скажем огромное спасибо...";
			link.l1 = "Да ты не морской лис, а скорее - морской пёс... или шакал. Что тебе ближе?";
			link.l1.go = "dominica_hunter_2";
		break;
		
		case "dominica_hunter_2":
			dialog.text = "Ты, я погляжу, ещё и остряк... молодец!";
		...
		case "belinda":
			...
			link.l1 = "Здравствуйте. Ведь это вы - донна Белинда де Риберо?";
		...
		case "belinda_2":
			...
			link.l1 = "У вас есть вещь, которая очень интересует Его Преосвященство. Это золотой остензорий, церковный потир, приобретённый вами недавно в лавке ростовщика в Виллемстаде.";
		...
		case "belinda_5":
			dialog.text = "Ах что вы, сударь... Давайте вернёмся к нашему разговору. Как я понимаю, этот остензорий нужен отцу Винсенто? Вы хотите, чтобы я вам его отдала?";
		...
		case "belinda_6":
			dialog.text = "Ах, оставьте... Неужели вы думаете, что мне так дороги эти деньги? Я выкупила его, чтобы отдать Святой Церкви, и без колебаний передам этот потир её представителю, тем более, члену Ордена Иисуса, служащему отца Винсенто. Но... быть может, вы не оставите меня в беде?";
		...
		case "belinda_8":
			dialog.text = "Вы можете пообещать мне, как представитель Святой Церкви, что никто и никогда не узнает того, о чём я вас попрошу?";
			link.l1 = "Даю слово, сеньора.";
			link.l1.go = "belinda_9";
		break;
		
		case "belinda_9":
			dialog.text = "Хорошо. Я верю вам. Мой очень близкий знакомый, Эстебан Соса, попал в беду - его похитили бандиты и требуют выкуп в сто тысяч песо. У меня нет таких денег, мне удалось собрать всего лишь половину, а просить помощи мне не у кого\nКроме того, я очень переживаю за... друга, и опасаюсь худшего - бандиты, получив выкуп, всё равно могут расправиться с пленником, дабы он не выдал их коменданту. Если бы вы, отважный капитан, брат Ордена Иисуса, смогли бы как-то уговорить бандитов отдать Эстебана за имеющуюся сумму и проследить, чтобы он остался жив...";
			link.l1 = "Когда и где должен состояться обмен?";
			link.l1.go = "belinda_10";
		break;
		
		case "belinda_10":
			dialog.text = "Их главарь по кличке Барти Живодёр сказал, что они будут ждать выкупа за Эстебана каждую ночь с одиннадцати вечера до полуночи у входа в пещеру в джунглях...";
		...
		case "belinda_12":
			dialog.text = "Я не смела на это надеяться... Но, капитан, Барти Живодёр также сказал, что если посланник придёт не один, или я обращусь к коменданту - то они немедленно убьют пленника...";
			link.l1 = "Я учту это.";
		...
		case "belinda_13":
			...
			link.l1 = "Я сделаю всё возможное, сударыня. Будем надеяться на лучшее.";
		...
		case "belinda_19_1":
			...
			link.l1 = "Я встретился с негодяями в пещере. Барти Живодёр и Эстебан Соса - одно и то же лицо. Он инсценировал похищение, чтобы вытянуть из вас деньги. Он рассказал о вашей... связи. Сказал также и то, что более не желает вас видеть. Поэтому и пошёл на эту гнусность. Я забрал у него этот перстень в качестве доказательства.";
			link.l1.go = "belinda_20";
		break;
		
		case "belinda_19_2":
			dialog.text = "Это... да, знаком. Что с Эстебаном?";
			link.l1 = "Я встретился с негодяями в пещере, где они набросились, скрутили меня и забрали ваши деньги. Барти Живодёр и Эстебан Соса - одно и то же лицо. Он сам инсценировал похищение. Он рассказал о вашей... связи. Эстебан отпустил меня и отдал этот перстень как доказательство. Он сказал, что больше не желает вас видеть и знать.";
			link.l1.go = "belinda_20";
		...
		case "belinda_20":
			...
			dialog.text = "Боже мой, Боже мой! Я не верю своим ушам! За что мне всё это, за что? Что я ему сделала, что он так...";
		...
		case "belinda_21":
			...
			link.l1 = "Спасибо, сеньора. Не беспокойтесь: обо всём, что произошло в пещере, никто не узнает. Братья Ордена Иисуса всегда держат своё слово. А теперь разрешите откланяться.";
		...
		case "barty":
			...
			link.l1 = "Это ты - Барти Живодёр? Совсем не похож на матёрого бандита...";
			link.l1.go = "barty_1";
		break;
		...
		case "barty_3":
			dialog.text = "Ах, ты ещё ерепенишься? Ну ладно, сейчас мы тебя хорошенько проучим... ребята, зададим жару этому умнику!";
			link.l1 = "Вот мразь!..";
			link.l1.go = "barty_4";
		break;
		...
		case "barty_7":
			dialog.text = "Да-да, я никакой не Барти Живодёр. Я просто...";
			link.l1 = "Ах ты засранец! Значит, ты просто решил вытрясти из Белинды сто тысяч, 'похитив' самого себя?";
			link.l1.go = "barty_8";
		break;
		
		case "barty_8":
			dialog.text = "Пойми меня как мужчина мужчину. Белинда... она действительно мне осточертела со своей любовью, да и её муж начал догадываться...";
			link.l1 = "Вот так номер! Вы любовники?";
			link.l1.go = "barty_9";
		break;
		
		case "barty_9":
			dialog.text = "Уже нет. Я просто сбежал от неё.";
			link.l1 = "И решил заодно прихватить денежек на дорогу, так? Всё ясно. Ну и что же мне с тобой сделать? Утопить в этом болоте за то, что пытался убить меня?";
			link.l1.go = "barty_10";
		break;
		...
		case "barty_11":
			dialog.text = "Мы бы просто выпотрошили твои карманы, и всё!";
			link.l1 = "Дружок, уже за одно это я должен вздёрнуть тебя на ноке рея своего корабля. Но из уважения к порядочной женщине, которая имела несчастье связаться с тобой, я этого не сделаю. Я доставлю тебя к ней, и пусть она разбирается, что с тобой делать...";
			link.l1.go = "barty_12";
		break;
		...
		case "barty_13":
			dialog.text = "Пощадите, сеньор! Отпустите меня, я просто уплыву отсюда и никогда более не появлюсь в Кумане! Я не собираюсь дожидаться, пока муж Белинды прикончит меня на дуэли или подошлёт наёмного убийцу...";
			link.l1 = "Ладно. Ради блага самой же сеньоры Белинды я не поведу тебя к ней. Но даже не думай, что я оставлю всё в тайне - она узнает, с какой мразью ей пришлось столкнуться в этой жизни. Что у тебя есть из вещей, которые она сможет опознать?";
			link.l1.go = "barty_14";
		break;
		...
		case "barty_14":
			...
			link.l2 = "Превосходно. И знаешь, Соса, я передумал - я же теперь служу Ордену Иисуса. А ты - нарцисс, преступник и бесполезный кусок дерьма. Лучше я утоплю тебя в этой пещере. Сие будет богоугодным делом.";
		...
		case "spa_hunter_2":
			...
			link.l1 = "Такого же, как и твои, глупец... И сейчас ты в этом убедишься.";
		...
		case "cabin_hunter":
			...
			link.l1 = "Да что же это за наказание такое! Даже сюда забрались... Кто вас нанял, чёрт побери?!";
			link.l1.go = "cabin_hunter_1";
		break;
		
		case "cabin_hunter_1":
			dialog.text = "Не твоё дело. Будешь рыпаться - заберём вещички с твоего трупа. Как тебе такая перспектива?";
		...
		case "batabano_officer":
			...
			link.l1 = "Выдвигайтесь через джунгли в сторону мыса Сан-Антонио. По тропе налево, потом всё время прямо. Затаитесь в засаде у самой бухты и будьте наготове. Я отправляюсь туда морем. Сколько времени потребуется на переход?";
		...
		// наёмник Патерсона
		case "housemercen":
			dialog.text = "Вот живучий ублюдок! Не сдох ещё... надо было побольше пороху положить. Ладно, сейчас я тебе помогу, недобитыш...";
			link.l1 = "...";
