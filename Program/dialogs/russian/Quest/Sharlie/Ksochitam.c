...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "guardmask_14":
			dialog.text = "Это старый город индейцев майя. Он сохранил своё обличие с тех времён, когда там ещё проживал этот народ. Величественные храмы, высокие пирамиды... Теперь его населяют ица, считающие себя прямыми потомками майя. Они стараются во всём следовать им - в религии, культуре и быту.";
