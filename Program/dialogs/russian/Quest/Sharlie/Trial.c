...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "florian_13":
			...
			link.l1 = "Да. Он уже давно готов к выходу в море, но губернатор Порто Белло намеренно держит его в доках. Сейчас он ждёт прибытия из Картахены барка 'Пуэбла' с грузом пороха для 'Алькантары'. Судя по словам матроса с галеона, у них нехватка пороха.";
		...
		case "florian_guide_01":
			...
			link.l1 = "Нет, я не это имел в виду. Ладно, забудьте: уверен, что проблем с перехватом какого-то барка у меня не возникнет.";
			link.l1.go = "florian_19";
