...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "guide_13":
			dialog.text = "А-а, я вас понял. Мы с вами как раз пришли к резиденции Его Светлости, и вы решили зайти на приём? Ну что же, не смею отвлекать вас от столь важного дела. Нашего губернатора зовут Жак Дьель дю Парке, и уверен, что он примет вас без отлагательств.";
		...
		case "guide_30":
			dialog.text = "Знаете что, друг мой? Держите эту небольшую памятку по управлению кораблём. Прочтите её, когда обзаведётесь своим. Полезный документ - в своё время мне очень помог.";
			link.l1 = "Хорошо, месье. И правда, сейчас я не очень готов впитывать столь сложные знания.";
			link.l1.go = "guide_38";
		...
		case "guide_44":
			dialog.text = "Итак, перед нами городские ворота, ведущие прямиком в джунгли... Вы будете смеяться, но у меня для вас ещё одна памятка. В этот раз - о нюансах наших сухопутных дел. Почитайте на досуге, чтобы лучше понять как проникать во враждебные города и как вести бой на суше. А сейчас я предлагаю выйти за ворота и немного поразвлечься - потренируемся в фехтовании.";
			link.l1 = "Вы - настоящая энциклопедия, месье. Пойдёмте! Тренировка будет как нельзя кстати.";
			link.l1.go = "guide_48";
