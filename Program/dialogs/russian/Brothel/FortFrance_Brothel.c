...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
	...
	switch (Dialog.CurrentNode)
	{
		...
		case "Gigolo_3":
			...
			link.l1 = "Не переживай. Я беру эту девушку для любви, а не для чего-то ещё. В одиннадцать вечера я её заберу. Вот только что мне делать до этого времени?..";
			link.l1.go = "Gigolo_4a";
		break;
		
		case "Gigolo_4a":
			dialog.text = "Ну даже не знаю, дорогой. В таверну там загляни, с барменом поговори...";
			link.l1 = "А это, кстати, мысль, так и сделаю. Всего доброго!";
			link.l1.go = "Gigolo_4";
		break;
