	...
	switch(Dialog.CurrentNode)
	{
		...
		case "First time":
            ...
            if (npchar.quest.BadMeeting != lastspeak_date)
			{
				...
				{
					dialog.text = "Приветствую тебя, Элен, дочь моя.";
					link.l1 = "И я вас, святой отец.";
				}
				link.l1.go = "node_3";
		...
		case "node_3":
			if(startHeroType == 4 && NPChar.location == "SantaCatalina_church")
			{
				dialog.text = "Я рад, что несмотря на ваши с Яном... занятия, вы не забываете о Господе нашем и доме Его. Чем я могу тебе помочь?";
			}
			else
			{
		...
		case "AffairOfHonor_GodJudgement_1":
			dialog.text = "Не беспокойся, "+GetSexPhrase("сын мой","дочь моя")+". Господь увидит твои страдания и поможет тебе. Всегда носи с собой крест для укрепления веры.";
...
// Jason-------------------------------------------------Сага----------------------------------------------
		...
		case "saga_1" :
			...
			dialog.text = "Благодарю, "+GetSexPhrase("сын мой","дочь моя")+". Как зовут сеньору, о душе которой я должен молиться?";
			Link.l1 = "Её зовут Чика Гонзалес. Она уроженка вашего города и отошла в мир иной много лет тому назад.";
			Link.l1.go = "saga_2";
		break;
		...
		case "saga_5" :
			dialog.text = "И больше ни за чью душу не хотите заказать молебен?";
			Link.l1 = "Ммм... Да вроде нет. А нужно ещё за кого-то?";
			Link.l1.go = "saga_6";
		break;
		
		case "saga_6" :
			dialog.text = "Ну, возможно, за сотни тех невинных людей, что пали от вашей руки или от клинков ваших безбожников, когда вы грабили этот несчастный город?.. Впрочем, вряд ли скромный священник может надеяться достучаться до совести человека, который без сожаления убивал простых мирных жителей...";
			Link.l1 = "Святой отец, вы не понимаете... Это всё в прошлом. Здесь и сейчас я не собираюсь никому причинять зла.";
			Link.l1.go = "saga_7";
		break;
		
		case "saga_7" :
			pchar.questTemp.saga7 = true;
			dialog.text = "Разве я могу верить вашему слову?.. Но, в любом случае, это святая земля, которую не должна покрывать кровь. Поэтому я не позову стражу. Идите с миром. Может быть до того, как вы предстанете перед высшим судом, вы успеете искупить хотя бы часть ваших грехов.";
			Link.l1 = "Может быть. На всё воля Господа.";
			Link.l1.go = "saga_4";
		break;
		...
		case "treatment_1":
			dialog.text = "Кто наложил на тебя эти заклятия, "+GetSexPhrase("сын мой","дочь моя")+"? Отвечай мне честно.";
		...
		case "treatment_4":
			dialog.text = "Молитвой, "+GetSexPhrase("сын мой","дочь моя")+". Святой очищающей молитвой в нашем храме. Ты должен будешь молиться очень долго, причём не только за себя. Ты должен будешь также молиться и за неё.";
			link.l1 = "За Джессику?";
		...
		case "treatment_6":
			dialog.text = "Всё в руках Господа, "+GetSexPhrase("сын мой","дочь моя")+". Я научу тебя молитвам и оставлю Священное Писание. Сила святой молитвы разрушит нечестивые заклятия, поразившие тебя и... очистит душу несчастной Джессики.";
		...
		case "treatment_7":
			dialog.text = "Хорошо, "+GetSexPhrase("сын мой","дочь моя")+". Я буду ждать тебя. Не теряй времени!";
		...
		case "candle":
			dialog.text = "Ты принес двадцать свечей, "+GetSexPhrase("сын мой","дочь моя")+"?";
			if (GetCharacterItem(pchar, "mineral3") >= 20)
			{
		...
		case "treatment_9":
			dialog.text = "Очень хорошо, "+GetSexPhrase("сын мой","дочь моя")+". Давай мне их и приходи завтра после деcяти вечера. Я научу тебя нужным молитвам и оставлю тебя в церкви на ночь.";
		...
		case "seektreatment":
			dialog.text = "Какие языческие заклятия поразили тебя, "+GetSexPhrase("сын мой","дочь моя")+"?";
		...
		case "seektreatment_1":
			...
			{
				dialog.text = "Я слышал о таких... Их принесли в наш мир нечестивые колдуны краснокожих безбожников. К сожалению, я могу лишь посоветовать тебе больше времени проводить в молитвах, "+GetSexPhrase("сын мой","дочь моя")+", и уповать на милость Господа нашего.";
		...
		case "seektreatment_2":
			dialog.text = "Не отчаивайся, "+GetSexPhrase("сын мой","дочь моя")+". Господь услышит тебя и ниспошлет помощь. Но также я тебе посоветую поспрашивать в других святых обителях - возможно, кто-то из священников больше знает о том, как снять языческие чары...";
		...
		case "seektreatment_3":
			dialog.text = "Ступай, "+GetSexPhrase("сын мой","дочь моя")+", и да хранит тебя Господь.";
		...
		case "seektreatment_4":
			dialog.text = "Помочь тебе может только Господь и ты сам, "+GetSexPhrase("сын мой","дочь моя")+". Святой отец лишь научит тебя, что и как ты должен делать. Ступай к нему.";
		...
		case "findtreatment":
			dialog.text = "Какие языческие заклятия поразили тебя, "+GetSexPhrase("сын мой","дочь моя")+"? Позволь предположить: ты не можешь бегать, сабля для тебя слишком тяжела, а движения твои - вялы?";
			link.l1 = "Как вы догадались, святой отец?!";
			link.l1.go = "findtreatment_1";
		break;
		
		case "findtreatment_1":
			dialog.text = "Глядя на то, какой поступью ты подошёл ко мне, "+GetSexPhrase("сын мой","дочь моя")+", понять было нетрудно. Господи, помилуй нас, грешных... Отвечай мне честно, "+GetSexPhrase("сын мой","дочь моя")+": кто наложил на тебя эти заклятия?";
		...
		case "findtreatment_2":
			...
			link.l1 = "Её звали... Джессика Роуз.";
		...
		case "GenQuest_Church_2_Start_5_1": //выше - выход из диалога без подтверждения - странно, однако
			dialog.text = "Я буду молиться за тебя, "+GetSexPhrase("сын мой","дочь моя")+"! Иди и воздай этим мошенникам по заслугам!";
		...
		case "GenQuest_Church_2_Thief_4_1_1":
			...
			link.l1 = LinkRandPhrase("Святой Отец", "Падре", "Отче") + ", успокойтесь. Главное, что они никому ничего не рассказали... и не расскажут. Кстати, они добровольно отдали мне чашу для причастия, которую я вам и привёз"+ GetSexPhrase("","ла") +".";
        ...
        case "work":
			...
			{
	            link.l10 = "Падре, я прив"+GetSexPhrase("ёз","езла")+" для вас бумаги от монаха из города "+XI_ConvertString("Colony"+pchar.GenQuest.Monkletter.StartCity)+".";
			...
			{
	            link.l11 = "Падре, я прибыл"+GetSexPhrase("","а")+" из колонии "+XI_ConvertString("Colony"+pchar.GenQuest.Churchbooks.StartCity)+". Местной церкви нужны молитвенники, и тамошний монах попросил меня обратиться за этим к вам.";
		...
		case "GenQuest_Church_1_Dialog_1":
			if(CheckAttribute(PChar, "GenQuest.ChurchQuest_1.2A_Scene"))	// Сцена 2а
			{
				...
				link.l1 = "Однако, " + LinkRandPhrase("падре", "святой отец", "отец мой") + ", души прихожан святого отца по имени " + PChar.GenQuest.ChurchQuest_1.PriestName + " столь же нуждаются в спасении, а без этих трудов он лишён поддержки столпов теософии и вдохновения в своих проповедях."; // belamour gen
		...
		case "GenQuest_Church_1_Dialog_1_2":	// Сцена 2б-а и 2б-б
			...
			{
				dialog.text = "Ах, "+ GetSexPhrase("сын мой","дочь моя") +"! Вы опоздали буквально на несколько часов! Я уже отправил книги Отца по имени " + PChar.GenQuest.ChurchQuest_1.PriestName + " с капитаном, которого зовут " + PChar.GenQuest.ChurchQuest_1.CapFullName + ". Утром этот богобоязненный человек пришёл на исповедь и обмолвился, что сегодня его судно отправляется в " + XI_ConvertString("Colony" + PChar.GenQuest.ChurchQuest_1.CapColony) + ". И хотя господин капитан не ручался за сроки, однако согласился помочь, уверив меня, что в порт " + XI_ConvertString("Colony" + PChar.GenQuest.ChurchQuest_1.QuestTown + "Gen") + " он непременно зайдёт."; // belamour gen
		...
		case "Monkletter":
			...
			{
				dialog.text = "Я уже потерял надежду когда-либо увидеть эти бумаги. Почему твой путь был столь долгим, "+ GetSexPhrase("сын мой","дочь моя") +"?";
				link.l1 = "Меня задержали непредвиденные обстоятельства, святой отец.";
				link.l1.go = "Monkletter_1";
			}
			else
			{
				dialog.text = "Я ждал эти бумаги, "+ GetSexPhrase("сын мой","дочь моя") +". Благодарю тебя за оперативную доставку. Прими от меня в награду эти несколько золотых и моё благословение.";
				link.l1 = "Спасибо, святой отец. Был"+GetSexPhrase("","а")+" рад"+GetSexPhrase("","а")+" помочь святой церкви!";
				link.l1.go = "Monkletter_3";
			}
		break;
		
		case "Monkletter_1":
			dialog.text = "Все мы под Богом ходим, "+ GetSexPhrase("сын мой","дочь моя") +"... Человек предполагает, а Господь располагает. Давай мне эти бумаги и ступай с миром.";
		...
		case "Monkletter_3":
			dialog.text = "Ступай с Богом, "+ GetSexPhrase("сын мой","дочь моя") +". Да хранит тебя Всевышний на твоём пути!";
			link.l1 = "До свидания, святой отец.";
		...
		case "Churchbooks":
			dialog.text = "Тебя послали взять у нас молитвенники для церкви "+XI_ConvertString("Colony"+pchar.GenQuest.Churchbooks.StartCity+"Gen")+"? Хорошо. У меня есть упаковка с тремя десятками молитвенников. Возьми её, "+ GetSexPhrase("сын мой","дочь моя") +".";
			link.l1 = "Благодарю, падре. До свидания!";
			link.l1.go = "Churchbooks_1";
		break;
		
		case "Churchbooks_1":
			dialog.text = "Да охранит тебя Господь на твоём пути! Ступай с миром...";
			link.l1 = "...";
			link.l1.go = "exit";
		...
		case "Churchbooks_2":
			...
			{
				dialog.text = "Благодарю тебя за твою помощь, "+ GetSexPhrase("сын мой","дочь моя") +", хотя бы и прибывшую с опозданием.";
				link.l1 = "Меня задержали непредвиденные обстоятельства в пути, святой отец.";
				link.l1.go = "Churchbooks_3";
			}
			else
			{
				dialog.text = "Благодарю тебя за помощь, "+ GetSexPhrase("сын мой","дочь моя") +". Ты привёз эти книги очень вовремя. Возьми в награду этот освященный оберег - он поможет тебе в час опасности.";
				link.l1 = "Спасибо, святой отец. Был"+GetSexPhrase("","а")+" рад"+GetSexPhrase("","а")+" помочь святой церкви!";
		...
		case "Churchbooks_3":
			dialog.text = "На всё воля Господня, "+ GetSexPhrase("сын мой","дочь моя") +"... Ступай с миром.";
			link.l1 = "До свидания, падре.";
			link.l1.go = "exit";
		...
		case "Churchbooks_4":
			dialog.text = "Ступай с Богом, "+ GetSexPhrase("сын мой","дочь моя") +". Да охранит тебя Господь от всех бед на твоём пути!";
			link.l1 = "До свидания, святой отец.";
...
void Church_GenQuest1_InitStartParam(ref chr)
{
	...
	switch(iRand)
	{
		...
		case "1":
			...
			Log_TestInfo("Церковный генератор 1: ключевая сцена - 2Б-А (поиск кэпа. О нём есть полная инфа).");
		break;
