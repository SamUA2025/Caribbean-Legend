...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		...
		case "G_Girl":
			...
			link.l1 = "Бригантины, Ваша Светлость. Перевозившей кап... почту. Важные документы. Я слышал, ведётся расследование, и, как верный друг английской короны, не могу не поделиться важными сведениями.";
			link.l1.go = "G_Girl_1";
		break;
		
		case "G_Girl_1":
			dialog.text = "Замечательно! Баронет Кортни будет вам очень рад! Я немедленно организую встречу.";
			link.l1 = "Спасибо, сэр. Я немного спешу, так что буду благодарен, если всё пройдёт быстро.";
			link.l1.go = "G_Girl_2";
		break;
