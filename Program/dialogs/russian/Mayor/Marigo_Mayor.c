...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		...
		case "FMQN_7":
			DelLandQuestMark(npchar);
			dialog.text = "Мы ждали вас, минхер "+GetFullName(pchar)+". Выражаю вам личную благодарность и благодарность жителей колонии за проявленную вами инициативу в ликвидации опасной шайки английских диверсантов. Вам полагается обещанное вознаграждение в 10 000 песо. Помимо этого: В трюм вашего корабля будут загружены 200 корабельного шёлка, а также большая премия - лицензия Голландской Вест-Индской торговой Компании сроком на три года. Это очень ценный документ, надеюсь, вы в курсе?";
			link.l1 = "Конечно! Лицензия на три года - это действительно дорого стоит.";
			link.l1.go = "FMQN_8";
		break;
		...
		case "tomas_1":
			...
			link.l1 = "Именно. Этот остров принадлежит Франции, а вы здесь - всего лишь арендаторы. Наглые арендаторы, вообразившие себе, что можете присвоить остров в собственность. С сегодняшнего дня любой голландской власти на Синт-Маартене пришёл конец. Это ясно?";
			link.l1.go = "tomas_2";
		break;
		
		case "tomas_2":
			dialog.text = "Но... Но что будет с нами, с голландскими солдатами, сдавшимися вам, и с ранеными в бою? И что...";
			link.l1 = "А это будет зависеть только от вас, минхер Томас. Если вы выполните мою маленькую просьбу, то я позволю всем, кто сложил оружие, взять своих раненых и отправиться отсюда на корабле или кораблях, которые мы найдём в доках, на Кюрасао к минхеру Стайвесанту.";
			link.l1.go = "tomas_2_1";
		break;
		
		case "tomas_2_1":
			dialog.text = "";
			link.l1 = "В противном случае вас ждут трюмы моих кораблей и казематы на Сент-Кристофере. Также, какого-нибудь важного голландского чиновника придётся показательно вздёрнуть на рее, чтобы отвадить у Стайвесанта желание нападать на наши колонии...";
			link.l1.go = "tomas_3";
		break;
