    ...
    switch (Dialog.CurrentNode)
	{
		case "quests":
			...
			if (pchar.questTemp.Slavetrader == "FindRatJamaica_WP")
            {
				...
				{
					link.l1 = "Я принёс тебе твой кулон с самоцветами. Держи.";
		...
		case "Jamaica_ratW_2":
            ...
            link.l1 = "Ничего смешного, малышка. Мы договорились с ним встретиться на Ямайке, а дальше нас ждёт совместный рейс... Если ты понимаешь, о чём я. Мне в одиночку не справиться, а он взял и свалил неизвестно куда!";
		...
		case "Jamaica_ratW_6":
            dialog.text = "Да, конечно, сэр. Франсуа взял курс на Кубу, в Гавану.";
            link.l1 = "Спасибо, дорогуша. Это всё, что я хотел"+ GetSexPhrase("","а") +" знать.";
            link.l1.go = "exit";
