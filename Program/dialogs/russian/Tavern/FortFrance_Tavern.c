...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		case "quests":
			...
			{
				link.l1 = "Скажите, мой друг, которому я снял"+GetSexPhrase("","а")+" комнату, куда он уехал? Обещал дождаться меня, но комната пуста.";
		...
		case "Sharlie_rum_2":
			dialog.text = "Отлично. Повторите его себе ещё несколько раз, а лучше - запишите где-нибудь. После того, как вы назовете пароль капитану люггера, на баркас будут перегружены ящики с бутылками рома, которые нужно доставить в бухту пиратского поселения Ле Франсуа - вас там встретят\nВот и вся задача. Из бухты Ле Франсуа до Сен-Пьера доберётесь пешком - баркас останется в бухте. Если вам ещё не стало страшно, и вы готовы выполнить это задание, то по завершении я заплачу вам пять тысяч песо.";
		...
		case "Sharlie_rum_3":
			dialog.text = "Баркас будет у пирса в семь вечера. Люди на баркасе опытные, до люггера доберётесь, думаю, быстро. Всё дело не должно занять более четырёх часов - уверен, к одиннадцати часам вечера вы будете уже снова в Сен-Пьере. Да, и возьмите для облегчения поисков вот эту подзорную трубу и вот эту карту Мартиники. Труба, конечно, дрянь-дрянью, но лучше, чем ничего. Пляж Ламантен находится на северной оконечности острова, так что, выйдя из порта, держите курс на север. Удачи!";
		...
		case "Sharlie_rum_4":
			...
			if(CheckAttribute(pchar, "questTemp.Sharlie.FastStart"))
			{
				...
				//Log_Info("Вы получили карту Мартиники");
			...
			NewGameTip("Экипируйте подзорную трубу через окно предметов (F1).");
		...
		case "Portugal_2":
			dialog.text = "Не сказал бы, что он прямо сам уехал, "+GetAddress_Form(NPChar)+". Вчера сюда пришли какие-то люди, с ними были такой одноглазый верзила - ну чисто бандит с виду, и шепелявый тип, похожий на кастильца. Я удивился было, но этот шепелявый так на меня глянул... ну чисто на вошь, перед тем как раздавить. И спрашивали, значит, про вашего друга... ну, я и сказал - а что мне делать было?";
			link.l1 = "Знаю, " + npchar.name + ", ты не герой, и правильно. Что ты ещё видел? Куда они направились?";
			link.l1.go = "Portugal_3";
		break;
		
		case "Portugal_3":
			dialog.text = "Да вроде ничего больше... хотя, нет! Постойте, одноглазый говорил что-то про повозку. Вроде как повозку они наняли, вашего друга куда-то на другую сторону острова везти. Вот и всё, клянусь "+GetAddress_Form(NPChar)+"... я бы стражу вызвал, но этот шепелявый на прощание сказал, что у меня красивая жена... Понимаете? Если они узнают, что я вам всё рассказал, они же её...";
			if (pchar.money >= 1000)
			{
		...
		case "Portugal_4":
			...
			dialog.text = "Спасибо, "+GetAddress_Form(NPChar)+". Ваш друг, к слову, он почти поправился, во всяком случае шёл сам. А второй человек - ну, этот тихий голландец, он как раз заходил с улицы, заприметил эту свору и сиганул наружу, только его и видели.";
