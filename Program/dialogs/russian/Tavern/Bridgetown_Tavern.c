...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		case "quests":
			...
			{
                link.l1 = "Я выполнил работу. Фернандо Родригес мёртв.";
		...
		case "TavernDone":
			...
			link.l1 = "Можно сказать, и праздник. Я везу рабов в Блювельд - недавно переделал свой новый бриг специально под эти цели - а тут зашёл на плантацию, поболтал с управляющим - он заказал мне приличную партию 'черного дерева'. Так что скоро жди меня опять в гости. Отвезу товар в Блювельд - буду возить на Барбадос, хе-хе...";
		...
		case "Tonzag_task":
			...
			dialog.text = "На Карибы прибыл из Кастилии один идальго, в расчёте переждать последствия одной... дуэли в Европе. Однако жажда мести границ не имеет - влиятельная испанская семья желает, чтобы этот идальго умер. Выполните их волю любым способом\nВ качестве доказательства вы должны отрезать его палец с фамильным перстнем и доставить мне. Кроме того, принесите мне всё, что найдёте при нём, все вещи. Вы готовы взяться за эту работу?";
			link.l1 = "Если оплата будет достойной, то конечно возьмусь.";
			link.l1.go = "Tonzag_task_1";
			link.l2 = "Работать наёмным убийцей? Да ни за что!";
		...
		case "Tonzag_task_1":
			dialog.text = "Награда определена в размере 30 000 песо - в накладе вы не останетесь. Кроме того, можете забрать себе с трупа все деньги, какие найдёте. Теперь подробности: вашего клиента зовут дон Фернандо Родригес. Его приметы: на вид 35 лет, высокий, смуглый, одевается как военный. Хороший моряк и опытный фехтовальщик\nГде его найти - сказать точно не могу, но достоверно известно, что он сейчас в одном из испанских поселений архипелага и не собирается никуда выдвигаться ещё два месяца. Обойдите все испанские города, расспросите людей - кто-нибудь обязательно его видел\nИ ещё: я достоверно знаю, с какими вещами он никогда не расстаётся, так что не вздумайте что-либо от меня утаить. Вопросы есть?";
		...
		case "Task_check":
			...
			{
				link.l1 = "Нет. Фернандо утонул вместе со своим кораблём, и палец утонул вместе с Фернандо.";
		...
		case "Task_fail":
			...
			link.l1 = "Но я же его уничтожил! А, пёс с тобой... На архипелаге и других занятий хватает. Бывай.";
			link.l1.go = "exit";
			pchar.questTemp.HWIC.Fail3 = "true";
		...
		case "Task_check_1":
			...
			dialog.text = "Великолепно! Палец я оставляю себе. Теперь по содержимому его карманов. Давай посмотрим, что ты привёз.";
		...
		case "Task_check_2":
			...
			{
				dialog.text = "Хм... Я же тебя предупреждал - я знаю, с чем Родригес никогда не расстаётся. И я не вижу здесь того, что мне надо. Ты прикарманил эти вещи? Или потерял? Неважно. Я более не желаю иметь с тобой дело. Проваливай.";
				link.l1 = "Ну и пёс с тобой...";
				link.l1.go = "exit";
				pchar.questTemp.HWIC.Fail3 = "true";
		...
		case "Task_complete":
			...
			dialog.text = "Вот твоё вознаграждение, как и было обещано - тридцать тысяч. И у меня сразу есть для тебя очередное, очень ответственное задание, связанное со значительным риском, но и оплата будет соответствующей - 40 000 песо.";
		...
		case "Fleetwood_house":
			...
			dialog.text = "В этот раз охотиться нужно не за человеком, а за вещью. Тебе нужно проникнуть в дом английского капитана, Ричарда Флитвуда, проживающего на Антигуа, и выкрасть его судовой журнал. Дом этот охраняется изнутри, да и сам Ричард со своим журналом нечасто в нём бывает\nПлан таков: ровно через 10 дней губернатор Сент-Джонса даёт у себя во дворце званый ужин, куда будет приглашён и капитан Флитвуд. Тебе нужно проникнуть в дом ночью, между часом и тремя часами - тогда не будет опасности твоего обнаружения. Внутри будет всего один солдат - когда Ричарда нет дома, то и охраны немного. Охранника ликвидируешь. Журнал следует искать в апартаментах Ричарда на втором этаже\nВозьми этот ключ, с его помощью ты откроешь запертую дверь дома.";
		...
		case "Fleetwood_house_1":
			...
			link.l1 = "Ровно через десять дней, с часу до трёх ночи.";
