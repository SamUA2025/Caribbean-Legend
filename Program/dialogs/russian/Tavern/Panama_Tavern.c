...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		...
		//-->работорговец
		case "Panama_rat_1":
			dialog.text = NPCStringReactionRepeat("Да, был у нас в городе этот тип. Всё по тёмным углам прятался... Потом к нему приехали какие-то дружки, на вид - форменные головорезы, и он ушёл из города.", "Ты уже "+ GetSexPhrase("спрашивал","спрашивала") +" об этом, я тебе ответил.", "Я же говорю тебе, ты уже "+ GetSexPhrase("спрашивал","спрашивала") +" об этом Гонтьере.", "Послушай, отойди и не мешай! Совсем что ли крыша поехала?", "block", 0, npchar, Dialog.CurrentNode);
