...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		case "quests":
			...
			{
				link.l1 = "А что ты можешь сказать о коменданте тюрьмы?";
		...
		case "Consumption":
			...
			link.l1 = "Да неужели? Хозяин портовой таверны не желает прислушиваться к сплетням - это что-то новенькое! Может быть, звон песо вернёт тебе любознательность?";
			link.l1.go = "Consumption_1";
		break;
		
		case "Consumption_1":
			dialog.text = "Серебро, оно, конечно, заманчиво, но собственная шкура как-то милее. Может вам, "+GetSexPhrase("господин хороший","госпожа хорошая")+", о чём другом порассказать? Я же завсегда с радостью - только намекните!";
		...
		case "Consumption_2":
			...
			dialog.text = "Ох и настойчив"+GetSexPhrase("ый","ая")+" же вы, сеньор"+GetSexPhrase("","ита")+". Только запомните - не было этого разговора.(шепчет) Я уже не раз слышал за последний год, как люди сгорают от чахотки в наших тюрьмах. Кто-то винит власти, кто-то Бога или Дьявола, но большинство лишь диву даётся - как быстро уносит жизни эта проклятущая болезнь. Бывает, здорового человека посадят, а через неделю-другую уж и нет его. Раз, и всё...";
			link.l1 = "Однако... Целый год, говоришь? И что, никто ничего так и не предпринял?";
			link.l1.go = "Consumption_3";
		break;
		
		case "Consumption_3":
			dialog.text = "А кому оно надо то, сеньор"+GetSexPhrase("","ита")+"? До тех, кто в тюрьме, никому дела то и нет - отбросы общества, как говорят чистоплюи в бархате. Был в городе один доктор, что в тюрьме работал, вроде как пытался как-то лечить этих бедняг, но и сам вскоре умер - заразился видать, и всё\nСейчас комендант просто туда никого не пускает, а властям и наплевать - меньше расходов на кормежку.";
			link.l1 = "Занятно, но чем эта болезнь, запертая за надёжными стенами, тебя так пугает, что мы шепчем, словно монашки о сладости греха?";
		...
		case "Consumption_5":
			dialog.text = "Вроде как. Никакого толку с него уже дружкам не было - сидел и напивался день за днём, словно забыть что-то хотел. А как напьётся, что еле языком ворочает, начинал нести что-то про чахотку, которая, мол, людей забирает в тишине\nИменно так - 'забирает в тишине', он говорил. И, по словам его, выходило, что 'чахотка' та - самое жуткое, что с человеком в камерах случиться может.";
			link.l1 = "Ну нёс пьяница всякую чепуху, что в том такого?";
		...
		case "Consumption_6":
			...
			{
				dialog.text = "Ничего, если не смотреть на то, что он становился смелее и говорил всё чаще, а потом - раз, и всё. Ножом по горлу и в канаву... а кто, да за что - мне безразлично.";
				link.l1 = "А что ты можешь сказать о коменданте?";
				link.l1.go = "Consumption_8";
			}
			else
			{
				dialog.text = "Ничего, если не смотреть на то, что он становился смелее и говорил всё чаще, а потом - раз, и всё. Ножом по горлу и в канаву... а кто, да за что - мне безразлично.(повышает голос) Да, такие уж тут берега, сеньор"+GetSexPhrase("","ита")+", глядеть надо в оба - шторма налетают с Больших Антил в мгновение ока - раз, и всё! Доброго ветра, сеньор"+GetSexPhrase("","ита")+", спасибо что поговорили!";
		...
		case "Consumption_8":
			dialog.text = "А что о нём говорить? Полковник, прибыл из Европы пару лет назад, получив это место. Вроде бы как был понижен там, в Старом Свете, за какие-то махинации. Не знаю, правда ли, но слухи ходили первое время. Впрочем, о ком они не ходят, да?";
			link.l1 = "Махинации, говоришь... Интересно. Что-нибудь ещё?";
			link.l1.go = "Consumption_9";
		break;
		
		case "Consumption_9":
			dialog.text = "Ну, как вам сказать... Полковник производит впечатление человека, всерьёз озабоченного собственной безопасностью. У нас, конечно, места не самые тихие - пираты, разбойники, а, бывает, и индейцы заплывают поохотиться, но сеньор комендант никуда не выходит без пары-тройки солдат\nА весь свой особняк, здесь, в городе, превратил в небольшую крепость - вооружил всю прислугу, и запрещает им открывать ставни.";
			link.l1 = "Но ведь днём он на службе в тюрьме, так?";
		...
		case "guardoftruth":
			dialog.text = "Помню такого. Он сам заходил в мою таверну, правда, ничего не рассказывал. Просто выпил немного рома, пошушукался с посетителями и ушёл. Очень был мрачный и суровый, весь в напряжении, словно в ожидании какой-то невзгоды\nДа и команда на том фрегате была под стать ему - все как один из наёмников, угрюмые, хмурые, и эфесы сабель всё поглаживали. Поговаривали, что на том фрегате были полные трюмы золота и драгоценных каменьев, но я не верю в подобные сказки - ценные грузы перевозят обычно в составе больших караванов\nПостояли они тут день - и ушли. В Европу собирались. А больше ничего я про них и не знаю.";
