...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		...
		case "guardoftruth":
			dialog.text = "Как уж там назывался этот корабль - 'Санта Маргарита', или 'Кастильская блудница', я не знаю, но с месяц назад действительно притащили сюда испанский галеон, взятый призом. Причём взяли его на шлюпе! Гай Марше, капитан этого шлюпа, потом два дня хлестал ром в таверне и всё бахвалился своей удачей - первый поход, и такой приз!\nНу да, велик героизм: на том галеоне даже абордажной роты не было, взяли их голыми руками, как ягнят. Да и кому там сопротивление оказывать было, когда плыли на нём какие-то церковные крысы? Видать, забыли паписты старую поговорку...";
		...
		case "guardoftruth_1":
			dialog.text = "А пёс его знает. Я уже давно его не видел у себя в таверне. Он как протрезвел, так сразу загнал трофейный галеон в доки и бегал вокруг него, как угорелый. Понятия не имею, где Марше сейчас. Может, на Тортуге, а может и в плавании.";
			link.l1 = "Ясно. Ну что же, спасибо за рассказ, дружище!";
			link.l1.go = "guardoftruth_2";			
		break;
		
		case "guardoftruth_2":
			dialog.text = "Всегда пожалуйста, месье "+pchar.name+", любая информация для нашего славного капитана, спасителя Сен-Пьера! Заходите ещё!";
			link.l1 = "...";
			link.l1.go = "exit";	
		...
		// Addon 2016-1 Jason Пиратская линейка
		case "mtraxx_jew":
            dialog.text = "Смотрю, Гаспар становится всё популярней и популярней у вашей братии... Его дом находится у городской стены. Выйдешь из таверны, повернешь налево, пройдешь в сторону порта, не выходя в порт ещё раз налево, до упора прямо и затем направо. Двухэтажный особняк.";
		...
		case "PZ3":
			...
			link.l1 = "Ну тогда на этот раз без серебра. Бывай.";
			link.l1.go = "Exit";
		break;
	}
