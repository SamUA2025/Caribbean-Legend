...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		case "quests":
			...
			{
				link.l1 = "Послушай, мне нужен охотник по имени Фергус Хупер. Мне сказали, что он в Белизе живёт. Где я могу его найти?";
				link.l1.go = "caleuche";
			}
		break;
		...
		// Калеуче
		case "caleuche":
			dialog.text = "Фергус? Он у меня частенько бывает. Но сейчас его нет - ушёл в сельву не позже, как вчера. Но ты не переживай, недели не пройдёт, как он снова будет сидеть у меня за столиком, пить ром и пугать всех сказками о своих морских похождениях. Хотя охотник он знатный, не спорю. Никто лучше него не умеет ловить змей.";
			link.l1 = "Змей? Хм. Так когда мне наведаться к тебе, чтобы застать Фергуса?";
			link.l1.go = "caleuche_1";
		break;
		
		case "caleuche_1":
			dialog.text = "Ну, раньше чем через три дня его не жди. Потом захаживай. Только учти, что он блюдёт режим дня и никогда не приходит раньше шести вечера, и уходит спать не позже десяти.";
