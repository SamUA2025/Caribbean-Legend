...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		...
		case "Havana_ratT_1":
			dialog.text = "А-а, этот мрачный тип? Да, заходил он ко мне, останавливался. Скажу тебе по секрету: он ходил на приём к самому дону Диего де Толедо. Подавал ходатайство на получение патента. Но что-то там у него не выгорело, и он убрался прочь.";
			Link.l1 = "А куда он отчалил, не в курсе? Я за ним уже с самого Порто Белло тянусь, да всё никак найти не получается.";
		...
		case "Havana_ratT_2":
			...
			Link.l1 = "Господи, да что же это за наказание такое! Я что, похож"+ GetSexPhrase("","а") +" на наёмн"+ GetSexPhrase("ого","ую") +" убийцу? Он мой приятель, я спешу передать ему новости, которые его весьма и весьма обрадуют, да и не надо ему уже прятаться - никто его не ищет.";
		...
		case "Havana_ratT_4":
			dialog.text = "Ну, после того как ему дали у нас от ворот поворот, он бубнил, что к лягушатникам, своим соотечественникам, подастся. На Тортугу он отправился... Что-то он ещё про любовницу свою бормотал, да я так и не понял толком.";
		...
		// калеуче
		case "caleuche":
			dialog.text = "Чёрт его знает, дружище. Может, и прибывал, да вот только я о нём ничего не знаю. Уж извини.";
