...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		case "quests":
			...
			{
				link.l1 = "Я пришёл за ответом сеньору Лукасу Роденбургу.";
		...
		case "SantiagoTripBank":
			...
			{
			dialog.text = "Насколько мне известно, кроме пакета должно было быть ещё кое-что, капитан. Так где же... это? Вы поняли, о чём я говорю?";
			link.l1 = "Конечно! Сундуки под надёжной охраной у меня на корабле. Сейчас я прикажу их доставить.";
			link.l1.go = "exit";
			}
		break;
		
		case "SantiagoTripBank_1":
			dialog.text = "Хм-м... интересно. Значит он, видите ли, 'сожалеет'. Так-так. Впрочем, сожаления сeньора Роденбурга весьма убедительны, тут сложно спорить. Сеньор, мне потребуется время для написания ответа - вас не затруднит зайти ко мне завтра днём и забрать письмо? Переночуйте в таверне, погуляйте по городу... у нас в Сантьяго есть на что посмотреть.";
			link.l1 = "Хорошо, я зайду завтра днём. До встречи, сeньор.";
		...
		case "SantiagoTripBank_3":
			...
			link.l1 = "Хорошо, я запомню, сeньор. Что-нибудь ещё?";
