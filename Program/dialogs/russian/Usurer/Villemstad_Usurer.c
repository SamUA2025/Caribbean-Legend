...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		case "quests":
			...
			{
				link.l1 = "Я принёс вам сундучок с дублонами.";
		...
		case "guardoftruth":
			...
			link.l1 = "Невероятно! И кому же могла понадобится церковная утварь? Минхер, а кому вы их продали? Я хочу попытаться выкупить...";
		...
		case "guardoftruth_4":
			dialog.text = "Золотое кадило купил человек по имени Роланд Мозес, более известный как Ролли Колпак. Зачем уже этому мяснику понадобилась церковная вещь, ума не приложу, но он почему-то пришёл от неё в неописуемый восторг... Кстати, с самим Ролли вы уже навряд ли встретитесь.";
		...
		case "guardoftruth_5":
			...
			link.l1 = "Ещё бы! Командир 'морских лис' в Сент-Джонсе на Антигуа...";
		...
		case "guardoftruth_7":
			...
			link.l1 = "Сеньора Белинда де Риберо? Я смогу найти её в Кумане, так?";
		...
		case "guardoftruth_9":
			dialog.text = "Всегда пожалуйста, минхер. Заходите ещё!";
