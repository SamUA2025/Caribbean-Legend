void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "First time":
	        ...
	        {
				dialog.text = "Хм... Верить этому проходимцу - дело неблагодарное, хотя его история похожа на правду. Быть может, на этот раз он не врёт. Но, пожалуй, побеседую-ка я с его жёнушкой... Боцман! Привести мне захваченную в плен женщину!";
    		...
    		{
    		    dialog.text = "Уф! Ну и тяжёлая же эта штуковина!";
    			link.l1 = "";
    			link.l1.go = "exit";
    		}
			//<-- водолазный скафандр
    		...
    		{
    		    dialog.text = "Нет-нет-нет! Даже и не подумаю! Трёх раз хватило вдоволь!..";
    			link.l1 = "...";
    			link.l1.go = "exit";
    		}
			if (CheckAttribute(pchar, "questTemp.Terrapin") && pchar.questTemp.Terrapin == "roof")
    		{
    		    dialog.text = "Дело сделано - Левассер мёртв. Это оказалось проще, чем я думал... Но что-то тут не так. Ведь Тибо даже не разговаривал с Мартэном! Это значит, что либо Робер предал меня, либо сыграл слепой случай\nНо куда же мог убежать этот гад Тибо? Наверняка, он уже мчится к Кэтрин. Надо что-то делать, если я хочу вырвать девушку из его лап...";
    			link.l1 = "";
    			link.l1.go = "terrapin";
    		}
			if (CheckAttribute(pchar, "questTemp.Guardoftruth") && pchar.questTemp.Guardoftruth == "think")
    		{
    		    dialog.text = "Сокровища, сокровища... индейский город... Я не верю в чудесные совпадения, чёрт возьми... Бьюсь об заклад, что к исчезновению фрегата этого Мигеля Дичозо приложил руку мой драгоценный братец. Думаю, он также позаботился о том, чтобы закрыть рот Дичозо\nА быть может, он был с ним в сговоре - не просто так же испанцы предположили, что Дичозо скрывается в Сен-Пьере. Тут неясно. Но я уверен, что индейское золото, которое Мишель 'вёз де Пуанси', и золото Мигеля Дичозо - одно и то же. Рассказ этого пленного кастильца вполне стыкуется с показаниями офицера об 'операциях' братишки и де Пуанси\nОднако получается, что Мишель вёз-вёз, да не довёз, и Дичозо вёз-вёз, да не довёз... забавно! И где же тогда пресловутые сокровища? Не за ними ли так спешно отправился братец, а? Думаю, что именно за ними\nСледовательно, если мне найти это золото, то я убью двух зайцев: и братцу дорогому взгляну в бесстыжие глаза, и... да-да, золото ещё никому не помешало. Но с какого же конца распутывать этот клубок? Видимо, придётся близко знакомиться с испанцами\nДон Рамон Мендоса отпадает - с ним я навряд ли договорюсь, а вот святой отец Винсенто, инквизитор, заклятый друг барона... вот этот подойдёт. Братья Ордена Иисуса не отличаются щепетильностью, зато любят деньги и не брезгуют грязными методами\nДичозо, Дичозо... где-то я уже слышал это имя... или нет? Ладно, чёрт с ним. Пойду к офицеру, забирать своего испанца, и отправляюсь в Сантьяго.";
    			link.l1 = "";
    			link.l1.go = "exit";
    		}
			if (CheckAttribute(pchar, "questTemp.Guardoftruth") && pchar.questTemp.Guardoftruth == "shore")
    		{
    		    dialog.text = "Ваниль перегружена на каракку, её паруса давно скрылись за горизонтом, а этот чёртов галеон, вместо того, чтобы выходить в открытое море, взял и вернулся в порт, будь он неладен. В порту на корабле показываться мне нежелательно: пусть думают, что я ушёл с Гваделупы... Отправлюсь-ка я пешком в город через джунгли и разведаю, что делает мой дорогой Марше...";
    			link.l1 = "";
    			link.l1.go = "exit";
    		}
    		...
    		{
    		    dialog.text = "Так-так! Вот я и нашёл место, указанное 'проявлением': это индейский истукан! Рядом с ним стрелка компаса Стрела Пути перестаёт метаться и указывает строго одно и то же направление, как ни крутись. Логично - индейская магия - индейский истукан. Теперь надо отметить направление, куда указывает Стрела Пути, на карте, а затем отправляться на Доминику.";
    			link.l1 = "";
    			link.l1.go = "exit";
    		...
    		{
    		    dialog.text = "Так-так! Вот я и нашёл место, указанное 'проявлением': это индейский истукан! Рядом с ним стрелка компаса Стрела Пути перестаёт метаться и указывает строго в одну и ту же сторону, как ни крутись. Логично - индейская магия - индейский истукан. Теперь надо отметить направление, куда указывает Стрела Пути, на карте, а затем отправляться на Мэйн.";
    			link.l1 = "";
    			link.l1.go = "exit";
    		...
    		{
				dialog.text = "Вот и конец длинного пути. И разве мог я себе представить, что освобождая своего брата, я тем самым готовился к смертельной схватке с ним? Что я поставил под угрозу весь мир? Слава Богу, всё позади\nБолее ничто меня не держит на Карибах. Пришло время возвращаться домой, во Францию. Но... вот только хочу ли я этого?";
			...
			if (CheckAttribute(pchar, "questTemp.Europe"))
    		{
				...
				dialog.text = "Вы слышали, что сказал полковник? Здесь прячутся мятежники! Обыскать весь дом, перевернуть всё и схватить всех, кто там находится! Вперёд!!";
				link.l1 = "...";
				link.l1.go = "exit";
    		...
    		{
    		    dialog.text = "Итак, сундук подготовлен. Можно, конечно, собирать всё самому, но лучше отправлюсь к Фадею - он явно из тех людей, кто может достать всё что угодно.";
    		...
    		{
    		    dialog.text = "Итак, нужно построить шесть лодок. Для этого моим людям потребуется 20 связок распиленных досок и 10 тюков кожи. Инструменты возьмем на корабле. Руководить работами должен человек, разбирающийся в плотницком деле и починке кораблей.";
    		...
    		{
    		    dialog.text = "Итак, я просто-напросто взорву этот завал из старых деревьев. Для этого мне потребуется 300 картузов пороха, чтобы наверняка.";
    		...
    		{
    		    dialog.text = RandSwear()+"Выход заперт!! Дверь не поддаётся - словно её подперли снаружи чем-то тяжёлым!.. "+RandSwear()+"\nЧ-ш-ш... Что это?..";
    			link.l1 = "";
    		...
    		{
    		    dialog.text = "Ну вот и всё... Тупик. Дальше идти некуда\nПохоже, дон Энрико был прав: из этих подземелий не выбраться. Появилась было надежда, когда я отпер дверь из зала с 'сокровищами', когда нашёл вторую дверь в подземелье с водой, но теперь... Я уже потерял счёт времени - сколько я уже хожу по этим тёмным проходам? Полдня, день? Как же тут тихо и жутко, словно в гробу\nА вот здесь, видимо, когда-то была церковь. Самое подходящее место для того, чтобы помолиться. Грехов у меня много, слишком много... Помолюсь, а затем лягу спать: я ужасно устал, еле держусь на ногах, и рана на спине разболелась. Может, повезёт, и не проснусь больше...";
    			link.l1 = "";
    			link.l1.go = "exit";
			...
			{
				dialog.text = "";
    			link.l1 = "Я, Шарль де Мор, французский капитан и дворянин, клянусь перед собой и своей совестью, что навсегда порываю со своим пиратским прошлым!";
    			link.l1.go = "Good_Choice";
				link.l2 = "Да! Да! Ах-ха-ха!! Я сделал это, я выжил! Выкуси, Зорро! Иди к дьяволу, Маркус! Теперь я сам по себе! Чарли Принц, может, и погиб, но вот Шарля де Мора теперь точно ничто и никто никогда не убьёт!";
    			link.l2.go = "Bad_Choice";
			}
			// <-- legendary edition
			
			if (CheckAttribute(pchar, "questTemp.TonzagQuest.JailDialog")) {
				dialog.text = "Чем бы заняться?";
			...
			if (CheckAttribute(pchar, "questTemp.HelenDrinking.RefusedGame")) {
				dialog.text = "Ну и вечер! И почему я послушался её? Прав был братец - девки тут совсем другие. Может, им что-то в ром добавляют?";
				link.l1 = "Пора спать, а потом - в Картахену!";
				link.l1.go = "exit";
			...
			if (CheckAttribute(pchar, "questTemp.PZ_OsmatrivaemSunduk")) {
				dialog.text = "Ни одну вещь не украли, пусть всё и лежит абы где, а не на своём месте.";
				link.l1 = "Даже из ценного ничего не взяли - значит, что-то искали, а не пытались ограбить. Но что? И, главное, кто?..";
				link.l1.go = "exit";
			...
			if (CheckAttribute(pchar, "questTemp.PZ_GotovimShlupki")) {
				dialog.text = "Дожидаемся ночи и атакуем!";
				link.l1 = "Начнём пока готовить шлюпки.";
				link.l1.go = "exit";
			...
			if (CheckAttribute(pchar, "questTemp.PZ_TiboUkralDevu")) {
				dialog.text = "Господи... Нет, нет, нет...";
				link.l1 = "";
				link.l1.go = "exit";
			...
			if (CheckAttribute(pchar, "questTemp.PZ_DevaMertva")) {
				dialog.text = "О Боже, Боже, Боже... За что, Господи, ну за что... Я же так старался...";
				link.l1 = "Я никогда себе этого не прощу. Это всё моя вина, и только моя. Я не успел совсем немного. Прости меня...";
				link.l1.go = "exit";
...
//navy <--
			...
			Link.l19 = "Хочу выбрать тип лечебного зелья для постоянного употребления.";
			Link.l19.go = "ChoosePotion";
			
			//--> Голландский гамбит
			if(CheckAttribute(pchar, "questTemp.HWIC_Coordinates") && PChar.location == Get_My_Cabin()) 
	        {
	        	Link.l11 = "Заняться нахождением острова по координатам на карте.";
	        ...
	        {
	        	Link.l13 = "Вызвать Адама Рейнера.";
	        ...
	        {
	        	Link.l13 = "Арестовать Адама Рейнера.";
	    		Link.l13.go = "FalseTrace_Cabin";
	    	}
			//<-- Ложный след
			// Addon 2016-1 Jason Пиратская линейка
	        ...
	        {
	        	Link.l17 = "Пересчитать содержимое сундука и принять решение по окончанию сбора амуниции для Жана Пикара.";
	        ...
	        {
	        	Link.l17 = "Отдать приказ об атаке на плантацию Маракайбо.";
	        ...
	        {
	        	Link.l17 = "Отдать приказ о постройке лодок.";
	        ...
	        {
	        	Link.l18 = "Сделать предложение руки и сердца.";
			...
			{
				Link.l14 = "Начать ремонт кораблей";
	        ...
	        {
	        	Link.l15 = "Закончить дела на Карибах и отправиться в Европу.";
	    		Link.l15.go = "final_1";
	    	}
			//<-- завершение игры
			Link.l20 = RandPhraseSimple("Не сейчас. Нет времени.", "Некогда. Дела ждут.");
			Link.l20.go = "exit";
		break;
		...
		case "ChoosePotion":
			Dialog.Text = "Выбор лечебного зелья:";
			...
			Link.l8 = "Стоп, я передумал"+GetSexPhrase("","а")+".";
		...
		case "TalkSelf_TownAttack":
			...
			if (sti(Pchar.Ship.Type) != SHIP_NOTUSED && bOk)
	        {
	            ...
	            else
	            {
					...
					{
						Dialog.Text = "Не-е-ет, я не сумасшедш"+GetSexPhrase("ий","ая")+". Взять этот город с суши невозможно...";
	    				Link.l1 = "...";
	    				Link.l1.go = "exit";
					}
					else
	        ...
	        else
	        {
				...
				{
					Dialog.Text = "Эх! Команды маловато, нужно хотя бы "+needCrew+" человек.";
					Link.l1 = "...";
					Link.l1.go = "exit";
				}
				else
...
//navy <--
		...
		case "Seek_AbyIsland":
			...
			{
				dialog.text = "Эх, у меня нет необходимых навигационных приборов для определения широты и долготы. Жаль. Поиски острова придётся отложить.";
				link.l1 = "";
				link.l1.go = "exit";
			}
		break;
		...
		case "knock_2":
			...
			dialog.text = "Постучали, теперь подождём ответа...";
			link.l1 = "(ждать)";
		...
		case "knock_wrong":
			dialog.text = "Не открывает... Значит, стучать надо было не так. Что же, приду завтра и попробую ещё раз - сегодня мне уже наверняка не откроют.";
			link.l1 = "(уйти)";
			link.l1.go = "exit";
		break;
		...
		case "SP_defend":
			PlaySound("VOICE\Russian\military02.wav");
			dialog.text = "Итак, перед нами поставлена задача - отбить атаку проклятых кастильцев на поселение Сен-Пьер. Форт захвачен, бои идут на улицах города. В бухте Сен-Пьера расположилась мощная вражеская эскадра, флагман которой - линейный корабль. Атаковать эскадру бесполезно - в форте засели испанцы, кроме того, кастильцы в городе не позволят нам высадить десант на лодках\nПоэтому мною было принято решение пройти через джунгли и атаковать мерзавцев с тыла через городские ворота. Очистив город и форт от захватчиков, займёмся эскадрой. Лишённая поддержки форта, она станет гораздо более уязвимой\nБой предстоит непростой, и я отдал распоряжение выплатить сверх вашего жалования сто тысяч песо на всю команду. Надеюсь, это укрепит вашу решимость в предстоящей битве. Вперёд!";
			link.l1 = "";
			link.l1.go = "exit";
		...
		case "final_1": // Jason НСО
			...
			{
				dialog.text = "Хотя, куда это я собрался? Я не могу покинуть пост генерал-губернатора без разрешения из Парижа! Иначе во Франции меня будет определённо ждать арест за самовольное оставление вверенных колоний. Париж, я буду скучать по тебе...";
				link.l1 = "";
				link.l1.go = "exit";
				EndQuestMovie();
			}
		...
		case "final_2":
			dialog.text = "И я думаю, это правильное решение! Что я там забыл, в этой старушке-Европе, когда здесь я нашёл самого себя? А вернуться во Францию я всегда успею!";
			link.l1 = "";
			link.l1.go = "exit";
		...
		case "FMQN_2":
			dialog.text = "Нет уж, всё-таки останусь. Но чёрта с два я буду сидеть и ждать у моря погоды - отправляюсь на корабль, пойду в порт Филипсбурга и разнюхаю обстановку. Я не намерен становиться слепым орудием в руках не внушающего доверия англичанина.";
			link.l1 = "";
			link.l1.go = "exit";
		...
		case "mtraxx_ammo":
			...
			{
				dialog.text = "Тридцать единиц холодного оружия в сундуке! Можно завершать, либо донести ещё пистолей, пуль, зелий?..";
				...
				{
					link.l3 = "Заполнить содержимым сундука Фадея, а излишки забрать."; 
					link.l3.go = "mtraxx_ammo_1";
				}
			}
			else
			{
				dialog.text = "Тридцать единиц холодного оружия ещё не собраны! Надо продолжать работу.";
				link.l1 = "";
				link.l1.go = "exit";
			}
		break;
		...
		case "mtraxx_mutiny":
            dialog.text = "Вперёд, в атаку! Ура!!";
			link.l1 = "";
			link.l1.go = "exit";
		...
		case "mtraxx_powder":
            if (GetSquadronGoods(pchar, GOOD_POWDER) >= 300) // наличие пороха
			{
				...
				{
					dialog.text = "Для доставки пороха всё готово - отнести бочонки к завалу!";
					link.l1 = "";
					link.l1.go = "exit";
		...
		case "LH_marry":
			...
			{
				link.l3 = "Ямайка - с ней столько всего связано! А любоваться рассветом в бухте Портленд - именно так я представляю себе рай на земле.";
		...
		case "LH_marry_2":
			...
			sTemp = sld.name;
			AddQuestUserData("LongHappy", "sName", sTemp);
			dialog.text = "Ну и куда без торжества мирского. Впрочем - это я бы предпочёл обсудить с "+sTemp+" чуть позже.";
			link.l1 = "";
			link.l1.go = "exit";
		...
		case "LH_marry_4":
			...
			{
				dialog.text = "Ещё не собраны все необходимые товары и деньги!";
				link.l1 = "";
				link.l1.go = "exit";
			}
		break;
