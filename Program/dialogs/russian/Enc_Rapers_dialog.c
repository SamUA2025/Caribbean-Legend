...
//			Diag.TempNode = "OnceAgain";
		...
		case "Node_10":
			dialog.text = "Ты лжёшь!!! Я уже чувствую запах золота, который струится из этой пещеры! Показывай место, если не хочешь подохнуть!";
		...
		case "EncGirl_Berglar2":
			...
			else
			{
				...
				link.l1 = "Забирай, паршивец! Но это тебе так просто с рук не сойдёт...";
