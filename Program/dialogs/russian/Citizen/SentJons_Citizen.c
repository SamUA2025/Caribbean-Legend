...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		...
		case "terrapin":
			...
			{
				dialog.text = LinkRandPhrase("Какой именно Джонс вам нужен? Я знаю не менее двух десятков.","У нас Джонсов, как грибов поганых. Поточнее можете сказать?","Да тут Джонсов не меньше, чем Джонсонов или Джексонов. Может, примету какую назовёте?");
