...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		...
		case "Havana_ratP_1":
			dialog.text = NPCStringReactionRepeat("Да, останавливался. Но уже ушёл от нас. Спросите о нём нашего трактирщика, капитан корвета снимал у него комнату в таверне.", "Вы уже "+ GetSexPhrase("спрашивали","спрашивали") +" об этом, я вам ответил.", "Я же говорю вам, вы уже "+ GetSexPhrase("спрашивали","спрашивали") +" об этом Гонтьере.", "Я прошу не мешать мне работать!", "block", 0, npchar, Dialog.CurrentNode);
