...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		...
		case "caleuche":
			...
			link.l1 = "Хм. А чего это ты вдруг заикаться стал, приятель? И глазки из стороны в сторону забегали... Сдаётся мне, что ты врёшь. Ну-ка, признавайся: ты видел этого человека?";
			link.l1.go = "caleuche_1";
		break;
		
		case "caleuche_1":
			dialog.text = "Г-говорю же вам, сеньор, не видел я н-никого! А з-заикаюсь я с детства, в-вот...";
			link.l1 = "Ты лжёшь. Я по глазам вижу. Где Мерриман?! Отвечай!";
			link.l1.go = "caleuche_2";
		break;
		
		case "caleuche_2":
			dialog.text = "Не знаю я никакого Мерримана! А если вы меня тронете - то комендант вас вздёрнет в форте, имейте это в виду!";
			link.l1 = "Ах, вот как! Ну ладно... Теперь слушай внимательно и вникай: Жоаким Мерриман - колдун. Его жаждет заполучить священная инквизиция. Его много лет назад, ещё в Европе, приговорили к сожжению за раскапывание могил, надругательства над трупами и колдовство. Я точно знаю, что он прячется в окрестностях Гаваны...";
		...
		case "caleuche_4":
			dialog.text = "";
			link.l1 = "... Что ты так побледнел? Я даю тебе слово дворянина, что и дня не пройдёт после моего доклада, как здесь будет всё кишеть испанскими солдатами, а ты, вздёрнутый на дыбу, будешь рассказывать, где прячется колдун. И потом пойдёшь вместе с ним на костёр как соучастник. А я приду посмотреть на аутодафе. Как тебе перспектива?";
			link.l1.go = "caleuche_5";
		break;
		
		case "caleuche_5":
			dialog.text = "Помилуйте, помилуйте, сеньор! Я не участвую во всём этом, клянусь! Я просто... я просто ничего не мог... Как я могу противостоять ему? Он ужасный человек, он может... вы не представляете, что он может! Пощадите!";
		...
		case "caleuche_6":
			dialog.text = "Он... он скрывается в пещере под кладбищем. Туда можно попасть только через дверь в часовне. Когда он выходит оттуда, я прячусь в своём доме и носа не кажу. Вы не представляете, как я хотел бы избавиться от этого ужаса!\nНо я не смею даже приблизиться к нему. Я видел... как он раскопал свежую могилу, вытащил оттуда труп, а потом этот труп ходил по кладбищу при луне! Я тогда чуть рассудка не лишился. Мерриман запретил мне уходить. Сказал, что если я посмею отлучиться из дома без разрешения хоть на полдня, то он меня найдёт и превратит... вот в это, в скелет ходячий!";
		...
		case "caleuche_8":
			dialog.text = "Всегда заперта, очень прочна, и с надёжным замком.";
			link.l1 = "Хм. Мерриман не дурак - наверняка в его убежище есть потайной выход, как в его европейском доме. Начнём ломать дверь - он сбежит, и ищи-свищи потом. Надо подумать...";
		...
		case "caleuche_12":
			dialog.text = "Будьте осторожны, сеньор. Из его пещеры доносятся такие страшные звуки, что я даже боюсь представить, кто или что там живёт. Но Мерриман там не один, это точно.";
