...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
	...
	switch (Dialog.CurrentNode)
	{
		case "quests":
			...
			{
				link.l1 = ""+npchar.name+", 'Розбоом' найден и захвачен. Приступим к выгрузке товара и расчёту?";
				link.l1.go = "mtraxx_5";
			}
		break;
		...
		// город майя
		case "tieyasal":
			dialog.text = "Видел. Он закупал припасы на свой корабль у меня. Кстати, совсем недавно. Вы буквально на несколько дней разминулись. Кстати, быть может, он ещё где-то в посёлке. Я, знаешь ли, не шпионю за людьми. Поспрашивай ещё, глядишь, и отыщется твой дон.";
		...
		case "mtraxx_5":
			...
			if (iTotalTemp < 1)
			{
				dialog.text = "Вы издеваетесь, молодой человек? В ваших трюмах нет ни одного центнера чёрного дерева! Вы меня нагло надули! Это вам даром не пройдёт - я пожалуюсь Маркусу Тираксу! Убирайтесь вон!!";
				link.l1 = "Гм...";
				link.l1.go = "mtraxx_6";
				break;
			}
		...
		case "mtraxx_7":
			...
			link.l1 = "Всего по 100 песо? Но это же грабёж!";
			link.l1.go = "mtraxx_8";
		break;
		...
		case "mtraxx_8":
            ...
            dialog.text = "Грабёж - это по вашей части, капитан, а я просто торговец. Берите ваши деньги и прекратим эти споры. Вы и так нажились на мне, сбыв где-то часть моего товара...";
