void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		case "First time":
			...
			{
				dialog.text = TimeGreeting() + "! Я вас раньше не видел, сеньор. Осмелюсь предположить, что вы капитан... Я угадал? Меня зовут "+GetFullName(npchar)+", и мой магазин к вашим услугам. Золото, серебро и много чего такого, что заинтересует делового человека.";
			...
			{
				dialog.text = TimeGreeting() + ", сеньор! Рад снова видеть вас в моём магазине. Желаете приобрести золотые самородки? Или, быть может, вас сегодня интересуют минералы?";
				link.l1 = "Покажите мне свои товары, "+npchar.name+".";
				link.l1.go = "trade";
				link.l4 = "Нет, ничего не надо, "+npchar.name+". Я просто зашёл поздороваться с вами.";
				link.l4.go = "exit";
			}
