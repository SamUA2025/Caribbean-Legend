...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
 	switch(Dialog.CurrentNode)
	{
		...
		case "BarbTemptation_1":
			...
			link.l2 = "Хм... Знаете, пожалуй, я передумал"+GetSexPhrase("","а")+". Лучше я пропью эти деньги в кабаке.";
		...
		case "FMQN":
			...
			dialog.text = "Важное? Ха! Впрочем, постойте. Действительно, есть кое-что важное. Из джунглей не вернулся патрульный отряд. Ему уже давно пора было топать в свои казармы отдыхать, но они, видимо, предпочитают считать попугаев. Либо - с ними что-то случилось. Если вы во время ваших поисков встретите их - передайте, чтобы придумали весомую причину своего отсутствия, иначе отправятся на гауптвахту. Командира отряда зовут Яннес Хоффман.";
		...
		case "FMQN_11":
			dialog.text = "Не беспокойтесь на этот счёт. Пойдут самые опытные солдаты под командованием лучшего офицера Филипсбурга Ханса Шулте.";
