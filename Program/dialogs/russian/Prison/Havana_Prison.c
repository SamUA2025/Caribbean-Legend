...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
 	switch(Dialog.CurrentNode)
	{
		...
		case "Mtraxx_1":
			...
			link.l1 = "На основании личной просьбы. Мы с Лопе встречались ещё в Европе, и я был поражён новостью о том, что его упекли за решётку, и о том, какие слухи распространяют о нём в городе. Я хочу с ним побеседовать.";
			link.l1.go = "Mtraxx_2";
		break;
		...
		case "Mtraxx_5":
            dialog.text = "Действительно, мне предписано передать дона Лопе Монторо в руки коменданта форта. Видимо, недельки-другой гауптвахты ему всё же не избежать. Если хотите - можете пройти к нему, он ещё здесь.";
