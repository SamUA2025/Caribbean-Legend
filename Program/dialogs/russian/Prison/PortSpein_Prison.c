...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
 	switch(Dialog.CurrentNode)
	{
        case "quests":
			...
			{
				link.l1 = "Слышал"+GetSexPhrase("","а")+", у вас свирепствует эпидемия?";
		...
		case "Consumption":
			...
			link.l1 = "Просто любопытно... Если мои ребята надебоширят на берегу и загремят под арест, стоит запастись жёлтым полотном?";
			link.l1.go = "Consumption_1";
		break;
		
		case "Consumption_1":
			dialog.text = "Если это шутка, сеньор"+GetSexPhrase("","ита")+", то мне, увы, не смешно. Казематы здесь сырые и холодные, да и климат - сами видите, какой. Чахотка - частый гость в этих подземельях. Я даже вынужден приплачивать своим ребятам за то, чтобы они разносили еду в камеры. А уж стоять в карауле там внутри - считается чем-то вроде каторжных работ.";
			link.l1 = "Прошу прощения, я просто хотел"+GetSexPhrase("","а")+" узнать, насколько всё серьёзно?";
		...
		case "Consumption_3":
			...
			link.l1 = "А разве не вы, ещё минуту назад, называли их оборванцами и преступниками, и считали их участь заслуженной?";
			link.l1.go = "Consumption_4";
		break;
		
		case "Consumption_4":
			dialog.text = "Довольно, сеньор"+GetSexPhrase("","ита")+"! Я полагаю, у вас, как и у меня, есть дела поважнее, чем состязаться в остроумии. Дверь прямо за вами - прошу.";
