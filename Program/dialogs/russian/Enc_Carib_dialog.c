void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "war_indian":
			...
			{
				dialog.text = LinkRandPhrase("Стоять, "+GetSexPhrase("бледнолицый","белая скво")+"! По какому праву ты ходить мой земля?","Стой, белый человек! Ты находиться земля моих предков и мой земля!","Остановись, яланауи! Тебе не место на мой земля!");
		...
		case "war_indian_1":
			dialog.text = RandPhraseSimple("Ты пожалеть, что родиться на этот свет, бледнолицый собака... Я вырезать твоё сердце и поджарить огонь!","Я заставить тебя есть камень, белолицый пёс! Ты на коленях умолять о смерти!");
		...
		case "war_indian_2_1":
			dialog.text = RandPhraseSimple("Я слышать твой голос - он говорить правда. Мы не обнажить топор друг против друг сегодня. Идти с миром, "+GetSexPhrase("бледнолицый","белая скво")+".",""+GetSexPhrase("Бледнолицый","Белая скво")+" редко приходить с мир на наш земля, но я видеть твой глаза - ты не лгать. Ступай.");
		...
		case "war_indian_trade_agree":
			...
			{
				dialog.text = "Хорошо. Вот твой товар. У тебя есть ещё огненный оружие на менять?";
				if (CheckCaribGuns())
				{
					link.l1 = "Есть. Будешь покупать?";
					link.l1.go = "war_indian_trade";
				}
				link.l2 = "Пока нет. В следующий раз принесу ещё.";
		...
		case "peace_indian":
			...
			dialog.text = LinkRandPhrase("Здравствуй, белый человек. Что тебе нужно в наши джунгли?","Наши джунгли много опасность. Что ты делать тут?","Что привести тебя сюда, "+GetSexPhrase("храбрый бледнолицый","храбрая белая скво")+"?");
		...
		case "peace_indian_1":
			dialog.text = RandPhraseSimple("Мы мирный народ. Мы не враждовать белый человек. Ступай, но будь осторож"+GetSexPhrase("ен","на")+" на наши тропы!","Я рад видеть "+GetSexPhrase("бледнолицый","белая скво")+" - друг индеец. Ступать с мир, "+GetSexPhrase("сын","дочь")+" моря!");
			link.l1 = RandPhraseSimple("И тебе удачи, сын сельвы...","Прощай, краснокожий друг.");
			link.l1.go = "exit_peace";
		break;
		
		case "peace_indian_2":
			dialog.text = RandPhraseSimple("Мы просто мирный охотники. Но не терпеть, чтобы нам так говорить на наш земля!","Мы не воевать с бел"+GetSexPhrase("ый","ая")+", но если бел"+GetSexPhrase("ый","ая")+" обнажить против нас топор или слово - мы ответить "+GetSexPhrase("ему","ей")+", как учить наши предки!");
