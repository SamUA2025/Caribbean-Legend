...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		case "quests":
			...
			link.l1 = HeroStringReactionRepeat(RandPhraseSimple("Zmieniam zdanie...","Nie mam teraz nic do powiedzenia."),"Zrozumiałem...","Tak, masz rację, już trzeci raz...","Przykro mi...",npchar,Dialog.CurrentNode);
			link.l1.go = "exit";
		break;
	}
