...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		...
		case "Cupture_after":
            ...
            link.l1 = RandPhraseSimple("Je ne fais que jeter un coup d'œil...","Je vérifiais juste, j'ai peut-être oublié de prendre quelque chose...");
            link.l1.go = "exit";
