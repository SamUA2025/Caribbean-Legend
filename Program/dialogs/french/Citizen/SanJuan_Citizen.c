...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
        ...
        // заменить на описание неких НПС, по квестам
			dialog.text = "Croyez-vous que je travaille pour le service secret de "+NationNameGenitive(sti(NPChar.nation))+" ?";
        ...
        // заменить на описание как пройти, по квестам
			dialog.text = "J'ai l'air d'un bureau d'enquête? Je ne sais pas, je n'en sais rien.";
