...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		case "quests":
			...
			link.l1 = RandPhraseSimple("J'ai changé d'avis.","Je n'ai rien à dire pour le moment.");
		    link.l1.go = "exit";
		break;
        ...
        // заменить на описание как пройти, по квестам
			dialog.text = "Est-ce que j'ai l'air d'un bureau d'enquête ? Je ne sais pas, je n'en sais rien.";

            link.l1 = "Tu es un vrai étourdi ! Va-t'en.";
			link.l1.go = "exit";
			link.l2 = "Une autre question, alors ?";
			link.l2.go = "new question";
		break;
