...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
	...
	{
		case "quests":
			dialog.text = NPCStringReactionRepeat(RandPhraseSimple("Que penses-tu de notre fort ? Il a fière allure, n'est-ce pas ? Et la garnison n'est pas encore pire, ha...","La vie d'un soldat de fort est assez ennuyeuse... Garder et patrouiller, dormir et se reposer, puis recommencer encore et encore. Mais c'est différent en ville... Que voulez-vous, "+GetAddress_Form(NPChar)+"?"),"Déranger un soldat avec des questions stupides n'est pas bienvenu, "+GetAddress_Form(NPChar)+"... ","C'est la troisième fois que tu essaies de me demander aujourd'hui...","Ce n'est pas facile d'être soldat et pourtant te voilà de nouveau"+GetSexPhrase(", crétin,  "," ")+" essayant de m'énerver. Fais attention ou tu finiras au sous-sol du fort...","block",1,npchar,Dialog.CurrentNode);
