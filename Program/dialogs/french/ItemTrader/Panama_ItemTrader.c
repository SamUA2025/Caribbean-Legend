...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
	...
	{
		case "quests":
			dialog.text = NPCStringReactionRepeat(RandPhraseSimple("Quel genre de questions ?","Que voulez-vous, "+GetAddress_Form(NPChar)+"?"),"Des questions encore, "+GetAddress_Form(NPChar)+"...","Des questions, des questions... Et si nous faisions du commerce, "+GetAddress_Form(NPChar)+"hein ?","Écoutez, combien de temps comptez-vous parler ?","block",1,npchar,Dialog.CurrentNode);
