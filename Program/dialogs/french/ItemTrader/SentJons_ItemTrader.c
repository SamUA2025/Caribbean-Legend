...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		case "quests":
			...
			link.l1 = HeroStringReactionRepeat(RandPhraseSimple("Aucune question pour l'instant...","Désolé, je n'ai rien à dire pour l'instant..."),"Désolé encore une fois...","Peut-être qu'il est vraiment temps de commercer...","Je suis désolé, marchandons...",npchar,Dialog.CurrentNode);
			link.l1.go = "exit";
		break;
	}
