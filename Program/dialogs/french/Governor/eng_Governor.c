...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    ...
    switch (Dialog.CurrentNode)
	{
		...
		case "work_1":  // работа на благо короны - линейка нации
			...
			{
                dialog.text = "Malheureusement, je ne peux pas vous considérer pour un emploi. Vous n'êtes pas quelqu'un avec qui je souhaite travailler pour le moment. Adieu.";
