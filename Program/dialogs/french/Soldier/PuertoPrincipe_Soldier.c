...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
	...
	{
		case "quests":
			dialog.text = NPCStringReactionRepeat(RandPhraseSimple("Quelles questions as-tu pour un soldat ?","Le soldat a toute sa vie planifiee - garde, bousculade... Comment puis-je vous aider, "+GetAddress_Form(NPChar)+"?"),"Tu ne devrais pas embêter un soldat avec des questions stupides, "+GetAddress_Form(NPChar)+"... ","C'est la troisième fois aujourd'hui que tu essaies de me poser une question...","Le destin d'un soldat n'est pas aisé, et maintenant toi, racaille, tu me rends fou...","block",1,npchar,Dialog.CurrentNode);
