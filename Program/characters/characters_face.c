...
void FaceMaker(aref rCharacter)
{
	...
	switch (rCharacter.model)
	{
		...
		// наёмники-контрактники,  торговые капитаны
		...
		case "Maskog"		:     	// Тиничгиту
			rCharacter.FaceId = 205;
		...
		case "Longway_mush"	:		rCharacter.FaceId = 220; 	break;		// Лонгвэй - модель мушкетера		
		...
		// Макроквест
		case "DeLuck"		:		rCharacter.FaceId = 149;	break;		// Фульк Делюк
		...
		case "Irons"		:		// Айронс DLC 1.3
			rCharacter.FaceId = 258;
			rCharacter.HeroModel = "Irons,Irons,Irons,Irons,Irons,Irons,Irons,Irons,Irons,Irons,Irons,Irons,Irons,Irons,Irons_14";
		break;		
		case "Irons_mush"	:		rCharacter.FaceId = 258;	break;		// Айронс DLC 1.3
...
//Jason - для высших квестовых пиратских врагов - наёмники
