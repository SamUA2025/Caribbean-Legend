...
int CreateHavanaCharacters(int n)
{
	...
	ch.model	= "huber_14";
	ch.sex = "man";
	ch.name 	= GetCharacterName("Diego");	// дон Диего
    ch.lastname = GetCharacterName("de Toledo");	// де Толедо
	ch.City = "Havana";
...
//	LAi_SetLoginTime(ch, 6.0, 21.99);
	...
	ch.sex = "man";
	ch.name 	= GetCharacterName("Alexandro");	// Алехандро
	...
	ch.model	= "banker_1_2";
	ch.sex = "man";
	ch.name 	= GetCharacterName("Jacopo");		// Якопо
	ch.lastname = GetCharacterName("Jeraldy");	// Джеральди
	ch.City = "Havana";
