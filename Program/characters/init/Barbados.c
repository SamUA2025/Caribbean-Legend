...
int CreateBarbadosCharacters(int n)
{
	...
	ch.model	= "huber_11";
	ch.sex = "man";
	ch.name 	= GetCharacterName("Francis");		// Фрэнсис
    ch.lastname = GetCharacterName("lord Willoughby");	// Лорд Уиллоби
	ch.City = "Bridgetown";
	ch.greeting = "mayor_2";
...
//	LAi_SetLoginTime(ch, 6.0, 21.99);
	...
	ch.name 	= GetCharacterName("Gaston");	// Гастон
    ch.lastname = GetCharacterName("Bald-pate"); // Плешивый
	ch.sex = "man";
	ch.City = "Bridgetown";
	ch.location = "Bridgetown_Tavern";
	ch.location.group = "barmen";
	...
	ch.name		= GetCharacterName("Mirabelle"); // Мирабель
	ch.lastname = "";
	ch.model	= "maman_2";
