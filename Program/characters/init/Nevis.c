...
//	LAi_SetLoginTime(ch, 6.0, 21.99);
	...
	ch.sex = "man";
	ch.name 	= GetCharacterName("Timothy");	// Тимоти
    ch.lastname = GetCharacterName("Vitrye");	// Витрие
	ch.City = "Charles";
	...
	ch.model	= "banker_8_1";
	ch.sex = "man";
	ch.name 	= GetCharacterName("Simon");	// Симон
	...
	ch.name		= GetCharacterName("Merilin");	// Мерилин
	ch.lastname = "";
	ch.model	= "maman_5";
