int CreateAntiguaCharacters(int n)
{
	...
	ch.model	= "huber_10";
	ch.name 	= GetCharacterName("Cristopher");	// Кристофер
    ch.lastname = GetCharacterName("Keynell");	// Кейнелл
	ch.sex = "man";
	ch.City = "SentJons";
	ch.greeting = "mayor_1";
	...
	ch.id		= "BenjaminJons";
	ch.model	= "Addington";
	ch.name 	= GetCharacterName("Benjamin");	// Бенджамин
    ch.lastname = GetCharacterName("Jones");		// Джонс
	ch.sex = "man";
	ch.City = "SentJons";
	ch.greeting = "soldier";
