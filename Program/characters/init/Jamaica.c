...
int CreateJamaicaCharacters(int n)
{
	...
	ch.model	= "huber_9";
	ch.sex = "man";
	ch.name 	= GetCharacterName("Edward");		// Эдвард
    ch.lastname = GetCharacterName("Doily");		// д'Ойли
	ch.City = "PortRoyal";
...
//	LAi_SetLoginTime(ch, 6.0, 21.99);
	...
	ch.name 	= GetCharacterName("Oldjivly");		// Олдживли
    ch.lastname = GetCharacterName("Moris");		// Морис
	...
	ch.model	= "banker_9_1";
	ch.sex = "man";
	ch.name 	= GetCharacterName("Mortimer");	// Мортимер
	ch.lastname = GetCharacterName("Hope");		// Хоуп
	ch.City = "PortRoyal";
	...
	ch.name		= GetCharacterName("Ida");	// Ида
	ch.lastname = "";
	ch.model	= "maman_3";
   ...
   //=============== Марун-Таун =============== // 170712
	...
	ch.id		= "Jackman";
	ch.name 	= GetCharacterName("Jacob");	// Якоб
	ch.lastname = GetCharacterName("Jackman");	// Джекман
	ch.rank = 30;
	ch.model	= "Jeckman";
	ch.sex = "man";
	ch.model.animation = "man";
