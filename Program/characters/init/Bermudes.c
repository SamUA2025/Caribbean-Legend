...
int CreateBermudesCharacters(int n)
{
	...
	ch.name		= GetCharacterName("One-eyed");	// Одноглазый
	ch.lastname = "";
	ch.sex = "man";
	ch.City = "Pirates";
	ch.location	= "Pirates_Tavern";
	...
	ch.name		= GetCharacterName("Pascal");	// Паскуале
	ch.lastname = GetCharacterName("Voisier");		// Вуазье
	ch.model	= "Pasquale";
	ch.greeting = "store_3";
	ch.sex = "man";
	ch.City = "Pirates";
	...
	ch.name 	= GetCharacterName("Master");	// Мастер
    ch.lastname = GetCharacterName("Alexis");	// Алексус
	ch.sex = "man";
	ch.City = "Pirates";
	...
	ch.id		= "Norman";
	ch.name 	= GetCharacterName("Abraham");	// Абрахам
	ch.lastname = GetCharacterName("Norman");		// Норман
	ch.model	= "Norman_1";
    ch.rank     = 45;
	ch.sex = "man";
	...
	LAi_SetCharacterUseBullet(ch, GUN_ITEM_TYPE, "bullet");
