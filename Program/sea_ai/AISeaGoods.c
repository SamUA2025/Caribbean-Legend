...
// belamour бессмертный офицер спасается сразу
void AISeaGoods_AddGood_ImmortalOfficer(ref rCharacter, string sGood, string sModel, float fTime, int iQuantity)
{
	if (!bSeaActive) return;
