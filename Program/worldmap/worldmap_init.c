...
.
	...
	worldMap.labels.Providence.text = "";
	...
	worldMap.labels.SantaQuiteria.text = "";
	...
	worldMap.labels.IslaDeCoche.text = "";
	// ugeen <-- временно для тестов	
	//-------  TOWN ----------------------------------------------------
