...
#define FRP_EXIT_TOWN		7
#define FRT_EXIT_TOWN		0
...
void initFastReloadTable()
{
	...
	curTable.l9.location = "SentJons_ExitTown";
	...
	curTable.l9.pic = FRP_EXIT_TOWN;
	curTable.l9.tex = FRT_EXIT_TOWN;
	curTable.l9.location = "BasTer_ExitTown";
	...
	curTable.l9.pic = FRP_EXIT_TOWN;
	curTable.l9.tex = FRT_EXIT_TOWN;
	curTable.l9.location = "Santiago_ExitTown";
	...
	curTable.l10.pic = FRP_EXIT_TOWN;
	curTable.l10.tex = FRT_EXIT_TOWN;
	curTable.l10.location = "FortFrance_ExitTown";
	...
	curTable.l9.pic = FRP_EXIT_TOWN;
	curTable.l9.tex = FRT_EXIT_TOWN;
	curTable.l9.location = "PortPax_ExitTown";
	...
	curTable.l9.pic = FRP_EXIT_TOWN;
	curTable.l9.tex = FRT_EXIT_TOWN;
	curTable.l9.location = "SanJuan_ExitTown";
	...
	curTable.l10.pic = FRP_EXIT_TOWN;
	curTable.l10.tex = FRT_EXIT_TOWN;
	curTable.l10.location = "SantoDomingo_ExitTown";
	...
	curTable.l9.pic = FRP_EXIT_TOWN;
	curTable.l9.tex = FRT_EXIT_TOWN;
	curTable.l9.location = "PortSpein_ExitTown";
	...
	curTable.l10.pic = FRP_EXIT_TOWN;
	curTable.l10.tex = FRT_EXIT_TOWN;
	curTable.l10.location = "Marigo_ExitTown";
	...
	curTable.l10.pic = FRP_EXIT_TOWN;
	curTable.l10.tex = FRT_EXIT_TOWN;
	curTable.l10.location = "Tortuga_ExitTown";
	...
	curTable.l10.pic = FRP_EXIT_TOWN;
	curTable.l10.tex = FRT_EXIT_TOWN;
	curTable.l10.location = "Panama_ExitTown";
	...
	curTable.l9.pic = FRP_EXIT_TOWN;
	curTable.l9.tex = FRT_EXIT_TOWN;
	curTable.l9.location = "Cartahena_ExitTown";
	...
	curTable.l9.pic = FRP_EXIT_TOWN;
	curTable.l9.tex = FRT_EXIT_TOWN;
	curTable.l9.location = "Caracas_ExitTown";
	...
	curTable.l9.pic = FRP_EXIT_TOWN;
	curTable.l9.tex = FRT_EXIT_TOWN;
	curTable.l9.location = "Cumana_ExitTown";
	...
	curTable.l9.pic = FRP_EXIT_TOWN;
	curTable.l9.tex = FRT_EXIT_TOWN;
	curTable.l9.location = "SantaCatalina_ExitTown";
	...
	curTable.l9.pic = FRP_EXIT_TOWN;
	curTable.l9.tex = FRT_EXIT_TOWN;
	curTable.l9.location = "Beliz_ExitTown";
	...
	curTable.l9.pic = FRP_EXIT_TOWN;
	curTable.l9.tex = FRT_EXIT_TOWN;
	curTable.l9.location = "SanAndres_ExitTown";
	...
	curTable.l2.pic = FRP_TAVERN;
	curTable.l2.tex = 0;
	curTable.l2.location = "FleuronTavern";
	// residence Dodson
	curTable.l3.pic = 35;
	curTable.l3.tex = 0;
	curTable.l3.location = "SanAugustineResidence";
	// residence Eddy
	curTable.l4.pic = 36;
	curTable.l4.tex = 0;
	curTable.l4.location = "ProtectorFisher";
	// residence Grinspy
	curTable.l5.pic = 38;
	curTable.l5.tex = 0;
	...
	curTable.l6.pic = FRP_USURER;
	curTable.l6.tex = 0;
	curTable.l6.location = "CarolineBank";
	// prison tartarus
	curTable.l7.pic = FRP_PRISON;
	curTable.l7.tex = 0;
	curTable.l7.location = "TartarusPrison";
	// chucrh
	curTable.l8.pic = FRP_CHURCH;
	curTable.l8.tex = 0;
	curTable.l8.location = "GloriaChurch";
	// mary
	curTable.l9.pic = 39;
	curTable.l9.tex = 0;
	curTable.l9.location = "CeresSmithy";
	// Jurgen
	curTable.l10.pic = 34;
	curTable.l10.tex = 0;
	curTable.l10.location = "CeresSmithy";
	//Khenryh
	curTable.l11.pic = 37;
	curTable.l11.tex = 0;
	curTable.l11.location = "SanGabrielMechanic";
	
	makearef(curTable,objFastReloadTable.table.IslaMona);
	// store
