...
int LocationInitPortPax(int n)
{
    ...
    // --> Квестовые локации.
	locations[n].reload.l31.name = "houseF1"; // Rebbebion, временное пристанище Анри Тибо по квесту "Путеводная звезда"
	locations[n].reload.l31.go = "PortPax_houseF1";
	...
	locations[n].reload.l32.go = "PortPax_houseS2";
	...
	locations[n].filespath.models = "locations\inside\tavern10\";
