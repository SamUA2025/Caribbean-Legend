...
int LocationInitBoarding(int n)
{
	...
	Locations[n].models.day.deckBigFonarsDay = "deckMedium_fd";	
	//Night
	locations[n].models.night.charactersPatch = "deckMedium_patch";
	Locations[n].models.night.deckMediumBigNight = "deckMedium_fn";	
	//Environment
	locations[n].environment.weather = "true";
	locations[n].environment.sea = "true"; 
	//Reload map
	...
	Locations[n].models.night.deckMediumBigNight = "deckLowVSBig_fn";	
	//Environment
	locations[n].environment.weather = "true";
	locations[n].environment.sea = "true";
