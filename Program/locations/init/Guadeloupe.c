...
{	
	...
	locations[n].reload.l13.name = "HutFish1";
	locations[n].reload.l13.go = "BasTer_HutFish1";
	locations[n].reload.l13.emerge = "reload1";
	locations[n].reload.l13.autoreload = "0";
	locations[n].reload.l13.label = "House";
	
	locations[n].reload.l14.name = "HutFish2";
	locations[n].reload.l14.go = "BasTer_HutFish1";
	...
	locations[n].reload.l29.name = "houseH4"; 
	...
	locations[n].reload.l30.name = "houseS6"; 
	...
	///////// дом рыбака///////////////////
	locations[n].id = "BasTer_HutFish1";
	...
	locations[n].reload.l1.name = "reload1";
	locations[n].reload.l1.go = "BasTer_town";
	locations[n].reload.l1.emerge = "HutFish1";
	locations[n].reload.l1.autoreload = "0";
	locations[n].reload.l1.label = "Street";
	
	locations[n].reload.l2.name = "reload2";
	locations[n].reload.l2.go = "BasTer_town";
	locations[n].reload.l2.emerge = "HutFish2";
	locations[n].reload.l2.autoreload = "0";
	locations[n].reload.l2.label = "Street";
	n = n + 1;
