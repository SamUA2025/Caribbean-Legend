...
void InitInterfaceTables()
{
	...
	Interfaces[INTERFACE_DEBUGWHR].SectionName = "interface\debuger_weather.c";
	Interfaces[INTERFACE_DEBUGWHR].IniFile = "RESOURCE\INI\INTERFACES\debuger_weather.ini";
	// ugeen <--
	
	// Sith --> 
	// Интерфейс снаряжения
	Interfaces[INTERFACE_INVENTORY].SectionName = "interface\inventory.c";
	Interfaces[INTERFACE_INVENTORY].IniFile = "RESOURCE\INI\INTERFACES\inventory.ini";
	// Интерфейс навыков
	Interfaces[INTERFACE_ABILITIES].SectionName = "interface\abilities.c";
	Interfaces[INTERFACE_ABILITIES].IniFile = "RESOURCE\INI\INTERFACES\abilities.ini";
	
	Interfaces[INTERFACE_DEATH].SectionName = "interface\death.c";
	Interfaces[INTERFACE_DEATH].IniFile = "RESOURCE\INI\INTERFACES\death.ini";
	...
	Interfaces[INTERFACE_MESSAGE].SectionName = "interface\message.c";
	Interfaces[INTERFACE_MESSAGE].IniFile = "RESOURCE\INI\INTERFACES\message.ini";
	// Sith <--
	// belamour cle
	Interfaces[INTERFACE_BLACKMARK_CHEAT].SectionName = "interface\blackmark_cheat.c";
	Interfaces[INTERFACE_BLACKMARK_CHEAT].IniFile     = "RESOURCE\INI\INTERFACES\blackmark_cheat.ini";
	
	Interfaces[INTERFACE_CHEAT_CHARACTER].SectionName = "interface\cheat_character.c";
	Interfaces[INTERFACE_CHEAT_CHARACTER].IniFile     = "RESOURCE\INI\INTERFACES\cheat_character.ini";
