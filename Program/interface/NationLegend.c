...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    totalInfo = XI_ConvertString(GetNationNameByType(Nation1)) + " " + XI_ConvertString("and") + " " + XI_ConvertString(GetNationNameByType(Nation2));
    if(RelatNat == RELATION_FRIEND)
    {
        totalInfo = totalInfo + XI_ConvertString("NationsFriends");
    }
    if(RelatNat == RELATION_ENEMY)
    {
        totalInfo = totalInfo + XI_ConvertString("NationsWar");
    }
    if(RelatNat == RELATION_NEUTRAL)
    {
        totalInfo = totalInfo + XI_ConvertString("NationsNeutral");
    }
