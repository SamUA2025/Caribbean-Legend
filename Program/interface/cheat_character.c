...
////////////////////////////////////////////////////////////////////////
string descF1 = "Главному герою +35 скилов";
...
void CalculateInfoDataF1()
{
    ...
    // Статистика по читам
    Statistic_AddValue(PChar, "Cheats.CF1", 1);
}
////////////////////////////////////////////////////////////////////////
string descF2 = "Корабельные навыки +1 ";
...
void CalculateInfoDataF2()
{
    ...
    // Статистика по читам
    Statistic_AddValue(PChar, "Cheats.CF2", 1);
}
////////////////////////////////////////////////////////////////////////
string descF3 = "Личные навыки +1 ";
...
////////////////////////////////////////////////////////////////////////
string descF6 = "Повысить репутацию ";
...
////////////////////////////////////////////////////////////////////////
string descF7 = "Понизить репутацию";
...
////////////////////////////////////////////////////////////////////////
string descF8 = "Повысить известность";
...
////////////////////////////////////////////////////////////////////////
string descF9 = "Понизить известность";
...
////////////////////////////////////////////////////////////////////////
string descF11 = "Повысить авторитет";
...
string descF12 = "Улучшить здоровье";
...
string descF13 = "Дополнительный вес +1000";
...
string descF14 = "Урон от клинка х10";
void CalculateInfoDataF14()
{
    totalInfo = descF14;
	
	if(!CheckAttribute(pchar, "cheats.bladedamage"))
	{
		totalInfo = totalInfo + NewStr() + LanguageConvertString(idLngFile, "Cheat_on") + NewStr();
		pchar.cheats.bladedamage = true;
	}
	else
	{
		totalInfo = totalInfo + NewStr() + LanguageConvertString(idLngFile, "Cheat_off") + NewStr();
...
string descF15 = "Урон от выстрела х10";

void CalculateInfoDataF15()
{
    totalInfo = descF15;

    if(!CheckAttribute(pchar, "cheats.gundamage"))
	{
		totalInfo = totalInfo + NewStr() + LanguageConvertString(idLngFile, "Cheat_on") + NewStr();
		pchar.cheats.gundamage = true;
	}
	else
	{
		totalInfo = totalInfo + NewStr() + LanguageConvertString(idLngFile, "Cheat_off") + NewStr();
...
////////////////////////////////////////
string descF16 = "Перезарядка огнестрельного оружия х10 ";

void CalculateInfoDataF16()
{
    totalInfo = descF16;

    if(!CheckAttribute(pchar, "cheats.guncharge"))
	{
		totalInfo = totalInfo + NewStr() + LanguageConvertString(idLngFile, "Cheat_on") + NewStr();
		pchar.cheats.guncharge = true;
	}
	else
	{
		totalInfo = totalInfo + NewStr() + LanguageConvertString(idLngFile, "Cheat_off") + NewStr();
...
string descF17 = "Шанс пробития блока 100%";

void CalculateInfoDataF17()
{
    totalInfo = descF17;

    if(!CheckAttribute(pchar, "cheats.sliding"))
	{
		totalInfo = totalInfo + NewStr() + LanguageConvertString(idLngFile, "Cheat_on") + NewStr();
		pchar.cheats.sliding = true;
	}
	else
	{
		totalInfo = totalInfo + NewStr() + LanguageConvertString(idLngFile, "Cheat_off") + NewStr();
...
string descF18 = "Восстановление энергии х10";

void CalculateInfoDataF18()
{
    totalInfo = descF18;

    if(!CheckAttribute(pchar, "cheats.energyupdate"))
	{
		totalInfo = totalInfo + NewStr() + LanguageConvertString(idLngFile, "Cheat_on") + NewStr();
		pchar.cheats.energyupdate = true;
	}
	else
	{
		totalInfo = totalInfo + NewStr() + LanguageConvertString(idLngFile, "Cheat_off") + NewStr();
...
string descF19 = "Регенерация ХП х10";
void CalculateInfoDataF19()
{
    totalInfo = descF19;
    
	if(!CheckAttribute(pchar, "cheats.hpupdate"))
	{
		totalInfo = totalInfo + NewStr() + LanguageConvertString(idLngFile, "Cheat_on") + NewStr();
		pchar.cheats.hpupdate = true;
	}
	else
	{
		totalInfo = totalInfo + NewStr() + LanguageConvertString(idLngFile, "Cheat_off") + NewStr();
		DeleteAttribute(pchar, "cheats.hpupdate");
	}
...
string descF20 = "Противники не пробивают блок главного героя ";
void CalculateInfoDataF20()
{
    totalInfo = descF20;
	
    if(!CheckAttribute(pchar, "cheats.NOsliding"))
	{
		totalInfo = totalInfo + NewStr() + LanguageConvertString(idLngFile, "Cheat_on") + NewStr();
		pchar.cheats.NOsliding = true;
	}
	else
	{
		totalInfo = totalInfo + NewStr() + LanguageConvertString(idLngFile, "Cheat_off") + NewStr();
		DeleteAttribute(pchar, "cheats.NOsliding");
	}
...
string descF21 = "Эффект яда таино ";
void CalculateInfoDataF21()
{
    totalInfo = descF21;
    // -->
     if(!CheckAttribute(pchar, "cheats.indian_poison"))
	{
		totalInfo = totalInfo + NewStr() + LanguageConvertString(idLngFile, "Cheat_on") + NewStr();
		pchar.cheats.indian_poison = true;
	}
	else
	{
		totalInfo = totalInfo + NewStr() + LanguageConvertString(idLngFile, "Cheat_off") + NewStr();
		DeleteAttribute(pchar, "cheats.indian_poison");
	}
...
void ChangeLanguage()
{
	int dockid = LanguageOpenFile("cheat_character.txt");
