...
void extrnInitPerks()
{
	...
	ChrPerksList.list.TannedLeather.descr = "perkTannedLeather"; // гимнаст
	ChrPerksList.list.TannedLeather.BaseType = "self";
	ChrPerksList.list.TannedLeather.PlayerOnly = true;
	ChrPerksList.list.TannedLeather.HeroType = "HT1";

	ChrPerksList.list.Dragoon.descr = "perkDragoon"; // атлет 
	ChrPerksList.list.Dragoon.BaseType = "self";
	ChrPerksList.list.Dragoon.PlayerOnly = true;
	...
	ChrPerksList.list.FencingMaster.descr = "perkFencingMaster"; // гимнаст 
	ChrPerksList.list.FencingMaster.BaseType = "self";
	ChrPerksList.list.FencingMaster.PlayerOnly = true;
	ChrPerksList.list.FencingMaster.HeroType = "HT1";

	ChrPerksList.list.SecondWind.descr = "perkSecondWind"; // атлет 
	ChrPerksList.list.SecondWind.BaseType = "self";
	ChrPerksList.list.SecondWind.PlayerOnly = true;
	...
	ChrPerksList.list.Jager.descr = "perkJager"; // стрелок
	ChrPerksList.list.Jager.BaseType = "self";
	ChrPerksList.list.Jager.PlayerOnly = true;
	ChrPerksList.list.Jager.HeroType = "HT4";
	
	ChrPerksList.list.Sniper.descr = "perkSniper"; // стрелок
	ChrPerksList.list.Sniper.BaseType = "self";
	ChrPerksList.list.Sniper.PlayerOnly = true;
	...
	// belamour legendary edition IW -->
	ChrPerksList.list.IronWill.TimeDelay    = 180; 
	ChrPerksList.list.IronWill.TimeDuration = 180;
	//<--
	...
	ChrPerksList.list.Medic.condition.HPPlus = true; // belamour legendary edition
	...
	ChrPerksList.list.TreasureHunter.descr = "perkTreasureHunter"; // счетовод 
	ChrPerksList.list.TreasureHunter.BaseType = "self";
	ChrPerksList.list.TreasureHunter.PlayerOnly = true;
	...
	ChrPerksList.list.Mimicry.descr = "perkMimicry"; // счетовод(ht2)
	ChrPerksList.list.Mimicry.BaseType = "ship";
	ChrPerksList.list.Mimicry.PlayerOnly = true;
	ChrPerksList.list.Mimicry.HeroType = "HT2";

	ChrPerksList.list.RatsWolf.descr = "perkRatsWolf"; // счетовод(ht2)
	ChrPerksList.list.RatsWolf.BaseType = "ship";
	ChrPerksList.list.RatsWolf.PlayerOnly = true;
	...
	ChrPerksList.list.Bombardier.descr = "perkBombardier"; // стрелок(ht4)
	ChrPerksList.list.Bombardier.BaseType = "ship";
	ChrPerksList.list.Bombardier.PlayerOnly = true;
     ...
     if (MOD_SKILL_ENEMY_RATE < 9) // belamour legendary edition для всех кроме ОК
    {
    	...
    	ChrPerksList.list.InstantRepair.TimeDelay = 120;// boal 13.02.2004 belamour 29.12.2021
