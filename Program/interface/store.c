...
void ShowHelpHint()
{
	...
	CreateTooltip("#" + sHeader, sText1, argb(255,196,255,196), sText2, argb(255,196,196,255), sText3, argb(255,255,196,196), sText4, argb(255,255,196,98), sPicture, sGroup, sGroupPicture, 64, 64);
}
void EndTooltip()
{
