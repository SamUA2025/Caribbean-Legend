...
// Character ===================================================================
	...
	else CI_CreateAndSetControls("PrimaryLand", "Ultimate_potion", CI_GetKeyCode("KEY_2"), 0, true);
...
// Interface open controls for alternative layout =======================================
	...
	if(bClassic) {
		CI_CreateAndSetControls("PrimaryLand", "Inventory", CI_GetKeyCode("VK_F1"), 0, false); // Инвентарь
		CI_CreateAndSetControls("PrimaryLand", "ShipState", CI_GetKeyCode("VK_F2"), 0, false); // Корабли
		CI_CreateAndSetControls("PrimaryLand", "QuestBook", CI_GetKeyCode("VK_F3"), 0, false); // Журнал
		CI_CreateAndSetControls("PrimaryLand", "Abilities", CI_GetKeyCode("VK_F4"), 0, false); // Навыки
		CI_CreateAndSetControls("PrimaryLand", "Nations", CI_GetKeyCode("VK_F5"), 0, false); // Нации
	} else {
