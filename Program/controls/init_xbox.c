...
// World map ===================================================================
	...
	CI_CreateAndSetControls( "WorldMapControls", "Ship_SailUp", CI_GetKeyCode("DPAD_UP"), 0, false );
	CI_CreateAndSetControls( "WorldMapControls", "Ship_SailDown", CI_GetKeyCode("DPAD_DOWN"), 0, false );
	CI_CreateAndSetControls( "WorldMapControls", "Ship_TurnLeft", CI_GetKeyCode("DPAD_LEFT"), 0, false );
	CI_CreateAndSetControls( "WorldMapControls", "Ship_TurnRight", CI_GetKeyCode("DPAD_RIGHT"), 0, false );
	CI_CreateAndSetControls( "WorldMapControls", "Ship_SailUp1", CI_GetKeyCode("LEFT_STICK_Y"), USE_AXIS_AS_BUTTON, false );
	CI_CreateAndSetControls( "WorldMapControls", "Ship_SailDown1", CI_GetKeyCode("LEFT_STICK_Y"), USE_AXIS_AS_INVERSEBUTTON, false );
	CI_CreateAndSetControls( "WorldMapControls", "Ship_TurnLeft1", CI_GetKeyCode("LEFT_STICK_X"), USE_AXIS_AS_INVERSEBUTTON, false );
	CI_CreateAndSetControls( "WorldMapControls", "Ship_TurnRight1", CI_GetKeyCode("LEFT_STICK_X"), USE_AXIS_AS_BUTTON, false );
